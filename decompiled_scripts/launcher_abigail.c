...
void main() // Position - 0x0
{
	...
	hLocal_96 = func_306(CHAR_ABIGAIL);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_302(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	if (!func_282(&unk229, &num, vector, 1f))
	{
		func_281();
	...
	while (true)
	{
		...
		func_223(num);
		func_216(&iLocal_98, &(num.f_9), vector);
	
		switch (num)
		{
			case 0:
				func_203(&num2, &num.f_28[0], "SONAR_PRE");
				break;
		
			case 1:
				func_198(&num, vector, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4861
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5512
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x554D
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57C1
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D4C
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x650F
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6556
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65C1
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x69D4
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69E4
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74FB
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7525
{
...
BOOL func_85(Player plParam0) // Position - 0x7551
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7653
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76E8
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x838A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x840C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8464
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x86E9
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8706
{
...
int func_106(int iParam0) // Position - 0x8C4F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C71
{
	if (bParam0)
		return uParam1;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D46
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DB8
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DCE
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8DE4
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E26
{
...
BOOL func_122(Any* panParam0) // Position - 0xA8B9
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA57
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAB33
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAC2C
{
...
int func_134(Ped pedParam0) // Position - 0xAC93
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xACDC
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xACFC
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAD1D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xADED
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE40
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAF35
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFDF
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB146
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB1E0
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB202
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB24F
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB2CC
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB370
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3FF
{
...
void func_160(Vehicle veParam0) // Position - 0xB597
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB753
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB7B9
{
...
BOOL func_169(int iParam0) // Position - 0xB7FA
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB871
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB9A8
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9F7
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBA08
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBBE9
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBC1C
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC65
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBC89
{
	switch (iParam0)
	{
		case 0:
...
Blip func_180(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC0F9
{
	Blip blip;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC125
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC13C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC1CB
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_185(var uParam0) // Position - 0xC9C9
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCA57
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_187(BOOL bParam0) // Position - 0xCABB
{
...
BOOL func_188(Vehicle veParam0) // Position - 0xCB52
{
...
BOOL func_189(int iParam0) // Position - 0xCB7C
{
	eCharacter character;
...
BOOL func_190() // Position - 0xD299
{
	return Global_100872.f_1;
}

BOOL func_191() // Position - 0xD2A7
{
	if (Global_97735 != -1)
...
BOOL func_196() // Position - 0xD357
{
	return Global_1575063;
}

BOOL func_197() // Position - 0xD363
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_198(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD37F
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD407
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD498
{
...
float func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD533
{
...
void func_203(var uParam0, var uParam1, char* sParam2) // Position - 0xD56D
{
		...
		switch (*uParam0)
		{
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > uParam0->f_166)
				{
					...
					else if (func_215(PLAYER::PLAYER_PED_ID(), *uParam1, true) < 15f)
					{
						*uParam0 = 4;
					}
				}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD869
{
...
BOOL func_205(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD8B7
{
	Global_21846 = 0;
...
BOOL func_208(Player plParam0) // Position - 0xDC1F
{
	return func_209(plParam0, 20);
}

BOOL func_209(Player plParam0, int iParam1) // Position - 0xDC2F
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDDA7
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
float func_215(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xDEA1
{
	Vector3 entityCoords;
...
void func_216(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDEFF
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_219(var uParam0, int iParam1) // Position - 0xE065
{
	BOOL flag;
	int i;
...
void func_221(var uParam0) // Position - 0xE10F
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_222(uParam0);
...
void func_222(var uParam0) // Position - 0xE126
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE236
{
	var unk;
...
void func_225(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE4A6
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_226(int iParam0) // Position - 0xE7FE
{
...
BOOL func_227(var uParam0) // Position - 0xE81E
{
...
BOOL func_228(var uParam0) // Position - 0xE836
{
...
void func_230(Object* pobParam0) // Position - 0xEB59
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEC04
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_233(Ped pedParam0, Vehicle veParam1) // Position - 0xEDC2
{
...
BOOL func_234(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEDF2
{
	int i;
	int num;
...
BOOL func_235(int iParam0) // Position - 0xF0AE
{
...
BOOL func_236(Ped pedParam0, int iParam1) // Position - 0xF0E2
{
	float xSize;
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xF158
{
	return func_238(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF170
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_239(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF231
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_240(Ped pedParam0, int iParam1) // Position - 0xF35D
{
...
BOOL func_242(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF46C
{
	var unk;
...
float func_243(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF4FD
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_244(float fParam0, var uParam1, var uParam2) // Position - 0xF51E
{
	float num;
	float num2;
...
int func_246(Ped pedParam0, Ped pedParam1) // Position - 0xF578
{
	int i;
...
BOOL func_247(Ped pedParam0) // Position - 0xF5B7
{
...
BOOL func_248(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF5DF
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_249(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF6DA
{
	float entityCoords;
	float num;
...
BOOL func_250(Ped pedParam0, float fParam1) // Position - 0xF7E6
{
	var outProjectile;
	var outCoords;
...
BOOL func_251(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF87B
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_252(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF909
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_253(int iParam0) // Position - 0xF951
{
...
void func_254(Vehicle veParam0) // Position - 0xF99B
{
	int taskSequenceId;
...
BOOL func_255(int iParam0) // Position - 0xFA38
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_256(int iParam0) // Position - 0xFACD
{
...
BOOL func_259(int iParam0) // Position - 0xFB4C
{
...
BOOL func_261(int iParam0) // Position - 0xFBBE
{
...
BOOL func_263(var uParam0) // Position - 0xFC2D
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_270(&(uParam0->f_48), sLocal_97, "base", 0);
			iLocal_89 = 1;
			break;
	
		case 1:
			if (!func_269(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_97))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_266(&uParam0->f_28[0], CHAR_ABIGAIL, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_264(&uParam0->f_35[0], num[1], -1584.0127f, 5158.5386f, 18.6057f, 210.5309f);
...
void func_264(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDDF
{
	func_265(pveParam0);
...
void func_265(Vehicle* pveParam0) // Position - 0xFE21
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_266(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFEBD
{
...
BOOL func_267(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFF19
{
	Hash model;
...
int func_268(var uParam0, eCharacter echParam1) // Position - 0xFFA7
{
	int num;
...
BOOL func_269(var uParam0) // Position - 0xFFED
{
	int i;
...
BOOL func_271(var uParam0) // Position - 0x1005B
{
	Hash model;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_266(&uParam0->f_28[0], CHAR_ABIGAIL, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1))
					flag = false;
...
BOOL func_272(int iParam0) // Position - 0x10166
{
	var unk;
	eCharacter character;
...
BOOL func_273(int iParam0) // Position - 0x101B7
{
	const char* string2;
...
BOOL func_274(int iParam0) // Position - 0x10270
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x10331
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_277(int iParam0) // Position - 0x10498
{
...
BOOL func_278(int iParam0) // Position - 0x104C3
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x104EE
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x10519
{
	if (func_256(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10568
{
	int i;
...
BOOL func_283(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x105CD
{
	int num;
	char* str;
...
BOOL func_284(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10645
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x106C0
{
	char* str;
...
BOOL func_289(char* sParam0) // Position - 0x10797
{
	var string1;
...
void func_294(Object* pobParam0, BOOL bParam1) // Position - 0x1084B
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_297(Vehicle* pveParam0) // Position - 0x108D5
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_300(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10960
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_301(Ped* ppedParam0) // Position - 0x109B0
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_302(int iParam0) // Position - 0x109F1
{
	if (*iParam0 == -1)
		return;
...
Hash func_306(eCharacter echParam0) // Position - 0x10A8D
{
	if (!func_36(echParam0))
