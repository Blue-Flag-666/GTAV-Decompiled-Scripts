...
void main() // Position - 0x0
{
	...
	uLocal_92 = { -1593.813f, 5221.2354f, 1.94482f };
	uLocal_95 = { -1603.9861f, 5243.6235f, 4.940323f };
	iLocal_98 = func_301(CHAR_ABIGAIL);
	sLocal_99 = "rcmabigail";
	iLocal_100 = -1;
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_297(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (!func_277(&unk230, &num, unk61, 1f))
	{
		func_276();
	...
	while (true)
	{
		...
		func_218(num);
		func_211(&iLocal_100, &(num.f_9), unk61);
	
		switch (num)
		{
			case 0:
				func_198(&num2, &num.f_28[0], "SONAR_PRE");
				break;
		
			case 1:
				func_193(&num, unk61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x38FE
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x393B
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x397B
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39A7
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EF0
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4133
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x45D2
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4673
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CE8
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64AB
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x64F2
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x655D
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x65BE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6962
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6972
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x746E
{
...
BOOL func_81(Player plParam0) // Position - 0x7498
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x759A
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x762F
{
	float num;
	float num2;
	float num3;
...
int func_193(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD290
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD318
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD3A9
{
...
float func_197(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD444
{
	var unk;
...
void func_198(var uParam0, var uParam1, char* sParam2) // Position - 0xD47E
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(*uParam1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()))
	{
		switch (*uParam0)
		{
			case 0:
				uParam0->f_166 = unk_0xA5E11AF0A2B928C1() + unk_0x15A88CFAAFFC6C4B(1000, 2000);
				_CONVERSATION_INITIALIZE_ACTOR(&(uParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
				unk_0x3EE48ADC8C7F5CC4(*uParam1, sLocal_99, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*uParam0 = 1;
				break;
		
			case 1:
				if (unk_0xA5E11AF0A2B928C1() > uParam0->f_166)
				{
					if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), uLocal_92, uLocal_95, 8f, 0, 1, 0))
					{
						unk_0x3EE48ADC8C7F5CC4(*uParam1, sLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*uParam0 = 3;
					}
				...
				if (unk_0x7BB3D8F4F6310EB8(*uParam1, sLocal_99, "outro", 3) && unk_0x92377426879E21FF(*uParam1, sLocal_99, "outro") > 0.99f)
					unk_0x3EE48ADC8C7F5CC4(*uParam1, sLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				break;
		
			case 3:
				if (unk_0x7BB3D8F4F6310EB8(*uParam1, sLocal_99, "intro", 3) && unk_0x92377426879E21FF(*uParam1, sLocal_99, "intro") > 0.99f)
					*uParam0 = 4;
				break;
			...
			case 4:
				...
				{
					if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), uLocal_92, uLocal_95, 8f, 0, 1, 0))
						unk_0x3EE48ADC8C7F5CC4(*uParam1, sLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
			...
			case 5:
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					if (unk_0x7BB3D8F4F6310EB8(*uParam1, sLocal_99, "loop_talk", 3))
					{
						if (unk_0x92377426879E21FF(*uParam1, sLocal_99, "loop_talk") > 0.99f)
						{
							uParam0->f_166 = unk_0xA5E11AF0A2B928C1() + unk_0x15A88CFAAFFC6C4B(7000, 10000);
						
							if (!unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), uLocal_92, uLocal_95, 8f, 0, 1, 0))
							{
								unk_0x3EE48ADC8C7F5CC4(*uParam1, sLocal_99, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*uParam0 = 1;
							}
							else
							{
								unk_0x3EE48ADC8C7F5CC4(*uParam1, sLocal_99, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*uParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (unk_0x7BB3D8F4F6310EB8(*uParam1, sLocal_99, "loop_look", 3) && unk_0x92377426879E21FF(*uParam1, sLocal_99, "loop_look") > 0.99f)
				{
					if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), uLocal_92, uLocal_95, 8f, 0, 1, 0))
					{
						if (unk_0xA5E11AF0A2B928C1() > uParam0->f_166)
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD77A
{
...
BOOL func_200(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD7C8
{
	Global_21726 = 0;
...
BOOL func_204(int iParam0, int iParam1) // Position - 0xDB40
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDCB8
{
	if (func_57(14))
	{
		if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0))
...
float func_210(var uParam0, var uParam1, int iParam2) // Position - 0xDDB2
{
	var unk;
	var unk4;
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDE10
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
...
void func_214(var uParam0, int iParam1) // Position - 0xDF76
{
	BOOL flag;
	int i;
...
void func_216(var uParam0) // Position - 0xE020
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_217(uParam0);
...
void func_217(var uParam0) // Position - 0xE037
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE147
{
	var unk;
...
BOOL func_221(int iParam0) // Position - 0xE70F
{
...
BOOL func_222(var uParam0) // Position - 0xE72F
{
...
BOOL func_223(var uParam0) // Position - 0xE747
{
...
void func_225(var uParam0) // Position - 0xEA6A
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB15
{
	int i;
	int num;
	var unk;
...
BOOL func_228(var uParam0, var uParam1) // Position - 0xECD3
{
	var unk;
...
BOOL func_229(var uParam0, BOOL bParam1, int iParam2) // Position - 0xED03
{
	int i;
	int num;
...
BOOL func_230(int iParam0) // Position - 0xEFBF
{
...
BOOL func_231(var uParam0, int iParam1) // Position - 0xEFF3
{
	float num;
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xF069
{
	return func_233(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF081
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF142
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_235(var uParam0, int iParam1) // Position - 0xF26E
{
	int num;
...
BOOL func_237(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF37D
{
	var unk;
	var unk4;
	float num;
...
float func_238(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF40E
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_239(float fParam0, var uParam1, var uParam2) // Position - 0xF42F
{
	float num;
	float num2;
...
int func_241(var uParam0, var uParam1) // Position - 0xF489
{
	int i;
...
int func_242(var uParam0) // Position - 0xF4C8
{
...
BOOL func_243(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF4F0
{
	float num;
	float num2;
	int num3;
...
BOOL func_244(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF5EB
{
	float num;
	float num2;
...
BOOL func_245(var uParam0, float fParam1) // Position - 0xF6F7
{
	var unk;
	var unk2;
...
BOOL func_246(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF78C
{
	var unk;
	var unk4;
	float num;
...
BOOL func_247(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF81A
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_248(int iParam0) // Position - 0xF862
{
...
void func_249(var uParam0) // Position - 0xF8AC
{
	var unk;
...
BOOL func_250(int iParam0) // Position - 0xF949
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_251(int iParam0) // Position - 0xF9DE
{
...
BOOL func_254(int iParam0) // Position - 0xFA5D
{
...
BOOL func_256(int iParam0) // Position - 0xFACF
{
...
BOOL func_257(var uParam0) // Position - 0xFAF7
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_258(var uParam0) // Position - 0xFB3E
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x28818732C8F0F80E(sLocal_99);
			func_265(&(uParam0->f_48), sLocal_99, "base", 0);
			iLocal_91 = 1;
			break;
	
		case 1:
			if (!func_264(&num) || !unk_0x2BBF749E555360DC(sLocal_99))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_261(&uParam0->f_28[0], CHAR_ABIGAIL, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1))
					flag = false;
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_259(&uParam0->f_35[0], num[1], -1584.0127f, 5158.5386f, 18.6057f, 210.5309f);
...
void func_259(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFCF0
{
	func_260(uParam0);
...
void func_260(var uParam0) // Position - 0xFD32
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_261(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFDCE
{
	if (func_262(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0x7DE17ACDD8BA2642(*uParam0))
		{
			if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_262(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFE2A
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_301(echParam1);
...
int func_263(var uParam0, eCharacter echParam1) // Position - 0xFEB8
{
	int num;
...
BOOL func_264(var uParam0) // Position - 0xFEFE
{
	int i;
...
BOOL func_266(var uParam0) // Position - 0xFF6B
{
	int num;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!unk_0x0CBB7C273DED26E7(num) || !unk_0x2BBF749E555360DC(sLocal_99))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_261(&uParam0->f_28[0], CHAR_ABIGAIL, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1))
					flag = false;
...
BOOL func_267(int iParam0) // Position - 0x1007A
{
	var unk;
	eCharacter character;
...
BOOL func_268(int iParam0) // Position - 0x100CB
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0x10184
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0x10245
{
	int i;
	var unk;
	int num;
...
BOOL func_272(int iParam0) // Position - 0x103AC
{
...
BOOL func_273(int iParam0) // Position - 0x103D7
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x10402
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x1042D
{
	if (func_251(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1047C
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x104E1
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10559
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x105D4
{
	char* str;
...
BOOL func_284(char* sParam0) // Position - 0x106AB
{
	var unk;
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x1075F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_292(var uParam0) // Position - 0x107E9
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_295(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10874
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_296(var uParam0) // Position - 0x108C4
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
void func_297(int iParam0) // Position - 0x10905
{
	if (*iParam0 == -1)
		return;
...
int func_301(eCharacter echParam0) // Position - 0x109A1
{
	if (!func_36(echParam0))
