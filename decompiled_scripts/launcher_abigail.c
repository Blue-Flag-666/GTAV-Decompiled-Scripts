...
void main() // Position - 0x0
{
	...
	hLocal_98 = func_301(CHAR_ABIGAIL);
	...
	if (!func_277(&unk229, &num, vector, 1f))
	{
		func_276();
	...
	while (true)
	{
		...
		func_218(num);
		func_211(&iLocal_100, &(num.f_9), vector);
		...
		switch (num)
		{
			...
			case 1:
				func_193(&num, vector, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39A7
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EF0
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x4257
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x434A
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x484D
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x54AE
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x54E9
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x575D
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CE8
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6972
{
	int i;
...
BOOL func_131(Ped pedParam0) // Position - 0xAC1D
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD3A9
{
...
float func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD444
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(*uParam1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
	{
		switch (*uParam0)
		{
			case 0:
				...
				TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "base", 1000f, -8f, -1, 1, 0, false, false, false);
				*uParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_92, uLocal_95, 8f, false, true, 0))
					{
						TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "intro", 8f, -8f, -1, 2, 0, false, false, false);
						*uParam0 = 3;
					}
					else if (func_210(PLAYER::PLAYER_PED_ID(), *uParam1, true) < 15f)
					{
						*uParam0 = 4;
					}
				}
			
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, sLocal_99, "outro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, sLocal_99, "outro") > 0.99f)
					TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "base", 8f, -8f, -1, 1, 0, false, false, false);
				break;
		
			case 3:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, sLocal_99, "intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, sLocal_99, "intro") > 0.99f)
					*uParam0 = 4;
				break;
			...
			case 4:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_92, uLocal_95, 8f, false, true, 0))
						TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, false, false, false);
			...
			case 5:
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, sLocal_99, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, sLocal_99, "loop_talk") > 0.99f)
						{
							uParam0->f_166 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 10000);
						
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_92, uLocal_95, 8f, false, true, 0))
							{
								TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "outro", 8f, -8f, -1, 2, 0, false, false, false);
								*uParam0 = 1;
							}
							else
							{
								TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "loop_look", 8f, -8f, -1, 1, 0, false, false, false);
								*uParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, sLocal_99, "loop_look", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, sLocal_99, "loop_look") > 0.99f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_92, uLocal_95, 8f, false, true, 0))
					{
						if (MISC::GET_GAME_TIMER() > uParam0->f_166)
...
BOOL func_203(Player plParam0) // Position - 0xDB30
{
	return func_204(plParam0, 20);
}

BOOL func_204(Player plParam0, int iParam1) // Position - 0xDB40
{
...
float func_210(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xDDB2
{
	Vector3 entityCoords;
...
void func_211(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDE10
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_220(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE3B7
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_225(Object* pobParam0) // Position - 0xEA6A
{
...
BOOL func_228(Ped pedParam0, Vehicle veParam1) // Position - 0xECD3
{
...
BOOL func_231(Ped pedParam0, int iParam1) // Position - 0xEFF3
{
	float xSize;
...
BOOL func_232(Ped pedParam0, int iParam1) // Position - 0xF069
{
	return func_233(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF081
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_234(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF142
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_235(Ped pedParam0, int iParam1) // Position - 0xF26E
{
...
BOOL func_237(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF37D
{
	var unk;
...
int func_241(Ped pedParam0, Ped pedParam1) // Position - 0xF489
{
	int i;
...
BOOL func_242(Ped pedParam0) // Position - 0xF4C8
{
...
BOOL func_243(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF4F0
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_244(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF5EB
{
	float entityCoords;
	float num;
...
BOOL func_245(Ped pedParam0, float fParam1) // Position - 0xF6F7
{
	var outProjectile;
	var outCoords;
...
BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF78C
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_247(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF81A
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_249(Vehicle veParam0) // Position - 0xF8AC
{
	int taskSequenceId;
...
BOOL func_258(var uParam0) // Position - 0xFB3E
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_264(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_99))
				return false;
...
void func_259(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFCF0
{
	func_260(pveParam0);
...
void func_260(Vehicle* pveParam0) // Position - 0xFD32
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFDCE
{
...
BOOL func_262(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFE2A
{
	Hash model;
...
BOOL func_266(var uParam0) // Position - 0xFF6B
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(model) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_99))
				return false;
...
void func_289(Object* pobParam0, BOOL bParam1) // Position - 0x1075F
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_292(Vehicle* pveParam0) // Position - 0x107E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_295(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10874
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_296(Ped* ppedParam0) // Position - 0x108C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
Hash func_301(eCharacter echParam0) // Position - 0x109A1
{
	if (!func_36(echParam0))
