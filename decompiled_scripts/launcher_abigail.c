...
int func_190(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(uParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_261(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
