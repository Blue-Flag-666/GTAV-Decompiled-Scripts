...
void main() // Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(eScriptParam_0))
	{
		...
		uLocal_314 = Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_33;
		func_73(&Global_1567810, uLocal_314);
		uLocal_376 = { Global_1567810.f_146.f_82[5 /*102*/] };
		fLocal_379 = Global_1567810.f_146.f_82[5 /*102*/].f_3;
	
		if (fLocal_379 < 0f)
			fLocal_379 = fLocal_379 + 360f;
	
		uLocal_386 = { Global_1567810.f_146.f_82[5 /*102*/].f_16 };
		fLocal_389 = Global_1567810.f_146.f_82[5 /*102*/].f_19.f_2;
		uLocal_380 = { Global_1567810.f_146.f_82[5 /*102*/].f_7 };
		uLocal_383 = { Global_1567810.f_146.f_82[5 /*102*/].f_10 };
	}
...
void func_2() // Position - 0xCE5
{
	...
	player = Global_1853822;

	if (player > -1 && player != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 30; i = i + 1)
		{
			if (Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_33 == Global_1853988[player /*867*/].f_267[i])
			{
				if (func_9(i) != -1)
				{
...
int func_4(Player plParam0) // Position - 0xDBC
{
	int address;
...
BOOL func_5(Player plParam0) // Position - 0xDD7
{
	Player player;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0xDF9
{
	Player player;
...
void func_7(int iParam0) // Position - 0xE59
{
	...
	{
		case 0:
			Global_2359296[func_8() /*5568*/].f_7.f_18 = Global_2359296[func_8() /*5568*/].f_7.f_18 + 1;
			break;
	
		case 1:
			Global_2359296[func_8() /*5568*/].f_7.f_21 = Global_2359296[func_8() /*5568*/].f_7.f_21 + 1;
			break;
	
		case 2:
			Global_2359296[func_8() /*5568*/].f_7.f_24 = Global_2359296[func_8() /*5568*/].f_7.f_24 + 1;
			break;
	
		case 3:
			Global_2359296[func_8() /*5568*/].f_7.f_27 = Global_2359296[func_8() /*5568*/].f_7.f_27 + 1;
			break;
	
		case 4:
			Global_2359296[func_8() /*5568*/].f_7.f_30 = Global_2359296[func_8() /*5568*/].f_7.f_30 + 1;
			break;
	
		case 99:
			Global_2359296[func_8() /*5568*/].f_7.f_33 = Global_2359296[func_8() /*5568*/].f_7.f_33 + 1;
			break;
	}
	...
	if (num != -1)
		Global_2359296[func_8() /*5568*/].f_7.f_82[num] = Global_2359296[func_8() /*5568*/].f_7.f_82[num] + 1;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x1002
{
	return -1;
}

void func_11(var uParam0) // Position - 0x100B
{
	Entity entity;
...
BOOL func_13(Player plParam0) // Position - 0x104D
{
	return IS_BIT_SET(Global_1654054.f_241.f_136[func_15(9) /*33*/][plParam0], func_14(9));
}
...
BOOL func_16(int iParam0) // Position - 0x108A
{
...
Hash func_18(int iParam0, int iParam1) // Position - 0x10CC
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_19(iParam1));
}

int func_19(int iParam0) // Position - 0x10E1
{
	int num;
	int num2;
...
void func_25(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x11C6
{
	if (bParam0)
	{
...
BOOL func_27(Player plParam0, int iParam1) // Position - 0x132D
{
	BOOL flag;
...
BOOL func_29(Player plParam0) // Position - 0x13C7
{
...
int func_31(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1414
{
	int num;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x1491
{
...
BOOL func_38(Ped pedParam0) // Position - 0x19C5
{
...
void func_39(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x19F6
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x1AC6
{
	Hash statName;
...
int func_46(var uParam0, ePedType eptParam1, Hash hParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x1BF9
{
	Ped ped;
...
BOOL func_48(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C6C
{
	int num;
	int num2;
...
BOOL func_54(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1EB2
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x1FAD
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_57() // Position - 0x1FC0
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_58(Vector3 vParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1FDC
{
...
BOOL func_59(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x208F
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_62(int iParam0) // Position - 0x21E3
{
	if (iParam0 == 1)
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x223A
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x22BE
{
	switch (func_66())
	{
		case 0:
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x232F
{
...
Vector3 func_76(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x5A56
{
	float num;
	float num2;
	float num3;
...
BOOL func_78(int iParam0, var uParam1) // Position - 0x5ADC
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_81(int iParam0) // Position - 0x69F4
{
	switch (iParam0)
	{
		case 87:
...
BOOL func_82(int iParam0, int iParam1) // Position - 0x6A23
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x8E93
{
	int i;
...
BOOL func_94(int iParam0) // Position - 0x90A8
{
	if (Global_43377 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x90CA
{
	return func_96(iParam0, Global_43377);
}

BOOL func_96(int iParam0, int iParam1) // Position - 0x90DB
{
	if (iParam1 == 15)
		return 1;
