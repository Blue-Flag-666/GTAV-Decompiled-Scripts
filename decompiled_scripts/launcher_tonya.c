...
void main() // Position - 0x0
{
	...
	MISC::CLEAR_AREA(uLocal_92, 5f, true, false, false, false);
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39CE
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F17
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x427C
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x436F
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x4872
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x54D3
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x550E
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x5782
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D0D
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6997
{
	int i;
...
int func_93(Player plParam0) // Position - 0x865D
{
...
void func_122(Ped pedParam0) // Position - 0xA9BE
{
	int num;
	int num2;
	int num3;
...
int func_124(Ped pedParam0) // Position - 0xAA9A
{
	int i;
...
int func_130(Ped pedParam0) // Position - 0xABFA
{
	int i;
...
BOOL func_131(Ped pedParam0) // Position - 0xAC43
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC63
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_136(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xADA7
{
	int i;
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF46
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xB0AD
{
	BOOL flag;
...
BOOL func_143(Player plParam0) // Position - 0xB139
{
...
int func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB186
{
	int num;
...
BOOL func_148(const char* sParam0) // Position - 0xB203
{
...
BOOL func_154(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB336
{
...
void func_155(Vehicle veParam0) // Position - 0xB4CE
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_172(const char* sParam0, int iParam1) // Position - 0xBB53
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_179(Vehicle veParam0) // Position - 0xC549
{
...
void func_189(var uParam0) // Position - 0xCD76
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		num = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_92);
		...
		if (num < 20f * 20f && bLocal_98)
		{
			switch (iLocal_99)
			{
				...
				case 2:
					if (func_196(&uLocal_265))
					{
						if (func_190(&uLocal_265) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
...
float func_190(int* piParam0) // Position - 0xDB27
{
	if (func_196(piParam0))
		if (func_192(piParam0))
			return piParam0->f_2;
		else
...
BOOL func_192(int* piParam0) // Position - 0xDBBB
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_193(int* piParam0) // Position - 0xDBC8
{
	func_194(piParam0, 0f);
	return;
}

void func_194(int* piParam0, float fParam1) // Position - 0xDBD7
{
...
void func_195(int* piParam0) // Position - 0xDC02
{
	if (!func_196(piParam0))
		func_193(piParam0);
...
BOOL func_196(int* piParam0) // Position - 0xDC1A
{
...
BOOL func_201(Player plParam0) // Position - 0xDFE3
{
	return func_202(plParam0, 20);
}

BOOL func_202(Player plParam0, int iParam1) // Position - 0xDFF3
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE309
{
...
void func_211(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE3A4
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
float func_215(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xE5A8
{
...
void func_221(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE985
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_226(Object* pobParam0) // Position - 0xF03E
{
...
BOOL func_229(Ped pedParam0, Vehicle veParam1) // Position - 0xF2A7
{
...
BOOL func_232(Ped pedParam0, int iParam1) // Position - 0xF5C7
{
	float xSize;
...
BOOL func_233(Ped pedParam0, int iParam1) // Position - 0xF63D
{
	return func_234(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF655
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_235(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_235(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF716
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_236(Ped pedParam0, int iParam1) // Position - 0xF842
{
...
BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF951
{
	var unk;
...
int func_242(Ped pedParam0, Ped pedParam1) // Position - 0xFA5D
{
	int i;
...
BOOL func_243(Ped pedParam0) // Position - 0xFA9C
{
...
BOOL func_244(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFAC4
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_245(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFBBF
{
	float entityCoords;
	float num;
...
BOOL func_246(Ped pedParam0, float fParam1) // Position - 0xFCCB
{
	var outProjectile;
	var outCoords;
...
BOOL func_247(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFD60
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_248(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFDEE
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_250(Vehicle veParam0) // Position - 0xFE80
{
	int taskSequenceId;
...
BOOL func_258(var uParam0) // Position - 0x100CE
{
	...
	iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_92 - { 10f, 10f, 10f }, uLocal_92 + { 10f, 10f, 10f }, false, true, true, true);
	bLocal_97 = true;
...
void func_277(Object* pobParam0, BOOL bParam1) // Position - 0x10AC4
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_280(Vehicle* pveParam0) // Position - 0x10B4E
{
...
void func_281(Vehicle* pveParam0) // Position - 0x10B86
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_283(var uParam0, int iParam1) // Position - 0x10C34
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_284(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_284(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10C75
{
...
void func_285(Ped* ppedParam0) // Position - 0x10CC5
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
