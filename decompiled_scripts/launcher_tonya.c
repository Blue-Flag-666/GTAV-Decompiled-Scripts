...
void main() // Position - 0x0
{
	...
	num.f_41 = 6;
	func_290(&num);
	uLocal_92 = { uScriptParam_0.f_1[0 /*3*/] };
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_288(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (!func_270(&unk61, &num, uLocal_92, 1f))
	{
	...
	unk_0xF82BC5193AF62796(uLocal_92, 5f, 1, 0, 0, 0);

	while (true)
	{
		SYSTEM::WAIT(0);
	
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1) || func_261(num))
			func_273(&num, true);
		...
		func_219(num);
		func_211(&iLocal_269, &(num.f_9), uLocal_92);
		func_189(&num);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3925
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x3962
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x39A2
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39CE
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F17
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4158
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x45F7
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4698
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D0D
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64D0
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x6517
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6582
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x65E3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6987
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6997
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7493
{
...
BOOL func_81(Player plParam0) // Position - 0x74BD
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x75BF
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7654
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x82F3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x8375
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x83CD
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x867A
{
...
int func_102(int iParam0) // Position - 0x8BB6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BD8
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8BEF
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8CAD
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8D4B
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8D8D
{
...
BOOL func_118(Any* panParam0) // Position - 0xA820
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAB93
{
...
BOOL func_131(var uParam0) // Position - 0xAC43
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAC63
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL func_133(int iParam0) // Position - 0xAC84
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135(int iParam0) // Position - 0xAD54
{
	switch (iParam0)
	{
		case 5:
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xADA7
{
	int i;
...
BOOL func_137(int iParam0) // Position - 0xAE9C
{
	switch (iParam0)
	{
		case 5:
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF46
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB0AD
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB139
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB186
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB203
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB2A7
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB336
{
...
void func_155(var uParam0) // Position - 0xB4CE
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_161(int iParam0) // Position - 0xB68A
{
	if (iParam0 == 1)
...
BOOL func_163(int iParam0) // Position - 0xB6F0
{
...
BOOL func_164(int iParam0) // Position - 0xB731
{
	int num;
...
int func_166(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB7A8
{
	int i;
...
void func_167(int iParam0, int iParam1) // Position - 0xB8DF
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB92E
{
	return func_169(iParam0, Global_43257);
}

BOOL func_169(int iParam0, int iParam1) // Position - 0xB93F
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_170(int iParam0) // Position - 0xBB20
{
	if (Global_43257 == 15)
		return false;
...
int func_172(var uParam0, int iParam1) // Position - 0xBB53
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBB9C
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
BOOL func_174(var uParam0, int iParam1) // Position - 0xBBC0
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_176(var uParam0) // Position - 0xC3C0
{
	float num;
...
void func_177(int iParam0, var uParam1) // Position - 0xC44E
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_178(BOOL bParam0) // Position - 0xC4B2
{
	var unk;
...
BOOL func_179(var uParam0) // Position - 0xC549
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_180(int iParam0) // Position - 0xC573
{
	eCharacter character;
...
BOOL func_181() // Position - 0xCC90
{
	return Global_100720.f_1;
}

BOOL func_182() // Position - 0xCC9E
{
	if (Global_97603 != -1)
...
BOOL func_187() // Position - 0xCD4E
{
	return Global_1575060;
}

BOOL func_188() // Position - 0xCD5A
{
	if (!unk_0xA26A9A07F761D8F8())
...
void func_189(var uParam0) // Position - 0xCD76
{
	...
	if (func_183() || unk_0xB53553DC4AAC7D8A())
	{
		unk_0xD6625E11483B2324(0);
		return;
	}
	...
	if (!bLocal_98)
	{
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_1@franklin_1a");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_1@franklin_1b");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_1@franklin_1c");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_2@franklin_2a");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_2@franklin_2b");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_2@franklin_2c");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_3@franklin_3a");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_3@franklin_3b");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_4@franklin_4a");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_4@franklin_4b");
		unk_0x28818732C8F0F80E("special_ped@tonya@franklin_4@franklin_4c");
	
		if (unk_0x2BBF749E555360DC("special_ped@tonya@franklin_1@franklin_1a") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_1@franklin_1b") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_1@franklin_1c") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_2@franklin_2a") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_2@franklin_2b") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_2@franklin_2c") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_3@franklin_3a") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_3@franklin_3b") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_4@franklin_4a") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_4@franklin_4b") && unk_0x2BBF749E555360DC("special_ped@tonya@franklin_4@franklin_4c"))
			bLocal_98 = true;
	}

	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		num = SYSTEM::VDIST2(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_92);
	
		if (num < 20f * 20f && bLocal_98)
		{
			switch (iLocal_99)
			{
				case 0:
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_100, 3, uParam0->f_28[0], "TONYA", 0, 1);
					
						if (*uParam0 == 58)
						{
							_CONVERSATION_ADD_LINE(&uLocal_100, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
						
							if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
							{
								unk_0x63EF69C6969A3D26(&uLocal_96);
								unk_0xDBC7406226B5540E(&uLocal_96);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 2f, -4f, -1, 262144, 0, 0, 0, 0);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0, 0, 0);
								unk_0xF2CFC6EC8C85FA78(uLocal_96);
								unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uLocal_96);
								unk_0x63EF69C6969A3D26(&uLocal_96);
							}
						}
						else if (*uParam0 == 59)
						{
							...
							if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
							{
								unk_0x63EF69C6969A3D26(&uLocal_96);
								unk_0xDBC7406226B5540E(&uLocal_96);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 4f, -4f, -1, 262144, 0, 0, 0, 0);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
								unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0, 0, 0, 0);
								unk_0xF2CFC6EC8C85FA78(uLocal_96);
								unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uLocal_96);
								unk_0x63EF69C6969A3D26(&uLocal_96);
							}
				...
				case 1:
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						if (func_196(&uLocal_265))
						{
							if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0) && !unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
								unk_0xEDB03CCB50D11479(uParam0->f_28[0], unk_0xC1A5EC5C986B98AD(), -1, 0, 4);
				...
				case 2:
					if (func_196(&uLocal_265))
					{
						if (func_190(&uLocal_265) > unk_0xD88C7A93096DA0F7(9f, 15f))
						{
							...
							switch (iLocal_268)
							{
								case 1:
									if (*uParam0 == 58)
									{
										_CONVERSATION_ADD_LINE(&uLocal_100, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
									
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_4@franklin_4a", "whats_wrong_with_you_0", 2f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_4@franklin_4b", "whats_wrong_with_you_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_4@franklin_4c", "whats_wrong_with_you_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
											unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uLocal_96);
											unk_0x63EF69C6969A3D26(&uLocal_96);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_4@franklin_4a", "whats_wrong_with_you_0", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_4@franklin_4b", "whats_wrong_with_you_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_4@franklin_4c", "whats_wrong_with_you_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
								...
								case 2:
									if (*uParam0 == 58)
									{
										_CONVERSATION_ADD_LINE(&uLocal_100, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
									
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_1@franklin_1a", "seriously_franklin_get_your_fat_0", 2f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_1@franklin_1b", "seriously_franklin_get_your_fat_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_1@franklin_1c", "seriously_franklin_get_your_fat_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
											unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uLocal_96);
											unk_0x63EF69C6969A3D26(&uLocal_96);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_1@franklin_1a", "seriously_franklin_get_your_fat_0", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_1@franklin_1b", "seriously_franklin_get_your_fat_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_1@franklin_1c", "seriously_franklin_get_your_fat_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
								...
								case 3:
									if (*uParam0 == 58)
									{
										_CONVERSATION_ADD_LINE(&uLocal_100, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
									
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_3@franklin_3a", "dont_be_actin_like_you_dont_know_me_0", 2f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_3@franklin_3b", "dont_be_actin_like_you_dont_know_me_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
											unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uLocal_96);
											unk_0x63EF69C6969A3D26(&uLocal_96);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_3@franklin_3a", "dont_be_actin_like_you_dont_know_me_0", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_3@franklin_3b", "dont_be_actin_like_you_dont_know_me_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
											unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uLocal_96);
								...
								case 4:
									if (*uParam0 == 58)
									{
										_CONVERSATION_ADD_LINE(&uLocal_100, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
									
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_2@franklin_2a", "seriously_franklin_im_tonya_0", 2f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_2@franklin_2b", "seriously_franklin_im_tonya_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_2@franklin_2c", "seriously_franklin_im_tonya_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
											unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uLocal_96);
											unk_0x63EF69C6969A3D26(&uLocal_96);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!unk_0x055111B11E6624FD(uParam0->f_28[0], 0))
										{
											unk_0x63EF69C6969A3D26(&uLocal_96);
											unk_0xDBC7406226B5540E(&uLocal_96);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_2@franklin_2a", "seriously_franklin_im_tonya_0", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_2@franklin_2b", "seriously_franklin_im_tonya_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@franklin_2@franklin_2c", "seriously_franklin_im_tonya_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
											unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0, 0, 0, 0);
											unk_0xF2CFC6EC8C85FA78(uLocal_96);
...
float func_190(var uParam0) // Position - 0xDB27
{
	if (func_196(uParam0))
		if (func_192(uParam0))
			return uParam0->f_2;
...
BOOL func_192(var uParam0) // Position - 0xDBBB
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_193(var uParam0) // Position - 0xDBC8
{
	func_194(uParam0, 0f);
	return;
}

void func_194(var uParam0, float fParam1) // Position - 0xDBD7
{
...
void func_195(var uParam0) // Position - 0xDC02
{
	if (!func_196(uParam0))
		func_193(uParam0);
...
BOOL func_196(var uParam0) // Position - 0xDC1A
{
...
int func_197(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0xDC27
{
	...
	Global_2883585 = 0;
	return func_198(sParam2, iParam4, false);
}
...
BOOL func_202(int iParam0, int iParam1) // Position - 0xDFF3
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xE16B
{
	if (func_57(14))
	{
		if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0))
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE2BB
{
	...
	Global_22722 = 0;
	Global_2883585 = 0;
	return func_198(sParam2, iParam3, false);
}

void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE309
{
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE3A4
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_215(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_214(uParam0, 1);
			}
			else
			{
				...
				if (func_215(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_217(uParam0);
			}
		}
	}
...
void func_214(var uParam0, int iParam1) // Position - 0xE50A
{
	BOOL flag;
	int i;
...
float func_215(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xE5A8
{
	var unk;
...
void func_217(var uParam0) // Position - 0xE5EE
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_218(uParam0);
...
void func_218(var uParam0) // Position - 0xE605
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE715
{
	var unk;
	...
	if (func_257(*panParam0) || func_255(*panParam0) || Global_78804 == 1)
		return true;
...
void func_221(int iParam0, var uParam1, int iParam2) // Position - 0xE985
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_223(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_222(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_223(uParam1) && uParam1->f_4 == 0 && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_222(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_222(int iParam0) // Position - 0xECDD
{
...
BOOL func_223(var uParam0) // Position - 0xECFD
{
...
BOOL func_224(var uParam0) // Position - 0xED15
{
...
void func_226(var uParam0) // Position - 0xF03E
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF0E9
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_229(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_229(var uParam0, var uParam1) // Position - 0xF2A7
{
	var unk;
...
BOOL func_230(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF2D7
{
	int i;
	int num;
...
BOOL func_231(int iParam0) // Position - 0xF593
{
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xF5C7
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_243(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_233(var uParam0, int iParam1) // Position - 0xF63D
{
	return func_234(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_234(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF655
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_235(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_235(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF716
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_236(var uParam0, int iParam1) // Position - 0xF842
{
	int num;
...
BOOL func_238(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF951
{
	var unk;
	var unk4;
	float num;

	unk = { func_240(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_240(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };
...
float func_239(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF9E2
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_240(float fParam0, var uParam1, var uParam2) // Position - 0xFA03
{
	float num;
	float num2;
...
int func_242(var uParam0, var uParam1) // Position - 0xFA5D
{
	int i;
...
int func_243(var uParam0) // Position - 0xFA9C
{
...
BOOL func_244(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFAC4
{
	float num;
	float num2;
	int num3;
...
BOOL func_245(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFBBF
{
	float num;
	float num2;
...
BOOL func_246(var uParam0, float fParam1) // Position - 0xFCCB
{
	var unk;
	var unk2;
...
BOOL func_247(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFD60
{
	var unk;
	var unk4;
	float num;

	unk = { func_240(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_248(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFDEE
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_249(int iParam0) // Position - 0xFE36
{
...
void func_250(var uParam0) // Position - 0xFE80
{
	var unk;
...
BOOL func_251(int iParam0) // Position - 0xFF1D
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_252(int iParam0) // Position - 0xFFB2
{
...
BOOL func_254() // Position - 0x10011
{
	if (Global_97603 != -1)
...
BOOL func_255(int iParam0) // Position - 0x10034
{
...
BOOL func_256() // Position - 0x10068
{
...
BOOL func_257(int iParam0) // Position - 0x100A6
{
...
BOOL func_258(var uParam0) // Position - 0x100CE
{
	if (!func_259(uParam0))
		return false;

	uLocal_95 = unk_0x54ECDA2DAB9CFB10(uLocal_92 - { 10f, 10f, 10f }, uLocal_92 + { 10f, 10f, 10f }, 0, 1, 1, 1);
	bLocal_97 = true;
	func_289("Created initial scene");
	return true;
}

BOOL func_259(var uParam0) // Position - 0x10122
{
	BOOL flag;
	var unk;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x852EC2A7DE66202D(joaat("IG_Tonya"));
			unk_0x28818732C8F0F80E("special_ped@tonya@intro");
			unk_0x28818732C8F0F80E("special_ped@tonya@base");
			unk_0x28818732C8F0F80E("special_ped@tonya@franklin_5@franklin_5a");
			unk_0x28818732C8F0F80E("special_ped@tonya@franklin_5@franklin_5b");
			unk_0x28818732C8F0F80E("special_ped@tonya@franklin_5@franklin_5c");
			iLocal_91 = 1;
			break;
	
		case 1:
			if (!unk_0x0CBB7C273DED26E7(joaat("IG_Tonya")) || !unk_0x2BBF749E555360DC("special_ped@tonya@intro") || !unk_0x2BBF749E555360DC("special_ped@tonya@base") || !unk_0x2BBF749E555360DC("special_ped@tonya@franklin_5@franklin_5a") || !unk_0x2BBF749E555360DC("special_ped@tonya@franklin_5@franklin_5b") || !unk_0x2BBF749E555360DC("special_ped@tonya@franklin_5@franklin_5c"))
				return false;
		...
		case 2:
			...
			{
				uParam0->f_28[0] = unk_0x69FDD9508259E5B5(5, joaat("IG_Tonya"), -16.53f, -1473.12f, 29.61f, 319.56f, 1, 1);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
				{
					unk_0xC5B2830898581862(uParam0->f_28[0], 1);
					unk_0x351E6B9FD37CFF33(uParam0->f_28[0], 1, 1);
					unk_0x60738E55FFF41FB8(joaat("IG_Tonya"), 1);
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
			{
				unk_0x63EF69C6969A3D26(&unk);
				unk_0xDBC7406226B5540E(&unk);
				unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@intro", "idle_intro", 4f, -4f, -1, 262144, 0, 0, 0, 0);
				unk_0x3EE48ADC8C7F5CC4(0, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0, 0, 0, 0);
				unk_0x06A2A5F6A6959BE7(0, unk_0xC1A5EC5C986B98AD(), -1);
				unk_0xF2CFC6EC8C85FA78(unk);
				unk_0x3D7110D966B0CEA2(uParam0->f_28[0], unk);
				unk_0x63EF69C6969A3D26(&unk);
				unk_0xEDB03CCB50D11479(uParam0->f_28[0], unk_0xC1A5EC5C986B98AD(), -1, 0, 4);
			}
		
			unk_0x2117C3CCFF2D957A(-16.53f, -1473.12f, 29.61f, 1f, 0);
			unk_0xE0A291F406691F03(joaat("IG_Tonya"));
			return true;
	}
...
BOOL func_260(int iParam0) // Position - 0x103D8
{
	int i;
...
BOOL func_261(int iParam0) // Position - 0x10440
{
	var unk;
	eCharacter character;
...
BOOL func_262(int iParam0) // Position - 0x10491
{
	var unk;
...
BOOL func_263(int iParam0) // Position - 0x1054A
{
	var unk;
...
BOOL func_264(int iParam0) // Position - 0x1060B
{
	int i;
	var unk;
	int num;
...
BOOL func_266(int iParam0) // Position - 0x10772
{
...
BOOL func_267(int iParam0) // Position - 0x1079D
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_268(int iParam0) // Position - 0x107C8
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_269(int iParam0) // Position - 0x107F3
{
	if (func_252(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_270(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10828
{
	int i;
...
BOOL func_271(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x1088D
{
	int num;
	char* str;
...
BOOL func_272(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10905
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_273(var uParam0, BOOL bParam1) // Position - 0x10980
{
	func_286();
	...
	unk_0x0B34FA69ECCE3927("special_ped@tonya@intro");
	unk_0x0B34FA69ECCE3927("special_ped@tonya@base");

	if (bLocal_98)
	{
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_1@franklin_1a");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_1@franklin_1b");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_1@franklin_1c");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_2@franklin_2a");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_2@franklin_2b");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_2@franklin_2c");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_3@franklin_3a");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_3@franklin_3b");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_4@franklin_4a");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_4@franklin_4b");
		unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_4@franklin_4c");
	}

	unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_5@franklin_5a");
	unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_5@franklin_5b");
	unk_0x0B34FA69ECCE3927("special_ped@tonya@franklin_5@franklin_5c");
...
void func_277(var uParam0, BOOL bParam1) // Position - 0x10AC4
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_280(var uParam0) // Position - 0x10B4E
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_281(var uParam0) // Position - 0x10B86
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_283(var uParam0, int iParam1) // Position - 0x10C34
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_284(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_284(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10C75
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_285(var uParam0) // Position - 0x10CC5
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
void func_288(int iParam0) // Position - 0x10D37
{
	if (*iParam0 == -1)
		return;
