...
void main() // Position - 0x0
{
	...
	if (!func_275(&unk61, &num, uLocal_90, 1f))
	{
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1) || func_266(num))
			func_278(&num, true);
		...
		func_224(num);
		func_216(&iLocal_267, &(num.f_9), uLocal_90);
		func_194(&num);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4887
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5538
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5573
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57E7
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D72
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6535
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x657C
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65E7
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x69FA
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A0A
{
	int i;
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x754B
{
...
BOOL func_85(Player plParam0) // Position - 0x7577
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7679
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x770E
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x83AD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x842F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_97(Player plParam0) // Position - 0x870C
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8729
{
...
int func_106(int iParam0) // Position - 0x8C72
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C94
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8CAB
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D69
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DDB
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DF1
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E07
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E49
{
...
BOOL func_122(Any* panParam0) // Position - 0xA8DC
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA7A
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAB56
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAC4F
{
...
int func_134(Ped pedParam0) // Position - 0xACB6
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xACFF
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAD1F
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAD40
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAE10
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE63
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAF58
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB002
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB169
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB203
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB225
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB272
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB2EF
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB393
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB422
{
...
void func_160(Vehicle veParam0) // Position - 0xB5BA
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB776
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB7DC
{
...
BOOL func_169(int iParam0) // Position - 0xB81D
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB894
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB9CB
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA1A
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBA2B
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBC0C
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBC3F
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC88
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0xBCAC
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_181(var uParam0) // Position - 0xC4AC
{
	float num;
...
void func_182(int iParam0, var uParam1) // Position - 0xC53A
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_183(BOOL bParam0) // Position - 0xC59E
{
...
BOOL func_184(Vehicle veParam0) // Position - 0xC635
{
...
BOOL func_185(int iParam0) // Position - 0xC65F
{
	eCharacter character;
...
BOOL func_186() // Position - 0xCD7C
{
	return Global_100872.f_1;
}

BOOL func_187() // Position - 0xCD8A
{
	if (Global_97735 != -1)
...
BOOL func_192() // Position - 0xCE3A
{
	return Global_1575063;
}

BOOL func_193() // Position - 0xCE46
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		...
		if (num < 20f * 20f && bLocal_96)
		{
			switch (iLocal_97)
			{
				...
				case 2:
					if (func_201(&uLocal_263))
					{
						if (func_195(&uLocal_263) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
...
float func_195(int* piParam0) // Position - 0xDC13
{
	if (func_201(piParam0))
		if (func_197(piParam0))
			return piParam0->f_2;
		else
			return func_196(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;
...
BOOL func_197(int* piParam0) // Position - 0xDCA7
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_198(int* piParam0) // Position - 0xDCB4
{
	func_199(piParam0, 0f);
	return;
}

void func_199(int* piParam0, float fParam1) // Position - 0xDCC3
{
	piParam0->f_1 = func_196(IS_BIT_SET(*piParam0, 4)) - fParam1;
...
void func_200(int* piParam0) // Position - 0xDCEE
{
	if (!func_201(piParam0))
		func_198(piParam0);
...
BOOL func_201(int* piParam0) // Position - 0xDD06
{
...
BOOL func_206(Player plParam0) // Position - 0xE0CF
{
	return func_207(plParam0, 20);
}

BOOL func_207(Player plParam0, int iParam1) // Position - 0xE0DF
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xE257
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE3A7
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE3F5
{
...
void func_216(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE490
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_220(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_219(uParam0, 1);
			}
			else
			{
				...
				if (func_220(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_222(uParam0);
			}
		}
	}
...
void func_219(var uParam0, int iParam1) // Position - 0xE5F6
{
	BOOL flag;
	int i;
...
float func_220(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xE694
{
...
void func_222(var uParam0) // Position - 0xE6DA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_223(uParam0);
...
void func_223(var uParam0) // Position - 0xE6F1
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE801
{
	var unk;
	...
	if (func_262(*panParam0) || func_260(*panParam0) || Global_78935 == 1)
		return true;
...
void func_226(Ped pedParam0, var uParam1, int iParam2) // Position - 0xEA71
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_227(int iParam0) // Position - 0xEDC9
{
...
BOOL func_228(var uParam0) // Position - 0xEDE9
{
...
BOOL func_229(var uParam0) // Position - 0xEE01
{
...
void func_231(Object* pobParam0) // Position - 0xF12A
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF1D5
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_234(Ped pedParam0, Vehicle veParam1) // Position - 0xF393
{
...
BOOL func_235(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF3C3
{
	int i;
	int num;
...
BOOL func_236(int iParam0) // Position - 0xF67F
{
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xF6B3
{
	float xSize;
...
BOOL func_238(Ped pedParam0, int iParam1) // Position - 0xF729
{
	return func_239(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_239(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF741
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_240(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF802
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_241(Ped pedParam0, int iParam1) // Position - 0xF92E
{
...
BOOL func_243(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xFA3D
{
	var unk;
...
float func_244(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xFACE
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0xFAEF
{
	float num;
	float num2;
...
int func_247(Ped pedParam0, Ped pedParam1) // Position - 0xFB49
{
	int i;
...
BOOL func_248(Ped pedParam0) // Position - 0xFB88
{
...
BOOL func_249(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFBB0
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_250(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFCAB
{
	float entityCoords;
	float num;
...
BOOL func_251(Ped pedParam0, float fParam1) // Position - 0xFDB7
{
	var outProjectile;
	var outCoords;
...
BOOL func_252(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFE4C
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_253(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFEDA
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_254(int iParam0) // Position - 0xFF22
{
...
void func_255(Vehicle veParam0) // Position - 0xFF6C
{
	int taskSequenceId;
...
BOOL func_256(int iParam0) // Position - 0x1000D
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_257(int iParam0) // Position - 0x100A2
{
...
BOOL func_258() // Position - 0x100E1
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_259() // Position - 0x100FE
{
	if (Global_97735 != -1)
...
BOOL func_260(int iParam0) // Position - 0x10121
{
...
BOOL func_261() // Position - 0x10155
{
...
BOOL func_262(int iParam0) // Position - 0x10193
{
...
BOOL func_263(var uParam0) // Position - 0x101BB
{
	if (!func_264(uParam0))
		return false;

	iLocal_93 = PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_90 - { 10f, 10f, 10f }, uLocal_90 + { 10f, 10f, 10f }, false, true, true, true);
	bLocal_95 = true;
	func_294("Created initial scene");
	return true;
}

BOOL func_264(var uParam0) // Position - 0x1020F
{
	BOOL flag;
	int taskSequenceId;
...
BOOL func_265(int iParam0) // Position - 0x104C5
{
	int i;
...
BOOL func_266(int iParam0) // Position - 0x1052D
{
	var unk;
	eCharacter character;
...
BOOL func_267(int iParam0) // Position - 0x1057E
{
	const char* string2;
...
BOOL func_268(int iParam0) // Position - 0x10637
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0x106F8
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_271(int iParam0) // Position - 0x1085F
{
...
BOOL func_272(int iParam0) // Position - 0x1088A
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_273(int iParam0) // Position - 0x108B5
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x108E0
{
	if (func_257(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_275(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10915
{
	int i;
...
BOOL func_276(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x1097A
{
	int num;
	char* str;
...
BOOL func_277(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x109F2
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_278(var uParam0, BOOL bParam1) // Position - 0x10A6D
{
	func_291();
...
void func_282(Object* pobParam0, BOOL bParam1) // Position - 0x10BB1
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_285(Vehicle* pveParam0) // Position - 0x10C3B
{
...
void func_286(Vehicle* pveParam0) // Position - 0x10C73
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_288(var uParam0, int iParam1) // Position - 0x10D21
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_289(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_289(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10D62
{
...
void func_290(Ped* ppedParam0) // Position - 0x10DB2
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_293(int iParam0) // Position - 0x10E24
{
	if (*iParam0 == -1)
		return;
