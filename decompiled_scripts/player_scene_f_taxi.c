...
BOOL func_2() // Position - 0x11B
{
	...
	if (!func_3(&unk))
	{
		vector = { unk_0x30BE8A934C020461(uLocal_72, 0) };
		num = SYSTEM::VDIST2(uLocal_176 + uLocal_181, vector);
	
		if (num < 4.5f * 4.5f)
		{
			unk_0xA6B22576A5268171(uLocal_72, uLocal_74, uLocal_179, 786599);
			return true;
		}
	}
...
BOOL func_3(var uParam0) // Position - 0x16F
{
	...
	if (unk_0xFBD273FDBCF0C5BD(uLocal_74, 0))
	{
	}
	else
	{
...
BOOL func_4() // Position - 0x1B6
{
	...
	if (!func_3(&unk))
	{
		...
		else if (unk_0x411B750250543BD0(Global_98011))
		{
			...
			if (!func_5(Global_100402, uLocal_74, 2))
				if (num >= 0.9f)
					unk_0x4C18E9202CF6CACA(Global_100402, uLocal_74, 2);
		
			if (!bLocal_180)
			{
				unk_0x2718E9CC165A99F6(uLocal_72, 0);
				bLocal_180 = true;
			}
		
			unk_0xCFAA9546D1402590(uLocal_72, uLocal_74, 6, 50);
		}
		else
		{
			if (!func_5(Global_100402, uLocal_74, 2))
			...
			unk_0xFB58581C53CF4C05(uLocal_74, -8f, 1);
			SYSTEM::WAIT(100);
		
			if (!func_3(&unk))
			{
				unk_0xDBC7406226B5540E(&unk2);
				unk_0xCFAA9546D1402590(0, uLocal_74, 24, 50);
				unk_0xA3CD3591C0B0EE9A(0, 2000);
				unk_0xC562419B5DA3BB96(0, uLocal_74, uLocal_176 + uLocal_181, uLocal_179, 0, uLocal_75, 786599, (4.5f / 2f) - 1f, 10f);
				unk_0xF2CFC6EC8C85FA78(unk2);
				unk_0x3D7110D966B0CEA2(uLocal_72, unk2);
...
BOOL func_5(int iParam0, var uParam1, int iParam2) // Position - 0x2C5
{
	if (!unk_0x055111B11E6624FD(iParam0, 0) && !unk_0x055111B11E6624FD(uParam1, 0))
		if (unk_0x44A6C9475C859B45(iParam0, uParam1))
			if (unk_0xA66E176E5772E965(uParam1, iParam2, 0) == iParam0)
				return true;
...
void func_12() // Position - 0x4B0
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_13(character) && !func_17(14) || Global_112599)
			{
...
void func_22() // Position - 0x6A5
{
	...
	unk_0x9C56520AE72AFDBF(iLocal_73, 1);
	uLocal_74 = unk_0xC9B41DD2C91B7017(uLocal_181 + uLocal_173, 15f, uLocal_75, 2);
	num = 0;

	while (!unk_0x7DE17ACDD8BA2642(Global_100402) || !unk_0x7DE17ACDD8BA2642(uLocal_74) || !unk_0x0CBB7C273DED26E7(iLocal_73) && num < 400)
	{
		if (!unk_0x7DE17ACDD8BA2642(uLocal_74))
			uLocal_74 = unk_0xC9B41DD2C91B7017(uLocal_181 + uLocal_173, 15f, uLocal_75, 2);
	...
	{
		unk_0x8386356641D0DED1(Global_100402, Global_95685);
		unk_0xEE72EF85581D1171(Global_100402, "A_F_Y_BevHills_01_White_FULL_01");
	}

	if (!unk_0x055111B11E6624FD(uLocal_74, 0))
	{
		unk_0xC8EE2E23B410B65A(uLocal_74, 1, 1, 0);
		unk_0x439314AD4FC79186(uLocal_74, 2);
		unk_0xCB8DD5B44DBC2DEB(uLocal_74, 1084227584);
		uLocal_72 = unk_0x4FA078B1B32445FD(uLocal_74, 4, iLocal_73, -1, 1, 1);
		unk_0x90FF6DBE9D84E401(uLocal_72, 0);
		unk_0xE0A291F406691F03(iLocal_73);
	}
...
void func_23() // Position - 0x7A1
{
	...
	func_44(iLocal_70, &uLocal_181, &uLocal_184, &unk);
	iLocal_73 = joaat("A_M_M_EastSA_02");
	func_29(1, iLocal_70, &uLocal_75, &uLocal_173, &unk9, &uLocal_176, &uLocal_179);
	num.f_1 = -1;
	num.f_17 = 4;
	num.f_17.f_8 = 4;
	num.f_17.f_13 = 4;
	...
	func_26(num, &unk118);
	func_24(iLocal_70, &uLocal_185, &uLocal_201, &uLocal_201, &unk238, &unk239);
	return;
}
	...
	switch (uParam0.f_2)
	{
		...
		case 155:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_27(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), unk_0xD88C7A93096DA0F7(-5f, 5f), unk_0xD88C7A93096DA0F7(-5f, 5f), 0f, unk_0xD88C7A93096DA0F7(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
		...
		case 158:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_27(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), unk_0xD88C7A93096DA0F7(-5f, 5f), unk_0xD88C7A93096DA0F7(-5f, 5f), 0f, unk_0xD88C7A93096DA0F7(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
	...
	switch (uParam0.f_2)
	{
		...
		case 196:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_27(uParam109, 43, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), unk_0xD88C7A93096DA0F7(-5f, 5f), unk_0xD88C7A93096DA0F7(-5f, 5f), 0f, unk_0xD88C7A93096DA0F7(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
...
int func_31(int iParam0, var uParam1, int iParam2) // Position - 0x7A5F
{
	...
	if (!func_32(Global_100085[iParam0 /*98*/], false, -1))
	{
		func_30(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
BOOL func_32(int iParam0, BOOL bParam1, int iParam2) // Position - 0x7C97
{
	...
	{
		if (func_37() || unk_0xCC17806DB0C41C19() || func_36())
		{
		}
		else if (!func_39())
		{
...
BOOL func_33(int iParam0) // Position - 0x7E19
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x7EE5
{
...
BOOL func_35(int iParam0, int iParam1) // Position - 0x7EFC
{
	BOOL num;
	var unk;
...
BOOL func_38() // Position - 0xB559
{
	return false;
}

BOOL func_39() // Position - 0xB562
{
	return true;
}

BOOL func_40() // Position - 0xB56B
{
	return true;
}

BOOL func_41() // Position - 0xB574
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xB58D
{
	var unk;
...
BOOL func_43(int iParam0) // Position - 0xB645
{
...
BOOL func_46(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xBB78
{
	if (bParam6)
...
BOOL func_47(int iParam0, var uParam1, char* sParam2) // Position - 0xBBBF
{
	var unk;
	int num;
	var unk4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_51(Global_113648.f_2365.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_51(Global_113648.f_2365.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_51(Global_113648.f_2365.f_539.f_2314[2]), 32);
			return true;
...
BOOL func_48(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xE1C3
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x10112
{
...
BOOL func_50(int iParam0, var uParam1, var uParam2) // Position - 0x10130
{
	switch (iParam0)
	{
		case 11:
...
{
	if (!unk_0x055111B11E6624FD(uLocal_72, 0) && unk_0xAE770DDB34967EC3(uLocal_72, 1))
		unk_0x1EEF71E3CDD868D3(&uLocal_72);

	if (!unk_0x055111B11E6624FD(uLocal_74, 0) && unk_0xAE770DDB34967EC3(uLocal_74, 1))
		unk_0x0E4B6CF706BE8AA4(&uLocal_74);

	unk_0x9C56520AE72AFDBF(iLocal_73, 0);
	unk_0xE0A291F406691F03(iLocal_73);
