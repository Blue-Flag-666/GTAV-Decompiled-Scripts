	...
	switch (iLocal_155)
	{
		...
		case 1:
			...
			if (!func_439(iLocal_156))
			{
				...
				if (!BitTest(Global_112922.f_18574.f_382, 0))
				{
					MISC::SET_BIT(&(Global_112922.f_18574.f_382), 0);
				}
				func_297(4);
			}
			else if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_156) > 250f)
			{
...
void func_249()
{
	if (!bLocal_507)
	{
		if (func_261(PLAYER::PLAYER_PED_ID(), iLocal_156, fLocal_334, 1))
		{
...
void func_250(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!iLocal_537)
		{
			if (!*iParam0)
			{
				if ((func_251(iLocal_156) && !PED::IS_PED_RAGDOLL(iLocal_156)) && !TASK::IS_PED_IN_WRITHE(iLocal_156))
				{
					if (func_261(PLAYER::PLAYER_PED_ID(), iLocal_156, fLocal_334, 1))
					{
						if (!func_244())
...
bool func_261(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if ((MISC::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (HUD::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_264(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((MISC::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_264(sParam2, 0, 0))
					{
...
bool func_264(char* sParam0, int iParam1, char* sParam2)
{
...
int func_275(int iParam0)
{
	if (iParam0 != func_233())
	{
		...
		else if ((Global_1575054 && iParam0 == PLAYER::PLAYER_ID()) && func_276(iParam0, 1, 0))
		{
			return Global_2689224[iParam0 /*451*/].f_317.f_6 != -1;
		}
	}
	...
	switch (iLocal_155)
	{
		...
		case 1:
			...
			else
			{
				...
				func_252(0);
				func_265(&uLocal_549, iLocal_156, 0, 0, 1, 1, 1);
				if (((!iLocal_332 && func_261(PLAYER::PLAYER_PED_ID(), iLocal_156, 10f, 1)) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_156))
				{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			...
			else
			{
				...
				if (!func_310())
				{
					if (!func_306() && !func_309(242628503))
					{
						func_301();
					}
				}
				if ((func_309(242628503) && TASK::GET_SEQUENCE_PROGRESS(iLocal_156) > 0) && func_305())
				{
					func_297(3);
				}
			}
...
int func_311(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_258(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
void func_314(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_318()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (((CAM::IS_SCREEN_FADED_IN() && !func_449()) && func_439(iLocal_156)) && func_296(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) > 4f)
			{
			...
			switch (iLocal_562)
			{
				...
				case 3:
					...
					else
					{
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_439(iLocal_156))
						{
...
void func_320(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_326(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_324(PLAYER::PLAYER_ID())) && !func_322(PLAYER::PLAYER_ID(), 0)) && !func_321()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_324(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_77856 = 0;
...
int func_326(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_328(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_329(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_332(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_366(iParam5, &Var0, Param1, fParam4, func_369(iParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_350(iParam0, 0, 0)) || func_350(iParam0, 1, 0)) || func_350(iParam0, 2, 0)) || func_369(iParam0) != 145) || func_349(iParam0)) || func_348(iParam0)) || func_347(iParam0)) || func_346(iParam0)) || !func_336(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_348(iParam0))
		{
		}
...
void func_366(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_363(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
...
int func_389(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_393(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_393(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_395()
{
	...
	if (iLocal_564 == 0)
	{
		if (func_439(iLocal_156))
		{
			if (func_296(PLAYER::PLAYER_PED_ID(), iLocal_156, 1) < 3f)
			{
				iLocal_564 = 1;
...
void func_397()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_393(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10,5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_418(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_283(0)) || func_417(1))
			{
			}
			else
			{
...
void func_421(int iParam0)
{
	...
	if (!func_432())
	{
		...
		func_431(PLAYER::PLAYER_PED_ID(), -1462,177f, 485,6856f, 115,2016f, 97,1913f, 0, 1);
	}
	func_2(&iLocal_161);
	func_4(&iLocal_156);
	func_2(&(Local_86.f_35[0]));
	...
	if (!func_432())
	{
		func_424(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 100f, 12, 5000, 0, 0);
	}
	func_423(0, -1, 1);
	if (iParam0 == 1)
	{
...
int func_431(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_438()
{
	...
	func_434();
	MISC::CLEAR_BIT(&(Global_112922.f_18574.f_382), 0);
	HUD::REQUEST_ADDITIONAL_TEXT("DREY1", 0);
	func_428(&uLocal_165, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_427();
	func_426();
}
...
void func_443(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_2(iParam0);
...
{
	if (func_429(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
