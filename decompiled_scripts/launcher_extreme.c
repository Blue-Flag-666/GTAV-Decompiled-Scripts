...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_294(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	if (num == 17)
	{
		iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(vector - { 40f, 40f, 40f }, vector + { 40f, 40f, 40f }, false, true, true, true);
	...
	while (true)
	{
		...
		func_214(num);
		func_207(&iLocal_92, &(num.f_9), vector);
	
		if (num == 18)
		{
			func_206(&num);
			func_201(&num, vector, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (num == 19)
		{
			func_206(&num);
			...
			if (AUDIO::HAS_SOUND_FINISHED(iLocal_94))
				func_201(&num, vector, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
		...
		if (func_183(&num, 0) || func_181(&num))
		{
			if (func_180(num))
				func_177(num, &blLocal_96);
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3A76
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x3A8B
{
	int num;
	int num2;
...
BOOL func_53(int iParam0, int iParam1) // Position - 0x3ACB
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3AEF
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3B04
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x404D
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x428E
{
	func_58();
...
void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x43B2
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x44A5
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x472D
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x47CE
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x49AE
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x565F
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x569A
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x590E
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E99
{
...
BOOL func_77(int iParam0) // Position - 0x6B21
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B31
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7648
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7672
{
...
BOOL func_85(Player plParam0) // Position - 0x769E
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77A0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7835
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x84D5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8557
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_97(Player plParam0) // Position - 0x8834
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8851
{
...
int func_106(int iParam0) // Position - 0x8D9A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DBC
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8DD3
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E91
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F19
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F2F
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F71
{
...
BOOL func_122(Any* panParam0) // Position - 0xAA04
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xABA2
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAC7E
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD77
{
...
int func_134(Ped pedParam0) // Position - 0xADDE
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAE27
{
...
BOOL func_136(int iParam0) // Position - 0xAE47
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAF17
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF6A
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xB05F
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB109
{
	if (bParam0)
	{
...
BOOL func_144(Player plParam0, int iParam1) // Position - 0xB270
{
	BOOL flag;
...
BOOL func_146(Player plParam0) // Position - 0xB30A
{
	Player player;
...
BOOL func_147(Player plParam0) // Position - 0xB32C
{
...
int func_149(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB379
{
	int num;
...
BOOL func_152(const char* sParam0) // Position - 0xB3F6
{
...
BOOL func_157(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB507
{
...
void func_158(Vehicle veParam0) // Position - 0xB69F
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_164(int iParam0) // Position - 0xB85B
{
	if (iParam0 == 1)
...
BOOL func_166(int iParam0) // Position - 0xB8C1
{
...
BOOL func_167(int iParam0) // Position - 0xB902
{
	int num;
	...
	num = func_169(&(Global_112897[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
int func_169(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB979
{
	int i;
...
void func_170(int iParam0, int iParam1) // Position - 0xBAB0
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAFF
{
	return func_172(iParam0, Global_43377);
}

BOOL func_172(int iParam0, int iParam1) // Position - 0xBB10
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_173(int iParam0) // Position - 0xBCF1
{
	if (Global_43377 == 15)
		return false;
...
int func_175(const char* sParam0, int iParam1) // Position - 0xBD24
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD6D
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_177(int iParam0, var uParam1) // Position - 0xBD91
{
	switch (iParam0)
	{
		case 0:
...
Blip func_178(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC202
{
	Blip blip;
...
var func_179(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC22E
{
	if (bParam0)
		return uParam1;
...
BOOL func_180(int iParam0) // Position - 0xC245
{
	switch (iParam0)
	{
		case 0:
...
int func_181(var uParam0) // Position - 0xC2D4
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, false, true, 0))
		{
			...
			else if (!func_182(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_157(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_182(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC37B
{
...
BOOL func_185(var uParam0) // Position - 0xCBAC
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCC3A
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_187(BOOL bParam0) // Position - 0xCC9E
{
...
BOOL func_188(Vehicle veParam0) // Position - 0xCD35
{
...
BOOL func_189(int iParam0) // Position - 0xCD5F
{
	eCharacter character;
...
BOOL func_190() // Position - 0xD47C
{
	return Global_100872.f_1;
}

BOOL func_191() // Position - 0xD48A
{
	if (Global_97735 != -1)
...
BOOL func_195(int iParam0, int iParam1) // Position - 0xD502
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Position - 0xD53A
{
	return Global_1575063;
}

BOOL func_197() // Position - 0xD546
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0xD562
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xD579
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xD59A
{
...
int func_201(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD5BC
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD644
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD6D5
{
...
float func_205(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD770
{
...
void func_206(var uParam0) // Position - 0xD7AA
{
...
void func_207(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD7D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_210(var uParam0, int iParam1) // Position - 0xD93D
{
	BOOL flag;
	int i;
...
void func_212(var uParam0) // Position - 0xD9E7
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_213(uParam0);
...
void func_213(var uParam0) // Position - 0xD9FE
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDB0E
{
	var unk;
	...
	if (func_252(*panParam0) || func_250(*panParam0) || Global_78935 == 1)
		return true;
...
void func_216(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDD7E
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_217(int iParam0) // Position - 0xE0D6
{
...
BOOL func_218(var uParam0) // Position - 0xE0F6
{
...
BOOL func_219(var uParam0) // Position - 0xE10E
{
...
void func_221(Object* pobParam0) // Position - 0xE437
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE4E2
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_224(Ped pedParam0, Vehicle veParam1) // Position - 0xE6A0
{
...
BOOL func_225(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE6D0
{
	int i;
	int num;
...
BOOL func_226(int iParam0) // Position - 0xE98C
{
...
BOOL func_227(Ped pedParam0, int iParam1) // Position - 0xE9C0
{
	float xSize;
...
BOOL func_228(Ped pedParam0, int iParam1) // Position - 0xEA36
{
	return func_229(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_229(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA4E
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_230(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEB0F
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_231(Ped pedParam0, int iParam1) // Position - 0xEC3B
{
...
BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xED4A
{
	var unk;
...
float func_234(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEDDB
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_235(float fParam0, var uParam1, var uParam2) // Position - 0xEDFC
{
	float num;
	float num2;
...
int func_237(Ped pedParam0, Ped pedParam1) // Position - 0xEE56
{
	int i;
...
BOOL func_238(Ped pedParam0) // Position - 0xEE95
{
...
BOOL func_239(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEEBD
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_240(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEFB8
{
	float entityCoords;
	float num;
...
BOOL func_241(Ped pedParam0, float fParam1) // Position - 0xF0C4
{
	var outProjectile;
	var outCoords;
...
BOOL func_242(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF159
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_243(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF1E7
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_244(int iParam0) // Position - 0xF22F
{
...
void func_245(Vehicle veParam0) // Position - 0xF279
{
	int taskSequenceId;
...
BOOL func_246(int iParam0) // Position - 0xF316
{
	if (iParam0 == -1)
		iParam0 = func_174();
...
BOOL func_247(int iParam0) // Position - 0xF3AB
{
...
BOOL func_250(int iParam0) // Position - 0xF42A
{
...
BOOL func_252(int iParam0) // Position - 0xF49C
{
...
BOOL func_253(var uParam0) // Position - 0xF4C4
{
	switch (*uParam0)
	{
		case 17:
...
BOOL func_254(var uParam0) // Position - 0xF539
{
	int num;
	int i;
...
void func_255(Ped* ppedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xF63D
{
	func_256(ppedParam0, hLocal_91, fParam1, fParam4, PED_TYPE_MISSION);
...
void func_256(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0xF66F
{
	func_257(ppedParam0);
...
void func_257(Ped* ppedParam0) // Position - 0xF690
{
...
BOOL func_258(var uParam0) // Position - 0xF6D1
{
	if (func_219(uParam0))
	{
...
BOOL func_259(var uParam0) // Position - 0xF6FB
{
	int i;
...
BOOL func_261(var uParam0) // Position - 0xF768
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				if (func_262(&uParam0->f_28[0], CHAR_DOM, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
...
BOOL func_262(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF8FB
{
...
BOOL func_263(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF957
{
	Hash model;
...
int func_264(var uParam0, eCharacter echParam1) // Position - 0xF9E5
{
	int num;
...
BOOL func_265(var uParam0) // Position - 0xFA2B
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_262(&uParam0->f_28[0], CHAR_DOM, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_266(&uParam0->f_35[0], num[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_266(&uParam0->f_35[1], num[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_266(&uParam0->f_35[2], num[1], -957.23f, -2764.89f, 14.04f, 147.61f);
...
void func_266(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFD2F
{
	func_267(pveParam0);
...
void func_267(Vehicle* pveParam0) // Position - 0xFD71
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_268(var uParam0) // Position - 0xFE0D
{
	int num;
	int i;
...
BOOL func_269(int iParam0) // Position - 0xFEF9
{
	var unk;
	eCharacter character;
...
BOOL func_270(int iParam0) // Position - 0xFF4A
{
	const char* string2;
...
BOOL func_271(int iParam0) // Position - 0x10004
{
	var unk;
...
BOOL func_272(int iParam0) // Position - 0x100C5
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_274(int iParam0) // Position - 0x1022C
{
...
BOOL func_275(int iParam0) // Position - 0x10257
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_276(int iParam0) // Position - 0x10282
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_277(int iParam0) // Position - 0x102AD
{
	if (func_247(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_279(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x102FC
{
	int i;
...
BOOL func_280(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10361
{
	int num;
	char* str;
...
BOOL func_281(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x103D9
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_282(var uParam0, BOOL bParam1) // Position - 0x10454
{
	if (*uParam0 == 18)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
...
void func_287(Object* pobParam0, BOOL bParam1) // Position - 0x105DB
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_290(Vehicle* pveParam0) // Position - 0x10665
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_293(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x106F0
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_294(int iParam0) // Position - 0x10740
{
	if (*iParam0 == -1)
		return;
...
Hash func_298(eCharacter echParam0) // Position - 0x107DC
{
	if (!func_36(echParam0))
