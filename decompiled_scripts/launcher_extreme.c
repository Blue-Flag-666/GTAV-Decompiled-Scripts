...
void main() // Position - 0x0
{
	...
	if (!func_274(&unk63, &num, vector, 1f))
	{
		func_273();
	...
	if (num == 17)
	{
		iLocal_97 = PED::ADD_SCENARIO_BLOCKING_AREA(vector - { 40f, 40f, 40f }, vector + { 40f, 40f, 40f }, false, true, true, true);
	...
	while (true)
	{
		...
		func_209(num);
		func_202(&iLocal_94, &(num.f_9), vector);
	
		if (num == 18)
		{
			func_201(&num);
			func_196(&num, vector, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (num == 19)
		{
			func_201(&num);
			...
			if (AUDIO::HAS_SOUND_FINISHED(iLocal_96))
				func_196(&num, vector, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
		
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && _DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]) && !AUDIO::IS_ANY_SPEECH_PLAYING(num.f_28[0]) && AUDIO::HAS_SOUND_FINISHED(iLocal_96) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_96, "DOM_BREATHING", num.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
		
			if (iLocal_95 == 0 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vector, num.f_15, num.f_15, num.f_15, false, false, 0))
			{
...
void func_3(int iParam0, const char* sParam1) // Position - 0x4CB
{
	func_21(sParam1);
...
var func_15(Hash hParam0) // Position - 0xD4D
{
	var outValue;
...
void func_21(const char* sParam0) // Position - 0xE44
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xE74
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1B4D
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29F8
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2A80
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2AC0
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2AEE
{
...
int func_31(Vehicle veParam0) // Position - 0x2BCA
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2C0C
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2C6F
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2CFD
{
	Hash num;
...
void func_37(Vehicle veParam0, var uParam1) // Position - 0x2FA7
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x35C6
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x36F5
{
	int i;
	var garageName;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x383C
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3879
{
...
Hash func_47(eCharacter echParam0) // Position - 0x389E
{
	return Global_2028[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x38AD
{
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3AF6
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x4040
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x43A5
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x4498
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x499B
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x55FC
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x5637
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x58AB
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E36
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AC0
{
	int i;
...
int func_93(Player plParam0) // Position - 0x8785
{
...
void func_122(Ped pedParam0) // Position - 0xAAE6
{
	int num;
	int num2;
	int num3;
...
int func_124(Ped pedParam0) // Position - 0xABC2
{
	int i;
...
int func_130(Ped pedParam0) // Position - 0xAD22
{
	int i;
...
BOOL func_131(Ped pedParam0) // Position - 0xAD6B
{
...
void func_135(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAEAE
{
	int i;
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB04D
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xB1B4
{
	BOOL flag;
...
BOOL func_142(Player plParam0) // Position - 0xB240
{
...
int func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB28D
{
	int num;
...
BOOL func_147(const char* sParam0) // Position - 0xB30A
{
...
void func_151() // Position - 0xB3C3
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			if (func_152(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, false, true, false))
...
BOOL func_152(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB41B
{
...
void func_153(Vehicle veParam0) // Position - 0xB5B3
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_170(const char* sParam0, int iParam1) // Position - 0xBC38
{
	int num;
	const char* str;
	Hash hashKey;
...
void func_172(int iParam0, var uParam1) // Position - 0xBCA5
{
	...
	{
		case 0:
			*uParam1 = func_173(-1604.668f, 5239.1f, 3.01f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 42);
			break;
	
		case 1:
			*uParam1 = func_173(-1592.84f, 5214.04f, 3.01f, false);
		...
		case 2:
		case 3:
			*uParam1 = func_173(190.26f, -956.35f, 29.63f, false);
		...
		case 4:
			*uParam1 = func_173(414f, -761f, 29f, false);
		...
		case 9:
			*uParam1 = func_173(-1622.89f, 4204.87f, 83.3f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
				*uParam1 = func_173(1835.53f, 4705.86f, 38.1f, false);
			else if (iParam0 == 12)
				*uParam1 = func_173(1826.13f, 4698.88f, 38.92f, false);
			else
				*uParam1 = func_173(637.02f, 119.7093f, 89.5f, false);
		...
		case 19:
			if (iParam0 == 18)
				*uParam1 = func_173(-954.19f, -2760.05f, 14.64f, false);
			else
				*uParam1 = func_173(-63.8f, -809.5f, 321.8f, false);
		...
		case 23:
			if (iParam0 == 21)
				*uParam1 = func_173(-1877.82f, -440.649f, 45.05f, false);
			else
				*uParam1 = func_173(-915.6f, 6139.2f, 5.5f, false);
		...
		case 27:
			*uParam1 = func_173(-1104.93f, 291.25f, 64.3f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 44);
			break;
		...
		case 34:
			*uParam1 = func_173(-303.82f, 6211.29f, 31.05f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_MINUTE);
			HUD::SET_BLIP_COLOUR(*uParam1, 44);
			break;
	
		case 43:
			*uParam1 = func_173(-44.75f, -1288.67f, 28.21f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_CELEBRITY_THEFT);
			HUD::SET_BLIP_COLOUR(*uParam1, 44);
			break;
	
		case 46:
			*uParam1 = func_173(-149.75f, 285.81f, 93.67f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
				*uParam1 = func_173(-70.71f, 301.43f, 106.79f, false);
			else
				*uParam1 = func_173(-257.22f, 292.85f, 90.63f, false);
...
Blip func_173(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC115
{
...
int func_176(var uParam0) // Position - 0xC1E7
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, false, true, 0))
		{
			...
			else if (!func_177(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_152(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_177(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC28E
{
...
BOOL func_183(Vehicle veParam0) // Position - 0xCC48
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112695 || Global_32166 || func_191() || func_190(8, -1) || func_96() || func_189() || func_188() || func_187() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || Global_32166 || func_191() || func_190(8, -1) || func_188() || func_96() || func_189() || func_187() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112695 || Global_32166 || func_191() || func_190(8, -1) || func_188() || func_96() || func_189() || func_187() || Global_113648.f_7690.f_919[character] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112695 || Global_32166 || func_191() || func_190(8, -1) || func_96() || func_189() || func_187() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_190(8, -1) || func_187() || func_186() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_192() || Global_32166 || func_191() || func_190(8, -1) || func_189() || func_188() || func_187() || Global_113648.f_7690.f_919[character] == 5)
								return false;
						break;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xD48C
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD5E8
{
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD683
{
...
void func_202(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD6EA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_211(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDC91
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_216(Object* pobParam0) // Position - 0xE34A
{
...
BOOL func_219(Ped pedParam0, Vehicle veParam1) // Position - 0xE5B3
{
...
BOOL func_222(Ped pedParam0, int iParam1) // Position - 0xE8D3
{
	float xSize;
...
BOOL func_223(Ped pedParam0, int iParam1) // Position - 0xE949
{
	return func_224(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_224(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE961
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_225(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_225(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEA22
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_226(Ped pedParam0, int iParam1) // Position - 0xEB4E
{
...
BOOL func_228(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEC5D
{
	var unk;
...
int func_232(Ped pedParam0, Ped pedParam1) // Position - 0xED69
{
	int i;
...
BOOL func_233(Ped pedParam0) // Position - 0xEDA8
{
...
BOOL func_234(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEDD0
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_235(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEECB
{
	float entityCoords;
	float num;
...
BOOL func_236(Ped pedParam0, float fParam1) // Position - 0xEFD7
{
	var outProjectile;
	var outCoords;
...
BOOL func_237(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF06C
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_238(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF0FA
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_240(Vehicle veParam0) // Position - 0xF18C
{
	int taskSequenceId;
...
void func_250(Ped* ppedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xF550
{
	func_251(ppedParam0, hLocal_93, fParam1, fParam4, PED_TYPE_MISSION);
...
void func_251(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0xF582
{
	func_252(ppedParam0);
...
void func_252(Ped* ppedParam0) // Position - 0xF5A3
{
...
BOOL func_257(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF80E
{
	if (func_258(ppedParam0, echParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_258(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF86A
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_293(echParam1);
...
void func_261(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFC42
{
	func_262(pveParam0);
...
void func_262(Vehicle* pveParam0) // Position - 0xFC84
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_282(Object* pobParam0, BOOL bParam1) // Position - 0x104EF
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_285(Vehicle* pveParam0) // Position - 0x10579
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_287(var uParam0, int iParam1) // Position - 0x105C3
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_288(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_288(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10604
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
Hash func_293(eCharacter echParam0) // Position - 0x106F0
{
	if (!func_36(echParam0))
