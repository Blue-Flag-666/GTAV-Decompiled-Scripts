...
void main() // Position - 0x0
{
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_289(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (!func_274(&unk64, &num, unk61, 1f))
	{
		func_273();
	...
	if (num == 17)
	{
		uLocal_97 = unk_0x54ECDA2DAB9CFB10(unk61 - { 40f, 40f, 40f }, unk61 + { 40f, 40f, 40f }, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_209(num);
		func_202(&iLocal_94, &(num.f_9), unk61);
	
		if (num == 18)
		{
			func_201(&num);
			func_196(&num, unk61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (num == 19)
		{
			func_201(&num);
			...
			if (unk_0x209C5E3492025E4B(uLocal_96))
				func_196(&num, unk61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
		
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && _DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]) && !unk_0x70ACD9400516DB25(num.f_28[0]) && unk_0x209C5E3492025E4B(uLocal_96) && unk_0xF6AFEDAAE44A2159("EXTREME_04_DOM_A", 0, -1) && unk_0xF6AFEDAAE44A2159("EXTREME_04_DOM_B", 0, -1) && unk_0xF6AFEDAAE44A2159("EXTREME_04_DOM_C", 0, -1))
				unk_0x03AC3DF6C3FAD811(uLocal_96, "DOM_BREATHING", num.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
		
			if (iLocal_95 == 0 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && unk_0x1C4E4DC1EFE24DF1(unk_0xC1A5EC5C986B98AD(), unk61, num.f_15, num.f_15, num.f_15, 0, 0, 0))
			{
				unk69 = { unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1) };
		...
		if (func_178(&num, 0) || func_176(&num))
		{
			if (func_175(num))
				func_172(num, &uLocal_98);
...
BOOL func_1(var uParam0) // Position - 0x3EA
{
...
BOOL func_2(Any* panParam0) // Position - 0x408
{
	var unk;
	var unk33;
	...
	{
		while (!func_162(*panParam0))
		{
			if (func_161(*panParam0))
				func_150();
...
void func_3(int iParam0, var uParam1) // Position - 0x4CB
{
	func_21(uParam1);
...
void func_17(BOOL bParam0) // Position - 0xD8B
{
...
void func_21(var uParam0) // Position - 0xE44
{
	unk_0x4310A0DB886F9FED(uParam0, uParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xE57
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xE74
{
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2A80
{
...
BOOL func_29(var uParam0) // Position - 0x2AC0
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2AEE
{
...
int func_31(var uParam0) // Position - 0x2BCA
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2C0C
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2C6F
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2CFD
{
	int num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2D3F
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2F9B
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(var uParam0, var uParam1) // Position - 0x2FA7
{
	int i;
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3302
{
	int i;
	int num;
...
BOOL func_40(int iParam0) // Position - 0x34F5
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x35C6
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x36F5
{
	int i;
	var unk;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3763
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x383C
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3879
{
...
int func_47(eCharacter echParam0) // Position - 0x389E
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3A4D
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x3A8A
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x3ACA
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3AF6
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x4040
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4281
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x4720
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x47C1
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E36
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65F9
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x6640
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66AB
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x670C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6AB0
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AC0
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75BC
{
...
BOOL func_81(Player plParam0) // Position - 0x75E6
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76E8
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x777D
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x841B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x849D
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x84F5
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x87A2
{
...
int func_102(int iParam0) // Position - 0x8CDE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D00
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8D17
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DD5
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8E73
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8EB5
{
...
BOOL func_118(Any* panParam0) // Position - 0xA948
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xACBB
{
...
BOOL func_131(var uParam0) // Position - 0xAD6B
{
...
BOOL func_132(int iParam0) // Position - 0xAD8B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_134(int iParam0) // Position - 0xAE5B
{
	switch (iParam0)
	{
		case 5:
...
void func_135(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEAE
{
	int i;
...
BOOL func_136(int iParam0) // Position - 0xAFA3
{
	switch (iParam0)
	{
		case 5:
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB04D
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB1B4
{
	BOOL flag;
...
BOOL func_142(int iParam0) // Position - 0xB240
{
...
int func_144(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB28D
{
	int num;
...
BOOL func_147(var uParam0) // Position - 0xB30A
{
...
void func_151() // Position - 0xB3C3
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
		if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			if (func_152(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
BOOL func_152(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB41B
{
...
void func_153(var uParam0) // Position - 0xB5B3
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_159(int iParam0) // Position - 0xB76F
{
	if (iParam0 == 1)
...
BOOL func_161(int iParam0) // Position - 0xB7D5
{
...
BOOL func_162(int iParam0) // Position - 0xB816
{
	int num;
	...
	num = func_164(&(Global_112735[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
int func_164(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB88D
{
	int i;
	...
	if (*iParam0 == -1)
	{
		...
		*iParam0 = Global_43221;
		...
		if (iParam4 != 0)
			func_165(iParam0, iParam4);
	}

	return 2;
}

void func_165(int iParam0, int iParam1) // Position - 0xB9C4
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA13
{
	return func_167(iParam0, Global_43257);
}

BOOL func_167(int iParam0, int iParam1) // Position - 0xBA24
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_168(int iParam0) // Position - 0xBC05
{
	if (Global_43257 == 15)
		return false;
...
int func_170(var uParam0, int iParam1) // Position - 0xBC38
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC81
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_172(int iParam0, var uParam1) // Position - 0xBCA5
{
	switch (iParam0)
	{
		case 0:
...
var func_173(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC115
{
	var unk;
...
var func_174(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC141
{
	if (bParam0)
		return uParam1;
...
BOOL func_175(int iParam0) // Position - 0xC158
{
	switch (iParam0)
	{
		case 0:
...
int func_176(var uParam0) // Position - 0xC1E7
{
	if (*uParam0 == 18)
	{
		if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, 0, 1, 0))
		{
			if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			{
			...
			else if (!func_177(unk_0xC1A5EC5C986B98AD(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0)) && func_152(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 3f, 1, 1056964608, 0, true, false))
			{
				unk_0x6FE9A0C01D25F413(unk_0xC1A5EC5C986B98AD(), 0, 0);
			}
		}
...
BOOL func_177(var uParam0, int iParam1) // Position - 0xC28E
{
	if (func_131(uParam0))
...
BOOL func_180(var uParam0) // Position - 0xCABF
{
	float num;
...
void func_181(int iParam0, var uParam1) // Position - 0xCB4D
{
	if (iParam0 == 1)
	{
		if (!func_134(uParam1))
...
BOOL func_182(BOOL bParam0) // Position - 0xCBB1
{
	var unk;
...
BOOL func_183(var uParam0) // Position - 0xCC48
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_184(int iParam0) // Position - 0xCC72
{
	eCharacter character;
...
BOOL func_185() // Position - 0xD38F
{
	return Global_100720.f_1;
}

BOOL func_186() // Position - 0xD39D
{
	if (Global_97603 != -1)
...
BOOL func_190(int iParam0, int iParam1) // Position - 0xD415
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_191() // Position - 0xD44D
{
	return Global_1575060;
}

BOOL func_192() // Position - 0xD459
{
	if (!unk_0xA26A9A07F761D8F8())
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0xD475
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xD48C
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xD4AD
{
...
int func_196(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD4CF
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_200(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD557
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD5E8
{
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD683
{
	var unk;
...
void func_201(var uParam0) // Position - 0xD6BD
{
	if (unk_0x3B7E6BE32C24780B())
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			unk_0x414C472A4880EAA3("Dom", uParam0->f_28[0], 0);

	return;
}

void func_202(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD6EA
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_200(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_205(uParam0, 1);
			}
			else
			{
				...
				if (func_200(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_207(uParam0);
			}
		}
	}
...
void func_205(var uParam0, int iParam1) // Position - 0xD850
{
	BOOL flag;
	int i;
...
void func_207(var uParam0) // Position - 0xD8FA
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_208(uParam0);
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDA21
{
	var unk;
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_78804 == 1)
		return true;
...
BOOL func_212(int iParam0) // Position - 0xDFE9
{
...
BOOL func_213(var uParam0) // Position - 0xE009
{
...
BOOL func_214(var uParam0) // Position - 0xE021
{
...
void func_216(var uParam0) // Position - 0xE34A
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE3F5
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_219(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_219(var uParam0, var uParam1) // Position - 0xE5B3
{
	var unk;
...
BOOL func_220(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE5E3
{
	int i;
	int num;
...
BOOL func_221(int iParam0) // Position - 0xE89F
{
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE8D3
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_233(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE949
{
	return func_224(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_224(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE961
{
	BOOL flag;
	var unk;
	int num;

	num = func_232(uParam0, uParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam1))
	{
		if (num != -1)
			func_231(&iLocal_37[num /*4*/]);
	...
	flag = func_225(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEA22
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_226(var uParam0, int iParam1) // Position - 0xEB4E
{
	int num;
...
BOOL func_228(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEC5D
{
	var unk;
	var unk4;
	float num;

	unk = { func_230(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_230(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_229(unk4, unk);
...
float func_229(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xECEE
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_230(float fParam0, var uParam1, var uParam2) // Position - 0xED0F
{
	float num;
	float num2;
...
int func_232(var uParam0, var uParam1) // Position - 0xED69
{
	int i;
...
int func_233(var uParam0) // Position - 0xEDA8
{
...
BOOL func_234(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEDD0
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_238(uParam0, bParam1, num, num2))
				return true;
		
			if (func_235(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_235(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEECB
{
	float num;
	float num2;
...
BOOL func_236(var uParam0, float fParam1) // Position - 0xEFD7
{
	var unk;
	var unk2;
	...
	if (unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_237(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_237(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF06C
{
	var unk;
	var unk4;
	float num;

	unk = { func_230(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_238(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF0FA
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_239(int iParam0) // Position - 0xF142
{
...
void func_240(var uParam0) // Position - 0xF18C
{
	var unk;
...
BOOL func_241(int iParam0) // Position - 0xF229
{
	if (iParam0 == -1)
		iParam0 = func_169();
...
BOOL func_242(int iParam0) // Position - 0xF2BE
{
...
BOOL func_245(int iParam0) // Position - 0xF33D
{
...
BOOL func_247(int iParam0) // Position - 0xF3AF
{
...
BOOL func_248(var uParam0) // Position - 0xF3D7
{
	switch (*uParam0)
	{
		case 17:
...
BOOL func_249(var uParam0) // Position - 0xF44C
{
	int num;
	int i;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_254(&num) || !func_253(&(uParam0->f_48)))
				return false;
...
void func_250(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xF550
{
	func_251(uParam0, iLocal_93, fParam1, fParam4, 26);
...
void func_251(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0xF582
{
	func_252(uParam0);
...
void func_252(var uParam0) // Position - 0xF5A3
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_253(var uParam0) // Position - 0xF5E4
{
	if (func_214(uParam0))
	{
...
BOOL func_254(var uParam0) // Position - 0xF60E
{
	int i;
...
BOOL func_256(var uParam0) // Position - 0xF67B
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				if (func_257(&uParam0->f_28[0], CHAR_DOM, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
...
BOOL func_257(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF80E
{
	if (func_258(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0x7DE17ACDD8BA2642(*uParam0))
		{
			if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_258(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF86A
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_293(echParam1);
...
int func_259(var uParam0, eCharacter echParam1) // Position - 0xF8F8
{
	int num;
...
BOOL func_260(var uParam0) // Position - 0xF93E
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				if (func_257(&uParam0->f_28[0], CHAR_DOM, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_261(&uParam0->f_35[0], num[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_261(&uParam0->f_35[1], num[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_261(&uParam0->f_35[2], num[1], -957.23f, -2764.89f, 14.04f, 147.61f);
...
void func_261(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFC42
{
	func_262(uParam0);
...
void func_262(var uParam0) // Position - 0xFC84
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x1AFE963DA61006ED(*uParam0))
...
BOOL func_263(var uParam0) // Position - 0xFD20
{
	int num;
	int i;
...
BOOL func_264(int iParam0) // Position - 0xFE0C
{
	var unk;
	eCharacter character;
...
BOOL func_265(int iParam0) // Position - 0xFE5D
{
	var unk;
...
BOOL func_266(int iParam0) // Position - 0xFF16
{
	var unk;
...
BOOL func_267(int iParam0) // Position - 0xFFD7
{
	int i;
	var unk;
	int num;
...
BOOL func_269(int iParam0) // Position - 0x10140
{
...
BOOL func_270(int iParam0) // Position - 0x1016B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_271(int iParam0) // Position - 0x10196
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_272(int iParam0) // Position - 0x101C1
{
	if (func_242(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_274(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10210
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_275(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_275(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_275(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10275
{
	int num;
	char* str;
	...
	if (func_276(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_276(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x102ED
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_277(var uParam0, BOOL bParam1) // Position - 0x10368
{
	if (*uParam0 == 18)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
...
void func_281(var uParam0, BOOL bParam1) // Position - 0x104B1
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_282(&uParam0->[i], false);
	}

	return;
}

void func_282(var uParam0, BOOL bParam1) // Position - 0x104EF
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_285(var uParam0) // Position - 0x10579
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_287(var uParam0, int iParam1) // Position - 0x105C3
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_288(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_288(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10604
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_289(int iParam0) // Position - 0x10654
{
	if (*iParam0 == -1)
		return;
...
int func_293(eCharacter echParam0) // Position - 0x106F0
{
	if (!func_36(echParam0))
