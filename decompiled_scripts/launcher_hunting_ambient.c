...
void main() // Position - 0x0
{
	...
	if (func_89(iLocal_94, 8388608))
		func_95(true);

	if (func_89(iLocal_94, 524288) && func_85() && !func_84())
		func_95(true);

	if (unk_0x24B651D85CCE5EB4(unk_0x63C7B2D430A46FC3()) > 1 && !func_89(iLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_75(3) && !Global_100715)
						{
							...
							{
								if (!func_89(iLocal_94, 1) || !unk_0x7DE17ACDD8BA2642(func_74()) && !Global_100715)
								{
									func_82(10);
									break;
								}
						...
						if (flag3)
						{
							...
							{
								if (num < iLocal_120 && num >= iLocal_121)
								{
									func_61(&iLocal_94, 128);
									flag3 = false;
							...
							else if (num < iLocal_120 || num >= iLocal_121)
							{
								func_61(&iLocal_94, 128);
								flag3 = false;
							...
							if (flag3)
							{
								...
								if (func_46(uLocal_86))
								{
									...
									else if (!func_89(iLocal_94, 2048) || !unk_0xF0E4B64AC0B5660E())
									{
				...
				case 5:
					...
					if (unk_0x6CAF14BE58B4BFF8(&uLocal_69))
					{
						...
						if (num2 != 1)
							num2 = func_37(&iLocal_98, 6, iLocal_100, false, 0);
				...
				case 6:
					...
					if (func_89(iLocal_94, 2097152))
						if (!func_75(3) && !unk_0xB8CEC43FB7EF2D92(iLocal_52))
							func_82(10);
				...
				case 7:
					...
					if (iLocal_105 != 263)
						func_83(iLocal_105, false, false);
...
void func_2() // Position - 0xB2B
{
	if (bLocal_125)
	{
		unk_0xE0A291F406691F03(joaat("blazer"));
		unk_0xE0A291F406691F03(joaat("journey"));
	}
...
float func_11(var uParam0) // Position - 0xC68
{
	if (func_14(uParam0))
		if (func_13(uParam0))
			return uParam0->f_2;
...
void func_21(var uParam0) // Position - 0xF25
{
	if (!func_14(uParam0))
		func_24(uParam0);
	else
...
void func_22(var uParam0) // Position - 0xF46
{
	func_23(uParam0, 0f);
	return;
}

void func_23(var uParam0, float fParam1) // Position - 0xF55
{
...
void func_24(var uParam0) // Position - 0xF80
{
	if (!func_14(uParam0))
		func_22(uParam0);
...
void func_25() // Position - 0xF98
{
	if (bLocal_125)
	{
		if (bLocal_126)
		{
			if (unk_0x7DE17ACDD8BA2642(uLocal_123))
				unk_0x0E4B6CF706BE8AA4(&uLocal_123);
		
			if (unk_0x7DE17ACDD8BA2642(uLocal_124))
				unk_0x0E4B6CF706BE8AA4(&uLocal_124);
		}
	}
...
void func_40() // Position - 0x14A2
{
	...
	if (unk_0x7DE17ACDD8BA2642(uLocal_124) && !unk_0x055111B11E6624FD(uLocal_124, 0) && !unk_0x584CD220C093B0B4(uLocal_124))
	{
		unk_0x439314AD4FC79186(uLocal_124, 2);
		unk_0xBF8238D446A5EAA1(uLocal_124, 1);
		unk_0x495ED6976429C1E8(uLocal_124, 0, 0);
		unk_0x9D92700BDDC6B69B(uLocal_124, 1);
		uLocal_122 = uLocal_124;
	
		if (unk_0x7DE17ACDD8BA2642(uLocal_123) && !unk_0x055111B11E6624FD(uLocal_123, 0))
		{
			unk_0xBF8238D446A5EAA1(uLocal_123, 1);
			unk_0x9D92700BDDC6B69B(uLocal_123, 1);
			unk_0x495ED6976429C1E8(uLocal_123, 0, 0);
			unk_0xDAF60DD724E215CF(uLocal_123, 1);
		}
	}
	else
	{
		if (unk_0x7DE17ACDD8BA2642(uLocal_124) && unk_0x055111B11E6624FD(uLocal_124, 0) || !unk_0x7DE17ACDD8BA2642(uLocal_124))
			func_41(0);
	
		if (unk_0x7DE17ACDD8BA2642(uLocal_123) && unk_0x055111B11E6624FD(uLocal_123, 0) || !unk_0x7DE17ACDD8BA2642(uLocal_123))
			func_41(0);
	
		if (iLocal_128 && unk_0x2BBF749E555360DC("oddjobs@hunterIntro") && unk_0x2BBF749E555360DC("oddjobs@hunterOutro"))
		{
			unk_0x0B34FA69ECCE3927("oddjobs@hunterIntro");
			unk_0x0B34FA69ECCE3927("oddjobs@hunterOutro");
			iLocal_128 = 0;
		}
	...
	if (flag)
	{
		unk_0x28818732C8F0F80E("oddjobs@hunterIntro");
		unk_0x28818732C8F0F80E("oddjobs@hunterOutro");
		iLocal_128 = 1;
	}
	else if (iLocal_128 && unk_0x2BBF749E555360DC("oddjobs@hunterIntro") && unk_0x2BBF749E555360DC("oddjobs@hunterOutro"))
	{
		unk_0x0B34FA69ECCE3927("oddjobs@hunterIntro");
		unk_0x0B34FA69ECCE3927("oddjobs@hunterOutro");
		iLocal_128 = 0;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x17C0
{
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1A3B
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1A78
{
...
int func_53(eCharacter echParam0) // Position - 0x1A9D
{
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_71() || Global_112695 || Global_32166 || func_70() || func_56(8, -1) || func_69() || func_68() || func_67() || func_58() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_71() || Global_32166 || func_70() || func_56(8, -1) || func_67() || func_69() || func_68() || func_58() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_71() || Global_112695 || Global_32166 || func_70() || func_56(8, -1) || func_69() || func_68() || func_58() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_71() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 || func_56(8, -1) || func_58() || func_66() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
void func_79() // Position - 0x25A1
{
	if (bLocal_125)
	{
		...
		if (!bLocal_127)
		{
			unk_0x10DFA2EC4C030EB3(-1702.46f, 4666.36f, 22.1255f, 10f, 0, 0, 0, 0, 0, 0, 0);
		
			if (!unk_0x7DE17ACDD8BA2642(uLocal_123))
				uLocal_123 = unk_0xABEEDBEF2BBDF5B3(joaat("blazer"), -1707.4337f, 4666.5625f, 22.1095f, 323.2491f, 1, 1, 0);
		
			if (!unk_0x7DE17ACDD8BA2642(uLocal_124))
			{
				uLocal_124 = unk_0xABEEDBEF2BBDF5B3(joaat("journey"), -1702.6951f, 4666.9414f, 22.7091f, 80.03f, 1, 1, 0);
				unk_0x5BC68FEFF4902C2B(uLocal_124, 1);
			}
...
{
	if (bLocal_125)
		return unk_0x0CBB7C273DED26E7(joaat("blazer")) && unk_0x0CBB7C273DED26E7(joaat("journey"));
...
void func_81() // Position - 0x2660
{
	if (bLocal_125)
	{
		...
		unk_0x852EC2A7DE66202D(joaat("journey"));
	}
