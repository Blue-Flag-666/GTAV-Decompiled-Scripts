...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_144(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_144(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
{
	func_255(&Global_106470, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_273(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2860791[iParam0 /*3*/][func_136(iParam1)];
...
int func_361(int iParam0)
{
	if (iParam0 != func_10())
	{
		...
		else if ((Global_1575054 && iParam0 == PLAYER::PLAYER_ID()) && func_362(iParam0, 1, 0))
		{
			return Global_2689224[iParam0 /*451*/].f_317.f_6 != -1;
		}
	}
...
int func_425(int iParam0, bool bParam1)
{
	...
	{
		if ((func_430() || MISC::IS_PC_VERSION()) || func_429())
		{
		}
		else if (!func_432())
		{
...
void func_440(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_18(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_444(*iParam1, 0, &uVar0))
		{
...
int func_444(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_471(iVar0, bParam1, uParam2) && !func_470(PLAYER::PLAYER_ID())) && !func_453(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_451(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_449(iParam0)) && !bVar1) && !(func_448(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_446(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_445(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_469(PLAYER::PLAYER_ID()) || func_468(PLAYER::PLAYER_ID()))
	{
		if (func_454(iParam0))
		{
			return 1;
...
int func_455(int iParam0)
{
	...
	if (func_456(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
	{
		return 1;
	}
	return 0;
...
int func_457(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_459(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_471(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_451(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_215(iParam0, 0, 0)) || func_215(iParam0, 1, 0)) || func_215(iParam0, 2, 0)) || func_262(iParam0) != 145) || func_478(iParam0)) || func_477(iParam0)) || func_445(iParam0)) || func_476(iParam0)) || !func_475(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_477(iParam0))
		{
		}
...
int func_482(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_467(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_485(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_490(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97311[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97311[iVar0]) == func_264(iParam0, iParam1))
				{
...
int func_503(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_504(iParam0, uVar1[iVar6], 1) && func_424(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_267(iVar5));
				}
				iVar5++;
			}
		}
