...
void func_9() // Position - 0x1515
{
	if (unk_0x7DE17ACDD8BA2642(uLocal_448))
	{
		...
		unk_0xC621CC7313639986(&uLocal_448);
	}
...
{
	unk_0xFECAE061D8C80757(uLocal_240, 1, 0, 0, 0);
	unk_0xFECAE061D8C80757(uLocal_240, 11, 0, 0, 0);
	unk_0x0A3B6B850C2EC4FD(uLocal_240, 1, 0, 0, 0, 1);
	unk_0x0A3B6B850C2EC4FD(uLocal_240, 0, 0, 0, 0, 1);
	uLocal_448 = unk_0xF19D6C0E8B56BE23(joaat("prop_cs_protest_sign_01"), unk_0x30BE8A934C020461(uLocal_240, 1), 1, 1, 0);
