...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_64(PLAYER::PLAYER_PED_ID(), unk, false) > 100f + 20f)
			func_74();
		...
		if (func_1(&iLocal_40, &uLocal_89, flag, false, true, DEFAULT))
			func_74();
...
BOOL func_1(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, eStackSize essParam5) // Position - 0x196
{
	...
	switch (uParam1->f_13)
	{
				...
				for (i = 0; i < *uParam0; i = i + 1)
				{
					if (func_42(&uParam0->[i /*24*/]) && uParam0->[i /*24*/])
					{
						...
						if (uParam0->[i /*24*/].f_7 || MISC::GET_MISSION_FLAG() && uParam1->f_16 == 0)
							...
							func_41(uParam1, 2);
						else if (func_30() < uParam0->[uParam1->f_12 /*24*/].f_9)
							func_41(uParam1, 1);
						else if (func_25())
							func_41(uParam1, 7);
						else
		...
		case 1:
			if (!uParam1->f_9)
				func_13(uParam1, uParam1->f_2, uParam0->[uParam1->f_12 /*24*/].f_9);
		...
		case 4:
			...
			if (!uParam1->f_9)
				func_13(uParam1, *uParam1, uParam0->[uParam1->f_12 /*24*/].f_9);
...
BOOL func_18(var uParam0) // Position - 0xDA7
{
	...
	if (uParam0->f_11 == 0)
		return !func_21(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10 + 2f, true);

	unk = { func_19(uParam0->f_16, 2f) };
...
struct<8> func_19(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xE4B
{
	...
	unk = 2;
	unk9 = { func_20(uParam0[1 /*3*/] - uParam0[0 /*3*/]) * { fParam8, fParam8, fParam8 } };
...
Vector3 func_20(float fParam0, var uParam1, var uParam2) // Position - 0xEAD
{
	float num;
	float num2;
...
BOOL func_25() // Position - 0xF96
{
	...
	if (func_29(vehiclePedIsIn))
		return true;

	if (func_26(vehiclePedIsIn, 3))
		return true;
...
void func_33() // Position - 0x118A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (Global_113648.f_2365.f_539.f_4321 != character && func_34(Global_113648.f_2365.f_539.f_4321))
...
Vector3 func_56(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x18FA
{
...
void func_57(int iParam0) // Position - 0x1933
{
	...
	if (uLocal_117[iParam0] == 0)
	{
		if (MISC::GET_GAME_TIMER() > uLocal_114[iParam0])
			uLocal_117[iParam0] = SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(uLocal_107[iParam0 /*3*/], uLocal_107[iParam0 /*3*/] + { 1f, 0f, 0f }, 2f, 2, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4);
	}
	else
	{
...
void func_65() // Position - 0x20F9
{
	...
	func_66(&uLocal_89, 0);
	uLocal_107[0 /*3*/] = { 47.6f, -1392f, 29.4f };
	uLocal_107[1 /*3*/] = { -700f, -925.3f, 19f };
	return;
}
...
{
	uParam0->f_12 = { func_20(fParam1 * { 5f, 5f, 5f }) };
