...
void main() // Position - 0x0
{
	...
	iLocal_90 = func_303(CHAR_MARY_ANN);
	iLocal_92 = -1;
	iLocal_95 = -1;
	...
	while (true)
	{
		...
		if (num == 21)
			func_205(&num, vector, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		else if (num == 22)
			func_200(&num, vector, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		else if (num == 23)
			if (iLocal_94 == 0)
				if (func_205(&num, vector, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
					iLocal_94 = 1;
			else
				func_197(&num);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x489E
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x554F
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x558A
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57FE
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D89
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x654C
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6593
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65FE
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A11
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A21
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7538
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7562
{
...
BOOL func_85(Player plParam0) // Position - 0x758E
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7690
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7725
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x83C2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8444
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x849C
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x8721
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x873E
{
...
int func_106(int iParam0) // Position - 0x8C87
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CA9
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8CC0
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D7E
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DF0
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E06
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E1C
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E5E
{
...
BOOL func_122(Any* panParam0) // Position - 0xA8F1
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA8F
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAB6B
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAC64
{
...
int func_134(Ped pedParam0) // Position - 0xACCB
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAD14
{
...
BOOL func_136(int iParam0) // Position - 0xAD34
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAE04
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE57
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xAF4C
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFF6
{
	if (bParam0)
	{
...
BOOL func_144(Player plParam0, int iParam1) // Position - 0xB15D
{
	BOOL flag;
...
BOOL func_146(Player plParam0) // Position - 0xB1F7
{
	Player player;
...
BOOL func_147(Player plParam0) // Position - 0xB219
{
...
int func_149(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB266
{
	int num;
...
BOOL func_152(const char* sParam0) // Position - 0xB2E3
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB387
{
...
BOOL func_158(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB416
{
...
void func_159(Vehicle veParam0) // Position - 0xB5AE
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_165(int iParam0) // Position - 0xB76A
{
	if (iParam0 == 1)
...
BOOL func_167(int iParam0) // Position - 0xB7D0
{
...
BOOL func_168(int iParam0) // Position - 0xB811
{
	int num;
...
int func_170(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB888
{
	int i;
...
void func_171(int iParam0, int iParam1) // Position - 0xB9BF
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA0E
{
	return func_173(iParam0, Global_43377);
}

BOOL func_173(int iParam0, int iParam1) // Position - 0xBA1F
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_174(int iParam0) // Position - 0xBC00
{
	if (Global_43377 == 15)
		return false;
...
int func_176(const char* sParam0, int iParam1) // Position - 0xBC33
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC7C
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_178(int iParam0, var uParam1) // Position - 0xBCA0
{
	switch (iParam0)
	{
		case 0:
...
Blip func_179(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC113
{
	Blip blip;
...
var func_180(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC13F
{
	if (bParam0)
		return uParam1;
...
BOOL func_181(int iParam0) // Position - 0xC156
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC1E5
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_184(var uParam0) // Position - 0xC9E3
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xCA71
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xCAD5
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCB6C
{
...
BOOL func_188(int iParam0) // Position - 0xCB96
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD2B3
{
	return Global_100872.f_1;
}

BOOL func_190() // Position - 0xD2C1
{
	if (Global_97735 != -1)
...
BOOL func_194(int iParam0, int iParam1) // Position - 0xD339
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD371
{
	return Global_1575063;
}

BOOL func_196() // Position - 0xD37D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_197(var uParam0) // Position - 0xD399
{
	if (iLocal_95 == -1)
	...
	if (MISC::GET_GAME_TIMER() - iLocal_95 >= 900)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				func_198(uParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_95 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_198(Ped pedParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xD3E9
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD402
{
	char* str;
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD5F7
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD67F
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD710
{
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD7AB
{
...
BOOL func_205(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD7E5
{
	var unk;
	...
	if (func_188(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_204(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
			{
				unk = 16;
				_CONVERSATION_INITIALIZE_ACTOR(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				_CONVERSATION_ADD_LINE_NO_SUBTITLE(&unk, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_206(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
				if (func_204(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
					func_153();
		}
	}
...
BOOL func_206(char* sParam0) // Position - 0xD8A7
{
	var string1;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xD8EB
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_209(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD90C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_212(var uParam0, int iParam1) // Position - 0xDA72
{
	BOOL flag;
	int i;
...
void func_214(var uParam0) // Position - 0xDB1C
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_215(uParam0);
...
void func_215(var uParam0) // Position - 0xDB33
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDC43
{
	var unk;
...
void func_218(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDEB3
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_219(int iParam0) // Position - 0xE20B
{
...
BOOL func_220(var uParam0) // Position - 0xE22B
{
...
BOOL func_221(var uParam0) // Position - 0xE243
{
...
void func_223(Object* pobParam0) // Position - 0xE56C
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE617
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_226(Ped pedParam0, Vehicle veParam1) // Position - 0xE7D5
{
...
BOOL func_227(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE805
{
	int i;
	int num;
...
BOOL func_228(int iParam0) // Position - 0xEAC1
{
...
BOOL func_229(Ped pedParam0, int iParam1) // Position - 0xEAF5
{
	float xSize;
...
BOOL func_230(Ped pedParam0, int iParam1) // Position - 0xEB6B
{
	return func_231(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_231(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEB83
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_232(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEC44
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_233(Ped pedParam0, int iParam1) // Position - 0xED70
{
...
BOOL func_235(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEE7F
{
	var unk;
...
float func_236(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEF10
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_237(float fParam0, var uParam1, var uParam2) // Position - 0xEF31
{
	float num;
	float num2;
...
int func_239(Ped pedParam0, Ped pedParam1) // Position - 0xEF8B
{
	int i;
...
BOOL func_240(Ped pedParam0) // Position - 0xEFCA
{
...
BOOL func_241(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEFF2
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_242(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF0ED
{
	float entityCoords;
	float num;
...
BOOL func_243(Ped pedParam0, float fParam1) // Position - 0xF1F9
{
	var outProjectile;
	var outCoords;
...
BOOL func_244(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF28E
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_245(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF31C
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_246(int iParam0) // Position - 0xF364
{
...
void func_247(Vehicle veParam0) // Position - 0xF3AE
{
	int taskSequenceId;
...
BOOL func_248(int iParam0) // Position - 0xF44B
{
	if (iParam0 == -1)
		iParam0 = func_175();
...
BOOL func_249(int iParam0) // Position - 0xF4E0
{
...
BOOL func_252(int iParam0) // Position - 0xF55F
{
...
BOOL func_254(int iParam0) // Position - 0xF5D1
{
...
BOOL func_255(var uParam0) // Position - 0xF5F9
{
	switch (*uParam0)
	{
		case 21:
...
BOOL func_257(var uParam0) // Position - 0xF6AC
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				if (func_258(&uParam0->f_28[0], CHAR_MARY_ANN, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
...
BOOL func_258(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA6C
{
...
BOOL func_259(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAC8
{
	Hash model;
...
int func_260(var uParam0, eCharacter echParam1) // Position - 0xFB56
{
	int num;
...
BOOL func_261(var uParam0) // Position - 0xFB9C
{
	if (func_221(uParam0))
	{
...
BOOL func_262(var uParam0) // Position - 0xFBC6
{
	int i;
...
BOOL func_264(var uParam0) // Position - 0xFC33
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_258(&uParam0->f_28[0], CHAR_MARY_ANN, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_268(&uParam0->f_28[1], num[1], 808.43f, 1279.16f, 360.47f, -79.11f, PED_TYPE_MISSION);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_266(&uParam0->f_35[0], num[2], 808.35f, 1277.2f, 360.15f, 216.5f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
				func_266(&uParam0->f_35[1], num[2], 807.89f, 1275.73f, 360.18f, 208.2f);
...
void func_266(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF78
{
	func_267(pveParam0);
...
void func_267(Vehicle* pveParam0) // Position - 0xFFBA
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_268(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x10058
{
	func_269(ppedParam0);
...
void func_269(Ped* ppedParam0) // Position - 0x10079
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_270(var uParam0) // Position - 0x100BA
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_258(&uParam0->f_28[0], CHAR_MARY_ANN, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
BOOL func_271(int iParam0) // Position - 0x10215
{
	var unk;
	eCharacter character;
...
BOOL func_272(int iParam0) // Position - 0x10266
{
	const char* string2;
...
BOOL func_273(int iParam0) // Position - 0x1031F
{
	var unk;
...
BOOL func_274(int iParam0) // Position - 0x103E0
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_276(int iParam0) // Position - 0x10547
{
...
BOOL func_277(int iParam0) // Position - 0x10572
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_278(int iParam0) // Position - 0x1059D
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x105C8
{
	if (func_249(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_281(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10617
{
	int i;
...
BOOL func_282(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x1067C
{
	int num;
	char* str;
...
BOOL func_283(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x106F4
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x1076F
{
	char* str;
...
void func_292(Object* pobParam0, BOOL bParam1) // Position - 0x10909
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_295(Vehicle* pveParam0) // Position - 0x10993
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_298(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10A1E
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_299(int iParam0) // Position - 0x10A6E
{
	if (*iParam0 == -1)
		return;
...
Hash func_303(eCharacter echParam0) // Position - 0x10B0A
{
	if (!func_36(echParam0))
