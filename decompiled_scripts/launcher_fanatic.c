...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112009[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_291(&(Global_112009[Var0.f_0 /*10*/].f_9));
			}
		}
		func_276(&Var0, 1);
	}
	if (!func_273(&iVar64, &Var0, Var61, 1f))
	{
		func_272();
	...
	while (true)
	{
		...
		func_208(Var0.f_0);
		func_201(&iLocal_94, &(Var0.f_9), Var61);
		if (iLocal_95 == 0)
		{
			if (Var0.f_0 == 22)
			{
		...
		if (Var0.f_0 == 21)
		{
			func_197(&Var0, Var61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_192(&Var0, Var61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_96 == 0)
			{
				if (func_197(&Var0, Var61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_96 = 1;
				}
			}
...
void func_190(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_200(PLAYER::PLAYER_PED_ID()) && func_200(iParam0->f_28[0])) && !func_147()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
float func_196(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_180(2))
	{
		if (!func_147())
		{
			if (((func_200(PLAYER::PLAYER_PED_ID()) && func_200(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_195(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_193(&uVar0, cParam4, sParam5, 7, 0, 0);
...
int func_209(var uParam0, bool bParam1)
{
	...
	if ((func_246(*uParam0) || func_244(*uParam0)) || Global_78103 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_245() && Global_99980.f_11 == 6) && iParam0 == func_168(&(Global_99980.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_256(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_200(uParam0->f_35[iVar4]))
				{
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_259(iParam0);
...
void func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_261(iParam0);
...
bool func_267(int iParam0, char* sParam1)
{
...
int func_273(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_274((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_274((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_274(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_275(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_275(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
