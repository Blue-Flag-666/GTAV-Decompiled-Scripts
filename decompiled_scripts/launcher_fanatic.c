...
void main() // Position - 0x0
{
	...
	iLocal_92 = func_298(CHAR_MARY_ANN);
	iLocal_94 = -1;
	iLocal_97 = -1;
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_294(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_211(num);
		func_204(&iLocal_94, &(num.f_9), unk61);
			...
			if (num == 22)
			{
				if (unk_0x3B7E6BE32C24780B())
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[1]))
					{
						...
						unk_0x414C472A4880EAA3("MaryAnnes_Friend", num.f_28[1], 0);
						unk_0x09910FB897E3D426("MaryAnnes_Friend", 0, 0, 0, 0);
						iLocal_95 = 1;
					}
				}
			}
		...
		if (num == 21)
			func_200(&num, unk61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		else if (num == 22)
			func_195(&num, unk61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		else if (num == 23)
			if (iLocal_96 == 0)
				if (func_200(&num, unk61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
					iLocal_96 = 1;
			else
				func_192(&num);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x393C
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x3979
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x39B9
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39E5
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F2E
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4172
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x4611
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x46B2
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D27
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64EA
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x6531
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x659C
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x65FD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x69A1
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69B1
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74AD
{
...
BOOL func_81(Player plParam0) // Position - 0x74D7
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x75D9
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x766E
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x830E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x8390
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x83E8
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x8695
{
...
int func_102(int iParam0) // Position - 0x8BD1
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BF3
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8C0A
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8CC8
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8D66
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8DA8
{
...
BOOL func_118(Any* panParam0) // Position - 0xA83B
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xABAE
{
...
BOOL func_131(var uParam0) // Position - 0xAC5E
{
...
BOOL func_132(int iParam0) // Position - 0xAC7E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_134(int iParam0) // Position - 0xAD4E
{
	switch (iParam0)
	{
		case 5:
...
void func_135(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xADA1
{
	int i;
...
BOOL func_136(int iParam0) // Position - 0xAE96
{
	switch (iParam0)
	{
		case 5:
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF40
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB0A7
{
	BOOL flag;
...
BOOL func_142(int iParam0) // Position - 0xB133
{
...
int func_144(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB180
{
	int num;
...
BOOL func_147(var uParam0) // Position - 0xB1FD
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB2A1
{
...
BOOL func_153(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB330
{
...
void func_154(var uParam0) // Position - 0xB4C8
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_160(int iParam0) // Position - 0xB684
{
	if (iParam0 == 1)
...
BOOL func_162(int iParam0) // Position - 0xB6EA
{
...
BOOL func_163(int iParam0) // Position - 0xB72B
{
	int num;
...
int func_165(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB7A2
{
	int i;
...
void func_166(int iParam0, int iParam1) // Position - 0xB8D9
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB928
{
	return func_168(iParam0, Global_43257);
}

BOOL func_168(int iParam0, int iParam1) // Position - 0xB939
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_169(int iParam0) // Position - 0xBB1A
{
	if (Global_43257 == 15)
		return false;
...
int func_171(var uParam0, int iParam1) // Position - 0xBB4D
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBB96
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_173(int iParam0, var uParam1) // Position - 0xBBBA
{
	switch (iParam0)
	{
		case 0:
...
var func_174(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC02B
{
	var unk;
...
var func_175(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC057
{
	if (bParam0)
		return uParam1;
...
BOOL func_176(int iParam0) // Position - 0xC06E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_177(var uParam0, int iParam1) // Position - 0xC0FD
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_179(var uParam0) // Position - 0xC8FB
{
	float num;
...
void func_180(int iParam0, var uParam1) // Position - 0xC989
{
	if (iParam0 == 1)
	{
		if (!func_134(uParam1))
...
BOOL func_181(BOOL bParam0) // Position - 0xC9ED
{
	var unk;
...
BOOL func_182(var uParam0) // Position - 0xCA84
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_183(int iParam0) // Position - 0xCAAE
{
	eCharacter character;
...
BOOL func_184() // Position - 0xD1CB
{
	return Global_100720.f_1;
}

BOOL func_185() // Position - 0xD1D9
{
	if (Global_97603 != -1)
...
BOOL func_189(int iParam0, int iParam1) // Position - 0xD251
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_190() // Position - 0xD289
{
	return Global_1575060;
}

BOOL func_191() // Position - 0xD295
{
	if (!unk_0xA26A9A07F761D8F8())
...
void func_192(var uParam0) // Position - 0xD2B1
{
	if (iLocal_97 == -1)
		iLocal_97 = unk_0xA5E11AF0A2B928C1();

	if (unk_0xA5E11AF0A2B928C1() - iLocal_97 >= 900)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				func_193(uParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_97 = unk_0xA5E11AF0A2B928C1();
			}
		}
	}
...
void func_193(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xD301
{
	unk_0xB7C28610A558761B(uParam0, sParam1, sParam2, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam3), 0);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD31A
{
	char* str;
...
int func_195(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD50F
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_199(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD597
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD628
{
...
float func_199(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD6C3
{
	var unk;
...
BOOL func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD6FD
{
	var unk;
	...
	if (func_183(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_199(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < 20f)
			{
				unk = 16;
				_CONVERSATION_INITIALIZE_ACTOR(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				_CONVERSATION_ADD_LINE_NO_SUBTITLE(&unk, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_201(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()))
				if (func_199(unk_0xC1A5EC5C986B98AD(), uParam1, 1) >= 20f)
					func_148();
		}
	}
...
BOOL func_201(char* sParam0) // Position - 0xD7BF
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xD803
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
void func_204(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD824
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_199(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_207(uParam0, 1);
			}
			else
			{
				...
				if (func_199(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_209(uParam0);
			}
		}
	}
...
void func_207(var uParam0, int iParam1) // Position - 0xD98A
{
	BOOL flag;
	int i;
...
void func_209(var uParam0) // Position - 0xDA34
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_210(uParam0);
...
void func_210(var uParam0) // Position - 0xDA4B
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDB5B
{
	var unk;
	...
	if (func_249(*panParam0) || func_247(*panParam0) || Global_78804 == 1)
		return true;
...
void func_213(int iParam0, var uParam1, int iParam2) // Position - 0xDDCB
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_215(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_214(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_215(uParam1) && uParam1->f_4 == 0 && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_214(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_214(int iParam0) // Position - 0xE123
{
...
BOOL func_215(var uParam0) // Position - 0xE143
{
...
BOOL func_216(var uParam0) // Position - 0xE15B
{
...
void func_218(var uParam0) // Position - 0xE484
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE52F
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_221(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_221(var uParam0, var uParam1) // Position - 0xE6ED
{
	var unk;
...
BOOL func_222(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE71D
{
	int i;
	int num;
...
BOOL func_223(int iParam0) // Position - 0xE9D9
{
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xEA0D
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_235(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_225(var uParam0, int iParam1) // Position - 0xEA83
{
	return func_226(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_226(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA9B
{
	BOOL flag;
	var unk;
	int num;

	num = func_234(uParam0, uParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam1))
	{
		if (num != -1)
			func_233(&iLocal_37[num /*4*/]);
...
BOOL func_227(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEB5C
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_228(var uParam0, int iParam1) // Position - 0xEC88
{
	int num;
...
BOOL func_230(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xED97
{
	var unk;
	var unk4;
	float num;

	unk = { func_232(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_232(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };
...
float func_231(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEE28
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_232(float fParam0, var uParam1, var uParam2) // Position - 0xEE49
{
	float num;
	float num2;
...
int func_234(var uParam0, var uParam1) // Position - 0xEEA3
{
	int i;
...
int func_235(var uParam0) // Position - 0xEEE2
{
...
BOOL func_236(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEF0A
{
	float num;
	float num2;
	int num3;
...
BOOL func_237(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF005
{
	float num;
	float num2;
...
BOOL func_238(var uParam0, float fParam1) // Position - 0xF111
{
	var unk;
	var unk2;
...
BOOL func_239(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF1A6
{
	var unk;
	var unk4;
	float num;

	unk = { func_232(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_240(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF234
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_241(int iParam0) // Position - 0xF27C
{
...
void func_242(var uParam0) // Position - 0xF2C6
{
	var unk;
...
BOOL func_243(int iParam0) // Position - 0xF363
{
	if (iParam0 == -1)
		iParam0 = func_170();
...
BOOL func_244(int iParam0) // Position - 0xF3F8
{
...
BOOL func_247(int iParam0) // Position - 0xF477
{
...
BOOL func_249(int iParam0) // Position - 0xF4E9
{
...
BOOL func_250(var uParam0) // Position - 0xF511
{
	switch (*uParam0)
	{
		case 21:
...
BOOL func_252(var uParam0) // Position - 0xF5C4
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_257(&num) || !func_256(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			{
				if (func_253(&uParam0->f_28[0], CHAR_MARY_ANN, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
					unk_0x2EDDA32F6EF3C8B7(uParam0->f_28[0], -915.6f, 6139.192f, 5.525f, 1, 0, 1);
					unk_0x464B5B0F22497FC5(uParam0->f_28[0], 2.52f, 0f, 111.24f, 0, 0);
				}
				else
				{
					flag = false;
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
			{
				...
				uParam0->f_41[0] = unk_0xF19D6C0E8B56BE23(num[1], unk6, 1, 1, 0);
				unk_0x2EDDA32F6EF3C8B7(uParam0->f_41[0], -916.6389f, 6137.046f, 4.7157f, 0, 0, 1);
				unk_0x464B5B0F22497FC5(uParam0->f_41[0], 1.7f, 19.1067f, 79.515f, 0, 1);
				unk_0xA16BAE0DDDB68BAD(uParam0->f_41[0], -0.0949f, 0.1369f, 0.6325f, 0.7564f);
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
			{
				...
				unk_0xDE209AFE421606C6(unk6, &(unk6.f_2), 0, 0);
				uParam0->f_41[1] = unk_0xF19D6C0E8B56BE23(num[2], unk6, 1, 1, 0);
				unk_0x2718E9CC165A99F6(uParam0->f_41[1], 1);
				unk_0x464B5B0F22497FC5(uParam0->f_41[1], -6.625818f, 1.30159f, -1.248891f, 0, 0);
			}
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[2]))
			{
				unk6 = { -915.6122f, 6137.662f, 4.6129f };
				uParam0->f_41[2] = unk_0xF19D6C0E8B56BE23(num[3], unk6, 1, 1, 0);
				unk_0x2EDDA32F6EF3C8B7(uParam0->f_41[2], -915.6122f, 6137.662f, 4.6129f, 0, 0, 1);
				unk_0x464B5B0F22497FC5(uParam0->f_41[2], -1.6843f, 2.1363f, -0.0913f, 0, 1);
				unk_0xA16BAE0DDDB68BAD(uParam0->f_41[2], -0.0147f, 0.0187f, -0.0011f, 0.9997f);
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[3]))
			{
				...
				uParam0->f_41[3] = unk_0xF19D6C0E8B56BE23(num[4], unk6, 1, 1, 0);
				unk_0x2EDDA32F6EF3C8B7(uParam0->f_41[3], -915.4199f, 6137.8555f, 4.6221f, 0, 0, 1);
				unk_0x464B5B0F22497FC5(uParam0->f_41[3], -5.793f, 1.496f, -36.333f, 2, 1);
				unk_0xA16BAE0DDDB68BAD(uParam0->f_41[3], -0.0439f, 0.0281f, -0.312f, 0.9487f);
...
BOOL func_253(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF984
{
...
BOOL func_254(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF9E0
{
	int num;
...
int func_255(var uParam0, eCharacter echParam1) // Position - 0xFA6E
{
	int num;
...
BOOL func_256(var uParam0) // Position - 0xFAB4
{
	if (func_216(uParam0))
	{
...
BOOL func_257(var uParam0) // Position - 0xFADE
{
	int i;
...
BOOL func_259(var uParam0) // Position - 0xFB4B
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_253(&uParam0->f_28[0], CHAR_MARY_ANN, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
					flag = false;
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[1]))
			{
				func_263(&uParam0->f_28[1], num[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
				func_261(&uParam0->f_35[0], num[2], 808.35f, 1277.2f, 360.15f, 216.5f);
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[1]))
				func_261(&uParam0->f_35[1], num[2], 807.89f, 1275.73f, 360.18f, 208.2f);
...
void func_261(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFE90
{
	func_262(uParam0);
...
void func_262(var uParam0) // Position - 0xFED2
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_263(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0xFF6E
{
	func_264(uParam0);
...
void func_264(var uParam0) // Position - 0xFF8F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_265(var uParam0) // Position - 0xFFD0
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				if (func_253(&uParam0->f_28[0], CHAR_MARY_ANN, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
BOOL func_266(int iParam0) // Position - 0x1012B
{
	var unk;
	eCharacter character;
...
BOOL func_267(int iParam0) // Position - 0x1017C
{
	var unk;
...
BOOL func_268(int iParam0) // Position - 0x10235
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0x102F6
{
	int i;
	var unk;
	int num;
...
BOOL func_271(int iParam0) // Position - 0x1045D
{
...
BOOL func_272(int iParam0) // Position - 0x10488
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_273(int iParam0) // Position - 0x104B3
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x104DE
{
	if (func_244(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1052D
{
	int i;
...
BOOL func_277(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10592
{
	int num;
	char* str;
...
BOOL func_278(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1060A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_279(var uParam0, BOOL bParam1) // Position - 0x10685
{
	char* str;
	...
	if (*uParam0 == 22)
		unk_0x17D46728E18012D3(uLocal_93, 0);
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x1081F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_290(var uParam0) // Position - 0x108A9
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_293(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10934
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_294(int iParam0) // Position - 0x10984
{
	if (*iParam0 == -1)
		return;
...
int func_298(eCharacter echParam0) // Position - 0x10A20
{
	if (!func_36(echParam0))
