...
void main() // Position - 0x0
{
	...
	sLocal_188 = "FBIPRD";
	uLocal_194 = { 0f, 0f, 0f };
	uLocal_197 = { -1335.3142f, -1277.9427f, 3.8649f };
	uLocal_200 = { -1336.3777f, -1279.0555f, 3.855f };
	iLocal_205 = -1;
	sLocal_212 = "FBIPRAU";
...
BOOL func_5(int iParam0) // Position - 0x2D1
{
	...
	func_6(&(Global_113648.f_2365.f_539), num2);
...
void func_6(var uParam0, int iParam1) // Position - 0x3E1
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_8(Global_113648.f_18535[i], &unk, &num2))
			{
...
void func_12() // Position - 0x1062
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_14(character) && !func_13(14) || Global_112599)
			{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1179
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x11B6
{
...
int func_17(eCharacter echParam0) // Position - 0x11DB
{
...
void func_23() // Position - 0x129C
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				unk_0x952D2B8A054C4FF8(unk_0xC1A5EC5C986B98AD(), -1335.9048f, -1278.6714f, 5.07569f, -1, 0, 2);
				iLocal_81 = 1;
			}
			break;
	
		case 1:
			if (func_93(unk_0xC1A5EC5C986B98AD(), uLocal_200, 2f, 1) && func_87(21))
			{
			...
			else
			{
				...
				if (bLocal_190)
				{
					uLocal_204 = unk_0xA5E11AF0A2B928C1();
					iLocal_81 = 2;
				}
				else if (!func_93(unk_0xC1A5EC5C986B98AD(), uLocal_197, 75f, 1))
				{
					if (!bLocal_207)
					{
						func_22(&uLocal_192);
					...
					func_84(&uLocal_192, uLocal_200, 1, true, "PRD_SHOP");
				}
				else if (func_93(unk_0xC1A5EC5C986B98AD(), uLocal_200, 12f, 1))
				{
					if (bLocal_207)
					{
						func_22(&uLocal_192);
					...
					func_84(&uLocal_192, uLocal_200, 1, true, "PRD_BLIP");
		...
		case 2:
			if (unk_0xA5E11AF0A2B928C1() - uLocal_204 > 2000)
			{
				func_22(&uLocal_192);
			
				if (func_43(&uLocal_382, &uLocal_378, &uLocal_213))
				{
					func_42(false, -1);
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x15B6
{
	if (unk_0x7DE17ACDD8BA2642(uParam0))
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x173E
{
	BOOL flag;
...
BOOL func_33(int iParam0) // Position - 0x17D6
{
...
int func_35(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1823
{
	int num;
...
void func_39(BOOL bParam0, BOOL bParam1) // Position - 0x18B6
{
	int num;
	int num2;
	int num3;
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_78805.f_1 == 1 && func_40(Global_78805))
		{
		}
		else
		{
...
BOOL func_40(int iParam0) // Position - 0x1986
{
	switch (iParam0)
	{
		case 71:
...
BOOL func_43(var uParam0, char* sParam1, var uParam2) // Position - 0x1ACF
{
	switch (*uParam0)
	{
		case 0:
			if (func_82())
			{
				if (func_81(74) || func_81(75) && func_80())
				{
					...
					else
					{
						...
						if (func_60(uParam2, func_76(), _GET_CURRENT_PLAYER_CHARACTER(), "FBIPRAU", func_75(), 9, 1, 0, 0, false))
						{
							*sParam1 = { func_59(true) };
							func_78(46, true);
							*uParam0 = 1;
						}
					}
...
BOOL func_45(int iParam0) // Position - 0x1C81
{
	if (iParam0 == 1)
...
void func_50() // Position - 0x1D55
{
	...
	func_51(func_54(), 0, _GET_CURRENT_PLAYER_CHARACTER(), func_76(), 9, 6000, 6000, -1, 0, -1, 0);
	return;
}

int func_51(int iParam0, int iParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1DAC
{
	int num;
	int num2;
...
void func_52(eCharacter echParam0) // Position - 0x1EFD
{
	int i;
	int num;
	int j;
...
BOOL func_56(int iParam0, int iParam1) // Position - 0x2157
{
	return false;
}

int func_57(eCharacter echParam0) // Position - 0x21B0
{
	...
	return Global_98159[func_58(echParam0)];
}

int func_58(eCharacter echParam0) // Position - 0x21E1
{
...
BOOL func_60(var uParam0, eCharacter echParam1, eCharacter echParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x2282
{
	func_74(uParam0, echParam1, sParam3, iParam7, iParam8, 0);
...
BOOL func_61(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x22EA
{
	Global_21726 = 0;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x2662
{
	return IS_BIT_SET(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x267A
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x27E2
{
	if (func_13(14))
	{
...
void func_74(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x296A
{
...
eCharacter func_76() // Position - 0x2AC8
{
	eCharacter num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2B01
{
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x2B9C
{
...
{
	if (bParam0)
		func_51(1527885205, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 0, -1, 0);
	else if (!func_81(3))
		func_51(-224691627, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 50, -1, 0);
	else
		func_51(-224691627, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 0, -1, 0);

	return;
}

BOOL func_80() // Position - 0x2C52
{
...
BOOL func_81(int iParam0) // Position - 0x2C7D
{
...
BOOL func_83(int iParam0) // Position - 0x2CF1
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_84(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, char* sParam6) // Position - 0x2D1E
{
	if (!unk_0xCE4AAA035282336C(*uParam0))
	{
		*uParam0 = func_85(uParam1, 5, iParam4);
...
int func_85(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x2D4D
{
	int num;
...
BOOL func_86(char* sParam0, int iParam1, int iParam2) // Position - 0x2D7B
{
...
BOOL func_87(int iParam0) // Position - 0x2D99
{
	return func_88(iParam0, 6, true);
}

BOOL func_88(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2DA9
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_92() == 0)
			return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_91(iParam0), -1, 0), iParam1);
	else
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x2E0A
{
	var unk;
	int num;
	...
	{
		iParam2 == 0;
		unk = Global_2805027[empsParam0 /*3*/][func_90(iParam1)];
...
int func_90(int iParam0) // Position - 0x2E47
{
	int num;
	int num2;
...
eMPStat func_91(int iParam0) // Position - 0x2E7B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x321F
{
	return SYSTEM::VDIST2(unk_0x30BE8A934C020461(uParam0, iParam5), vParam1) <= fParam4 * fParam4;
}

BOOL func_94(int iParam0, BOOL bParam1) // Position - 0x323D
{
	func_99();
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_97(1, uLocal_194, 0))
			{
				return true;
			}
			break;
		...
		case 1:
			if (bParam1)
			{
				func_95(unk_0xC1A5EC5C986B98AD(), -1339.7863f, -1277.5099f, 3.8874f, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
		...
		case 2:
			if (bParam1)
			{
				func_95(unk_0xC1A5EC5C986B98AD(), uLocal_200, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_95(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x32E8
{
	if (func_250(uParam0))
		unk_0x909F139DC199D8E0(uParam0);

	func_96(uParam0, fParam1, fParam4, false, 1);
	return;
}

BOOL func_96(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x330E
{
	BOOL flag;
	float num;
...
BOOL func_97(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x336A
{
	switch (iParam0)
	{
		case 0:
			if (func_98(uParam1, uLocal_194, 1056964608, false) && iParam4 == 0f)
				return true;
			break;
...
BOOL func_98(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, int iParam6, BOOL bParam7) // Position - 0x33D2
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
void func_101() // Position - 0x34B1
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!bLocal_203)
			{
				if (func_93(unk_0xC1A5EC5C986B98AD(), uLocal_197, 60f, 1))
				{
		...
		case 3:
			func_95(unk_0xC1A5EC5C986B98AD(), uLocal_200, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
{
	return func_88(iParam0, 5, true);
}

void func_106(char* sParam0, var uParam1) // Position - 0x36A1
{
	if (!*uParam1)
	{
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x36BE
{
	iParam2 = iParam2;
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_94(iLocal_80, false))
			{
				...
				if (_IS_MISSION_REPLAY_IN_PROGRESS())
				{
					func_114(&unk2, -1327.1753f, -1290.8113f, 3.8472f, 291.8355f, 0, 0, 0, 0, 0, joaat("asterope"), 0, _CHAR_NULL, 1);
					func_111(0, -1, 1);
					unk = unk_0xA5E11AF0A2B928C1();
				
					while (!func_110(21) && unk_0xA5E11AF0A2B928C1() - unk < 2000)
					{
						SYSTEM::WAIT(0);
					}
...
void func_109(var uParam0) // Position - 0x37FC
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_113() // Position - 0x3931
{
	return IS_BIT_SET(Global_100681.f_20, 13);
}

void func_114(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x3942
{
	int num;

	num = 1;

	if (!_IS_MISSION_REPLAY_IN_PROGRESS() || !func_234())
		num = 0;
	...
	if (num == 1)
	{
		...
		*uParam0 = func_203(fParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_202(fParam1, 0f, 0f, 0f, false))
		{
		...
		func_193(fParam1, 5f, 0);
	
		if (func_14(echParam12))
		{
			func_191(echParam12, 0);
		
			while (!func_115(uParam0, echParam12, fParam1, fParam4, true, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
BOOL func_115(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3AD6
{
	var unk;
	var unk2;
	int num;
	...
	if (func_14(echParam1))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_190(echParam1, &num, iParam7);
		...
		if (Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == num)
		{
			...
			if (unk_0x0CBB7C273DED26E7(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = unk_0xABEEDBEF2BBDF5B3(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_182(uParam0, &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == num)
		{
			...
			if (unk_0x0CBB7C273DED26E7(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = unk_0xABEEDBEF2BBDF5B3(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_182(uParam0, &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				unk_0x6251E3530642F38E(*uParam0, num.f_96);
		...
		else
		{
			...
			if (unk_0x0CBB7C273DED26E7(num))
			{
				...
				*uParam0 = unk_0xABEEDBEF2BBDF5B3(num, uParam2, fParam5, 1, 1, 0);
				...
				func_182(uParam0, &(num.f_31), &(num.f_81));
				unk_0x6251E3530642F38E(*uParam0, num.f_96);
				...
				else if (echParam1 == CHAR_MICHAEL && !Global_113648.f_2365.f_539.f_4316 && Global_113648.f_9087.f_99.f_58[131] && unk_0x504B9BB48D41C264(*uParam0) == joaat("tailgater"))
				{
					...
					func_116(echParam1, uParam0, 0, true);
				}
...
void func_116(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x48F7
{
	var unk;
	var unk2;
	int num;
	...
	if (func_14(echParam0) && unk_0x7DE17ACDD8BA2642(*uParam1) && unk_0xFBD273FDBCF0C5BD(*uParam1, 0))
	{
		...
		if (unk_0x5764B6FBEED065BB(*uParam1) >= 0 && func_121(*uParam1, false, &unk))
		{
			func_120(uParam1, &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_113648.f_20120[echParam0 /*43*/].f_31 = func_119(*uParam1);
				...
				func_117(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num2, true, &(Global_113648.f_20120[echParam0 /*43*/].f_1));
				...
				func_117(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num2, false, &(Global_113648.f_20120[echParam0 /*43*/].f_2));
			}
		}
	}
...
int func_117(int iParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4) // Position - 0x550B
{
	...
	for (i = 0; func_118(i, &unk, &num, &num2, &num3); i = i + 1)
	{
...
float func_119(var uParam0) // Position - 0x6A70
{
	int num;
	int num2;
	int num3;
...
int func_120(var uParam0, var uParam1, var uParam2) // Position - 0x6B20
{
	int i;
	int num;
...
BOOL func_121(var uParam0, BOOL bParam1, var uParam2) // Position - 0x6D13
{
	int num;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_153(num, bParam1, uParam2) && !func_152(unk_0x93E99A2DBCBA9CFA()) && !func_133(uParam0))
		return false;
	...
	if (func_130(unk_0x93E99A2DBCBA9CFA()) && unk_0x2D92D1084D213DC4(num) || unk_0xAF4434A9F7368F35(num))
		flag = true;

	if (unk_0xCC4A4E244DA78599(uParam0) && !func_127(uParam0) && !flag && !(func_126(unk_0x504B9BB48D41C264(uParam0)) && func_123(unk_0x93E99A2DBCBA9CFA())))
	{
	...
	if (!unk_0xA26A9A07F761D8F8())
	{
		if (func_122(uParam0) && unk_0x504B9BB48D41C264(uParam0) != joaat("sentinel2") && unk_0x504B9BB48D41C264(uParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
BOOL func_122(var uParam0) // Position - 0x6E81
{
	int i;
...
BOOL func_123(Player plParam0) // Position - 0x6EBC
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7) == 11;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x73B7
{
	int num;
...
BOOL func_126(int iParam0) // Position - 0x7417
{
...
BOOL func_127(var uParam0) // Position - 0x7459
{
	switch (unk_0x504B9BB48D41C264(uParam0))
	{
...
BOOL func_128(Player plParam0) // Position - 0x7521
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7) == 26;

	return false;
}

BOOL func_129(Player plParam0) // Position - 0x7568
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7) == 13;

	return false;
}

BOOL func_130(Player plParam0) // Position - 0x75AF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7) == 7;

	return false;
}

BOOL func_131(int iParam0) // Position - 0x75F5
{
...
BOOL func_132(Player plParam0) // Position - 0x7636
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_133(var uParam0) // Position - 0x765C
{
...
BOOL func_134(var uParam0) // Position - 0x768B
{
	...
	if (func_138(uParam0, false))
		return true;

	if (func_137(unk_0x93E99A2DBCBA9CFA()) && !func_131(unk_0x504B9BB48D41C264(uParam0)) || unk_0x091E6E360116B927(uParam0, joaat("thruster")))
		return false;
...
BOOL func_135(var uParam0) // Position - 0x773C
{
	int num;
	...
	if (unk_0x7DE17ACDD8BA2642(uParam0) && unk_0xFBD273FDBCF0C5BD(uParam0, 0))
	{
		...
		if (unk_0xCC4A4E244DA78599(uParam0) && !func_127(uParam0) || func_136(num))
			return true;
...
BOOL func_136(int iParam0) // Position - 0x77B3
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_137(Player plParam0) // Position - 0x7803
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_152(plParam0) && Global_2657589[plParam0 /*466*/].f_321.f_10 == plParam0)
		return true;

	return false;
}

BOOL func_138(var uParam0, BOOL bParam1) // Position - 0x783C
{
	switch (unk_0x504B9BB48D41C264(uParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_140(unk_0x504B9BB48D41C264(uParam0), 0))
				if (Global_2793044.f_304 == uParam0)
					return true;
				else if (func_139(uParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_139(var uParam0) // Position - 0x7897
{
	int i;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x78D0
{
	if (iParam1 == 0)
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x7DD7
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_150(Player plParam0) // Position - 0x81B6
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[plParam0 /*466*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7) == 5;

	return false;
}

BOOL func_151(Player plParam0) // Position - 0x8215
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[plParam0 /*466*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7) == 8;

	return false;
}

BOOL func_152(Player plParam0) // Position - 0x8275
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7) == 9;

	return false;
}

BOOL func_153(int iParam0, BOOL bParam1, var uParam2) // Position - 0x82BC
{
	BOOL flag;
...
BOOL func_154(int iParam0) // Position - 0x8708
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_155(var uParam0, eCharacter echParam1) // Position - 0x8731
{
	var unk;
	int i;
	int j;
	...
	func_156(uParam0, &(Global_113648.f_32751.f_5510));
	return;
}

void func_156(var uParam0, var uParam1) // Position - 0x8933
{
	int i;
		...
		*uParam1 = unk_0x46177D0BA2953EC5(uParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x175FDAC9EB940479(uParam0, i + 1))
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(i + 1));
		}
...
BOOL func_158(int iParam0) // Position - 0x8C8E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_160(var uParam0) // Position - 0x8D5E
{
	if (!unk_0x7DE17ACDD8BA2642(uParam0) || !unk_0xFBD273FDBCF0C5BD(uParam0, 0) || func_177(uParam0, 0, false) || func_177(uParam0, 1, false) || func_177(uParam0, 2, false) || func_176(uParam0) != _CHAR_NULL || func_175(uParam0) || func_174(uParam0) || func_122(uParam0) || func_173(uParam0) || !func_161(unk_0x504B9BB48D41C264(uParam0)))
	{
		func_174(uParam0);
		func_174(uParam0);
		func_177(uParam0, 0, false);
		func_177(uParam0, 1, false);
		func_177(uParam0, 2, false);
		func_176(uParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_161(int iParam0) // Position - 0x8E3B
{
	if (iParam0 == 0)
		return false;

	if (!func_162(iParam0, false, -1))
		return false;
...
BOOL func_162(int iParam0, BOOL bParam1, int iParam2) // Position - 0x8FED
{
	int i;
	var unk;
...
BOOL func_163(int iParam0) // Position - 0x916F
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x923B
{
	if (unk_0xCC17806DB0C41C19())
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x9252
{
	BOOL num;
	var unk;
...
BOOL func_168() // Position - 0xC8AF
{
	return false;
}

BOOL func_169() // Position - 0xC8B8
{
	return true;
}

BOOL func_170() // Position - 0xC8C1
{
	return true;
}

BOOL func_171() // Position - 0xC8CA
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xC8E3
{
	var unk;
...
BOOL func_173(var uParam0) // Position - 0xC99B
{
	int num;
	var unk;
	...
	if (!func_162(num, false, -1))
		return true;

	return false;
}

BOOL func_174(var uParam0) // Position - 0xC9E2
{
	int i;
...
BOOL func_175(var uParam0) // Position - 0xCA5E
{
	int i;
...
eCharacter func_176(var uParam0) // Position - 0xCB46
{
	int i;
...
BOOL func_177(var uParam0, int iParam1, BOOL bParam2) // Position - 0xCBA9
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_178(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_178(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xCC17
{
...
void func_179(var uParam0, eCharacter echParam1) // Position - 0xCCEF
{
	int i;
...
void func_180(var uParam0) // Position - 0xCD71
{
	if (!func_181(*uParam0))
...
BOOL func_181(var uParam0) // Position - 0xCD9C
{
	return unk_0x175FDAC9EB940479(uParam0, 5);
}

int func_182(var uParam0, var uParam1, var uParam2) // Position - 0xCDAB
{
	int i;
	int num;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (unk_0xCA36A30E79A35222(*uParam0, num) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_187(*uParam0, num, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_149(unk_0x504B9BB48D41C264(*uParam0), 1) && unk_0xCA36A30E79A35222(*uParam0, 24) != func_185(*uParam0, uParam1->[38] - 1))
		unk_0x886F6B56E2966139(*uParam0, 24, func_185(*uParam0, uParam1->[38] - 1), 0);
...
BOOL func_183(var uParam0) // Position - 0xCF85
{
	int i;
	int num;
	int num2;
...
int func_185(var uParam0, int iParam1) // Position - 0xD0B8
{
	int value;
	int value2;
	float num;
	...
	if (unk_0x7DE17ACDD8BA2642(uParam0) && unk_0xFBD273FDBCF0C5BD(uParam0, 0))
	{
		...
		value = func_186(uParam0, 38) + 1;
		value2 = func_186(uParam0, 24) + 1;
...
int func_186(var uParam0, int iParam1) // Position - 0xD1A1
{
	int i;
	...
	for (i = unk_0xF66CFEE3C6DDCF4D(uParam0, iParam1) - 1; i >= 0 && func_187(uParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_187(var uParam0, int iParam1, int iParam2) // Position - 0xD203
{
...
BOOL func_188() // Position - 0xD227
{
	return false;
}

BOOL func_189(var uParam0, var uParam1) // Position - 0xD230
{
	if (unk_0xA26A9A07F761D8F8())
	{
	}
...
void func_190(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xD271
{
	int num;
...
void func_191(eCharacter echParam0, int iParam1) // Position - 0xD4CD
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (unk_0x7DE17ACDD8BA2642(Global_98012[i]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x504B9BB48D41C264(Global_98012[i]) == func_192(echParam0, iParam1))
				{
...
int func_192(eCharacter echParam0, int iParam1) // Position - 0xD56B
{
	int num;
	...
	if (func_14(echParam0))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_190(echParam0, &num, iParam1);
		return num;
	}
	else
	{
...
void func_193(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xD5AD
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_201(&Global_77348.f_555[0 /*21*/], i))
...
BOOL func_198(int iParam0, int iParam1) // Position - 0xD8D0
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_199(&Global_113648.f_32751.f_5038[num /*157*/]))
		return false;

	return func_162(Global_113648.f_32751.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}
...
BOOL func_200(int iParam0, int iParam1) // Position - 0xD94E
{
	if (iParam0 == -1)
		return false;
...
BOOL func_201(var uParam0, int iParam1) // Position - 0xD96E
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	switch (iParam1)
	{
		case 0:
			*uParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			uParam0->f_4 = func_192(CHAR_MICHAEL, 1);
			uParam0->f_12 = 0;
		...
		case 2:
			*uParam0 = { -22.6297f, -1439.1368f, 29.6549f };
			...
			uParam0->f_4 = func_192(CHAR_FRANKLIN, 1);
			uParam0->f_12 = 1;
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 20);
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 7);
			num = 1;
		...
		case 3:
			*uParam0 = { -22.5229f, -1434.6986f, 29.6552f };
			...
			uParam0->f_4 = func_192(CHAR_FRANKLIN, 2);
			uParam0->f_12 = 1;
		...
		case 6:
			*uParam0 = { 1981.4163f, 3808.1313f, 31.1384f };
			...
			uParam0->f_4 = func_192(CHAR_TREVOR, 1);
			uParam0->f_12 = 2;
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 20);
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 7);
			num = 1;
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_202(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_202(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_202(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
BOOL func_202(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xF05C
{
	if (bParam6)
...
var func_203(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF0A3
{
	return func_204(&(Global_107196.f_2890), uParam0, fParam3, false);
}

var func_204(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF0BD
{
	var unk;
	Vector3 vector;
	BOOL flag;
	...
	if (func_227(uParam0))
	{
		if (func_202(uParam1, 0f, 0f, 0f, false))
		{
			uParam1 = { *uParam0 };
			fParam4 = uParam0->f_6;
		}
		...
		if (func_226(uParam0))
		{
			...
			if (unk_0x7DE17ACDD8BA2642(unk))
			{
				...
				func_208(unk, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_179(unk, uParam0->f_11);
				}
				else if (!func_206(unk, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && unk_0x4310A0DB886F9FED(unk_0x688846D56810779A(), "startup_positioning"))
				{
					num = func_205(unk);
...
int func_205(var uParam0) // Position - 0xF36F
{
	int i;
	var unk;
	var unk2;
...
BOOL func_206(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xF432
{
	int num;
	var unk;
	int num2;
	...
	{
		case joaat("cargobob"):
			if (func_207(uParam0, Global_77348.f_139[38], false))
			{
				func_194(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_207(uParam0, Global_77348.f_139[43], true))
			{
				func_194(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_207(uParam0, unk[i], true) && func_98(unk_0x30BE8A934C020461(unk[i], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_202(uParam1, 0f, 0f, 0f, false) || unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(uParam0, 1), unk_0x30BE8A934C020461(unk[i], 1), 1) < 10f)
					{
...
BOOL func_207(var uParam0, var uParam1, BOOL bParam2) // Position - 0xF63A
{
	var unk;
	var unk2;
	var unk3;
...
void func_208(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF69B
{
	int num;
	int num2;
	int i;
	...
	if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(num + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(num2 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			for (i = 1; i <= 9; i = i + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(i));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			for (j = 1; j <= 6; j = j + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(j));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			for (k = 1; k <= 11; k = k + 1)
			{
				if (k != 9 && k != 10)
				{
					...
					{
						unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(k));
					}
				}
			}
		}
		else if (uParam1->f_66 == -1035489563)
		{
			for (l = 1; l <= 2; l = l + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(l));
				}
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			for (m = 1; m <= 2; m = m + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_157(m));
				}
			}
		}
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_216(uParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_215())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
			func_182(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		...
		if (func_209() && unk_0xAF4434A9F7368F35(uParam1->f_66) && unk_0xDA1D0C30C85358D4(uParam0) && !unk_0x091E6E360116B927(uParam0, joaat("avenger")))
...
BOOL func_210(int iParam0) // Position - 0xFE11
{
	int num;
...
BOOL func_211(int iParam0) // Position - 0xFE35
{
	int num;
...
BOOL func_213(var uParam0, int iParam1) // Position - 0xFE67
{
	int num;
	int num2;
	int num3;
...
void func_214(var uParam0, var uParam1) // Position - 0xFE8A
{
	int num;
	int num2;
...
BOOL func_216(var uParam0) // Position - 0xFF13
{
	int num;
...
int func_217(var uParam0) // Position - 0xFF5B
{
	if (!func_188() && func_218(uParam0))
		return 1;

	return 0;
}

BOOL func_218(int iParam0) // Position - 0xFF7B
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_219(var uParam0) // Position - 0xFFCE
{
...
int func_220(var uParam0) // Position - 0x10057
{
...
{
	if (func_223(iParam0, false))
		return Global_1894573[iParam0 /*608*/].f_10.f_182;

	return -1;
}

BOOL func_223(int iParam0, BOOL bParam1) // Position - 0x100C6
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x10124
{
	var unk;
...
BOOL func_226(var uParam0) // Position - 0x10171
{
	if (func_227(uParam0))
	{
...
BOOL func_227(var uParam0) // Position - 0x101A6
{
	if (uParam0->f_12.f_66 == 0)
		return 0;

	if (!func_162(uParam0->f_12.f_66, false, -1))
		return 0;

	if (uParam0->f_12.f_66 == joaat("stunt") && func_98(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false))
		return 0;
...
BOOL func_231(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1024A
{
...
BOOL func_232() // Position - 0x102D8
{
	float num;
...
BOOL func_233(int iParam0) // Position - 0x1034D
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_237() // Position - 0x10459
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_93(unk_0xC1A5EC5C986B98AD(), uLocal_197, 150f, 1))
				{
					func_243(2);
				}
				else if (!func_93(unk_0xC1A5EC5C986B98AD(), uLocal_197, 75f, 1))
...
BOOL func_238() // Position - 0x10516
{
	int num;
	...
	if (!func_239(bLocal_190, num) && !bLocal_190)
		return false;

	return true;
}

BOOL func_239(BOOL bParam0, int iParam1) // Position - 0x10552
{
	int num;
...
BOOL func_245() // Position - 0x10644
{
	func_246();
		...
		switch (_GET_CURRENT_PLAYER_CHARACTER())
		{
			case CHAR_MICHAEL:
				if (Global_113648.f_2365.f_539.f_2395[0] == -99)
					func_247(uLocal_208[0], uLocal_208[1], uLocal_208[2]);
				else if (Global_113648.f_2365.f_539.f_2395[1] == -99)
					func_247(uLocal_208[1], uLocal_208[0], uLocal_208[2]);
				else if (Global_113648.f_2365.f_539.f_2395[2] == -99)
					func_247(uLocal_208[2], uLocal_208[1], uLocal_208[0]);
				break;
...
void func_247(var uParam0, var uParam1, var uParam2) // Position - 0x1083F
{
...
int func_249() // Position - 0x10890
{
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (Global_113648.f_2365.f_539.f_2395[i] != -99)
			num = num + 1;
	}
...
BOOL func_250(var uParam0) // Position - 0x108CC
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void func_251() // Position - 0x108EC
{
	...
	if (func_241(num) < 1500)
		func_252(_GET_CURRENT_PLAYER_CHARACTER(), 96, 1500, false, false);

	return;
}

void func_252(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1093C
{
	int num;
	int num2;

	if (func_282(echParam0) == 3)
		return;

	if (func_282(echParam0) == 4)
		return;

	func_253(func_282(echParam0), 1, iParam1, iParam2, false);
...
void func_256(int iParam0) // Position - 0x112E9
{
	BOOL flag;
	var unk;
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_258() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x061B1200C95204CB(&(Global_113648.f_20566.f_471), iParam0);
		unk_0x061B1200C95204CB(&(Global_2359296[func_258() /*5568*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x11468
{
	switch (iParam0)
	{
		case 0:
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x11577
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_90(iParam2)];
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x115A7
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
BOOL func_262(int iParam0) // Position - 0x115E5
{
	int num;
	int num2;
	int num3;
	...
	return IS_BIT_SET(Global_2359296[func_258() /*5568*/].f_681.f_10, iParam0);
}
...
BOOL func_267(var uParam0, int iParam1) // Position - 0x11916
{
	int i;
	var unk;
...
void func_272(var uParam0, int iParam1) // Position - 0x11A97
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_277(int iParam0) // Position - 0x11B0D
{
	switch (iParam0)
	{
		case 60:
...
int func_282(eCharacter echParam0) // Position - 0x11CA3
{
	return Global_2028[echParam0 /*29*/].f_17;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x11CB4
{
...
void func_284(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x11CDC
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x11D71
{
...
{
	func_287(joaat("Player_Zero"), 14, 31, true);
	func_287(joaat("Player_Zero"), 14, 32, true);
	func_287(joaat("Player_Zero"), 14, 33, true);
	func_287(joaat("Player_Zero"), 14, 34, true);
	func_287(joaat("Player_Zero"), 14, 35, true);
	func_287(joaat("Player_Zero"), 14, 36, true);
	func_287(joaat("Player_Zero"), 14, 37, true);
	func_287(joaat("Player_Zero"), 14, 38, true);
	func_287(joaat("Player_Zero"), 14, 39, true);
	func_287(joaat("Player_Zero"), 14, 40, true);
	func_287(joaat("Player_Zero"), 14, 41, true);
	func_287(joaat("Player_Zero"), 14, 42, true);
	func_287(joaat("Player_Zero"), 14, 43, true);
	func_287(joaat("Player_Zero"), 14, 44, true);
	func_287(joaat("Player_Zero"), 9, 9, true);
	func_287(joaat("Player_Zero"), 9, 10, true);
	func_287(joaat("Player_Zero"), 9, 11, true);
	func_287(joaat("Player_Zero"), 9, 12, true);
	func_287(joaat("Player_Zero"), 9, 13, true);
	func_287(joaat("Player_Zero"), 9, 14, true);
	func_287(joaat("Player_One"), 14, 26, true);
	func_287(joaat("Player_One"), 14, 27, true);
	func_287(joaat("Player_One"), 14, 28, true);
	func_287(joaat("Player_One"), 14, 29, true);
	func_287(joaat("Player_One"), 14, 30, true);
	func_287(joaat("Player_One"), 14, 31, true);
	func_287(joaat("Player_One"), 14, 32, true);
	func_287(joaat("Player_One"), 14, 33, true);
	func_287(joaat("Player_One"), 14, 34, true);
	func_287(joaat("Player_One"), 14, 35, true);
	func_287(joaat("Player_One"), 14, 36, true);
	func_287(joaat("Player_One"), 14, 37, true);
	func_287(joaat("Player_One"), 14, 38, true);
	func_287(joaat("Player_One"), 14, 39, true);
	func_287(joaat("Player_One"), 9, 5, true);
	func_287(joaat("Player_One"), 9, 6, true);
	func_287(joaat("Player_One"), 9, 7, true);
	func_287(joaat("Player_One"), 9, 8, true);
	func_287(joaat("Player_One"), 9, 9, true);
	func_287(joaat("Player_One"), 9, 10, true);
	func_287(joaat("Player_Two"), 14, 49, true);
	func_287(joaat("Player_Two"), 14, 50, true);
	func_287(joaat("Player_Two"), 14, 51, true);
	func_287(joaat("Player_Two"), 14, 52, true);
	func_287(joaat("Player_Two"), 14, 53, true);
	func_287(joaat("Player_Two"), 14, 54, true);
	func_287(joaat("Player_Two"), 14, 55, true);
	func_287(joaat("Player_Two"), 14, 56, true);
	func_287(joaat("Player_Two"), 14, 57, true);
	func_287(joaat("Player_Two"), 14, 58, true);
	func_287(joaat("Player_Two"), 14, 59, true);
	func_287(joaat("Player_Two"), 14, 60, true);
	func_287(joaat("Player_Two"), 9, 9, true);
	func_287(joaat("Player_Two"), 9, 10, true);
	func_287(joaat("Player_Two"), 9, 11, true);
	func_287(joaat("Player_Two"), 9, 12, true);
	func_287(joaat("Player_Two"), 9, 13, true);
	func_287(joaat("Player_Two"), 9, 14, true);
	func_287(joaat("Player_Two"), 9, 15, true);
	func_287(joaat("Player_Two"), 9, 16, true);
	return;
}
...
BOOL func_288(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1217B
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_291(int iParam0) // Position - 0x13160
{
	...
	switch (iParam0)
	{
		...
		default:
			func_299(num6, iParam0, 155, -1);
			return;
	}

	func_292(&Global_78341[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_292(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x143D8
{
	int num;
	eMPStat stat;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_296(Global_2883588, 1, true, true, -1))
				unk_0x061B1200C95204CB(&(iParam0->f_6), 2);
		
			if (!func_296(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_288(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			unk_0xECDAB41968FF21A8(&(iParam0->f_6), 1);
	
		if (func_288(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			unk_0xECDAB41968FF21A8(&(iParam0->f_6), 2);
	
		if (!func_288(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			unk_0xECDAB41968FF21A8(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = _MPCHAR_STAT_GET_INT(func_295(iParam1, iParam0->f_2), Global_78338, 0);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				unk_0xECDAB41968FF21A8(&(iParam0->f_6), 1);
		
			num = _MPCHAR_STAT_GET_INT(func_294(iParam1, iParam0->f_2), Global_78338, 0);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				unk_0xECDAB41968FF21A8(&(iParam0->f_6), 2);
		
			if (func_293(iParam1, iParam0->f_2, &stat))
			{
...
eMPStat func_294(int iParam0, int iParam1) // Position - 0x14B82
{
	switch (iParam1)
	{
		case 0:
...
eMPStat func_295(int iParam0, int iParam1) // Position - 0x14F7D
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_296(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x15378
{
	int num;
	int num2;
	eMPStat stat;
	...
	if (func_297(uParam0, iParam1, &stat, &num2, bParam2, bParam3))
	{
...
void func_299(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x17C9A
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_292(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_292(&Global_78341[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_292(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x7FEA86016BC12607(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_292(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x7FEA86016BC12607(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
		...
		if (num7 >= 0)
		{
			num8 = unk_0xDAEB80C06A5C96B9(unk, 10, -1, 0, -1, func_300(iParam0));
...
void func_357(var uParam0, int iParam1) // Position - 0x29270
{
	...
	{
		func_361(&uLocal_82, uParam0->[i /*3*/]);
	}
...
void func_358(var uParam0, var uParam1, float fParam2) // Position - 0x292B4
{
	...
	while (num2 < uParam1->f_46)
	{
		...
		if (func_359(uParam1, uParam1->[num2 /*3*/] + num6))
			num6 = { -num6 };
...
BOOL func_359(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x293C1
{
	BOOL flag;
	int num;
	int num2;
...
void func_361(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2951D
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
{
	uLocal_208[0] = "PRD_BUYM";
	uLocal_208[1] = "PRD_BUYF";
	uLocal_208[2] = "PRD_BUYT";
	return;
}
...
BOOL func_378() // Position - 0x2979F
{
	if (Global_100681 == 13 || Global_100681 == 10 || Global_100681 == 11 || Global_100681 == 12)
		return false;
