...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_316(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	if (!func_296(&unk63, &num, vector, 1f))
	{
		func_295();
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1))
		{
			if (num == 30)
			{
				if (func_227(PLAYER::PLAYER_PED_ID(), -1102.7241f, 290.1463f, 63.23002f, true) < 200f)
				{
		...
		func_225(num);
		func_218(&iLocal_93, &(num.f_9), vector);
	
		if (num == 27)
		{
			func_216(&num, vector, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (num == 28)
		{
			func_216(&num, vector, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (num == 29)
		{
			func_216(&num, vector, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (num == 30)
		{
			if (iLocal_263 == 0)
		...
		if (func_187(&num, 0) || func_186(&num) || func_184(&num) || func_182(&num))
		{
			if (func_181(num))
				func_178(num, &blLocal_262);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x497C
{
	int num;
	int dlcWeaponIndex;
	int i;
...
BOOL func_77(int iParam0) // Position - 0x6AEF
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AFF
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7616
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7640
{
...
BOOL func_85(Player plParam0) // Position - 0x766C
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x776E
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7803
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x84A2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8524
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_97(Player plParam0) // Position - 0x8801
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x881E
{
...
int func_106(int iParam0) // Position - 0x8D67
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D89
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8DA0
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E5E
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8ED0
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8EE6
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8EFC
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F3E
{
...
BOOL func_122(Any* panParam0) // Position - 0xA9D1
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAB6F
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAC4B
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD44
{
...
int func_134(Ped pedParam0) // Position - 0xADAB
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xADF4
{
...
BOOL func_136(int iParam0) // Position - 0xAE14
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAEE4
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF37
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xB02C
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0D6
{
	if (bParam0)
	{
...
BOOL func_144(Player plParam0, int iParam1) // Position - 0xB23D
{
	BOOL flag;
...
BOOL func_146(Player plParam0) // Position - 0xB2D7
{
	Player player;
...
BOOL func_147(Player plParam0) // Position - 0xB2F9
{
...
int func_149(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB346
{
	int num;
...
BOOL func_152(const char* sParam0) // Position - 0xB3C3
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB467
{
...
BOOL func_158(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4F6
{
...
void func_159(Vehicle veParam0) // Position - 0xB68E
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_165(int iParam0) // Position - 0xB84A
{
	if (iParam0 == 1)
...
BOOL func_167(int iParam0) // Position - 0xB8B0
{
...
BOOL func_168(int iParam0) // Position - 0xB8F1
{
	int num;
...
int func_170(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB968
{
	int i;
...
void func_171(int iParam0, int iParam1) // Position - 0xBA9F
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAEE
{
	return func_173(iParam0, Global_43377);
}

BOOL func_173(int iParam0, int iParam1) // Position - 0xBAFF
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_174(int iParam0) // Position - 0xBCE0
{
	if (Global_43377 == 15)
		return false;
...
int func_176(const char* sParam0, int iParam1) // Position - 0xBD13
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD5C
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_178(int iParam0, var uParam1) // Position - 0xBD80
{
	switch (iParam0)
	{
		case 0:
...
Blip func_179(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC1F0
{
	Blip blip;
...
var func_180(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC21C
{
	if (bParam0)
		return uParam1;
...
BOOL func_181(int iParam0) // Position - 0xC233
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_182(var uParam0) // Position - 0xC2C2
{
	if (*uParam0 == 30)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (bLocal_261)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_183(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], true) <= 15f)
					{
						func_317("Special launching Josh 4 (not in vehicle)");
						return true;
					}
				}
				else if (func_183(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], true) <= 10f)
				{
...
float func_183(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xC341
{
...
BOOL func_184(var uParam0) // Position - 0xC39F
{
	if (*uParam0 == 29)
	{
		if (func_227(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, true) < 6f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
			...
			else if (!func_185(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_158(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_185(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC432
{
...
int func_186(var uParam0) // Position - 0xC465
{
	if (*uParam0 == 28)
	{
		if (func_227(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, true) < 9f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
			...
			else if (!func_185(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_158(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_189(var uParam0) // Position - 0xCCFA
{
	float num;
...
void func_190(int iParam0, var uParam1) // Position - 0xCD88
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_191(BOOL bParam0) // Position - 0xCDEC
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_192(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_192(Vehicle veParam0) // Position - 0xCE83
{
...
BOOL func_193(int iParam0) // Position - 0xCEAD
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_201() || Global_32286 || func_200() || func_199(8, -1) || func_197() || func_100() || func_198() || func_196() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_201() || Global_112857 || Global_32286 || func_200() || func_199(8, -1) || func_100() || func_198() || func_196() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_201() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_199(8, -1) || func_196() || func_195() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_194() // Position - 0xD5CA
{
	return Global_100872.f_1;
}

BOOL func_195() // Position - 0xD5D8
{
	if (Global_97735 != -1)
...
BOOL func_200() // Position - 0xD688
{
	return Global_1575063;
}

BOOL func_201() // Position - 0xD694
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_202() // Position - 0xD6B0
{
	switch (iLocal_94)
	{
		...
		case 1:
			if (func_227(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) <= 20f)
		...
		case 2:
			...
			else if (func_227(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) >= 25f)
			{
				func_153();
				bLocal_261 = true;
				iLocal_94 = 0;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD77C
{
...
BOOL func_204(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD7CA
{
	Global_21846 = 0;
...
BOOL func_207(Player plParam0) // Position - 0xDB32
{
	return func_208(plParam0, 20);
}

BOOL func_208(Player plParam0, int iParam1) // Position - 0xDB42
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDCBA
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDE0A
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
int func_216(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDE2B
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_227(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDEB3
{
...
void func_218(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDEEE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_227(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_221(uParam0, 1);
			}
			else
			{
				...
				if (func_227(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_223(uParam0);
			}
		}
	}
...
void func_221(var uParam0, int iParam1) // Position - 0xE054
{
	BOOL flag;
	int i;
...
void func_223(var uParam0) // Position - 0xE0FE
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(uParam0);
...
void func_224(var uParam0) // Position - 0xE115
{
	BOOL flag;
	int num;
	int i;
...
void func_226(var uParam0) // Position - 0xE225
{
	int i;
...
float func_227(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xE2A5
{
	Vector3 entityCoords;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE2DF
{
	var unk;
	...
	if (func_264(*panParam0) || func_262(*panParam0) || Global_78935 == 1)
		return true;
...
void func_229(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE54F
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_230(int iParam0) // Position - 0xE8A7
{
...
BOOL func_231(var uParam0) // Position - 0xE8C7
{
...
BOOL func_232(var uParam0) // Position - 0xE8DF
{
...
void func_234(Object* pobParam0) // Position - 0xEC08
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEC33
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_192(playersLastVehicle2))
						{
...
BOOL func_236(Ped pedParam0, Vehicle veParam1) // Position - 0xEDF1
{
...
BOOL func_237(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEE21
{
	int i;
	int num;
...
BOOL func_238(int iParam0) // Position - 0xF0DD
{
...
BOOL func_239(Ped pedParam0, int iParam1) // Position - 0xF111
{
	float xSize;
...
BOOL func_240(Ped pedParam0, int iParam1) // Position - 0xF187
{
	return func_241(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_241(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF19F
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_242(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF260
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_243(Ped pedParam0, int iParam1) // Position - 0xF38C
{
...
BOOL func_245(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF49B
{
	var unk;
...
float func_246(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF52C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_247(float fParam0, var uParam1, var uParam2) // Position - 0xF54D
{
	float num;
	float num2;
...
int func_249(Ped pedParam0, Ped pedParam1) // Position - 0xF5A7
{
	int i;
...
BOOL func_250(Ped pedParam0) // Position - 0xF5E6
{
...
BOOL func_251(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF60E
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_252(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF709
{
	float entityCoords;
	float num;
...
BOOL func_253(Ped pedParam0, float fParam1) // Position - 0xF815
{
	var outProjectile;
	var outCoords;
...
BOOL func_254(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF8AA
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_255(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF938
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_256(int iParam0) // Position - 0xF980
{
...
void func_257(Vehicle veParam0) // Position - 0xF9CA
{
	int taskSequenceId;
...
BOOL func_258(int iParam0) // Position - 0xFA67
{
	if (iParam0 == -1)
		iParam0 = func_175();
...
BOOL func_259(int iParam0) // Position - 0xFAFC
{
...
BOOL func_262(int iParam0) // Position - 0xFB7B
{
...
BOOL func_264(int iParam0) // Position - 0xFBED
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFC15
{
...
BOOL func_266(var uParam0) // Position - 0xFCB0
{
	switch (*uParam0)
	{
		case 27:
...
BOOL func_267(var uParam0) // Position - 0xFD25
{
	int num;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_279(&num) || !func_278(&(uParam0->f_48)))
				return false;
		
			if (!func_277(false, true))
			{
			}
		
			if (!func_276(true, true))
			{
			}
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_273(&uParam0->f_28[0], CHAR_JOSH, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
			...
			{
				func_271(&uParam0->f_28[1], num[2], -1102.92f, 290.12f, 64.28f, 40.46f, PED_TYPE_COP);
			...
			{
				func_271(&uParam0->f_28[2], num[2], -1102.73f, 290.91f, 64.28f, 92.06f, PED_TYPE_COP);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_269(&uParam0->f_35[0], num[3], -1107.5f, 280.33f, 64.01f, 97.97f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_268(&uParam0->f_35[1], false);
...
void func_268(Vehicle* pveParam0, BOOL bParam1) // Position - 0x1011E
{
	var unk;
	float num;
	...
	func_269(pveParam0, hLocal_91, unk, num);
...
void func_269(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10192
{
	func_270(pveParam0);
...
void func_270(Vehicle* pveParam0) // Position - 0x101D4
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_271(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x10270
{
	func_272(ppedParam0);
...
void func_272(Ped* ppedParam0) // Position - 0x10291
{
...
BOOL func_273(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x102D2
{
...
BOOL func_274(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1032E
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_320(echParam1);
...
int func_275(var uParam0, eCharacter echParam1) // Position - 0x103BC
{
	int num;
...
BOOL func_276(BOOL bParam0, BOOL bParam1) // Position - 0x10402
{
	int num;
...
BOOL func_277(BOOL bParam0, BOOL bParam1) // Position - 0x10470
{
	int num;
...
BOOL func_278(var uParam0) // Position - 0x10516
{
	if (func_232(uParam0))
	{
...
BOOL func_279(var uParam0) // Position - 0x10540
{
	int i;
...
BOOL func_281(var uParam0) // Position - 0x105AD
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_279(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh3"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_273(&uParam0->f_28[0], CHAR_JOSH, 566.1639f, -1773.8171f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
					flag = false;
...
void func_282(Vehicle* pveParam0) // Position - 0x10795
{
	func_269(pveParam0, hLocal_91, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*pveParam0, 4);
...
BOOL func_283(var uParam0) // Position - 0x107DB
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_279(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh2"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_273(&uParam0->f_28[0], CHAR_JOSH, 565.3901f, -1772.8378f, 29.80087f, 62.501556f, "JOSH LAUNCHER RC", 1))
					flag = false;
...
BOOL func_284(var uParam0) // Position - 0x109FE
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_273(&uParam0->f_28[0], CHAR_JOSH, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_268(&uParam0->f_35[0], true);
		
			if (!func_285(true, true))
				flag = false;
...
BOOL func_285(BOOL bParam0, BOOL bParam1) // Position - 0x10B6B
{
	int num;
...
BOOL func_286(int iParam0) // Position - 0x10BD9
{
	var unk;
	eCharacter character;
...
BOOL func_287(int iParam0) // Position - 0x10C2A
{
	const char* string2;
...
BOOL func_288(int iParam0) // Position - 0x10CE3
{
	var unk;
...
BOOL func_289(int iParam0) // Position - 0x10DA4
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_291(int iParam0) // Position - 0x10F0B
{
...
BOOL func_292(int iParam0) // Position - 0x10F36
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_293(int iParam0) // Position - 0x10F61
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_294(int iParam0) // Position - 0x10F8C
{
	if (func_259(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_296(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10FDB
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_297(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_297(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_297(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x11040
{
	int num;
	char* str;
	...
	if (func_298(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_298(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x110B8
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_299(var uParam0, BOOL bParam1) // Position - 0x11133
{
	char* str;
...
BOOL func_303(char* sParam0) // Position - 0x11231
{
	var string1;
...
void func_308(var uParam0, BOOL bParam1) // Position - 0x112DD
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_309(&uParam0->[i], false);
	}

	return;
}

void func_309(Object* pobParam0, BOOL bParam1) // Position - 0x1131B
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_312(Vehicle* pveParam0) // Position - 0x113A5
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_314(var uParam0, int iParam1) // Position - 0x113EF
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_315(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_315(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11430
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_316(int iParam0) // Position - 0x11480
{
	if (*iParam0 == -1)
		return;
...
Hash func_320(eCharacter echParam0) // Position - 0x1151C
{
	if (!func_36(echParam0))
