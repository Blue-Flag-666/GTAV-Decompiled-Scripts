...
void main() // Position - 0x0
{
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_311(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (!func_291(&unk64, &num, unk61, 1f))
	{
		func_290();
	...
	if (num == 27)
	{
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_97, 5, num.f_28[0], "JOSH", 0, 1);
	}
	else if (num == 30)
	{
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_97, 4, num.f_28[0], "JOSH", 0, 1);
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_97, 3, num.f_28[1], "JOSHCOP", 0, 1);
		uLocal_262 = unk_0xA5E11AF0A2B928C1();
	}
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1))
		{
			if (num == 30)
			{
				if (func_222(unk_0xC1A5EC5C986B98AD(), -1102.7241f, 290.1463f, 63.23002f, 1) < 200f)
				{
		...
		func_220(num);
		func_213(&iLocal_95, &(num.f_9), unk61);
	
		if (num == 27)
		{
			func_211(&num, unk61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (num == 28)
		{
			func_211(&num, unk61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (num == 29)
		{
			func_211(&num, unk61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (num == 30)
		{
			if (iLocal_265 == 0)
			{
				if (unk_0x3B7E6BE32C24780B())
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[1]))
					{
						...
						unk_0x414C472A4880EAA3("Cop_standing_idle", num.f_28[1], 0);
					}
				
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[2]))
					{
						func_312("Josh 4: Trying to set Cop 2 component variation");
						unk_0x414C472A4880EAA3("Cop_with_notepad", num.f_28[2], 0);
					}
		...
		if (func_182(&num, 0) || func_181(&num) || func_179(&num) || func_177(&num))
		{
			if (func_176(num))
				func_173(num, &uLocal_264);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3A19
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x3A56
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x3A96
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3AC2
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x400D
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x424E
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x46ED
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x478E
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E03
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65C6
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x660D
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6678
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x66D9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6A7D
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A8D
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7589
{
...
BOOL func_81(Player plParam0) // Position - 0x75B3
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76B5
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x774A
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x83E8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x846A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x84C2
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x876F
{
...
int func_102(int iParam0) // Position - 0x8CAB
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CCD
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8CE4
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DA2
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8E40
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E82
{
...
BOOL func_118(Any* panParam0) // Position - 0xA915
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAC88
{
...
BOOL func_131(var uParam0) // Position - 0xAD38
{
...
BOOL func_132(int iParam0) // Position - 0xAD58
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_134(int iParam0) // Position - 0xAE28
{
	switch (iParam0)
	{
		case 5:
...
void func_135(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE7B
{
	int i;
...
BOOL func_136(int iParam0) // Position - 0xAF70
{
	switch (iParam0)
	{
		case 5:
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB01A
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB181
{
	BOOL flag;
...
BOOL func_142(int iParam0) // Position - 0xB20D
{
...
int func_144(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB25A
{
	int num;
...
BOOL func_147(var uParam0) // Position - 0xB2D7
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB37B
{
...
BOOL func_153(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB40A
{
...
void func_154(var uParam0) // Position - 0xB5A2
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_160(int iParam0) // Position - 0xB75E
{
	if (iParam0 == 1)
...
BOOL func_162(int iParam0) // Position - 0xB7C4
{
...
BOOL func_163(int iParam0) // Position - 0xB805
{
	int num;
...
int func_165(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB87C
{
	int i;
...
void func_166(int iParam0, int iParam1) // Position - 0xB9B3
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA02
{
	return func_168(iParam0, Global_43257);
}

BOOL func_168(int iParam0, int iParam1) // Position - 0xBA13
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_169(int iParam0) // Position - 0xBBF4
{
	if (Global_43257 == 15)
		return false;
...
int func_171(var uParam0, int iParam1) // Position - 0xBC27
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC70
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_173(int iParam0, var uParam1) // Position - 0xBC94
{
	switch (iParam0)
	{
		case 0:
...
var func_174(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC103
{
	var unk;
...
var func_175(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC12F
{
	if (bParam0)
		return uParam1;
...
BOOL func_176(int iParam0) // Position - 0xC146
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_177(var uParam0) // Position - 0xC1D5
{
	if (*uParam0 == 30)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (bLocal_263)
			{
				if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
				{
					if (func_178(unk_0xC1A5EC5C986B98AD(), uParam0->f_28[0], 1) <= 15f)
					{
						func_312("Special launching Josh 4 (not in vehicle)");
						return true;
					}
				}
				else if (func_178(unk_0xC1A5EC5C986B98AD(), uParam0->f_28[0], 1) <= 10f)
				{
...
float func_178(var uParam0, var uParam1, int iParam2) // Position - 0xC254
{
	var unk;
	var unk4;
...
BOOL func_179(var uParam0) // Position - 0xC2B2
{
	if (*uParam0 == 29)
	{
		if (func_222(unk_0xC1A5EC5C986B98AD(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			{
			...
			else if (!func_180(unk_0xC1A5EC5C986B98AD(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0)) && func_153(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x6FE9A0C01D25F413(unk_0xC1A5EC5C986B98AD(), 0, 0);
			}
		}
...
BOOL func_180(var uParam0, int iParam1) // Position - 0xC345
{
	if (func_131(uParam0))
...
int func_181(var uParam0) // Position - 0xC378
{
	if (*uParam0 == 28)
	{
		if (func_222(unk_0xC1A5EC5C986B98AD(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			{
			...
			else if (!func_180(unk_0xC1A5EC5C986B98AD(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0)) && func_153(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 4f, 1, 1056964608, 0, true, false))
			{
				unk_0x6FE9A0C01D25F413(unk_0xC1A5EC5C986B98AD(), 0, 0);
			}
		}
...
BOOL func_184(var uParam0) // Position - 0xCC0D
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xCC9B
{
	if (iParam0 == 1)
	{
		if (!func_134(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xCCFF
{
	var unk;
...
BOOL func_187(var uParam0) // Position - 0xCD96
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_188(int iParam0) // Position - 0xCDC0
{
	eCharacter character;
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_196() || Global_112695 || Global_32166 || func_195() || func_194(8, -1) || func_96() || func_193() || func_192() || func_191() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_196() || Global_32166 || func_195() || func_194(8, -1) || func_192() || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_196() || Global_112695 || Global_32166 || func_195() || func_194(8, -1) || func_192() || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_196() || Global_112695 || Global_32166 || func_195() || func_194(8, -1) || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_196() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 || func_194(8, -1) || func_191() || func_190() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
BOOL func_189() // Position - 0xD4DD
{
	return Global_100720.f_1;
}

BOOL func_190() // Position - 0xD4EB
{
	if (Global_97603 != -1)
...
BOOL func_195() // Position - 0xD59B
{
	return Global_1575060;
}

BOOL func_196() // Position - 0xD5A7
{
	if (!unk_0xA26A9A07F761D8F8())
...
void func_197() // Position - 0xD5C3
{
	...
	{
		case 0:
			if (unk_0xA5E11AF0A2B928C1() - uLocal_262 > 100 && bLocal_263 == false)
				iLocal_96 = 1;
			break;
	
		case 1:
			if (func_222(unk_0xC1A5EC5C986B98AD(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
				if (_CONVERSATION_ADD_LINE(&uLocal_97, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
					iLocal_96 = 2;
			break;
		...
		case 2:
			...
			else if (func_222(unk_0xC1A5EC5C986B98AD(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_148();
				bLocal_263 = true;
				iLocal_96 = 0;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD68F
{
...
BOOL func_199(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD6DD
{
	Global_21726 = 0;
...
BOOL func_203(int iParam0, int iParam1) // Position - 0xDA55
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDBCD
{
	if (func_57(14))
	{
		if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0))
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDD1D
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
int func_211(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDD3E
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_222(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDDC6
{
...
void func_213(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDE01
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_222(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_216(uParam0, 1);
			}
			else
			{
				...
				if (func_222(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_218(uParam0);
			}
		}
	}
...
void func_216(var uParam0, int iParam1) // Position - 0xDF67
{
	BOOL flag;
	int i;
...
void func_218(var uParam0) // Position - 0xE011
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_219(uParam0);
...
void func_219(var uParam0) // Position - 0xE028
{
	BOOL flag;
	int num;
	int i;
...
void func_221(var uParam0) // Position - 0xE138
{
	int i;
...
float func_222(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xE1B8
{
	var unk;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE1F2
{
	var unk;
	...
	if (func_259(*panParam0) || func_257(*panParam0) || Global_78804 == 1)
		return true;
	...
	if (func_253(*panParam0))
	{
		if (*panParam0 == 19)
			func_252(panParam0->f_28[0]);
	...
	if (panParam0->f_25 == 1)
		if (!func_232(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_232(panParam0, false, 0))
			return false;
...
void func_224(int iParam0, var uParam1, int iParam2) // Position - 0xE462
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_226(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_225(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_226(uParam1) && uParam1->f_4 == 0 && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_225(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_225(int iParam0) // Position - 0xE7BA
{
...
BOOL func_226(var uParam0) // Position - 0xE7DA
{
...
BOOL func_227(var uParam0) // Position - 0xE7F2
{
...
void func_229(var uParam0) // Position - 0xEB1B
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB46
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_231(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_231(var uParam0, var uParam1) // Position - 0xED04
{
	var unk;
...
BOOL func_232(var uParam0, BOOL bParam1, int iParam2) // Position - 0xED34
{
	int i;
	int num;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_28[i]))
			{
				if (!unk_0x66599E73DBA5A850(uParam0->f_28[i]))
				{
					...
					if (func_251(*uParam0))
					{
						if (!func_162(*uParam0))
						{
							if (func_246(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_228(uParam0);
								else
						...
						if (func_234(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_228(uParam0);
							else
...
BOOL func_233(int iParam0) // Position - 0xEFF0
{
...
BOOL func_234(var uParam0, int iParam1) // Position - 0xF024
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_245(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_235(var uParam0, int iParam1) // Position - 0xF09A
{
	return func_236(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_236(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF0B2
{
	BOOL flag;
	var unk;
	int num;

	num = func_244(uParam0, uParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam1))
	{
		if (num != -1)
			func_243(&iLocal_37[num /*4*/]);
	
		return false;
	}

	if (!func_240(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_237(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_237(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF173
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_238(var uParam0, int iParam1) // Position - 0xF29F
{
	int num;
...
BOOL func_240(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF3AE
{
	var unk;
	var unk4;
	float num;

	unk = { func_242(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_242(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };
...
float func_241(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF43F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_242(float fParam0, var uParam1, var uParam2) // Position - 0xF460
{
	float num;
	float num2;
...
int func_244(var uParam0, var uParam1) // Position - 0xF4BA
{
	int i;
...
int func_245(var uParam0) // Position - 0xF4F9
{
...
BOOL func_246(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF521
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_250(uParam0, bParam1, num, num2))
				return true;
		
			if (func_247(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_247(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF61C
{
	float num;
	float num2;
...
BOOL func_248(var uParam0, float fParam1) // Position - 0xF728
{
	var unk;
	var unk2;
	...
	if (unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_249(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_249(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF7BD
{
	var unk;
	var unk4;
	float num;

	unk = { func_242(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_250(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF84B
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_251(int iParam0) // Position - 0xF893
{
...
void func_252(var uParam0) // Position - 0xF8DD
{
	var unk;
...
BOOL func_253(int iParam0) // Position - 0xF97A
{
	if (iParam0 == -1)
		iParam0 = func_170();
...
BOOL func_254(int iParam0) // Position - 0xFA0F
{
...
BOOL func_257(int iParam0) // Position - 0xFA8E
{
...
BOOL func_259(int iParam0) // Position - 0xFB00
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFB28
{
...
BOOL func_261(var uParam0) // Position - 0xFBC3
{
	switch (*uParam0)
	{
		case 27:
...
BOOL func_262(var uParam0) // Position - 0xFC38
{
	int num;
	int i;
	float num2;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_274(&num) || !func_273(&(uParam0->f_48)))
				return false;
		
			if (!func_272(false, true))
			{
			}
		
			if (!func_271(true, true))
			{
			}
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (func_268(&uParam0->f_28[0], CHAR_JOSH, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
			...
			{
				func_266(&uParam0->f_28[1], num[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
			...
			{
				func_266(&uParam0->f_28[2], num[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
				func_264(&uParam0->f_35[0], num[3], -1107.5f, 280.33f, 64.01f, 97.97f);
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[1]))
			{
				func_263(&uParam0->f_35[1], false);
...
void func_263(var uParam0, BOOL bParam1) // Position - 0x1002E
{
	var unk;
	float num;
	...
	func_264(uParam0, iLocal_93, unk, num);
...
void func_264(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x100A2
{
	func_265(uParam0);
...
void func_265(var uParam0) // Position - 0x100E4
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_266(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x10180
{
	func_267(uParam0);
...
void func_267(var uParam0) // Position - 0x101A1
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_268(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x101E2
{
...
BOOL func_269(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1023E
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_315(echParam1);
...
int func_270(var uParam0, eCharacter echParam1) // Position - 0x102CC
{
	int num;
...
BOOL func_271(BOOL bParam0, BOOL bParam1) // Position - 0x10312
{
	int num;
...
BOOL func_272(BOOL bParam0, BOOL bParam1) // Position - 0x10380
{
	int num;
...
BOOL func_273(var uParam0) // Position - 0x10426
{
	if (func_227(uParam0))
	{
...
BOOL func_274(var uParam0) // Position - 0x10450
{
	int i;
...
BOOL func_276(var uParam0) // Position - 0x104BD
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x28818732C8F0F80E("rcmjosh3");
			iLocal_91 = 1;
			break;
	
		case 1:
			if (!func_274(&num) || !unk_0x2BBF749E555360DC("rcmjosh3"))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_268(&uParam0->f_28[0], CHAR_JOSH, 566.1639f, -1773.8171f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
					flag = false;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				uParam0->f_59 = unk_0x191673E3F99212B2(563.76f, -1773.86f, 28.36f, 0f, 0.05f, -110.7f, 2);
				unk_0x468D976993BF7FE1(uParam0->f_28[0], uParam0->f_59, "rcmjosh3", "sit_stairs_idle", 8f, -8f, 17, 0, 1148846080, 0);
...
void func_277(var uParam0) // Position - 0x106A5
{
	func_264(uParam0, iLocal_93, 558.09f, -1765.39f, 28.86f, 335.3252f);
	unk_0x7A1950259E8A78CC(*uParam0, 4);
...
BOOL func_278(var uParam0) // Position - 0x106EB
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x28818732C8F0F80E("rcmjosh2");
			iLocal_91 = 1;
			break;
	
		case 1:
			if (!func_274(&num) || !unk_0x2BBF749E555360DC("rcmjosh2"))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_268(&uParam0->f_28[0], CHAR_JOSH, 565.3901f, -1772.8378f, 29.80087f, 62.501556f, "JOSH LAUNCHER RC", 1))
					flag = false;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				uLocal_94 = unk_0x191673E3F99212B2(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0x5F243F8265BB664F(uLocal_94, 1);
				unk_0x468D976993BF7FE1(uParam0->f_28[0], uLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
		
			unk_0x0B34FA69ECCE3927("rcmjosh2");
...
BOOL func_279(var uParam0) // Position - 0x1090E
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_268(&uParam0->f_28[0], CHAR_JOSH, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
					flag = false;
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
				func_263(&uParam0->f_35[0], true);
...
BOOL func_280(BOOL bParam0, BOOL bParam1) // Position - 0x10A7B
{
	int num;
...
BOOL func_281(int iParam0) // Position - 0x10AE9
{
	var unk;
	eCharacter character;
...
BOOL func_282(int iParam0) // Position - 0x10B3A
{
	var unk;
...
BOOL func_283(int iParam0) // Position - 0x10BF3
{
	var unk;
...
BOOL func_284(int iParam0) // Position - 0x10CB4
{
	int i;
	var unk;
	int num;
...
BOOL func_286(int iParam0) // Position - 0x10E1B
{
...
BOOL func_287(int iParam0) // Position - 0x10E46
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_288(int iParam0) // Position - 0x10E71
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_289(int iParam0) // Position - 0x10E9C
{
	if (func_254(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_291(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10EEB
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_292(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_292(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_292(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10F50
{
	int num;
	char* str;
	...
	if (func_293(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_293(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10FC8
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x11043
{
	char* str;
	...
	if (bParam1)
	{
		...
		func_301(uParam0, 0, false, false);
	}

	if (unk_0xCE4AAA035282336C(uLocal_264))
		unk_0x45533C09A6C9B409(&uLocal_264);

	func_300(&(uParam0->f_48));
	...
	{
		case 30:
			unk_0xB9FBFC24675DC5BC(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"));
			break;
	}
...
BOOL func_298(char* sParam0) // Position - 0x11141
{
	var unk;
...
void func_303(var uParam0, BOOL bParam1) // Position - 0x111ED
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_304(&uParam0->[i], false);
	}

	return;
}

void func_304(var uParam0, BOOL bParam1) // Position - 0x1122B
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_307(var uParam0) // Position - 0x112B5
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_309(var uParam0, int iParam1) // Position - 0x112FF
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_310(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_310(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11340
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_311(int iParam0) // Position - 0x11390
{
	if (*iParam0 == -1)
		return;
...
int func_315(eCharacter echParam0) // Position - 0x1142C
{
	if (!func_36(echParam0))
