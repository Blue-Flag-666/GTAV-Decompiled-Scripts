...
void main() // Position - 0x0
{
	...
	if (!func_291(&unk63, &num, vector, 1f))
	{
		func_290();
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1))
		{
			if (num == 30)
			{
				if (func_222(PLAYER::PLAYER_PED_ID(), -1102.7241f, 290.1463f, 63.23002f, true) < 200f)
				{
		...
		func_220(num);
		func_213(&iLocal_95, &(num.f_9), vector);
	
		if (num == 27)
		{
			func_211(&num, vector, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (num == 28)
		{
			func_211(&num, vector, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (num == 29)
		{
			func_211(&num, vector, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (num == 30)
		{
			if (iLocal_265 == 0)
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3AC2
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x400D
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x4372
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x4465
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x4968
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x55C9
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x5604
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x5878
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E03
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A8D
{
	int i;
...
int func_93(Player plParam0) // Position - 0x8752
{
...
void func_122(Ped pedParam0) // Position - 0xAAB3
{
	int num;
	int num2;
	int num3;
...
int func_124(Ped pedParam0) // Position - 0xAB8F
{
	int i;
...
int func_130(Ped pedParam0) // Position - 0xACEF
{
	int i;
...
BOOL func_131(Ped pedParam0) // Position - 0xAD38
{
...
void func_135(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE7B
{
	int i;
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB01A
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xB181
{
	BOOL flag;
...
BOOL func_142(Player plParam0) // Position - 0xB20D
{
...
int func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB25A
{
	int num;
...
BOOL func_147(const char* sParam0) // Position - 0xB2D7
{
...
void func_152() // Position - 0xB3B2
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			if (func_153(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, false, true, false))
...
BOOL func_153(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB40A
{
...
void func_154(Vehicle veParam0) // Position - 0xB5A2
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_171(const char* sParam0, int iParam1) // Position - 0xBC27
{
	int num;
	const char* str;
	Hash hashKey;
...
void func_173(int iParam0, var uParam1) // Position - 0xBC94
{
	switch (iParam0)
	{
		...
		case 13:
			if (iParam0 == 11)
				*uParam1 = func_174(1835.53f, 4705.86f, 38.1f, false);
			else if (iParam0 == 12)
				*uParam1 = func_174(1826.13f, 4698.88f, 38.92f, false);
			else
				*uParam1 = func_174(637.02f, 119.7093f, 89.5f, false);
		...
		case 19:
			if (iParam0 == 18)
				*uParam1 = func_174(-954.19f, -2760.05f, 14.64f, false);
			else
				*uParam1 = func_174(-63.8f, -809.5f, 321.8f, false);
		...
		case 23:
			if (iParam0 == 21)
				*uParam1 = func_174(-1877.82f, -440.649f, 45.05f, false);
			else
				*uParam1 = func_174(-915.6f, 6139.2f, 5.5f, false);
		...
		case 48:
			if (iParam0 == 47)
				*uParam1 = func_174(-70.71f, 301.43f, 106.79f, false);
			else
				*uParam1 = func_174(-257.22f, 292.85f, 90.63f, false);
...
Blip func_174(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC103
{
	...
	if (*uParam0 == 30)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (bLocal_263)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_178(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], true) <= 15f)
					{
						func_312("Special launching Josh 4 (not in vehicle)");
						return true;
					}
				}
				else if (func_178(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], true) <= 10f)
				{
...
float func_178(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xC254
{
...
BOOL func_179(var uParam0) // Position - 0xC2B2
{
	if (*uParam0 == 29)
	{
		if (func_222(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, true) < 6f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
			...
			else if (!func_180(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_153(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_180(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC345
{
...
int func_181(var uParam0) // Position - 0xC378
{
	if (*uParam0 == 28)
	{
		if (func_222(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, true) < 9f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
			...
			else if (!func_180(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_153(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_187(Vehicle veParam0) // Position - 0xCD96
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || Global_32166 || func_195() || func_194(8, -1) || func_192() || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_196() || Global_112695 || Global_32166 || func_195() || func_194(8, -1) || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_196() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_194(8, -1) || func_191() || func_190() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || func_193() || Global_112695 || Global_32166 || func_195() || Global_44446 || func_194(8, -1) || func_192() || func_190() || func_191() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
void func_197() // Position - 0xD5C3
{
	...
	{
		case 0:
			if (MISC::GET_GAME_TIMER() - iLocal_262 > 100 && bLocal_263 == false)
				iLocal_96 = 1;
			break;
	
		case 1:
			if (func_222(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) <= 20f)
		...
		case 2:
			...
			else if (func_222(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) >= 25f)
			{
				func_148();
				bLocal_263 = true;
				iLocal_96 = 0;
...
BOOL func_202(Player plParam0) // Position - 0xDA45
{
	return func_203(plParam0, 20);
}

BOOL func_203(Player plParam0, int iParam1) // Position - 0xDA55
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDD1D
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
int func_211(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDD3E
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_222(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void func_213(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDE01
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
float func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xE1B8
{
	Vector3 entityCoords;
...
void func_224(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE462
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_229(Object* pobParam0) // Position - 0xEB1B
{
...
BOOL func_231(Ped pedParam0, Vehicle veParam1) // Position - 0xED04
{
...
BOOL func_234(Ped pedParam0, int iParam1) // Position - 0xF024
{
	float xSize;
...
BOOL func_235(Ped pedParam0, int iParam1) // Position - 0xF09A
{
	return func_236(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_236(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF0B2
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_237(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_237(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF173
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_238(Ped pedParam0, int iParam1) // Position - 0xF29F
{
...
BOOL func_240(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF3AE
{
	var unk;
...
int func_244(Ped pedParam0, Ped pedParam1) // Position - 0xF4BA
{
	int i;
...
BOOL func_245(Ped pedParam0) // Position - 0xF4F9
{
...
BOOL func_246(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF521
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_247(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF61C
{
	float entityCoords;
	float num;
...
BOOL func_248(Ped pedParam0, float fParam1) // Position - 0xF728
{
	var outProjectile;
	var outCoords;
...
BOOL func_249(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF7BD
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_250(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF84B
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_252(Vehicle veParam0) // Position - 0xF8DD
{
	int taskSequenceId;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFB28
{
...
BOOL func_262(var uParam0) // Position - 0xFC38
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_266(&uParam0->f_28[1], num[2], -1102.92f, 290.12f, 64.28f, 40.46f, PED_TYPE_COP);
			...
			{
				func_266(&uParam0->f_28[2], num[2], -1102.73f, 290.91f, 64.28f, 92.06f, PED_TYPE_COP);
...
void func_263(Vehicle* pveParam0, BOOL bParam1) // Position - 0x1002E
{
	var unk;
	float num;
	...
	func_264(pveParam0, hLocal_93, unk, num);
...
void func_264(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x100A2
{
	func_265(pveParam0);
...
void func_265(Vehicle* pveParam0) // Position - 0x100E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_266(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x10180
{
	func_267(ppedParam0);
...
void func_267(Ped* ppedParam0) // Position - 0x101A1
{
...
BOOL func_268(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x101E2
{
...
BOOL func_269(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1023E
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_315(echParam1);
...
BOOL func_276(var uParam0) // Position - 0x104BD
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_274(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh3"))
				return false;
...
void func_277(Vehicle* pveParam0) // Position - 0x106A5
{
	func_264(pveParam0, hLocal_93, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*pveParam0, 4);
...
BOOL func_278(var uParam0) // Position - 0x106EB
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_274(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh2"))
				return false;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
void func_304(Object* pobParam0, BOOL bParam1) // Position - 0x1122B
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_307(Vehicle* pveParam0) // Position - 0x112B5
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_309(var uParam0, int iParam1) // Position - 0x112FF
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_310(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_310(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11340
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
Hash func_315(eCharacter echParam0) // Position - 0x1142C
{
	if (!func_36(echParam0))
