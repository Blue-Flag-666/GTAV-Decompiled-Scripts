...
void main() // Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	iLocal_78 = func_355(CHAR_MARNIE);
	iLocal_79 = func_355(14);
	sLocal_83 = "Marnie";
	fLocal_313 = 40f;
	fLocal_314 = 0.35f;
	fLocal_315 = 0f;
	...
	func_302(60, 0, false);
	func_302(CHAR_JIMMY_BOSTON, CHAR_MICHAEL, false);

	while (true)
	{
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_BTT", 0);
		SYSTEM::WAIT(0);
		func_286(uLocal_84.f_9, 0, 0, 0, 0, 0);
...
Hash func_69(int iParam0, int iParam1) // Position - 0x5A44
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_70(iParam1));
}

int func_70(int iParam0) // Position - 0x5A59
{
	int num;
	int num2;
...
BOOL func_72(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5ABC
{
...
BOOL func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x84BC
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_74(int iParam0) // Position - 0x935F
{
	if (!IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_75(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x93A7
{
	int num;
...
ePedComponentType func_76(int iParam0) // Position - 0x9452
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_77(Hash hParam0, int iParam1) // Position - 0x9502
{
	int i;
	var unk;
...
void func_78(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9E31
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x9F5B
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_80(Hash hParam0, int iParam1) // Position - 0x9FA3
{
	int i;
	var unk;
...
void func_81(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xBDEB
{
	int num;
	Hash outfit;
...
struct<14> func_84(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC11A
{
	func_148();
...
void func_87(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD48C
{
	int num;
	int num2;
...
BOOL func_91(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE428
{
	int num;
	int num2;
	int num3;
...
void func_94(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE548
{
	int num;
	int num2;
	Hash outfit;
...
BOOL func_149(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F7C5
{
	Hash entityModel;
	int num;
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1FA1E
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1FA5B
{
...
Hash func_152(eCharacter echParam0) // Position - 0x1FA80
{
	return Global_2058[echParam0 /*29*/];
}

BOOL func_153(eCharacter echParam0) // Position - 0x1FA8F
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_154(const char* sParam0, int iParam1) // Position - 0x1FA9B
{
...
void func_162(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x201DA
{
...
char* func_168(eCharacter echParam0) // Position - 0x217EE
{
	echParam0 = echParam0;
	return "";
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x21840
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x21856
{
...
void func_174(int iParam0) // Position - 0x218B8
{
	if (*iParam0 == -1)
		return;
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x21E4B
{
	int num;
	int num2;
	int num3;
...
BOOL func_184(int iParam0, int iParam1) // Position - 0x2226F
{
	if (iParam0 == -1)
		return false;
...
void func_185(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x2228F
{
	if (iParam0 != 198)
	{
		if (Global_78689)
...
BOOL func_189() // Position - 0x22D48
{
...
BOOL func_195(int iParam0) // Position - 0x266C8
{
	int num;
	int i;
...
BOOL func_198(int iParam0) // Position - 0x268FF
{
...
BOOL func_200(const char* sParam0) // Position - 0x26966
{
...
int func_202(const char* sParam0, int iParam1) // Position - 0x269D7
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_203(int iParam0, int iParam1) // Position - 0x26A20
{
...
int func_204(int iParam0, int iParam1, BOOL bParam2) // Position - 0x26A71
{
	...
	for (i = 0; i < Global_53888[num /*203*/].f_3; i = i + 1)
	{
		...
		if (num3 < 3)
			func_205(Global_53888[num /*203*/].f_4[i], Global_53888[num /*203*/].f_1, true, bParam2, false);
	}
...
void func_205(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x26C6D
{
	...
	if (!bParam2)
	{
		...
		num3 = num5;
		unk = { func_211(Global_44588[num5 /*12*/].f_1) };
	...
	else
	{
		...
		if (Global_53888[num6 /*203*/].f_10[Global_53888[num6 /*203*/].f_9 - 1 /*48*/].f_1)
			...
			unk = { func_211(Global_44588[num8 /*12*/].f_1) };
	}
...
void func_206(eCharacter echParam0, int iParam1, int iParam2, const char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11, const char* sParam12, const char* sParam13) // Position - 0x27042
{
	eCharacter character;
	BOOL flag;
	var txdName;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x27258
{
	switch (iParam0)
	{
		case 0:
...
const char* func_209(int iParam0, var uParam1) // Position - 0x275C3
{
	*uParam1 = 1;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x2798E
{
	func_156();
...
void func_215(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x27C75
{
	int i;
...
BOOL func_220(Ped pedParam0) // Position - 0x28111
{
...
void func_221(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28131
{
	if (bParam0)
	{
...
BOOL func_223(Player plParam0, int iParam1) // Position - 0x28298
{
	BOOL flag;
...
BOOL func_225(Player plParam0) // Position - 0x28332
{
	Player player;
...
BOOL func_226(Player plParam0) // Position - 0x28354
{
...
int func_228(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x283A1
{
	int num;
...
BOOL func_229() // Position - 0x283D4
{
...
void func_232(Ped* ppedParam0) // Position - 0x28449
{
...
BOOL func_233() // Position - 0x2848A
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
	{
...
void func_234(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x284BE
{
	Player playerIndex;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x286B8
{
...
void func_238(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x2870A
{
	func_239(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_239(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28734
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x28B2A
{
...
BOOL func_241(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x28B54
{
	int i;
	var garageName;
	int num;
...
BOOL func_242(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x28BC2
{
...
BOOL func_243(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x28C9A
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_244(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x28F90
{
	float num;
	float num2;
	float num3;
...
Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0x29044
{
	float num;
	float num2;
...
void func_246(Vehicle veParam0) // Position - 0x29083
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x2911F
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_250(int iParam0, int iParam1, int iParam2) // Position - 0x29140
{
	int num;
...
BOOL func_256(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x29311
{
...
BOOL func_257(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x29344
{
...
void func_258(Vehicle veParam0) // Position - 0x294DC
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_260() // Position - 0x2951E
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			if (func_277(PLAYER::PLAYER_PED_ID(), uLocal_84.f_28[0], true) >= 4.5f)
			{
			...
			if (iLocal_312 == 0)
			{
				if (func_277(PLAYER::PLAYER_PED_ID(), uLocal_84.f_28[0], true) <= 2.5f)
				{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x297A8
{
	...
	Global_22842 = 0;
	Global_2883585 = 0;
	return func_262(sParam2, iParam3, false);
}

BOOL func_262(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x297F6
{
	Global_21846 = 0;
...
BOOL func_264() // Position - 0x29AFB
{
...
BOOL func_265(Player plParam0) // Position - 0x29B5E
{
	return func_266(plParam0, 20);
}

BOOL func_266(Player plParam0, int iParam1) // Position - 0x29B6E
{
	return IS_BIT_SET(Global_1895156[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x29B86
{
	return -1;
}
...
BOOL func_270() // Position - 0x29C55
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x29CEE
{
	if (func_92(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_274(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29E1F
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x29E75
{
...
BOOL func_276() // Position - 0x29F10
{
...
float func_277(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x29F29
{
...
BOOL func_284(int iParam0) // Position - 0x2A133
{
	if (iParam0 == 1)
		if (Global_20500.f_1 > 3)
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2A199
{
	float num;
	int value;
	int alpha;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_288(Global_78945, Global_78947, iParam10) };
				y == -0.014f;
...
float func_287(const char* sParam0) // Position - 0x2A47E
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (num)
			{
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_289(num), 8);
					break;
			}
			break;
...
BOOL func_297(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2A85F
{
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_284(0) || func_298(true))
			{
			}
			else
			{
...
BOOL func_299(int iParam0) // Position - 0x2A9A0
{
	if (Global_43377 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x2A9C2
{
	return func_301(iParam0, Global_43377);
}

BOOL func_301(int iParam0, int iParam1) // Position - 0x2A9D3
{
	if (iParam1 == 15)
		return 1;
...
void func_302(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2ABB4
{
	int num;
	...
	if (Global_117[echParam0 /*10*/].f_8 != 172)
	{
		...
		if (echParam1 == 4)
		{
			...
			func_307(echParam0, 0, 1);
			func_307(echParam0, 1, 1);
			func_307(echParam0, 2, 1);
		}
		else
		{
			if (func_306(echParam0, echParam1) == 1 && func_305(echParam0, echParam1) == 1)
				bParam2 = false;
		
			num = echParam1;
			func_308(echParam0, num, 1);
			func_307(echParam0, num, 1);
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x2ADAD
{
	return Global_2058[character /*29*/].f_3;
}

int func_305(eCharacter echParam0, int iParam1) // Position - 0x2ADC0
{
...
int func_306(eCharacter echParam0, int iParam1) // Position - 0x2ADEA
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_307(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x2AE14
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_308(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x2AE59
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL func_309(var uParam0) // Position - 0x2AE9E
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_77)
	{
		...
		case 1:
			if (!func_315(&num) || !func_313(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			{
				if (func_310(&uParam0->f_28[0], CHAR_MARNIE, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_220(PLAYER::PLAYER_PED_ID()))
				{
...
BOOL func_310(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B021
{
	if (func_311(ppedParam0, echParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_311(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B07D
{
	Hash model;

	if (!func_153(echParam1))
	{
		model = func_355(echParam1);
...
int func_312(var uParam0, eCharacter echParam1) // Position - 0x2B10B
{
	int num;
...
BOOL func_313(var uParam0) // Position - 0x2B151
{
	if (func_314(uParam0))
	{
...
BOOL func_314(var uParam0) // Position - 0x2B17B
{
...
BOOL func_315(var uParam0) // Position - 0x2B1A0
{
	int i;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x2B20D
{
...
void func_318() // Position - 0x2B231
{
	...
	func_319(&uLocal_84, 0, false, false);
...
void func_321(var uParam0, BOOL bParam1) // Position - 0x2B2AD
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_322(&uParam0->[i], false);
	}

	return;
}

void func_322(Object* pobParam0, BOOL bParam1) // Position - 0x2B2EB
{
...
void func_323(Object* pobParam0) // Position - 0x2B326
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_326(Vehicle* pveParam0) // Position - 0x2B3A0
{
...
void func_327(Vehicle* pveParam0) // Position - 0x2B3D8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_328(Vehicle veParam0) // Position - 0x2B474
{
...
void func_330(var uParam0, int iParam1) // Position - 0x2B4B0
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_331(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_331(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x2B4F1
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
BOOL func_332() // Position - 0x2B541
{
	int num;
...
void func_333(BOOL bParam0) // Position - 0x2B5E2
{
	...
	if (!func_350())
	{
		...
		if (bParam0)
		{
			...
			func_334(SCRIPT::GET_THIS_SCRIPT_NAME(), num);
		}
		else
		{
			if (Global_112897[num /*10*/].f_9 == -1)
...
void func_334(const char* sParam0, int iParam1) // Position - 0x2B6B2
{
	if (Global_100833 != 12)
...
BOOL func_335(const char* sParam0, int iParam1, int iParam2) // Position - 0x2B6DA
{
	...
	if (func_341())
	{
		...
		{
			num = func_336(SCRIPT::GET_THIS_SCRIPT_NAME());
...
int func_337() // Position - 0x2B8BF
{
	...
	num = func_338(&(Global_100833.f_3), false);
	num2 = 0;
...
int func_339(Hash hParam0, BOOL bParam1) // Position - 0x2B90D
{
	int i;
...
BOOL func_340() // Position - 0x2B943
{
...
BOOL func_341() // Position - 0x2B993
{
...
BOOL func_350() // Position - 0x2BB41
{
...
Hash func_355(eCharacter echParam0) // Position - 0x2BCD8
{
