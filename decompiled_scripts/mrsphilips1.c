			...
			switch (iLocal_142)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_219(PLAYER::PLAYER_PED_ID(), 1974.513f, 3814.579f, 32.4266f, 270f, false, true);
							PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Walk"), false, 1, false);
							PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 4000, 0, true, false);
...
BOOL func_9(int iParam0, int iParam1) // Position - 0xA17
{
...
BOOL func_32(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1534
{
	Hash entityModel;
	int i;
	var unk;
...
BOOL func_33(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x16F1
{
	int num;
...
int func_34(Hash hParam0) // Position - 0x177D
{
	switch (hParam0)
	{
...
int func_35(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17B8
{
	int i;
	int j;
	int k;
...
void func_36(Hash hParam0, int iParam1, int iParam2) // Position - 0x1FC9
{
	int num;
	int num2;
...
BOOL func_37(Hash hParam0, int iParam1, int iParam2) // Position - 0x2053
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(Hash hParam0, int iParam1, int iParam2) // Position - 0x2131
{
	Global_78341[1 /*14*/] = { func_84(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_78341[1 /*14*/].f_6, 2);
}

BOOL func_39(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x2159
{
	var unk;
	int i;
...
BOOL func_40(Hash hParam0, int iParam1, int iParam2) // Position - 0x275D
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_41(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x27F6
{
	int i;
	int j;
...
int func_42(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x2897
{
	int num;
...
int func_43(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2B9E
{
	int num;
	int num2;
	int num3;
...
int func_45(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3A35
{
	int num;
...
int func_46(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3CFC
{
	int i;
	int num;
...
BOOL func_47(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D33
{
	int num;
...
BOOL func_48(Hash hParam0, int iParam1, var uParam2) // Position - 0x3D5C
{
	*uParam2 = -99;
...
int func_49(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4027
{
	int num;
...
int func_50(Hash hParam0, int iParam1, int iParam2) // Position - 0x42B1
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x4408
{
	int num;
...
BOOL func_52(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x44A2
{
	switch (hParam0)
	{
...
Hash func_53(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4570
{
	var outProp;
	int componentId;
	int num;
...
int func_54(Hash hParam0, int iParam1) // Position - 0x468A
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_55(Hash hParam0) // Position - 0x4A31
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_56(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x4A92
{
	Hash entityModel;
...
int func_57(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x4B8E
{
	Hash entityModel;
...
int func_58(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4CCC
{
	var unk;
	Ped i;
	Ped ped;
...
int func_59(Hash hParam0) // Position - 0x4D87
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_60(ePedComponentType epctParam0) // Position - 0x4DE6
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_61(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x4E6C
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x50E9
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x550E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x5801
{
	int pedPropIndex;
...
int func_65(Ped pedParam0, int iParam1) // Position - 0x5848
{
...
int func_66(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x58A8
{
	ePedComponentType componentId;
...
void func_68(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x59AB
{
	int num;
	int offset;
	eMPStat stat;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x59F5
{
	Hash statName;
...
BOOL func_72(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5A96
{
...
BOOL func_75(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9191
{
	int num;
...
ePedComponentType func_76(int iParam0) // Position - 0x923C
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_77(Hash hParam0, int iParam1) // Position - 0x92EC
{
	int i;
	var unk;
...
void func_78(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9C1B
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_80(Hash hParam0, int iParam1) // Position - 0x9D8D
{
	int i;
	var unk;
...
void func_81(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xBBD5
{
	int num;
	Hash itemHash;
...
struct<14> func_84(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBEE0
{
	func_148();
...
BOOL func_91(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE1F1
{
	int num;
	int num2;
	eMPStat stat;
...
void func_94(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE312
{
	int num;
	int num2;
	Hash hash;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x26C3D
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_208(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x26C5E
{
	...
	func_210(false, true, false, false, false, false, false);
...
BOOL func_209(Ped pedParam0) // Position - 0x26D08
{
...
void func_210(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26D28
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_214(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_211() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0x26E8F
{
	BOOL flag;
...
BOOL func_214(Player plParam0) // Position - 0x26F1B
{
...
int func_216(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x26F68
{
	int num;
...
BOOL func_219(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26FE5
{
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x271FF
{
...
void func_223(BOOL bParam0) // Position - 0x2722B
{
	...
	func_210(true, true, false, false, false, false, false);
	return;
}
...
BOOL func_226(int iParam0, int iParam1, int iParam2) // Position - 0x272C6
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_233(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iParam1, 1, 1056964608, false, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
			{
				...
				if (!func_232(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE))
...
BOOL func_232(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x27497
{
...
BOOL func_233(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x274CA
{
...
void func_234(Vehicle veParam0) // Position - 0x27662
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_238(Global_78814, Global_78816, iParam10) };
				y == -0.014f;
...
float func_237(const char* sParam0) // Position - 0x27989
{
...
void func_257(Object* pobParam0, BOOL bParam1) // Position - 0x281A6
{
...
void func_258(Object* pobParam0) // Position - 0x281E1
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_261(Vehicle* pveParam0) // Position - 0x2825B
{
...
void func_262(Vehicle* pveParam0) // Position - 0x28293
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_263(Vehicle veParam0) // Position - 0x2832F
{
...
void func_265(var uParam0, int iParam1) // Position - 0x2836B
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_266(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_266(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x283AC
{
...
void func_267(Ped* ppedParam0) // Position - 0x283FC
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_269(BOOL bParam0) // Position - 0x284DE
{
	...
	if (!func_290())
	{
		...
		if (bParam0)
		{
			...
			func_270(SCRIPT::GET_THIS_SCRIPT_NAME(), num);
		}
		else
		{
			if (Global_112735[num /*10*/].f_9 == -1)
...
void func_270(const char* sParam0, int iParam1) // Position - 0x285AE
{
	if (Global_100681 != 12)
...
BOOL func_271(const char* sParam0, int iParam1, int iParam2) // Position - 0x285D6
{
	...
	if (func_277())
	{
		...
		{
			num = func_272(SCRIPT::GET_THIS_SCRIPT_NAME());
...
int func_274(char* sParam0, BOOL bParam1) // Position - 0x287DF
{
	...
	hashKey = MISC::GET_HASH_KEY(sParam0);
	num = func_275(hashKey, true);
	num == -1 && !bParam1;
	return num;
}

int func_275(Hash hParam0, BOOL bParam1) // Position - 0x28809
{
	int i;
