...
void main() // Position - 0x0
{
	...
	{
		SYSTEM::WAIT(0);
		unk_0x385C3C9C52E9D548("SF_MrsPhilips", 0);
		func_236(uLocal_79.f_9, 0, 0, 0, 0, 0);
		...
		case 1:
			switch (iLocal_142)
			{
				case 0:
					if (func_226(1, 1093140480, 0))
					{
						...
						if (unk_0xB2FB1E59B6F71D15(joaat("DOORHASH_T_TRAILER_CS")))
						{
							...
							unk_0x289D605FFACC399B(joaat("DOORHASH_T_TRAILER_CS"), 0, 1, 0);
						}
				...
				case 1:
					...
					{
						func_220(1974.513f, 3814.579f, 32.4266f, 1, 1, 1, 1, 0, true, true, true, 1, true);
						iLocal_142 = iLocal_142 + 1;
					}
					break;
				...
				case 2:
					if (unk_0x2FECE8D166B3056B())
					{
						...
						{
							func_219(unk_0xC1A5EC5C986B98AD(), 1974.513f, 3814.579f, 32.4266f, 270f, false, 1);
							unk_0xC5F9EF8F410596F9(unk_0xC1A5EC5C986B98AD(), joaat("MotionState_Walk"), 0, 1, 0);
							unk_0x6C7E85F31A43117F(unk_0x93E99A2DBCBA9CFA(), 1f, 4000, 0, 1, 0);
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x440
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0xA68
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
BOOL func_32(var uParam0, int iParam1, int iParam2) // Position - 0x1534
{
	int num;
	int i;
	var unk;
...
BOOL func_33(var uParam0, int iParam1, var uParam2) // Position - 0x16F1
{
	int num;
...
int func_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17B8
{
	int i;
	int j;
	int k;
...
BOOL func_37(int iParam0, int iParam1, int iParam2) // Position - 0x2053
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x2159
{
	var unk;
	int i;
...
BOOL func_40(int iParam0, int iParam1, int iParam2) // Position - 0x275D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_41(var uParam0, int iParam1, int iParam2) // Position - 0x27F6
{
	int i;
	int j;
...
int func_42(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x2897
{
	int num;
...
int func_43(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2B9E
{
	int num;
	int num2;
	int num3;
...
BOOL func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0x3751
{
	int num;
...
BOOL func_47(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D33
{
	int num;
...
BOOL func_48(int iParam0, int iParam1, var uParam2) // Position - 0x3D5C
{
	*uParam2 = -99;
...
int func_49(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4027
{
	int num;
...
void func_51(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4408
{
	int num;
...
BOOL func_52(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x44A2
{
	switch (iParam0)
	{
...
int func_56(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4A92
{
	int num;
	int num2;
	int num3;
...
int func_57(var uParam0, int iParam1) // Position - 0x4B8E
{
	int num;
...
BOOL func_61(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4E6C
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x50E9
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x550E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(var uParam0, int iParam1) // Position - 0x5801
{
	int num;
	var unk;
...
int func_65(var uParam0, int iParam1) // Position - 0x5848
{
	int num;
	var unk;
	var unk2;
...
int func_66(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x58A8
{
	int num;
	int num2;
	int num3;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x59F5
{
	int num;
...
int func_70(int iParam0) // Position - 0x5A25
{
	int num;
	int num2;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x5A59
{
	var unk;
	int num;
...
BOOL func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x82A6
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_74(int iParam0) // Position - 0x9149
{
	if (!IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_75(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9191
{
	int num;
...
void func_78(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9C1B
{
	int num;
	var unk;
	int num2;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x9D45
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
void func_87(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD252
{
	int num;
	eMPStat stat;
...
eMPStat func_89(int iParam0, int iParam1) // Position - 0xD9FB
{
	switch (iParam1)
	{
		case 0:
...
eMPStat func_90(int iParam0, int iParam1) // Position - 0xDDF6
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_91(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE1F1
{
	int num;
	int num2;
	eMPStat stat;
...
void func_206(var uParam0, int iParam1, BOOL bParam2) // Position - 0x26B48
{
	int i;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x26C3D
{
	if (unk_0x7DE17ACDD8BA2642(uParam0))
...
void func_208(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x26C5E
{
	var unk;
	...
	func_210(false, true, false, 0, false, false, false);
...
BOOL func_209(var uParam0) // Position - 0x26D08
{
...
void func_210(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26D28
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_216(0, iParam3, bParam2, 0);
	
		if (unk_0xA26A9A07F761D8F8())
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_214(unk_0x93E99A2DBCBA9CFA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !func_211() && !bParam4 && !bParam5 && !unk_0x8253CEEA17ED481B())
				unk_0x226C3A30511D5DC4(unk_0xC1A5EC5C986B98AD(), 0);
		else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_214(unk_0x93E99A2DBCBA9CFA()) && !bParam4 && !bParam5)
			unk_0x226C3A30511D5DC4(unk_0xC1A5EC5C986B98AD(), 0);
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x26E8F
{
	BOOL flag;
...
BOOL func_214(int iParam0) // Position - 0x26F1B
{
...
int func_216(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x26F68
{
	int num;
...
BOOL func_217() // Position - 0x26F9B
{
...
BOOL func_219(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x26FE5
{
	BOOL flag;
	float num;
...
void func_220(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x27041
{
	var unk;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x271FF
{
	return unk_0x30BE8A934C020461(unk_0xF2CFBB1105511E1A(uParam0), 0);
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x27212
{
	func_156();
...
void func_223(BOOL bParam0) // Position - 0x2722B
{
	...
	func_210(true, true, false, 0, false, false, false);
	return;
}
...
BOOL func_226(int iParam0, int iParam1, int iParam2) // Position - 0x272C6
{
	int num;
	...
	if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
	{
		...
		{
			if (!func_233(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), iParam1, 1, 1056964608, 0, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
			{
				...
				if (!func_232(unk_0xC1A5EC5C986B98AD(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x27424
{
...
BOOL func_232(var uParam0, int iParam1) // Position - 0x27497
{
	if (func_209(uParam0))
...
BOOL func_233(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x274CA
{
...
void func_234(var uParam0) // Position - 0x27662
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
void func_236(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x276A4
{
	float num;
	int value;
	int num2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x72474BA05A104E1E())
			{
				...
				unk = { func_238(Global_78814, Global_78816, iParam10) };
				num4 == -0.014f;
...
float func_237(var uParam0) // Position - 0x27989
{
...
BOOL func_247(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x27D6A
{
	if (!func_250(0) || Global_78828 || Global_78817 == 1 || !unk_0x35DF833D93BCC488())
		return false;
	...
	switch (Global_78813)
	{
		...
		case 5:
			if (unk_0x2FECE8D166B3056B() || func_249(0) || func_248(true))
			{
			}
			else
			{
...
BOOL func_249(int iParam0) // Position - 0x27EAB
{
	if (iParam0 == 1)
...
BOOL func_250(int iParam0) // Position - 0x27F02
{
	if (Global_43257 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x27F24
{
	return func_252(iParam0, Global_43257);
}

BOOL func_252(int iParam0, int iParam1) // Position - 0x27F35
{
	if (iParam1 == 15)
		return 1;
...
void func_253() // Position - 0x28116
{
	func_225();
	func_268();
	func_254(&uLocal_79, 1, false, false);
...
void func_257(var uParam0, BOOL bParam1) // Position - 0x281A6
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_258(var uParam0) // Position - 0x281E1
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_261(var uParam0) // Position - 0x2825B
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_262(var uParam0) // Position - 0x28293
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_263(var uParam0) // Position - 0x2832F
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void func_265(var uParam0, int iParam1) // Position - 0x2836B
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_266(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_266(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x283AC
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_267(var uParam0) // Position - 0x283FC
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_268() // Position - 0x2843D
{
	int num;
...
void func_269(BOOL bParam0) // Position - 0x284DE
{
	...
	if (!func_290())
	{
		...
		{
			func_161(num, 1, 0);
			func_270(unk_0x688846D56810779A(), num);
		}
		else
		{
			if (Global_112735[num /*10*/].f_9 == -1)
...
BOOL func_271(char* sParam0, int iParam1, int iParam2) // Position - 0x285D6
{
	var unk;
	var unk2;
	int num;
	...
	if (func_277())
	{
		...
		{
			num = func_272(unk_0x688846D56810779A());
...
int func_273() // Position - 0x287BB
{
	...
	num = func_274(&(Global_100681.f_3), false);
	num2 = 0;
...
int func_274(char* sParam0, BOOL bParam1) // Position - 0x287DF
{
	...
	num = func_275(unk, true);
	num == -1 && !bParam1;
	return num;
}

int func_275(var uParam0, BOOL bParam1) // Position - 0x28809
{
	int i;
...
BOOL func_276() // Position - 0x2883F
{
...
BOOL func_277() // Position - 0x2888F
{
...
void func_278(int iParam0) // Position - 0x288FB
{
...
BOOL func_290() // Position - 0x28B58
{
