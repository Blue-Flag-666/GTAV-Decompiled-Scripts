...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_238(uLocal_77.f_9, 0, 0, 0, 0, 0);
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x441
{
...
BOOL func_9(int iParam0, int iParam1) // Position - 0xA18
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA69
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
BOOL func_32(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1535
{
	Hash entityModel;
	int i;
	var unk;
...
BOOL func_33(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x16F2
{
	int num;
...
int func_34(Hash hParam0) // Position - 0x177E
{
	switch (hParam0)
	{
...
int func_35(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17B9
{
	int i;
	int j;
	int k;
...
void func_36(Hash hParam0, int iParam1, int iParam2) // Position - 0x1FCA
{
	int num;
	int num2;
...
BOOL func_37(Hash hParam0, int iParam1, int iParam2) // Position - 0x2054
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(Hash hParam0, int iParam1, int iParam2) // Position - 0x2132
{
	Global_78472[1 /*14*/] = { func_85(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_78472[1 /*14*/].f_6, 2);
}

BOOL func_39(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x215A
{
	var unk;
	int i;
...
BOOL func_40(Hash hParam0, int iParam1, int iParam2) // Position - 0x275E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_41(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x27F7
{
	int i;
	int j;
...
int func_42(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x2898
{
	int num;
...
int func_43(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2B9F
{
	int num;
	int num2;
	int num3;
...
BOOL func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0x3752
{
	int num;
...
int func_45(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3A36
{
	int num;
...
int func_46(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3CFD
{
	int i;
	int num;
...
BOOL func_47(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D34
{
	int num;
...
BOOL func_48(Hash hParam0, int iParam1, var uParam2) // Position - 0x3D5D
{
	*uParam2 = -99;
...
int func_49(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4028
{
	int num;
...
int func_50(Hash hParam0, int iParam1, int iParam2) // Position - 0x42B2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x4409
{
	int num;
...
BOOL func_52(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x44A3
{
	switch (hParam0)
	{
...
Hash func_53(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4571
{
	var outProp;
	int componentId;
	int num;
...
int func_54(Hash hParam0, int iParam1) // Position - 0x468B
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_55(Hash hParam0) // Position - 0x4A32
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_56(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x4A93
{
	Hash entityModel;
...
int func_57(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x4B8F
{
	Hash entityModel;
...
int func_58(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4CCD
{
	var outfit;
	int i;
	int num;
...
int func_59(Hash hParam0) // Position - 0x4D88
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_60(ePedComponentType epctParam0) // Position - 0x4DE7
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_61(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x4E6D
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x50EA
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x550F
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x5802
{
	int pedPropIndex;
...
int func_65(Ped pedParam0, int iParam1) // Position - 0x5849
{
...
int func_66(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x58A9
{
	ePedComponentType componentId;
...
void func_68(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x59AC
{
	int num;
	int offset;
	int num2;
...
Hash func_70(int iParam0, int iParam1) // Position - 0x5A17
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(iParam1));
}

int func_71(int iParam0) // Position - 0x5A2C
{
	int num;
	int num2;
...
BOOL func_73(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5A8F
{
...
BOOL func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x848F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_75(int iParam0) // Position - 0x9332
{
	if (!IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_76(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x937A
{
	int num;
...
ePedComponentType func_77(int iParam0) // Position - 0x9425
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(Hash hParam0, int iParam1) // Position - 0x94D5
{
	int i;
	var unk;
...
void func_79(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9E04
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x9F2E
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(Hash hParam0, int iParam1) // Position - 0x9F76
{
	int i;
	var unk;
...
void func_82(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xBDBE
{
	int num;
	Hash outfit;
...
struct<14> func_85(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC0C9
{
	func_149();
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD438
{
	int num;
	int num2;
...
BOOL func_92(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE3D4
{
	int num;
	int num2;
	int num3;
...
void func_95(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE4F4
{
	int num;
	int num2;
	Hash outfit;
...
BOOL func_150(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F770
{
	Hash entityModel;
	int num;
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1F9C9
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1FA06
{
...
Hash func_153(eCharacter echParam0) // Position - 0x1FA2B
{
	return Global_2058[echParam0 /*29*/];
}

BOOL func_154(eCharacter echParam0) // Position - 0x1FA3A
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_155(const char* sParam0, int iParam1) // Position - 0x1FA46
{
...
void func_163(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x20184
{
...
char* func_169(eCharacter echParam0) // Position - 0x21798
{
	echParam0 = echParam0;
	return "";
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x217EA
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x21800
{
...
void func_175(int iParam0) // Position - 0x21862
{
	if (*iParam0 == -1)
		return;
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x21DF5
{
	int num;
	int num2;
	int num3;
...
BOOL func_185(int iParam0, int iParam1) // Position - 0x22219
{
	if (iParam0 == -1)
		return false;
...
void func_186(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x22239
{
	if (iParam0 != 198)
	{
		if (Global_78689)
...
BOOL func_190() // Position - 0x22CF2
{
...
void func_197(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x26690
{
	int i;
...
BOOL func_199(int iParam0) // Position - 0x2697A
{
	int num;
	int i;
...
BOOL func_202(int iParam0) // Position - 0x26BB1
{
...
BOOL func_204(const char* sParam0) // Position - 0x26C18
{
...
int func_206(const char* sParam0, int iParam1) // Position - 0x26C89
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x26DC7
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_210(Ped pedParam0) // Position - 0x26E92
{
...
void func_211(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26EB2
{
	if (bParam0)
	{
...
BOOL func_213(Player plParam0, int iParam1) // Position - 0x27019
{
	BOOL flag;
...
BOOL func_215(Player plParam0) // Position - 0x270B3
{
	Player player;
...
BOOL func_216(Player plParam0) // Position - 0x270D5
{
...
int func_218(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27122
{
	int num;
...
BOOL func_219() // Position - 0x27155
{
...
BOOL func_221(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2719F
{
...
void func_222(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x271FB
{
	Player playerIndex;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x273B9
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x273CC
{
	func_157();
...
BOOL func_228(int iParam0, int iParam1, int iParam2) // Position - 0x27480
{
	int num;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x275DE
{
...
BOOL func_234(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x27651
{
...
BOOL func_235(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x27684
{
...
void func_236(Vehicle veParam0) // Position - 0x2781C
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2785E
{
	float num;
	int value;
	int alpha;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_240(Global_78945, Global_78947, iParam10) };
				y == -0.014f;
...
float func_239(const char* sParam0) // Position - 0x27B43
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (num)
			{
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_241(num), 8);
					break;
			}
			break;
...
BOOL func_249(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x27F24
{
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_251(0) || func_250(true))
			{
			}
			else
			{
...
BOOL func_251(int iParam0) // Position - 0x28065
{
	if (iParam0 == 1)
...
BOOL func_252(int iParam0) // Position - 0x280BC
{
	if (Global_43377 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x280DE
{
	return func_254(iParam0, Global_43377);
}

BOOL func_254(int iParam0, int iParam1) // Position - 0x280EF
{
	if (iParam1 == 15)
		return 1;
...
void func_255() // Position - 0x282D0
{
	func_227();
	func_270();
	func_256(&uLocal_77, 1, false, false);
...
void func_259(Object* pobParam0, BOOL bParam1) // Position - 0x28360
{
...
void func_260(Object* pobParam0) // Position - 0x2839B
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_263(Vehicle* pveParam0) // Position - 0x28415
{
...
void func_264(Vehicle* pveParam0) // Position - 0x2844D
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_265(Vehicle veParam0) // Position - 0x284E9
{
...
void func_268(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x28566
{
...
void func_269(Ped* ppedParam0) // Position - 0x285B6
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
BOOL func_270() // Position - 0x285F7
{
	int num;
...
void func_271(BOOL bParam0) // Position - 0x28698
{
	...
	if (!func_292())
	{
		...
		if (bParam0)
		{
			...
			func_272(SCRIPT::GET_THIS_SCRIPT_NAME(), num);
		}
		else
		{
			if (Global_112897[num /*10*/].f_9 == -1)
...
void func_272(const char* sParam0, int iParam1) // Position - 0x28768
{
	if (Global_100833 != 12)
...
BOOL func_273(const char* sParam0, int iParam1, int iParam2) // Position - 0x28790
{
...
int func_275() // Position - 0x28975
{
	...
	num = func_276(&(Global_100833.f_3), false);
	num2 = 0;
...
int func_276(char* sParam0, BOOL bParam1) // Position - 0x28999
{
	...
	hashKey = MISC::GET_HASH_KEY(sParam0);
	num = func_277(hashKey, true);
	num == -1 && !bParam1;
	return num;
}

int func_277(Hash hParam0, BOOL bParam1) // Position - 0x289C3
{
	int i;
...
BOOL func_278() // Position - 0x289F9
{
...
BOOL func_279() // Position - 0x28A49
{
...
BOOL func_292() // Position - 0x28D12
{
