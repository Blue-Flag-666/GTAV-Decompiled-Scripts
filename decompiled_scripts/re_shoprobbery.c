...
Hash func_5(int iParam0, int iParam1) // Position - 0x170D
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_6(iParam1));
}

int func_6(int iParam0) // Position - 0x1722
{
	int num;
	int num2;
...
BOOL func_12(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1BB4
{
	if (iParam0 == -1)
		return false;
...
int func_13(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x1C14
{
...
void func_17(int iParam0) // Position - 0x2523
{
	BOOL flag;
	var txdName;
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_19() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_19() /*5568*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x269D
{
	switch (iParam0)
	{
		case 0:
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x27AD
{
	if (iParam2 == -1)
		iParam2 = func_7();
...
BOOL func_22(int iParam0) // Position - 0x27EB
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	return IS_BIT_SET(Global_2359296[func_19() /*5568*/].f_681.f_10, iParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x298B
{
	if (iParam1 == -1)
		iParam1 = func_7();
...
BOOL func_27(var uParam0, int iParam1) // Position - 0x2B16
{
	int i;
	var unk;
...
void func_32(var uParam0, int iParam1) // Position - 0x2C97
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_37(int iParam0) // Position - 0x2D0D
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x2D6B
{
...
int func_42(eCharacter echParam0) // Position - 0x2E8E
{
	return Global_2058[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x2E9F
{
	func_44();
...
void func_44() // Position - 0x2EB8
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_45(character) && !func_38(14) || Global_112760)
			{
...
BOOL func_45(eCharacter echParam0) // Position - 0x2FB5
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x2FC1
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2FFE
{
...
Hash func_48(eCharacter echParam0) // Position - 0x3023
{
	return Global_2058[echParam0 /*29*/];
}

void func_49(Hash hParam0, int iParam1) // Position - 0x3032
{
	int outValue;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x3382
{
...
void func_58(int iParam0, int iParam1) // Position - 0x33AA
{
	if (iParam0 == -1)
		iParam0 = func_71();
...
BOOL func_62(int iParam0) // Position - 0x3DC6
{
	switch (iParam0)
	{
		case 29:
...
void func_65(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x3E59
{
	int i;
...
BOOL func_68(int iParam0) // Position - 0x418B
{
	int num;
	int i;
...
int func_72(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x42B4
{
...
void func_77(int iParam0) // Position - 0x45DD
{
	...
	vector = { func_96(iParam0) };

	if (IS_BIT_SET(vector.f_4, 2))
		func_82(iParam0, &vector);
...
BOOL func_80(int iParam0) // Position - 0x4D49
{
	Hash entityModel;
...
Vehicle func_81(Vehicle veParam0) // Position - 0x4DB5
{
	return veParam0;
}
...
var func_91(BOOL bParam0, var uParam1, var uParam2) // Position - 0x59B2
{
	if (bParam0)
		return uParam1;
...
void func_99(Blip blParam0, var uParam1) // Position - 0x86CC
{
	int value;
	int num;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x8846
{
...
Blip func_107(Pickup pkParam0) // Position - 0x8AEA
{
	Blip blip;
...
var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B22
{
	if (bParam0)
		return uParam1;
...
Blip func_112(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8DFD
{
	return func_113(veParam0, !bParam1, bParam2);
}

Blip func_113(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8E10
{
	Blip blip;
...
BOOL func_116(int iParam0) // Position - 0x8F83
{
	int num;
	int num2;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8FD3
{
...
BOOL func_118(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x9021
{
	Global_21846 = 0;
...
BOOL func_121(Player plParam0) // Position - 0x9389
{
	return func_122(plParam0, 20);
}

BOOL func_122(Player plParam0, int iParam1) // Position - 0x9399
{
	return IS_BIT_SET(Global_1895156[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x93B1
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x9541
{
	if (func_38(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x9720
{
...
BOOL func_139(int iParam0) // Position - 0x98C0
{
	if (iParam0 == 1)
		if (Global_20500.f_1 > 3)
...
void func_141(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9940
{
	if (bParam0)
	{
...
BOOL func_143(Player plParam0, int iParam1) // Position - 0x9AA7
{
	BOOL flag;
...
BOOL func_145(Player plParam0) // Position - 0x9B41
{
	Player player;
...
BOOL func_146(Player plParam0) // Position - 0x9B63
{
...
int func_148(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9BB0
{
	int num;
...
void func_153() // Position - 0x9F70
{
	if (!ENTITY::IS_ENTITY_DEAD(veLocal_173, false))
	{
		...
		{
			ENTITY::SET_ENTITY_HEALTH(veLocal_173, 0, 0);
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0xA6B8
{
...
BOOL func_161(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xACA5
{
...
int func_163(BOOL bParam0) // Position - 0xAD96
{
	if (func_164())
	{
		Global_113800 = true;
		...
		if (bParam0 && func_62(Global_113799))
...
BOOL func_164() // Position - 0xADE9
{
	switch (func_165(&Global_32343, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xAFA5
{
	return func_168(iParam0, Global_43377);
}

BOOL func_168(int iParam0, int iParam1) // Position - 0xAFB6
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_169(int iParam0) // Position - 0xB197
{
	if (Global_43377 == 15)
		return false;
...
Blip func_171(Entity eParam0, BOOL bParam1, int iParam2) // Position - 0xB30B
{
	Blip blip;
...
void func_176(Ped pedParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xB763
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0xB77C
{
	char* str;
...
void func_178() // Position - 0xB971
{
	...
	if (iLocal_47 == 1)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_126 - { 20f, 20f, 20f }, uLocal_126 + { 20f, 20f, 20f }, false, true, true, true);
	...
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_129 - { 20f, 20f, 20f }, uLocal_129 + { 20f, 20f, 20f }, false, true, true, true);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC902
{
...
BOOL func_204(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEB42
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
...
BOOL func_205(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xEEDC
{
	if (bParam6)
...
BOOL func_206(eCharacter echParam0) // Position - 0xEF23
{
	int num;
...
BOOL func_207(int iParam0) // Position - 0xEF44
{
...
BOOL func_215(int iParam0, int iParam1) // Position - 0xF23F
{
	int num;
	int num2;
...
BOOL func_216(int iParam0) // Position - 0xF34B
{
	int num;
	int num2;
	int num3;
...
BOOL func_217(int iParam0, int iParam1) // Position - 0xF427
{
...
BOOL func_218(int iParam0) // Position - 0xF447
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_224() || func_223() || func_222() || func_221() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_226() || Global_32286 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || Global_113810.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_224() || func_223() || func_221() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_226() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_130(8, -1) || func_221() || func_220() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_226() || Global_32286 || func_225() || func_130(8, -1) || func_223() || func_222() || func_221() || Global_113810.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_226() || func_223() || Global_112857 || Global_32286 || func_225() || Global_44569 || func_130(8, -1) || func_222() || func_220() || func_221() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_219() // Position - 0xFB64
{
	return Global_100872.f_1;
}

BOOL func_220() // Position - 0xFB72
{
	if (Global_97735 != -1)
...
BOOL func_229(int iParam0, int iParam1, eCharacter echParam2) // Position - 0xFC5D
{
	BOOL num;
	eCharacter character;
...
int func_230(eCharacter echParam0) // Position - 0xFD41
{
...
BOOL func_231(int iParam0) // Position - 0xFD65
{
	int num;
	BOOL flag;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xFE01
{
	int profileSetting;
...
void func_237(int iParam0) // Position - 0x1022E
{
	...
	if (func_200())
	{
		...
		func_240(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_239(Global_113799, true), 64);
