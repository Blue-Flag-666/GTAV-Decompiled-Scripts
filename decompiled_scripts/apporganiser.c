...
void func_8()
{
	...
	if (!Global_97066)
	{
		Global_97250 = CLOCK::GET_CLOCK_MONTH();
		Global_97249 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
		Global_97248 = CLOCK::GET_CLOCK_HOURS();
		Global_97066 = 1;
		Global_97071 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
		Global_97070 = CLOCK::GET_CLOCK_HOURS();
		func_12();
		return;
	}
