...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_83 = func_357(60);
	uLocal_84 = func_357(14);
...
void func_8()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_11(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_9(iVar0) && (!func_13(14) || Global_111873))
			{
...
void func_17(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_18(iParam0) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_90768[26 /*34*/].f_6) == 0)
			{
				Global_112922.f_7261[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_112922.f_7261[iParam0], true, true);
			}
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_41(&iVar20);
		iVar21 = func_40(Var10, Global_112922.f_7688.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_38(Global_112922.f_7688.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_36(Global_112922.f_7688.f_765[iVar20 /*10*/]))
				{
					Global_112922.f_7688.f_765[iVar20 /*10*/] = { Var10 };
					func_37(&Var10);
					return 1;
...
void func_41(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_40(Global_112922.f_7688.f_765[iVar0 /*10*/], Global_112922.f_7688.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (BitTest(Global_77669[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_82(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
							func_104(14);
							if (Global_77667 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
						}
						func_104(iVar0);
						if (Global_77667 == 1)
						{
			...
			{
				Global_77669[1 /*14*/] = { func_112(iVar10, iVar0, func_71(iParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
		}
		if (Global_77667 == 1)
		{
			iVar2 = 0;
...
int func_63(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_176(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_64, Global_112922.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_176(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_61, Global_112922.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_97(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[0], Global_112922.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_97(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[1], Global_112922.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_97(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[2], Global_112922.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_106(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2822371[iParam0 /*3*/][func_107(iParam2)];
	if (iVar0 != 0)
	{
...
int func_108(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		iVar0 = Global_2822371[iParam0 /*3*/][func_107(iParam1)];
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_115(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_115(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_176(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_176(iParam0, iVar2, uVar5[iVar2]))
				{
							...
							if (!func_176(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									...
									if (Global_77669[2 /*14*/].f_12 == iVar3)
									{
										...
										{
											if (!func_68(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77669[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						if (!func_68(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77669[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77669[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_72(iParam1)) && Global_77669[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_72(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (Global_78112 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_222(Global_78113, Global_78115, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
{
	if (((!func_234(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
...
{
	return func_236(iParam0, Global_42602);
}
...
int func_251(int iParam0, int iParam1, int iParam2, char* sParam3)
{
	...
	while (iVar1 < 8)
	{
		...
		{
			if (Global_54522[iVar0 /*53*/] == iParam1 && Global_54522[iVar0 /*53*/].f_1 == iParam2)
			{
				if (iParam0 == Global_54522[iVar0 /*53*/].f_3)
				{
					Global_54522[iVar0 /*53*/].f_5 = 1;
					StringCopy(&(Global_54522[iVar0 /*53*/].f_6), sParam3, 16);
				}
				return 1;
			}
		}
...
void func_256(int iParam0, bool bParam1)
{
	...
	{
		func_295(&(Global_112009[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_259()
{
	...
	{
		func_322(13, SYSTEM::FLOOR(Global_112922.f_10194.f_3853));
	}
...
int func_281(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77669[1 /*14*/] = { func_112(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_72(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_72(iParam1), Global_77669[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, 0);
		}
	}
...
void func_282(char* sParam0, var uParam1)
{
...
void func_286(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_287(&sVar32, Var0.f_3, Global_100017, bParam1, bParam2);
	}
}
...
void func_289()
{
	...
	{
		func_8();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_290(Global_112922.f_2363.f_539.f_4321));
	}
	else
	{
...
void func_291()
{
	...
	if (MISC::IS_XBOX360_VERSION() || func_293())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if (MISC::IS_PS3_VERSION() || func_292())
	{
...
void func_296(int iParam0, bool bParam1)
{
	...
	func_312(iParam0, Global_78127);
	if (!bParam1)
	{
		iVar32 = func_311(iParam0);
		if (iVar32 != 0)
		{
...
{
	func_300(iParam0, 1);
	Global_112922.f_18574[iParam0 /*6*/].f_3 = func_299();
...
void func_306(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	if (iParam0 != 198)
	{
		if (Global_77858)
		...
		func_309(iParam0, bParam3, iParam4, 0);
...
void func_313(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_320(iParam0))
		{
			...
			if (!bParam1)
			{
				func_318(func_319(iParam0));
				if (!func_317(68))
				{
					func_314("DI_HLP_STRY", 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
void func_315(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
int func_335()
{
	...
	iVar0 = func_336(&(Global_99980.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_339()
{
	...
	{
		if (func_334(&(Global_99980.f_3)) > -1)
		{
			return 1;
		}
	}
