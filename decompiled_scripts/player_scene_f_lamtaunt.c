...
void main() // Position - 0x0
{
	...
	bLocal_261 = true;
	iLocal_276 = -1;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_507, "", 16);
	fLocal_511 = 0f;
	...
	while (bLocal_261 && func_137(2, 0))
	{
		...
		switch (iLocal_70)
		{
			...
			case 2:
				if (func_133())
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 0, unk_0xC1A5EC5C986B98AD(), "FRANKLIN", 0, 1);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 2, Global_100402, "LAMAR", 0, 1);
					iLocal_70 = 3;
				}
				break;
...
BOOL func_2() // Position - 0x171
{
	...
	for (i = 0; i < iLocal_262; i = i + 1)
	{
		func_125(&iLocal_262[i], i);
	}
...
void func_3(int iParam0) // Position - 0x1B0
{
	...
	{
		if (!bLocal_517 && unk_0x7559C38E6535AB89(iParam0, unk_0xC1A5EC5C986B98AD(), 1))
		{
			character = func_124(iParam0);
			num = func_121(character);
			num2 = func_120(num);
		
			if (num2 != -1)
			{
				num3 = func_118(iParam0);
			
				if (num3 != 0)
				{
					if (!func_117(num2) || func_109(num2) == 6)
					{
						func_108(75, unk_0x30BE8A934C020461(iParam0, 0), 250f, -1);
					
						if (func_41(Global_96415, character, 2, 0, num3, num2, 75))
							bLocal_517 = true;
					}
				}
			}
	...
	func_6(iParam0, 138, &uLocal_72, "FMFAUD", &uLocal_237, &uLocal_258, 3);
	num4 = SYSTEM::VDIST2(unk_0x30BE8A934C020461(iParam0, 1), unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1));

	if (num4 > 8f * 8f)
	{
		iLocal_515 = -1;
	}
	else if (unk_0x70ACD9400516DB25(iParam0))
	{
		iLocal_515 = -1;
	}
	else
	{
		if (iLocal_515 <= 0)
			iLocal_515 = unk_0xA5E11AF0A2B928C1();
	
		if (iLocal_515 > 0)
		{
			if (iLocal_516 == 0)
			{
				if (iLocal_515 + 15000 < unk_0xA5E11AF0A2B928C1())
				{
			...
			else if (iLocal_515 + 10000 < unk_0xA5E11AF0A2B928C1())
			{
...
{
	unk_0x824D23CC0FE1835A(iParam0, sParam1, func_5(iParam2), 1);
	return;
}
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6) // Position - 0x517
{
	...
	vector = { unk_0x30BE8A934C020461(iParam0, 1) };
	...
	if (iParam1 == 6 || iParam1 == 31)
		if (unk_0x2655A8EC638E4FD1(vector2.f_2 - vector.f_2) > 2f)
			return 0;
	else if (!unk_0x865259F0333CAA4B(iParam0) || !unk_0x51DF6895C236B231(iParam0))
		return 0;
	...
	if (!unk_0x87644B1F984197FE(0, 46) && !unk_0xE665ABCFC5784C35(0, 46))
		return 0;

	if (!flag)
	{
		unk9 = unk_0x846426CCFA47452B(iParam0);
	
		if (Global_100733.f_386 != unk9)
			return 0;
	}
	...
	if (unk_0x42FA33BDEDF21186(&unk10))
		num2 = 1;
	else
		num2 = 0;
	...
	if (num2 || func_31(sParam3, &unk5, uParam4))
	{
		if (num == 5)
			if (character == CHAR_MICHAEL)
				_CONVERSATION_INITIALIZE_ACTOR(uParam2, 0, unk_0xC1A5EC5C986B98AD(), "MICHAEL", 0, 1);
			else if (character == CHAR_FRANKLIN)
				_CONVERSATION_INITIALIZE_ACTOR(uParam2, 0, unk_0xC1A5EC5C986B98AD(), "FRANKLIN", 0, 1);
			else if (character == CHAR_TREVOR)
				_CONVERSATION_INITIALIZE_ACTOR(uParam2, 0, unk_0xC1A5EC5C986B98AD(), "TREVOR", 0, 1);
...
BOOL func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5) // Position - 0x94E
{
	...
	if (func_29(sParam0, 7))
	{
		...
		{
			_CONVERSATION_INITIALIZE_ACTOR(uParam2, 0, unk_0xC1A5EC5C986B98AD(), str, 0, 1);
...
{
	if (unk_0x7F29CD9C0A5C1E44(sParam0, iParam1))
		return true;
	else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xE444FD7526C8BB46())
		if (!unk_0x013E7E3AE7157E76(iParam1))
...
int func_31(char* sParam0, var uParam1, var uParam2) // Position - 0x1229
{
	...
	if (func_29(sParam0, 7))
	{
		...
		{
			if (!unk_0x2AC37494BBF1DB16(&uParam2->[i /*4*/]))
			{
				for (j = 0; j < num2; j = j + 1)
				{
					if (!unk_0x2AC37494BBF1DB16(&num2[j /*4*/]))
					{
						if (unk_0x4310A0DB886F9FED(&uParam2->[i /*4*/], &num2[j /*4*/]))
						{
		...
		num4 = unk_0x15A88CFAAFFC6C4B(0, num3 + 1);
		*uParam1 = { num2[num4 /*4*/] };
...
void func_39() // Position - 0x1A9A
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_36(character) && !func_24(14) || Global_112599)
			{
...
BOOL func_41(var uParam0, eCharacter echParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1BD4
{
	...
	num = 3;
	num2 = func_121(echParam1);
	num3 = func_107(uParam0);
	num4 = 10000;

	if (iParam3 == 0)
	{
		if (func_105(num2, iParam2, -1, &num5, &num6))
		{
			if (iParam5 == -1)
				return false;
			...
			if (func_101(iParam5, num5, num6, num, num3, echParam1, num4, 10000, iParam6, iParam4, num8, num7, 1))
				return true;
			else
				return false;
		}
	}
	else if (func_97(num2, iParam2, -1, &unk))
	{
...
int func_43(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x1DC0
{
	...
	return func_44(func_76(echParam0), 0, iParam1, iParam2, false);
}
...
void func_47(int iParam0) // Position - 0x26CF
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_49() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x061B1200C95204CB(&(Global_113648.f_20566.f_471), iParam0);
		unk_0x061B1200C95204CB(&(Global_2359296[func_49() /*5568*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x284D
{
	switch (iParam0)
	{
		case 0:
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x295B
{
	int num;
...
int func_51(int iParam0) // Position - 0x298B
{
	int num;
	int num2;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x29CB
{
	if (iParam2 == -1)
		iParam2 = func_52();
...
BOOL func_55(int iParam0) // Position - 0x2A09
{
	int num;
	int num2;
	int num3;
	...
	return IS_BIT_SET(Global_2359296[func_49() /*5568*/].f_681.f_10, iParam0);
}

int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x2BAF
{
	var unk;
	int num;
...
BOOL func_61(var uParam0, int iParam1) // Position - 0x2D77
{
	int i;
	var unk;
...
void func_66(var uParam0, int iParam1) // Position - 0x2EF8
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_71(int iParam0) // Position - 0x2F6E
{
	switch (iParam0)
	{
		case 60:
...
int func_76(eCharacter echParam0) // Position - 0x3104
{
	return Global_2028[echParam0 /*29*/].f_17;
}

int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x3115
{
	int num;
...
BOOL _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x3275
{
	int num;
	char* str;
	int num2;
	...
	if (func_84(echParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_8960 = iParam6;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x3304
{
	return Global_2028[character /*29*/].f_3;
}

int func_84(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3317
{
	int num;
	BOOL flag;
	...
	func_85(echParam0, sParam1, flag, func_86(unk_0x93E99A2DBCBA9CFA()));
	return 1;
}

void func_85(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x37F2
{
	if (!func_15())
		return;
...
var func_86(int iParam0) // Position - 0x384F
{
				...
				if (iParam0 == Global_8260[num /*15*/].f_11)
				{
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (Global_2694519)
								if (num == 14)
									func_88(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_88(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78558)
								{
									...
									func_88(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_88(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8260[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_88(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_88(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
...
void func_88(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x3DFE
{
...
void func_89(int iParam0) // Position - 0x3EB1
{
...
void func_90(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3EC3
{
	unk_0x9FD96C5DE6EDFC15(uParam0, sParam1);
	unk_0xC6A3EF6C4A3412C1(SYSTEM::ROUND(fParam2));
...
void func_94() // Position - 0x3FE3
{
	...
	while (num3 < num2)
	{
		if (!func_95(Global_113648.f_14143[num3 /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18))
			Global_22792 = num3;
...
BOOL func_95(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x40AF
{
	int num;
	int num2;
	int num3;
...
int func_96() // Position - 0x419A
{
	...
	while (i < num2)
	{
		if (Global_113648.f_14143[i /*104*/].f_24 == 0 || Global_113648.f_14143[i /*104*/].f_24 == 1)
			if (!func_95(Global_113648.f_14143[i /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18))
				Global_22792 = i;
...
BOOL func_97(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4302
{
	var unk;
	var unk5;
	int num;
	...
	else
	{
		...
		TEXT_LABEL_APPEND_STRING(&unk, func_100(iParam0), 16);
		TEXT_LABEL_APPEND_STRING(&unk, "_", 16);
		...
		if (iParam2 == -1)
		{
			...
			if (func_98(&unk5[0 /*4*/], num))
				iParam2 = 1;
			else if (func_98(&unk5[1 /*4*/], num))
				iParam2 = 0;
			else
...
BOOL func_98(var uParam0, int iParam1) // Position - 0x443A
{
	int num;
	int num2;
	...
	while (num < 35)
	{
		if (!unk_0xB71C73D0269747D5(&Global_113648.f_14143[num /*104*/]))
			if (unk_0x4310A0DB886F9FED(&Global_113648.f_14143[num /*104*/], uParam0))
				if (Global_113648.f_14143[num /*104*/].f_99[iParam1])
					num2 = 1;
...
BOOL func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, eCharacter echParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x4583
{
	int num;
	...
	if (Global_113648.f_7690.f_764 < 8)
	{
		...
		func_102(CHAR_MICHAEL);
		func_102(CHAR_FRANKLIN);
		func_102(CHAR_TREVOR);
		return true;
	}
...
void func_102(eCharacter echParam0) // Position - 0x46BE
{
	int i;
	int num;
	int j;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x47E6
{
...
BOOL func_105(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4) // Position - 0x480E
{
	var unk;
	int num;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_97(iParam0, iParam1, 0, &unk[0 /*4*/]) && func_97(iParam0, iParam1, 1, &unk[1 /*4*/]))
			{
				num = func_99(iParam0);
			
				if (func_98(&unk[0 /*4*/], num))
					iParam2 = 1;
				else if (func_98(&unk[1 /*4*/], num))
					iParam2 = 0;
				else
					iParam2 = unk_0x15A88CFAAFFC6C4B(0, 2);
			}
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x49F5
{
	if (iParam0 == iParam5)
		return;
	...
	Global_43258[iParam0 /*5*/] = { uParam1 };
...
int func_109(int iParam0) // Position - 0x4A3E
{
	...
	for (i = 0; i < Global_113648.f_7690.f_764; i = i + 1)
	{
		if (Global_113648.f_7690.f_651[i /*14*/] == iParam0)
			return func_113(iParam0, unk);
	}

	for (i = 0; i < Global_113648.f_7690.f_866; i = i + 1)
	{
		if (Global_113648.f_7690.f_765[i /*10*/] == iParam0)
			return func_110(iParam0, unk);
	}

	return 6;
}

int func_110(int iParam0, var uParam1) // Position - 0x4AF4
{
	int num;
	BOOL flag;
	...
	if (flag)
		if (num.f_3 < Global_113648.f_7690.f_919[_GET_CURRENT_PLAYER_CHARACTER_0()])
			return 5;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x4B89
{
	func_39();
	return Global_113648.f_2365.f_539.f_4321;
}
...
int func_113(int iParam0, var uParam1) // Position - 0x4BF1
{
	int num;
	BOOL flag;
...
int func_115(int iParam0, var uParam1) // Position - 0x4CCC
{
	int num;
	BOOL flag;
...
BOOL func_117(int iParam0) // Position - 0x4DBC
{
	int i;
...
int func_119(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4F4B
{
	int i;
	float num;
	float num2;
...
int func_121(eCharacter echParam0) // Position - 0x5031
{
	if (echParam0 == _CHAR_NULL)
		return 7;

	if (echParam0 < func_123())
		return func_122(echParam0);
...
int func_122(eCharacter echParam0) // Position - 0x5089
{
	return Global_2028[echParam0 /*29*/].f_11;
}

eCharacter func_123() // Position - 0x509A
{
...
eCharacter func_124(int iParam0) // Position - 0x50BC
{
	eCharacter i;
	int num;
	eCharacter character;
...
int func_125(int iParam0, int iParam1) // Position - 0x5102
{
	...
	if (unk_0x7DE17ACDD8BA2642(*iParam0))
	{
		...
		switch (uLocal_270[iParam1])
		{
			case 0:
				if (unk_0x7BB3D8F4F6310EB8(*iParam0, &uLocal_361, &uLocal_442[iParam1 /*16*/], 2))
				{
					num2 = fLocal_514;
					num3 = -1f;
					num4 = -1f;
				
					if (unk_0x8EE7F4F26F4886B7(&uLocal_361, &uLocal_442[iParam1 /*16*/], "WalkInterruptible", &num3, &num4))
						num2 = num3;
					else
						num2 = fLocal_514;
				
					if (unk_0xABF98B1999FE64CA(Global_98011) > num2)
					{
						if (func_131(uLocal_291[iParam1 /*3*/], 0f, 0f, 0f, false))
						{
							unk = { unk_0x30BE8A934C020461(*iParam0, 1) };
							uLocal_291[iParam1 /*3*/] = { (unk - uLocal_277) * { 4f, 4f, 4f } };
							uLocal_291[iParam1 /*3*/].f_2 = 0f;
						}
						...
						if (unk_0x66599E73DBA5A850(*iParam0))
						{
							...
							unk_0x99C48B4CDA4D89A7(*iParam0, uLocal_277 + (uLocal_291[iParam1 /*3*/] * { 0.1f, 0.1f, 0.1f }), 1f, -1, 1193033728, 1056964608);
							unk_0xC5F9EF8F410596F9(*iParam0, joaat("MotionState_Walk"), 0, 1, 0);
							unk_0xBB6027D1D193CBA6(*iParam0, 0, 0);
							unk_0x0211CB63720F4D7C(*iParam0, 2);
						}
				...
				if (!unk_0x411B750250543BD0(Global_98010) && !unk_0x411B750250543BD0(Global_98011))
				{
					SYSTEM::WAIT(0);
			...
			case 1:
				if (unk_0xF5F493B789EA063E(*iParam0, joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD")) != 1)
				{
					unk_0x7D9A648CC1936BDA(*iParam0, uLocal_277 + uLocal_291[iParam1 /*3*/], 1f, -1, 0.25f, num, 1193033728);
					uLocal_270[iParam1] = 2;
					return 1;
				}
			
				num5 = SYSTEM::VMAG(uLocal_291[iParam1 /*3*/] * { 0.05f, 0.05f, 0.05f });
			
				if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(*iParam0, 1), uLocal_277) >= num5)
				{
					if (!func_130() && !unk_0x865259F0333CAA4B(*iParam0))
					{
						unk_0x7D9A648CC1936BDA(*iParam0, uLocal_277 + uLocal_291[iParam1 /*3*/], 1f, -1, 0.25f, num, 1193033728);
						uLocal_270[iParam1] = 2;
						return 1;
				...
				if (unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), *iParam0) || unk_0xB8C39D031C377E33(*iParam0, 0))
				{
					uLocal_270[iParam1] = 10;
					return 1;
				}
				break;
		
			case 2:
				if (unk_0x48A4D45B3B4CEFFD(*iParam0) || unk_0xBACC143C07E3925E(*iParam0))
					return 0;
				...
				{
					if (uLocal_308[iParam1] == 0f)
						uLocal_308[iParam1] = SYSTEM::VMAG(uLocal_291[iParam1 /*3*/]) * 0.75f;
				
					unk_0xAE8B22E491138054(*iParam0, uLocal_277 + uLocal_291[iParam1 /*3*/], uLocal_308[iParam1], 1077936128, 1086324736);
					uLocal_270[iParam1] = 3;
					return 1;
				}
			...
			case 3:
				...
				if (unk_0xF0D71A193E011DE7(sLocal_513))
					unk_0x2112CE9FD54D593A(sLocal_513, 0);
			
				if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(*iParam0, 1), uLocal_277 + uLocal_291[iParam1 /*3*/]) < uLocal_308[iParam1] * uLocal_308[iParam1])
				{
					if (unk_0x271BB87FB0E07F8A(uLocal_277 + uLocal_291[iParam1 /*3*/], uLocal_308[iParam1], 1))
					{
						unk_0x978687517F88D889(*iParam0, uLocal_277 + uLocal_291[iParam1 /*3*/], uLocal_308[iParam1], 0);
						uLocal_270[iParam1] = 4;
						return 1;
					}
				}
				break;
			...
			case 4:
				if (unk_0xA239AFE8684C2BD1(*iParam0))
				{
				}
				else
				{
					...
					unk4 = { func_126(uLocal_277 + uLocal_291[iParam1 /*3*/], func_129(uLocal_308[iParam1] * 0.9f, 10f, 100f), 0f) };
				
					if (unk_0xF5F493B789EA063E(*iParam0, joaat("SCRIPT_TASK_USE_NEAREST_SCENARIO_TO_POS")) == 1)
					{
					}
					else if (unk_0xD150D18ADFDC5159(unk4, 0, &vector, 14))
					{
						if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(*iParam0, 1), vector) > 100f)
						{
							unk_0x7D9A648CC1936BDA(*iParam0, vector, 1f, -1, 0.25f, num, 1193033728);
							uLocal_270[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				{
					if (i != iParam1)
						if (uLocal_270[i] == 2 || uLocal_270[i] == 3)
							uLocal_270[i] = 10;
				}
			
				unk_0x0133FF6E23A1DCA4(5, uLocal_275, joaat("PLAYER"));
				unk_0x0133FF6E23A1DCA4(5, joaat("PLAYER"), uLocal_275);
				unk_0x0133FF6E23A1DCA4(5, uLocal_275, Global_95685);
				unk_0x0133FF6E23A1DCA4(5, Global_95685, uLocal_275);
				unk_0xB7EB8CCA28444BAB(*iParam0, 15f, 0);
				uLocal_270[iParam1] = 11;
				return 1;
...
Vector3 func_126(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x56FC
{
	float num;
	float num2;
	float num3;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		num = { unk_0xD88C7A93096DA0F7(-fParam3, fParam3), unk_0xD88C7A93096DA0F7(-fParam3, fParam3), 0f };
	
		if ((num * num) + (num.f_1 * num.f_1) <= num2)
		{
			num3 = fParam4 / 2f;
			num.f_2 = unk_0xD88C7A93096DA0F7(-num3, num3);
			return uParam0 + num;
		}
	}

	return func_127(uParam0, fParam3, fParam4);
}

Vector3 func_127(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x5775
{
	var unk;
	float num;
	...
	num = fParam4 / 2f;
	unk = { func_128(unk, unk_0xD88C7A93096DA0F7(0f, fParam3)) };
	unk.f_2 = unk_0xD88C7A93096DA0F7(-num, num);
	return uParam0 + unk;
}

Vector3 func_128(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x57BD
{
	float num;
...
BOOL func_131(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x5835
{
	if (bParam6)
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x587C
{
	...
	if (!func_134())
	{
		if (unk_0x411B750250543BD0(Global_98011))
		{
			...
			if (!bLocal_512)
			{
				...
				else if (_CONVERSATION_ADD_LINE(&uLocal_72, "PRSAUD", &uLocal_507, 3, 0, 0, 0))
				{
					bLocal_512 = true;
				}
			}
...
BOOL func_135() // Position - 0x59F2
{
	...
	if (!func_134())
	{
		if (unk_0x411B750250543BD0(Global_98011))
		{
			for (i = 0; i < iLocal_262; i = i + 1)
			{
				if (!unk_0x66599E73DBA5A850(iLocal_262[i]))
				{
					unk_0x468D976993BF7FE1(iLocal_262[i], Global_98011, &uLocal_361, &uLocal_442[i /*16*/], 8f, -4f, 3, 0, 1148846080, 0);
					uLocal_270[i] = 0;
				}
				else
				{
...
BOOL func_136() // Position - 0x5A7B
{
	...
	if (unk_0x411B750250543BD0(Global_98010))
	{
		...
		{
			if (!unk_0x66599E73DBA5A850(iLocal_262[i]))
				unk_0x468D976993BF7FE1(iLocal_262[i], Global_98010, &uLocal_361, &uLocal_377[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		}
	
		if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 1, unk_0xC1A5EC5C986B98AD(), "FRANKLIN", 0, 1);
	
		if (!unk_0x66599E73DBA5A850(Global_100402))
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 4, Global_100402, "LAMAR", 0, 1);
	
		if (!unk_0x66599E73DBA5A850(iLocal_262[0]))
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 5, iLocal_262[0], "GangMember1", 0, 1);
	
		if (!unk_0x66599E73DBA5A850(iLocal_262[1]))
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 6, iLocal_262[1], "GangMember2", 0, 1);
...
BOOL func_137(int iParam0, int iParam1) // Position - 0x5B5B
{
	Vector3 vector;
	float num;
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x5C49
{
...
void func_145() // Position - 0x5D0B
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_262; i = i + 1)
		{
			if (iLocal_266[i] != 0)
			{
				unk_0x852EC2A7DE66202D(iLocal_266[i]);
			
				if (!unk_0x0CBB7C273DED26E7(iLocal_266[i]))
				{
					flag = false;
					unk_0x852EC2A7DE66202D(iLocal_266[i]);
				}
		...
		if (!unk_0x2AC37494BBF1DB16(&uLocal_361))
		{
			unk_0x28818732C8F0F80E(&uLocal_361);
		
			if (!unk_0x2BBF749E555360DC(&uLocal_361))
			{
				flag = false;
				unk_0x28818732C8F0F80E(&uLocal_361);
			}
	...
	if (unk_0x7DE17ACDD8BA2642(Global_100402))
	{
		if (func_37(CHAR_LAMAR) == unk_0x504B9BB48D41C264(Global_100402))
			unk_0x85BAE84748AD1A23(Global_100402, 1, 1);
	
		func_146(&Global_100402, Global_95685);
		unk_0x598D91BBD045C1F3(Global_100402, 132, 1);
		unk_0x598D91BBD045C1F3(Global_100402, 317, 1);
		func_146(&Global_100402, Global_95685);
	}

	unk_0xDA95D0C19E737224("TAUNTERS", &uLocal_275);

	for (i = 0; i < iLocal_262; i = i + 1)
	{
		if (iLocal_266[i] != 0)
		{
			iLocal_262[i] = unk_0x69FDD9508259E5B5(iLocal_276, iLocal_266[i], uLocal_277 + uLocal_281[i /*3*/], 0, 1, 1);
			unk_0x692C3FDAD7DB53CC(iLocal_262[i], fLocal_280 + uLocal_304[i]);
			unk_0x90FF6DBE9D84E401(iLocal_262[i], 0);
			unk_0x8386356641D0DED1(iLocal_262[i], uLocal_275);
			unk_0x3EE48ADC8C7F5CC4(iLocal_262[i], &uLocal_361, &uLocal_377[i /*16*/], 8f, -8f, -1, 9, 0, 0, 0, 0);
			unk_0x598D91BBD045C1F3(iLocal_262[i], 317, 1);
		
			if (iLocal_276 == 6)
				unk_0xCBDC2B59922F92C3(iLocal_262[i], joaat("WEAPON_STUNGUN"), 1000, 0, 1);
		}
	}
...
void func_146(int iParam0, int iParam1) // Position - 0x5EE9
{
	unk_0xD14067404D35AAE7(*iParam0, 0);
	unk_0x598D91BBD045C1F3(*iParam0, 20, 1);
	unk_0xBB5C1E4A07AE1774(*iParam0, 16);

	if (iParam1 != joaat("NO_RELATIONSHIP"))
		unk_0x8386356641D0DED1(*iParam0, iParam1);
...
void func_147() // Position - 0x5F1F
{
	...
	func_151(iLocal_71, &uLocal_277, &fLocal_280, &unk);
	func_149(iLocal_71, &uLocal_313, &uLocal_329, &uLocal_345, &unk9, &unk10);

	switch (iLocal_71)
	{
		case 218:
			uLocal_281[0 /*3*/] = { unk_0xD88C7A93096DA0F7(-10f, 10f), unk_0xD88C7A93096DA0F7(-10f, 10f), 0f };
			uLocal_281[1 /*3*/] = { unk_0xD88C7A93096DA0F7(-10f, 10f), unk_0xD88C7A93096DA0F7(-10f, 10f), 0f };
			uLocal_291[0 /*3*/] = { -77.3f, -4.1f, 1f };
			uLocal_291[1 /*3*/] = { uLocal_291[0 /*3*/] };
			uLocal_291[iLocal_262 /*3*/] = { 66.7f, -7.299f, 1f };
			uLocal_304[0] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_304[1] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_308[0] = 30f;
			uLocal_308[1] = uLocal_308[0];
			uLocal_308[iLocal_262] = 20f;
			fLocal_514 = 0.94f;
			iLocal_266[0] = joaat("G_M_Y_StrPunk_01");
			iLocal_266[1] = joaat("G_M_Y_StrPunk_02");
			iLocal_276 = 7;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361, "SWITCH@FRANKLIN@GANG_TAUNT_P1", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[0 /*16*/], "gang_taunt_loop_thug_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[1 /*16*/], "gang_taunt_loop_thug_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[0 /*16*/], "gang_taunt_exit_thug_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[1 /*16*/], "gang_taunt_exit_thug_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_507, "FRAS_IG_6_P1", 16);
			fLocal_511 = 0f;
			break;
	
		case 219:
			uLocal_281[0 /*3*/] = { -0.2331f, 0.0497f, 0.0041f };
			uLocal_281[1 /*3*/] = { 0.6908f, -0.4534f, 0.0042f };
			uLocal_291[0 /*3*/] = { -0.6f, -144.3f, 0f };
			uLocal_291[1 /*3*/] = { uLocal_291[0 /*3*/] };
			uLocal_291[iLocal_262 /*3*/] = { 112.2308f, 43.129f, 3.188f };
			uLocal_304[0] = 180f;
			uLocal_304[1] = 180f;
			uLocal_308[0] = 40f;
			uLocal_308[1] = uLocal_308[0];
			uLocal_308[iLocal_262] = 40f;
			fLocal_514 = 0.94f;
			iLocal_266[0] = joaat("G_M_Y_StrPunk_01");
			iLocal_266[1] = joaat("G_M_Y_StrPunk_02");
			iLocal_276 = 7;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361, "SWITCH@FRANKLIN@GANG_TAUNT_P3", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[0 /*16*/], "gang_taunt_with_lamar_loop_g1", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[1 /*16*/], "gang_taunt_with_lamar_loop_g2", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[0 /*16*/], "gang_taunt_with_lamar_exit_g1", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[1 /*16*/], "gang_taunt_with_lamar_exit_g2", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_507, "FRAS_IG_6_P3", 16);
			fLocal_511 = 0f;
			break;
	
		case 220:
			uLocal_281[0 /*3*/] = { 1.7097f, -1.8585f, -0.052f };
			uLocal_281[1 /*3*/] = { 2.7011f, -1.5f, -0.052f };
			uLocal_291[0 /*3*/] = { { 21.5656f, -1890.5951f, 59.4395f } - uLocal_277 };
			uLocal_291[1 /*3*/] = { uLocal_291[0 /*3*/] };
			uLocal_291[iLocal_262 /*3*/] = { { -4.6336f, -54.7307f, 67.5391f } * { -1f, -1f, -1f } };
			uLocal_304[0] = -0.7167f;
			uLocal_304[1] = -0.7167f;
			uLocal_308[0] = 40f;
			uLocal_308[1] = uLocal_308[0];
			uLocal_308[iLocal_262] = 40f;
			fLocal_514 = 0.99f;
			...
			iLocal_276 = 6;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361, "SWITCH@FRANKLIN@GANG_TAUNT_P5", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[0 /*16*/], "fras_ig_6_p5_loop_g1", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[1 /*16*/], "fras_ig_6_p5_loop_g2", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[0 /*16*/], "fras_ig_6_p5_exit_g1", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[1 /*16*/], "fras_ig_6_p5_exit_g2", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_507, "FRAS_IG_6_P4", 16);
			fLocal_511 = 0.625f;
			break;
	
		case 225:
			uLocal_281[0 /*3*/] = { 3.8209f, 1.0394f, 0f };
			uLocal_281[1 /*3*/] = { 4.0994f, -0.0922f, 0f };
			uLocal_291[0 /*3*/] = { { 27.9565f, -1650.5173f, 278.2831f } - uLocal_277 };
			uLocal_291[1 /*3*/] = { uLocal_291[0 /*3*/] };
			uLocal_291[iLocal_262 /*3*/] = { -{ 0f, 62.7f, 54.673f } };
			uLocal_304[0] = -23.9383f;
			uLocal_304[1] = 5.0908f;
			uLocal_308[0] = 40f;
			uLocal_308[1] = uLocal_308[0];
			uLocal_308[iLocal_262] = 40f;
			fLocal_514 = 0.94f;
			...
			iLocal_276 = 7;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361, "SWITCH@FRANKLIN@GANG_TAUNT_P3", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[0 /*16*/], "fras_ig_10_p3_loop_g1", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_377[1 /*16*/], "fras_ig_10_p3_loop_g2", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[0 /*16*/], "fras_ig_10_p3_exit_g1", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_442[1 /*16*/], "fras_ig_10_p3_exit_g2", 64);
			uLocal_507 = { func_148("FRAS_IG_10", 3) };
			fLocal_511 = 0f;
			break;
		...
		default:
			uLocal_281[0 /*3*/] = { unk_0xD88C7A93096DA0F7(-10f, 10f), unk_0xD88C7A93096DA0F7(-10f, 10f), 0f };
			uLocal_281[1 /*3*/] = { unk_0xD88C7A93096DA0F7(-10f, 10f), unk_0xD88C7A93096DA0F7(-10f, 10f), 0f };
			uLocal_291[0 /*3*/] = { 0f, 0f, 0f };
			uLocal_291[1 /*3*/] = { 0f, 0f, 0f };
			uLocal_291[iLocal_262 /*3*/] = { 0f, 0f, 0f };
			uLocal_304[0] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_304[1] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_308[0] = 0f;
			uLocal_308[1] = 0f;
			uLocal_308[iLocal_262] = 0f;
			fLocal_514 = -1f;
			iLocal_266[0] = joaat("G_M_Y_StrPunk_01");
			iLocal_266[1] = joaat("G_M_Y_StrPunk_02");
			iLocal_276 = -1;
	...
	TEXT_LABEL_ASSIGN_STRING(&uLocal_377[iLocal_262 /*16*/], "", 64);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_377[iLocal_262 /*16*/], "", 64);
	return;
}
...
BOOL func_152(var uParam0) // Position - 0x7E7E
{
	...
	if (func_131(vector, 0f, 0f, 0f, false))
...
BOOL func_153(int iParam0, var uParam1, char* sParam2) // Position - 0x7F36
{
	var unk;
	int num;
	var unk4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_157(Global_113648.f_2365.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_157(Global_113648.f_2365.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_157(Global_113648.f_2365.f_539.f_2314[2]), 32);
			return true;
	
		case 11:
			if (func_156(iParam0, &unk, uParam1))
			{
...
BOOL func_154(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xA405
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_156(int iParam0, var uParam1, var uParam2) // Position - 0xC371
{
	switch (iParam0)
	{
		case 11:
...
void func_158() // Position - 0xCD71
{
	...
	for (i = 0; i < iLocal_266; i = i + 1)
	{
		if (iLocal_266[i] != 0)
			unk_0x1EEF71E3CDD868D3(&iLocal_262[i]);
	}

	for (i = 0; i < iLocal_266; i = i + 1)
	{
		if (iLocal_266[i] != 0)
			unk_0xE0A291F406691F03(iLocal_266[i]);
	}

	unk_0x28F88BFAD6397895(uLocal_275);

	if (!unk_0xF0D71A193E011DE7(sLocal_513))
		unk_0x2112CE9FD54D593A(sLocal_513, 1);
