...
void __EntryFunction__()
{
	...
	if (func_398())
	{
		Global_78103 = 1;
		iLocal_94 = 0;
		while (!func_388(&Local_98))
		{
			SYSTEM::WAIT(0);
		}
		func_387(&Local_98, 0, 1);
		Global_78103 = 0;
	}
	func_380(50, 1, 0);
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_364(Local_98.f_9, 0, 0, 0, 0, 0);
...
void func_1()
{
	switch (iLocal_327)
	{
		...
		case 1:
			func_210();
			if (func_208(Local_98.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
			{
...
void func_4(int iParam0, bool bParam1)
{
	...
	{
		func_174(&(Global_112009[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	Global_77669[1 /*14*/] = { func_84(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_77669[1 /*14*/] = { func_84(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_76(iParam1), Global_77669[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_149(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_64, Global_112922.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_77669[1 /*14*/] = { func_84(iVar10, iParam1, iParam2, -1) };
		if (!func_74(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_77669[1 /*14*/] = { func_84(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_77669[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77669[1 /*14*/] = { func_84(iVar10, 14, uVar28[iVar1], -1) };
							func_52(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
							func_67(14);
							if (Global_77667 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_77667 == 1)
						{
			...
			{
				Global_77669[1 /*14*/] = { func_84(iVar10, iVar0, func_42(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77669[1 /*14*/] = { func_84(iVar10, 14, uVar69[iVar1], -1) };
			func_52(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
			func_67(14);
			if (Global_77667 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
		}
		if (Global_77667 == 1)
		{
			iVar2 = 0;
...
{
	Global_77669[1 /*14*/] = { func_84(iParam0, iParam1, iParam2, -1) };
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2822371[iParam0 /*3*/][func_70(iParam2)];
	if (iVar0 != 0)
	{
...
int func_71(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		iVar0 = Global_2822371[iParam0 /*3*/][func_70(iParam1)];
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_149(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_61, Global_112922.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_83(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[0], Global_112922.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_83(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[1], Global_112922.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_83(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[2], Global_112922.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_86(int iParam0)
{
	...
	func_87(&(Global_77669[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_71(func_90(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_71(func_89(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_87(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_87(&(Global_77669[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_87(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_87(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_149(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_149(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_149(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_77669[2 /*14*/] = { func_84(iVar0, 14, iVar4, -1) };
									if (Global_77669[2 /*14*/].f_12 == iVar3)
									{
										if (func_149(iParam0, 14, iVar4))
										{
											if (!func_40(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77669[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_77669[2 /*14*/] = { func_84(iVar0, iVar2, iVar1, -1) };
						if (!func_40(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77669[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77669[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_76(iParam1)) && Global_77669[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_156()
{
	...
	{
		if (func_151(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_150(PLAYER::PLAYER_PED_ID());
			if (func_153(iVar0) && (!func_92(14) || Global_111873))
			{
...
void func_161(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_162(&sVar32, Var0.f_3, Global_100017, bParam1, bParam2);
	}
}
...
void func_167()
{
	...
	{
		func_156();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_168(Global_112922.f_2363.f_539.f_4321));
	}
	else
	{
...
{
	func_179(iParam0, 1);
	Global_112922.f_18574[iParam0 /*6*/].f_3 = func_178();
...
int func_189()
{
	if ((func_9() == -1 || func_9() == 999) && !func_190() == 0)
	{
		return 1;
	}
	return 0;
...
void func_210()
{
	if (!bLocal_491)
	{
		if (iLocal_492 == -1)
		{
			if ((!func_208(Local_98.f_28[0]) || !func_208(Local_98.f_28[1])) || !func_208(Local_98.f_28[2]))
			{
...
void func_211()
{
	switch (iLocal_327)
	{
		...
		case 1:
			...
			func_251();
			func_233();
			func_230(&iLocal_159, "", "", &uLocal_335, iLocal_336, 0);
			func_227();
			func_224();
			func_221();
			func_218();
...
void func_216()
{
	if ((func_208(Local_98.f_28[0]) && func_217(Local_98.f_35[0])) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
	{
	...
	if ((func_208(Local_98.f_28[1]) && func_217(Local_98.f_35[1])) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481))
	{
...
void func_218()
{
	if ((iLocal_465 && func_208(Local_98.f_28[2])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		if (((((!PED::IS_PED_FLEEING(Local_98.f_28[2]) && !TASK::IS_PED_GETTING_UP(Local_98.f_28[2])) && !PED::IS_PED_PRONE(Local_98.f_28[2])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2])) && !func_220(Local_98.f_28[2], 63541484)) && !func_220(Local_98.f_28[2], 242628503))
		{
			if ((!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], true) || (func_217(Local_98.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1], true))) || (func_217(Local_98.f_35[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], true)))
			{
				func_219(1);
...
void func_221()
{
	if ((bLocal_464 && func_208(Local_98.f_28[1])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
	{
		if ((((((!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true)) && !TASK::IS_PED_GETTING_UP(Local_98.f_28[1])) && !PED::IS_PED_PRONE(Local_98.f_28[1])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[1])) && !func_220(Local_98.f_28[1], 63541484)) && !func_220(Local_98.f_28[1], 242628503))
		{
			func_219(1);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, true);
			TASK::TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
...
void func_224()
{
	if (func_208(Local_98.f_28[1]) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		...
		else if ((((((((!bLocal_464 && !func_220(Local_98.f_28[1], 1785177548)) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[1])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true)) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1])) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !func_220(Local_98.f_28[1], 1805844857)) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
		{
...
void func_227()
{
	if (!func_208(Local_98.f_28[0]) || (func_228(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0]) > 150f && (!ENTITY::IS_ENTITY_ON_SCREEN(Local_98.f_28[0]) || !ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 17))))
	{
		if (!func_208(Local_98.f_28[0]))
		{
...
void func_230(int* iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if ((MISC::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (HUD::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_232(sParam1, 0, 0))
					{
						func_231(sParam2, 7500, 0);
					}
				}
			...
			else
			{
				...
				if ((MISC::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_232(sParam2, 0, 0))
					{
						func_231(sParam1, 7500, 0);
					}
				}
				*uParam3 = MISC::GET_GAME_TIMER();
			}
	...
	{
		if (func_232(sParam1, 0, 0))
		{
			HUD::CLEAR_THIS_PRINT(sParam1);
		}
		if (func_232(sParam2, 0, 0))
		{
...
void func_233()
{
	if ((!bLocal_408 && func_208(Local_98.f_28[1])) && func_208(PLAYER::PLAYER_PED_ID()))
	{
		if (((((((iLocal_344 < 4 && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !func_250()) && MISC::GET_GAME_TIMER() > iLocal_345) && func_228(Local_98.f_28[1], PLAYER::PLAYER_PED_ID()) < 10f) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true)) && !PED::IS_PED_FLEEING(Local_98.f_28[1]))
		{
			if (func_234(&uLocal_160, "PAP4AUD", "PAP4_CAMERA", sLocal_339[iLocal_344], 7, 0, 0))
			{
				iLocal_344++;
...
bool func_234(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	...
	Global_2883585 = 0;
	return func_235(sParam2, iParam4, 0);
}
...
int func_251()
{
	...
	if (func_253(Local_98.f_35[0]) || iVar1)
	{
		if (PED::IS_PED_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], false))
		{
			if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
			{
				if (func_252(&uLocal_160, "PAP4AUD", "PAP4_BLOCKED", 7, 0, 0, 0))
				{
					if (((func_208(Local_98.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0])) && !PED::IS_PED_FLEEING(Local_98.f_28[0]))
					{
						TASK::TASK_COMBAT_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
						func_226(&(Local_98.f_41[0]), 0);
					}
...
void func_254()
{
	if (((!bLocal_408 && func_208(PLAYER::PLAYER_PED_ID())) && func_208(Local_98.f_28[0])) && func_274(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 5f, 1))
	{
		if ((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || func_255(Local_98.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_255(Local_98.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			if (MISC::GET_GAME_TIMER() > iLocal_373)
			{
				if (!func_250())
				{
					if (iLocal_372 < 3)
					{
						if (func_234(&uLocal_160, "PAP4AUD", "PAP4_ATTACK", sLocal_368[iLocal_372], 7, 0, 0))
						{
					...
					else if (func_252(&uLocal_160, "PAP4AUD", "PAP4_BEG", 7, 0, 0, 0))
					{
						ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_98.f_28[0]);
						iLocal_373 = MISC::GET_GAME_TIMER() + 15000;
					}
	...
	if (func_209(PLAYER::PLAYER_PED_ID()) && func_209(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_268(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
bool func_258(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_259(&(Local_52[iVar4 /*4*/]), Var1, iParam1, &(Local_52[iVar4 /*4*/].f_3), iParam0, iParam5);
...
bool func_274(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_275()
{
	if (func_208(Local_98.f_28[1]) && func_217(Local_98.f_35[1]))
	{
...
void func_276()
{
	if ((func_217(Local_98.f_35[1]) && (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[1], PLAYER::PLAYER_PED_ID(), true))) && !bLocal_388)
	{
		if ((func_208(Local_98.f_28[1]) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
		{
			if (func_250())
			{
				func_222();
			}
			func_252(&uLocal_160, "PAP4AUD", "PAP4_VSTEAL", 8, 0, 0, 0);
			func_219(1);
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_390))
...
void func_277()
{
	if (((func_208(Local_98.f_28[0]) && func_208(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_FLEEING(Local_98.f_28[0]))
	{
		if (func_217(Local_98.f_35[0]))
		{
			if (iLocal_326 == 2)
			{
				if (iLocal_436 == 0)
				{
					if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], false) || PED::IS_PED_BEING_JACKED(Local_98.f_28[0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true)) || func_284(Local_98.f_35[0]))
					{
						iLocal_436 = 1;
						iLocal_326 = 2;
					}
...
void func_278()
{
	if (func_208(Local_98.f_28[0]))
	{
		...
		{
			if ((((!bLocal_386 && iLocal_385) && !func_279(Local_98.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
		...
		else if ((((!bLocal_386 && iLocal_385) && !func_279(Local_98.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0) || PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0]))
			{
				TASK::CLEAR_PED_TASKS(Local_98.f_28[0]);
...
void func_280()
{
	...
	switch (iLocal_436)
	{
		case 1:
			...
			bVar0 = false;
			func_222();
			if ((func_217(Local_98.f_35[0]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true)) && func_274(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 5f, 1))
			{
				bVar0 = func_252(&uLocal_160, "PAP4AUD", "PAP4_CARSHOT", 7, 0, 0, 0);
			}
			else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], false) || func_284(Local_98.f_35[0]))
			{
				bVar0 = func_252(&uLocal_160, "PAP4AUD", "PAP4_STEAL", 7, 0, 0, 0);
			}
			else
			{
				bVar0 = func_234(&uLocal_160, "PAP4AUD", "PAP4_STEAL", "PAP4_STEAL_1", 7, 0, 0);
			}
			if (bVar0)
			{
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
				...
				func_226(&(Local_98.f_41[0]), 0);
				if (func_208(Local_98.f_28[1]) && !PED::IS_PED_FLEEING(Local_98.f_28[1]))
				{
				...
				if ((((func_208(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true))
					{
		...
		case 2:
			if (func_228(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0]) > 20f)
			{
				iLocal_436 = 4;
			}
			else if (MISC::GET_GAME_TIMER() > iLocal_437)
			{
				if ((func_208(Local_98.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && iLocal_385)
				{
					if (iLocal_444)
					{
						TASK::TASK_COMBAT_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
					...
					else if (func_252(&uLocal_160, "PAP4AUD", "PAP4_RETAL", 7, 0, 0, 0))
					{
						iLocal_444 = 1;
						TASK::TASK_COMBAT_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
						func_226(&(Local_98.f_41[0]), 0);
...
void func_281()
{
	if (func_228(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0]) < 10f)
	{
		if (iLocal_445 || !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], false))
		{
			func_282();
		}
		else if (func_252(&uLocal_160, "PAP4AUD", "PAP4_RETURN", 7, 0, 0, 0))
		{
			iLocal_445 = 1;
			func_282();
		}
...
void func_283()
{
	...
	if (((func_208(Local_98.f_28[1]) && func_208(Local_98.f_28[0])) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
	{
		fVar0 = func_228(Local_98.f_28[1], Local_98.f_28[0]);
		if (fVar0 > 20f)
		{
			if (!func_220(Local_98.f_28[1], -2015108952))
			{
		...
		{
			if (!func_220(Local_98.f_28[1], -875674219))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], Local_98.f_28[0], -1);
			}
		}
...
int func_284(int iParam0)
{
	...
	if ((func_208(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && func_217(iParam0))
	{
...
void func_285()
{
	...
	{
		case 0:
			if (func_208(Local_98.f_28[0]) && func_208(Local_98.f_28[1]))
			{
				if (func_252(&uLocal_160, "PAP4AUD", "PAP4_TV_TALK", 7, 0, 0, 0))
				{
					iLocal_159 = func_310(Local_98.f_28[0], 1, 0, 5);
					func_309(&iLocal_159, "", "", &uLocal_335, &iLocal_336, 1, 0);
...
void func_286()
{
	if ((((func_208(Local_98.f_28[0]) && func_208(Local_98.f_28[1])) && func_208(PLAYER::PLAYER_PED_ID())) && !bLocal_388) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
...
void func_287()
{
	...
	if ((((!bLocal_464 && func_208(PLAYER::PLAYER_PED_ID())) && func_208(Local_98.f_28[1])) && func_208(Local_98.f_28[0])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
	{
		...
		fVar6 = func_288(PLAYER::PLAYER_PED_ID(), Var0, 1);
		fVar7 = func_288(PLAYER::PLAYER_PED_ID(), Var3, 1);
		if (fVar6 < fVar7)
		{
			Var8 = { Var3 };
		}
...
float func_288(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_289()
{
	if ((iLocal_385 == 0 && func_208(Local_98.f_28[0])) && iLocal_436 == 0)
	{
		if ((((((!TASK::IS_PED_GETTING_UP(Local_98.f_28[0]) && !PED::IS_PED_PRONE(Local_98.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], true)) && !func_220(Local_98.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[0]))
		{
...
void func_290()
{
	...
	if (((iLocal_460 != 3 && func_208(PLAYER::PLAYER_PED_ID())) && func_208(Local_98.f_28[0])) && func_208(Local_98.f_28[1]))
	{
		switch (iLocal_460)
		{
			case 0:
			...
			case 1:
				if (iLocal_463 < 4)
				{
					...
					if (func_234(&uLocal_160, "PAP4AUD", "PAP4_BLOCK", sLocal_450[iLocal_463], 7, iVar0, 0))
					{
						iLocal_463++;
						iLocal_460 = 2;
					}
			...
			case 2:
				if (!func_250())
				{
					...
					else if (iLocal_462 < 3)
					{
						...
						if (func_252(&uLocal_160, "PAP4AUD", sLocal_446[iLocal_462], 7, iVar1, 0, 0))
						{
							iLocal_461 = 1;
							iLocal_462++;
							iLocal_460 = 0;
...
int func_291()
{
	if (func_250() && AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() < iLocal_455[iLocal_462])
	{
		return 1;
	}
	return 0;
...
void func_293(bool bParam0)
{
	...
	else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_390))
	{
		...
		if ((((((!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !func_220(Local_98.f_28[1], 1805844857)) && !bLocal_464) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[1])) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
		{
			TASK::TASK_PLAY_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 1000f, -8f, -1, 57, 0f, false, false, false);
...
void func_294()
{
	if (func_208(Local_98.f_28[0]) && func_208(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0))
		{
			if (MISC::GET_GAME_TIMER() > iLocal_374)
			{
				if (func_252(&uLocal_160, "PAP4AUD", "PAP4_FIST", 7, 0, 0, 0))
				{
...
void func_295()
{
	...
	if (func_208(PLAYER::PLAYER_PED_ID()))
	{
		if (bLocal_407)
		{
			if ((((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) && func_303()) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_484, fLocal_487)) || !func_208(Local_98.f_28[1])) || !func_208(Local_98.f_28[2]))
			{
				iLocal_461 = 1;
				iLocal_460 = 3;
				iLocal_436 = 5;
			...
			else if ((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), true)) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("object"))
			{
				func_278();
				iLocal_461 = 1;
				iLocal_460 = 3;
			...
			else if ((((func_256(Local_98.f_28[0], 1126825984) && func_303()) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("object")) || PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				if (func_220(Local_98.f_28[0], 780511057))
				{
					iLocal_461 = 1;
					iLocal_460 = 3;
					iLocal_436 = 5;
			...
			else if (((((func_256(Local_98.f_28[0], 1126825984) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), true)) || iLocal_387) && (func_300(PLAYER::PLAYER_PED_ID()) == joaat("weapon_unarmed") || func_300(PLAYER::PLAYER_PED_ID()) == joaat("object")))
			{
				if (func_208(Local_98.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0))
				{
					TASK::TASK_COMBAT_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
					func_226(&(Local_98.f_41[0]), 0);
					bLocal_391 = false;
		...
		else
		{
			...
			{
				func_222();
				if (func_208(Local_98.f_28[0]) && !func_279(Local_98.f_28[0]))
				{
					if (HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (func_252(&uLocal_160, "PAP4AUD", "PAP4_THREAT", 7, 1, 0, 0))
						{
							RECORDING::_0x293220DA1B46CEBC(2f, 2f, 0);
							bLocal_408 = false;
						}
					}
					else if (func_252(&uLocal_160, "PAP4AUD", "PAP4_THREAT", 7, 0, 0, 0))
					{
						RECORDING::_0x293220DA1B46CEBC(2f, 2f, 0);
						bLocal_408 = false;
					}
			...
			else if ((func_208(Local_98.f_28[0]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && (((((((ENTITY::GET_ENTITY_HEALTH(Local_98.f_28[0]) < 150 || (func_269(Local_98.f_28[0], 0, 0, 0, 0) && func_303())) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), true) && func_300(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_274(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 20f, 1)) || (func_208(Local_98.f_28[1]) && PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))) || (func_208(Local_98.f_28[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true))) || (func_208(Local_98.f_28[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), true))) || iLocal_384))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
				{
					iLocal_384 = 1;
		...
		if (func_208(Local_98.f_28[1]))
		{
			if (((((((((func_269(Local_98.f_28[1], 0, 0, 0, 0) && func_303()) || ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || ((func_256(Local_98.f_28[1], 1126825984) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_300(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || !func_217(Local_98.f_35[1])) || PED::IS_PED_RAGDOLL(Local_98.f_28[1])) || func_297(Local_98.f_28[1])) || func_279(Local_98.f_28[0])) || func_279(Local_98.f_28[2])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_484, fLocal_487))
			{
		...
		if (func_208(Local_98.f_28[2]) && !iLocal_465)
		{
			if (((((((((((func_255(Local_98.f_28[2], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_303()) || (func_255(Local_98.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_303())) || (func_255(Local_98.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_303())) || func_297(Local_98.f_28[2])) || func_297(Local_98.f_28[0])) || func_297(Local_98.f_28[1])) || PED::IS_PED_RAGDOLL(Local_98.f_28[2])) || !func_217(Local_98.f_35[1])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_484, fLocal_487)) || func_279(Local_98.f_28[0])) || func_279(Local_98.f_28[1]))
			{
				if (!PED::IS_PED_FLEEING(Local_98.f_28[2]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], false))
				{
					...
					bLocal_391 = false;
					iLocal_387 = 1;
					if (func_300(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed"))
					{
						func_278();
					}
					iLocal_460 = 3;
...
int func_297(int iParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_217(iVar0))
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iParam0, iVar0) && !func_298(iVar0))
			{
...
void func_299()
{
	if (func_208(Local_98.f_28[0]))
	{
		if ((((((!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], true) && iLocal_385) && !bLocal_386) && !func_279(Local_98.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID())) && iLocal_436 == 0)
		{
			if (PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0) || PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0]))
			{
				TASK::CLEAR_PED_TASKS(Local_98.f_28[0]);
...
int func_303()
{
	if (func_300(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stickybomb"))
	{
		if ((func_257(Local_98.f_28[0], 1126825984) || func_257(Local_98.f_28[1], 1126825984)) || func_257(Local_98.f_28[2], 1126825984))
		{
			return 1;
		}
	}
...
void func_304()
{
	if ((((((bLocal_407 && iLocal_385) && iLocal_461) && func_217(Local_98.f_35[0])) && func_208(Local_98.f_28[0])) && !func_250()) && func_220(Local_98.f_28[0], -1794415470))
	{
...
int func_305()
{
	...
	if (!bVar0 && !bVar1)
	{
		...
		if (((func_208(Local_98.f_28[1]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[1])) && !PED::IS_PED_FLEEING(Local_98.f_28[1]))
		{
			TASK::TASK_COMBAT_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 0, 16);
			func_226(&(Local_98.f_41[1]), 0);
		}
		if (((func_208(Local_98.f_28[2]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[2], 0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[2])) && !PED::IS_PED_FLEEING(Local_98.f_28[2]))
		{
...
void func_306()
{
	if (func_208(Local_98.f_28[0]))
	{
		if (func_217(Local_98.f_35[0]) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0]) && !func_220(Local_98.f_28[0], -1273030092))
			{
			...
			{
				func_225(&(Local_98.f_41[0]));
			}
		}
		if (func_217(Local_98.f_35[1]))
		{
...
void func_307(bool bParam0, bool bParam1)
{
	...
	if ((((((func_217(Local_98.f_35[0]) && func_208(Local_98.f_28[0])) && bLocal_407) && iLocal_385) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) && !iLocal_389)
	{
		...
		else if ((bParam0 || !func_250()) || !func_274(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 30f, 1))
		{
			if (((((iLocal_461 && !func_220(Local_98.f_28[0], -1794415470)) && !func_220(Local_98.f_28[0], 355471868)) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[0], -1, false)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) && !iLocal_389)
			{
				if (!func_305() && !func_251())
				{
					bVar0 = false;
					if (!bParam0)
					{
						...
						iVar1 = 0;
						if (!func_274(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 30f, 1))
						{
							iVar1 = 1;
						}
						if (iLocal_463 > 1)
						{
							bVar0 = func_252(&uLocal_160, "PAP4AUD", "PAP4_LEAVE2", 7, iVar1, 0, 0);
						}
						else
						{
							bVar0 = func_252(&uLocal_160, "PAP4AUD", "PAP4_LEAVE", 7, iVar1, 0, 0);
						}
					}
					if (bVar0 || bParam0)
					{
						...
						if ((((func_208(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
						{
							if (bParam0 || (func_217(Local_98.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1], true)))
							{
								...
								else if (func_217(Local_98.f_35[0]))
								{
									TASK::OPEN_SEQUENCE_TASK(&iVar2);
							...
							else if (func_217(Local_98.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[1], 0, false))
							{
...
void func_308()
{
	...
	if (func_208(Local_98.f_28[1]))
	{
		if ((((!func_220(Local_98.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], false))
		{
			...
			if (func_217(Local_98.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[1], -1, false))
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_473, Local_476, fLocal_479, false, true, true);
...
void func_309(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_311()
{
	switch (iLocal_327)
	{
		case 0:
			...
			if (MISC::GET_GAME_TIMER() > iLocal_358)
			{
				...
				if (func_347(1, 1093140480, 0))
				{
					...
					if (func_217(Local_98.f_35[0]))
					{
						func_344(Local_98.f_35[0], Local_421, fLocal_430, 0, 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_98.f_35[0], 5f);
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_98.f_35[0], 1);
					}
					if (func_217(Local_98.f_35[1]))
					{
						func_344(Local_98.f_35[1], Local_424, fLocal_431, 0, 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_98.f_35[1], 5f);
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_98.f_35[1], 1);
					}
					func_336(Local_328, Local_331, fLocal_334, -500,71f, 241,83f, 82,46f, 262,59f, 1, 1, 1, 0, 0);
					func_333(-484,2f, 229,68f, 82,21f, 1, 1, 1, 0, 1, 1, 1, 1, 1, 1);
		...
		case 1:
			...
			if ((((func_208(Local_98.f_28[0]) && func_208(Local_98.f_28[1])) && func_208(Local_98.f_28[2])) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[0])) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
			{
...
void func_313(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_317(PLAYER::PLAYER_ID())) && !func_315(PLAYER::PLAYER_ID(), 0)) && !func_314()) && !bParam4) && !bParam5)
			{
...
void func_323()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_324(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10,5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_324(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_333(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_334(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_335(bool bParam0)
{
	...
	func_313(1, 1, 0, 0, 0, 0, 0);
}

void func_336(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_337(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_341(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_341(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_342(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_342(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_342(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_342(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_342(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_342(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_342(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_342(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_342(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_342(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_342(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_342(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_342(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_342(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_342(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_342(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_342(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_344(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_347(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_324(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_220(PLAYER::PLAYER_PED_ID(), -828834893))
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
				}
			}
...
void func_349(char* sParam0, bool bParam1)
{
	func_335(bParam1);
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				if (func_208(PLAYER::PLAYER_PED_ID()))
				{
					func_363(&uLocal_160, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				}
				func_362();
		...
		case 2:
			if (func_398())
			{
				func_361(Local_432, fLocal_435, 1, 0);
				func_351();
			}
			else
			{
				...
				if ((CAM::IS_SCREEN_FADED_IN() && func_209(Local_98.f_28[0])) && func_229(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 1) > 6f)
				{
...
void func_351()
{
	...
	if (func_208(PLAYER::PLAYER_PED_ID()) && !func_358())
	{
		func_356(PLAYER::PLAYER_PED_ID(), Local_432);
	...
	{
		func_353(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
	}
	func_352(1, 1, 1);
}
...
void func_353(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
Vector3 func_356(int iParam0, struct<3> Param1)
{
	var uVar0;
...
void func_362()
{
	if (func_208(Local_98.f_28[0]))
	{
		...
		PED::SET_PED_DIES_WHEN_INJURED(Local_98.f_28[0], true);
		func_363(&uLocal_160, 3, Local_98.f_28[0], "BEVERLY", 0, 1);
	}
	if (func_208(Local_98.f_28[1]))
	{
		func_363(&uLocal_160, 4, Local_98.f_28[1], "Pap4Cameraman", 0, 1);
	}
}
...
void func_364(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78112 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_366(Global_78113, Global_78115, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
struct<2> func_366(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_367(iVar2), 8);
					break;
			}
			break;
...
int func_375(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_377(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_331(0)) || func_376(1))
			{
			}
			else
			{
...
{
	return func_379(iParam0, Global_42602);
}
		...
		if (bParam2)
		{
			if (!Global_77858)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_382(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_382(iParam0) };
...
int func_388(var uParam0)
{
	...
	switch (iLocal_94)
	{
		...
		case 1:
			if (!func_397(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_94 = 2;
		...
		case 2:
			...
			{
				if (func_394(&(uParam0->f_28[0]), 50, -490,809f, 232,39f, 82,018f, 33,84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_392(&(uParam0->f_28[1]), iVar0[3], -498,1656f, 228,6284f, 82,09948f, 292,9763f, 26);
			...
			{
				func_392(&(uParam0->f_28[2]), iVar0[4], -498,309f, 227,9112f, 82,106f, 296,4216f, 26);
				if (func_208(uParam0->f_28[2]))
				{
			...
			{
				func_390(&(uParam0->f_35[0]), iVar0[1], -497,99f, 224,97f, 82,67f, 266,5f);
			...
			{
				func_390(&(uParam0->f_35[1]), iVar0[2], -501,55f, 230,7f, 83,1f, 233,93f);
			...
			{
				func_389(&(uParam0->f_41[0]), iVar0[5], -490,11f, 233,15f, 82,1f, 0f);
				if (func_209(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
			...
			{
				func_389(&(uParam0->f_41[1]), iVar0[6], -490,11f, 233,15f, 82,1f, 0f);
				if (func_209(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
...
void func_389(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_225(iParam0);
...
void func_390(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_391(iParam0);
...
void func_392(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_393(iParam0);
...
int func_394(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_395(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_408(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_409()
{
	...
	if (func_208(Local_98.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
	{
		if (func_208(PLAYER::PLAYER_PED_ID()))
		{
			if (func_208(Local_98.f_28[0]) && func_217(Local_98.f_35[1]))
			{
			...
			else if (!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true))
			{
				func_296();
				PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, true);
				func_410(&(Local_98.f_28[1]), 500, 0);
			}
		}
		else
		{
	...
	if (func_208(Local_98.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		if (PED::IS_PED_IN_GROUP(Local_98.f_28[2]))
		{
			PED::REMOVE_PED_FROM_GROUP(Local_98.f_28[2]);
		...
		if (func_208(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], true))
			{
				...
				if (func_217(iVar0) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, true) || !func_208(Local_98.f_28[0])))
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar1);
			...
			{
				PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[2], 128, true);
				func_410(&(Local_98.f_28[2]), 350, 1);
			}
		}
		else
		{
	...
	func_408(&(Local_98.f_28[0]), 1, 0, 1);
	func_408(&(Local_98.f_28[1]), 1, 0, 1);
	func_408(&(Local_98.f_28[2]), 1, 0, 1);
	func_405(&(Local_98.f_35[0]));
	func_405(&(Local_98.f_35[1]));
...
void func_412(bool bParam0)
{
	...
	if (!func_429())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_413(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112009[iVar0 /*10*/].f_9 == -1)
...
int func_414(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_420())
	{
		...
		{
			iVar33 = func_415(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_416()
{
	...
	iVar0 = func_417(&(Global_99980.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_420()
{
	...
	{
		if (func_415(&(Global_99980.f_3)) > -1)
		{
			return 1;
		}
	}
