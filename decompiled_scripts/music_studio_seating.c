...
BOOL func_28(Player plParam0) // Position - 0x11DD
{
...
BOOL func_33(Ped pedParam0) // Position - 0x1553
{
	int weaponHash;
...
void func_54(int* piParam0, int iParam1) // Position - 0x1A94
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x2224
{
	int i;
...
BOOL func_66(Player plParam0) // Position - 0x2368
{
	return func_67(plParam0) == joaat("WEAPON_MINIGUN");
}

int func_67(Player plParam0) // Position - 0x237C
{
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))
				if (func_78(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->f_16[uParam0->f_9 /*14*/]) || func_71(playerIndex) == uParam0->f_9)
					return 1;
		}
	}
...
BOOL func_77(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x2576
{
...
BOOL func_78(Ped pedParam0, var uParam1) // Position - 0x25D6
{
...
void func_81(int* piParam0, int iParam1) // Position - 0x2674
{
...
void func_85(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x273C
{
	int offset;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2838
{
	switch (func_91())
	{
		case 0:
...
BOOL func_96(Player plParam0) // Position - 0x28DB
{
