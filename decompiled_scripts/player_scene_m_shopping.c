...
void main() // Position - 0x0
{
	...
	iLocal_71 = 318;
	bLocal_261 = true;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_328, "", 64);
	fLocal_348 = -1f;
	iLocal_350 = -1;
...
int func_3(int iParam0) // Position - 0x12C
{
	...
	if (!unk_0x66599E73DBA5A850(*iParam0))
	{
		...
		if (iLocal_262 >= 0)
		{
			...
			{
				if (unk_0xF5F493B789EA063E(*iParam0, joaat("SCRIPT_TASK_SMART_FLEE_PED")) != 1)
					unk_0x4C3AF5B8506D15D6(*iParam0, 0, 0);
		...
		switch (iLocal_262)
		{
			...
			case 1:
				...
				else if (unk_0x411B750250543BD0(Global_98011))
				{
					...
					if (!unk_0x7BB3D8F4F6310EB8(*iParam0, &uLocal_280, &uLocal_312, 2))
					{
						unk_0x909F139DC199D8E0(*iParam0);
						unk_0xFB58581C53CF4C05(*iParam0, -16f, 1);
						unk_0x4138C1DA9CF50A80(*iParam0);
						unk_0x7D9A648CC1936BDA(*iParam0, uLocal_272 + uLocal_276, 1f, -1, fLocal_279 * 0.1f, 0, 1193033728);
						unk_0xC5F9EF8F410596F9(*iParam0, joaat("MotionState_Walk"), 0, 0, 0);
					...
					else
					{
						...
						if (!unk_0x8EE7F4F26F4886B7(&uLocal_280, &uLocal_312, "WalkInterruptible", &num2, &unk))
						{
						}
						else
						{
				...
				else if (iLocal_71 != 151)
				{
					...
					if (unk_0x2AC37494BBF1DB16(&uLocal_328))
					{
						unk_0x7D9A648CC1936BDA(*iParam0, uLocal_272 + uLocal_276, 1f, -1, fLocal_279 * 0.1f, 0, 1193033728);
						unk_0xC5F9EF8F410596F9(*iParam0, joaat("MotionState_Walk"), 0, 0, 0);
						unk_0x0211CB63720F4D7C(*iParam0, 2);
					...
					{
						unk_0x5BC7CE6499A6BFDB(*iParam0, &uLocal_328, uLocal_272 + uLocal_344, fLocal_275 + fLocal_347, 0, 0, 1);
			...
			case 2:
				...
				else
				{
					...
					if (func_132(uLocal_276, 0f, 0f, 0f, false))
					{
						unk2 = { unk_0x7394CB479CCA24AF(unk_0xC1A5EC5C986B98AD(), 5f, 0f, 0f) };
						uLocal_276 = { (unk2 - uLocal_272) * { 4f, 4f, 4f } };
					}
			...
			case 3:
				...
				{
					if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(*iParam0, 1), uLocal_272 + uLocal_276) < fLocal_279 * fLocal_279)
					{
						if (fLocal_279 == 0f)
							fLocal_279 = SYSTEM::VMAG(uLocal_276) * 0.75f;
					
						unk_0xAE8B22E491138054(*iParam0, uLocal_272 + uLocal_276, fLocal_279, 1077936128, 1086324736);
						func_134(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(*iParam0, 1), uLocal_272 + uLocal_276) < fLocal_279 * fLocal_279)
				{
					if (unk_0x271BB87FB0E07F8A(uLocal_272 + uLocal_276, fLocal_279, 1))
					{
						unk_0x978687517F88D889(*iParam0, uLocal_272 + uLocal_276, fLocal_279, 0);
						unk_0x17D46728E18012D3(uLocal_349, 0);
						func_134(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					unk5 = { func_4(uLocal_272 + uLocal_276, fLocal_279 * 0.9f, 0f) };
				
					if (unk_0xD150D18ADFDC5159(unk5, 0, &vector, 14))
					{
						if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(*iParam0, 1), vector) > 100f)
						{
							unk_0x7D9A648CC1936BDA(*iParam0, vector, 1f, -1, 1048576000, 0, 1193033728);
							unk10 = { unk_0x30BE8A934C020461(*iParam0, 1) - { 2f, 2f, 2f } };
							unk13 = { unk_0x30BE8A934C020461(*iParam0, 1) + { 2f, 2f, 2f } };
							uLocal_349 = unk_0x54ECDA2DAB9CFB10(unk10, unk13, 0, 0, 1, 1);
			...
			case 7:
				...
				if (unk_0x7BB3D8F4F6310EB8(*iParam0, &uLocal_280, &uLocal_296, 2))
				{
				}
				else
				{
					unk_0x7BB3D8F4F6310EB8(*iParam0, &uLocal_280, &uLocal_312, 2);
				}
				break;
			...
			case 8:
				...
				if (unk_0xF5F493B789EA063E(*iParam0, joaat("SCRIPT_TASK_SMART_FLEE_PED")) != 1)
				{
					unk_0xC6C9BF71106ABCAC(*iParam0, unk_0xC1A5EC5C986B98AD(), 50f, 20000, 1, 0);
					return 1;
				}
			
				if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(*iParam0, 1), unk_0x30BE8A934C020461(*iParam0, 1)) > 50f * 1.25f)
				{
					unk_0x7D9A648CC1936BDA(*iParam0, uLocal_272 + uLocal_276, 1f, -1, fLocal_279 * 0.1f, 0, 1193033728);
...
Vector3 func_4(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x872
{
	float num;
	float num2;
	float num3;
...
Vector3 func_5(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x8EB
{
	var unk;
	float num;
	...
	num = fParam4 / 2f;
	unk = { func_6(unk, unk_0xD88C7A93096DA0F7(0f, fParam3)) };
	unk.f_2 = unk_0xD88C7A93096DA0F7(-num, num);
	return uParam0 + unk;
}

Vector3 func_6(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x933
{
	float num;
...
void func_7(int iParam0) // Position - 0x96A
{
	...
	if (unk_0x66599E73DBA5A850(iParam0))
	{
		if (!bLocal_352 && unk_0x7559C38E6535AB89(iParam0, unk_0xC1A5EC5C986B98AD(), 1))
		{
			character = func_129(iParam0);
			num = func_126(character);
			num2 = func_125(num);
			...
			if (num2 != -1)
			{
				...
				if (num3 != 0)
				{
					if (!func_122(num2) || func_114(num2) == 6)
					{
						func_113(75, unk_0x30BE8A934C020461(iParam0, 0), 250f, -1);
					
						if (func_46(Global_96415, character, 2, 0, num3, num2, 75))
							bLocal_352 = true;
					}
				}
			}
	...
	func_10(iParam0, 138, &uLocal_72, "FMMAUD", &uLocal_237, &uLocal_258, 3);
	...
	{
		if (iLocal_350 <= 0)
			iLocal_350 = unk_0xA5E11AF0A2B928C1();
	
		if (iLocal_350 > 0)
		{
			if (iLocal_351 == 0)
			{
				if (iLocal_350 + 15000 < unk_0xA5E11AF0A2B928C1())
				{
			...
			else if (iLocal_350 + 10000 < unk_0xA5E11AF0A2B928C1())
			{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xAD8
{
	char* str;
...
int func_10(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6) // Position - 0xCCD
{
	Vector3 vector;
	Vector3 vector2;
	eCharacter character;
...
void func_11(var uParam0) // Position - 0x1073
{
	func_12(uParam0, 0f);
	return;
}

void func_12(var uParam0, float fParam1) // Position - 0x1082
{
...
BOOL func_14(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5) // Position - 0x1105
{
	char* str;
	int i;
	int j;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1229
{
...
BOOL func_17(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1277
{
	Global_21726 = 0;
...
BOOL func_21(int iParam0, int iParam1) // Position - 0x15EF
{
	return IS_BIT_SET(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1607
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1795
{
	if (func_28(14))
	{
...
void func_32(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x192A
{
...
BOOL func_33(char* sParam0, int iParam1) // Position - 0x1980
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x19BF
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x19E1
{
...
int func_36(char* sParam0, var uParam1, var uParam2) // Position - 0x1A7C
{
	var unk;
	var unk5;
	int num;
...
BOOL func_37(int iParam0) // Position - 0x2120
{
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x226E
{
...
int func_40(eCharacter echParam0) // Position - 0x2293
{
	return Global_2028[echParam0 /*29*/];
}

BOOL func_41(eCharacter echParam0) // Position - 0x22A2
{
	return echParam0 < CHAR_MULTIPLAYER;
}

int func_42(eCharacter echParam0) // Position - 0x22AE
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x22D4
{
	func_44();
...
void func_44() // Position - 0x22ED
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_41(character) && !func_28(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != character && func_41(Global_113648.f_2365.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x23EA
{
	eCharacter i;
	int num;
...
BOOL func_46(var uParam0, eCharacter echParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2427
{
	int num;
	int num2;
	int num3;
	...
	num = 3;
	num2 = func_126(echParam1);
	num3 = func_112(uParam0);
	num4 = 10000;

	if (iParam3 == 0)
	{
		if (func_110(num2, iParam2, -1, &num5, &num6))
		{
			if (iParam5 == -1)
				return false;
			...
			if (func_106(iParam5, num5, num6, num, num3, echParam1, num4, 10000, iParam6, iParam4, num8, num7, 1))
				return true;
			else
				return false;
		}
	}
	else if (func_102(num2, iParam2, -1, &unk))
	{
...
int func_48(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x2613
{
	...
	return func_49(func_81(echParam0), 0, iParam1, iParam2, false);
}
...
void func_52(int iParam0) // Position - 0x2F22
{
	BOOL flag;
	var unk;
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_54() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x061B1200C95204CB(&(Global_113648.f_20566.f_471), iParam0);
		unk_0x061B1200C95204CB(&(Global_2359296[func_54() /*5568*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x30A0
{
	switch (iParam0)
	{
		case 0:
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x31AE
{
	int num;
...
int func_56(int iParam0) // Position - 0x31DE
{
	int num;
	int num2;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x321E
{
	if (iParam2 == -1)
		iParam2 = func_57();
...
BOOL func_60(int iParam0) // Position - 0x325C
{
	int num;
	int num2;
	int num3;
	...
	return IS_BIT_SET(Global_2359296[func_54() /*5568*/].f_681.f_10, iParam0);
}

int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3402
{
	var unk;
	int num;
...
BOOL func_66(var uParam0, int iParam1) // Position - 0x35CA
{
	int i;
	var unk;
...
void func_71(var uParam0, int iParam1) // Position - 0x374B
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_76(int iParam0) // Position - 0x37C1
{
	switch (iParam0)
	{
		case 60:
...
int func_81(eCharacter echParam0) // Position - 0x3957
{
	return Global_2028[echParam0 /*29*/].f_17;
}

int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x3968
{
	int num;
...
BOOL _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x3AC8
{
	int num;
	char* str;
	int num2;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x3B57
{
	return Global_2028[character /*29*/].f_3;
}

int func_89(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3B6A
{
	int num;
	BOOL flag;
	...
	func_90(echParam0, sParam1, flag, func_91(unk_0x93E99A2DBCBA9CFA()));
	return 1;
}

void func_90(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x4048
{
	if (!func_19())
		return;
...
var func_91(int iParam0) // Position - 0x40A5
{
				...
				if (iParam0 == Global_8260[num /*15*/].f_11)
				{
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (Global_2694519)
								if (num == 14)
									func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78558)
								{
									...
									func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8260[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
...
void func_93(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x4654
{
...
void func_94(int iParam0) // Position - 0x4707
{
...
void func_95(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4719
{
	unk_0x9FD96C5DE6EDFC15(uParam0, sParam1);
	unk_0xC6A3EF6C4A3412C1(SYSTEM::ROUND(fParam2));
...
void func_99() // Position - 0x4839
{
	...
	while (num3 < num2)
	{
		if (!func_100(Global_113648.f_14143[num3 /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18))
			Global_22792 = num3;
...
BOOL func_100(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x4904
{
	int num;
	int num2;
	int num3;
...
int func_101() // Position - 0x49EF
{
	...
	while (i < num2)
	{
		if (Global_113648.f_14143[i /*104*/].f_24 == 0 || Global_113648.f_14143[i /*104*/].f_24 == 1)
			if (!func_100(Global_113648.f_14143[i /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18))
				Global_22792 = i;
...
BOOL func_102(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4B57
{
	var unk;
	var unk5;
	int num;
	...
	else
	{
		...
		TEXT_LABEL_APPEND_STRING(&unk, func_105(iParam0), 16);
		TEXT_LABEL_APPEND_STRING(&unk, "_", 16);
		...
		if (iParam2 == -1)
		{
			...
			if (func_103(&unk5[0 /*4*/], num))
				iParam2 = 1;
			else if (func_103(&unk5[1 /*4*/], num))
				iParam2 = 0;
			else
...
BOOL func_103(var uParam0, int iParam1) // Position - 0x4C8F
{
	int num;
	int num2;
...
BOOL func_106(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, eCharacter echParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x4DD8
{
	int num;
	...
	if (Global_113648.f_7690.f_764 < 8)
	{
		...
		func_107(CHAR_MICHAEL);
		func_107(CHAR_FRANKLIN);
		func_107(CHAR_TREVOR);
		return true;
	}
...
void func_107(eCharacter echParam0) // Position - 0x4F13
{
	int i;
	int num;
	int j;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x503B
{
...
BOOL func_110(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4) // Position - 0x5063
{
	var unk;
	int num;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_102(iParam0, iParam1, 0, &unk[0 /*4*/]) && func_102(iParam0, iParam1, 1, &unk[1 /*4*/]))
			{
				num = func_104(iParam0);
			
				if (func_103(&unk[0 /*4*/], num))
					iParam2 = 1;
				else if (func_103(&unk[1 /*4*/], num))
					iParam2 = 0;
				else
					iParam2 = unk_0x15A88CFAAFFC6C4B(0, 2);
			}
...
void func_113(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x524A
{
	if (iParam0 == iParam5)
		return;
...
int func_115(int iParam0, var uParam1) // Position - 0x5349
{
	int num;
	BOOL flag;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x53DE
{
	func_44();
	return Global_113648.f_2365.f_539.f_4321;
}
...
int func_118(int iParam0, var uParam1) // Position - 0x5446
{
	int num;
	BOOL flag;
...
int func_120(int iParam0, var uParam1) // Position - 0x5521
{
	int num;
	BOOL flag;
...
BOOL func_122(int iParam0) // Position - 0x5611
{
	int i;
...
int func_124(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x57A0
{
	int i;
	float num;
	float num2;
...
int func_126(eCharacter echParam0) // Position - 0x5886
{
	if (echParam0 == _CHAR_NULL)
		return 7;

	if (echParam0 < func_128())
		return func_127(echParam0);
...
int func_127(eCharacter echParam0) // Position - 0x58DE
{
	return Global_2028[echParam0 /*29*/].f_11;
}

eCharacter func_128() // Position - 0x58EF
{
...
eCharacter func_129(int iParam0) // Position - 0x5911
{
	eCharacter i;
	int num;
	eCharacter character;
...
BOOL func_130(int iParam0) // Position - 0x5957
{
	Vector3 vector;
	Vector3 vector2;
...
BOOL func_131(var uParam0, BOOL bParam1) // Position - 0x59B5
{
	if (unk_0x7559C38E6535AB89(uParam0, unk_0xC1A5EC5C986B98AD(), 1))
		return true;

	if (unk_0xB8C39D031C377E33(uParam0, unk_0xC1A5EC5C986B98AD()))
		return true;
	...
	if (bParam1)
	{
		...
		if (unk_0x66681C67B07D3657(uParam0, 124))
			return true;
	}
...
BOOL func_132(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x5A05
{
	if (bParam6)
...
void func_133(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x5A4C
{
...
BOOL func_135() // Position - 0x5A76
{
	if (!func_137())
	{
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 0, unk_0xC1A5EC5C986B98AD(), "MICHAEL", 0, 1);
	
		switch (func_38(Global_100402))
		{
			case 0:
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 1, Global_100402, func_136(0), 0, 1);
				break;
		
			case 1:
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 2, Global_100402, func_136(1), 0, 1);
				break;
		
			case 2:
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 3, Global_100402, func_136(2), 0, 1);
				break;
	...
	if (iLocal_265 != 0)
	{
		...
		{
			uLocal_264 = unk_0x0744FA5607ECEB91(uLocal_272 + uLocal_266, 1f, iLocal_265, 1, 0, 1);
		
			if (unk_0x7DE17ACDD8BA2642(uLocal_264))
			{
				unk_0xC2E3C377D893C17A(uLocal_264, uLocal_272 + uLocal_266, 1, 0, 0, 1);
				unk_0x464B5B0F22497FC5(uLocal_264, { fLocal_275, 0f, 0f } + uLocal_269, 2, 1);
				unk_0x2718E9CC165A99F6(uLocal_264, 1);
			}
		}
	}
...
BOOL func_138(int iParam0, int iParam1) // Position - 0x5CCC
{
	Vector3 vector;
	float num;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x5DBA
{
...
void func_146() // Position - 0x5E7C
{
	...
	if (iLocal_263 != 0)
		unk_0x93FFD6B088A8E34D(iLocal_263, 3);
	...
	while (!flag && num < 400)
	{
		...
		if (iLocal_263 != 0)
			if (!unk_0xCF74D35FEBDBE99F(iLocal_263))
				flag = false;
...
void func_147(int iParam0, int iParam1) // Position - 0x5F12
{
...
void func_148() // Position - 0x5F48
{
	...
	func_166(iLocal_71, &uLocal_272, &fLocal_275, &unk);

	switch (iLocal_71)
	{
		case 98:
			uLocal_276 = { -25f, -35f, 0f };
			fLocal_279 = 30f;
			fLocal_348 = 0.73f;
			break;
	
		case 99:
			uLocal_276 = { { 24.3224f, -700.7733f, -1306.8362f } - uLocal_272 };
			fLocal_279 = 40f;
			iLocal_262 = 2;
			break;
	
		case 100:
			uLocal_276 = { { 82.0206f + 1f, 272.6104f, -566.2225f } - uLocal_272 };
			fLocal_279 = 30f;
			iLocal_262 = 2;
			break;
	
		case 101:
			uLocal_276 = { { 53.6418f + 1f, -217.321f, 77.2686f } - uLocal_272 };
			fLocal_279 = 25f;
			iLocal_262 = 2;
			break;
	
		case 102:
			uLocal_276 = { { 102.0191f + 1f, 313.2252f, 412.1519f } - uLocal_272 };
			fLocal_279 = 15f;
			iLocal_262 = 2;
			break;
	
		case 170:
			uLocal_276 = { { 37.8417f + 1f, -275.1926f, -616.7041f } - uLocal_272 };
			fLocal_279 = 30f;
			break;
	
		case 171:
			uLocal_276 = { { 56.8469f + 1f, -125.1416f, -106.3491f } - uLocal_272 };
			fLocal_279 = 25f;
			break;
		...
		case 94:
			uLocal_276 = { { 112.1615f + 1f, 328.301f, -16.8925f } - uLocal_272 };
			fLocal_279 = 25f;
			break;
		...
		case 152:
			uLocal_276 = { 0f, 0f, 0f };
			fLocal_279 = 0f;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_328, "PROP_HUMAN_SEAT_SUNLOUNGER", 64);
			uLocal_344 = { 1.358f, 2.385f, -0.608f };
			fLocal_347 = 160f;
			iLocal_265 = joaat("prop_patio_lounger1");
			uLocal_266 = { { 63.082f, 357.697f, -1352.644f } - { 64.08f, 355.1845f, -1353.791f } };
			uLocal_269 = { 0f, 0f, 54.35f - 72f };
			break;
		...
		case 151:
			...
			uLocal_266 = { 0.8706f, 2.0176f, -0.4948f };
			uLocal_269 = { 0f, 0f, 0f };
			break;
	
		default:
			uLocal_276 = { unk_0xD88C7A93096DA0F7(-50f, 50f), unk_0xD88C7A93096DA0F7(-50f, 50f), 0f };
			fLocal_279 = SYSTEM::VMAG(uLocal_276) * 0.75f;
			break;
	}
	...
	if (iLocal_71 != 94 && iLocal_71 != 152 && iLocal_71 != 151)
	{
		...
		if (func_151(0, iLocal_71, &num, &unk106, &unk109, &unk110, &unk113))
			iLocal_263 = num;
	}
	else
	{
	...
	if (iLocal_262 == 0)
	{
		func_149(iLocal_71, &uLocal_280, &uLocal_296, &uLocal_312, &unk114, &unk115);
		iLocal_262 = 0;
	}
	else
	{
		TEXT_LABEL_ASSIGN_STRING(&uLocal_280, "", 64);
		TEXT_LABEL_ASSIGN_STRING(&uLocal_296, "", 64);
		TEXT_LABEL_ASSIGN_STRING(&uLocal_312, "", 64);
		iLocal_262 = 2;
	}
...
BOOL func_149(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5) // Position - 0x6281
{
	*uParam4 = 9;
	*uParam5 = 8;
...
BOOL func_151(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x69B5
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
int func_153(int iParam0, var uParam1, int iParam2) // Position - 0xA084
{
	...
	if (!func_154(Global_100085[iParam0 /*98*/], false, -1))
	{
		func_152(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
BOOL func_154(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA2BC
{
	int i;
	var unk;
	...
	if (iParam0 == joaat("blimp"))
		if (!func_163() && !func_162() && !func_161() && !func_160() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED())
			return false;

	if (iParam0 == joaat("hotknife") || iParam0 == joaat("carbonrs") || iParam0 == joaat("khamelion"))
	{
		if (func_159() || unk_0xCC17806DB0C41C19() || func_158())
		{
		}
		else if (!func_161())
		{
...
BOOL func_155(int iParam0) // Position - 0xA43E
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xA50A
{
...
BOOL func_157(int iParam0, int iParam1) // Position - 0xA521
{
	BOOL num;
	var unk;
...
BOOL func_160() // Position - 0xDB7E
{
	return false;
}

BOOL func_161() // Position - 0xDB87
{
	return true;
}

BOOL func_162() // Position - 0xDB90
{
	return true;
}

BOOL func_163() // Position - 0xDB99
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xDBB2
{
	var unk;
...
BOOL func_165(int iParam0) // Position - 0xDC6A
{
...
BOOL func_167(var uParam0) // Position - 0xE0D5
{
	...
	if (func_132(vector, 0f, 0f, 0f, false))
...
BOOL func_168(int iParam0, var uParam1, char* sParam2) // Position - 0xE18D
{
	var unk;
	int num;
	var unk4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_172(Global_113648.f_2365.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_172(Global_113648.f_2365.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_172(Global_113648.f_2365.f_539.f_2314[2]), 32);
			return true;
	
		case 11:
			if (func_171(iParam0, &unk, uParam1))
			{
...
BOOL func_169(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x1059A
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x124E7
{
...
BOOL func_171(int iParam0, var uParam1, var uParam2) // Position - 0x12505
{
	switch (iParam0)
	{
		case 11:
...
{
	if (iLocal_263 != 0)
		unk_0x8485F4B24A112331(iLocal_263);
