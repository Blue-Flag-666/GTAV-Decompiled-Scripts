...
void func_1() // Position - 0x78
{
	...
	if (uLocal_20.f_66.f_2 == 1 && Global_4536659 && func_16(&uLocal_20))
		flag = true;

	if (Global_4535172[iLocal_19 /*85*/].f_66 == 2147483647 && uLocal_20.f_66.f_12)
	{
		if (flag)
			func_15(false);
	...
	if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() && uLocal_20.f_66.f_2 == 1 && uLocal_20.f_66.f_13 && !uLocal_20.f_66.f_12)
	{
		if (MISC::GET_FRAME_COUNT() - uLocal_20.f_66.f_14 >= func_12(uLocal_20.f_66.f_5))
		{
			...
			else
			{
				...
				Global_4535172[iLocal_19 /*85*/].f_66 = uLocal_20.f_66;
			}
...
void func_17(int iParam0) // Position - 0x631
{
	...
	if (flag || SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 7))
	{
		...
		num = func_38(eventData, &unk7);
	
		if (num != -1)
		{
			Global_4535172[num /*85*/].f_66.f_8 = 0;
		
			if (Global_4535172[num /*85*/].f_66.f_18 == 0)
				Global_4535172[num /*85*/].f_66.f_18 = MISC::GET_FRAME_COUNT();
		}
		...
		switch (eventData.f_2)
		{
			case 0:
				if (num != -1)
				{
					Global_4540738[num /*12*/] = Global_4535172[num /*85*/].f_66.f_3;
					Global_4540738[num /*12*/].f_1 = Global_4535172[num /*85*/].f_66.f_7;
					Global_4540738[num /*12*/].f_2 = Global_4535172[num /*85*/].f_66.f_4;
					Global_4540738[num /*12*/].f_3 = Global_4535172[num /*85*/].f_66.f_1;
					Global_4540738[num /*12*/].f_5 = eventData.f_1;
					Global_4540738[num /*12*/].f_6 = eventData.f_3;
					Global_4540738[num /*12*/].f_7 = eventData.f_4;
					Global_4540738[num /*12*/].f_8 = eventData.f_5;
					Global_4540738[num /*12*/].f_9 = eventData.f_6;
					Global_4540738[num /*12*/].f_11 = 1;
					Global_4535172[num /*85*/].f_66.f_2 = 2;
				
					if (Global_4535172[num /*85*/].f_66.f_11 & 4 != 0)
						func_33(num, flag3);
					else if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
						if (flag3)
							NETSHOPPING::NET_GAMESERVER_BASKET_APPLY_SERVER_DATA(Global_4535172[num /*85*/].f_66, &unk92);
				}
				break;
			...
			default:
				if (num != -1)
				{
					...
					if (Global_4535172[num /*85*/].f_66.f_11 & 1 != 0 && Global_4535172[num /*85*/].f_66.f_9 < 2 && func_32(eventData.f_2))
					{
						if (func_10(num))
						{
							if (func_24())
							...
							else if (Global_4535172[num /*85*/].f_66.f_11 & 2 != 0)
							{
								Global_4536680 = Global_4535172[num /*85*/].f_66.f_4;
								Global_4536682 = Global_4535172[num /*85*/].f_66.f_6;
								Global_4536683 = eventData.f_2;
								Global_4536681 = Global_4535172[num /*85*/].f_66.f_1;
							
								if (func_23(Global_4536680) && _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
								{
									if (!func_22(Global_4535172[num /*85*/].f_66))
									{
										num2 = func_21();
										Global_4536533[num2 /*7*/] = Global_4535172[num /*85*/].f_66;
										Global_4536533[num2 /*7*/].f_2 = Global_4536680;
										Global_4536533[num2 /*7*/].f_3 = Global_4536682;
										Global_4536533[num2 /*7*/].f_1 = Global_4536681;
						...
						else if (Global_4535172[num /*85*/].f_66.f_11 & 2 != 0)
						{
							...
							if (func_23(Global_4536680) && _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
							{
								if (!func_22(Global_4535172[num /*85*/].f_66))
								{
									...
									Global_4536533[num3 /*7*/].f_2 = Global_4536680;
									Global_4536533[num3 /*7*/].f_3 = Global_4536682;
									Global_4536533[num3 /*7*/].f_1 = Global_4536681;
					...
					else if (Global_4535172[num /*85*/].f_66.f_11 & 2 != 0)
					{
						...
						if (func_23(Global_4536680) && _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() && func_32(eventData.f_2))
						{
							if (!func_22(Global_4535172[num /*85*/].f_66))
							{
								num4 = func_21();
								Global_4536533[num4 /*7*/] = Global_4535172[num /*85*/].f_66;
								Global_4536533[num4 /*7*/].f_2 = Global_4536680;
								Global_4536533[num4 /*7*/].f_3 = Global_4536682;
								Global_4536533[num4 /*7*/].f_1 = Global_4536681;
					...
					if (Global_4535172[num /*85*/].f_66.f_2 == 3)
					{
						...
						if (Global_4535172[num /*85*/].f_66.f_11 & 4 != 0)
							func_18(num, Global_4535172[num /*85*/].f_66.f_4, Global_4535172[num /*85*/].f_66.f_10, Global_4535172[num /*85*/].f_66.f_1, eventData.f_2);
					}
				}
				break;
		}
...
int func_21() // Position - 0xD24
{
	...
	{
		if (Global_4536533[i /*7*/] != 0 && Global_4536533[i /*7*/] != 2147483647)
			num = num + 1;
	}
...
BOOL func_24() // Position - 0x1714
{
	...
	if (!flag)
	{
		if (!NETSHOPPING::NET_GAMESERVER_IS_SESSION_VALID(func_11()) || NETSHOPPING::NET_GAMESERVER_IS_SESSION_REFRESH_PENDING())
		{
			if (func_30(Global_4535172[num /*85*/].f_66.f_6, Global_4535172[num /*85*/].f_66.f_4, Global_4535172[num /*85*/].f_66.f_1) == 1)
				Global_4536678 = 1;
	...
	if (transactionId != 2147483647)
	{
		if (flag || flag2 || NETSHOPPING::NET_GAMESERVER_CHECKOUT_START(transactionId))
		{
			...
			if (flag || flag2)
				func_25(Global_4535172[num /*85*/], num);
...
int func_27(int iParam0) // Position - 0x1915
{
	var address;
...
BOOL func_28(int iParam0) // Position - 0x1930
{
	int num;
...
BOOL func_32(int iParam0) // Position - 0x2003
{
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x2030
{
	...
	switch (Global_4535172[iParam0 /*85*/].f_66.f_4)
	{
		...
		case joaat("SERVICE_SPEND_LOSE_WANTED_LEVEL"):
			if (IS_GAMER_HANDLE_VALID(Global_4535172[iParam0 /*85*/].f_14))
				MONEY::NETWORK_SPENT_BUY_WANTEDLEVEL(Global_4535172[iParam0 /*85*/].f_66.f_1, &(Global_4535172[iParam0 /*85*/].f_14), notBankrupt, hasTheMoney, 0);
			break;
		...
		case joaat("SERVICE_SPEND_RENAME_ORGANIZATION"):
			MONEY::NETWORK_SPENT_RENAME_ORGANIZATION(Global_4535172[iParam0 /*85*/].f_66.f_1, notBankrupt, hasTheMoney, &(Global_4535172[iParam0 /*85*/].f_14.f_26));
			break;
	
		case 2115896461:
			_NETWORK_SPEND_RENAME_ACID_PRODUCT(Global_4535172[iParam0 /*85*/].f_66.f_1, notBankrupt, hasTheMoney, func_35(&(Global_1914706[PLAYER::PLAYER_ID() /*299*/].f_267)));
			break;
	
		case 797947947:
			_NETWORK_SPEND_RENAME_ACID_LAB(Global_4535172[iParam0 /*85*/].f_66.f_1, notBankrupt, hasTheMoney, func_35(&(Global_1914706[PLAYER::PLAYER_ID() /*299*/].f_283)));
			break;
		...
		case joaat("SERVICE_SPEND_PASSIVE"):
			MONEY::NETWORK_SPENT_BUY_PASSIVE_MODE(Global_4535172[iParam0 /*85*/].f_66.f_1, notBankrupt, hasTheMoney, 0);
			break;
		...
		case joaat("SERVICE_SPEND_UTILITY_BILLS"):
			MONEY::NETWORK_SPEND_APARTMENT_UTILITIES(Global_4535172[iParam0 /*85*/].f_66.f_1, notBankrupt, hasTheMoney, &Global_4540949);
			break;
	
		case joaat("SERVICE_SPEND_PA_SERVICE_DANCER"):
			MONEY::NETWORK_SPENT_PA_SERVICE_DANCER(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/], notBankrupt, hasTheMoney);
			break;
		...
		case joaat("SERVICE_EARN_AMBIENT_JOB_DESTROY_VEH"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_DESTROY_VEH", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_DISTRACT_COPS"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_DISTRACT_COPS", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_PLANE_TAKEDOWN"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_PLANE_TAKEDOWN", &unk);
			break;
		...
		case joaat("SERVICE_SPEND_TAXI"):
			...
			MONEY::NETWORK_SPENT_TAXI(Global_4535172[iParam0 /*85*/].f_66.f_1, notBankrupt, hasTheMoney, 0, num2);
			break;
		...
		case joaat("SERVICE_EARN_AMBIENT_JOB_HOT_TARGET_DELIVER"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_HOT_TARGET_DELIVER", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_HOT_TARGET_KILL"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_HOT_TARGET_KILL", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_URBAN_WARFARE"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_KILL_LIST", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_CHECKPOINT_COLLECTION"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_CP_COLLECTION", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_TIME_TRIAL"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_TIME_TRIAL", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_CHALLENGES"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_CHALLENGES", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_HELI_HOT_TARGET"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_HOT_TARGET_HELI", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_DEAD_DROP"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_DEAD_DROP", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_PENNED_IN"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_PENNED_IN", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_PASS_PARCEL"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_PASS_THE_PARCEL", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_BLAST"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_CRIMINAL_DAMAGE", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_HOT_PROPERTY"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_HOT_PROPERTY", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_KING"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_KING_OF_THE_HILL", &unk);
			break;
	
		case joaat("SERVICE_EARN_AMBIENT_JOB_BEAST"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "AM_HUNT_THE_BEAST", &unk);
			break;
		...
		case joaat("SERVICE_EARN_SALVAGE_CHECKPOINT_COLLECTION"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "GB_SALVAGE", &unk);
			break;
		...
		case joaat("SERVICE_SPEND_NIGHTCLUB_ENTRY_FEE"):
			if (_NETWORK_IS_PLAYER_VALID(PLAYER::INT_TO_PLAYERINDEX(Global_4535172[iParam0 /*85*/]), false, false))
		...
		case joaat("SERVICE_EARN_AMBIENT_JOB_RC_TIME_TRIAL"):
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, "RC_TIME_TRIAL", &unk);
			break;
	...
	switch (Global_4535172[iParam0 /*85*/].f_66.f_4)
	{
		...
		case 333526332:
		case 1823444356:
			MONEY::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, &(Global_4535172[iParam0 /*85*/].f_14.f_26), &unk);
			break;
		...
		case 883337077:
			...
			_NETWORK_EARN_TAXI_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, &unk14);
			break;
	
		case -1274418755:
			_NETWORK_EARN_DAILY_STASH_HOUSE_PARTICIPATION(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case -1853979468:
			_NETWORK_EARN_DAILY_STASH_HOUSE_COMPLETED(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 1633116913:
			_NETWORK_EARN_JUGGALO_STORY_MISSION(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 668586600:
			_NETWORK_EARN_JUGGALO_STORY_MISSION_PARTICIPATION(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 15168061:
			_NETWORK_EARN_FOOLIGAN_JOB(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 590289134:
			_NETWORK_EARN_FOOLIGAN_JOB_PARTICIPATION(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 99792878:
			_NETWORK_EARN_AWARD_JUGGALO_MISSION(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 1866258778:
			_NETWORK_EARN_AWARD_ACID_LAB(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case -178394060:
			_NETWORK_EARN_AWARD_DAILY_STASH(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 409592287:
			_NETWORK_EARN_AWARD_DEAD_DROP(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 593836803:
			_NETWORK_EARN_AWARD_RANDOM_EVENT(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 1973036520:
			_NETWORK_EARN_AWARD_TAXI(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 2063456538:
			_NETWORK_EARN_SETUP_PARTICIPATION_ACID_LAB(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case -728008329:
			_NETWORK_EARN_SOURCE_PARTICIPATION_ACID_LAB(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case 119239868:
			_NETWORK_EARN_SELL_PARTICIPATION_ACID_LAB(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case -456458353:
			_NETWORK_EARN_SMUGGLER_OPS(Global_4535172[iParam0 /*85*/].f_66.f_15, Global_4535172[iParam0 /*85*/], Global_4535172[iParam0 /*85*/].f_66.f_16);
			break;
	
		case -2091351051:
			_NETWORK_EARN_BONUS_OBJECTIVE(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/], Global_4535172[iParam0 /*85*/].f_66.f_15);
			break;
	
		case -373571001:
			_NETWORK_EARN_AVENGER(Global_4535172[iParam0 /*85*/].f_66.f_1, Global_4535172[iParam0 /*85*/]);
			break;
	
		case -367430800:
			_NETWORK_EARN_AVENGER(Global_4535172[iParam0 /*85*/].f_66.f_1, -2);
			break;
	}

	if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
		if (bParam1)
			NETSHOPPING::NET_GAMESERVER_BASKET_APPLY_SERVER_DATA(Global_4535172[iParam0 /*85*/].f_66, &unk17);

	func_7(iParam0);
	return;
}

BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x454D
{
	Player player;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x45B7
{
...
void func_39(int iParam0) // Position - 0x4643
{
	...
	hashKey = hashKey || func_41();
	hashKey = hashKey + Global_4538687;
	func_40(&hash);
	hashKey = hashKey || hash;
	MISC::CLEAR_BIT(&hashKey, 28);
	MISC::CLEAR_BIT(&hashKey, 29);
	MISC::CLEAR_BIT(&hashKey, 26);
	flag = Global_4540738[iParam0 /*12*/].f_9 && hashKey;
	flag2 = Global_4540738[iParam0 /*12*/].f_8 && hashKey;
	num = Global_4540738[iParam0 /*12*/].f_7;

	if (num == 0)
		num = -2085313189;

	if (Global_4540738[iParam0 /*12*/] != Global_4540738[iParam0 /*12*/].f_5 || Global_4540738[iParam0 /*12*/].f_1 != Global_4540738[iParam0 /*12*/].f_6 || Global_4540738[iParam0 /*12*/].f_2 != num || Global_4540738[iParam0 /*12*/].f_3 != flag2 + flag)
		Global_110511 = 1;
...
Hash func_41() // Position - 0x4784
{
	return SYSTEM::SHIFT_LEFT(1, 25);
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x4793
{
	if (Global_1575038 == 0)
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			return true;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x4817
{
	switch (func_45())
	{
		case 0:
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x4888
{
...
void func_53(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33) // Position - 0x48DF
{
	if (Global_262145.f_24258)
		func_51();
	...
	uLocal_20.f_14 = { Global_4535172[uParam0.f_33 /*85*/].f_14 };
	iLocal_19 = uParam0.f_33;

	if (uParam0.f_33 < 0)
		func_51();

	if (!func_54(uParam0, uParam0.f_33))
	{
		func_7(uParam0.f_33);
		func_51();
	}
...
BOOL func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19) // Position - 0x4963
{
	if (Global_4535172[iParam19 /*85*/].f_66.f_1 != uParam0.f_1)
		return false;

	if (Global_4535172[iParam19 /*85*/].f_66.f_3 != uParam0.f_3)
		return false;

	if (Global_4535172[iParam19 /*85*/].f_66.f_4 != uParam0.f_4)
		return false;

	if (Global_4535172[iParam19 /*85*/].f_66.f_5 != uParam0.f_5)
		return false;

	if (Global_4535172[iParam19 /*85*/].f_66.f_6 != uParam0.f_6)
		return false;

	if (Global_4535172[iParam19 /*85*/].f_66.f_7 != uParam0.f_7)
		return false;

	if (Global_4535172[iParam19 /*85*/].f_66.f_14 != uParam0.f_14)
		return false;

	if (Global_4535172[iParam19 /*85*/].f_66.f_17 != uParam0.f_17)
		return false;
