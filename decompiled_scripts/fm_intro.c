...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_421(false))
			uLocal_708[unk_0xD378D2332270959A() /*5*/] = 3;
		...
		{
			case 0:
				if (!IS_BIT_SET(iLocal_719, 10))
					if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
						unk_0xECDAB41968FF21A8(&iLocal_719, 10);
				...
				if (func_418() && unk_0x7F29CD9C0A5C1E44("FMINT", 0))
				{
					if (func_417() > 0)
					{
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_371, 1, 0, "Lamar", 0, 1);
						func_415(false);
						func_414(4, true);
						func_414(1, true);
						func_414(0, true);
						func_414(2, true);
						func_414(3, false);
						func_412(iLocal_61, true);
						uLocal_708[unk_0xD378D2332270959A() /*5*/] = 2;
					
						if (bLocal_727)
							uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = -2;
						else
							uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = -1;
					}
				}
			
				if (func_417() == 4)
					uLocal_708[unk_0xD378D2332270959A() /*5*/] = 4;
			
				if (func_417() == 6 && uLocal_708[unk_0xD378D2332270959A() /*5*/] < 4)
					uLocal_708[unk_0xD378D2332270959A() /*5*/] = 6;
				break;
			...
			case 2:
				...
				if (func_417() == 6 && uLocal_708[unk_0xD378D2332270959A() /*5*/] < 4)
					uLocal_708[unk_0xD378D2332270959A() /*5*/] = 5;
				break;
			...
			case 5:
				func_21(&(iLocal_536.f_5));
			
				if (func_20(&(iLocal_536.f_5)))
					uLocal_708[unk_0xD378D2332270959A() /*5*/] = 3;
				break;
...
{
	if (!bLocal_725)
		if (IS_BIT_SET(iLocal_536.f_1, 1))
			return true;
	else if (IS_BIT_SET(iLocal_536.f_1, 2))
		return true;
...
void func_3() // Position - 0x2EE
{
	if (unk_0xE85391CF212DE622())
	{
		if (!IS_BIT_SET(iLocal_536.f_1, 3))
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 0))
				unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 3);
	
		if (!IS_BIT_SET(iLocal_536.f_1, 4))
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 2))
				unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 4);
	
		if (!IS_BIT_SET(iLocal_536.f_1, 5))
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 3))
				unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 5);
	
		if (!IS_BIT_SET(iLocal_536.f_1, 6))
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 4))
				unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 6);
	
		if (!IS_BIT_SET(iLocal_536.f_1, 7))
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 5))
				unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 7);
	
		if (!IS_BIT_SET(iLocal_536.f_1, 8))
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 6))
				unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 8);
	
		switch (iLocal_536.f_2)
		{
			case 0:
				if (IS_BIT_SET(iLocal_536.f_1, 3))
				{
					if (func_4(&(iLocal_536.f_3), &(iLocal_536.f_4), -1031.7882f, -2731.816f, 19.0546f, 240.4822f, &uLocal_543))
					{
						unk_0xC8EE2E23B410B65A(unk_0x972B1BFB16AD20B5(iLocal_536.f_3), 1, 0, 0);
						iLocal_536.f_2 = 2;
					}
				}
				break;
...
BOOL func_4(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, var uParam6) // Position - 0x4B6
{
	if (func_9(Global_2793044.f_849) && func_9(Global_2793044.f_850))
	{
		if (!unk_0x7E2E2E8A648611F4(*uParam0))
			if (func_6(uParam0, Global_2793044.f_849, fParam2, fParam5, 1, 1, true, 0, 1, true, false, false, 0, false))
				unk_0xA303DFE285DB0BDD(unk_0x972B1BFB16AD20B5(*uParam0), 1);
	
		if (!unk_0x7E2E2E8A648611F4(*uParam1))
		{
			if (func_5(uParam1, *uParam0, 25, Global_2793044.f_850, -1, true, 1, 1))
			{
				...
				_CONVERSATION_INITIALIZE_ACTOR(uParam6, 8, unk_0x0DB8386015E986B7(*uParam1), "FM_TAXI", 0, 1);
			}
		}
	}
...
BOOL func_5(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7) // Position - 0x5A3
{
...
BOOL func_6(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, BOOL bParam8, int iParam9, int iParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, int iParam14, BOOL bParam15) // Position - 0x62B
{
	float num;
	var unk;
	...
	unk = unk_0xABEEDBEF2BBDF5B3(iParam1, uParam2, fParam5, iParam7, iParam6, iParam14);
	...
	if (unk_0x7DE17ACDD8BA2642(unk))
	{
		*uParam0 = unk_0x5FCD9CA713B11294(unk);
		...
		if (unk_0x7E2E2E8A648611F4(*uParam0))
		{
			...
			func_7(uParam2, fParam5, iParam1, unk);
			return true;
		}
	}
...
void func_7(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4, var uParam5) // Position - 0x734
{
	int i;

	if (func_8(unk_0x93E99A2DBCBA9CFA(), vParam0, iParam4) > -1)
	{
...
int func_8(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x807
{
	int num;
	int i;
	Vector3 vector;
...
int func_9(int iParam0) // Position - 0x8A5
{
	if (iParam0 == 0)
		return 1;
...
void func_11() // Position - 0x8CB
{
	...
	for (i = 0; i < unk_0x1C57E792CD67EF97(); i = i + 1)
	{
		if (unk_0x9A45DBB669E889B7(unk_0x74A08123C183740A(i)))
			if (bLocal_725)
				if (!IS_BIT_SET(iLocal_536.f_1, 2))
					if (IS_BIT_SET(uLocal_708[i /*5*/].f_3, 2))
						unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 2);
			else if (!IS_BIT_SET(iLocal_536.f_1, 1))
				if (IS_BIT_SET(uLocal_708[i /*5*/].f_3, 1))
					unk_0xECDAB41968FF21A8(&(iLocal_536.f_1), 1);
	}
...
{
	if (!func_15(unk_0x93E99A2DBCBA9CFA(), true))
		return;
...
int func_13(Player plParam0) // Position - 0x96E
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x990
{
	int num;
...
BOOL func_15(Player plParam0, BOOL bParam1) // Position - 0x9F0
{
	if (func_19() != 0)
...
BOOL func_16(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA17
{
	if (bParam1)
		if (func_17(plParam0))
			return 1;
...
BOOL func_17(Player plParam0) // Position - 0xA49
{
	return func_18(plParam0);
}

BOOL func_18(int iParam0) // Position - 0xA57
{
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xAC1
{
	if (pStopwatch->f_1 == 0)
	{
...
void func_24() // Position - 0xB61
{
	switch (iLocal_724)
	{
		case 0:
			...
			{
				unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3), 2);
				uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = 99;
			}
			break;
	}
...
BOOL func_26(int iParam0, int iParam1, BOOL bParam2) // Position - 0xBB1
{
	...
	if (bParam2)
		...
		if (func_19() == 0)
			return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_30(iParam0), -1, 0), iParam1);
	else
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0xC12
{
	var unk;
	int num;
	...
	{
		iParam2 == 0;
		unk = Global_2805027[empsParam0 /*3*/][func_28(iParam1)];
...
eMPStat func_30(int iParam0) // Position - 0xC8F
{
	switch (iParam0)
	{
		case 0:
...
void func_31() // Position - 0x1028
{
	...
	if (!_STOPWATCH_IS_INITIALIZED(&uLocal_361))
		_STOPWATCH_INITIALIZE(&uLocal_361, false, false);

	if (!IS_BIT_SET(iLocal_719, 21))
		unk_0xECDAB41968FF21A8(&iLocal_719, 21);

	if (!IS_BIT_SET(iLocal_719, 3))
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_359))
			_STOPWATCH_INITIALIZE(&uLocal_359, false, false);
		else if (IS_BIT_SET(iLocal_719, 21))
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
				if (unk_0xACD39355028D39EF(unk_0xC1A5EC5C986B98AD()))
					if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_359, 3000, false))
						unk_0xECDAB41968FF21A8(&iLocal_719, 3);
	
		if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_359, 40000, false))
			unk_0xECDAB41968FF21A8(&iLocal_719, 3);
	}
	else if (!IS_BIT_SET(iLocal_719, 16))
	{
		if (!unk_0xF0E4B64AC0B5660E())
		{
			if (!unk_0xFEE065E56A9BEF3F())
			{
				unk_0xECDAB41968FF21A8(&iLocal_719, 16);
				_STOPWATCH_DESTROY(&uLocal_359);
			}
		}
	}
	...
	if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 2))
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_365))
		{
			_STOPWATCH_INITIALIZE(&uLocal_365, false, false);
		}
		else if (!IS_BIT_SET(iLocal_720, 1))
		{
			if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_365, 10000, false))
			{
				unk_0xECDAB41968FF21A8(&iLocal_720, 1);
				_STOPWATCH_DESTROY(&uLocal_365);
			}
		}
		else if (IS_BIT_SET(iLocal_719, 19))
		{
			if (!IS_BIT_SET(iLocal_719, 18))
			{
				if (!func_196() || _STOPWATCH_HAS_TIME_PASSED(&uLocal_359, 5000, false))
				{
					func_195(0);
					unk_0xECDAB41968FF21A8(&iLocal_719, 18);
	...
	if (IS_BIT_SET(iLocal_719, 18))
	{
		if (!IS_BIT_SET(iLocal_719, 2))
		{
			if (unk_0x35DF833D93BCC488())
			{
				...
				if (func_99(&uLocal_371, CHAR_LAMAR, "FM_1AU", "FM_ICALL", num, 0))
				{
					func_98(true);
					unk_0xECDAB41968FF21A8(&iLocal_719, 2);
				
					if (!IS_BIT_SET(iLocal_719, 20))
					{
						func_83(19, 3, true);
						unk_0xECDAB41968FF21A8(&iLocal_719, 20);
					}
			...
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (!func_79())
				{
					if (!IS_BIT_SET(iLocal_719, 12))
					{
						...
						unk_0xECDAB41968FF21A8(&iLocal_719, 12);
						_STOPWATCH_INITIALIZE(&uLocal_363, false, false);
						_STOPWATCH_INITIALIZE(&uLocal_367, false, false);
					}
				}
			}
		}
		...
		if (IS_BIT_SET(iLocal_719, 12))
		{
			if (!IS_BIT_SET(iLocal_719, 17))
			{
				if (!unk_0xFEE065E56A9BEF3F())
				{
					func_75();
					unk_0xECDAB41968FF21A8(&iLocal_719, 17);
					_STOPWATCH_DESTROY(&uLocal_359);
				}
			}
			else if (!func_196())
			{
				if (!IS_BIT_SET(iLocal_719, 23))
				{
					if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_367, 4500, false))
					{
						unk_0xECDAB41968FF21A8(&iLocal_719, 23);
						unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3), 3);
					}
				}
			
				if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_363, 15000, false))
					if (!IS_BIT_SET(iLocal_719, 22))
						unk_0xECDAB41968FF21A8(&iLocal_719, 22);
			
				if (unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) == 0)
				{
					if (IS_BIT_SET(iLocal_719, 14))
						unk_0x061B1200C95204CB(&iLocal_719, 14);
				
					if (!func_25(iLocal_61))
					{
						if (IS_BIT_SET(iLocal_719, 13))
							unk_0x061B1200C95204CB(&iLocal_719, 13);
					
						if (IS_BIT_SET(iLocal_719, 25) || !IS_BIT_SET(iLocal_719, 25) && !unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
						{
							if (!IS_BIT_SET(iLocal_719, 0))
							{
								if (IS_BIT_SET(iLocal_719, 15))
									unk_0x061B1200C95204CB(&iLocal_719, 15);
							
								if (unk_0xCE4AAA035282336C(Global_100733.f_263[iLocal_61]))
								{
									func_69("GET_AMMU", false);
									unk_0xECDAB41968FF21A8(&iLocal_719, 0);
									unk_0xECDAB41968FF21A8(&iLocal_719, 25);
								
									if (unk_0xCE4AAA035282336C(Global_100733.f_263[iLocal_61]))
									{
										if (!IS_BIT_SET(Global_2793044.f_848, 2))
							...
							else if (IS_BIT_SET(Global_2793044.f_848, 2))
							{
								if (unk_0xCE4AAA035282336C(Global_100733.f_263[iLocal_61]))
								{
									if (!IS_BIT_SET(iLocal_719, 15))
									{
										...
										unk_0xECDAB41968FF21A8(&iLocal_719, 15);
									}
								}
							}
					...
					{
						if (IS_BIT_SET(iLocal_719, 0))
							unk_0x061B1200C95204CB(&iLocal_719, 0);
					
						if (!IS_BIT_SET(iLocal_719, 13))
						{
							func_69("GET_GUN", false);
							func_68(true);
							unk_0xECDAB41968FF21A8(&iLocal_719, 13);
						}
					}
				}
				else if (!IS_BIT_SET(iLocal_719, 14))
				{
					...
					if (unk_0xCE4AAA035282336C(Global_100733.f_263[iLocal_61]))
					{
						...
						func_412(iLocal_61, false);
					}
				
					func_69("LOSE_COP", false);
					unk_0xECDAB41968FF21A8(&iLocal_719, 14);
				}
			}
		}
	}
	else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_361, 300000, false))
	{
		unk_0xECDAB41968FF21A8(&iLocal_719, 18);
	}

	if (!IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 0))
	{
		if (unk_0xED31EFCAA05B93ED(unk_0xC1A5EC5C986B98AD(), joaat("WEAPON_PISTOL"), 0) || unk_0xED31EFCAA05B93ED(unk_0xC1A5EC5C986B98AD(), joaat("WEAPON_COMBATPISTOL"), 0) || unk_0xED31EFCAA05B93ED(unk_0xC1A5EC5C986B98AD(), joaat("WEAPON_APPISTOL"), 0) || unk_0xED31EFCAA05B93ED(unk_0xC1A5EC5C986B98AD(), joaat("WEAPON_MICROSMG"), 0))
		{
			...
			{
				func_61(true);
				unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3), 0);
				func_25(iLocal_61);
			}
		}
		else
	...
	else if (!IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 1))
	{
		if (!func_42())
		{
			unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3), 1);
			func_35();
			_DISPLAY_HELP_TEXT("FM_IHELP_AMMU", -1);
		
			if (!IS_BIT_SET(iLocal_719, 31))
			{
				func_32(119, 1, -1, 1);
				func_32(115, 1, -1, 1);
				unk_0xECDAB41968FF21A8(&iLocal_719, 31);
			}
			...
			if (bLocal_725)
				if (bLocal_726)
					uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = 3;
				else
					uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = 1;
			else
				uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = 99;
...
void func_32(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1692
{
	int num;

	if (func_33())
	{
		num = Global_2848280[iParam0 /*3*/][func_28(iParam2)];
...
BOOL func_33() // Position - 0x16C4
{
	return true;
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x16D1
{
...
BOOL func_43(int iParam0) // Position - 0x1B15
{
...
void func_44(int iParam0) // Position - 0x1B25
{
	...
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		num = func_58(unk_0x93E99A2DBCBA9CFA());
	
		if (num < iParam0)
			if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
				_NETSHOPPING_PROCESS_TRANSACTION(joaat("SERVICE_EARN_HOLDUPS"), iParam0 - num, &unk, false, false, false);
			else
				unk_0x69BF04590412824E(iParam0 - num);
	}

	return;
}

void _NETSHOPPING_PROCESS_TRANSACTION(int iParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B70
{
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SERVICE_SPEND_MAKE_IT_RAIN"):
			if (iParam1 > 0 || Global_262145.f_28375)
				func_46(uParam2, -1135378931, 537254313, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), iParam0, iParam1, num, 7);
			break;
		...
		case joaat("SERVICE_EARN_SPIN_THE_WHEEL_CASH"):
			func_46(uParam2, -1135378931, 1445302971, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), iParam0, iParam1, num, 7);
			break;
	}
...
int func_46(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x2411
{
	...
	*uParam0 = 15;
	...
	if (flag || flag2 || unk_0x8C722BABE4726C11(&num, iParam3, iParam4, iParam2, iParam5, iParam6))
	{
		...
		{
			*uParam0 = func_53(num, iParam1, iParam4, iParam2, iParam3, iParam5, false, iParam6, iParam7, 1, true);
...
BOOL func_51(int iParam0) // Position - 0x279E
{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x27DD
{
	int i;
...
int _GET_PLAYER_SCRIPT_EVENT_BITS(int iParam0) // Position - 0x29BB
{
	var unk;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x29D3
{
...
int func_58(int iParam0) // Position - 0x29EA
{
	int num;
...
BOOL func_60(int iParam0) // Position - 0x2A3F
{
	if (iParam0 == -1)
		return false;
	else
...
void func_63(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2AFC
{
	...
	else if (unk_0xA26A9A07F761D8F8())
	{
		if (func_19() == 0)
		{
			num = _MPCHAR_STAT_GET_INT(func_30(iParam0), -1, 0);
			unk_0x061B1200C95204CB(&num, iParam1);
			_MPCHAR_STAT_SET_INT(func_30(iParam0), num, -1, 1, false);
		}
	}
	else
	{
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2B6E
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_28(iParam2)];
...
BOOL func_67(int iParam0) // Position - 0x2C96
{
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1926510, 19))
			unk_0xECDAB41968FF21A8(&Global_1926510, 19);
	else if (IS_BIT_SET(Global_1926510, 19))
...
void func_75() // Position - 0x2E1E
{
	...
	unk = { func_78(unk_0x93E99A2DBCBA9CFA()) };
	flag = unk_0x56046AEC15223442();
	flag2 = func_77(&unk);
...
void _DISPLAY_HELP_TEXT_NO_SOUND(char* text, int iParam1) // Position - 0x2E8C
{
	unk_0x476CC3711883B966(text);
...
BOOL func_77(var uParam0) // Position - 0x2EA3
{
...
struct<13> func_78(Player plParam0) // Position - 0x2EC9
{
	var unk;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2EFC
{
...
BOOL func_82(int iParam0) // Position - 0x2F1E
{
	if (iParam0 == 1)
...
void func_83(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2F75
{
	int num;
	...
	if (Global_117[echParam0 /*10*/].f_8 != 169)
	{
		...
		if (echParam1 == 4)
		{
			...
			func_88(echParam0, 0, 1);
			func_88(echParam0, 1, 1);
			func_88(echParam0, 2, 1);
		}
		else
		{
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x3166
{
	return Global_2028[character /*29*/].f_3;
}

int func_86(eCharacter echParam0, int iParam1) // Position - 0x3179
{
...
int func_87(eCharacter echParam0, int iParam1) // Position - 0x31A3
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_88(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x31CD
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_89(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x3212
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x3257
{
	if (func_97(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x32F9
{
	func_92();
...
void func_92() // Position - 0x3312
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_93(character) && !func_97(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != character && func_93(Global_113648.f_2365.f_539.f_4321))
...
BOOL func_93(eCharacter echParam0) // Position - 0x340F
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x341B
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3458
{
...
int func_96(eCharacter echParam0) // Position - 0x347D
{
...
BOOL func_99(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x34BC
{
	char* str;
	BOOL flag;
	int num;
	...
	flag = false;
	num = -99;
	return func_100(uParam0, echParam1, sParam2, sParam3, 1, iParam5, iParam4, str, flag, num, str, str, -1);
}

BOOL func_100(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, char* sParam7, BOOL bParam8, int iParam9, char* sParam10, char* sParam11, Player plParam12) // Position - 0x3501
{
	var unk;
	var unk2;
	int num;
	...
	unk2 = func_191(sParam2, sParam3);
	num = 0;

	if (!unk_0x2AC37494BBF1DB16(sParam7))
		num = unk_0x14580F20CBCE4FA9(sParam7);

	if (func_190(unk, unk2, num))
		return true;

	if (!func_186(iParam6))
		return false;

	if (func_183(unk, unk2, num))
	{
		if (func_182())
			return false;
	
		func_181();
		return func_107(uParam0, echParam1, plParam12, sParam2, sParam3, iParam4, iParam5, iParam6, sParam7, bParam8, iParam9, sParam10, sParam11);
	}

	if (!func_106(iParam4))
		return false;

	func_101(unk, unk2, num, sParam3, iParam4, iParam5, iParam6);
	return false;
}

void func_101(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0x35E6
{
...
BOOL func_107(var uParam0, eCharacter echParam1, Player plParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, BOOL bParam9, int iParam10, char* sParam11, char* sParam12) // Position - 0x36EC
{
	var unk;
	...
	if (iParam5 == 4)
	{
		...
		return func_174(uParam0, echParam1, sParam3, sParam4, &unk);
	}
	...
	if (iParam5 == 1 || iParam5 == 7)
	{
		...
		return func_156(uParam0, echParam1, sParam3, sParam4, iParam7);
	}

	if (iParam5 == 5)
		return func_155(echParam1, plParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	if (iParam5 == 2)
		return func_144(echParam1, plParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	if (iParam5 == 3)
		return func_143(echParam1, plParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	if (iParam5 == 6)
		return func_108(echParam1, plParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	return false;
}

BOOL func_108(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x37E5
{
	BOOL flag;
	...
	if (func_110(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_109(120000);
		return 1;
	}
...
BOOL func_110(eCharacter echParam0, Player plParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0x383F
{
	Player player;
	int num;
	char* str;
	...
	num2 = 0;
	str2 = func_134(sParam5, bParam6, &num2);
	num3 = func_132(iParam7, &num2);
	num4 = 0;
	...
	if (!num2 == 0 || !unk_0x2AC37494BBF1DB16(str))
		flag2 = func_131(echParam0, sParam2, num7, str2, num3, str, num2, num8, 1, num6, 0, flag, num5, 0, num4, sParam8, sParam9);
	else
		flag2 = func_114(echParam0, sParam2, num7, num8, 1, num6, 0, flag, num5, 0);
...
BOOL func_114(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x39BF
{
	int num;
	char* str;
	int num2;
	...
	if (func_115(echParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_8960 = iParam6;
...
int func_115(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3A2B
{
	int num;
	BOOL flag;
	...
	func_116(echParam0, sParam1, flag, func_120(unk_0x93E99A2DBCBA9CFA()));
	return 1;
}

void func_116(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x3E13
{
	if (!func_117())
		return;
...
BOOL func_119(int iParam0, int iParam1) // Position - 0x3EE3
{
	return IS_BIT_SET(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

var func_120(int iParam0) // Position - 0x3EFB
{
				...
				if (iParam0 == Global_8260[num /*15*/].f_11)
				{
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (Global_2694519)
								if (num == 14)
									func_122(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_122(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78558)
								{
									...
									func_122(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_122(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8260[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_122(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_122(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
...
void func_122(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x44AB
{
...
void func_123(int iParam0) // Position - 0x455E
{
...
void func_124(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4570
{
	unk_0x9FD96C5DE6EDFC15(uParam0, sParam1);
	unk_0xC6A3EF6C4A3412C1(SYSTEM::ROUND(fParam2));
...
void func_128() // Position - 0x467E
{
	...
	while (num3 < num2)
	{
		if (!func_129(Global_4541032[num3 /*104*/].f_18, Global_4541032[Global_4542281 /*104*/].f_18))
			Global_4542281 = num3;
...
BOOL func_129(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x4728
{
	int num;
	int num2;
	int num3;
...
int func_130() // Position - 0x4813
{
	...
	while (i < num2)
	{
		if (Global_4541032[i /*104*/].f_24 == 0 || Global_4541032[i /*104*/].f_24 == 1)
			if (!func_129(Global_4541032[i /*104*/].f_18, Global_4541032[Global_4542281 /*104*/].f_18))
				Global_4542281 = i;
...
BOOL func_131(eCharacter echParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0x493E
{
	int num;
	...
	if (func_115(echParam0, sParam1, iParam2, iParam6, sParam3, sParam5, iParam4, iParam7, iParam8, iParam9, bParam11, iParam12, iParam13, iParam14, sParam15, sParam16, num) == 1)
	{
		if (bParam11 == true)
		{
...
int func_132(int iParam0, var uParam1) // Position - 0x49C0
{
	if (iParam0 == -99)
		return -99;
...
char* func_134(char* sParam0, BOOL bParam1, var uParam2) // Position - 0x4A90
{
	if (unk_0x2AC37494BBF1DB16(sParam0))
		return sLocal_18;
...
int func_135(Player plParam0) // Position - 0x4ACD
{
	int num;
...
void func_136(Player plParam0, BOOL bParam1) // Position - 0x4B03
{
	if (!_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
		return;

	if (func_138(plParam0) != -1)
		return;
...
BOOL func_137(Player plParam0) // Position - 0x4B6F
{
	int i;
...
int func_138(Player plParam0) // Position - 0x4BA1
{
	int i;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x4D03
{
	return -1;
}
...
BOOL func_143(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x4D1D
{
	BOOL flag;

	func_142();
	flag = false;
	return func_110(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

BOOL func_144(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x4D44
{
	BOOL flag;

	flag = false;
	return func_145(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

BOOL func_145(eCharacter echParam0, Player plParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0x4D67
{
	Player player;
	int num;
	char* str;
	...
	if (!num2 == 0 || !unk_0x2AC37494BBF1DB16(str))
		flag2 = func_154(echParam0, sParam2, num7, str2, num3, str, num2, num8, 1, num6, 0, flag, num5, 0, num4, sParam8, sParam9);
	else
...
BOOL _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x4EC5
{
	int num;
	char* str;
	int num2;
	...
	if (func_148(echParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_8960 = iParam6;
...
int func_148(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x4F54
{
	int num;
	BOOL flag;
	...
	func_149(echParam0, sParam1, flag, func_120(unk_0x93E99A2DBCBA9CFA()));
	return 1;
}

void func_149(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x542A
{
	if (!func_117())
		return;
...
void func_151() // Position - 0x5519
{
	...
	while (num3 < num2)
	{
		if (!func_152(Global_113648.f_14143[num3 /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18))
			Global_22792 = num3;
...
BOOL func_152(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x55E4
{
	int num;
	int num2;
	int num3;
...
int func_153() // Position - 0x56CF
{
	...
	while (i < num2)
	{
		if (Global_113648.f_14143[i /*104*/].f_24 == 0 || Global_113648.f_14143[i /*104*/].f_24 == 1)
			if (!func_152(Global_113648.f_14143[i /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18))
				Global_22792 = i;
...
BOOL func_154(eCharacter echParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0x5837
{
	int num;
	...
	if (func_148(echParam0, sParam1, iParam2, iParam6, sParam3, sParam5, iParam4, iParam7, iParam8, iParam9, bParam11, iParam12, iParam13, iParam14, sParam15, sParam16, num) == 1)
	{
		if (bParam11 == true)
		{
			Global_8960 = iParam10;
...
BOOL func_155(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x58E3
{
	BOOL flag;
	...
	if (func_145(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_109(120000);
		return 1;
	}
...
BOOL func_156(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x5935
{
	BOOL flag;
	int num;
	...
	if (IS_BIT_SET(iParam4, 4))
		flag = func_173(uParam0, echParam1, sParam2, sParam3, num, 0, 0, true);
	else
		flag = func_162(uParam0, echParam1, sParam2, sParam3, num, 0, 0, true);
...
BOOL func_162(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5A46
{
	func_172(uParam0, echParam1, sParam2, iParam5, iParam6, 0);
	Global_21773 = 0;
	Global_21732 = true;
	Global_21739 = 0;
	Global_21734 = 0;
...
BOOL func_163(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x5A94
{
	Global_21726 = 0;
...
void func_172(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x6005
{
...
BOOL func_173(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x605B
{
	func_172(uParam0, echParam1, sParam2, iParam5, iParam6, 0);
	Global_21773 = 1;
	Global_21732 = true;
...
BOOL func_174(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, char* sParam4) // Position - 0x60A9
{
	!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD());
	...
	if (func_176(uParam0, echParam1, sParam2, sParam3, 9, sParam4, 0, 0, true))
	{
		func_175();
		func_159();
		func_112();
...
BOOL func_176(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x6107
{
	func_172(uParam0, echParam1, sParam2, iParam6, iParam7, 0);
	Global_21773 = 0;
	Global_21732 = true;
	Global_21739 = 0;
	Global_21734 = 1;
...
BOOL func_177(var uParam0, char* sParam1, char* sParam2) // Position - 0x615C
{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x6198
{
	...
	Global_22722 = 0;
	Global_2883585 = 0;
	return func_163(sParam2, iParam3, false);
}
...
BOOL func_183(var uParam0, var uParam1, int iParam2) // Position - 0x622B
{
	if (!func_184(uParam0))
		return 0;
...
BOOL func_184(var uParam0) // Position - 0x626A
{
	if (!func_185())
		return false;
...
BOOL func_186(int iParam0) // Position - 0x62A9
{
	if (func_189())
		return false;
...
BOOL func_190(var uParam0, var uParam1, int iParam2) // Position - 0x6342
{
	if (!func_80())
		return false;

	return func_183(uParam0, uParam1, iParam2);
}

var func_191(char* sParam0, char* sParam1) // Position - 0x6360
{
	var unk;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x63F1
{
	unk_0x56C9BC27C0FF68D7(message);
	return unk_0x6A92D111B5409879(0);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x6404
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x6411
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x646F
{
	return uParam0->f_1;
}
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 8))
			unk_0xECDAB41968FF21A8(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139), 8);
	else if (IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 8))
...
{
	return IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 8);
}
...
void func_203() // Position - 0x64F0
{
	...
	if (!bLocal_728)
		uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = 0;
	else
		uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = 3;
...
{
	if (func_210(&uLocal_62, &(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4)))
		uLocal_708[unk_0xD378D2332270959A() /*5*/].f_2 = -1;
...
void func_205(var uParam0) // Position - 0x656B
{
	BOOL flag;

	flag = unk_0xFEE065E56A9BEF3F();
	...
	switch (iLocal_723)
	{
		case 0:
			...
			{
				if (!_STOPWATCH_IS_INITIALIZED(&uLocal_729))
					_STOPWATCH_INITIALIZE(&uLocal_729, false, false);
				...
				if (!flag)
				{
					if (!unk_0xF0E4B64AC0B5660E())
					{
						...
						_STOPWATCH_DESTROY(&uLocal_729);
						_STOPWATCH_INITIALIZE(&uLocal_729, false, false);
						iLocal_723 = iLocal_723 + 1;
					}
				}
				else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_729, 5000, false))
				{
					iLocal_723 = iLocal_723 + 1;
					_STOPWATCH_DESTROY(&uLocal_729);
					_STOPWATCH_INITIALIZE(&uLocal_729, false, false);
		...
		case 99:
			if (!IS_BIT_SET(iLocal_720, 2))
				unk_0xECDAB41968FF21A8(&iLocal_720, 2);
			break;
	}
...
BOOL func_210(var uParam0, var uParam1) // Position - 0x6821
{
	float num;
	var unk;
	int i;
	...
	if (!IS_BIT_SET(*uParam0, 13))
	{
		...
		{
			num2 = { unk_0x103F436394008500(unk_0x3401C73FB9F2E08B()) };
		
			if (num2 != 0f || num2.f_1 != 0f || num2.f_2 != 0f)
			{
				unk_0xD4E2F1C0CFBCE829(num2, 0f, 0f, 0f);
	...
	if (!IS_BIT_SET(*uParam0, 31))
	{
		if (uParam0->f_6 > 0)
		{
			uParam0->f_32 = unk_0xAF0CB15312D8B8E3(234.0331f, -1005.2032f, -98.4626f, "hei_dlc_garage_high_new");
	...
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		switch (uParam0->f_6)
		{
			case 0:
				...
				Global_1935678 = false;
				Global_1935680 = 0;
				Global_1935679 = false;
				Global_1935681 = 0;
				...
				if (unk_0x72474BA05A104E1E())
				{
					*uParam0 = 0;
					uParam0->f_4 = 0;
					uParam0->f_5 = 0;
					func_370(false, false, false, true, true, true, 0);
					...
					uParam0->f_6 = 1;
					*uParam0 = 0;
					unk_0x061B1200C95204CB(uParam0, 0);
					unk_0x061B1200C95204CB(uParam0, 1);
					unk_0x061B1200C95204CB(uParam0, 2);
					unk_0x061B1200C95204CB(uParam0, 9);
					unk_0xECDAB41968FF21A8(uParam0, 7);
					uParam0->f_122 = unk_0x54ECDA2DAB9CFB10(-1012.7869f, -2747.5974f, 15f, -1052.0299f, -2716.1438f, 25f, 0, 1, 1, 1);
				}
				break;
			...
			case 2:
				if (!unk_0xB53553DC4AAC7D8A())
				{
					if (!IS_BIT_SET(*uParam0, 4))
					{
						...
						{
							unk_0x3EF548873C55CA64();
							unk_0x05541906569796AF(754.2219f, 1226.8309f, 356.5081f, func_311(-14.367f, 0f, 157.3524f), 100f, 0);
							_STOPWATCH_DESTROY(&(uParam0->f_17));
							_STOPWATCH_INITIALIZE(&(uParam0->f_17), false, false);
							unk_0xECDAB41968FF21A8(uParam0, 4);
						}
					}
					else if (unk_0x173922034C9CB651("FM_INTRO_START") && unk_0x16760C7780F48003() || _STOPWATCH_HAS_TIME_PASSED(&(uParam0->f_17), 5000, false))
					{
						...
						else if (unk_0x14D67215B926AFF2() > 0)
						{
							...
							unk_0xCE4412DC4B679860(uParam0->f_7, 754.2219f, 1226.8309f, 356.5081f, -14.367f, 0f, 157.3524f, 42.2442f, 0, 1, 1, 2);
							unk_0xCE4412DC4B679860(uParam0->f_7, 740.7797f, 1193.9226f, 351.1997f, -9.6114f, 0f, 157.8659f, 44.8314f, 6500, 0, 0, 2);
			...
			case 9:
				...
				if (unk_0xFBD273FDBCF0C5BD(uParam0->f_48, 0))
				{
					...
					unk_0x724FFAED1C56CE2B(uParam0->f_48, 1, 0);
					...
					if (func_303(uParam0))
					{
						if (func_306(uParam0))
						{
							if (func_307(uParam0, 10, 0))
							{
								if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
								{
									unk_0xC2E3C377D893C17A(unk_0xC1A5EC5C986B98AD(), -2870.8044f, 81.4979f, 13.1957f, 1, 0, 0, 1);
									unk_0x2718E9CC165A99F6(unk_0xC1A5EC5C986B98AD(), 1);
								}
			...
			case 19:
					...
					if (!IS_BIT_SET(uParam0->f_3, 6))
					{
						if (uParam0->f_32 != 0)
						{
							if (unk_0x494DA26A8EE9C560(uParam0->f_32))
							{
								...
								for (i = 0; i < 8; i = i + 1)
								{
									if (!unk_0x055111B11E6624FD(uParam0->f_49[i], 0))
										unk_0x13C69F2F37B2A737(uParam0->f_49[i], uParam0->f_32, unk_0x14580F20CBCE4FA9("GtaMloRoom001"));
								}
				...
				if (func_307(uParam0, 19, 0) && IS_BIT_SET(uParam0->f_3, 0))
				{
			...
			case 22:
				...
				if (IS_BIT_SET(uParam0->f_3, 0))
				{
					...
					unk_0xEEF11E0DB5769366(uParam0->f_7, 1);
					unk_0xCE4412DC4B679860(uParam0->f_7, 228.1892f, -1006.7584f, -96.8311f, -13.0682f, 0.0572f, 0.7306f, 40.033f, 0, 1, 1, 2);
					unk_0xCE4412DC4B679860(uParam0->f_7, 228.2493f, -1006.1546f, -98.1976f, -2.3097f, 0.0572f, 0.7306f, 40.033f, 6000, 0, 0, 2);
			...
			case 27:
				func_275(uParam0);
				func_274(uParam0);
				unk_0xC2E3C377D893C17A(unk_0xC1A5EC5C986B98AD(), -1148.2856f, -1639.737f, 5.106698f, 1, 0, 0, 1);
			...
			case 28:
				...
				if (unk_0x173922034C9CB651("FM_INTRO_DRIVE_START") && IS_BIT_SET(uParam0->f_3, 3) && func_307(uParam0, 28, 0))
					uParam0->f_6 = 29;
				break;
			...
			case 29:
				...
				{
					unk_0x724FFAED1C56CE2B(uParam0->f_33, 1, 0);
				...
				func_256(true, true, true, 0, false, false, false);
				uParam0->f_6 = 30;
				break;
			...
			case 31:
				...
				if (unk_0x42C63C7AA899C5C8("MP_Lamar_Car", 0))
				{
					if (unk_0xFBD273FDBCF0C5BD(uParam0->f_34, 0))
					{
						...
						unk_0xC2E3C377D893C17A(uParam0->f_34, -1028.4062f, -2732.7822f, 19.5931f, 1, 0, 0, 1);
				...
				if (func_253(uParam0) && func_252(uParam0) && !unk_0x2FECE8D166B3056B())
				{
					...
					func_251(uParam0);
					func_250(uParam0);
					func_256(false, true, true, 0, false, false, false);
					unk_0xECDAB41968FF21A8(uParam0, 15);
					...
					if (!IS_BIT_SET(uParam0->f_1, 1))
						if (func_307(uParam0, 33, -5450))
							if (func_246(&(uParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_1", 9, 0, 0))
								unk_0xECDAB41968FF21A8(&(uParam0->f_1), 1);
			...
			case 34:
				...
				if (IS_BIT_SET(*uParam0, 15))
				{
					if (!unk_0x055111B11E6624FD(uParam0->f_34, 0))
					{
						...
						if (!unk_0x055111B11E6624FD(uParam0->f_35, 0))
							unk_0x724FFAED1C56CE2B(uParam0->f_35, 0, 0);
					
						if (!unk_0x055111B11E6624FD(uParam0->f_36, 0))
							unk_0x724FFAED1C56CE2B(uParam0->f_36, 1, 0);
			...
			case 35:
				...
				if (IS_BIT_SET(*uParam0, 15))
				{
					...
					if (!unk_0x055111B11E6624FD(uParam0->f_35, 0))
						unk_0x724FFAED1C56CE2B(uParam0->f_35, 1, 0);
				
					if (!unk_0x055111B11E6624FD(uParam0->f_36, 0))
						unk_0x724FFAED1C56CE2B(uParam0->f_36, 0, 0);
			...
			case 50:
				...
				if (func_307(uParam0, 50, 0) && IS_BIT_SET(*uParam0, 20))
				{
						...
						if (!IS_BIT_SET(*uParam0, 23))
						{
							if (unk_0x42C63C7AA899C5C8("MP_Female_Character", 0))
							{
								if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
								{
									...
									unk_0x692C3FDAD7DB53CC(unk_0xC1A5EC5C986B98AD(), unk_0x06A2A02CDC68090B(unk, unk.f_1));
			...
			case 56:
				...
				else if (_STOPWATCH_HAS_TIME_PASSED(&(uParam0->f_17), 10000, false))
				{
					if (func_286(uParam0))
					{
						...
						!func_237(unk_0x93E99A2DBCBA9CFA());
						func_256(false, true, true, 0, false, false, false);
						...
						unk_0xBE863059A8A9BE39(0, 0, 0);
						unk_0xECDAB41968FF21A8(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139), 3);
						uParam0->f_13 = unk_0xA5E11AF0A2B928C1() - func_231(uParam0, 48, false);
						uParam0->f_293 = 1;
						func_242(uParam0, 10177.75f);
						unk_0xECDAB41968FF21A8(uParam0, 15);
						uParam0->f_6 = 49;
		...
		{
			if (uParam0->f_293)
				uParam0->f_289 = SYSTEM::TO_FLOAT(unk_0xA5E11AF0A2B928C1() - uParam0->f_13);
			else
		...
		if (uParam0->f_6 > 0 && uParam0->f_6 <= 57)
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
				if (unk_0x1B82EF141CC65934(unk_0x93E99A2DBCBA9CFA()))
					unk_0xE333240A90F2FF3C(unk_0x93E99A2DBCBA9CFA(), 0, 60);
...
void func_211(var uParam0) // Position - 0x9F4C
{
	int num;
	...
	if (!IS_BIT_SET(*uParam0, 9))
	{
		if (uParam0->f_6 > 0)
		{
			if (!unk_0x359808AE8C4C629B())
			{
				...
				{
					num = unk_0x93E99A2DBCBA9CFA() + 32;
					unk_0x5908F275D64882F5(1, num);
					func_212(true);
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 18))
			unk_0xECDAB41968FF21A8(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139), 18);
	else if (IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 18))
...
void func_214(var uParam0) // Position - 0xA03E
{
	var unk;

	if (unk_0x7DE17ACDD8BA2642(uParam0->f_58[uParam0->f_90]))
	{
		unk_0x055111B11E6624FD(uParam0->f_58[uParam0->f_90], 0);
		unk = { unk_0x30BE8A934C020461(uParam0->f_58[uParam0->f_90], 1) };
...
void func_215(var uParam0, int iParam1) // Position - 0xA0AB
{
	var unk;
	var unk4;
	...
	{
		unk_0x055111B11E6624FD(uParam0->f_58[iParam1], 0);
		func_216(iParam1, &unk, &unk4);
		unk_0xC2E3C377D893C17A(uParam0->f_58[iParam1], unk, 1, 0, 0, 1);
		unk_0x692C3FDAD7DB53CC(uParam0->f_58[iParam1], unk4);
		unk_0x2718E9CC165A99F6(uParam0->f_58[iParam1], 1);
		unk_0x8E2A5E6443418B19(uParam0->f_58[iParam1]);
		unk_0xDDE449983CE7572E(uParam0->f_58[iParam1], 0, 0);
		unk_0x724FFAED1C56CE2B(uParam0->f_58[iParam1], 0, 0);
	}

	if (unk_0x7DE17ACDD8BA2642(uParam0->f_74[iParam1]))
	{
		unk_0x055111B11E6624FD(uParam0->f_74[iParam1], 0);
		unk_0x724FFAED1C56CE2B(uParam0->f_74[iParam1], 0, 0);
	}
...
float func_217(var uParam0) // Position - 0xA396
{
	float num;
	float num2;
	...
	if (uParam0->f_6 >= 31 && uParam0->f_6 < 33)
	{
		if (func_266(uParam0))
		{
			num = SYSTEM::TO_FLOAT(uParam0->f_27 + unk_0xB9D2E7C5399C7D85());
...
void func_218(var uParam0) // Position - 0xA413
{
	if (IS_BIT_SET(*uParam0, 29))
	{
		unk_0xB6E44413867944D1(-1160.9424f, -1657.6859f, 5.129621f, 0.8912546f, -0.3982928f, -0.21685989f, 226, 130, 78, 3.999999f, 6.6f, 1f, 30f, 1f);
		unk_0xB6E44413867944D1(-1157.3236f, -1659.8784f, 5.449264f, -0.84035075f, 0.39846787f, -0.36746988f, 226, 130, 78, 3.900002f, 8.8f, 1f, 30f, 1f);
	}

	return;
}

void func_219(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA492
{
...
void func_229(var uParam0) // Position - 0xA8D8
{
	int i;
...
{
	unk_0x90DA349CD13C7839(-533.6674f, -1961.7877f, 16.82666f, -429.5074f, -1860.3097f, 22.79688f, 20.5f, 1);
	unk_0x90DA349CD13C7839(224.4978f, -274.7691f, 48.879707f, 263.15814f, -170.51065f, 63.18772f, 21f, 1);
	return;
}

int func_231(var uParam0, int iParam1, BOOL bParam2) // Position - 0xA953
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < (num3 - num2) + 1; i = i + 1)
	{
		...
		if (bParam2)
			num = num + func_233(num4);
		else
			num = num + func_232(num4);
...
BOOL func_234(var uParam0) // Position - 0xAD94
{
	int num;
	int num2;
	...
	if (unk_0x0CBB7C273DED26E7(num) && unk_0x0CBB7C273DED26E7(num2))
	{
		if (!unk_0x7DE17ACDD8BA2642(uParam0->f_34))
		{
			uParam0->f_34 = unk_0xABEEDBEF2BBDF5B3(num2, -198.221f, 301.8606f, 95.9455f, 148.1586f, 0, 0, 0);
		...
		else if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35))
		{
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_34, 0))
			{
				uParam0->f_35 = unk_0x69FDD9508259E5B5(26, num, -195.2f, 307.1825f, 95.9455f, 143.6341f, 0, 0);
...
void func_235(var uParam0, int iParam1) // Position - 0xAEBA
{
	if (unk_0x7DE17ACDD8BA2642(uParam0->f_58[iParam1]))
...
{
	return IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_143, 22);
}
...
int func_239(var uParam0) // Position - 0xAF78
{
	if (uParam0->f_6 < 31)
...
void func_240(var uParam0, float fParam1) // Position - 0xAFB4
{
	func_241(uParam0->f_34, 7, "FMINTRO", fParam1, true);
	return;
}

void func_241(var uParam0, int iParam1, char* sParam2, float fParam3, BOOL bParam4) // Position - 0xAFCC
{
	var unk;
	...
	if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
	{
		...
		{
			unk = unk_0x97CF93A45CD8B11D(iParam1, sParam2);
		
			if (unk_0x55127F0E4EDDE886(uParam0) != unk)
			{
				unk_0x900E2CFB61F6D92B(uParam0, iParam1, sParam2, 1);
				unk_0x994076CEABE359CF(uParam0, 1);
			}
...
void func_242(var uParam0, float fParam1) // Position - 0xB04C
{
	func_241(uParam0->f_34, 6, "FMINTRO", fParam1, true);
	return;
}

void func_243(var uParam0) // Position - 0xB064
{
	int num;
	int num2;
	...
	if (!uParam0->f_296)
	{
		num = unk_0x14580F20CBCE4FA9("ss1_rd1_03");
		num2 = num;
	
		if (unk_0x9C35450854805E6E(num2))
		{
			func_9(num2);
			uParam0->f_296 = 1;
		}
...
void func_244(var uParam0) // Position - 0xB099
{
	int i;

	for (i = 0; i < 10; i = i + 1)
	{
		if (unk_0x7DE17ACDD8BA2642(uParam0->f_37[i]))
			unk_0xE9C250FA35A936C8(&uParam0->f_37[i]);
	}
...
BOOL func_245(var uParam0) // Position - 0xB0E8
{
	int i;
	...
	else
	{
		...
		if (unk_0x0CBB7C273DED26E7(joaat("G_M_Y_MexGoon_02")) && unk_0x2BBF749E555360DC("amb@world_human_leaning@male@wall@back@foot_up@idle_a") && unk_0x2BBF749E555360DC("amb@world_human_hang_out_street@male_a@base"))
		{
			for (i = 0; i < 10; i = i + 1)
			{
				if (!unk_0x7DE17ACDD8BA2642(uParam0->f_37[i]))
				{
					uParam0->f_37[i] = unk_0x69FDD9508259E5B5(4, joaat("G_M_Y_MexGoon_02"), -85.925f, -1233.407f, 27.759f, 0f, 0, 0);
					unk_0x226C3A30511D5DC4(uParam0->f_37[i], 1);
					unk_0xC5B2830898581862(uParam0->f_37[i], 1);
				
					switch (i)
					{
						case 0:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_leaning@male@wall@back@foot_up@idle_a", "idle_a", -85.925f, -1233.407f, 27.759f, 0f, 0f, 97.75f, 1000f, -1000f, -1, 1025, 0, 2, 0);
							break;
					
						case 1:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_hang_out_street@male_a@base", "base", -86.487f, -1232.985f, 28.759f, 0f, 0f, -110.5f, 1000f, -1000f, -1, 1, 0, 2, 0);
							break;
					
						case 2:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_leaning@male@wall@back@foot_up@idle_a", "idle_a", -82.139f, -1203.525f, 26.574f, 0f, 0f, 90.75f, 1000f, -1000f, -1, 1, 0, 2, 0);
							break;
					
						case 3:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_hang_out_street@male_a@base", "base", -83.539f, -1203.537f, 27.549f, 0f, 0f, -85.25f, 1000f, -1000f, -1, 1, 0, 2, 0);
							break;
					
						case 4:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_leaning@male@wall@back@foot_up@idle_a", "idle_a", -83.75f, -1197.136f, 26.471f, 0f, 0f, -174.5f, 1000f, -1000f, -1, 1, 0, 2, 0);
							break;
					
						case 5:
							unk_0xC2E3C377D893C17A(uParam0->f_37[i], -82.0542f, -1199.2643f, 26.592f, 1, 0, 0, 1);
							unk_0x692C3FDAD7DB53CC(uParam0->f_37[i], 76.8852f);
							unk_0xCBDC2B59922F92C3(uParam0->f_37[i], joaat("WEAPON_ASSAULTRIFLE"), 100, 1, 1);
							unk_0x2718E9CC165A99F6(uParam0->f_37[i], 1);
							break;
					
						case 6:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_leaning@male@wall@back@foot_up@idle_a", "idle_a", -86f, -1222.397f, 27.417f, 0f, 0f, 98.75f, 1000f, -1000f, -1, 1, 0, 2, 0);
							break;
					
						case 7:
							unk_0xC2E3C377D893C17A(uParam0->f_37[i], -85.5161f, -1205.7815f, 26.5847f, 1, 0, 0, 1);
							unk_0x692C3FDAD7DB53CC(uParam0->f_37[i], 87.5786f);
							unk_0xCBDC2B59922F92C3(uParam0->f_37[i], joaat("WEAPON_ASSAULTRIFLE"), 100, 1, 1);
							unk_0x2718E9CC165A99F6(uParam0->f_37[i], 1);
							break;
					
						case 8:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_hang_out_street@male_a@base", "base", -87.1f, -1221.762f, 28.367f, 0f, 0f, -85.25f, 1000f, -1000f, -1, 1, 0, 2, 0);
							break;
					
						case 9:
							unk_0xC4F7B29AE0A7D629(uParam0->f_37[i], "amb@world_human_hang_out_street@male_a@base", "base", -87.063f, -1222.918f, 28.417f, 0f, 0f, -45.5f, 1000f, -1000f, -1, 1, 0, 2, 0);
							break;
					}
				}
			}
...
BOOL func_246(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB4BD
{
	...
	Global_2883585 = 0;
	return func_163(sParam2, iParam4, false);
}

void func_247(var uParam0) // Position - 0xB511
{
	int i;
	var unk;
	...
	if (!IS_BIT_SET(*uParam0, 25))
	{
		for (i = 0; i < 1; i = i + 1)
		{
			...
			if (!unk_0x66599E73DBA5A850(uParam0->f_98[i]) && unk_0xFBD273FDBCF0C5BD(uParam0->f_92[i], 0))
			{
				unk_0x2718E9CC165A99F6(uParam0->f_92[i], 0);
				unk_0xC75D5CC27D850469(uParam0->f_92[i], 10f);
				unk_0xC562419B5DA3BB96(uParam0->f_98[i], uParam0->f_92[i], unk, 5f, 0, unk_0x504B9BB48D41C264(uParam0->f_92[i]), 262144, 1f, 100f);
			}
		}
...
BOOL func_248(var uParam0) // Position - 0xB5EC
{
	int i;
	var unk;
	float num;
	...
	if (unk_0x0CBB7C273DED26E7(num2))
	{
		for (i = 0; i < 1; i = i + 1)
		{
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_92[i]))
			{
				switch (i)
				{
					case 0:
				...
				uParam0->f_92[i] = unk_0xABEEDBEF2BBDF5B3(num2, unk, num, 0, 0, 0);
				unk_0xCB8DD5B44DBC2DEB(uParam0->f_92[i], 1084227584);
				unk_0x2718E9CC165A99F6(uParam0->f_92[i], 1);
				unk_0xDAF60DD724E215CF(uParam0->f_92[i], 2);
			}
		}
	}
	...
	if (unk_0x0CBB7C273DED26E7(func_249()))
	{
		for (i = 0; i < 1; i = i + 1)
		{
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_98[i]))
			{
				if (unk_0x7DE17ACDD8BA2642(uParam0->f_92[i]))
				{
					if (unk_0xFBD273FDBCF0C5BD(uParam0->f_92[i], 0))
					{
						uParam0->f_98[i] = unk_0x4FA078B1B32445FD(uParam0->f_92[i], 4, func_249(), -1, 0, 0);
						unk_0xC5B2830898581862(uParam0->f_98[i], 1);
						unk_0xC8EE2E23B410B65A(uParam0->f_92[i], 1, 1, 0);
					}
				}
			}
		}
...
var func_249() // Position - 0xB798
{
	return unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD());
}

void func_250(var uParam0) // Position - 0xB7A8
{
	int i;
	...
	{
		if (unk_0x7DE17ACDD8BA2642(uParam0->f_92[i]))
			unk_0x2728CF7242F08BD5(&uParam0->f_92[i]);
	
		if (unk_0x7DE17ACDD8BA2642(uParam0->f_98[i]))
			unk_0xE9C250FA35A936C8(&uParam0->f_98[i]);
	}
...
void func_251(var uParam0) // Position - 0xB809
{
	int i;
	...
	if (IS_BIT_SET(uParam0->f_3, 2))
	{
		...
		for (i = 0; i < 7; i = i + 1)
		{
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_104[i]))
				unk_0xE9C250FA35A936C8(&uParam0->f_104[i]);
		}
...
int func_252(var uParam0) // Position - 0xB8A7
{
	if (func_266(uParam0))
	{
...
int func_253(var uParam0) // Position - 0xB914
{
	int num;
	...
	if (!IS_BIT_SET(uParam0->f_3, 10))
	{
		...
		if (unk_0x0CBB7C273DED26E7(num))
		{
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_36))
			{
				uParam0->f_36 = unk_0x69FDD9508259E5B5(26, num, -976.6968f, -2679.8606f, 35.6049f, 138.062f, 0, 0);
...
void func_254(var uParam0, float fParam1) // Position - 0xB9DA
{
	func_241(uParam0->f_34, 5, "FMINTRO", fParam1, false);
	return;
}

void func_255(var uParam0) // Position - 0xB9F2
{
	int i;
...
void func_256(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBA30
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xBB97
{
	BOOL flag;
...
BOOL func_260(int iParam0) // Position - 0xBC23
{
...
int func_262(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xBC70
{
	int num;
...
void func_264(var uParam0) // Position - 0xBCC6
{
	int i;

	for (i = 0; i < 7; i = i + 1)
	{
		if (!unk_0x055111B11E6624FD(uParam0->f_104[i], 0))
		{
			unk_0xC7A494C74ED33C50(uParam0->f_104[i]);
			unk_0x970443E58680427C(uParam0->f_104[i], func_265(i), 0, 0, 64);
		}
	}
...
BOOL func_266(var uParam0) // Position - 0xBD95
{
	if (uParam0->f_295)
		return func_267();
	else
...
BOOL func_267() // Position - 0xBDB4
{
	return func_268(unk_0x93E99A2DBCBA9CFA());
}

BOOL func_268(var uParam0) // Position - 0xBDC4
{
...
void func_270(var uParam0, int iParam1) // Position - 0xBDF0
{
	unk_0xE0A291F406691F03(func_271(iParam1));

	if (unk_0x7DE17ACDD8BA2642(uParam0->f_49[iParam1]))
	{
		unk_0xFBD273FDBCF0C5BD(uParam0->f_49[iParam1], 0);
...
void func_273(var uParam0) // Position - 0xBF10
{
	var unk;
	int i;
...
void func_274(var uParam0) // Position - 0xBFC6
{
...
void func_275(var uParam0) // Position - 0xC020
{
	if (unk_0x7DE17ACDD8BA2642(uParam0->f_49[2]))
		if (unk_0xFBD273FDBCF0C5BD(uParam0->f_49[2], 0))
...
void func_277(var uParam0, char* sParam1, char* sParam2, var uParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9) // Position - 0xC083
{
	if (unk_0x7DE17ACDD8BA2642(uParam3))
	{
		unk_0x055111B11E6624FD(uParam3, 0);
	
		if (!unk_0xF57C1326FD40C8A7(uParam0->f_8))
			uParam0->f_8 = unk_0xDEE46CEB08617ECA("DEFAULT_ANIMATED_CAMERA", 0);
	
		uParam0->f_9 = -1;
		uParam0->f_9 = unk_0x191673E3F99212B2(fParam4, fParam7, 2);
		unk_0xA87ED500F56EB698(uParam0->f_9, uParam3, 0);
...
void func_278(var uParam0) // Position - 0xC0FE
{
...
void func_279() // Position - 0xC17D
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		unk_0x07695A0DBD6AE9F8(func_265(i), 0, 1);
	}

	return;
}

BOOL func_280(var uParam0) // Position - 0xC1A3
{
	int i;
	var unk;
	...
	if (!IS_BIT_SET(uParam0->f_3, 2))
	{
		...
		{
			uParam0->f_33 = unk_0xF19D6C0E8B56BE23(joaat("p_cs_mp_jet_01_s"), unk, 0, 0, 0);
			unk_0x73562E6072D7A39D(uParam0->f_33, 3000);
			unk_0xAD02BD8A749B79F9(uParam0->f_33, 0);
			unk_0x724FFAED1C56CE2B(uParam0->f_33, 0, 0);
			...
			for (i = 0; i < 7; i = i + 1)
			{
				if (func_283(uParam0, i))
					uParam0->f_104[i] = unk_0x69FDD9508259E5B5(26, joaat("MP_F_Freemode_01"), -1117.7778f, -1557.6249f, 3.3819f, 0f, 0, 0);
				else
					uParam0->f_104[i] = unk_0x69FDD9508259E5B5(26, joaat("MP_M_Freemode_01"), -1117.7778f, -1557.6249f, 3.3819f, 0f, 0, 0);
			
				if (func_282(uParam0, i))
				{
					!unk_0x055111B11E6624FD(unk_0xF2CFBB1105511E1A(unk_0xADCF72047FEB806E(uParam0->f_112[i])), 0);
					unk_0x52D31974082B54B1(unk_0xF2CFBB1105511E1A(unk_0xADCF72047FEB806E(uParam0->f_112[i])), uParam0->f_104[i]);
					unk_0xC7A494C74ED33C50(uParam0->f_104[i]);
				}
				else
				{
...
BOOL func_282(var uParam0, int iParam1) // Position - 0xCCDD
{
	if (uParam0->f_295 && uParam0->f_112[iParam1] != -1 && _NETWORK_IS_PLAYER_VALID(unk_0xADCF72047FEB806E(uParam0->f_112[iParam1]), false, true))
		return true;

	return false;
}

BOOL func_283(var uParam0, int iParam1) // Position - 0xCD18
{
...
BOOL func_286(var uParam0) // Position - 0xCE45
{
	int num;
	int num2;
	...
	if (unk_0x0CBB7C273DED26E7(num) && unk_0x0CBB7C273DED26E7(num2) && unk_0x56659E29BE303D7F(5, "FMINTRO") && unk_0x56659E29BE303D7F(6, "FMINTRO") && unk_0x56659E29BE303D7F(7, "FMINTRO") && unk_0x2BBF749E555360DC("mp_intro_seq@"))
	{
		if (!unk_0x7DE17ACDD8BA2642(uParam0->f_34))
		{
			unk_0xF82BC5193AF62796(-1034.0347f, -2730.4849f, 19.0565f, 3f, 1, 0, 0, 0);
			uParam0->f_34 = unk_0xABEEDBEF2BBDF5B3(num2, -1032.3224f, -2731.192f, 19.0658f, 239.2169f, 0, 0, 0);
			unk_0xA8B5836CB4C7CB8C(uParam0->f_34, 1);
			unk_0x325BA8A2EF6F869F(uParam0->f_34, 0);
			unk_0x03879CC8EF9E3635(uParam0->f_34, 1, 1, 1, 1, 1, 1, 1, 0);
		}
		else if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35))
		{
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_34, 0))
			{
				uParam0->f_35 = unk_0x69FDD9508259E5B5(26, num, -1031.6f, -2730.15f, 20.15f, 143.6341f, 0, 0);
				unk_0xD30E9CAE1FEA1C7E(uParam0->f_35, uParam0->f_34, 20000, -1, 1f, 1048592, 0);
				unk_0xC5B2830898581862(uParam0->f_35, 1);
				unk_0x226C3A30511D5DC4(uParam0->f_34, 1);
				unk_0x226C3A30511D5DC4(uParam0->f_35, 1);
...
void func_287(var uParam0) // Position - 0xD011
{
	int i;
	...
	if (!IS_BIT_SET(uParam0->f_3, 0))
	{
		...
		if (func_289(uParam0))
		{
			if (func_288(uParam0))
			{
				...
				for (i = 0; i < 8; i = i + 1)
				{
					unk_0xE0A291F406691F03(func_271(i));
				}
			
				unk_0xE0A291F406691F03(func_269());
				unk_0xECDAB41968FF21A8(&(uParam0->f_3), 0);
			}
		}
	}
...
BOOL func_288(var uParam0) // Position - 0xD0B3
{
	int num;
				...
				if (unk_0x0CBB7C273DED26E7(num))
				{
					if (unk_0x2BBF749E555360DC("MP_INTRO_SEQ@"))
					{
						if (!unk_0x055111B11E6624FD(uParam0->f_49[2], 0))
						{
							...
							uParam0->f_91 = unk_0x69FDD9508259E5B5(4, num, 226.6826f, -998.5228f, -99.9999f, 63.813f, 0, 0);
							...
							unk_0x2718E9CC165A99F6(uParam0->f_91, 1);
							unk_0xDDE449983CE7572E(uParam0->f_91, 0, 0);
...
BOOL func_289(var uParam0) // Position - 0xD2A1
{
	int num;
	var unk;
	var unk4;
	...
	if (!IS_BIT_SET(uParam0->f_2, 31))
	{
		...
		for (i = 0; i < 8; i = i + 1)
		{
			...
			if (!func_293(unk, 0f, 0f, 0f, false))
			{
				if (!unk_0x7DE17ACDD8BA2642(uParam0->f_49[i]))
				{
					num = func_271(i);
					...
					if (unk_0x9C35450854805E6E(num))
					{
						if (unk_0x0CBB7C273DED26E7(num))
						{
							uParam0->f_49[i] = unk_0xABEEDBEF2BBDF5B3(num, unk, unk4, 0, 0, 0);
							unk_0xAD02BD8A749B79F9(uParam0->f_49[i], 1);
							unk_0x24C146D70061EDE5(uParam0->f_49[i], 0f);
							unk_0x306867EE104AD281(uParam0->f_49[i], 0);
						
							if (i == 2)
							{
								unk_0xADDC2DFB04C3C0E9(uParam0->f_49[i], 4, 0, 1);
								unk_0x70B81583DCDC7F26(uParam0->f_49[i], 4, 0, 1f);
							}
		...
		for (i = 0; i < 8; i = i + 1)
		{
			...
			if (!IS_BIT_SET(uParam0->f_2, i))
				if (func_290(uParam0, i))
					unk_0xECDAB41968FF21A8(&(uParam0->f_2), i);
				else
					return false;
		
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_49[i], 0))
				if (!unk_0x180DF71528D0B43F(uParam0->f_49[i]))
					return false;
		}
...
BOOL func_290(var uParam0, int iParam1) // Position - 0xD404
{
	switch (iParam1)
	{
		case 0:
			...
			{
				if (unk_0x6BDF27AD591C4E31(uParam0->f_49[iParam1]) > 0)
				{
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 0, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 1, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 2, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 3, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 4, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 5, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 7, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 10, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 12, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 14, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 15, 4, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 23, 11, 0);
					return true;
				}
			}
			break;
		...
		case 1:
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_49[iParam1], 0))
			{
				...
				{
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 12, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 15, 3, 0);
					unk_0x3AE6D08FF755906B(uParam0->f_49[iParam1], 22, 1);
					unk_0x10A3F931EEFE03E8(uParam0->f_49[iParam1], 0);
					return true;
				}
			}
			break;
		...
		case 2:
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_49[iParam1], 0))
			{
				if (unk_0x6BDF27AD591C4E31(uParam0->f_49[iParam1]) > 0)
				{
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 0, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 4, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 14, 5, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 15, 3, 0);
					unk_0x3AE6D08FF755906B(uParam0->f_49[iParam1], 22, 1);
					unk_0x10A3F931EEFE03E8(uParam0->f_49[iParam1], 0);
					return true;
		...
		case 4:
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_49[iParam1], 0))
			{
				...
				{
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 1, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 2, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 4, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 7, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 11, 3, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 12, 2, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 13, 2, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 15, 3, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 16, 4, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 23, 5, 0);
					unk_0x3AE6D08FF755906B(uParam0->f_49[iParam1], 22, 1);
					unk_0x10A3F931EEFE03E8(uParam0->f_49[iParam1], 0);
					return true;
				}
		...
		case 5:
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_49[iParam1], 0))
			{
				if (unk_0x6BDF27AD591C4E31(uParam0->f_49[iParam1]) > 0)
				{
					...
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 1, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 2, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 3, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 4, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 6, 2, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 10, 3, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 14, 7, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 15, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 23, 5, 0);
					unk_0x3AE6D08FF755906B(uParam0->f_49[iParam1], 22, 1);
					unk_0x10A3F931EEFE03E8(uParam0->f_49[iParam1], 0);
					return true;
		...
		case 6:
			if (unk_0xFBD273FDBCF0C5BD(uParam0->f_49[iParam1], 0))
			{
				if (unk_0x6BDF27AD591C4E31(uParam0->f_49[iParam1]) > 0)
				{
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 1, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 4, 1, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 8, 0, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 14, 7, 0);
					unk_0x886F6B56E2966139(uParam0->f_49[iParam1], 23, 0, 0);
					unk_0x3AE6D08FF755906B(uParam0->f_49[iParam1], 22, 1);
					unk_0x10A3F931EEFE03E8(uParam0->f_49[iParam1], 0);
					return true;
				}
...
BOOL func_293(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xDC1D
{
	if (bParam6)
...
void func_297() // Position - 0xDDB7
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		unk_0x852EC2A7DE66202D(func_271(i));
	}

	return;
}

void func_298(var uParam0, float fParam1, int iParam2) // Position - 0xDDDC
{
	func_241(uParam0->f_92[0], 100, "FM_Intro_uber", fParam1, false);
	func_241(uParam0->f_92[1], 101, "FM_Intro_uber", fParam1, false);
	func_241(uParam0->f_92[2], 102, "FM_Intro_uber", fParam1 + iParam2, false);
	func_241(uParam0->f_92[3], 103, "FM_Intro_uber", fParam1, false);
	func_241(uParam0->f_92[4], 104, "FM_Intro_uber", fParam1, false);
	return;
}

void func_299(var uParam0, int iParam1) // Position - 0xDE4B
{
	int i;
	int num;
	...
	{
		case 14:
			func_300(uParam0, 0, -2997.1738f, 330.9234f, 14.2341f, -15.97f, &num, true);
			func_300(uParam0, 2, -2983.9001f, 423.7414f, 14.4122f, -5.25f, &num, true);
			break;
	
		case 15:
			func_300(uParam0, 1, -2622.2075f, -109.3386f, 19.2643f, 39.34f, &num, true);
			func_300(uParam0, 3, -2583.9497f, -143.6469f, 20.6224f, 48.89f, &num, true);
			func_300(uParam0, 7, -2552.1448f, -169.0495f, 19.8664f, 60.04f, &num, true);
			func_300(uParam0, 8, -2531.4744f, -174.4581f, 19.2269f, 58.09f, &num, true);
			break;
		...
		case 17:
			func_300(uParam0, 0, -2420.6177f, -232.2668f, 15.3525f, 57.71f, &num, true);
			func_300(uParam0, 2, -2399.7092f, -249.2471f, 14.9551f, 58.19f, &num, true);
			func_300(uParam0, 4, -2568.499f, -153.4655f, 20.4075f, 54.1f, &num, true);
			func_300(uParam0, 5, -2485.392f, -198.0737f, 17.5783f, 63.83f, &num, true);
			func_300(uParam0, 6, -2469.139f, -206.5518f, 17.0201f, 60.64f, &num, true);
			func_300(uParam0, 9, -2408.7327f, -238.8328f, 15.2055f, 59.84f, &num, true);
			break;
	
		case 18:
			func_300(uParam0, 1, -2146.384f, -323.4933f, 12.0429f, 14.8813f, &num, true);
			func_300(uParam0, 3, -2075.444f, -374.131f, 11.556f, 56.66f, &num, true);
			func_300(uParam0, 7, -2160.252f, -294.0829f, 12.5163f, 163.95f, &num, true);
			func_300(uParam0, 8, -2191.4287f, -335.8769f, 12.7225f, 84.71f, &num, true);
			break;
	
		case 19:
			func_300(uParam0, 0, -1833.8702f, -561.7711f, 11.0989f, 48.11f, &num, true);
			func_300(uParam0, 1, -1630.5872f, -685.6821f, 16.5351f, 58.23f, &num, true);
			func_300(uParam0, 2, -1668.738f, -662.7587f, 14.7925f, 60.52f, &num, true);
			func_300(uParam0, 3, -1564.946f, -738.6324f, 10.7672f, 68.32f, &num, true);
			func_300(uParam0, 4, -1706.5074f, -720.8959f, 9.6281f, -132.94f, &num, true);
			func_300(uParam0, 5, -1626.756f, -769.9745f, 10.2367f, -128.8f, &num, true);
			func_300(uParam0, 6, -1782.7637f, -610.5726f, 10.3008f, 52.34f, &num, true);
			func_300(uParam0, 7, -1595.258f, -733.587f, 10.8576f, 68.39f, &num, true);
			func_300(uParam0, 8, -1751.8918f, -682.1017f, 9.6795f, -134.89f, &num, true);
			func_300(uParam0, 9, -1742.0983f, -642.5658f, 9.8169f, 48.19f, &num, true);
			break;
	
		case 33:
			func_300(uParam0, 0, -934.4687f, -2716.0378f, 12.7365f, 309.2312f, &num, false);
			func_300(uParam0, 5, -975.6617f, -2733.5168f, 12.8172f, 267.4944f, &num, false);
			break;
		...
		case 36:
			func_300(uParam0, 6, -850.1183f, -2615.271f, 14.1979f, 327.7461f, &num, false);
			break;
		...
		case 38:
			func_300(uParam0, 0, -712.0925f, -1983.5159f, 25.688f, -167.99f, &num, false);
			func_300(uParam0, 1, -533.9934f, -2004.7274f, 26.9085f, 58.71f, &num, false);
			func_300(uParam0, 2, -653.3551f, -2047.7823f, 27.3566f, -112.14f, &num, false);
			func_300(uParam0, 3, -663.821f, -1934.8499f, 27.1417f, -121.65f, &num, false);
			func_300(uParam0, 4, -656.6017f, -2009.0784f, 30.0188f, -106.53f, &num, false);
			func_300(uParam0, 5, -502.696f, -2023.0684f, 26.2376f, 60.2827f, &num, false);
			func_300(uParam0, 6, -460.1447f, -2044.032f, 26.2371f, 63.9022f, &num, false);
			func_300(uParam0, 7, -624.7944f, -1960.9753f, 26.29f, 237.3848f, &num, false);
			func_300(uParam0, 8, -463.0545f, -1998.2552f, 36.6533f, 27.85f, &num, false);
			func_300(uParam0, 9, -473.4099f, -1950.2133f, 24.7576f, 37.16f, &num, false);
			func_300(uParam0, 10, -574.5834f, -1994.9f, 26.2871f, 236.0571f, &num, false);
			func_300(uParam0, 11, -546.7894f, -2012.7808f, 26.3137f, 235.9205f, &num, false);
			func_300(uParam0, 12, -584.929f, -1970.3323f, 26.2437f, 55.8826f, &num, false);
			func_300(uParam0, 13, -633.4936f, -1937.6824f, 26.2413f, 54.9911f, &num, false);
			func_300(uParam0, 14, -601.2188f, -1941.4187f, 17.4986f, 148.6622f, &num, false);
			break;
	
		case 39:
			func_300(uParam0, 4, -499.2335f, -1906.5316f, 16.3534f, 133.5751f, &num, false);
			func_300(uParam0, 9, -518.8654f, -1918.1439f, 16.3355f, 134.6305f, &num, false);
			break;
	
		case 40:
			func_300(uParam0, 3, -270.2197f, -1499.7521f, 29.4309f, -13.07f, &num, false);
			func_300(uParam0, 7, -313.1461f, -1559.5889f, 24.2966f, 145.66f, &num, false);
			func_300(uParam0, 8, -301.9485f, -1550.0525f, 25.5595f, 146.95f, &num, false);
			break;
		...
		case 43:
			func_300(uParam0, 1, 246.1231f, -238.5137f, 52.9482f, 251.5966f, &num, false);
			func_300(uParam0, 2, 214.2755f, -202.6486f, 53.5033f, 70.72f, &num, false);
			func_300(uParam0, 6, 263.1977f, -115.1292f, 69.0366f, 155.02f, &num, false);
			break;
	
		case 44:
			func_300(uParam0, 0, 392.6941f, 239.868f, 102.5932f, 159.15f, &num, false);
			func_300(uParam0, 7, 375.2224f, 192.316f, 102.0397f, 160.4247f, &num, false);
			func_300(uParam0, 12, 377.4185f, 166.3668f, 102.0407f, 337.9135f, &num, false);
			break;
	
		case 45:
			func_300(uParam0, 1, 267.8363f, 181.3352f, 103.7037f, 71.7724f, &num, false);
			func_300(uParam0, 3, 216.3894f, 211.8832f, 105.2308f, -19.82f, &num, false);
			func_300(uParam0, 4, 290.3365f, 172.6194f, 103.7313f, 67.09f, &num, false);
			func_300(uParam0, 5, 283.6507f, 155.574f, 103.264f, 252.0678f, &num, false);
			func_300(uParam0, 8, 309.5128f, 156.7439f, 103.3183f, -112.52f, &num, false);
			func_300(uParam0, 9, 249.0189f, 168.3015f, 104.5421f, -112.05f, &num, false);
			func_300(uParam0, 11, 313.7221f, 144.8591f, 102.6542f, 249.0527f, &num, false);
			func_300(uParam0, 13, 171.2032f, 216.4137f, 105.2411f, 69.1778f, &num, false);
			break;
		...
		case 47:
			func_300(uParam0, 2, 226.2312f, 176.6035f, 104.3217f, 252.5577f, &num, false);
			func_300(uParam0, 6, 247.4283f, 168.6965f, 103.9378f, 250.2977f, &num, false);
			func_300(uParam0, 7, 211.375f, 181.7446f, 104.561f, 250.2252f, &num, false);
			break;
		...
		case 49:
			func_300(uParam0, 2, -192.4192f, 249.71f, 91.7534f, -99.42f, &num, false);
			func_300(uParam0, 3, -45.3246f, 256.5581f, 105.0516f, 272.9104f, &num, false);
			func_300(uParam0, 4, -24.1551f, 272.3286f, 106.4563f, 96.6005f, &num, false);
			func_300(uParam0, 5, 6.5526f, 270.3987f, 108.268f, 84.5591f, &num, false);
			func_300(uParam0, 6, -124.1576f, 245.0871f, 96.1105f, -89.91f, &num, false);
			func_300(uParam0, 7, -140.9613f, 262.532f, 94.5308f, 87.51f, &num, false);
			func_300(uParam0, 9, -83.4766f, 247.5941f, 99.488f, 275.7796f, &num, false);
			func_300(uParam0, 10, -215.5077f, 252.4543f, 91.0469f, 264.726f, &num, false);
			break;
...
void func_300(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, var uParam6, BOOL bParam7) // Position - 0xE817
{
	if (unk_0xFBD273FDBCF0C5BD(uParam0->f_58[iParam1], 0) && !unk_0x66599E73DBA5A850(uParam0->f_74[iParam1]))
	{
		unk_0x2718E9CC165A99F6(uParam0->f_58[iParam1], 0);
		unk_0xDDE449983CE7572E(uParam0->f_58[iParam1], 1, 0);
		unk_0xC2E3C377D893C17A(uParam0->f_58[iParam1], fParam2, 1, 0, 0, 1);
		unk_0x692C3FDAD7DB53CC(uParam0->f_58[iParam1], fParam5);
		unk_0xCB8DD5B44DBC2DEB(uParam0->f_58[iParam1], 1084227584);
		unk_0x8E2A5E6443418B19(uParam0->f_58[iParam1]);
	
		if (bParam7)
		{
			unk_0x3DFE9C7902334B74(uParam0->f_74[iParam1], uParam0->f_58[iParam1], 0, 1, 35f, 786603, 5f, 5f, 1);
			unk_0xC75D5CC27D850469(uParam0->f_58[iParam1], 30f);
		}
		else
		{
			unk_0x3DFE9C7902334B74(uParam0->f_74[iParam1], uParam0->f_58[iParam1], 0, 1, 15f, 786603, 5f, 5f, 1);
			unk_0xC75D5CC27D850469(uParam0->f_58[iParam1], 10f);
		}
	
		unk_0x71A535529C1CA5DF(uParam0->f_74[iParam1], 1);
		unk_0x724FFAED1C56CE2B(uParam0->f_58[iParam1], 1, 0);
		unk_0x724FFAED1C56CE2B(uParam0->f_74[iParam1], 1, 0);
		unk_0xECDAB41968FF21A8(uParam6, iParam1);
	}

	return;
}

void func_301(var uParam0, char* sParam1, char* sParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, int iParam10) // Position - 0xE93B
{
	if (!unk_0xF57C1326FD40C8A7(uParam0->f_8))
		uParam0->f_8 = unk_0xDEE46CEB08617ECA("DEFAULT_ANIMATED_CAMERA", 0);

	uParam0->f_9 = -1;
	uParam0->f_9 = unk_0x191673E3F99212B2(fParam3, fParam6, 2);
	unk_0x5950D902D5442CB4(uParam0->f_8, uParam0->f_9, sParam1, sParam2);
	unk_0xE1549D437DEA008D(uParam0->f_9, iParam9);
...
void func_302(var uParam0) // Position - 0xE9AC
{
...
BOOL func_303(var uParam0) // Position - 0xE9DA
{
	BOOL flag;
	int i;
	...
	else
	{
		...
		if (!unk_0x7DE17ACDD8BA2642(uParam0->f_92[2]))
		{
			...
			{
				uParam0->f_92[2] = unk_0xABEEDBEF2BBDF5B3(joaat("monroe"), -2994.4165f, 435.5293f, 14.278f, 184.1746f, 0, 0, 0);
		...
		if (!unk_0x7DE17ACDD8BA2642(uParam0->f_92[3]))
		{
			if (unk_0x0CBB7C273DED26E7(joaat("cheetah")))
			{
				uParam0->f_92[3] = unk_0xABEEDBEF2BBDF5B3(joaat("cheetah"), -2992.2593f, 473.8287f, 14.5044f, 184.1746f, 0, 0, 0);
		...
		else if (unk_0xFBD273FDBCF0C5BD(uParam0->f_92[4], 0))
		{
			if (!IS_BIT_SET(uParam0->f_3, 1))
			{
				if (unk_0x6BDF27AD591C4E31(uParam0->f_92[4]) > 0)
				{
					...
					unk_0xECDAB41968FF21A8(&(uParam0->f_3), 1);
				}
				else
				{
					flag = false;
...
BOOL func_306(var uParam0) // Position - 0xEEB1
{
	int i;
	int num;
	var unk;
	...
	else
	{
		...
		if (unk_0x0CBB7C273DED26E7(joaat("asterope")) && unk_0x0CBB7C273DED26E7(joaat("sentinel")) && unk_0x0CBB7C273DED26E7(func_249()))
		{
			for (i = 0; i < 15; i = i + 1)
			{
				if (!unk_0x7DE17ACDD8BA2642(uParam0->f_58[i]))
				{
					if (i < 7)
						num = joaat("asterope");
					else
					...
					func_216(i, &unk, &unk4);
					uParam0->f_58[i] = unk_0xABEEDBEF2BBDF5B3(num, unk, unk4, 0, 0, 0);
					unk_0x7A1950259E8A78CC(uParam0->f_58[i], i);
					unk_0x226C3A30511D5DC4(uParam0->f_58[i], 1);
					unk_0xDAF60DD724E215CF(uParam0->f_58[i], 2);
					unk_0x2718E9CC165A99F6(uParam0->f_58[i], 1);
				}
			
				if (unk_0x7DE17ACDD8BA2642(uParam0->f_58[i]))
				{
					if (!unk_0x7DE17ACDD8BA2642(uParam0->f_74[i]))
					{
						uParam0->f_74[i] = unk_0x4FA078B1B32445FD(uParam0->f_58[i], 4, func_249(), -1, 0, 0);
						unk_0x226C3A30511D5DC4(uParam0->f_74[i], 1);
						unk_0xC5B2830898581862(uParam0->f_74[i], 1);
					}
				}
			}
		}
		...
		for (i = 0; i < 15; i = i + 1)
		{
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_58[i]) || !unk_0x7DE17ACDD8BA2642(uParam0->f_74[i]))
				return false;
		}
...
BOOL func_307(var uParam0, int iParam1, int iParam2) // Position - 0xF049
{
	int num;

	num = func_231(uParam0, iParam1, false);

	if (uParam0->f_293)
		if (uParam0->f_13 + num + iParam2 <= unk_0xA5E11AF0A2B928C1())
			return true;
	else if (num + iParam2 <= func_239(uParam0))
		return true;

	return false;
}

BOOL func_308(var uParam0) // Position - 0xF08F
{
	int num;
	...
	if (unk_0x0CBB7C273DED26E7(num) && unk_0x56659E29BE303D7F(8, "FMIntro"))
	{
		if (!unk_0x7DE17ACDD8BA2642(uParam0->f_48))
		{
			uParam0->f_48 = unk_0xABEEDBEF2BBDF5B3(num, unk_0x999683705B8A6ED8(8, 0f, "FMIntro"), 0f, 0, 0, 0);
			...
			unk_0x724FFAED1C56CE2B(uParam0->f_48, 0, 0);
			unk_0xE0A291F406691F03(num);
		}
	}
...
void func_309(var uParam0, int iParam1) // Position - 0xF14B
{
	if (func_307(uParam0, iParam1, 0))
		if (uParam0->f_293)
			uParam0->f_13 = unk_0xA5E11AF0A2B928C1() - func_231(uParam0, iParam1, false);
		else
			uParam0->f_291 = 1;
...
void func_310(var uParam0) // Position - 0xF182
{
	uParam0->f_13 = unk_0xA5E11AF0A2B928C1();
	return;
}

Vector3 func_311(float fParam0, float fParam1, float fParam2) // Position - 0xF192
{
...
{
	unk_0x9D0EAD95433304CA(-533.6674f, -1961.7877f, 16.82666f, -429.5074f, -1860.3097f, 22.79688f, 20.5f, 0, 0, 0);
	unk_0x9D0EAD95433304CA(224.4978f, -274.7691f, 48.879707f, 263.15814f, -170.51065f, 63.18772f, 21f, 0, 0, 0);
	return;
}
...
void func_315(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0xF239
{
	func_319();
	func_317(1);
	unk_0xCD3C8E1022864F65(1);
	unk_0x8581263F2F024518();
	func_256(true, true, true, 0, false, false, bParam2);
	func_316();
	func_208(12, true, -1);
	func_209(0);
...
void func_317(int iParam0) // Position - 0xF2FD
{
	int i;
	...
	{
		unk_0x4F6F113654DD2FF9(i, iParam0);
		func_318(i);
	}
...
BOOL func_324(int iParam0) // Position - 0xF502
{
	int num;
...
char* func_327(int iParam0, var uParam1) // Position - 0xF5A3
{
	var unk;
...
void _SET_TRANSITION_STATE(eTransitionState etsParam0) // Position - 0x12AEB
{
	int num;
	char* str;
	var unk;
	...
	if (Global_1575060)
	{
		...
		unk = unk_0x14580F20CBCE4FA9(str);
		unk2 = _STOPWATCH_GET_TIME_PASSED(&Global_2696935, true, false);
		_STOPWATCH_RESET(&Global_2696933, true, false);
		unk_0x92B68F81508EDC3A(unk, 1, num, etsParam0, 0);
	}

	if (etsParam0 == TRANSITION_STATE_MP_SWOOP_UP)
		func_334();

	Global_1574993 = etsParam0;
	return;
}
...
BOOL func_336() // Position - 0x12B8E
{
	int num;
	...
	if (Global_2684799.f_6618 && Global_2694444)
	{
		if (func_341(0))
		{
			if (func_339() && !unk_0x72474BA05A104E1E())
			{
				...
				{
					num = func_338(Global_2684799.f_6640);
				
					if (num == 24)
						return true;
				}
			
				if (IS_BIT_SET(Global_2657589[unk_0x93E99A2DBCBA9CFA() /*466*/].f_73.f_2, 26))
					return true;
			
				if (IS_BIT_SET(Global_2657589[unk_0x93E99A2DBCBA9CFA() /*466*/].f_73.f_2, 27))
					return true;
				...
				if (IS_BIT_SET(Global_4718592.f_37, 23))
					if (!_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !func_261())
						return true;
			}
		}
	}
...
BOOL func_339() // Position - 0x13174
{
	if (func_340() == 0)
		return true;
...
BOOL func_341(int iParam0) // Position - 0x13197
{
	if (func_351(unk_0x93E99A2DBCBA9CFA()) && IS_BIT_SET(Global_1950108.f_4, 22))
		return false;
	...
	if (Global_2694445 && func_349() || Global_2694445 == false)
		return true;
...
BOOL func_342() // Position - 0x132F4
{
	return func_343(unk_0x93E99A2DBCBA9CFA());
}

BOOL func_343(int iParam0) // Position - 0x13304
{
	return func_344(&(Global_2657589[iParam0 /*466*/].f_445), 0);
}

BOOL func_344(var uParam0, int iParam1) // Position - 0x1331D
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_345(int iParam0) // Position - 0x1332B
{
	var unk;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x1337A
{
...
BOOL func_351(Player plParam0) // Position - 0x133E0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_338(Global_2657589[plParam0 /*466*/].f_321.f_7) == 13;

	return false;
}

void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x13427
{
	if (unk_0xA26A9A07F761D8F8() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = unk_0x0DB7F8294D73598B();
...
var _STOPWATCH_GET_TIME_PASSED(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x13464
{
	if (unk_0xA26A9A07F761D8F8() && !useLocalTimer)
		if (!useAccurateTime)
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(eTransitionState etsParam0) // Position - 0x134AB
{
	switch (etsParam0)
	{
...
void func_366(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13A04
{
	if (func_367())
		return;

	if (func_364() == 1 || unk_0xFEE065E56A9BEF3F() || bParam0)
	{
		func_363(0);
...
BOOL func_367() // Position - 0x13A4F
{
	if (func_368())
...
BOOL func_368() // Position - 0x13A66
{
	if (Global_2694444)
...
void func_370(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0x13AF1
{
	...
	_SET_PLAYER_CONTROL_EX(unk_0x93E99A2DBCBA9CFA(), false, controlBs, 0);
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x13B80
{
	eSetPlayerControlFlags controlBs;
	BOOL flag;
	BOOL flag2;
	...
	else
	{
		...
		if (unk_0xE6DEE82DB0922DF0(plParam0) && unk_0x48DC6A21D1CAD89C(plParam0) || iParam3 == 1)
		{
			...
			if (!flag20)
			{
				...
				else if (flag14 || !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !func_261())
			...
			if (bParam1)
			{
				...
				if (!func_375(unk) && !unk_0x24405041A9F1A910(unk))
					if (!flag22)
...
BOOL func_375(var uParam0) // Position - 0x140A7
{
	int num;
...
void func_376(int iParam0, int iParam1, int iParam2) // Position - 0x140D8
{
	int num;
	int i;
...
void func_377(int iParam0, int iParam1) // Position - 0x141A8
{
	int num;
...
BOOL func_379() // Position - 0x1421C
{
...
void func_382(var uParam0) // Position - 0x1427F
{
	unk_0x992BB708B4B7A005(unk_0xF2CFBB1105511E1A(uParam0), 346, 1);
	return;
}

void func_383(var uParam0) // Position - 0x14295
{
...
void func_386(char* sParam0, char* sParam1, float fParam2, char* sParam3, int iParam4) // Position - 0x15709
{
...
void func_387(char* sParam0, char* sParam1, float fParam2, char* sParam3, int iParam4) // Position - 0x15764
{
...
void func_389(var uParam0) // Position - 0x15814
{
...
void func_390() // Position - 0x1586E
{
	...
	if (unk_0x5E6D8811A0BD0954(iLocal_536.f_3))
	{
		switch (iLocal_536.f_2)
		{
			case 2:
				if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 1))
				{
					if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
					{
						if (func_410(iLocal_536.f_3))
						{
							if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
							{
								if (unk_0xF5F493B789EA063E(unk_0xC1A5EC5C986B98AD(), joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 1 && unk_0xF5F493B789EA063E(unk_0xC1A5EC5C986B98AD(), joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 0)
									unk_0xD30E9CAE1FEA1C7E(unk_0xC1A5EC5C986B98AD(), unk_0x972B1BFB16AD20B5(iLocal_536.f_3), 20000, 2, 1f, 1, 0);
							}
							else if (!IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 2))
							{
								if (unk_0x44A6C9475C859B45(unk_0xC1A5EC5C986B98AD(), unk_0x972B1BFB16AD20B5(iLocal_536.f_3)))
								{
									unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4), 2);
									func_409(true);
								}
								else
								{
									unk_0x10DFA2EC4C030EB3(-1031.7882f, -2731.816f, 19.0546f, 50f, 0, 0, 0, 0, 0, 0, 0);
								}
							}
						}
					}
			...
			case 1:
				if (func_410(iLocal_536.f_3))
					if (!func_408(iLocal_536.f_4))
						if (IS_BIT_SET(iLocal_719, 26))
							if (unk_0xF5F493B789EA063E(unk_0x0DB8386015E986B7(iLocal_536.f_4), joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1 && unk_0xF5F493B789EA063E(unk_0x0DB8386015E986B7(iLocal_536.f_4), joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 0)
								unk_0x8005EE2134A9EB38(unk_0x0DB8386015E986B7(iLocal_536.f_4), unk_0x972B1BFB16AD20B5(iLocal_536.f_3), -663.8057f, -952.3882f, 20.2985f, 4, 15f, 802987, 5f, 5f, 0);
				break;
		
			case 3:
				if (!IS_BIT_SET(iLocal_719, 27))
				{
					if (!unk_0x72474BA05A104E1E() && !unk_0x984CA71F26DF483C())
						if (!func_125())
							if (!unk_0xFEE065E56A9BEF3F())
						...
						unk_0xECDAB41968FF21A8(&iLocal_719, 27);
				}
				else if (!IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 4))
				{
					if (func_397(-649.4202f, -954.0247f, 20.5269f, 90.7653f, true, false, false, false, true, false, 1, false, 0))
					{
						...
						unk_0xAABD7B0753C5C286(0);
						unk_0xEAB390443C680F72(0, 1065353216);
						unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3), 4);
					}
				}
				break;
			...
			case 4:
				if (!func_408(iLocal_536.f_4))
				{
					if (!IS_BIT_SET(iLocal_719, 29))
					{
						if (func_410(iLocal_536.f_3))
						{
							unk_0x267F4694BB0C680B(unk_0x0DB8386015E986B7(iLocal_536.f_4), unk_0x972B1BFB16AD20B5(iLocal_536.f_3), -664.8411f, -952.2484f, 20.283f, 92.0219f, 0, 60f, 1);
							unk_0x78DD793477D04C42(800);
							unk_0xECDAB41968FF21A8(&iLocal_719, 29);
						}
					}
					else if (!IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 5))
					{
						if (unk_0xF5F493B789EA063E(unk_0x0DB8386015E986B7(iLocal_536.f_4), joaat("SCRIPT_TASK_VEHICLE_PARK")) == 7)
							unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3), 5);
					}
				}
				break;
			...
			case 5:
				if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
				{
					...
					else if (!IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 6))
					{
						unk_0xECDAB41968FF21A8(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3), 6);
						unk_0xECDAB41968FF21A8(&(Global_2793044.f_848), 4);
						unk_0x061B1200C95204CB(&(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4), 2);
			...
			case 6:
				if (!func_408(iLocal_536.f_4))
				{
					if (func_410(iLocal_536.f_3))
					{
						if (unk_0xF5F493B789EA063E(unk_0x0DB8386015E986B7(iLocal_536.f_4), joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 1 && unk_0xF5F493B789EA063E(unk_0x0DB8386015E986B7(iLocal_536.f_4), joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 0)
						{
							unk_0x71A535529C1CA5DF(unk_0x0DB8386015E986B7(iLocal_536.f_4), 1);
							unk_0xA6B22576A5268171(unk_0x0DB8386015E986B7(iLocal_536.f_4), unk_0x972B1BFB16AD20B5(iLocal_536.f_3), 12f, 786599);
							func_392(&(iLocal_536.f_3));
							func_392(&(iLocal_536.f_4));
						}
					}
				}
				break;
		...
		if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 1))
		{
			unk_0x350F65B0612C7A16(-1614.1733f, -3243.3167f, 28.4915f, -440.9012f);
		
			if (!IS_BIT_SET(iLocal_719, 26))
				unk_0xECDAB41968FF21A8(&iLocal_719, 26);
		}
	
		if (!IS_BIT_SET(iLocal_719, 28))
		{
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 2))
			{
				if (!_STOPWATCH_IS_INITIALIZED(&uLocal_369))
				{
					func_220();
					_STOPWATCH_INITIALIZE(&uLocal_369, false, false);
				}
				else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_369, 5000, false))
				{
					if (_CONVERSATION_ADD_LINE(&uLocal_543, "MPTXIAU", "MPTXI_T1", 12, 0, 0, 1))
						unk_0xECDAB41968FF21A8(&iLocal_719, 28);
				}
			}
		}
	
		if (!IS_BIT_SET(iLocal_719, 30))
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 5))
				if (_CONVERSATION_ADD_LINE(&uLocal_543, "MPTXIAU", "MPTXI_AR", 12, 0, 0, 1))
					unk_0xECDAB41968FF21A8(&iLocal_719, 30);
		...
		if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_4, 2))
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
				unk_0xACD39355028D39EF(unk_0xC1A5EC5C986B98AD());
	}
...
void func_395(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x15E4B
{
	int num;
	int num2;
	float num3;
...
BOOL func_397(float fParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x15F9D
{
	var unk;
	float num;
	float num2;
	...
	if (!func_404(false))
	{
		if (func_403(unk_0x93E99A2DBCBA9CFA(), true, false) && !(func_402() || func_401()))
		{
			...
			else if (func_312() == TRANSITION_STATE_POST_BINK_VIDEO_WARP)
			{
			}
			else
			{
	...
	if (!fParam0 == Global_2672505.f_1025 || !fParam0.f_1 == Global_2672505.f_1025.f_1 || !fParam0.f_2 == Global_2672505.f_1025.f_2 || !fParam3 == Global_2672505.f_1028)
	{
		...
		{
			if (unk_0x55DB5FC567C065D9(unk_0x0DB7F8294D73598B(), Global_2672505.f_1029) < func_400(false))
				return false;
	...
	if (Global_2672505.f_1023)
	{
		...
		if (Global_2672505.f_1030 > -1)
		{
			...
			if (func_398(&(Global_2672505.f_1030), fParam0, fParam3, unk))
			{
				func_405(bParam6, bParam9);
				return true;
			}
...
BOOL func_398(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x164B1
{
...
BOOL func_402() // Position - 0x165F5
{
	return IS_BIT_SET(Global_4718592.f_30, 12) && IS_BIT_SET(Global_1969892, 0);
}

BOOL func_403(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x16611
{
...
void func_405(BOOL bParam0, BOOL bParam1) // Position - 0x16679
{
	...
	if (!IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_267.f_31, 14) && !func_407())
		func_406();
...
BOOL func_407() // Position - 0x166F8
{
	if (!unk_0x1758F8A8511510AB() && !func_404(false))
		return false;
...
BOOL func_408(var uParam0) // Position - 0x1672F
{
	if (unk_0x7E2E2E8A648611F4(uParam0))
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 15))
			unk_0xECDAB41968FF21A8(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139), 15);
	else if (IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 15))
		unk_0x061B1200C95204CB(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139), 15);

	return;
}

BOOL func_410(var uParam0) // Position - 0x167AB
{
	if (unk_0x7E2E2E8A648611F4(uParam0))
...
BOOL func_411(var uParam0) // Position - 0x167CB
{
	if (unk_0x7DE17ACDD8BA2642(uParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x168C2
{
...
{
	return uLocal_708[iParam0 /*5*/];
}

int func_420(int iParam0) // Position - 0x16980
{
	return uLocal_708[iParam0 /*5*/].f_2;
}

BOOL func_421(BOOL bParam0) // Position - 0x16991
{
	if (func_423())
	{
		if (bParam0)
...
void func_424(BOOL bParam0) // Position - 0x169F5
{
	...
	if (unk_0xA26A9A07F761D8F8())
	{
		if (bLocal_725)
		{
			if (IS_BIT_SET(uLocal_708[unk_0xD378D2332270959A() /*5*/].f_3, 2))
			{
				if (!IS_BIT_SET(iLocal_719, 31))
				{
					func_32(119, 1, -1, 1);
	...
	func_219(&uLocal_62, false, bParam0);

	if (unk_0xA26A9A07F761D8F8())
		if (Global_2672505.f_3541)
			func_754(false, true, false, true);

	if (unk_0xA26A9A07F761D8F8())
		func_409(false);

	unk_0x17D46728E18012D3(uLocal_62.f_122, 0);
	unk_0x90DA349CD13C7839(-1042.9182f, -2723.1401f, 17.341135f, -1087.7639f, -2667.6052f, 25.795933f, 25.5625f, 1);
	unk_0x90DA349CD13C7839(-1005.74243f, -2734.2646f, 14.919123f, -1082.9584f, -2675.189f, 26.016474f, 39.375f, 1);
	unk_0x061B1200C95204CB(&(Global_2793044.f_848), 4);
	func_98(false);
	func_61(false);
	func_753();
	func_752(iLocal_61, false);
	_STOPWATCH_DESTROY(&(Global_2672505.f_3791));
	...
	if (flag)
	{
		func_427(false, 0, 0, false, true);
	}
	else
	{
		unk_0xCD3C8E1022864F65(1);
		func_427(false, 0, 3, true, true);
	}

	unk_0x061B1200C95204CB(&(Global_2793044.f_848), 0);
	func_415(false);
	func_414(4, false);
	func_414(1, false);
	func_414(0, false);
	...
	func_425(iLocal_536.f_5);
	return;
}

void func_425(var uParam0, var uParam1) // Position - 0x16C14
{
	if (uParam0.f_1)
		if (unk_0x3CDF9E9E483AADE1(unk_0x55DB5FC567C065D9(unk_0x0DB7F8294D73598B(), uParam0)) >= 1000)
...
void func_427(BOOL bParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x16C73
{
	int num;
	int num2;
	BOOL flag;
	...
	{
		func_728();
		func_727(true, true, true);
		func_726();
		func_725();
	
		if (num != -1)
		{
			Global_1890444[num /*129*/].f_1 = 0;
			Global_1890444[num /*129*/].f_2 = 0;
			Global_1890444[num /*129*/] = 0;
		}
	}
	...
	if (!IS_BIT_SET(Global_4718592.f_29, 1) && !func_715())
	{
	...
	TEXT_LABEL_ASSIGN_STRING(&(Global_4718592.f_113716), "", 32);
	...
	if (num != -1 && Global_2683862.f_669.f_10 != 0)
		Global_1890444[unk_0x93E99A2DBCBA9CFA() /*129*/].f_2 = Global_2683862.f_669.f_10;

	if (func_423() || num != -1 && IS_BIT_SET(Global_1853910[num /*862*/].f_861, 7))
	{
		if (!bParam4)
		{
			Global_4718592 = 2;
	...
	{
		func_709(true, Global_1926705.f_9 != 4);
		func_727(true, true, false);
		func_687(false);
		func_686();
		Global_1837306 = 0;
	...
	func_674(false);
	func_673();
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_861), 7);
	Global_1889702 = 0f;
	Global_1889703 = 0f;
	Global_1836595 = 0;
	Global_1836596 = -1;
	...
	flag2 = func_18(num);
	Global_1853910[num /*862*/].f_194 = 0;
	...
	if (unk_0xA26A9A07F761D8F8())
	{
		switch (Global_1926705.f_9)
		{
			...
			case 6:
				...
				unk_0x061B1200C95204CB(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_861), 1);
				TEXT_LABEL_ASSIGN_STRING(&(Global_2657589[unk_0x93E99A2DBCBA9CFA() /*466*/].f_226), "", 24);
			...
			case 2:
				...
				player = Global_1853910[num /*862*/].f_10;
			
				if (player != _INVALID_PLAYER_INDEX())
					if (unk_0xE6DEE82DB0922DF0(player))
						Global_2684799.f_6008 = { func_78(player) };
					else
						flag3 = true;
				else
					flag3 = true;
			
				if (flag3 && func_642() && unk_0xA9B8A7219CCBCD56() == 1)
					Global_2684799.f_6008 = { GET_LOCAL_GAMER_HANDLE() };
			...
			case 4:
				...
				{
					Global_1948305.f_17 = Global_1948305.f_17 + 1;
				}
				else if (func_337())
				{
					Global_1948392.f_18 = Global_1948392.f_18 + 1;
				}
				else if (func_617(*Global_4718592.f_113724) || func_616(*Global_4718592.f_113724) || func_614() && func_613(249))
				{
					Global_1948525.f_18 = Global_1948525.f_18 + 1;
				}
	...
	if (flag || func_721(unk_0x93E99A2DBCBA9CFA()))
	{
	...
	unk_0x061B1200C95204CB(&Global_1836105, 0);
	func_573(false);
	Global_1836373 = 0;
	Global_1836578 = -1;
	Global_1889632 = 0;
	...
	if (func_572() == false)
		if (Global_1926705.f_9 == -1 && flag2 == false)
			func_564(0);
		else
	...
	if (func_572() == false)
	{
		...
		{
			if (!func_558(Global_1853910[num /*862*/]) && !func_714() && !flag2 && !func_404(false) && !func_701() && !func_713())
			{
				func_557(true);
				iParam1 == iParam1;
			}
	...
	if (Global_1853910[num /*862*/] != -1)
	{
		iParam2 = iParam2;
	
		if (func_554(Global_1853910[num /*862*/]))
		{
			if (unk_0x67EBFCF2F78761B9())
			{
				num4 = func_529(0);
				_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_MINIGAME_END, -1);
				func_521(joaat("MPPLY_MGAME_CHEAT_END"), num4);
	...
	if (Global_1926705 == 0)
	{
		if (!flag2)
		{
			Global_1853910[num /*862*/].f_10 = -1;
			unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_861), 1);
		}
	}
	...
	{
		func_557(false);
		unk_0xECDAB41968FF21A8(&(Global_1853910[num /*862*/].f_861), 1);
		Global_1853910[num /*862*/].f_10 = func_518(unk_0x93E99A2DBCBA9CFA());
		unk_0x93DEB757E8BAAC12(0);
		func_376(0, 0, 1);
	...
	if (Global_1853910[num /*862*/] < 10 && Global_1853910[num /*862*/] != -1 && !func_404(false))
		if (!unk_0x2AC37494BBF1DB16(&(Global_1853910[num /*862*/].f_144)) && Global_1853910[num /*862*/] != 5 && Global_1853910[num /*862*/] != 148)
			func_512(&(Global_1853910[num /*862*/].f_144));

	if (Global_1853910[num /*862*/] != 6)
		Global_1926651 = 1;

	Global_1853910[num /*862*/] = -1;
	Global_1853910[num /*862*/].f_36.f_2 = -1;
	Global_1853910[num /*862*/].f_36.f_16 = -1;
	Global_1853910[num /*862*/].f_36.f_1 = -1;
	Global_4718592 = 0;

	if (!flag2)
		func_511(0);

	Global_1853910[num /*862*/].f_36.f_18 = 0;
	unk_0x061B1200C95204CB(&(Global_1853910[unk_0xD056B8CB0E6A5169() /*862*/].f_795), 0);
	...
	if (!flag2)
	{
		TEXT_LABEL_ASSIGN_STRING(&(Global_1853910[num /*862*/].f_144), str, 24);
		TEXT_LABEL_ASSIGN_STRING(&(Global_1853910[num /*862*/].f_150), str, 24);
		func_510();
	}

	TEXT_LABEL_ASSIGN_STRING(&Global_1881495[num /*16*/], str, 64);
	TEXT_LABEL_ASSIGN_STRING(&(Global_1853910[num /*862*/].f_164), str, 64);
	Global_1890444[num /*129*/].f_31 = { unk13 };
	Global_1890444[num /*129*/].f_33 = { unk13 };
	Global_1836588 = 0;
	Global_1836589 = 0;
	Global_1836113 = -1;
	flag4 = false;
	...
	else
	{
		...
		if (!IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_861, 1) && !func_741())
		{
			if (unk_0x1758F8A8511510AB())
			{
				if (func_517())
	...
	if (!func_404(false))
		TEXT_LABEL_ASSIGN_STRING(&(Global_4718592.f_113731), "", 64);

	if (func_472(116, &num5))
		func_471(num5);

	if (func_472(123, &num5))
		func_471(num5);
...
void func_428(BOOL bParam0) // Position - 0x17F6F
{
	...
	if (!func_451(unk_0x93E99A2DBCBA9CFA()) && !IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_861, 17))
		func_450();
...
void func_430(int iParam0, int iParam1, BOOL bParam2) // Position - 0x180AC
{
	int num;

	if (func_432(iParam1, bParam2))
	{
		num = func_431();
...
BOOL func_432(int iParam0, BOOL bParam1) // Position - 0x1810E
{
	if (Global_1575048)
		return false;
...
BOOL func_437() // Position - 0x1820A
{
...
void func_441(var uParam0, int iParam1) // Position - 0x182AD
{
	...
	if (IS_BIT_SET(num2, 1))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_DM_START, iParam1);
		func_521(joaat("MPPLY_DM_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 1);
		flag = true;
	}

	if (IS_BIT_SET(num2, 2))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_RACE_START, iParam1);
		func_521(joaat("MPPLY_RACE_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 2);
		flag = true;
	}

	if (IS_BIT_SET(num2, 3))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_CHAR_MC_STARTED, iParam1);
		func_521(joaat("MPPLY_MC_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 3);
		flag = true;
	}

	if (IS_BIT_SET(num2, 4))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_MINIGAME_START, iParam1);
		func_521(joaat("MPPLY_MGAME_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 4);
		flag = true;
	}

	if (IS_BIT_SET(num2, 5))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_CAPTURE_START, iParam1);
		func_521(joaat("MPPLY_CAP_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 5);
		flag = true;
	}

	if (IS_BIT_SET(num2, 6))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_SURVIVAL_START, iParam1);
		func_521(joaat("MPPLY_SUR_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 6);
		flag = true;
	}

	if (IS_BIT_SET(num2, 7))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_LTS_START, iParam1);
		func_521(joaat("MPPLY_LTS_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 7);
		flag = true;
	}

	if (IS_BIT_SET(num2, 8))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_PARACHUTE_START, iParam1);
		func_521(joaat("MPPLY_PARA_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 8);
		flag = true;
	}

	if (IS_BIT_SET(num2, 9))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_AKULA_MINI_HEADSHOTS, iParam1);
		func_521(joaat("MPPLY_HEIST_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 9);
		flag = true;
	}

	if (IS_BIT_SET(num2, 26))
	{
		_MPCHAR_STAT_INCREMENT_INT_BY_ONE(MP_STAT_FMEVENT_START, iParam1);
		func_521(joaat("MPPLY_FMEVN_CHEAT_START"), 2);
		func_521(joaat("MPPLY_ACTIVITY_STARTED"), 1);
		unk_0x061B1200C95204CB(&num2, 26);
		flag = true;
	}
	...
	{
		*uParam0 = 1;
		unk_0xFF21926417F83AB2(num2, iParam1);
	}
...
BOOL func_443() // Position - 0x18517
{
	if (func_722(unk_0x93E99A2DBCBA9CFA()) || func_721(unk_0x93E99A2DBCBA9CFA()))
...
BOOL func_449() // Position - 0x1859E
{
	BOOL num;
	int i;
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (!unk_0x2AC37494BBF1DB16(&Global_4718592.f_114039[i /*6*/]))
			num = 0;
	}
...
BOOL func_451(int iParam0) // Position - 0x185EC
{
	int num;
	...
	if (Global_1969817)
	{
		if (func_349())
		{
			if (func_457(*Global_4718592.f_166301))
			{
				...
				{
					case 1:
						unk_0x82EC7C3BD3DA9941(2947.7297f, -3860.6223f, 142.61438f, 5f, joaat("xs_combined_dyst_06_build_03"), 0);
						break;
				}
			}
			else if (func_456(*Global_4718592.f_166301))
			{
				...
				{
					case 3:
						unk_0x82EC7C3BD3DA9941(2943.7654f, -3859.6245f, 151.10071f, 5f, joaat("xs_propint3_set_waste_03_licencep"), 0);
						break;
				}
			}
			...
			else if (func_454(*Global_4718592.f_166301))
			{
				...
				{
					case 3:
						unk_0x82EC7C3BD3DA9941(2944.7256f, -3846.3835f, 140.00003f, 5f, joaat("xs_propint5_waste_09_ground_d"), 0);
						unk_0x82EC7C3BD3DA9941(2948.5894f, -3859.2585f, 145.65782f, 5f, joaat("xs_propint5_waste_09_ground_cut"), 0);
						unk_0x82EC7C3BD3DA9941(2950.4646f, -3861.078f, 149.8605f, 5f, joaat("xs_propint4_waste_09_lollywall"), 0);
						break;
				}
			}
...
{
	return IS_BIT_SET(Global_2683862.f_3, 7);
}
...
void func_466() // Position - 0x188F9
{
	...
	{
		unk.f_6 = 32;
		Global_2657589[unk_0x93E99A2DBCBA9CFA() /*466*/].f_126 = { unk };
	}
...
void func_467() // Position - 0x1892B
{
	...
	unk.f_4 = -1;
	unk.f_7 = 32;
	unk.f_79 = { Global_2672505.f_3420.f_79 };
	unk.f_95 = { Global_2672505.f_3420.f_95 };
	Global_2672505.f_3420 = { unk };
	return;
}

int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x18978
{
	var unk;
	int i;
	int num;
...
BOOL func_469(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x189DD
{
...
BOOL func_472(int iParam0, var uParam1) // Position - 0x18AEF
{
	int i;

	for (i = 0; i < 2; i = i + 1)
	{
		if (Global_2756015[i /*5*/] == iParam0)
		{
			*uParam1 = i;
			return true;
		}
...
{
	return IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 18);
}
...
void func_478() // Position - 0x18C67
{
	...
	if (num >= 0)
		unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_96.f_32), 6);
...
{
	return IS_BIT_SET(Global_2683862, 16);
}
...
{
	return IS_BIT_SET(Global_2683862.f_2, 15);
}
...
void func_510() // Position - 0x18ECC
{
	...
	num = unk_0x93E99A2DBCBA9CFA();
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 4);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 5);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 7);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 8);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 9);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 10);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 11);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 12);
	unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_11.f_1), 13);
	return;
}

void func_511(int iParam0) // Position - 0x18F82
{
...
void func_512(char* sParam0) // Position - 0x18F90
{
	...
	if (!func_514() && func_513(120, -1) && !func_404(false))
	{
		unk_0x5FC63CAE65990F70(sParam0, &unk, 13);
	
		if (unk_0x73EC603A60C832F3(&unk, 13))
			unk_0xF27423FF2D483551(&unk);
	}

	return;
}

BOOL func_513(int iParam0, int iParam1) // Position - 0x18FD5
{
	int num;
	int num2;

	num = Global_2848280[iParam0 /*3*/][func_28(iParam1)];
...
BOOL func_514() // Position - 0x19001
{
	int num;

	num = unk_0x93E99A2DBCBA9CFA();

	if (Global_1853910[num /*862*/].f_36.f_2 == 63 || Global_1853910[num /*862*/].f_36.f_2 == 62 || Global_1853910[num /*862*/].f_36.f_2 == 61)
		return true;
...
BOOL func_524(int iParam0) // Position - 0x1923A
{
	if (Global_1665487)
	{
		switch (iParam0)
...
int func_525(int iParam0) // Position - 0x192BE
{
	int num;
	int num2;
...
void _MPCHAR_STAT_INCREMENT_INT_BY_ONE(eMPStat empsParam0, int iParam1) // Position - 0x192DC
{
	int num;

	num = _MPCHAR_STAT_GET_INT(empsParam0, func_28(iParam1), 0);
	num = num + 1;

	if (!func_528(empsParam0))
		_MPCHAR_STAT_SET_INT(empsParam0, num, iParam1, 1, false);
	else
		func_527(empsParam0, num, iParam1, 1);

	return;
}

void func_527(eMPStat empsParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1931D
{
	int num;
...
BOOL func_528(eMPStat empsParam0) // Position - 0x19E4F
{
	if (Global_1665487)
	{
		switch (empsParam0)
...
void func_532(int iParam0, int iParam1) // Position - 0x1A2B5
{
	func_533(iParam0, iParam1);
	return;
}

void func_533(int iParam0, int iParam1) // Position - 0x1A2C5
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_534() // Position - 0x1A2DA
{
	if (Global_1836615 || Global_1836584 || _NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) || func_257())
		return true;

	return false;
}

BOOL func_535() // Position - 0x1A311
{
	switch (func_536())
	{
		case 15:
...
BOOL func_539(int iParam0, int iParam1) // Position - 0x1A37E
{
	return iParam0 && iParam1 != false;
}

BOOL func_540() // Position - 0x1A38D
{
...
BOOL func_541(int iParam0, int iParam1) // Position - 0x1A3B6
{
...
BOOL func_542(int iParam0) // Position - 0x1A3D6
{
	int num;
...
BOOL func_543(int iParam0) // Position - 0x1A3F9
{
	switch (iParam0)
	{
		case 131:
...
BOOL func_544() // Position - 0x1A515
{
	if (func_543(Global_2696843))
		return false;
...
BOOL func_547() // Position - 0x1A573
{
...
BOOL func_548(int iParam0) // Position - 0x1A5C3
{
	int i;

	for (i = 0; i < 11; i = i + 1)
	{
		if (iParam0 == func_549(i))
			return true;
	}
...
BOOL func_550(int iParam0) // Position - 0x1A60D
{
	int i;
...
BOOL func_552() // Position - 0x1A656
{
	return func_616(*Global_4718592.f_113724);
}

BOOL func_553() // Position - 0x1A66C
{
	return func_617(*Global_4718592.f_113724);
}

BOOL func_554(int iParam0) // Position - 0x1A682
{
	switch (iParam0)
	{
		case 15:
...
void func_557(BOOL bParam0) // Position - 0x1A74B
{
	...
	else if (IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_861, 2))
		unk_0x061B1200C95204CB(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_861), 2);

	return;
}

BOOL func_558(int iParam0) // Position - 0x1A7A8
{
...
int func_564(int iParam0) // Position - 0x1A820
{
	...
	if (iParam0 == 0)
	{
		Global_1926664 = Global_1926664 + 1;
		unk_0x26124AEC857CDC1A(unk, "quit", Global_1926664);
		unk_0x26124AEC857CDC1A(unk, "quitd", 1);
		unk_0x26124AEC857CDC1A(unk, "ply", Global_1926664.f_2);
		unk_0x26124AEC857CDC1A(unk, "lp", unk_0xD48CE560FB238316());
	}
	else if (iParam0 == 1 || iParam0 == 4)
	{
		Global_1926689.f_1 = Global_1926689.f_1 + 1;
		unk_0x26124AEC857CDC1A(unk, "quit", Global_1926689.f_1);
		unk_0x26124AEC857CDC1A(unk, "quitd", 1);
		unk_0x26124AEC857CDC1A(unk, "ply", Global_1926689.f_4);
		unk_0x26124AEC857CDC1A(unk, "lp", unk_0xD48CE560FB238316());
	}
...
BOOL func_568() // Position - 0x1A9FC
{
...
BOOL func_569() // Position - 0x1AA2C
{
	if (!func_570())
		return true;
...
BOOL func_570() // Position - 0x1AA41
{
	if (func_571())
		return false;
...
void func_577(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9) // Position - 0x1AB69
{
	if (iParam0 == 0)
		iParam0 = 1;
	...
	switch (Global_1926705.f_9)
	{
		...
		case 2:
			Global_1926705 = 1;
			Global_1926705.f_23 = { fParam1 };
			Global_1926705.f_17 = { uParam4 };
			unk_0x061B1200C95204CB(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_861), 1);
			break;
		...
		case 4:
			...
			unk_0xECDAB41968FF21A8(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_861), 1);
			break;
	...
	Global_2657589[unk_0x93E99A2DBCBA9CFA() /*466*/].f_226 = { uParam4 };
	return;
}
...
BOOL func_582() // Position - 0x1AED8
{
...
BOOL func_584() // Position - 0x1AF2C
{
...
{
	return IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_36.f_18, 24);
}
...
void func_589(int iParam0) // Position - 0x1AF85
{
	Global_1926705.f_10 = iParam0;
	return;
}
...
int func_590() // Position - 0x1AF95
{
	...
	player2 = unk_0x93E99A2DBCBA9CFA();

	for (i = 0; i < 32; i = i + 1)
	{
		player = unk_0xADCF72047FEB806E(i);
	
		if (unk_0xE6DEE82DB0922DF0(player) && player != player2)
		{
			unk = { func_78(player) };
		
			if (unk_0x7A033258C83D54CA(&unk, &(Global_2684799.f_6624)) && func_592(player))
			{
				func_591();
				return 1;
			}
...
BOOL func_592(Player plParam0) // Position - 0x1B032
{
	return IS_BIT_SET(Global_1853910[plParam0 /*862*/].f_36.f_18, 9);
}
...
BOOL func_612(var uParam0) // Position - 0x1B231
{
	int i;

	for (i = 0; i < 6; i = i + 1)
	{
		if (Global_262145.f_5059[i] == uParam0)
			return true;
	}
...
BOOL func_613(int iParam0) // Position - 0x1B260
{
	int num;
	int num2;
...
BOOL func_614() // Position - 0x1B291
{
	return func_615(*Global_4718592.f_113724);
}

BOOL func_615(var uParam0) // Position - 0x1B2A7
{
	int i;
...
BOOL func_616(var uParam0) // Position - 0x1B2D6
{
	int i;
...
BOOL func_619(int iParam0) // Position - 0x1B363
{
	int i;
...
BOOL func_622() // Position - 0x1B3B9
{
	return IS_BIT_SET(Global_1574942, 4);
}
...
void func_628(int iParam0) // Position - 0x1B46D
{
	Global_1926705.f_5 = 1;
	Global_1926705.f_11 = iParam0;
	return;
}

BOOL func_629(int iParam0) // Position - 0x1B484
{
	int i;
...
BOOL func_630(int iParam0) // Position - 0x1B4D1
{
	int i;
...
BOOL func_631() // Position - 0x1B51D
{
	if (IS_BIT_SET(Global_4718592.f_18, 0))
		return true;

	return func_638(*Global_4718592.f_113724, true) || func_637(*Global_4718592.f_113724) || func_636(*Global_4718592.f_113724) || func_635(*Global_4718592.f_113724) || func_634(*Global_4718592.f_166301) || func_633(*Global_4718592.f_166301) || func_632(*Global_4718592.f_166301);
}
...
BOOL func_635(int iParam0) // Position - 0x1B5E2
{
	int i;
...
BOOL func_636(int iParam0) // Position - 0x1B62F
{
	int i;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0x1B71A
{
	var unk;
...
void func_641(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1B769
{
	if (unk_0x2AC37494BBF1DB16(&uParam0))
		return;
...
void func_643(int iParam0) // Position - 0x1B79C
{
	if (unk_0xA26A9A07F761D8F8())
	{
...
void func_644(BOOL bParam0) // Position - 0x1B7B6
{
	if (Global_2764621 != bParam0)
		Global_2764621 = bParam0;
...
int func_648(int iParam0) // Position - 0x1B80B
{
	...
	{
		num = _MPCHAR_STAT_GET_INT(func_650(iParam0), -1, 0);
...
void func_649(int iParam0, int iParam1) // Position - 0x1B84F
{
	...
	_MPCHAR_STAT_SET_INT(func_650(iParam0), iParam1, -1, 1, false);
	return;
}

eMPStat func_650(int iParam0) // Position - 0x1B870
{
	switch (iParam0)
	{
		case 0:
...
void func_652(int iParam0, int iParam1) // Position - 0x1B89E
{
...
BOOL func_656() // Position - 0x1B907
{
...
void func_660() // Position - 0x1B961
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		Global_2684799.f_1.f_845[i /*57*/].f_44 = 0;
...
int func_661() // Position - 0x1B99F
{
	...
	unk_0xD4EE6AD36FDB6F7E(0);
	unk = unk_0xCCD4212BA2F7884E(0);
	Global_1926664.f_2 = Global_1926664.f_2 + 1;
	...
	unk_0x26124AEC857CDC1A(unk, "quit", Global_1926664);
	unk_0x26124AEC857CDC1A(unk, "ply", Global_1926664.f_2);
	unk_0x26124AEC857CDC1A(unk, "plyd", 1);
	unk_0x26124AEC857CDC1A(unk, "lp", unk_0xD48CE560FB238316());
...
BOOL func_665(int iParam0) // Position - 0x1BAA1
{
	switch (func_19())
	{
		case 0:
...
void func_670(int iParam0) // Position - 0x1BB35
{
...
BOOL func_679(var uParam0) // Position - 0x1BC4D
{
	int num;
	int num2;

	num = unk_0xAC464F61BE9FD50D(uParam0, 5);
	num2 = -1;
	...
	switch (unk_0x504B9BB48D41C264(uParam0))
	{
		case joaat("MP_M_Freemode_01"):
			...
			num2 = unk_0xFC680D6CC972AEFB(uParam0, 5, num, unk_0xEDEBC30DEBDF84C8(uParam0, 5));
		
			if (unk_0x7FEA86016BC12607(num2, joaat("PARACHUTE"), 0))
				return 1;
			break;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1BD1D
{
	if (iParam2 == -1)
		iParam2 = func_29();
...
void func_683(BOOL bParam0, int iParam1) // Position - 0x1BD5A
{
	...
	if (bParam0)
	{
		func_684(&Global_23270.f_6103[num /*10*/]);
...
void func_684(var uParam0) // Position - 0x1BE18
{
	if (uParam0->f_9 != 0)
	{
...
BOOL func_685(var uParam0, BOOL bParam1, int iParam2) // Position - 0x1BE44
{
	var unk;
	int num;
	int i;
...
void func_687(BOOL bParam0) // Position - 0x1BEE9
{
	var unk;
	int i;
	var unk43;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		unk43 = Global_1926731[i /*42*/].f_3;
		Global_1926731[i /*42*/] = { unk };
	
		if (func_741())
			Global_1926731[i /*42*/].f_3 = unk43;
	
		Global_1926731[i /*42*/].f_1 = _INVALID_PLAYER_INDEX();
		Global_1926731[i /*42*/] = -1;
		Global_1926731[i /*42*/].f_2 = -1;
	}

	if (!func_741() && !func_701() && bParam0)
	{
...
BOOL func_688() // Position - 0x1BFB6
{
	int i;

	for (i = 0; i < 32; i = i + 1)
	{
		if (Global_1926731[i /*42*/].f_1 != _INVALID_PLAYER_INDEX())
			if (Global_1926731[i /*42*/].f_11 > 0)
				return true;
	}
...
BOOL func_690(int iParam0) // Position - 0x1C01B
{
	int i;
...
void func_691(BOOL bParam0) // Position - 0x1C055
{
	...
	if (!bParam0)
	{
		unk.f_18 = Global_1948592.f_18;
		unk.f_29 = Global_1948592.f_29;
		unk.f_30 = Global_1948592.f_30;
		unk.f_35 = Global_1948592.f_35;
		unk.f_27 = Global_1948592.f_27;
		unk = Global_1948592;
		unk.f_1 = Global_1948592.f_1;
		unk.f_2 = Global_1948592.f_2;
		unk.f_3 = Global_1948592.f_3;
		unk.f_4 = Global_1948592.f_4;
		unk.f_5 = Global_1948592.f_5;
		unk.f_6 = Global_1948592.f_6;
		unk.f_32 = Global_1948592.f_32;
	}
...
void func_692(BOOL bParam0) // Position - 0x1C0ED
{
	...
	if (!bParam0)
	{
		unk.f_37 = Global_1948392.f_37;
		unk.f_33 = Global_1948392.f_33;
		unk.f_30 = Global_1948392.f_30;
		unk.f_39 = Global_1948392.f_39;
		unk.f_20 = Global_1948392.f_20;
		unk.f_15 = Global_1948392.f_15;
		unk.f_35 = Global_1948392.f_35;
		unk.f_36 = Global_1948392.f_36;
		unk.f_31 = Global_1948392.f_31;
		unk.f_34 = Global_1948392.f_34;
		unk.f_27 = Global_1948392.f_27;
		unk.f_28 = Global_1948392.f_28;
		unk.f_32 = Global_1948392.f_32;
		unk.f_29 = Global_1948392.f_29;
		unk.f_77 = Global_1948392.f_77;
	}
...
void func_693(BOOL bParam0) // Position - 0x1C19D
{
	...
	if (!bParam0)
	{
		unk.f_2 = { Global_1948305.f_2 };
		unk.f_14 = Global_1948305.f_14;
		unk.f_19 = Global_1948305.f_19;
		unk.f_23 = Global_1948305.f_23;
		unk.f_25 = Global_1948305.f_25;
		unk.f_30 = Global_1948305.f_30;
		unk.f_26 = Global_1948305.f_26;
		unk.f_27 = Global_1948305.f_27;
		unk.f_28 = Global_1948305.f_28;
		unk.f_29 = Global_1948305.f_29;
		unk.f_31 = Global_1948305.f_31;
		unk.f_32 = Global_1948305.f_32;
		unk.f_33 = Global_1948305.f_33;
		unk.f_40 = Global_1948305.f_40;
		unk.f_42 = Global_1948305.f_42;
		unk.f_50 = Global_1948305.f_50;
		unk.f_46 = Global_1948305.f_46;
		unk.f_51 = Global_1948305.f_51;
	}
...
void func_696(var uParam0, int iParam1) // Position - 0x1C561
{
	int num;
...
{
	return IS_BIT_SET(Global_2683862.f_43.f_4, 8);
}
...
void func_708(BOOL bParam0) // Position - 0x1C723
{
	if (!func_701() || bParam0)
	{
		Global_1837303 = 0;
...
void func_709(BOOL bParam0, BOOL bParam1) // Position - 0x1C745
{
	...
	for (i = 0; i <= 13; i = i + 1)
	{
		Global_2683862.f_43.f_430[i] = 0;
		Global_2683862.f_43.f_445[i] = 0;
		Global_2683862.f_43.f_475[i /*6*/] = { unk };
		Global_2683862.f_43.f_460[i] = 0;
	}
	...
	if (bParam0)
	{
		...
		if (bParam1)
		{
			...
			for (i = 0; i < 5; i = i + 1)
			{
				Global_2683862.f_43.f_589[i] = -1;
				Global_2683862.f_43.f_595[i] = -1;
			}
		
			Global_2683862.f_43.f_55 = 0;
			Global_2683862.f_43.f_12 = { unk };
...
void func_711() // Position - 0x1C9CD
{
	...
	unk = unk_0x6869576A83390221();
	unk2 = unk_0x3CDF9E9E483AADE1(unk_0x55DB5FC567C065D9(Global_1057161, unk_0x0DB7F8294D73598B()));
	unk_0xE9E3903AA22C2091(Global_4718592, &(Global_4718592.f_114011), unk, unk2, Global_1057161.f_1);
	func_712();
	return;
}
...
BOOL func_715() // Position - 0x1CA56
{
...
int func_723(var uParam0) // Position - 0x1CAFD
{
	if (uParam0 == Global_262145.f_5042[0])
		return 0;
	else if (uParam0 == Global_262145.f_5042[1])
		return 1;
	else if (uParam0 == Global_262145.f_5042[2])
		return 2;
	else if (uParam0 == Global_262145.f_5042[3])
		return 3;
	else if (uParam0 == Global_262145.f_5042[4])
		return 4;
	else if (uParam0 == Global_262145.f_5042[5])
		return 5;
	else if (uParam0 == Global_262145.f_5042[6])
		return 6;
	else if (uParam0 == Global_262145.f_5042[7])
		return 7;
	else if (uParam0 == Global_262145.f_5042[8])
		return 8;
	else if (uParam0 == Global_262145.f_5042[9])
		return 9;
	else if (uParam0 == Global_262145.f_5042[10])
		return 10;
	else if (uParam0 == Global_262145.f_5042[11])
		return 11;
	else if (uParam0 == Global_262145.f_5042[12])
		return 12;
	else if (uParam0 == Global_262145.f_5042[13])
		return 13;
	else if (uParam0 == Global_262145.f_5042[14])
		return 14;
	else if (uParam0 == Global_262145.f_5042[15])
		return 15;
...
void func_727(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1CCBF
{
	var unk;

	Global_2683862.f_669.f_3 = { unk };
	...
	if (bParam0)
	{
		...
		if (bParam2 && !unk_0x1758F8A8511510AB())
		{
			Global_1926731.f_1347 = 0;
			Global_1926731.f_1348 = 0;
		}
...
BOOL func_730() // Position - 0x1CDAB
{
...
BOOL func_739() // Position - 0x1CEB3
{
	if (func_740() != 2)
		return false;
...
void func_743(BOOL bParam0) // Position - 0x1CF29
{
	...
	if (num != -1)
		if (bParam0)
			if (!IS_BIT_SET(Global_1853910[num /*862*/].f_199, 0))
				unk_0xECDAB41968FF21A8(&(Global_1853910[num /*862*/].f_199), 0);
		else if (IS_BIT_SET(Global_1853910[num /*862*/].f_199, 0))
			unk_0x061B1200C95204CB(&(Global_1853910[num /*862*/].f_199), 0);
...
{
	Global_2672505.f_1684.f_816 = _INVALID_PLAYER_INDEX();
	return;
}
...
void func_750(int iParam0) // Position - 0x1D030
{
	...
	unk.f_2 = 3;
	unk.f_28 = 4;
	Global_1944061.f_5[iParam0 /*53*/] = { unk };
	return;
}
...
void func_754(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1D0CF
{
	func_227();
	...
	func_256(false, true, true, 0, false, bParam2, false);
	func_760();
	func_208(12, false, -1);
	func_209(1);
	unk_0xE927736B0094B990(0, -1);
	...
	if (func_125() == false && func_758() == false && bParam1 && !func_260(unk_0x93E99A2DBCBA9CFA()) && !unk_0x58A962BEF2DDE1DF() && func_339())
		_SET_PLAYER_CONTROL_EX(unk_0x93E99A2DBCBA9CFA(), true, 0, 0);
...
void func_755() // Position - 0x1D1A1
{
	...
	if (unk_0xA26A9A07F761D8F8() && _STOPWATCH_IS_INITIALIZED(&Global_2802588))
	{
		if (!_STOPWATCH_HAS_TIME_PASSED(&Global_2802588, 3500, true) || unk_0xD451220300531739(unk_0x93E99A2DBCBA9CFA()))
		{
			if (!func_757())
			{
				if (unk_0x72474BA05A104E1E())
				...
				else if (!_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0))
				{
...
{
	if (IS_BIT_SET(Global_2802592, iParam0) && unk_0xA26A9A07F761D8F8())
	{
		if (!_STOPWATCH_HAS_TIME_PASSED(&Global_2802593[iParam0 /*2*/], 3500, true) || unk_0xD451220300531739(iParam0))
		{
			if (!func_757())
			{
				if (unk_0x72474BA05A104E1E())
				{
					_STOPWATCH_RESET(&Global_2802593[iParam0 /*2*/], true, false);
				}
				else if (!_NETWORK_IS_PLAYER_IN_SCTV(iParam0, 0))
				{
					unk_0x0EF6003F5941AD7E(iParam0, 1);
				
					if (!unk_0x055111B11E6624FD(unk_0xF2CFBB1105511E1A(iParam0), 0))
						unk_0x312E265D2DE9D3DD(unk_0xF2CFBB1105511E1A(iParam0), 255, 0);
				}
			}
			else
			{
		...
		{
			if (!unk_0x055111B11E6624FD(unk_0xF2CFBB1105511E1A(iParam0), 0))
				unk_0x70E20EBF87C51C88(unk_0xF2CFBB1105511E1A(iParam0));
		
			_STOPWATCH_DESTROY(&Global_2802593[iParam0 /*2*/]);
			unk_0x061B1200C95204CB(&Global_2802592, iParam0);
		}
	}
...
BOOL func_757() // Position - 0x1D37A
{
...
BOOL func_758() // Position - 0x1D398
{
...
void func_761(BOOL bParam0) // Position - 0x1D40B
{
	...
	num = func_797(unk_0x93E99A2DBCBA9CFA(), bParam0);
	num2 = func_795(num, bParam0);
	...
	if (!func_780(1))
	{
		func_773(func_774(59, false, false), false);
		func_771(func_774(135, false, false), true);
		func_770(func_774(22, false, false), func_774(73, false, false));
	}
	else
	{
	...
	if (func_766() || func_765())
	{
		...
		if (unk_0xA26A9A07F761D8F8())
		{
			func_762(28, true, false);
			func_762(29, true, false);
			func_762(30, true, false);
			func_762(31, true, false);
			func_762(32, true, false);
			func_762(33, true, false);
			func_762(34, true, false);
			func_762(35, true, false);
			func_762(36, true, false);
			func_762(37, true, false);
			func_762(38, true, false);
			func_762(58, true, false);
		}
	}

	if (func_774(21, false, false))
...
void func_762(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D5CC
{
	if (bParam1)
	{
...
void func_763(int iParam0) // Position - 0x1D68B
{
	...
	{
		func_65(iParam0, 10, true);
		func_65(iParam0, 19, true);
	}
...
void func_767(BOOL bParam0) // Position - 0x1D9F3
{
	...
	func_762(28, bParam0, false);
	func_762(30, bParam0, false);
	func_762(31, bParam0, false);
	func_762(33, bParam0, false);
	func_762(34, bParam0, false);
	func_762(38, bParam0, false);
	func_762(58, bParam0, false);
	return;
}
...
void func_768(BOOL bParam0) // Position - 0x1DA45
{
	...
	func_762(29, bParam0, false);
	func_762(32, bParam0, false);
	func_762(36, bParam0, false);
	func_762(35, bParam0, false);
	func_762(37, bParam0, false);
	return;
}

BOOL func_769() // Position - 0x1DA85
{
	if (!func_799())
		return false;
...
void func_770(BOOL bParam0, BOOL bParam1) // Position - 0x1DA9A
{
	...
	func_762(0, bParam0, true);
	func_762(1, bParam0, true);
	func_762(2, bParam0, true);
	func_762(3, bParam0, true);
	func_762(4, bParam0, true);
	func_762(5, bParam0, true);
	func_762(6, bParam0, true);
	func_762(7, bParam0, flag);
	func_762(8, bParam0, true);
	func_762(9, bParam0, true);
	func_762(10, bParam0, true);
	func_762(11, bParam0, true);
	func_762(12, bParam0, flag);
	func_762(13, bParam0, true);
	func_762(21, bParam0, true);
	func_762(14, bParam0, true);
	func_762(15, bParam0, true);
	func_762(16, bParam0, true);
	func_762(17, bParam0, true);
	func_762(18, bParam0, true);
	func_762(19, bParam0, true);
	func_762(20, bParam0, true);
	func_762(22, bParam0, true);
	func_762(23, bParam0, true);
	func_762(24, bParam0, true);
	func_762(25, bParam0, true);
	func_762(26, bParam0, true);
	func_762(27, bParam0, true);
	func_414(1, !bParam1);
...
void func_771(BOOL bParam0, BOOL bParam1) // Position - 0x1DBC2
{
	...
	if (Global_262145.f_63 == 1 && func_774(135, false, false))
		bParam0 = true;

	if (!bParam0 || bParam0 && flag)
		func_762(44, bParam0, false);
...
BOOL func_772(BOOL bParam0) // Position - 0x1DC48
{
	int num;
	...
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_2793044.f_1819, 26))
		{
			num = _MPCHAR_STAT_GET_INT(MP_STAT_FM_NON_MISS_HELP_TEXT, -1, 0);
...
void func_773(BOOL bParam0, BOOL bParam1) // Position - 0x1DCA3
{
	...
	flag = func_772(false);
	func_762(39, bParam0, false);
	func_762(40, bParam0, false);
	func_762(41, bParam0, false);

	if (!bParam0 || bParam0 && flag)
	{
		func_762(43, bParam0, false);
		func_762(42, bParam0, false);
	}
...
BOOL func_774(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1DD54
{
	int num;
	int num2;
...
BOOL func_775() // Position - 0x1DEBF
{
	int num;
...
BOOL func_776(int iParam0, int iParam1) // Position - 0x1DF1F
{
	if (!func_769())
		return false;
...
BOOL func_777(var uParam0, int iParam1) // Position - 0x1DF5F
{
	int num;
	int num2;
	int num3;
...
BOOL func_780(int iParam0) // Position - 0x1E164
{
	return false;
}
...
void func_781(int iParam0, BOOL bParam1) // Position - 0x1E16D
{
	...
	if (iParam0 != -1)
	{
		...
		num2 = num / 32;
		num = num % 32;
		unk_0xECDAB41968FF21A8(&Global_1836844[num2], num);
	}

	return;
}

BOOL func_782() // Position - 0x1E206
{
	int num;
...
void func_783(BOOL bParam0) // Position - 0x1E23B
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 25))
		{
			func_784(unk_0x93E99A2DBCBA9CFA(), 12);
			unk_0xECDAB41968FF21A8(&(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139), 25);
		}
	}
	else if (IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_139, 25))
	{
...
int func_785(var uParam0, int iParam1) // Position - 0x1E2C1
{
	int num;
	int num2;
	int num3;
	...
	{
		unk_0xECDAB41968FF21A8(&uParam0->[num2], num3);
		return 1;
	}
...
BOOL func_786(int iParam0) // Position - 0x1E2F9
{
	if (func_766())
		return true;
	...
	return IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_139, 25);
}

BOOL func_787() // Position - 0x1E325
{
	int num;

	if (IS_BIT_SET(Global_2793044.f_1824, 6))
		return true;
...
{
	return IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_143, 7);
}

BOOL func_789() // Position - 0x1E39C
{
	if (Global_1574612)
		return true;
...
BOOL func_791(int iParam0) // Position - 0x1E3DC
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 130:
			num2 = iParam0;
			num2 = num2 % 32;
			num = _MPCHAR_STAT_GET_INT(func_792(iParam0), -1, 0);
...
eMPStat func_792(int iParam0) // Position - 0x1E60B
{
	int num;
	...
	{
		case 0:
			return MP_STAT_FM_ACT_PHN;
	
		case 1:
			return MP_STAT_FM_ACT_PH2;
	
		case 2:
			return MP_STAT_FM_ACT_PH3;
	
		case 3:
			return MP_STAT_FM_ACT_PH4;
	
		case 4:
			return MP_STAT_FM_ACT_PH5;
	
		case 5:
			return MP_STAT_FM_ACT_PH6;
	
		case 6:
			return MP_STAT_FM_ACT_PH7;
	
		case 7:
			return MP_STAT_FM_ACT_PH8;
	
		case 8:
			return MP_STAT_FM_ACT_PH9;
...
BOOL func_794(int iParam0) // Position - 0x1E982
{
	if (Global_1574612)
		return true;
...
BOOL func_799() // Position - 0x1EAF6
{
	if (Global_1574612)
		return true;
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x1EB26
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1EBAA
{
	switch (func_19())
	{
		case 0:
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x1EBEC
{
...
void func_806(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x1EC1C
{
	int num;

	unk_0xCF50389093DECE87(2, 0, uParam0.f_16);
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	unk_0xAC5E62CB7808A363(&iLocal_536, 7, 0);
	unk_0x10BF12101F9D80A4(&uLocal_708, 11, 0);
	...
	unk_0x9D0EAD95433304CA(-1005.74243f, -2734.2646f, 14.919123f, -1082.9584f, -2675.189f, 26.016474f, 39.375f, 0, 0, 0);
	func_809();
	func_807();
	uLocal_708[unk_0xD378D2332270959A() /*5*/] = 0;
	return;
}
...
void func_808(int iParam0, int iParam1) // Position - 0x1ED56
{
	int num;
	int num2;
...
void func_809() // Position - 0x1EDE7
{
	...
	unk_0x195020A03AE6C628(0, 17.0693f, -1115.9354f, 28.7968f, 0);
	unk_0xF2CFC6EC8C85FA78(uLocal_721);
	return;
}

BOOL _NETWORK_WAIT_FOR_HOST_BROADCAST_DATA() // Position - 0x1EE19
{
	int num;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x1EE72
{
	int i;
