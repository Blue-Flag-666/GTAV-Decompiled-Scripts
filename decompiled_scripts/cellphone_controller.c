...
BOOL func_16() // Position - 0xBA9
{
	...
	if (func_22(FRONTEND_CONTROL, Global_20467, 0) && !HUD::IS_HUD_COMPONENT_ACTIVE(HUD_WEAPON_WHEEL) && !MISC::IS_STUNT_JUMP_IN_PROGRESS())
	{
		if (MISC::IS_PC_VERSION())
		{
		...
		if (HUD::THEFEED_GET_LAST_SHOWN_PHONE_ACTIVATABLE_FEED_ID() == Global_22902 && HUD::THEFEED_GET_LAST_SHOWN_PHONE_ACTIVATABLE_FEED_ID() != -1)
		{
			...
			while (func_20(FRONTEND_CONTROL, Global_20467) && iLocal_74 < 250 && Global_20712 == 0 && !HUD::IS_HUD_COMPONENT_ACTIVE(HUD_WEAPON_WHEEL))
			{
				if (Global_9074 > 0)
					func_17();
			...
			if (func_20(FRONTEND_CONTROL, Global_20467) && Global_20712 == 0 && !HUD::IS_HUD_COMPONENT_ACTIVE(HUD_WEAPON_WHEEL))
				iLocal_75 = 1;
...
void func_32(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x1E20
{
					...
					if (i == Global_8377[num /*15*/].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							else if (Global_8377[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_32(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
...
BOOL func_39(Player plParam0) // Position - 0x25F0
{
	Player player;
	var gamerHandle;
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x26C9
{
	var gamerHandle;
...
BOOL IS_XBOX_PLATFORM() // Position - 0x26E0
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x26F6
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x2982
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x29BF
{
...
Hash func_51(eCharacter echParam0) // Position - 0x29E4
{
...
void func_53() // Position - 0x2A1A
{
	...
	if (Global_22906 != 0)
	{
		if (PED::IS_PEDHEADSHOT_VALID(Global_22906))
		{
			...
			{
				TEXT_LABEL_ASSIGN_STRING(&string1, PED::GET_PEDHEADSHOT_TXD_STRING(Global_22906), 64);
	...
	{
		TEXT_LABEL_ASSIGN_STRING(&string1, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286 /*104*/].f_17 /*29*/].f_7)), 64);
		Global_22914[Global_4542286] = 0;
	}
	...
	if (Global_4541037[Global_4542286 /*104*/].f_32 == 4 || Global_4541037[Global_4542286 /*104*/].f_32 == 5 || Global_4541037[Global_4542286 /*104*/].f_32 == 6 || Global_4541037[Global_4542286 /*104*/].f_32 == 7 || Global_4541037[Global_4542286 /*104*/].f_32 == 8 || Global_4541037[Global_4542286 /*104*/].f_32 == 9 || Global_4541037[Global_4542286 /*104*/].f_32 == 10 || Global_4541037[Global_4542286 /*104*/].f_32 == 11)
	{
		...
		TEXT_LABEL_ASSIGN_STRING(&sender, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	else
	{
		...
		if (Global_4541037[Global_4542286 /*104*/].f_17 == 145)
		{
			...
			TEXT_LABEL_APPEND_STRING(&sender2, &Global_9058, 64);
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&sender3, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286 /*104*/].f_17 /*29*/].f_3)), 64);
...
void func_55() // Position - 0x30E1
{
	if (IS_BIT_SET(Global_8370, 1))
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			uLocal_51[Global_20500] = NETWORK::GET_NETWORK_TIME();
			uLocal_41[Global_20500] = 1;
		}
		else if (!IS_BIT_SET(Global_8370, 10))
		{
			uLocal_46[Global_20500] = MISC::GET_GAME_TIMER();
			uLocal_41[Global_20500] = 1;
		}
		else
		{
...
void func_58() // Position - 0x321D
{
	...
	{
		TEXT_LABEL_ASSIGN_STRING(&string1, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912 /*104*/].f_17 /*29*/].f_7)), 64);
	...
	if (Global_113810.f_14144[Global_22912 /*104*/].f_32 == 4 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 5 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 6 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 7 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 8 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 9 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 10 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 11 || Global_113810.f_14144[Global_22912 /*104*/].f_32 == 12)
	{
		...
		while (num < num2)
		{
			switch (Global_113810.f_14144[Global_22912 /*104*/].f_32)
			{
				...
				case 12:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1936022[num /*4*/]);
					break;
			}
		...
		TEXT_LABEL_ASSIGN_STRING(&sender, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	else
	{
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&sender3, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912 /*104*/].f_17 /*29*/].f_3)), 64);
...
void func_61() // Position - 0x3946
{
	if (uLocal_41[Global_20500] == 1)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_61 = NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), uLocal_51[Global_20500]);
		}
		else
		{
			uLocal_56[Global_20500] = MISC::GET_GAME_TIMER();
...
BOOL func_70(Player plParam0) // Position - 0x4498
{
	return func_71(plParam0, 20);
}

BOOL func_71(Player plParam0, int iParam1) // Position - 0x44A8
{
...
var func_73(Player plParam0) // Position - 0x44C9
{
...
int func_99(int iParam0) // Position - 0x566F
{
	...
	if (interiorFromEntity == 0)
		...
		return 9;
	else if (interiorFromEntity == Global_112780 || interiorFromEntity == Global_112781 && func_107(67))
		return 9;
...
void func_100(int iParam0) // Position - 0x5A97
{
	...
	for (i = 0; i <= 19 - 1; i = i + 1)
	{
		Global_112782[i] = INTERIOR::GET_INTERIOR_AT_COORDS(func_101(i));
	}
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x941F
{
...
Hash func_129(int iParam0, int iParam1) // Position - 0x9BAD
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_130(iParam1));
}
