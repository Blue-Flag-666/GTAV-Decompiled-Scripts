...
BOOL func_18(var uParam0, var uParam1) // Position - 0xB49
{
	...
	{
		if (!Global_78819)
			func_26(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 5, &iLocal_389, &uLocal_387, "DIVING_TITLE" /*Piece Collected~s~*/, "DIVING_COLLECT" /*~1~/30 submarine pieces collected.*/);
...
int func_28(int iParam0) // Position - 0x15D3
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_113648.f_10051.f_108, func_31(func_32(iParam0), i)))
				outValue = outValue + 1;
		}
	}
	else if (iParam0 == 6)
...
void func_53() // Position - 0x1F3B
{
	...
	switch (iLocal_411)
	{
		case 0:
			...
			else if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veLocal_409) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
			{
		...
		case 1:
			...
			if (!func_60())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veLocal_409))
				{
					if (!HUD::DOES_BLIP_EXIST(blLocal_410))
						blLocal_410 = func_54(veLocal_409, false, false);
				
					VEHICLE::SET_VEHICLE_ENGINE_ON(veLocal_409, false, true, false);
				
					if (VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(veLocal_409)))
						if (!ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(veLocal_409))
							VEHICLE::SET_BOAT_ANCHOR(veLocal_409, true);
...
void func_57() // Position - 0x212A
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veLocal_409))
	{
		...
		if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(veLocal_409))
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&veLocal_409);
	}
...
BOOL func_60() // Position - 0x21E6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veLocal_409))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_409, false))
				return true;
		}
		else if (func_61())
		{
...
void func_62() // Position - 0x22A1
{
	...
	if (func_24(&uLocal_42, &iLocal_55, entityCoords, &iLocal_388))
	{
		...
		if (distanceBetweenCoords > 200f)
		{
			...
			else if (HUD::DOES_BLIP_EXIST(blLocal_390))
			{
				HUD::REMOVE_BLIP(&blLocal_390);
			}
		}
		else
		{
			...
			if (uLocal_42.f_1.f_4 < uLocal_42.f_1.f_3)
			{
				if (bLocal_406)
				{
					...
					if (func_61())
						AUDIO::PLAY_SOUND_FROM_COORD(iLocal_408, "SINGLE_BLIP_FROM_BOAT", vector, "ABIGAIL_SONAR_SOUNDSET", false, 0, false);
					else
						AUDIO::PLAY_SOUND_FROM_COORD(iLocal_408, "SCRIPT_TRIGGERED_FROM_PROP", entityCoords, "ABIGAIL_SONAR_SOUNDSET", false, 0, false);
				}
				else
				{
					...
					else
					{
						...
						{
							if (HUD::DOES_BLIP_EXIST(uLocal_393[i]))
								HUD::SET_BLIP_SCALE(uLocal_393[i], fLocal_403);
						}
					}
...
void func_64() // Position - 0x263A
{
	...
	if (HUD::DOES_BLIP_EXIST(blLocal_392))
		HUD::REMOVE_BLIP(&blLocal_392);

	for (i = 0; i <= 3; i = i + 1)
	{
		if (HUD::DOES_BLIP_EXIST(uLocal_393[i]))
			HUD::REMOVE_BLIP(&uLocal_393[i]);
	}
...
void func_69() // Position - 0x278C
{
	...
	for (i = 0; i < 30; i = i + 1)
	{
		iLocal_55[i /*11*/].f_3 = { func_23(i) };
		iLocal_55[i /*11*/].f_10 = 0;
	}

	iLocal_55[0 /*11*/].f_6 = { -16.4f, 78.53f, -146.67f };
	iLocal_55[1 /*11*/].f_6 = { 0f, 45f, 10f };
	iLocal_55[2 /*11*/].f_6 = { 0.72f, 65.2f, -50.26f };
	iLocal_55[3 /*11*/].f_6 = { 0f, 15f, -132.16f };
	iLocal_55[4 /*11*/].f_6 = { 166.37f, -40f, 168.81f };
	iLocal_55[5 /*11*/].f_6 = { 90f, 56.2f, 90f };
	iLocal_55[6 /*11*/].f_6 = { -20f, 0f, 89.95f };
	iLocal_55[7 /*11*/].f_6 = { 4.08f, 54.9f, -65.35f };
	iLocal_55[8 /*11*/].f_6 = { 174.15f, -58.2f, -144.66f };
	iLocal_55[9 /*11*/].f_6 = { -28.22f, 36.11f, -90.22f };
	iLocal_55[10 /*11*/].f_6 = { -5f, 44f, 65f };
	iLocal_55[11 /*11*/].f_6 = { 0f, -108f, 45.36f };
	iLocal_55[12 /*11*/].f_6 = { -10.9f, 43.12f, 131.52f };
	iLocal_55[13 /*11*/].f_6 = { 12.37f, 49.66f, 126.88f };
	iLocal_55[14 /*11*/].f_6 = { 4.35f, 10.22f, 27.51f };
	iLocal_55[15 /*11*/].f_6 = { 0f, 10f, 60.73f };
	iLocal_55[16 /*11*/].f_6 = { 150.56f, -78.67f, -174.35f };
	iLocal_55[17 /*11*/].f_6 = { 0f, 50f, 46.41f };
	iLocal_55[18 /*11*/].f_6 = { 6.26f, 44.65f, 8.88f };
	iLocal_55[19 /*11*/].f_6 = { 90f, 78.5f, 16.04f };
	iLocal_55[20 /*11*/].f_6 = { -1.36f, 6.53f, -70.94f };
	iLocal_55[21 /*11*/].f_6 = { -61.86f, 78.61f, 126.5f };
	iLocal_55[22 /*11*/].f_6 = { -10f, -80.71f, 69.7f };
	iLocal_55[23 /*11*/].f_6 = { -76.43f, -70.02f, 29.74f };
	iLocal_55[24 /*11*/].f_6 = { -28f, -70f, 107.53f };
	iLocal_55[25 /*11*/].f_6 = { 4.19f, 6.46f, 110.43f };
	iLocal_55[26 /*11*/].f_6 = { -3.19f, 60.6f, 25f };
	iLocal_55[27 /*11*/].f_6 = { 0f, -81.68f, -20.16f };
	iLocal_55[28 /*11*/].f_6 = { 7.39f, 44.52f, 19.65f };
	iLocal_55[29 /*11*/].f_6 = { 89.74f, 80.95f, 151.74f };
	return;
}
...
void func_75(BOOL bParam0) // Position - 0x2D13
{
	...
	if (bParam0)
	{
		if (func_77(&(uLocal_42.f_1)) || func_17(110) == true)
			func_76(27);
