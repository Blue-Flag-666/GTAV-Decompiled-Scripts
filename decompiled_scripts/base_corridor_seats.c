...
{
	return unk_0x9DC9E896F189AAA5(uParam0, 355.60925f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.999474f, 15f, 0, 1, 0);
}
...
BOOL func_70() // Position - 0x17F9
{
	if (Global_1853753 != _INVALID_PLAYER_INDEX())
	{
		if (unk_0x269C91515A1405D5("base_corridor_seats", Global_1853753, 1, 0))
			return false;
