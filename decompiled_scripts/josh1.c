...
void main() // Position - 0x0
{
	...
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		...
		func_298(&uLocal_83, false, true);
		Global_78804 = 0;
	}

	if (func_297(PLAYER::PLAYER_PED_ID()))
		hLocal_328 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_83.f_28[0], hLocal_328);
...
void func_1() // Position - 0x17C
{
	switch (iLocal_145)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(obLocal_147))
				{
					...
					obLocal_147 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), true, false, true);
				}
		...
		case 1:
			...
			if (!bLocal_160)
			{
				if (func_297(uLocal_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_147))
				{
					iLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_150, uLocal_153, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(uLocal_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_149))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_149) > 0.29f)
				{
					if (!bLocal_161)
					{
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_163, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.1068f, 290.4275f, 62.9487f, -1102.038f, 291.34207f, 66.278946f, 2f, false, true, 0))
				{
					...
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					{
						TASK::CLEAR_PED_TASKS(uLocal_83.f_28[0]);
						_DEBUG_PRINT("Stopping Josh?");
					}
				
					if (ENTITY::DOES_ENTITY_EXIST(obLocal_147))
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(obLocal_147, -8f, true);
				
					iLocal_162 = 1;
				}
			
				if (func_218(uLocal_83.f_28[0], PLAYER::PLAYER_PED_ID(), true) > 17.5f)
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_83.f_28[0], -8f, true);
						TASK::CLEAR_PED_TASKS(uLocal_83.f_28[0]);
					}
				...
				if (PED::IS_PED_INJURED(uLocal_83.f_28[0]) || FILES::GET_DLC_VEHICLE_FLAGS(uLocal_83.f_28[0]) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uLocal_83.f_28[0], true), 5f))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_83.f_28[0], -8f, true);
		...
		case 2:
			func_298(&uLocal_83, false, false);
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
			{
				...
				TASK::TASK_PERFORM_SEQUENCE(uLocal_83.f_28[0], iLocal_146);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_146);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_83.f_28[0], false);
			
				if (iLocal_162 == 0)
					PED::FORCE_PED_MOTION_STATE(uLocal_83.f_28[0], joaat("MotionState_Walk"), false, 0, true);
			}
...
int func_34(Hash hParam0) // Position - 0x1B3F
{
	switch (hParam0)
	{
...
int func_35(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1B7A
{
	int i;
	int j;
	int k;
...
void func_36(Hash hParam0, int iParam1, int iParam2) // Position - 0x238B
{
	int num;
	int num2;
...
BOOL func_37(Hash hParam0, int iParam1, int iParam2) // Position - 0x2415
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(Hash hParam0, int iParam1, int iParam2) // Position - 0x24F3
{
	Global_78341[1 /*14*/] = { func_84(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_78341[1 /*14*/].f_6, 2);
}

BOOL func_39(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x251B
{
	var unk;
	int i;
...
BOOL func_40(Hash hParam0, int iParam1, int iParam2) // Position - 0x2B1F
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_41(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2BB8
{
	int i;
	int j;
...
int func_42(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x2C59
{
	int num;
...
int func_43(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2F60
{
	int num;
	int num2;
	int num3;
...
int func_45(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3DF7
{
	int num;
...
int func_46(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x40BF
{
	int i;
	int num;
...
BOOL func_47(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x40F6
{
	int num;
...
BOOL func_48(Hash hParam0, int iParam1, var uParam2) // Position - 0x411F
{
	*uParam2 = -99;
...
int func_49(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x43E9
{
	int num;
...
int func_50(Hash hParam0, int iParam1, int iParam2) // Position - 0x4673
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x47CA
{
	int num;
...
BOOL func_52(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x4864
{
	switch (hParam0)
	{
...
Hash func_53(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4932
{
	var outProp;
	int componentId;
	int num;
...
int func_54(Hash hParam0, int iParam1) // Position - 0x4A4C
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_55(Hash hParam0) // Position - 0x4DF3
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_56(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x4E54
{
	Hash entityModel;
...
int func_57(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x4F50
{
	Hash entityModel;
...
int func_58(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x508E
{
	var unk;
	Ped i;
	Ped ped;
...
int func_59(Hash hParam0) // Position - 0x5149
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_60(ePedComponentType epctParam0) // Position - 0x51A8
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_61(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x522E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x54AB
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x58D0
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x5BC3
{
	int pedPropIndex;
...
int func_65(Ped pedParam0, int iParam1) // Position - 0x5C0A
{
...
int func_66(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5C6A
{
	ePedComponentType componentId;
...
void func_68(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5D6D
{
	int num;
	int offset;
	eMPStat stat;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5DB7
{
	Hash statName;
...
BOOL func_72(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5E58
{
...
BOOL func_75(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9554
{
	int num;
...
ePedComponentType func_76(int iParam0) // Position - 0x95FF
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_77(Hash hParam0, int iParam1) // Position - 0x96AF
{
	int i;
	var unk;
...
void func_78(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9FDE
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_80(Hash hParam0, int iParam1) // Position - 0xA150
{
	int i;
	var unk;
...
void func_81(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xBF98
{
	int num;
	Hash itemHash;
...
struct<14> func_84(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC2A5
{
	func_148();
...
BOOL func_91(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE5FE
{
	int num;
	int num2;
	eMPStat stat;
...
void func_94(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE71F
{
	int num;
	int num2;
	Hash hash;
...
BOOL func_149(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1FBBB
{
	Hash entityModel;
	int num;
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1FE14
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1FE51
{
...
Hash func_152(eCharacter echParam0) // Position - 0x1FE76
{
...
void func_154(const char* sParam0, int iParam1) // Position - 0x1FE91
{
...
void func_162(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x205D3
{
...
int func_205(const char* sParam0, int iParam1) // Position - 0x2722A
{
	int num;
	const char* str;
	Hash hashKey;
...
float func_218(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x27854
{
...
BOOL func_223(Player plParam0) // Position - 0x27C68
{
	return func_224(plParam0, 20);
}

BOOL func_224(Player plParam0, int iParam1) // Position - 0x27C78
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x27F5D
{
...
void func_237(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x28069
{
	...
	func_238(false, true, false, false, false, false, false);
...
void func_238(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28113
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_242(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_239() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0x2827A
{
	BOOL flag;
...
BOOL func_242(Player plParam0) // Position - 0x28306
{
...
int func_244(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x28353
{
	int num;
...
void func_247() // Position - 0x283B5
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Josh", uLocal_83.f_28[0], 0);
	}
	...
	switch (iLocal_145)
	{
		case 0:
			if (func_263(1, 1093140480, 0))
			{
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_83.f_28[0], "Josh", 0, 0, 0);
				...
				if (func_262(playersLastVehicle))
				{
				...
				func_252(-1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, unk, num, 3f, 6f, 3f, true, true, true, false, false);
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!bLocal_160)
				{
					...
					func_248(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, true);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					{
						iLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_150, uLocal_153, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(uLocal_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						_DEBUG_PRINT("Done Josh leadout anim on Josh exit state");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_147);
						PED::FORCE_PED_MOTION_STATE(uLocal_83.f_28[0], joaat("MotionState_Idle"), false, 1, true);
						bLocal_160 = true;
					}
				}
			}
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!bLocal_160)
				{
					...
					{
						iLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_150, uLocal_153, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(uLocal_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
...
BOOL func_248(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28A3C
{
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x28C56
{
...
void func_251(BOOL bParam0) // Position - 0x28C69
{
	...
	func_238(true, true, false, false, false, false, false);
	return;
}
...
void func_253(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28CD2
{
	Vehicle playersLastVehicle;
	BOOL flag;
	BOOL flag2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false))
		{
			...
			else
			{
				...
				if (entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)
					if (func_257(playersLastVehicle, vParam0, vParam3, fParam6))
						flag = true;
			}
			...
			if (bParam16)
				if (func_255(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL func_255(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x290F2
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_256(echParam1, i, &garageName, &num); i = i + 1)
	{
...
BOOL func_257(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29239
{
	float num;
	var unk3;
	var unk6;
...
void func_260(Vehicle veParam0) // Position - 0x29622
{
...
BOOL func_262(Vehicle veParam0) // Position - 0x296A7
{
...
BOOL func_268(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x2984B
{
	if (func_297(pedParam0))
...
BOOL func_269(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2987E
{
...
void func_270(Vehicle veParam0) // Position - 0x29A16
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
			...
			if (!_IS_MISSION_REPEAT_ACTIVE(false))
			{
				if (!bLocal_156)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, false, true, 0))
					{
						if (func_297(uLocal_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_147))
						{
							iLocal_148 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_150, uLocal_153, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(uLocal_83.f_28[0], iLocal_148, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_147, iLocal_148, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
							TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_83.f_28[0], -1, 0, 2);
							TASK::TASK_LOOK_AT_ENTITY(uLocal_83.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, SLF_EXTEND_YAW_LIMIT | 8 | 2048, 2);
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_148))
				{
					...
					if (func_218(PLAYER::PLAYER_PED_ID(), uLocal_83.f_28[0], true) <= 2.5f)
					{
...
void func_273() // Position - 0x29DE7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			if (func_269(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, false, true, false))
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_282(Global_78814, Global_78816, iParam10) };
				y == -0.014f;
...
float func_281(const char* sParam0) // Position - 0x2A2C9
{
...
BOOL func_291(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2A6B1
{
	...
	switch (Global_78813)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_278(0) || func_292(true))
			{
			}
			else
			{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x2AA06
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
BOOL func_297(Ped pedParam0) // Position - 0x2AA27
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
		if (!PED::IS_PED_INJURED(pedParam0))
			return true;
...
void func_301(Vehicle* pveParam0, BOOL bParam1) // Position - 0x2AD17
{
	var unk;
	float num;
	...
	func_302(pveParam0, hLocal_81, unk, num);
...
void func_302(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x2AD8B
{
	func_303(pveParam0);
...
void func_303(Vehicle* pveParam0) // Position - 0x2ADCD
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_304(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2AE69
{
	if (func_305(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_305(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2AEC5
{
	Hash model;

	if (!func_153(echParam1))
	{
		model = func_348(echParam1);
...
void func_312() // Position - 0x2B079
{
	...
	func_324(&uLocal_83.f_28[0], true, 1, 1);
...
void func_316(Object* pobParam0, BOOL bParam1) // Position - 0x2B173
{
...
void func_317(Object* pobParam0) // Position - 0x2B1AE
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_320(Vehicle* pveParam0) // Position - 0x2B228
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_323(Ped* ppedParam0) // Position - 0x2B2B3
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_324(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x2B2F4
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_326(BOOL bParam0) // Position - 0x2B3E5
{
	...
	if (!func_343())
	{
		...
		if (bParam0)
		{
			...
			func_327(SCRIPT::GET_THIS_SCRIPT_NAME(), num);
		}
		else
		{
			if (Global_112735[num /*10*/].f_9 == -1)
...
void func_327(const char* sParam0, int iParam1) // Position - 0x2B4B5
{
	if (Global_100681 != 12)
...
BOOL func_328(const char* sParam0, int iParam1, int iParam2) // Position - 0x2B4DD
{
...
int func_332(Hash hParam0, BOOL bParam1) // Position - 0x2B710
{
	int i;
...
Hash func_348(eCharacter echParam0) // Position - 0x2BADD
{
	if (!func_153(echParam0))
