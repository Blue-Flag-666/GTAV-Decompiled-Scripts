...
void main() // Position - 0x0
{
	...
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		...
		while (!func_301(&uLocal_81))
		{
			SYSTEM::WAIT(0);
		}
	
		func_300(&uLocal_81, false, true);
		Global_78935 = 0;
	}
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_282(uLocal_81.f_9, 0, 0, 0, 0, 0);
...
void func_1() // Position - 0x17C
{
	switch (iLocal_143)
	{
		...
		case 1:
			...
			if (!bLocal_158)
			{
				if (func_299(uLocal_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_145))
				{
		...
		case 2:
			func_300(&uLocal_81, false, false);
...
Hash func_70(int iParam0, int iParam1) // Position - 0x5DD8
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(iParam1));
}

int func_71(int iParam0) // Position - 0x5DED
{
	int num;
	int num2;
...
BOOL func_73(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5E50
{
...
BOOL func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x884F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_75(int iParam0) // Position - 0x96F2
{
	if (!IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_76(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x973A
{
	int num;
...
ePedComponentType func_77(int iParam0) // Position - 0x97E5
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(Hash hParam0, int iParam1) // Position - 0x9895
{
	int i;
	var unk;
...
void func_79(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xA1C4
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA2EE
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(Hash hParam0, int iParam1) // Position - 0xA336
{
	int i;
	var unk;
...
void func_82(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xC181
{
	int num;
	Hash outfit;
...
struct<14> func_85(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC48C
{
	func_149();
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD845
{
	int num;
	int num2;
...
BOOL func_92(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE7E2
{
	int num;
	int num2;
	int num3;
...
void func_95(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE902
{
	int num;
	int num2;
	Hash outfit;
...
BOOL func_207(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x27543
{
	int num;
...
void func_208(eCharacter echParam0) // Position - 0x2765B
{
	int i;
	int num;
	int j;
...
void func_210(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x27783
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x2797E
{
	return Global_2058[character /*29*/].f_3;
}

int func_213(eCharacter echParam0, int iParam1) // Position - 0x27991
{
...
int func_214(eCharacter echParam0, int iParam1) // Position - 0x279BB
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_215(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x279E5
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_216(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x27A2A
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x27A6F
{
	if (func_93(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x27B11
{
	func_157();
	return Global_113810.f_2366.f_539.f_4321;
}

float func_219(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x27B2A
{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x27B88
{
...
BOOL func_221(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x27BD6
{
	Global_21846 = 0;
...
BOOL func_223() // Position - 0x27EDB
{
...
BOOL func_224(Player plParam0) // Position - 0x27F3E
{
	return func_225(plParam0, 20);
}

BOOL func_225(Player plParam0, int iParam1) // Position - 0x27F4E
{
	return IS_BIT_SET(Global_1895156[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x27F66
{
	return -1;
}
...
BOOL func_229() // Position - 0x28039
{
...
BOOL func_230() // Position - 0x28060
{
	int num;
	int weaponHash;
...
void func_234(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x281E0
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x28236
{
...
void func_239(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x283EB
{
	if (bParam0)
	{
...
BOOL func_241(Player plParam0, int iParam1) // Position - 0x28552
{
	BOOL flag;
...
BOOL func_243(Player plParam0) // Position - 0x285EC
{
	Player player;
...
BOOL func_244(Player plParam0) // Position - 0x2860E
{
...
int func_246(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2865B
{
	int num;
...
void _DEBUG_PRINT(char* sParam0) // Position - 0x286B1
{
	sParam0 = sParam0;
	return;
}
...
BOOL func_250(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28D44
{
...
void func_251(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x28DA0
{
	Player playerIndex;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x28F5E
{
...
void func_254(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28FB0
{
	func_255(fParam0, fParam3, fParam6, uParam7, fParam10, fParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_255(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28FDA
{
	Vehicle playersLastVehicle;
	BOOL flag;
	BOOL flag2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x293D0
{
...
BOOL func_257(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x293FA
{
	int i;
	var garageName;
	int num;
...
BOOL func_258(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x29468
{
...
BOOL func_259(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29541
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_260(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x29837
{
	float num;
	float num2;
	float num3;
...
Vector3 func_261(float fParam0, var uParam1, var uParam2) // Position - 0x298EB
{
	float num;
	float num2;
...
void func_262(Vehicle veParam0) // Position - 0x2992A
{
...
BOOL func_264(Vehicle veParam0) // Position - 0x299AF
{
...
BOOL func_265(int iParam0, int iParam1, int iParam2) // Position - 0x299D9
{
	int num;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x29AE0
{
...
BOOL func_270(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x29B53
{
...
BOOL func_271(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x29B86
{
...
void func_272(Vehicle veParam0) // Position - 0x29D1E
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_280(int iParam0) // Position - 0x2A286
{
	if (iParam0 == 1)
		if (Global_20500.f_1 > 3)
...
void func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2A2EC
{
	float num;
	int value;
	int alpha;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_284(Global_78945, Global_78947, iParam10) };
				y == -0.014f;
...
float func_283(const char* sParam0) // Position - 0x2A5D1
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (num)
			{
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_285(num), 8);
					break;
			}
			break;
...
BOOL func_293(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2A9B9
{
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_280(0) || func_294(true))
			{
			}
			else
			{
...
BOOL func_295(int iParam0) // Position - 0x2AAFA
{
	if (Global_43377 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x2AB1C
{
	return func_297(iParam0, Global_43377);
}

BOOL func_297(int iParam0, int iParam1) // Position - 0x2AB2D
{
	if (iParam1 == 15)
		return 1;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x2AD0E
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
BOOL func_299(Ped pedParam0) // Position - 0x2AD2F
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
		if (!PED::IS_PED_INJURED(pedParam0))
			return true;
...
BOOL func_301(var uParam0) // Position - 0x2AE44
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_77)
	{
		...
		case 1:
			if (!func_311(&num) || !func_309(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_306(&uParam0->f_28[0], CHAR_JOSH, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_303(&uParam0->f_35[0], true);
		
			if (!func_302(true, true))
				flag = false;
...
BOOL func_302(BOOL bParam0, BOOL bParam1) // Position - 0x2AFB1
{
	int num;
...
void func_303(Vehicle* pveParam0, BOOL bParam1) // Position - 0x2B01F
{
	var unk;
	float num;
	...
	func_304(pveParam0, hLocal_79, unk, num);
...
void func_304(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x2B093
{
	func_305(pveParam0);
...
void func_305(Vehicle* pveParam0) // Position - 0x2B0D5
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_306(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B171
{
	if (func_307(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_307(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B1CD
{
	Hash model;

	if (!func_154(echParam1))
	{
		model = func_350(echParam1);
...
int func_308(var uParam0, eCharacter echParam1) // Position - 0x2B25B
{
	int num;
...
BOOL func_309(var uParam0) // Position - 0x2B2A1
{
	if (func_310(uParam0))
	{
...
BOOL func_310(var uParam0) // Position - 0x2B2CB
{
...
BOOL func_311(var uParam0) // Position - 0x2B2F0
{
	int i;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x2B35D
{
...
void func_314() // Position - 0x2B381
{
	...
	func_326(&uLocal_81.f_28[0], true, 1, 1);
	func_315(&uLocal_81, 1, false, false);
...
void func_318(Object* pobParam0, BOOL bParam1) // Position - 0x2B47B
{
...
void func_319(Object* pobParam0) // Position - 0x2B4B6
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_322(Vehicle* pveParam0) // Position - 0x2B530
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_324(var uParam0, int iParam1) // Position - 0x2B57A
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_326(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_325(Ped* ppedParam0) // Position - 0x2B5BB
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_326(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x2B5FC
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
BOOL func_327() // Position - 0x2B64C
{
	int num;
...
void func_328(BOOL bParam0) // Position - 0x2B6ED
{
	...
	if (!func_345())
	{
		...
		if (bParam0)
		{
			...
			func_329(SCRIPT::GET_THIS_SCRIPT_NAME(), num);
		}
		else
		{
			if (Global_112897[num /*10*/].f_9 == -1)
...
void func_329(const char* sParam0, int iParam1) // Position - 0x2B7BD
{
	if (Global_100833 != 12)
...
BOOL func_330(const char* sParam0, int iParam1, int iParam2) // Position - 0x2B7E5
{
...
int func_334(Hash hParam0, BOOL bParam1) // Position - 0x2BA18
{
	int i;
...
BOOL func_335() // Position - 0x2BA4E
{
...
BOOL func_336() // Position - 0x2BA9E
{
...
BOOL func_345() // Position - 0x2BC4C
{
...
Hash func_350(eCharacter echParam0) // Position - 0x2BDE5
{
	if (!func_154(echParam0))
