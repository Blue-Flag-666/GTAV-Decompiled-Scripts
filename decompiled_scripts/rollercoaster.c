...
void main() // Position - 0x0
{
	...
	fLocal_35 = 180f;
	iLocal_38 = 3;
	hLocal_40 = joaat("prop_ld_test_01");
	...
	if (!CAM::DOES_CAM_EXIST(caLocal_930))
	{
		caLocal_930 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1652.2273f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, true, 2);
		CAM::SET_CAM_PARAMS(caLocal_930, -1652.2273f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
		CAM::SET_CAM_ACTIVE(caLocal_930, true);
	...
	if (CAM::DOES_CAM_EXIST(caLocal_930))
	{
		CAM::SET_CAM_PARAMS(caLocal_930, -1651.5007f, -1118.3954f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
	...
	if (func_56(PLAYER::PLAYER_PED_ID()) && func_56(uLocal_868.f_9))
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1648.4f, -1127.6f, 18.3f, true, false, false, true);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_868.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
		ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
	}
	...
	if (CAM::DOES_CAM_EXIST(caLocal_930))
	{
		CAM::SET_CAM_ACTIVE(caLocal_930, false);
		CAM::DESTROY_CAM(caLocal_930, false);
	}
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_14(&caLocal_893, pedBoneCoords, ENTITY::GET_ENTITY_ROTATION(uLocal_868.f_9, 2), 50f, caLocal_893.f_20, caLocal_893.f_21, 3, 1101004800, 0, 0, -1082130432, false);
		CAM::ATTACH_CAM_TO_ENTITY(caLocal_893, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, true);
	}

	SYSTEM::WAIT(0);

	if (func_56(PLAYER::PLAYER_PED_ID()) && func_56(uLocal_880.f_9))
	{
		func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_880.f_9, true), &num2, &num3, 1);
		func_9(&caLocal_893, true, true, false, false, 1045220557, false, 1065353216, false);
		CAM::SET_CAM_ROT(caLocal_893, { num3, 0f, num2 } + caLocal_893.f_14, 2);
	}
	...
	while (true)
	{
		...
		if (func_56(PLAYER::PLAYER_PED_ID()) && func_56(uLocal_880.f_9))
		{
			func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_880.f_9, true), &num2, &num3, 1);
			func_9(&caLocal_893, true, true, false, false, 1045220557, false, 1065353216, false);
			CAM::SET_CAM_ROT(caLocal_893, { num3 + (num5 * num6 * 2f), 0f, num2 + num5 } + caLocal_893.f_14, 2);
		}
...
void func_6() // Position - 0x833
{
	...
	num = SYSTEM::TO_FLOAT(MISC::ABSI(iLocal_941[iLocal_940 + 1 /*3*/] - iLocal_941[iLocal_940 /*3*/]));
...
void func_17(var uParam0) // Position - 0x123B
{
	...
	if (uParam0->f_3 >= 1f)
	{
		...
		if (uParam0->f_4[3] % iLocal_935 == 0)
			PAD::SET_CONTROL_SHAKE(PLAYER_CONTROL, iLocal_933, iLocal_934);
	}
...
void func_28(var uParam0, int iParam1, int iParam2) // Position - 0x174D
{
	...
	*uParam0 = { func_18(&uLocal_159[uParam0->f_4[0] /*3*/], &uLocal_159[uParam0->f_4[1] /*3*/], &uLocal_159[uParam0->f_4[2] /*3*/], &uLocal_159[uParam0->f_4[3] /*3*/], uParam0->f_3) };
	*uParam0 = { *uParam0 + uLocal_862 };
	uParam0->f_9 = OBJECT::CREATE_OBJECT_NO_OFFSET(hLocal_40, *uParam0, true, true, false);
...
void func_29() // Position - 0x185B
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_925[i]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_925[i], true, false);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_925[i], false, false);
			ENTITY::SET_ENTITY_COLLISION(iLocal_925[i], false, false);
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_925[i], true);
		}
	}
...
void func_35(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x2B9C
{
...
BOOL func_37(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2FBC
{
	int i;
	var garageName;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x322E
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x326B
{
...
Hash func_45(eCharacter echParam0) // Position - 0x3290
{
	return Global_2028[echParam0 /*29*/];
}

BOOL func_46(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x329F
{
	float num;
	var unk3;
	var unk6;
...
void func_48(Vehicle veParam0) // Position - 0x3649
{
...
BOOL func_49(Vehicle veParam0, Hash hParam1) // Position - 0x36AE
{
	var minimum;
	float maximum;
	var minimum2;
...
BOOL func_56(Ped pedParam0) // Position - 0x3BD5
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x3DED
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x3E0E
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

int func_61(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3E21
{
	int i;
	int j;
	int k;
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
				...
				if (IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							...
							func_81(pedParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_104(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(i), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_71(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(i), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78341[1 /*14*/] = { func_113(entityModel, i, func_70(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_71(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
...
BOOL func_62(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x4633
{
	int num;
...
int func_63(Hash hParam0) // Position - 0x46BF
{
	switch (hParam0)
	{
...
void func_64(Hash hParam0, int iParam1, int iParam2) // Position - 0x46FA
{
	int num;
	int num2;
...
BOOL func_65(Hash hParam0, int iParam1, int iParam2) // Position - 0x4784
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_66(Hash hParam0, int iParam1, int iParam2) // Position - 0x4862
{
	Global_78341[1 /*14*/] = { func_113(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_78341[1 /*14*/].f_6, 2);
}

BOOL func_67(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x488A
{
	var unk;
	int i;
...
BOOL func_68(Hash hParam0, int iParam1, int iParam2) // Position - 0x4E8E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_69(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x4F27
{
	int num;
...
int func_70(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x4FD2
{
	int i;
	int j;
...
ePedComponentType func_71(int iParam0) // Position - 0x5073
{
	switch (iParam0)
	{
		case 0:
...
int func_72(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5123
{
	int num;
...
int func_73(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x542A
{
	int num;
	int num2;
	int num3;
...
int func_75(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x62C1
{
	int num;
...
int func_76(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6588
{
	int i;
	int num;
...
BOOL func_77(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x65BF
{
	int num;
...
BOOL func_78(Hash hParam0, int iParam1, var uParam2) // Position - 0x65E8
{
	*uParam2 = -99;
...
int func_79(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x68B2
{
	int num;
...
int func_80(Hash hParam0, int iParam1, int iParam2) // Position - 0x6B3C
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_81(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x6C93
{
	int num;
...
BOOL func_82(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x6D2D
{
	switch (hParam0)
	{
...
Hash func_83(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6DFB
{
	var outProp;
	int componentId;
	int num;
...
int func_84(Hash hParam0, int iParam1) // Position - 0x6F15
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_85(Hash hParam0) // Position - 0x72BC
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_86(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x731D
{
	Hash entityModel;
...
int func_87(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x7419
{
	Hash entityModel;
...
int func_88(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x7557
{
	var unk;
	Ped i;
	Ped ped;
...
int func_89(Hash hParam0) // Position - 0x7612
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_90(ePedComponentType epctParam0) // Position - 0x7671
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
struct<10> func_91(Hash hParam0, int iParam1) // Position - 0x76F7
{
	int i;
	var unk;
...
void func_92(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x8027
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_94(Hash hParam0, int iParam1) // Position - 0x8199
{
	int i;
	var unk;
...
void func_95(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9FE1
{
	int num;
	Hash itemHash;
...
BOOL func_98(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xA2EC
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_99(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xA569
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_100(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xA98E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_101(Ped pedParam0, ePedComponentType epctParam1) // Position - 0xAC81
{
	int pedPropIndex;
...
int func_102(Ped pedParam0, int iParam1) // Position - 0xACC8
{
...
int func_103(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAD28
{
	ePedComponentType componentId;
...
void func_105(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xAE2B
{
	int num;
	int offset;
	eMPStat stat;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAE75
{
	Hash statName;

	bParam4;
	statName = Global_2805027[empsParam0 /*3*/][func_107(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0xAEE5
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805027[empsParam0 /*3*/][func_107(iParam1)];
...
BOOL func_110(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xAF22
{
...
struct<14> func_113(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE61F
{
	func_176();
...
BOOL func_120(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1097A
{
	int num;
	int num2;
	eMPStat stat;
...
void func_122(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x10A8D
{
	int num;
	int num2;
	Hash hash;
	...
	else
	{
		...
		if (componentId2 >= 0)
		{
			num5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_71(iParam0));
...
BOOL func_177(Ped pedParam0, int iParam1, int iParam2) // Position - 0x21FBC
{
	Hash entityModel;
	int num;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_177(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_78341[2 /*14*/].f_12 == j)
										if (func_177(pedParam0, 14, k))
											if (!func_67(entityModel, iParam2, 14, k, &unk, &Global_78341[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						if (!func_67(entityModel, iParam2, i, num, &unk, &Global_78341[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_71(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_71(iParam1)))
	{
		return true;
	}
...
void func_178(BOOL bParam0) // Position - 0x22215
{
	...
	func_179(true, true, false, false, false, false, false);
	return;
}

void func_179(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x22254
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_183(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_180() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0x223BB
{
	BOOL flag;
...
BOOL func_183(Player plParam0) // Position - 0x22447
{
...
int func_185(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x22494
{
	int num;
...
void func_187(BOOL bParam0) // Position - 0x224EA
{
	...
	func_227(303, 0, 0);
	func_226(&caLocal_893, false, true);
	func_225(&iLocal_931);
	func_225(&iLocal_932);
	func_56(PLAYER::PLAYER_PED_ID());
...
void func_194(int iParam0) // Position - 0x23143
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_196() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_196() /*5568*/].f_681.f_10), iParam0);
	}
...
BOOL func_215(int iParam0, int iParam1) // Position - 0x23987
{
...
void func_216(Hash hParam0, int iParam1) // Position - 0x239D8
{
	int outValue;
...
void func_220(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x23ADE
{
	...
	func_179(false, true, false, false, false, false, false);
...
BOOL func_221(Ped pedParam0) // Position - 0x23B88
{
...
Vector3 func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23BA8
{
	var groundZ;
...
void func_223() // Position - 0x23BEE
{
	...
	for (i = 0; i < iLocal_925; i = i + 1)
	{
		...
		{
			ENTITY::SET_ENTITY_HEADING(iLocal_925[i], 140f);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_925[i], true, false);
			ENTITY::SET_ENTITY_COLLISION(iLocal_925[i], true, false);
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_925[i], true);
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_925[i], true);
...
void func_224(Object* pobParam0, BOOL bParam1) // Position - 0x23D22
{
...
void func_228() // Position - 0x23EFE
{
	...
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_78558)
		{
			if (func_231() == 2 == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
