...
void func_40() // Position - 0x3117
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_42(character) && !func_41(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != character && func_42(Global_113810.f_2366.f_539.f_4321))
...
int func_61(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3E21
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_114(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_114(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_114(entityModel, 14, unk18[j], -1) };
							func_81(pedParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_104(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_71(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_114(entityModel, i, func_70(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_114(entityModel, 14, unk59[j], -1) };
			func_81(pedParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_104(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_71(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_71(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_62(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x4633
{
	...
	{
		if (!func_178(pedParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
{
	Global_78472[1 /*14*/] = { func_114(hParam0, iParam1, iParam2, -1) };
...
BOOL func_69(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x4F27
{
	...
	{
		if (!func_178(pedParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_97(&unk, -99, -99, Global_113810.f_2366.f_539.f_196[0], Global_113810.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_97(&unk, -99, -99, Global_113810.f_2366.f_539.f_196[1], Global_113810.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_97(&unk, -99, -99, Global_113810.f_2366.f_539.f_196[2], Global_113810.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
Hash func_107(int iParam0, int iParam1) // Position - 0xAE96
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_108(iParam1));
}

int func_108(int iParam0) // Position - 0xAEAB
{
	int num;
	int num2;
...
BOOL func_111(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xAF1A
{
...
BOOL func_112(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD91A
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_113(int iParam0) // Position - 0xE7BD
{
	if (!IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_114(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE805
{
	func_177();
...
void func_116(int iParam0) // Position - 0xE947
{
	...
	func_117(&Global_78472[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_117(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xFBBE
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_110(func_120(iParam1, iParam0->f_2), Global_78469);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_110(func_119(iParam1, iParam0->f_2), Global_78469);
			...
			{
				num = func_110(num2, Global_78469);
...
BOOL func_121(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x10B5B
{
	int num;
	int num2;
	int num3;
...
void func_123(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x10C6D
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_117(&Global_78472[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_117(&Global_78472[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_117(&Global_78472[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78670)
		{
			...
			func_117(&Global_78472[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_178(Ped pedParam0, int iParam1, int iParam2) // Position - 0x222E2
{
	Hash entityModel;
	int num;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_178(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_178(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_114(entityModel, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_178(pedParam0, 14, k))
											if (!func_67(entityModel, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_114(entityModel, i, num, -1) };
					
						if (!func_67(entityModel, iParam2, i, num, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_71(iParam1)) && Global_78472[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_71(iParam1)))
	{
		return true;
	}
...
void func_180(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2257A
{
	if (bParam0)
	{
...
BOOL func_182(Player plParam0, int iParam1) // Position - 0x226E1
{
	BOOL flag;
...
BOOL func_184(Player plParam0) // Position - 0x2277B
{
	Player player;
...
BOOL func_185(Player plParam0) // Position - 0x2279D
{
...
int func_187(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x227EA
{
	int num;
...
int func_191(var uParam0, int iParam1) // Position - 0x2299B
{
...
int func_192(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x22B8B
{
...
void func_196(int iParam0) // Position - 0x2349A
{
	BOOL flag;
	var txdName;
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_198() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_198() /*5568*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x23613
{
	switch (iParam0)
	{
		case 0:
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x23722
{
	if (iParam2 == -1)
		iParam2 = func_109();
...
BOOL func_201(int iParam0) // Position - 0x23760
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	return IS_BIT_SET(Global_2359296[func_198() /*5568*/].f_681.f_10, iParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x23900
{
	if (iParam1 == -1)
		iParam1 = func_109();
...
BOOL func_206(var uParam0, int iParam1) // Position - 0x23A8B
{
	int i;
	var unk;
...
void func_211(var uParam0, int iParam1) // Position - 0x23C0C
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_216(int iParam0) // Position - 0x23C82
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_217(int iParam0, int iParam1) // Position - 0x23CD2
{
...
void func_218(Hash hParam0, int iParam1) // Position - 0x23D23
{
	int outValue;
...
int func_221(eCharacter echParam0) // Position - 0x23E18
{
...
BOOL func_223(Ped pedParam0) // Position - 0x23ED3
{
...
Vector3 func_224(Ped pedParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23EF3
{
	var groundZ;
...
void func_226(Object* pobParam0, BOOL bParam1) // Position - 0x2406E
{
...
void func_227(var uParam0) // Position - 0x240A9
{
	if (*uParam0 != -1)
	{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x24753
{
