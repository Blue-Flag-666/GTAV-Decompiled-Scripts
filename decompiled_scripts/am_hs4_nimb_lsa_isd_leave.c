...
void func_6(Player plParam0) // Position - 0x345
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x414
{
	Player player;
...
BOOL func_8(Player plParam0, int iParam1) // Position - 0x474
{
	BOOL flag;
...
BOOL func_11(Player plParam0) // Position - 0x51A
{
	Player player;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x53C
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x597
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x5F5
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x63A
{
	return uParam0->f_1;
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x646
{
...
BOOL func_21(Ped pedParam0) // Position - 0xB7A
{
...
void func_22(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0xBAB
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0xC7B
{
	Hash statName;
...
BOOL func_29(Player plParam0) // Position - 0xD51
{
...
void func_37(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xE92
{
	if (bParam0)
	{
...
int func_39(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFF9
{
	int num;
...
BOOL func_47(int iParam0) // Position - 0x11DE
{
	if (iParam0 == 1)
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x1329
{
	uParam0->f_1 = 0;
	return;
}
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x1477
{
...
BOOL func_61(var uParam0) // Position - 0x14FE
{
	func_280();
...
BOOL func_62(var uParam0) // Position - 0x1561
{
	func_63();
...
void func_65(Vehicle veParam0) // Position - 0x1630
{
...
BOOL func_66(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x16CC
{
	int i;
	int num;
	Ped ped;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x17B0
{
	return -1;
}

Ped func_68(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x17B9
{
	Ped pedInVehicleSeat;
...
BOOL func_72(var uParam0) // Position - 0x1A22
{
	if (uParam0->f_20 == 0)
		return true;
...
Hash func_73() // Position - 0x1AA2
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

var func_74(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1AB2
{
	if (bParam0)
		return uParam1;
...
void func_81(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D7A
{
	Hash entityModel;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veParam0) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_137(veParam0, uParam1, bParam2, bParam3);
			...
			if (func_136(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (uParam1->f_9[44] == 2)
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2259
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_83(Hash hParam0) // Position - 0x2269
{
	return func_136(hParam0);
}

BOOL func_84(Hash hParam0) // Position - 0x2277
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_85(Vehicle veParam0) // Position - 0x237E
{
	Hash entityModel;
...
void func_86(var uParam0, var uParam1, var uParam2) // Position - 0x2409
{
	struct<5> eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x2448
{
	int address;
	int i;
	Player player;
...
BOOL func_88(int iParam0) // Position - 0x24AD
{
	int i;
...
BOOL func_90(int iParam0, int iParam1, BOOL bParam2) // Position - 0x24F8
{
	if (iParam0 == -1)
		return false;
...
Hash func_92(int iParam0, int iParam1) // Position - 0x2587
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_93(iParam1));
}

int func_93(int iParam0) // Position - 0x259C
{
	int num;
	int num2;
...
int func_98(Vehicle veParam0, Any* panParam1) // Position - 0x2CCA
{
...
BOOL func_99(Vehicle veParam0) // Position - 0x2D47
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_100(Vehicle veParam0) // Position - 0x2DD4
{
	int int;
...
BOOL func_101(var uParam0, Player plParam1) // Position - 0x2E30
{
	func_105();
	...
	func_103(*uParam0, &Global_1950733, &(Global_1950733.f_1), &(Global_1950733.f_4), &(Global_1950733.f_7), &(Global_1950733.f_10));
	...
	{
		if (func_102(uParam0, plParam1, Global_1950733, Global_1950733.f_1, Global_1950733.f_4, Global_1950733.f_7, Global_1950733.f_10, 0, Global_1950733.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1950733.f_23 == 0 && func_102(uParam0, plParam1, Global_1950733, Global_1950733.f_1, Global_1950733.f_4, Global_1950733.f_7, Global_1950733.f_10, 0, Global_1950733.f_13) || Global_1950733.f_23 != 0 && Global_1950733.f_24 == 0 && func_102(uParam0, plParam1, Global_1950733, Global_1950733.f_14, Global_1950733.f_17, Global_1950733.f_20, Global_1950733.f_10, 1, Global_1950733.f_13) || Global_1950733.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577932 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_102(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x30DB
{
...
int func_103(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3104
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_104(Global_1950759, 0f, 0f, 0f, false) && !func_104(Global_1950762, 0f, 0f, 0f, false) && !func_104(Global_1950765, 0f, 0f, 0f, false) && !(Global_1950768 == 0f))
	{
...
BOOL func_104(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x8818
{
	if (bParam6)
...
BOOL func_106(Vehicle veParam0) // Position - 0x88D8
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_107(Vehicle veParam0) // Position - 0x8910
{
	int int;
...
BOOL func_108(Vehicle veParam0, Any* panParam1) // Position - 0x8958
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
	...
	{
		num = Global_2359296[func_115() /*5568*/].f_681.f_2;
...
BOOL func_109(Vehicle veParam0) // Position - 0x8AB5
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_110(Vehicle veParam0) // Position - 0x8DB7
{
...
int func_111(Player plParam0) // Position - 0x8DE3
{
...
int func_112(Player plParam0) // Position - 0x8E00
{
...
BOOL func_113(Player plParam0, BOOL bParam1) // Position - 0x8E23
{
	if (func_11(plParam0))
...
int func_114(Player plParam0) // Position - 0x8E67
{
	if (func_11(plParam0))
		if (func_113(plParam0, false))
...
BOOL func_117(Player plParam0, BOOL bParam1) // Position - 0x8EB2
{
	return func_118(plParam0, bParam1, 1);
}

BOOL func_118(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x8EC3
{
	Player player;
...
BOOL func_119(Player plParam0, int iParam1) // Position - 0x8F20
{
	if (func_11(plParam0))
...
BOOL func_120(int iParam0, BOOL bParam1) // Position - 0x8F6F
{
	int num;
	int num2;
...
int func_123(int iParam0) // Position - 0x8FF1
{
	int num;
	int num2;
...
BOOL func_125(Player plParam0) // Position - 0x902B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_126(plParam0) && Global_2657704[plParam0 /*463*/].f_321.f_10 == plParam0)
			return true;

	return false;
}

BOOL func_126(Player plParam0) // Position - 0x9060
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0 /*463*/].f_321.f_7 != -1)
				return func_127(Global_2657704[plParam0 /*463*/].f_321.f_7) == 22;
...
void func_128(Vehicle veParam0, int iParam1) // Position - 0x955B
{
	int num;
	int num2;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0x9B06
{
	var gamerHandle;
...
BOOL func_134(Vehicle veParam0) // Position - 0x9B1B
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_136(Hash hParam0) // Position - 0x9E3D
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_137(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9EA8
{
	int num;
	int num2;
	int i;
...
Hash func_138(BOOL bParam0) // Position - 0xA59E
{
	if (bParam0)
		return -426933872;
...
BOOL func_140(int iParam0) // Position - 0xA647
{
	int num;
...
BOOL func_141(int iParam0) // Position - 0xA66B
{
	int num;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0xA689
{
...
BOOL func_144(var uParam0, int iParam1) // Position - 0xA6B5
{
	int num;
	int num2;
	int num3;
...
int func_145(var uParam0, var uParam1, var uParam2) // Position - 0xA6D8
{
	int i;
	int modType;
...
BOOL func_146(Vehicle veParam0) // Position - 0xA8B2
{
	int i;
	int modType;
	Hash hashKey;
...
int func_148(Vehicle veParam0, int iParam1) // Position - 0xA9E3
{
	int value;
	int value2;
	float num;
...
int func_149(Vehicle veParam0, int iParam1) // Position - 0xAACC
{
	int i;
...
BOOL func_150(Hash hParam0, int iParam1) // Position - 0xAB2E
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_151(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xAF0D
{
...
BOOL func_152() // Position - 0xAF31
{
	return false;
}

void func_153(Vehicle veParam0, int iParam1) // Position - 0xAF3A
{
	int vehicleMod;
...
BOOL func_154(int iParam0) // Position - 0xAFB2
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_156(Vehicle veParam0) // Position - 0xAFE3
{
	int int;
...
int func_157(var uParam0) // Position - 0xB028
{
...
BOOL func_158(int iParam0) // Position - 0xB048
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_160(Vehicle veParam0) // Position - 0xB14B
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xB1D2
{
...
Vector3 func_164(float fParam0, var uParam1, var uParam2) // Position - 0xB327
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_165(var uParam0) // Position - 0xB354
{
	Player player;
	...
	else
	{
		...
		func_166(uParam0->f_23, &Global_1887945[player /*53*/], false, -1);
	}
...
void func_166(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xB42B
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_167(Ped pedParam0, int iParam1, int iParam2) // Position - 0xB594
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_168(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xC86F
{
	Hash entityModel;
	int num;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0xD095
{
	int num;
	int num2;
...
int func_172(int iParam0) // Position - 0xD125
{
	int num;
	int num2;
...
int func_174(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xDAE9
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_175(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xEB1B
{
	Hash entityModel;
	int num;
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(20000) * Global_262145.f_2917), 0);
					break;
			
				case 1:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1400) * Global_262145.f_2918), 2);
					break;
			
				case 2:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(9750) * Global_262145.f_2919), 3);
					break;
			
				case 3:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2150) * Global_262145.f_2920), 0);
					break;
			
				case 4:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2921), 0);
					break;
			
				case 54:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12400) * Global_262145.f_2922), 1);
					break;
			
				case 5:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_262145.f_2923), 0);
					break;
			
				case 6:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2924), 2);
					break;
			
				case 55:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1350) * Global_262145.f_2925), 1);
					break;
			
				case 7:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1450) * Global_262145.f_2926), 0);
					break;
			
				case 8:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2700) * Global_262145.f_2927), 7);
					break;
			
				case 9:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1200) * Global_262145.f_2928), 0);
					break;
			
				case 10:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1500) * Global_262145.f_2929), 0);
					break;
			
				case 11:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2650) * Global_262145.f_2930), 0);
					break;
			
				case 56:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_262145.f_2931), 1);
					break;
			
				case 12:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2932), 2);
					break;
			
				case 57:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_262145.f_2933), 1);
					break;
			
				case 58:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2934), 1);
					break;
			
				case 59:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7400) * Global_262145.f_2935), 1);
					break;
			
				case 60:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2936), 1);
					break;
			
				case 17:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_262145.f_2941), 2);
					break;
			
				case 18:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2942), 2);
					break;
			
				case 19:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3600) * Global_262145.f_2943), 2);
					break;
			
				case 20:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2944), 3);
					break;
			
				case 21:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12500) * Global_262145.f_2945), 3);
					break;
			
				case 22:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2946), 3);
					break;
			
				case 23:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2947), 3);
					break;
			
				case 24:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2948), 3);
					break;
			
				case 25:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_262145.f_2949), 2);
					break;
			
				case 26:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_262145.f_2950), 3);
					break;
			
				case 27:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4800) * Global_262145.f_2951), 3);
					break;
			
				case 28:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_262145.f_2952), 3);
					break;
			
				case 61:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12350) * Global_262145.f_2953), 1);
					break;
			
				case 62:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_262145.f_2954), 1);
					break;
			
				case 63:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4500) * Global_262145.f_2955), 1);
					break;
			
				case 64:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_262145.f_2956), 1);
					break;
			
				case 65:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12300) * Global_262145.f_2957), 1);
					break;
			
				case 29:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2958), 0);
					break;
			
				case 30:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2959), 0);
					break;
			
				case 31:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2960), 0);
					break;
			
				case 66:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2961), 1);
					break;
			
				case 32:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2962), 2);
					break;
			
				case 33:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_262145.f_2963), 3);
					break;
			
				case 34:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7250) * Global_262145.f_2964), 2);
					break;
			
				case 35:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(11900) * Global_262145.f_2965), 0);
					break;
			
				case 36:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2750) * Global_262145.f_2966), 0);
					break;
			
				case 37:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1750) * Global_262145.f_2967), 0);
					break;
			
				case 38:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_262145.f_2968), 3);
					break;
			
				case 39:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3250) * Global_262145.f_2969), 2);
					break;
			
				case 40:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1000) * Global_262145.f_2970), 0);
					break;
			
				case 67:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2971), 1);
					break;
			
				case 41:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2972), 2);
					break;
			
				case 68:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2973), 1);
					break;
			
				case 42:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5050) * Global_262145.f_2974), 0);
					break;
			
				case 43:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2450) * Global_262145.f_2975), 2);
					break;
			
				case 44:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2976), 0);
					break;
			
				case 45:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2977), 0);
					break;
			
				case 46:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_262145.f_2978), 0);
					break;
			
				case 47:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1150) * Global_262145.f_2979), 3);
					break;
			
				case 48:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2980), 3);
					break;
			
				case 49:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7600) * Global_262145.f_2981), 3);
					break;
			
				case 50:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2600) * Global_262145.f_2982), 2);
					break;
			
				case 51:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2983), 3);
					break;
			
				case 52:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7450) * Global_262145.f_2984), 3);
					break;
			
				case 53:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2985), 0);
					break;
			
				case 69:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2986), 1);
					break;
			
				case 70:
					func_182(sParam0, iParam1, pedParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2987), 2);
					break;
			}
			...
			if (entityModel == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_182(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2988), 0);
						break;
				
					case 88:
						func_182(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2989), 0);
						break;
				
					case 89:
						func_182(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2990), 0);
						break;
					...
					case 13:
						func_182(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2937), 0);
						break;
				
					case 14:
						func_182(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2938), 0);
						break;
				
					case 15:
						func_182(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2939), 2);
						break;
				
					case 16:
						func_182(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2940), 0);
						break;
				
					case 71:
						func_182(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2940), 0);
						break;
				
					case 72:
						func_182(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2940), 0);
						break;
				}
			}
			else if (entityModel == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_182(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2988), 0);
						break;
				
					case 88:
						func_182(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2989), 0);
						break;
				
					case 89:
						func_182(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2990), 0);
						break;
					...
					case 14:
						func_182(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2938), 0);
						break;
				
					case 15:
						func_182(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2939), 2);
						break;
				
					case 16:
						func_182(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2940), 0);
						break;
				}
			}
			break;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x11D43
{
	int profileSetting;
...
void func_182(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x11E0D
{
	var unk;
...
BOOL func_183(Ped pedParam0, int iParam1) // Position - 0x120C2
{
...
Hash func_184(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12382
{
	var outProp;
	int componentId;
	int num;
...
int func_185(Hash hParam0, int iParam1) // Position - 0x1249C
{
	switch (hParam0)
	{
...
ePedComponentType func_186(int iParam0) // Position - 0x12843
{
	switch (iParam0)
	{
		case 0:
...
int func_187(Hash hParam0) // Position - 0x128F3
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_188(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x12954
{
	int i;
	int j;
...
int func_189(Ped pedParam0, int iParam1) // Position - 0x129F5
{
...
int func_190(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12A55
{
	ePedComponentType componentId;
...
int func_191(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x12AAC
{
	int pedPropIndex;
...
int func_192(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x12AF3
{
	Hash entityModel;
...
int func_193(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x12BEF
{
	Hash entityModel;
...
int func_194(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x12D2D
{
	var outfit;
	int i;
	int num;
...
int func_195(Hash hParam0) // Position - 0x12DE8
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_196(ePedComponentType epctParam0) // Position - 0x12E47
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_197(Ped pedParam0, int iParam1, int iParam2) // Position - 0x12ECD
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_78472[1 /*14*/] = { func_213(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num2] != -99)
			{
				if (!func_197(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_197(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_78472[2 /*14*/] = { func_213(entityModel, 14, j, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == i)
									{
										if (func_197(pedParam0, 14, j))
										{
											if (!func_201(entityModel, iParam2, 14, j, &unk, &Global_78472[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_213(entityModel, num2, num, -1) };
					
						if (!func_201(entityModel, iParam2, num2, num, &unk, &Global_78472[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_91(1759, Global_78469) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	{
		if (Global_78472[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_186(iParam1)) && Global_78472[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_186(iParam1)))
			return true;
...
BOOL func_198(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x13328
{
	Hash componentHash;
...
BOOL func_199(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x133D1
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_200(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13479
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_201(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x134CC
{
	var unk;
	int i;
...
BOOL func_202(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13AD0
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_203(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13D4D
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_204(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14174
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_205(Hash hParam0, int iParam1, int iParam2) // Position - 0x14467
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_206(Hash hParam0, int iParam1) // Position - 0x14500
{
	int i;
	var unk;
...
void func_207(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14E2F
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_208(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x14F59
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_209(Hash hParam0, int iParam1) // Position - 0x14FA1
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_212(&unk, -99, -99, Global_113810.f_2366.f_539.f_196[0], Global_113810.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_212(&unk, -99, -99, Global_113810.f_2366.f_539.f_196[1], Global_113810.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_212(&unk, -99, -99, Global_113810.f_2366.f_539.f_196[2], Global_113810.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_210(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16DE9
{
	int num;
	Hash outfit;
...
struct<14> func_213(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x170F4
{
	func_259();
...
void func_214(int iParam0, int iParam1, Hash hParam2) // Position - 0x17135
{
	switch (iParam0)
	{
		case 2:
...
void func_215(int iParam0) // Position - 0x17241
{
	...
	func_216(&Global_78472[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_216(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x173FC
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_91(func_219(iParam1, iParam0->f_2), Global_78469);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_91(func_218(iParam1, iParam0->f_2), Global_78469);
...
BOOL func_220(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x183AB
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_221(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1924E
{
	int num;
	int num2;
	int num3;
...
BOOL func_222(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1928C
{
...
void func_225(int iParam0, Hash hParam1) // Position - 0x1BD6C
{
	int num;
...
void func_226(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1BD8C
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_216(&Global_78472[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_216(&Global_78472[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_216(&Global_78472[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78670)
		{
			...
			func_216(&Global_78472[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_227(int iParam0, Hash hParam1) // Position - 0x1C016
{
	BOOL flag;
	int num;
	var unk;
...
void func_228(int iParam0, Hash hParam1) // Position - 0x1C119
{
	BOOL flag;
	int num;
	var unk;
...
void func_229(int iParam0, Hash hParam1) // Position - 0x1C3F8
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		func_216(&Global_78472[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_230(int iParam0, Hash hParam1) // Position - 0x1F1CD
{
	BOOL flag;
	int num;
	var unk;
...
void func_231(int iParam0, Hash hParam1) // Position - 0x1F2D2
{
	BOOL flag;
	int value;
	var unk;
...
void func_232(int iParam0, Hash hParam1) // Position - 0x1FAAE
{
	BOOL flag;
	int value;
	var unk;
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1FD93
{
	BOOL flag;
	int value;
	var unk;
...
void func_234(int iParam0, Hash hParam1) // Position - 0x213BB
{
	BOOL flag;
	int value;
	var unk;
...
void func_235(int iParam0, Hash hParam1) // Position - 0x22A1A
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x22B75
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x22DF5
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_238(int iParam0, int iParam1) // Position - 0x24199
{
	int num;
	int num2;
...
int func_239(int iParam0, int iParam1) // Position - 0x241C8
{
	int num;

	num = func_91(func_240(iParam0), iParam1);
	return num;
}

int func_240(int iParam0) // Position - 0x241E0
{
	int num;
	int num2;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x2453D
{
	BOOL flag;
	int value;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x25CA2
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, int iParam1, Hash hParam2) // Position - 0x26B73
{
	switch (iParam0)
	{
		case 2:
...
void func_245(int iParam0, Hash hParam1) // Position - 0x26E49
{
	int num;
...
void func_246(int iParam0, Hash hParam1) // Position - 0x26E69
{
	BOOL flag;
	int num;
	var unk;
...
void func_247(int iParam0, Hash hParam1) // Position - 0x26F6C
{
	BOOL flag;
	int num;
	var unk;
...
void func_248(int iParam0, Hash hParam1) // Position - 0x2721D
{
	BOOL flag;
	int value;
	var unk;
...
void func_249(int iParam0, Hash hParam1) // Position - 0x29FDD
{
	BOOL flag;
	int num;
	var unk;
...
void func_250(int iParam0, Hash hParam1) // Position - 0x2A0FE
{
	BOOL flag;
	int value;
	var unk;
...
void func_251(int iParam0, Hash hParam1) // Position - 0x2A9F6
{
	BOOL flag;
	int value;
	var unk;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x2ACAD
{
	BOOL flag;
	int value;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x2C377
{
	BOOL flag;
	int value;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x2D9AA
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2DB01
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x2DE1D
{
	BOOL flag;
	int value;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x30311
{
	BOOL flag;
	int value;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x3189C
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_260(Ped pedParam0) // Position - 0x327CF
{
	int num;
...
BOOL func_262(BOOL bParam0) // Position - 0x32882
{
...
BOOL func_264() // Position - 0x328C3
{
...
BOOL func_266(BOOL bParam0) // Position - 0x32913
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_164769, 12) && func_267();

	return IS_BIT_SET(*Global_4718592.f_164769, 12);
}

BOOL func_267() // Position - 0x32949
{
...
BOOL func_268(Ped pedParam0, BOOL bParam1) // Position - 0x32977
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_117(PLAYER::PLAYER_ID(), true) && Global_1895156[PLAYER::PLAYER_ID() /*609*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_269(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x331B1
{
	Hash componentHash;
...
int func_270(int iParam0, Hash hParam1) // Position - 0x339D1
{
...
int func_271(Ped pedParam0) // Position - 0x339F3
{
...
Player func_272() // Position - 0x33A56
{
	Player player;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x33A74
{
...
BOOL func_275(Player plParam0, BOOL bParam1) // Position - 0x33A9B
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_276(Player plParam0) // Position - 0x33AD4
{
	if (func_11(plParam0))
		if (Global_1895156[plParam0 /*609*/].f_10 != _INVALID_PLAYER_INDEX())
...
BOOL func_278(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x33B2B
{
...
BOOL func_285() // Position - 0x33CA2
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x33CB6
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x33D3A
{
	switch (func_95())
	{
		case 0:
...
Hash func_288() // Position - 0x33D6D
{
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x33DA0
{
...
BOOL func_298(Ped pedParam0) // Position - 0x33EDC
{
	int pedDrawableVariation;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x33FAC
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
void func_300(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x33FCA
{
...
void func_301(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x33FFA
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
