...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x5F1
{
	return uParam0->f_1;
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x5FD
{
...
BOOL func_20(Ped pedParam0) // Position - 0xB23
{
...
void func_21(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0xB54
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0xC24
{
	Hash statName;
...
void func_36(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xE3B
{
	if (bParam0)
	{
...
int func_38(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFA2
{
	int num;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x1420
{
...
void func_64(Vehicle veParam0) // Position - 0x15D9
{
...
BOOL func_65(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1675
{
	int i;
	int num;
	Ped ped;
...
Ped func_67(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1762
{
	Ped pedInVehicleSeat;
...
void func_80(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D1A
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x21F1
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_82(Hash hParam0) // Position - 0x2201
{
	return func_133(hParam0);
}

BOOL func_83(Hash hParam0) // Position - 0x220F
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_84(Vehicle veParam0) // Position - 0x2310
{
	Hash entityModel;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x23DA
{
	int address;
	int i;
	Player player;
...
int func_96(Vehicle veParam0, Any* panParam1) // Position - 0x2C3A
{
...
BOOL func_97(Vehicle veParam0) // Position - 0x2CB7
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_98(Vehicle veParam0) // Position - 0x2D44
{
	int int;
...
BOOL func_99(var uParam0, Player plParam1) // Position - 0x2DA0
{
	func_103();
...
BOOL func_100(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x304B
{
...
int func_101(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3074
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_104(Vehicle veParam0) // Position - 0x869E
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_105(Vehicle veParam0) // Position - 0x86D6
{
	int int;
...
BOOL func_106(Vehicle veParam0, Any* panParam1) // Position - 0x871E
{
	Player playerFromGamerHandle;
	BOOL flag;
...
BOOL func_107(Vehicle veParam0) // Position - 0x8805
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_108(Vehicle veParam0) // Position - 0x8AFB
{
...
int func_109(Player plParam0) // Position - 0x8B27
{
...
int func_110(Player plParam0) // Position - 0x8B44
{
...
BOOL func_111(Player plParam0, BOOL bParam1) // Position - 0x8B67
{
...
int func_112(Player plParam0) // Position - 0x8BA2
{
	if (func_111(plParam0, false))
...
void func_125(Vehicle veParam0, int iParam1) // Position - 0x9280
{
	int num;
	int num2;
...
BOOL func_131(Vehicle veParam0) // Position - 0x9840
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_133(Hash hParam0) // Position - 0x9B62
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_134(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9BB5
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_135() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")))
...
BOOL func_142(Vehicle veParam0) // Position - 0xA594
{
	int i;
	int modType;
	Hash hashKey;
...
int func_144(Vehicle veParam0, int iParam1) // Position - 0xA6C5
{
	int value;
	int value2;
	float num;
...
int func_145(Vehicle veParam0, int iParam1) // Position - 0xA7AE
{
	int i;
...
BOOL func_146(Hash hParam0, int iParam1) // Position - 0xA810
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_147(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xABEF
{
...
void func_149(Vehicle veParam0, int iParam1) // Position - 0xAC1C
{
	int vehicleMod;
...
BOOL func_152(Vehicle veParam0) // Position - 0xACC5
{
	int int;
...
BOOL func_156(Vehicle veParam0) // Position - 0xAE2D
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xAEB4
{
...
void func_162(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xB10D
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_163(Ped pedParam0, int iParam1, int iParam2) // Position - 0xB276
{
	switch (iParam1)
	{
		case 1841427399:
...
BOOL func_164(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xC50D
{
	Hash entityModel;
	int num;
...
int func_170(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xD788
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_171(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xE7BA
{
	Hash entityModel;
	int num;
		...
		case 4:
			...
			if (entityModel == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 13:
						func_178(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2937), 0);
						break;
				
					case 14:
						func_178(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2938), 0);
						break;
				
					case 15:
						func_178(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2939), 2);
						break;
				
					case 16:
						func_178(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2940), 0);
						break;
				
					case 71:
						func_178(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2940), 0);
						break;
				
					case 72:
						func_178(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2940), 0);
						break;
				}
			}
			else if (entityModel == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 14:
						func_178(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2938), 0);
						break;
				
					case 15:
						func_178(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2939), 2);
						break;
				
					case 16:
						func_178(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2940), 0);
						break;
				}
			}
			break;
...
void func_178(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x11AAB
{
	var unk;
...
BOOL func_179(Ped pedParam0, int iParam1) // Position - 0x11D60
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			if (pedDrawableVariation > 15)
			{
				...
				if (num2 >= 237)
				{
					componentHash = func_180(joaat("MP_M_Freemode_01"), num2, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			else if (pedDrawableVariation > 15)
			{
				...
				if (num3 >= 256)
				{
					componentHash2 = func_180(joaat("MP_F_Freemode_01"), num3, 11, 4);
...
Hash func_180(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12022
{
	var outProp;
	int componentId;
	int num;
...
int func_181(Hash hParam0, int iParam1) // Position - 0x1213C
{
	switch (hParam0)
	{
...
ePedComponentType func_182(int iParam0) // Position - 0x124E3
{
	switch (iParam0)
	{
		case 0:
...
int func_183(Hash hParam0) // Position - 0x12593
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_184(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x125F4
{
	int i;
	int j;
...
int func_185(Ped pedParam0, int iParam1) // Position - 0x12695
{
...
int func_186(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x126F5
{
	ePedComponentType componentId;
...
int func_187(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1274C
{
	int pedPropIndex;
...
int func_188(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x12793
{
	Hash entityModel;
...
int func_189(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1288F
{
	Hash entityModel;
...
int func_190(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x129CD
{
	var unk;
	Ped i;
	Ped ped;
...
int func_191(Hash hParam0) // Position - 0x12A88
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_192(ePedComponentType epctParam0) // Position - 0x12AE7
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_193(Ped pedParam0, int iParam1, int iParam2) // Position - 0x12B6D
{
	Hash entityModel;
	int num;
	Hash hash;
...
BOOL func_194(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x12FC9
{
	Hash componentHash;
...
BOOL func_195(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x13072
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_196(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1311A
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_197(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x1316D
{
	var unk;
	int i;
...
BOOL func_198(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13771
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_180(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_180(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_180(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_180(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_199(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x139EE
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_200(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13E13
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_201(Hash hParam0, int iParam1, int iParam2) // Position - 0x14107
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_202(Hash hParam0, int iParam1) // Position - 0x141A0
{
	int i;
	var unk;
...
void func_203(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14ACF
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_205(Hash hParam0, int iParam1) // Position - 0x14C41
{
	int i;
	var unk;
...
void func_206(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16A89
{
	int num;
	Hash itemHash;
...
struct<14> func_209(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x16D94
{
	func_255();
...
void func_210(int iParam0, int iParam1, Hash hParam2) // Position - 0x16DD5
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_217(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x18EE1
{
	int num;
	int num2;
	eMPStat stat;
	...
	if (func_218(hParam0, iParam1, &stat, &num2, bParam2, bParam3))
	{
...
BOOL func_218(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x18F20
{
...
void func_221(int iParam0, Hash hParam1) // Position - 0x1B811
{
	int num;
...
void func_222(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1B831
{
	int num;
	int num2;
	Hash hash;
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num4 > componentId)
			{
				...
				func_212(&Global_78341[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num3, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78539)
		{
			...
			func_212(&Global_78341[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_223(int iParam0, Hash hParam1) // Position - 0x1BAB8
{
	BOOL flag;
	int num;
	var unk;
...
void func_224(int iParam0, Hash hParam1) // Position - 0x1BBBB
{
	BOOL flag;
	int num;
	var unk;
...
void func_225(int iParam0, Hash hParam1) // Position - 0x1BE9A
{
	BOOL flag;
	int value;
	var unk;
...
void func_226(int iParam0, Hash hParam1) // Position - 0x1EC70
{
	BOOL flag;
	int num;
	var unk;
...
void func_227(int iParam0, Hash hParam1) // Position - 0x1ED75
{
	BOOL flag;
	int value;
	var unk;
...
void func_228(int iParam0, Hash hParam1) // Position - 0x1F551
{
	BOOL flag;
	int value;
	var unk;
...
void func_229(int iParam0, Hash hParam1) // Position - 0x1F836
{
	BOOL flag;
	int value;
	var unk;
...
void func_230(int iParam0, Hash hParam1) // Position - 0x20E5E
{
	BOOL flag;
	int value;
	var unk;
...
void func_231(int iParam0, Hash hParam1) // Position - 0x224BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_232(int iParam0, Hash hParam1) // Position - 0x22618
{
	BOOL flag;
	int num;
	var unk;
...
void func_233(int iParam0, Hash hParam1) // Position - 0x22898
{
	BOOL flag;
	int value;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x23FDF
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Position - 0x25747
{
	BOOL flag;
	int value;
	var unk;
...
void func_239(int iParam0, int iParam1, Hash hParam2) // Position - 0x26618
{
	switch (iParam0)
	{
		case 2:
...
void func_241(int iParam0, Hash hParam1) // Position - 0x268EE
{
	int num;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x2690E
{
	BOOL flag;
	int num;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x26A11
{
	BOOL flag;
	int num;
	var unk;
...
void func_244(int iParam0, Hash hParam1) // Position - 0x26CC2
{
	BOOL flag;
	int value;
	var unk;
...
void func_245(int iParam0, Hash hParam1) // Position - 0x29A83
{
	BOOL flag;
	int num;
	var unk;
...
void func_246(int iParam0, Hash hParam1) // Position - 0x29BA4
{
	BOOL flag;
	int value;
	var unk;
...
void func_247(int iParam0, Hash hParam1) // Position - 0x2A49C
{
	BOOL flag;
	int value;
	var unk;
...
void func_248(int iParam0, Hash hParam1) // Position - 0x2A753
{
	BOOL flag;
	int value;
	var unk;
...
void func_249(int iParam0, Hash hParam1) // Position - 0x2BD90
{
	BOOL flag;
	int value;
	var unk;
...
void func_250(int iParam0, Hash hParam1) // Position - 0x2D3C3
{
	BOOL flag;
	int num;
	var unk;
...
void func_251(int iParam0, Hash hParam1) // Position - 0x2D51A
{
	BOOL flag;
	int num;
	var unk;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x2D836
{
	BOOL flag;
	int value;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x2FD27
{
	BOOL flag;
	int value;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x312DC
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_256(Ped pedParam0) // Position - 0x3220F
{
	int num;
...
BOOL func_264(Ped pedParam0, BOOL bParam1) // Position - 0x323B7
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
			...
			switch (pedDrawableVariation)
			{
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 7:
						case 12:
							num = func_265(joaat("MP_M_Freemode_01"), 11, func_184(pedParam0, 11, PV_COMP_INVALID), 0);
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num3 >= 241)
						{
							componentHash2 = func_180(joaat("MP_M_Freemode_01"), num3, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num4 = func_265(joaat("MP_F_Freemode_01"), 11, func_184(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num5 >= 256)
						{
							componentHash3 = func_180(joaat("MP_F_Freemode_01"), num5, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num6 = func_265(joaat("MP_F_Freemode_01"), 11, func_184(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num7 = func_265(joaat("MP_F_Freemode_01"), 11, func_184(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num8 >= 136)
						{
							componentHash4 = func_180(joaat("MP_F_Freemode_01"), num8, 8, 4);
...
int func_265(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x32BF1
{
	Hash componentHash;
...
int func_266(int iParam0, Hash hParam1) // Position - 0x33415
{
...
int func_267(Ped pedParam0) // Position - 0x33437
{
...
BOOL func_274(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x33561
{
...
Hash func_284() // Position - 0x337A3
{
...
BOOL func_294(Ped pedParam0) // Position - 0x33912
{
	int pedDrawableVariation;
