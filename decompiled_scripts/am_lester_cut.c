...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		switch (func_238(unk_0xD378D2332270959A()))
		{
			case 0:
				if (func_237() == 2)
					uLocal_165[unk_0xD378D2332270959A() /*3*/] = 2;
				else if (func_237() == 6)
					uLocal_165[unk_0xD378D2332270959A() /*3*/] = 5;
				break;
			...
			case 2:
				if (func_237() == 2)
				{
					...
					else if (unk_0xCE4AAA035282336C(Global_1935132))
					{
						...
						if (IS_BIT_SET(iLocal_434, 3))
							unk_0x423A98584B1756BF();
					
						unk_0xECDAB41968FF21A8(&(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2), 0);
					}
				
					if (func_8(unk_0x93E99A2DBCBA9CFA()))
					{
						uLocal_165[unk_0xD378D2332270959A() /*3*/] = 3;
			...
			case 5:
				func_6(&(iLocal_85.f_3));
			
				if (func_5(&(iLocal_85.f_3)))
					uLocal_165[unk_0xD378D2332270959A() /*3*/] = 6;
				break;
...
void func_3() // Position - 0x22A
{
	...
	if (unk_0xE85391CF212DE622())
	{
		if (iLocal_164 == 0)
		{
			unk_0x061B1200C95204CB(&iLocal_434, 0);
			unk_0xECDAB41968FF21A8(&iLocal_434, 1);
		
			if (iLocal_85.f_2 != -1)
				if (!unk_0x9A45DBB669E889B7(unk_0x74A08123C183740A(iLocal_85.f_2)))
					iLocal_85.f_2 = -1;
		}
	
		num = iLocal_164;
	
		if (unk_0x9A45DBB669E889B7(num))
		{
			player = unk_0xFE2D0B37A9596A4C(num);
		
			if (!IS_BIT_SET(uLocal_165[iLocal_164 /*3*/].f_2, 0))
				unk_0x061B1200C95204CB(&iLocal_434, 1);
		
			if (_NETWORK_IS_PLAYER_VALID(player, false, true))
			{
				if (IS_BIT_SET(uLocal_165[iLocal_164 /*3*/].f_2, 1))
				{
					unk_0xECDAB41968FF21A8(&iLocal_434, 12);
				
					if (iLocal_85.f_2 == -1)
						if (iLocal_85.f_2 != iLocal_164)
							iLocal_85.f_2 = iLocal_164;
				}
				else if (iLocal_85.f_2 == iLocal_164)
				{
					iLocal_85.f_2 = -1;
				}
			}
		...
		if (iLocal_164 == 32)
		{
			if (IS_BIT_SET(iLocal_434, 1))
				unk_0xECDAB41968FF21A8(&(iLocal_85.f_1), 0);
		
			if (!IS_BIT_SET(iLocal_434, 12))
				if (iLocal_85.f_2 != -1)
					iLocal_85.f_2 = -1;
		
			unk_0xECDAB41968FF21A8(&iLocal_434, 0);
			iLocal_164 = 0;
		}
	}
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x320
{
	Player player;
...
BOOL func_5(var uParam0) // Position - 0x380
{
	if (uParam0->f_1)
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x3C8
{
	if (pStopwatch->f_1 == 0)
	{
...
BOOL func_8(var uParam0) // Position - 0x40D
{
	if (func_11(uParam0))
		return true;
...
BOOL func_9(int iParam0) // Position - 0x430
{
	int num;
...
BOOL func_11(int iParam0) // Position - 0x466
{
	int num;
...
void func_19() // Position - 0x830
{
	...
	switch (uLocal_165[unk_0xD378D2332270959A() /*3*/].f_1)
	{
		case 0:
			if (!IS_BIT_SET(iLocal_434, 2))
				if (!IS_BIT_SET(iLocal_434, 5))
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
						if (!func_234())
							if (!func_232())
								if (unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) == 0)
									if (!func_231(0))
										if (!func_228(unk_0x93E99A2DBCBA9CFA(), true, false))
											if (!func_227())
												func_226() == 0;
		
			if (!IS_BIT_SET(iLocal_434, 5))
			{
				if (func_228(unk_0x93E99A2DBCBA9CFA(), true, false) || func_227() || func_226() > 0 || func_225() || func_221() || func_220() || func_199(false))
				{
					unk_0xECDAB41968FF21A8(&iLocal_434, 5);
					func_12();
				...
				else
				{
					if (unk_0xCE4AAA035282336C(Global_1935132))
					{
						if (!IS_BIT_SET(iLocal_434, 14))
						{
							if (iLocal_85.f_2 != -1)
							{
								if (iLocal_85.f_2 != unk_0xD378D2332270959A())
								{
									unk_0x1886753DA39F38F8(Global_1935132, 39);
									unk_0x225EB85DBC38E707(Global_1935132, 0.7f);
									unk_0xECDAB41968FF21A8(&iLocal_434, 14);
								}
							}
						}
						else if (iLocal_85.f_2 == -1 || iLocal_85.f_2 == unk_0xD378D2332270959A())
						{
							unk_0x1886753DA39F38F8(Global_1935132, 0);
							unk_0x225EB85DBC38E707(Global_1935132, 1f);
							unk_0x061B1200C95204CB(&iLocal_434, 14);
						}
					}
				
					if (IS_BIT_SET(iLocal_434, 8))
						unk_0x061B1200C95204CB(&iLocal_434, 8);
					...
					if (func_198())
					{
						if (unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) == 0)
						{
							...
							{
								if (!IS_BIT_SET(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2, 1))
									unk_0xECDAB41968FF21A8(&(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2), 1);
								...
								if (IS_BIT_SET(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2, 1))
								{
									if (iLocal_85.f_2 == unk_0xD378D2332270959A())
									{
										...
										unk_0xECDAB41968FF21A8(&iLocal_434, 25);
										unk_0xF82BC5193AF62796(1274.854f, -1721.1538f, 53.6808f, 2f, 1, 0, 0, 1);
										...
										uLocal_165[unk_0xD378D2332270959A() /*3*/].f_1 = 1;
									}
									else if (iLocal_85.f_2 != -1)
									{
										if (!IS_BIT_SET(iLocal_434, 13))
										{
											if (func_188(true, true, 1, true))
											{
												...
												unk_0xECDAB41968FF21A8(&iLocal_434, 13);
											}
										}
									}
								}
					...
					{
						if (!IS_BIT_SET(iLocal_434, 9))
						{
							if (func_188(false, true, 1, true))
							{
								if (!func_225())
								{
									...
									unk_0xECDAB41968FF21A8(&iLocal_434, 2);
									unk_0xECDAB41968FF21A8(&iLocal_434, 9);
								}
							}
						}
					
						if (IS_BIT_SET(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2, 1))
							unk_0x061B1200C95204CB(&(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2), 1);
					
						if (IS_BIT_SET(iLocal_434, 13))
							unk_0x061B1200C95204CB(&iLocal_434, 13);
					}
				}
			}
			else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				if (unk_0x1B82EF141CC65934(unk_0x93E99A2DBCBA9CFA()))
				{
					...
					{
						if (!func_228(unk_0x93E99A2DBCBA9CFA(), true, false) && !func_227() && func_226() == 0 && !func_225() && !func_221() && !func_199(false))
						{
							if (!_STOPWATCH_IS_INITIALIZED(&uLocal_437))
							{
								_STOPWATCH_INITIALIZE(&uLocal_437, false, false);
							}
							else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_437, 10, false))
							{
								unk_0x061B1200C95204CB(&iLocal_434, 5);
								unk_0x061B1200C95204CB(&iLocal_434, 2);
								unk_0x061B1200C95204CB(&iLocal_434, 3);
								unk_0x061B1200C95204CB(&iLocal_434, 8);
								_STOPWATCH_DESTROY(&uLocal_437);
		...
		case 1:
			if (bLocal_432)
				if (func_182())
					uLocal_165[unk_0xD378D2332270959A() /*3*/].f_1 = 2;
			else if (func_142())
				uLocal_165[unk_0xD378D2332270959A() /*3*/].f_1 = 2;
			break;
		...
		case 2:
			if (func_87())
				uLocal_165[unk_0xD378D2332270959A() /*3*/].f_1 = 3;
			break;
	
		case 3:
			if (!IS_BIT_SET(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2, 0))
				unk_0xECDAB41968FF21A8(&(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2), 0);
			break;
	}
	...
	if (func_86())
	{
		...
		func_12();
		unk = Global_1665626[func_85(-1)];
		unk_0xECDAB41968FF21A8(&unk, 2);
		unk_0xECDAB41968FF21A8(&(uLocal_165[unk_0xD378D2332270959A() /*3*/].f_2), 0);
		func_84(1304, unk, -1, 1);
		func_197(12, false);
...
void func_20(BOOL bParam0) // Position - 0xD44
{
	...
	num = func_71(unk_0x93E99A2DBCBA9CFA(), bParam0);
	...
	if (!func_55(1))
	{
		func_48(func_49(59, false, false), false);
		func_43(func_49(135, false, false), true);
		func_41(func_49(22, false, false), func_49(73, false, false));
	}
	else
	{
		func_41(false, false);
...
void func_21(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF05
{
	if (bParam1)
	{
		if (!func_32(iParam0, 0, false))
		{
	...
	else if (func_32(iParam0, 0, false))
	{
...
void func_23(int iParam0, int iParam1, BOOL bParam2) // Position - 0xFDE
{
	...
	else if (unk_0xA26A9A07F761D8F8())
	{
		if (func_27() == 0)
		{
			num = _MPCHAR_STAT_GET_INT(func_26(iParam0), -1, 0);
			unk_0x061B1200C95204CB(&num, iParam1);
			_MPCHAR_STAT_SET_INT(func_26(iParam0), num, -1, 1, false);
		}
	}
	else
	{
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x1050
{
	int num;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x1080
{
	int num;
	int num2;
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_85(iParam1)];
...
eMPStat func_26(int iParam0) // Position - 0x10BD
{
	switch (iParam0)
	{
		case 0:
...
void func_29(int iParam0) // Position - 0x14D3
{
	...
	{
		func_28(iParam0, 10, true);
		func_28(iParam0, 19, true);
	}
...
BOOL func_32(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1833
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_27() == 0)
			return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_26(iParam0), -1, 0), iParam1);
	else
...
void func_33(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1894
{
	int num;

	if (func_34())
	{
		num = Global_2848280[iParam0 /*3*/][func_85(iParam2)];
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x197D
{
	int num;
	BOOL num2;

	num = Global_2848280[iParam0 /*3*/][func_85(iParam1)];
...
void func_43(BOOL bParam0, BOOL bParam1) // Position - 0x1B0C
{
	...
	if (Global_262145.f_63 == 1 && func_49(135, false, false))
		bParam0 = true;
...
int func_44(int iParam0) // Position - 0x1B92
{
	...
	{
		num = _MPCHAR_STAT_GET_INT(func_46(iParam0), -1, 0);
...
void func_45(int iParam0, int iParam1) // Position - 0x1BD6
{
	...
	_MPCHAR_STAT_SET_INT(func_46(iParam0), iParam1, -1, 1, false);
	return;
}

eMPStat func_46(int iParam0) // Position - 0x1BF7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_47(BOOL bParam0) // Position - 0x1C15
{
	int num;
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D21
{
	int num;
	int num2;
...
BOOL func_51(int iParam0, int iParam1) // Position - 0x1EEC
{
	if (!func_40())
		return false;
...
BOOL func_52(var uParam0, int iParam1) // Position - 0x1F2C
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x2131
{
	return false;
}
...
int func_60(var uParam0, int iParam1) // Position - 0x228E
{
	int num;
	int num2;
	int num3;
...
BOOL func_65(int iParam0) // Position - 0x237D
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 130:
			num2 = iParam0;
			num2 = num2 % 32;
			num = _MPCHAR_STAT_GET_INT(func_66(iParam0), -1, 0);
...
eMPStat func_66(int iParam0) // Position - 0x25AC
{
	int num;
...
BOOL func_68(int iParam0) // Position - 0x2923
{
	if (Global_1574612)
		return true;
...
BOOL func_73(int iParam0) // Position - 0x2A97
{
	if (iParam0 == -1)
		return false;
	else
...
void func_81(int iParam0, int iParam1) // Position - 0x2BB3
{
	int num;
	int num2;
...
void func_84(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2D27
{
	int num;

	num = Global_2805027[iParam0 /*3*/][func_85(iParam2)];

	if (num != 0)
		unk_0x3CC35ACFFC9C730E(num, uParam1, iParam3);

	switch (iParam0)
	{
		case 788:
			Global_1665566[func_85(iParam2)] = uParam1;
			break;
	
		case 789:
			Global_1665572[func_85(iParam2)] = uParam1;
			break;
	
		case 790:
			Global_1665578[func_85(iParam2)] = uParam1;
			break;
	
		case 791:
			Global_1665584[func_85(iParam2)] = uParam1;
			break;
	
		case 8729:
			Global_1665590[func_85(iParam2)] = uParam1;
			break;
	
		case 778:
			Global_1665536[func_85(iParam2)] = uParam1;
			break;
	
		case 779:
			Global_1665542[func_85(iParam2)] = uParam1;
			break;
	
		case 780:
			Global_1665548[func_85(iParam2)] = uParam1;
			break;
	
		case 781:
			Global_1665554[func_85(iParam2)] = uParam1;
			break;
	
		case 8731:
			Global_1665560[func_85(iParam2)] = uParam1;
			break;
	
		case 768:
			Global_1665506[func_85(iParam2)] = uParam1;
			break;
	
		case 769:
			Global_1665512[func_85(iParam2)] = uParam1;
			break;
	
		case 770:
			Global_1665518[func_85(iParam2)] = uParam1;
			break;
	
		case 771:
			Global_1665524[func_85(iParam2)] = uParam1;
			break;
	
		case 8733:
			Global_1665530[func_85(iParam2)] = uParam1;
			break;
	
		case 758:
			Global_1665596[func_85(iParam2)] = uParam1;
			break;
	
		case 759:
			Global_1665602[func_85(iParam2)] = uParam1;
			break;
	
		case 760:
			Global_1665608[func_85(iParam2)] = uParam1;
			break;
	
		case 761:
			Global_1665614[func_85(iParam2)] = uParam1;
			break;
	
		case 8735:
			Global_1665620[func_85(iParam2)] = uParam1;
			break;
	
		case 1304:
			Global_1665626[func_85(iParam2)] = uParam1;
			break;
	
		case 7236:
			Global_1665632[func_85(iParam2)] = uParam1;
			break;
	
		case 640:
			Global_1665638[func_85(iParam2)] = uParam1;
			break;
	
		case 1279:
			Global_1665644[func_85(iParam2)] = uParam1;
			break;
	
		case 1878:
			Global_2851323[0 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 2269:
			Global_2851323[1 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 2932:
			Global_2851323[2 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3061:
			Global_2851323[3 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 12424:
			Global_2851502[func_85(iParam2)] = uParam1;
			break;
	
		case 765:
			Global_1665650[func_85(iParam2)] = uParam1;
			break;
	
		case 766:
			Global_1665656[func_85(iParam2)] = uParam1;
			break;
	
		case 767:
			Global_1665662[func_85(iParam2)] = uParam1;
			break;
	
		case 8734:
			Global_1665668[func_85(iParam2)] = uParam1;
			break;
	
		case 9538:
			Global_1665674[func_85(iParam2)] = uParam1;
			break;
	
		case 11803:
			Global_1665680[func_85(iParam2)] = uParam1;
			break;
	
		case 1237:
			Global_1665686[func_85(iParam2)] = uParam1;
			break;
	
		case 3056:
			Global_2851411[0 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3057:
			Global_2851411[1 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3058:
			Global_2851411[2 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3059:
			Global_2851411[3 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3060:
			Global_2851411[4 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3639:
			Global_2851505[0 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3640:
			Global_2851505[1 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3641:
			Global_2851505[2 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3642:
			Global_2851505[3 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3643:
			Global_2851505[4 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3644:
			Global_2851521[0 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3645:
			Global_2851521[1 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3646:
			Global_2851521[2 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3647:
			Global_2851521[3 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3648:
			Global_2851521[4 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3224:
			Global_2851411[5 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3230:
			Global_2851323[4 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3666:
			Global_2851537[func_85(iParam2)] = uParam1;
			break;
	
		case 3667:
			Global_2851546[func_85(iParam2)] = uParam1;
			break;
	
		case 3668:
			Global_2851540[func_85(iParam2)] = uParam1;
			break;
	
		case 3669:
			Global_2851549[func_85(iParam2)] = uParam1;
			break;
	
		case 3670:
			Global_2851543[func_85(iParam2)] = uParam1;
			break;
	
		case 3671:
			Global_2851552[func_85(iParam2)] = uParam1;
			break;
	
		case 3692:
			Global_2851555[func_85(iParam2)] = uParam1;
			break;
	
		case 3232:
			Global_2851411[6 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3233:
			Global_2851323[5 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3237:
			Global_2851411[7 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 3235:
			Global_2851323[6 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4022:
			Global_2851411[8 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4023:
			Global_2851323[7 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4025:
			Global_2851411[9 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4026:
			Global_2851323[8 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4028:
			Global_2851411[10 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4029:
			Global_2851323[9 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4031:
			Global_2851411[11 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 4032:
			Global_2851323[10 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6112:
			Global_2851411[12 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6113:
			Global_2851323[11 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6170:
			Global_2851411[13 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6171:
			Global_2851323[12 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6548:
			Global_2851411[14 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6549:
			Global_2851323[13 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6561:
			Global_2851411[15 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6562:
			Global_2851323[14 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6564:
			Global_2851411[16 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6565:
			Global_2851323[15 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6567:
			Global_2851411[17 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 6568:
			Global_2851323[16 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 7286:
			Global_2851323[17 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 7288:
			Global_2851323[18 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 7290:
			Global_2851323[19 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 8013:
			Global_2851323[20 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 8285:
			Global_2851558[func_85(iParam2)] = uParam1;
			break;
	
		case 8286:
			Global_2851561[func_85(iParam2)] = uParam1;
			break;
	
		case 8287:
			Global_2851564[func_85(iParam2)] = uParam1;
			break;
	
		case 8288:
			Global_2851567[func_85(iParam2)] = uParam1;
			break;
	
		case 8289:
			Global_2851570[func_85(iParam2)] = uParam1;
			break;
	
		case 8290:
			Global_2851573[func_85(iParam2)] = uParam1;
			break;
	
		case 8291:
			Global_2851576[func_85(iParam2)] = uParam1;
			break;
	
		case 8292:
			Global_2851579[func_85(iParam2)] = uParam1;
			break;
	
		case 8293:
			Global_2851582[func_85(iParam2)] = uParam1;
			break;
	
		case 8294:
			Global_2851585[func_85(iParam2)] = uParam1;
			break;
	
		case 8295:
			Global_2851588[func_85(iParam2)] = uParam1;
			break;
	
		case 8296:
			Global_2851591[func_85(iParam2)] = uParam1;
			break;
	
		case 8297:
			Global_2851594[func_85(iParam2)] = uParam1;
			break;
	
		case 8905:
			Global_2851597[func_85(iParam2)] = uParam1;
			break;
	
		case 8537:
			Global_2851323[21 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 8982:
			Global_2851411[23 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 8980:
			Global_2851323[22 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 8985:
			Global_2851411[24 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 8983:
			Global_2851323[23 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 9624:
			Global_2851323[24 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 9913:
			Global_2851323[25 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 10443:
			Global_2851411[27 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 10441:
			Global_2851323[26 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 10446:
			Global_2851411[28 /*3*/][func_85(iParam2)] = uParam1;
			break;
	
		case 10444:
			Global_2851323[27 /*3*/][func_85(iParam2)] = uParam1;
			break;
...
BOOL func_87() // Position - 0x38A9
{
	switch (iLocal_262)
	{
		case 0:
			if (!IS_BIT_SET(iLocal_434, 18))
			{
				if (!unk_0x66599E73DBA5A850(uLocal_263))
				{
					uLocal_436 = unk_0x53B496178AE44636(uLocal_263);
					unk_0x3BCF1F6A3573A1DF(uLocal_436, 1);
					unk_0x4049FDC177C92D4B(uLocal_436, "FM_LEST_BLP" /*Lester*/);
					func_136("FM_LEST_GTL" /*~s~Go to ~b~Lester.*/, false);
					unk_0xECDAB41968FF21A8(&iLocal_434, 18);
				}
			}
		
			if (!IS_BIT_SET(iLocal_434, 20))
			{
				if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
				{
					if (!unk_0x66599E73DBA5A850(uLocal_263))
					{
						if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), 1272.7472f, -1715.2231f, 53.45897f, 1273.7319f, -1717.4268f, 55.70897f, 2f, 0, 1, 0))
						{
							...
							unk_0xECDAB41968FF21A8(&iLocal_434, 20);
						}
					}
				}
			}
			...
			if (!IS_BIT_SET(iLocal_434, 3))
			{
				...
				unk_0xECDAB41968FF21A8(&iLocal_434, 3);
			}
			else if (!IS_BIT_SET(iLocal_434, 10))
			{
				if (unk_0x3B7E6BE32C24780B())
				{
					unk_0x07695A0DBD6AE9F8("MP_1", 0, 1);
					unk_0xECDAB41968FF21A8(&iLocal_434, 10);
				}
			}
		
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
				if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), 1275.0946f, -1715.7693f, 53.70897f, 1274.3821f, -1714.2185f, 56.02147f, 1.375f, 0, 1, 0))
					if (IS_BIT_SET(iLocal_434, 10))
						iLocal_262 = iLocal_262 + 1;
			break;
	...
	if (!IS_BIT_SET(iLocal_434, 11))
	{
		if (unk_0x42C63C7AA899C5C8("MP_1", 0))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				unk_0xC2E3C377D893C17A(unk_0xC1A5EC5C986B98AD(), 1275.2192f, -1722.5026f, 53.655f, 1, 0, 0, 1);
				...
				unk_0xECDAB41968FF21A8(&iLocal_434, 11);
			}
		}
	}

	if (!IS_BIT_SET(iLocal_434, 26))
	{
		if (iLocal_262 > 2)
		{
			if (unk_0xD73EA79D6A369031(0))
			{
				if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
				{
					...
					unk_0xAABD7B0753C5C286(0f);
					unk_0xEAB390443C680F72(0f, 1065353216);
					unk_0xECDAB41968FF21A8(&iLocal_434, 26);
				}
			}
		}
	}

	if (IS_BIT_SET(iLocal_434, 19))
	{
...
void func_90(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3CE6
{
	func_115();
	...
	func_106(false, true, true, 0, false, bParam2, false);
	func_105();
	func_104(12, false, -1);
	func_103(1);
	...
	if (func_225() == false && func_101() == false && bParam1 && !func_99(unk_0x93E99A2DBCBA9CFA()) && !unk_0x58A962BEF2DDE1DF() && func_97())
...
void func_92(Player plParam0) // Position - 0x3EC2
{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0x3F91
{
	BOOL flag;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x401E
{
	if (unk_0xA26A9A07F761D8F8() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = unk_0x0DB7F8294D73598B();
...
void func_106(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x41BC
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (unk_0xA26A9A07F761D8F8())
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_99(unk_0x93E99A2DBCBA9CFA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !func_107() && !bParam4 && !bParam5 && !unk_0x8253CEEA17ED481B())
...
int func_108(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x4323
{
	int num;
...
void func_113(int iParam0) // Position - 0x4416
{
	int i;
...
void func_117() // Position - 0x44E4
{
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		...
		if (unk_0x73A9A190149B93A1(unk_0x93E99A2DBCBA9CFA()))
			unk_0xFD75FD38D5622C50(unk_0x93E99A2DBCBA9CFA());
	}
...
void func_118() // Position - 0x451A
{
	...
	func_12();
	unk_0xE0A291F406691F03(func_119(CHAR_LESTER));
	unk_0xE0A291F406691F03(joaat("prop_wheelchair_01_s"));
	unk_0x0B34FA69ECCE3927("missfinale_c2leadinoutfin_c_int");
	return;
}

int func_119(eCharacter echParam0) // Position - 0x457B
{
	if (!func_121(echParam0))
		return func_120(echParam0);
	else
...
int func_120(eCharacter echParam0) // Position - 0x45A1
{
	return Global_2028[echParam0 /*29*/];
}

BOOL func_121(eCharacter echParam0) // Position - 0x45B0
{
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x46D7
{
	...
	else
	{
		...
		if (unk_0xE6DEE82DB0922DF0(plParam0) && unk_0x48DC6A21D1CAD89C(plParam0) || iParam3 == 1)
		{
			...
			if (!flag20)
			{
				...
				else if (flag14 || !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !func_100())
			...
			if (bParam1)
			{
				...
				if (!func_130(unk) && !unk_0x24405041A9F1A910(unk))
					if (!flag22)
...
BOOL func_130(var uParam0) // Position - 0x4BFD
{
	int num;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0x4C2E
{
	int num;
	int i;
...
void func_132(int iParam0, int iParam1) // Position - 0x4CFE
{
	int num;
...
BOOL func_142() // Position - 0x4F05
{
	switch (iLocal_441)
	{
		case 0:
			...
			if (unk_0x5FAF55B1F052A2E6(uLocal_442) && func_194())
			{
				func_175();
				func_174();
				func_171(false, false, true, false, true, true, 0);
				_SET_PLAYER_CONTROL_EX(unk_0x93E99A2DBCBA9CFA(), false, SPC_CLEAR_TASKS | 8192, 0);
				unk_0x5DB569D82FF62CD0(0, 1);
				unk_0x3298713EEACD1622(unk_0xC1A5EC5C986B98AD(), 1, 1);
				func_168(true, 1, false);
			
				if (!unk_0x66599E73DBA5A850(uLocal_264))
				{
					unk_0xF82BC5193AF62796(1273.8845f, -1718.0037f, 53.7715f, 3f, 1, 0, 0, 0);
					unk_0x35DD50D05C962B6A(uLocal_264);
					unk_0xC2E3C377D893C17A(uLocal_264, 1275.2563f, -1722.3683f, 53.655f, 1, 0, 0, 1);
				...
				unk_0xCE4412DC4B679860(uLocal_443, 1276.4088f, -1719.9183f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
				unk_0x9E2404A25985615A(1, 0, 3000, 1, 0, 0);
				unk_0x9FD96C5DE6EDFC15(uLocal_442, "SET_DETAILS");
				func_167("FM_LEST_CAM" /*~s~CAM: 02*/);
				unk_0xAE3413B0654A0035();
				unk_0x9FD96C5DE6EDFC15(uLocal_442, "SET_LOCATION");
				func_167("FM_LEST_CAM2" /*~s~FRONT DOOR*/);
				unk_0xAE3413B0654A0035();
			
				if (unk_0x4F873840FC0FA8FE() == -1)
					unk_0xADD48E9C814DB7CB("scanline_cam");
			
				unk_0xECDAB41968FF21A8(&iLocal_434, 15);
				_STOPWATCH_INITIALIZE(&uLocal_444, false, false);
				...
				unk_0xECDAB41968FF21A8(&iLocal_434, 23);
			
				if (!IS_BIT_SET(iLocal_434, 17))
				{
					if (unk_0xB2FB1E59B6F71D15(208246292))
					{
						unk_0x289D605FFACC399B(208246292, 0, 0, 0);
						unk_0xECDAB41968FF21A8(&iLocal_434, 17);
					}
				}
		...
		case 1:
			if (!unk_0x66599E73DBA5A850(uLocal_264))
			{
				if (!IS_BIT_SET(iLocal_434, 21))
				{
					if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_444, 1000, false))
					{
						unk_0x952D2B8A054C4FF8(uLocal_264, 1276.4088f, -1719.9183f, 56.1054f, -1, 0, 2);
						unk_0xECDAB41968FF21A8(&iLocal_434, 21);
					}
				}
			}
		
			if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_444, 1500, false))
			{
				if (IS_BIT_SET(iLocal_434, 17))
				{
					if (!unk_0x66599E73DBA5A850(uLocal_264))
					{
						if (!unk_0x66599E73DBA5A850(uLocal_263))
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_267, "FM_1AU", "FM_LESTCUT", 7, 0, 0, 0))
							{
								_STOPWATCH_DESTROY(&uLocal_444);
								_STOPWATCH_INITIALIZE(&uLocal_444, false, false);
		...
		case 2:
			if (!unk_0x66599E73DBA5A850(uLocal_264))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					...
					unk_0xECDAB41968FF21A8(&iLocal_434, 22);
					unk_0x1F9F6C767BE640D5(uLocal_264);
					unk_0x7D9A648CC1936BDA(uLocal_264, 1273.5762f, -1718.4594f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
					_STOPWATCH_DESTROY(&uLocal_444);
					_STOPWATCH_INITIALIZE(&uLocal_444, false, false);
					iLocal_441 = iLocal_441 + 1;
				}
		...
		case 3:
			if (!unk_0x66599E73DBA5A850(uLocal_264))
			{
				if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_444, 5000, false) || unk_0x9DC9E896F189AAA5(uLocal_264, 1275.1378f, -1718.4255f, 53.729942f, 1272.4507f, -1719.6267f, 55.45897f, 1.5625f, 0, 1, 0))
				{
					if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
					{
						unk_0xC2E3C377D893C17A(unk_0xC1A5EC5C986B98AD(), 1273.8845f, -1718.0037f, 53.7715f, 1, 0, 0, 1);
					...
					func_147();
					func_90(true, true, false, true);
					unk_0x061B1200C95204CB(&iLocal_434, 22);
					...
					unk_0xECDAB41968FF21A8(&iLocal_434, 24);
					iLocal_441 = 99;
				}
			}
			break;
		...
		case 99:
			if (unk_0xB2FB1E59B6F71D15(208246292))
			{
				...
				unk_0xECDAB41968FF21A8(&iLocal_434, 19);
				iLocal_441 = 100;
			}
			break;
	...
	if (IS_BIT_SET(iLocal_434, 15))
	{
		if (unk_0x5FAF55B1F052A2E6(uLocal_442))
		{
			...
			if (unk_0x30DFE1FFD2CC7420() >= 0 && unk_0x30DFE1FFD2CC7420() < 12)
				func_167("FM_LEST_AM" /*~s~AM*/);
			else
				func_167("FM_LEST_PM" /*~s~PM*/);
	...
	if (IS_BIT_SET(iLocal_434, 23))
		if (func_143())
			unk_0x061B1200C95204CB(&iLocal_434, 23);

	return false;
}

BOOL func_143() // Position - 0x5436
{
	BOOL flag;
	...
	if (!unk_0x7DE17ACDD8BA2642(uLocal_263))
	{
		...
		{
			if (func_145(&uLocal_263, CHAR_LESTER, 1276.39f, -1712.845f, 54.372f, 338.0729f, true))
			{
				unk_0xC5B2830898581862(uLocal_263, 1);
				unk_0x226C3A30511D5DC4(uLocal_263, 1);
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_267, 8, uLocal_263, "Lester", 0, 1);
				unk_0x0A3B6B850C2EC4FD(uLocal_263, 1, 0, 0, 0, 1);
			}
		}
	}
	...
	if (!unk_0x7DE17ACDD8BA2642(uLocal_265))
		if (unk_0x0CBB7C273DED26E7(joaat("prop_wheelchair_01_s")))
			uLocal_265 = unk_0xF19D6C0E8B56BE23(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, 0, 0, 0);

	if (!unk_0x7DE17ACDD8BA2642(uLocal_263))
		return false;

	if (!unk_0x66599E73DBA5A850(uLocal_263))
		if (!unk_0x655790C883F82CEB(uLocal_263))
			return false;
	...
	{
		uLocal_266 = unk_0x191673E3F99212B2(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
		unk_0x468D976993BF7FE1(uLocal_263, uLocal_266, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
		unk_0xA2CBB04560DD6361(uLocal_265, uLocal_266, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x55BF
{
...
BOOL func_145(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x565A
{
	int num;

	if (!func_121(echParam1))
	{
		num = func_119(echParam1);
...
int func_146(var uParam0, eCharacter echParam1) // Position - 0x56E8
{
	int num;
...
void func_147() // Position - 0x572E
{
	...
	unk_0x061B1200C95204CB(&iLocal_434, 15);
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5785
{
...
BOOL func_149(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x57D3
{
	Global_21726 = 0;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x5B4B
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x5CB3
{
	if (func_162(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x5D55
{
	func_159();
...
void func_159() // Position - 0x5D6E
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_121(character) && !func_162(14) || Global_112599)
			{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x5E6B
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x5EA8
{
	if (func_121(character))
		return func_120(character);
	else
...
void func_166(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x5FC1
{
...
void func_168(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x6029
{
	func_170();
	func_113(1);
	unk_0xCD3C8E1022864F65(1);
	unk_0x8581263F2F024518();
	func_106(true, true, true, 0, false, false, bParam2);
	func_169();
	func_104(12, true, -1);
	func_103(0);
...
void func_171(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0x6116
{
	eSetPlayerControlFlags controlBs;
...
{
	if (!_IS_FMMC_ACTIVE() && !func_177() && Global_2684798)
...
BOOL _IS_FMMC_ACTIVE() // Position - 0x6235
{
...
BOOL func_180() // Position - 0x625C
{
	return Global_2683862.f_735;
}

BOOL func_181() // Position - 0x626B
{
	return IS_BIT_SET(Global_2683862.f_2, 11);
}

BOOL func_182() // Position - 0x627C
{
	switch (iLocal_262)
	{
		case 0:
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x639C
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x63A9
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x6407
{
	return uParam0->f_1;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x6413
{
	unk_0x56C9BC27C0FF68D7(message);
	return unk_0x6A92D111B5409879(0);
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x6426
{
...
BOOL func_188(BOOL bParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x643D
{
...
BOOL func_192(int iParam0) // Position - 0x6563
{
...
int func_194() // Position - 0x6594
{
	...
	if (!unk_0x7DE17ACDD8BA2642(uLocal_264))
	{
		if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
		{
			unk = unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD());
			uLocal_264 = unk_0x69FDD9508259E5B5(4, unk, 1273.8271f, -1717.8727f, 53.7715f, 19.2225f, 0, 0);
			unk_0x226C3A30511D5DC4(uLocal_264, 1);
			unk_0xC5B2830898581862(uLocal_264, 1);
			unk_0x52D31974082B54B1(unk_0xC1A5EC5C986B98AD(), uLocal_264);
		}
	}
	...
	if (!unk_0x66599E73DBA5A850(uLocal_264))
		if (!unk_0x655790C883F82CEB(uLocal_264))
			return 0;
...
void func_196(int iParam0, int iParam1) // Position - 0x6655
{
	int num;
	int num2;
...
void func_197(int iParam0, BOOL bParam1) // Position - 0x66E6
{
	if (bParam1)
...
BOOL func_198() // Position - 0x6743
{
	...
	if (bLocal_433)
	{
		if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), 1274.5474f, -1720.6945f, 53.6807f) > 500f)
		{
			if (unk_0x7DE17ACDD8BA2642(uLocal_264))
			{
				unk = uLocal_264;
	...
	if (!unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), 1273.8043f, -1722.4661f, 53.217487f, 1277.1472f, -1720.779f, 56.092487f, 3.4375f, 0, 1, 0))
		return false;

	return true;
}

BOOL func_199(BOOL bParam0) // Position - 0x67DA
{
	Player player;

	player = unk_0x93E99A2DBCBA9CFA();

	if (func_218(player) || func_217(player) || func_216(player) || func_215(player) || func_214(player) || func_213(player) || func_212(player) || func_211(player) || func_210(player) || func_207(player) && func_206(player))
		return true;

	if (bParam0)
		if (func_205(player))
			return true;
	else if (func_200(player))
		return true;

	return false;
}

BOOL func_200(Player plParam0) // Position - 0x688F
{
	if (func_205(plParam0) || func_204(plParam0) || func_203(plParam0) || func_201(plParam0))
		return true;

	return false;
}

BOOL func_201(Player plParam0) // Position - 0x68C9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 19;
...
BOOL func_203(Player plParam0) // Position - 0x6DC4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 15;

	return false;
}

BOOL func_204(Player plParam0) // Position - 0x6E0B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 16;

	return false;
}

BOOL func_205(Player plParam0) // Position - 0x6E52
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 14;

	return false;
}

BOOL func_206(Player plParam0) // Position - 0x6E99
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_207(Player plParam0) // Position - 0x6EBF
{
	if (func_209(plParam0) && func_208(plParam0) == plParam0)
		return true;

	return false;
}

Player func_208(Player plParam0) // Position - 0x6EE3
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_209(Player plParam0) // Position - 0x6F07
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[plParam0 /*466*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 25;

	return false;
}

BOOL func_210(Player plParam0) // Position - 0x6F67
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 26;

	return false;
}

BOOL func_211(Player plParam0) // Position - 0x6FAE
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 21;

	return false;
}

BOOL func_212(Player plParam0) // Position - 0x6FF5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 24;

	return false;
}

BOOL func_213(Player plParam0) // Position - 0x703C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 22;

	return false;
}

BOOL func_214(Player plParam0) // Position - 0x7083
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 23;

	return false;
}

BOOL func_215(Player plParam0) // Position - 0x70CA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 11;

	return false;
}

BOOL func_216(Player plParam0) // Position - 0x7111
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 17;

	return false;
}

BOOL func_217(Player plParam0) // Position - 0x7158
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[plParam0 /*466*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_202(Global_2657589[plParam0 /*466*/].f_321.f_7) == 20;

	return false;
}

BOOL func_218(Player plParam0) // Position - 0x71B8
{
	return func_219(&(Global_2657589[plParam0 /*466*/].f_445), 0);
}

BOOL func_219(var uParam0, int iParam1) // Position - 0x71D1
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_220() // Position - 0x71DF
{
	return Global_1947731;
}

BOOL func_221() // Position - 0x71EB
{
	return false;
}

BOOL func_222(int iParam0) // Position - 0x7205
{
	int num;
	...
	num = _MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_PIM_HIDE_JOBS, -1, 0);
	return IS_BIT_SET(num, iParam0);
}

BOOL func_223() // Position - 0x7268
{
	return IS_BIT_SET(_MPCHAR_STAT_GET_INT(_0x1556539446, -1, 0), 2);
}

BOOL func_224() // Position - 0x727B
{
...
BOOL func_228(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x72C8
{
	if (bParam1)
		if (func_229(iParam0))
			return true;
...
BOOL func_230(int iParam0) // Position - 0x7308
{
	return IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_11.f_1, 0);
}

BOOL func_231(int iParam0) // Position - 0x731F
{
	if (iParam0 == 1)
		if (Global_20383.f_1 > 3)
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x73B7
{
...
BOOL func_236(int iParam0) // Position - 0x73D9
{
	if (func_36())
		return true;
...
BOOL _IS_PLAYER_IN_AN_ORGANIZATION(Player plParam0, BOOL bCanBeBoss) // Position - 0x74AA
{
	if (!bCanBeBoss)
...
BOOL _IS_PLAYER_BOSS_OF_ORGANIZATION(Player plParam0) // Position - 0x74D5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x761E
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x76A2
{
	switch (func_27())
	{
		case 0:
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x7708
{
...
void func_256(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x7747
{
	func_260(func_261(uParam0), uParam0);
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	unk_0xAC5E62CB7808A363(&iLocal_85, 79, 0);
	unk_0x10BF12101F9D80A4(&uLocal_165, 97, 0);
...
BOOL _NETWORK_WAIT_FOR_HOST_BROADCAST_DATA() // Position - 0x7789
{
	int num;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x77E2
{
	int i;
...
void func_260(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x7909
{
	if (!unk_0xA26A9A07F761D8F8())
		func_245();
...
int func_261(int iParam0) // Position - 0x7928
{
	...
	switch (func_262(func_263(iParam0, true)))
	{
		case 0:
			return 8;
