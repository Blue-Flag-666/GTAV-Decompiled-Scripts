	...
	if (func_232(PLAYER::PLAYER_PED_ID()) && func_232(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_246(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
void func_252()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_232(Local_85.f_28[0]))
	{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_232(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					func_288(sLocal_160, PLAYER::PLAYER_PED_ID(), 0, 2);
				}
			}
...
void func_295()
{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_231(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_148))
			{
...
void func_306()
{
	...
	func_314(&uLocal_163, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_307()
{
	...
	func_310();
	func_254(1);
	func_309(PLAYER::PLAYER_PED_ID(), -258,8661f, 292,7882f, 90,5764f, 153,0393f, 0, 1);
	func_308(1, 1, 1);
}
...
int func_309(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
{
	if (((!func_335(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_304(0)) || func_334(1))
			{
			}
			else
			{
...
void func_341(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_346(*iParam1, 0, &uVar0))
		{
...
int func_346(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_374(iVar0, bParam1, uParam2) && !func_373(PLAYER::PLAYER_ID())) && !func_356(iParam0))
	{
		return 0;
	}
	...
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_352(iParam0)) && !bVar1) && !(func_351(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_348(PLAYER::PLAYER_ID())))
	{
...
{
	if (func_372(PLAYER::PLAYER_ID()) || func_371(PLAYER::PLAYER_ID()))
	{
		if (func_357(iParam0))
		{
			return 1;
...
int func_358(int iParam0)
{
	...
	if (func_359(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
	{
		return 1;
	}
	return 0;
...
int func_360(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_362(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_378(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_273(iParam0, 0, 0)) || func_273(iParam0, 1, 0)) || func_273(iParam0, 2, 0)) || func_394(iParam0) != 145) || func_393(iParam0)) || func_392(iParam0)) || func_347(iParam0)) || func_391(iParam0)) || !func_381(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_392(iParam0))
		{
		}
...
int func_398(int iParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_402(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_370(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_401(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_401(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_400(iParam0);
	if (func_399(*iParam0))
	{
...
{
	if (!func_404() && func_403(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_407(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97311[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97311[iVar0]) == func_408(iParam0, iParam1))
				{
...
void func_409(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
	...
	if (func_436(uParam0))
	{
		...
		if (func_435(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_419(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_419(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_421(iParam0, uVar1[iVar6], 1) && func_420(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
					if ((!bParam4 || func_415(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
void func_422(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_378(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_378(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_378(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						MISC::SET_BIT(&(uParam1->f_77), func_378(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_378(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_378(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_378(iVar5));
				}
				iVar5++;
			}
		}
...
int func_444(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 1:
			if (!func_449(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			if (func_231(uParam0->f_28[0]))
			{
				...
				{
					func_445(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2,5f), 0f);
