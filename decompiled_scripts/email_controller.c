...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!Global_44455 && unk_0xA5E11AF0A2B928C1() > Global_43808)
		{
			for (i = 0; i < 122; i = i + 1)
			{
				...
				if (Global_55187 > 0)
				{
					...
					while (num5 != 0)
					{
						if (Global_55188[num6 /*53*/].f_52 != 0 && num6 < 8 && Global_55188[num6 /*53*/].f_4)
						{
							...
							else if (Global_55188[num6 /*53*/].f_2 < 1)
							{
								if (func_34(7, _CHAR_NULL, 2, -1, 0))
								{
									flag5 = false;
								
									if (Global_55188[num6 /*53*/].f_5 || Global_55188[num6 /*53*/].f_10 > 0)
										flag5 = true;
									...
									if (func_17(Global_55188[num6 /*53*/], Global_55188[num6 /*53*/].f_1, flag5))
									{
										...
										if (Global_55188[num6 /*53*/].f_5)
											func_16(Global_55188[num6 /*53*/], &(Global_55188[num6 /*53*/].f_6), flag6);
									
										if (Global_55188[num6 /*53*/].f_10 > 0)
										{
											j = 0;
										
											for (j = 0; j < Global_55188[num6 /*53*/].f_10; j = j + 1)
											{
...
void func_1(int iParam0) // Position - 0x439
{
	...
	if (!Global_53765[num /*203*/].f_10[num3 /*48*/].f_1)
	{
		...
		TEXT_LABEL_COPY(&unk, { func_13(Global_44465[num4 /*12*/].f_1) }, 4);
	}
	else
	{
...
void func_2(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13) // Position - 0x7A5
{
	...
	if (character == echParam0)
	{
		...
		if (flag)
			func_3(unk_0x4BE755B3858339A1(&unk, &unk, 0, 2, unk_0x45816CECE89B5B19(func_4(iParam1)), 0));
		else
			func_3(unk_0x4BE755B3858339A1("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0x45816CECE89B5B19(func_4(iParam1)), 0));
...
BOOL func_17(int iParam0, int iParam1, BOOL bParam2) // Position - 0x14F4
{
	...
	for (i = 0; i < Global_53765[num /*203*/].f_3; i = i + 1)
	{
		...
		if (num3 < 3)
			func_18(Global_53765[num /*203*/].f_4[i], Global_53765[num /*203*/].f_1, true, bParam2, false);
	}
...
void func_18(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x16F0
{
	...
	if (!bParam2)
	{
		...
		num3 = num5;
		unk = { func_13(Global_44465[num5 /*12*/].f_1) };
	...
	else
	{
		...
		if (Global_53765[num6 /*203*/].f_10[Global_53765[num6 /*203*/].f_9 - 1 /*48*/].f_1)
			...
			unk = { func_13(Global_44465[num8 /*12*/].f_1) };
	}
...
void func_32(int iParam0, BOOL bParam1) // Position - 0x2239
{
	...
	for (i = 0; i < num3; i = i + 1)
	{
		if (Global_47790[iParam0 /*46*/].f_3[i] != Global_44465[num2 /*12*/].f_2 && Global_47790[iParam0 /*46*/].f_3[i] != Global_44465[num2 /*12*/].f_3)
			func_18(Global_47790[iParam0 /*46*/].f_3[i], iParam0, false, false, bParam1);
	}
...
BOOL func_34(int iParam0, eCharacter echParam1, int iParam2, int iParam3, int iParam4) // Position - 0x241A
{
			...
			if (IS_BIT_SET(iParam0, _GET_CURRENT_PLAYER_CHARACTER_0()))
			{
				...
				if (num4 < 9)
					if (Global_113648.f_18105.f_175[num4 /*19*/].f_8 == 1 || Global_113648.f_18105.f_175[num4 /*19*/].f_8 == 2)
						if (func_41(&(Global_113648.f_18105.f_175[num4 /*19*/].f_5)))
							if (func_38(&(Global_113648.f_18105.f_175[num4 /*19*/].f_5)) < 30f)
								return false;
			}
		}
	}
	...
	if (iParam3 != -1)
		if (func_36(unk_0xC1A5EC5C986B98AD(), iParam3, 0))
			return false;
...
int func_61() // Position - 0x4A31
{
	...
	func_67(&unk, unk_0x731F95B6458DCF80());
	func_66(&unk, unk_0x77BBAAED3E25322C());
	func_65(&unk, unk_0x30DFE1FFD2CC7420());
	func_64(&unk, unk_0x8C0F17CAC308A14B());
	func_63(&unk, unk_0x61117764C67882B7());
	func_62(&unk, unk_0x367F557725B53815());
	return unk;
}
...
void func_68() // Position - 0x4C32
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		...
		for (j = 0; j < 4; j = j + 1)
		{
			...
			Global_53765[i /*203*/].f_10[j /*48*/].f_2 = { Global_113648.f_21039.f_311[i /*203*/].f_10[j /*48*/].f_2 };
			Global_53765[i /*203*/].f_10[j /*48*/].f_6 = Global_113648.f_21039.f_311[i /*203*/].f_10[j /*48*/].f_6;
		
			for (k = 0; k < 10; k = k + 1)
			{
				Global_53765[i /*203*/].f_10[j /*48*/].f_7[k /*4*/] = { Global_113648.f_21039.f_311[i /*203*/].f_10[j /*48*/].f_7[k /*4*/] };
			}
		}
	}
	...
	for (i = 0; i < 8; i = i + 1)
	{
		...
		Global_55188[i /*53*/].f_6 = { Global_113648.f_21039.f_3442[i /*53*/].f_6 };
		Global_55188[i /*53*/].f_10 = Global_113648.f_21039.f_3442[i /*53*/].f_10;
	
		for (j = 0; j < 10; j = j + 1)
		{
			Global_55188[i /*53*/].f_11[j /*4*/] = { Global_113648.f_21039.f_3442[i /*53*/].f_11[j /*4*/] };
		}
