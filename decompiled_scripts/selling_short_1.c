...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0x3DD
{
	BOOL flag;
...
BOOL func_13(Player plParam0) // Position - 0x475
{
...
int func_15(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4C2
{
	int num;
...
void func_44(Any anParam0) // Position - 0x2AEE
{
...
void func_46(Hash hParam0) // Position - 0x2B5F
{
	if (hParam0 != 0)
...
void func_51(Ped* ppedParam0) // Position - 0x2C5F
{
...
void func_53(Object* pobParam0) // Position - 0x2CC9
{
