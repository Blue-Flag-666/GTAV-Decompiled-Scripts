...
void main() // Position - 0x0
{
	...
	func_35(true);
	unk_0x2A3302E8B9D69CC9("les_1b_mcs_2", 8);
	func_18(true);
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x3DD
{
	BOOL flag;
...
BOOL func_13(int iParam0) // Position - 0x475
{
...
int func_15(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x4C2
{
	int num;
...
void func_25(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2424
{
...
void func_33(var uParam0, int iParam1) // Position - 0x26B6
{
...
void func_34(int iParam0) // Position - 0x2785
{
...
BOOL func_40(int iParam0) // Position - 0x295D
{
	if (iParam0 == 1)
...
void func_44(var uParam0) // Position - 0x2AEE
{
...
void func_51(var uParam0) // Position - 0x2C5F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_53(var uParam0) // Position - 0x2CC9
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
