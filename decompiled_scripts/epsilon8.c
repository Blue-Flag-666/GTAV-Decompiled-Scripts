...
void __EntryFunction__()
{
	...
	MISC::CLEAR_BIT(&(Global_112922.f_18574.f_382), true);
...
void func_31(bool bParam0)
{
	...
	else if (BitTest(Global_112922.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_33() /*5559*/].f_675.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_112922.f_20564.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_33() /*5559*/].f_675.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_32(bParam0));
...
void func_34(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2822371[iParam0 /*3*/][func_35(iParam2)];
	if (iVar0 != 0)
	{
...
int func_39(int iParam0)
{
	...
	return BitTest(Global_2359296[func_33() /*5559*/].f_675.f_10, iParam0);
}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		iVar0 = Global_2822371[iParam0 /*3*/][func_35(iParam1)];
...
void func_84()
{
	...
	{
		if (func_87(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_86(PLAYER::PLAYER_PED_ID());
			if (func_85(iVar0) && (!func_56(14) || Global_111873))
			{
				if (Global_112922.f_2363.f_539.f_4321 != iVar0 && func_85(Global_112922.f_2363.f_539.f_4321))
				{
...
void func_95()
{
	...
	if (iLocal_311 == 1)
	{
		...
		Global_112922.f_18574.f_388 = 1;
	}
	else
	{
		AUDIO::TRIGGER_MUSIC_EVENT("EPS8_PASS");
		Global_112922.f_18574.f_388 = 0;
	}
...
void func_96(int iParam0, bool bParam1)
{
	...
	{
		func_254(&(Global_112009[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_100()
{
	...
	{
		func_57(13, SYSTEM::FLOOR(Global_112922.f_10194.f_3853));
	}
...
int func_122(int iParam0, int iParam1, int iParam2)
{
	...
	Global_77669[1 /*14*/] = { func_170(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_77669[1 /*14*/] = { func_170(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_162(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_162(iParam1), Global_77669[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_162(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, 0);
		}
	}
...
int func_123(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_234(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_64, Global_112922.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_77669[1 /*14*/] = { func_170(iVar10, iParam1, iParam2, -1) };
		if (!func_160(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_77669[1 /*14*/] = { func_170(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_77669[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77669[1 /*14*/] = { func_170(iVar10, 14, uVar28[iVar1], -1) };
							func_141(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
							func_156(14);
							if (Global_77667 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_162(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_162(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_162(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
						}
						func_156(iVar0);
						if (Global_77667 == 1)
						{
			...
			{
				Global_77669[1 /*14*/] = { func_170(iVar10, iVar0, func_131(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77669[1 /*14*/] = { func_170(iVar10, 14, uVar69[iVar1], -1) };
			func_141(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
			func_156(14);
			if (Global_77667 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_162(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_162(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_162(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
		}
		if (Global_77667 == 1)
		{
			iVar2 = 0;
...
{
	Global_77669[1 /*14*/] = { func_170(iParam0, iParam1, iParam2, -1) };
...
void func_156(int iParam0)
{
	...
	{
		func_159(iParam0, Global_77669[1 /*14*/].f_5, Global_77669[1 /*14*/].f_2, 2, Global_77669[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_77669[1 /*14*/].f_6, 1) && BitTest(Global_77669[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_161(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_234(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_61, Global_112922.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_169(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[0], Global_112922.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_169(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[1], Global_112922.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_169(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[2], Global_112922.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_172(int iParam0)
{
	...
	func_173(&(Global_77669[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_40(func_176(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), true);
			}
			uVar0 = func_40(func_175(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_40(iVar1, Global_77666, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_179(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_173(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_173(&(Global_77669[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_173(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_173(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_234(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_234(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_234(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_77669[2 /*14*/] = { func_170(iVar0, 14, iVar4, -1) };
									if (Global_77669[2 /*14*/].f_12 == iVar3)
									{
										if (func_234(iParam0, 14, iVar4))
										{
											if (!func_129(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77669[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_77669[2 /*14*/] = { func_170(iVar0, iVar2, iVar1, -1) };
						if (!func_129(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77669[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77669[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_162(iParam1)) && Global_77669[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_162(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_241(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_242(&sVar32, Var0.f_3, Global_100017, bParam1, bParam2);
	}
}
...
void func_247()
{
	...
	{
		func_84();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_248(Global_112922.f_2363.f_539.f_4321));
	}
	else
	{
...
{
	func_259(iParam0, 1);
	Global_112922.f_18574[iParam0 /*6*/].f_3 = func_258();
...
int func_269()
{
	if ((func_101() == -1 || func_101() == 999) && !func_270() == 0)
	{
		return 1;
	}
	return 0;
							...
							if (MISC::GET_GAME_TIMER() > iLocal_290 + 10000)
							{
								if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_297(PLAYER::PLAYER_PED_ID(), iLocal_615, 0) < 85f)
								{
									if (iLocal_279 < 25)
									{
										...
										if (func_289(PLAYER::PLAYER_PED_ID(), Local_221, 65f) && !func_289(PLAYER::PLAYER_PED_ID(), Local_221, 40f))
										{
											if (!ENTITY::IS_ENTITY_DEAD(iLocal_579, false))
											{
												if (iLocal_360 == 0)
...
void func_310()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_615, false))
	{
		if ((func_64(iLocal_615, PLAYER::PLAYER_PED_ID(), 3f, 1) || func_64(iLocal_615, iLocal_632, 3f, 1)) || func_297(iLocal_615, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1) <= 3f)
		{
...
int func_329(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_336() || func_335(Global_4718592.f_138376)) || func_334())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_330(int iParam0)
{
	if (iParam0 != func_78())
	{
		...
		else if ((Global_1575054 && iParam0 == PLAYER::PLAYER_ID()) && func_331(iParam0, 1, 0))
		{
			return Global_2689224[iParam0 /*451*/].f_317.f_6 != -1;
		}
	}
...
void func_352()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("taxi")) && STREAMING::HAS_MODEL_LOADED(joaat("sadler"))) && STREAMING::HAS_MODEL_LOADED(joaat("habanero"))) && STREAMING::HAS_MODEL_LOADED(joaat("schafter2"))) && STREAMING::HAS_MODEL_LOADED(joaat("rumpo")))
	{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC01"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), Local_650[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(Local_650[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
					if (!CAM::IS_SPHERE_VISIBLE(Local_650[iLocal_910 /*3*/], 8f))
					{
						...
						if (iLocal_910 > 4 || func_289(PLAYER::PLAYER_PED_ID(), Local_158, 150f))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC02"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), Local_696[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(Local_696[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC03"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), Local_742[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), Local_742[iLocal_910 /*3*/], 220f)) && !MISC::IS_POSITION_OCCUPIED(Local_742[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC04"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), Local_788[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(Local_788[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC05"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), Local_834[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), Local_834[iLocal_910 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(Local_834[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC06"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), Local_880[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), Local_880[iLocal_910 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(Local_880[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (bParam2)
		{
			if (!Global_77858)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_359(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_359(iParam0) };
...
void func_368()
{
	...
	switch (iLocal_567)
	{
		...
		case 2:
			...
			if (Global_112922.f_18574.f_387 == 0)
			{
				func_378(0, 29, 50000);
				Global_112922.f_18574.f_387 = 1;
			}
			func_369(1, 1, 1, 1);
			if (func_19(iLocal_632))
			{
...
void func_383(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103486.f_4))
	{
		...
		{
			if (func_430(24) != Global_103486.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_427(ENTITY::GET_ENTITY_COORDS(Global_103486.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_384(Global_103486.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_384(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_418(iParam5, &Var0, Param1, fParam4, func_421(iParam0));
...
void func_385(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_415(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_112922.f_32749.f_4801 = func_404();
			}
...
void func_386(int iParam0, int iParam1)
{
	...
	func_422(iParam0, &(Global_112922.f_32749.f_5510));
}
...
int func_415(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_341(Global_112922.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_341(Global_112922.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_341(Global_112922.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_418(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_415(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_420(iParam0);
			func_419(uParam1, &(Global_112922.f_32749.f_69[Global_76676.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_439(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_319(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
	...
	while (iVar28 <= 14)
	{
		...
		if (iVar0 != 12 && iVar0 != 14)
		{
			...
			else
			{
				...
				{
					Var1.f_3 = Global_112922.f_2363.f_539[Var1.f_5 /*65*/].f_13[iVar28];
					Var1.f_4 = Global_112922.f_2363.f_539[Var1.f_5 /*65*/][iVar28];
				}
...
int func_446(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_449()
{
	...
	if (func_19(Local_83.f_35[0]))
	{
		...
		{
			func_446(iLocal_616[0], Local_162[0 /*3*/], fLocal_233[0], 0, 1);
	...
	if ((((iLocal_568 == 3 || iLocal_568 == 4) || iLocal_568 == 5) || iLocal_568 == 6) || iLocal_568 == 7)
	{
		...
		if (!func_299() || !iLocal_353 == 1)
		{
			if (iLocal_311 == 1)
			{
				...
				if (!BitTest(Global_112922.f_18574.f_382, 1))
				{
					MISC::SET_BIT(&(Global_112922.f_18574.f_382), true);
				}
				iLocal_568 = 8;
			}
		}
	...
	if (Global_78112 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_464(Global_78113, Global_78115, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
{
	if (((!func_475(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
...
{
	return func_477(iParam0, Global_42602);
}
...
int func_483(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_101() == 0)
		{
			return BitTest(func_40(func_481(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_487(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_20(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_488(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_17(iParam0);
...
int func_492(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	struct<15> Var0;
	bool bVar15;
...
int func_509()
{
	...
	iVar0 = func_510(&(Global_99980.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_513()
{
	...
	{
		if (func_508(&(Global_99980.f_3)) > -1)
		{
			return 1;
		}
	}
