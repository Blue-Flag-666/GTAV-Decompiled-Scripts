					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_55, false))
					{
						if (!PED::IS_PED_INJURED(pedLocal_54))
						{
							if (PED::IS_PED_SITTING_IN_VEHICLE(pedLocal_53, veLocal_55))
							{
								...
								{
									TASK::CLEAR_PED_TASKS(pedLocal_52);
									TASK::TASK_ENTER_VEHICLE(pedLocal_52, veLocal_55, &func_107, 0, 1f, 1, 0);
									PED::SET_PED_KEEP_TASK(pedLocal_52, true);
								}
							}
						}
...
void func_7() // Position - 0x128D
{
	switch (iLocal_49)
	{
		...
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_55, false))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_289 > &func_107)
				{
					if (!PED::IS_PED_INJURED(pedLocal_54))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_54, SCRIPT_TASK_VEHICLE_MISSION) == 7)
...
BOOL _GET_RANDOM_BOOL() // Position - 0x13CA
{
...
void func_15(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1CC6
{
	int outValue;
	Hash statHash;
...
void func_19(int iParam0) // Position - 0x2673
{
	BOOL flag;
	var txdName;
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_21() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), iParam0);
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x27ED
{
	switch (iParam0)
	{
		case 0:
...
Hash func_23(int iParam0, int iParam1) // Position - 0x2920
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_24(iParam1));
}

int func_24(int iParam0) // Position - 0x2935
{
	int num;
	int num2;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2975
{
	if (iParam2 == -1)
		iParam2 = func_25();
...
BOOL func_28(int iParam0) // Position - 0x29B3
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x2B82
{
	if (iParam1 == -1)
		iParam1 = func_25();
...
BOOL func_34(var uParam0, int iParam1) // Position - 0x2D0D
{
	int i;
	var unk;
...
void func_39(var uParam0, int iParam1) // Position - 0x2E8E
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_44(int iParam0) // Position - 0x2F04
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_46(int iParam0, int iParam1) // Position - 0x2F62
{
...
void func_47(Hash hParam0, int iParam1) // Position - 0x2FB3
{
	int outValue;
...
int func_50(eCharacter echParam0) // Position - 0x30A8
{
	return Global_2058[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x30B9
{
	func_52();
...
void func_52() // Position - 0x30D2
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_53(character) && !func_45(14) || Global_112760)
			{
...
BOOL func_53(eCharacter echParam0) // Position - 0x31CF
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x31DB
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3218
{
...
Hash func_56(eCharacter echParam0) // Position - 0x323D
{
	return Global_2058[echParam0 /*29*/];
}

BOOL func_57() // Position - 0x324C
{
	float xSize;
			...
			case 1:
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					if (!PED::IS_PED_INJURED(pedLocal_53))
					{
						...
						PED::SET_PED_KEEP_TASK(pedLocal_53, true);
						ENTITY::SET_ENTITY_HEALTH(pedLocal_53, 101, 0);
...
int func_73(Ped pedParam0, Vehicle veParam1) // Position - 0x3FAD
{
	var entityCoords;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x413B
{
...
BOOL func_76(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x4189
{
	Global_21846 = 0;
...
BOOL func_79(Player plParam0) // Position - 0x44F1
{
	return func_80(plParam0, 20);
}

BOOL func_80(Player plParam0, int iParam1) // Position - 0x4501
{
	return IS_BIT_SET(Global_1895156[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x4519
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x46A9
{
	if (func_45(14))
	{
...
void func_89(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x47DB
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x4831
{
...
BOOL func_92(int iParam0) // Position - 0x4894
{
	var groundZ;
	var normal;
...
float func_93(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x48C4
{
	return (fParam0 * fParam3) + (fParam0.f_1 * fParam3.f_1) + (fParam0.f_2 * fParam3.f_2);
}

BOOL func_94() // Position - 0x48E5
{
	return false;
}

BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x48EE
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_97(int iParam0) // Position - 0x49F1
{
	BOOL num;
	int num2;
	Vector3 vector;
...
int func_98(BOOL bParam0) // Position - 0x4A9B
{
	if (func_103())
	{
		Global_113800 = true;
		...
		if (bParam0 && func_102(Global_113799))
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x4BC9
{
...
BOOL func_102(int iParam0) // Position - 0x4C24
{
	switch (iParam0)
	{
		case 29:
...
BOOL func_103() // Position - 0x4C53
{
	switch (func_104(&Global_32343, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x4E0F
{
	return func_107(iParam0, Global_43377);
}

BOOL func_107(int iParam0, int iParam1) // Position - 0x4E20
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_108(int iParam0) // Position - 0x5001
{
	if (Global_43377 == 15)
		return false;
...
Blip func_110(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x5141
{
	Blip blip;
...
Blip func_111(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x518B
{
	Blip blip;
...
var func_112(BOOL bParam0, var uParam1, var uParam2) // Position - 0x522F
{
	if (bParam0)
		return uParam1;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x57A3
{
...
int func_134(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x75F3
{
...
BOOL func_135(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x77CD
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
...
BOOL func_136(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x7B67
{
	if (bParam6)
...
BOOL func_137(eCharacter echParam0) // Position - 0x7BAE
{
	int num;
...
BOOL func_138(int iParam0) // Position - 0x7BCF
{
...
var func_149(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7FA1
{
	if (bParam0)
		return uParam1;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x7FC5
{
	int num;
	int num2;
...
BOOL func_159(int iParam0) // Position - 0x82D2
{
	int num;
	int num2;
	int num3;
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x83AE
{
...
BOOL func_161(int iParam0) // Position - 0x83CE
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_169() || Global_112857 || Global_32286 || func_168() || func_88(8, -1) || func_167() || func_166() || func_165() || func_164() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_169() || Global_32286 || func_168() || func_88(8, -1) || func_165() || func_167() || func_166() || func_164() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_169() || Global_112857 || Global_32286 || func_168() || func_88(8, -1) || func_165() || func_167() || func_166() || func_164() || Global_113810.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_169() || Global_112857 || Global_32286 || func_168() || func_88(8, -1) || func_167() || func_166() || func_164() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_169() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_88(8, -1) || func_164() || func_163() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_162() // Position - 0x8AEB
{
	return Global_100872.f_1;
}

BOOL func_163() // Position - 0x8AF9
{
	if (Global_97735 != -1)
...
BOOL func_168() // Position - 0x8B82
{
	return Global_1575063;
}

BOOL func_169() // Position - 0x8B8E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_172(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x8BE4
{
	BOOL num;
	eCharacter character;
...
int func_173(eCharacter echParam0) // Position - 0x8CC8
{
...
BOOL func_174(int iParam0) // Position - 0x8CEC
{
	int num;
	BOOL flag;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8D88
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x8DB0
{
	int profileSetting;
...
void func_202(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA3A9
{
	int i;
...
BOOL func_204(int iParam0) // Position - 0xA694
{
	int num;
	int i;
...
void func_208() // Position - 0xA706
{
	if (!bLocal_72 && iLocal_49 == 0)
	{
		if (!PED::IS_PED_INJURED(pedLocal_52) && !PED::IS_PED_INJURED(pedLocal_53))
		{
			TASK::TASK_GO_STRAIGHT_TO_COORD(pedLocal_52, ENTITY::GET_ENTITY_COORDS(pedLocal_53, true), 3f, &func_107, 1193033728, 1056964608);
			PED::SET_PED_KEEP_TASK(pedLocal_52, true);
			SYSTEM::WAIT(0);
		}
	}
