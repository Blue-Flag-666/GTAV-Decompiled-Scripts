...
{
	return !IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_839, 4) && !func_31();
}
...
BOOL func_46() // Position - 0xB41
{
	...
	return IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_839, 5);
}
...
{
	return IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_839, 3);
}
...
{
	return IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_839, 2);
}
...
BOOL func_62(Player plParam0) // Position - 0xE2D
{
	if (plParam0 > -1)
	{
		if (Global_2657704[plParam0 /*463*/].f_246 > -1)
			if (func_63(Global_2657704[plParam0 /*463*/].f_246) == 4)
				return true;
	
		if (IS_BIT_SET(Global_2657704[plParam0 /*463*/].f_199, 4))
			return true;
	}
...
{
	return plParam0 != -1 && IS_BIT_SET(Global_1853988[plParam0 /*867*/].f_839, 1);
}
...
{
	return IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_839, 1);
}
...
{
	return IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_839, 6);
}
