...
void __EntryFunction__()
{
	...
	{
		func_376("Force cleanup [TERMINATING]");
		func_353(1);
		func_338(1);
	}
	if (func_337())
	...
	if (!func_337())
	{
		if ((func_319(Local_82.f_28[0]) && func_319(PLAYER::PLAYER_PED_ID())) && !func_318(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		func_301(Local_82.f_9, 0, 0, 0, 0, 0);
		...
		{
			if (func_319(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668,882f, -19,65248f, 172,6748f, 1653,855f, 8,008027f, 175,0248f, 7f, false, true, 0))
			{
				if (func_319(Local_155.f_0))
				{
					if (func_318(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 10f, 1))
					{
						func_299();
					}
				}
	...
	switch (iLocal_149)
	{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_178))
			{
				...
				{
					if (func_318(PLAYER::PLAYER_PED_ID(), iLocal_178, 1f, 1))
					{
		...
		case 2:
			...
			{
				if (func_213(&uLocal_182, "EXT4AUD", "EXT4_WIL2", 8, 0, 0, 0))
				{
					func_9();
				}
			}
...
void func_231()
{
	...
	func_232(&uLocal_182, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_213(&uLocal_182, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}
...
void func_233(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_234(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_240(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_238(PLAYER::PLAYER_ID())) && !func_236(PLAYER::PLAYER_ID(), 0)) && !func_235()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_238(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_77856 = 0;
...
int func_240(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
				...
				if (func_262(1, 20f, 1))
				{
					if ((!iLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658,95f, -5,45f, 173,78f, 0,2f, 0,2f, 0,2f, false, true, 0))
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							func_253(1654,721f, 4,166876f, 172,5245f, 1662,562f, -8,920052f, 178,2742f, 6,25f, Local_348, fLocal_351, 1, 1, 1, 0, 0);
						}
						else
						{
							Local_348 = { 1649,793f, 11,7826f, 172,7745f };
							fLocal_351 = 220,9923f;
							func_252(Local_348, fLocal_351);
						}
						func_249(1660,186f, -7,492f, 172,774f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
...
void func_251(bool bParam0)
{
	...
	func_234(1, 1, 0, 0, 0, 0, 0);
}

void func_252(struct<3> Param0, float fParam3)
{
	int iVar0;
...
int func_262(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_269()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (((((((PAD::IS_CONTROL_PRESSED(0, 30) || PAD::IS_CONTROL_PRESSED(0, 31)) || PAD::IS_CONTROL_PRESSED(0, 23)) || PAD::IS_CONTROL_PRESSED(0, 21)) || PAD::IS_CONTROL_PRESSED(0, 22)) || (func_281() && PAD::IS_CONTROL_PRESSED(0, 1))) || (func_281() && PAD::IS_CONTROL_PRESSED(0, 2))) || (func_281() && PAD::IS_CONTROL_PRESSED(0, 32)))
			{
	...
	{
		case 0:
			if (func_319(Local_82.f_28[0]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_82.f_28[0], 17, true);
			}
			iLocal_368 = 0;
			iLocal_383 = 1;
			func_280("EXT4_01", 7500, 1);
			iLocal_170 = func_279(Local_155.f_0, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_149 = 1;
			break;
		...
		case 1:
			...
			if (func_319(PLAYER::PLAYER_PED_ID()))
			{
				if (func_319(Local_155.f_0))
				{
					if (func_318(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 100f, 1))
					{
						CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
					...
					if (func_318(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 32f, 1))
					{
						if (func_273(Local_155.f_0, 1, 0, 0, 0))
						{
							if (iLocal_169 == 0)
							{
								if (!func_268())
								{
									func_272(&uLocal_182, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_1", 7, 0, 0);
									iLocal_169 = 1;
								}
							}
							else if (iLocal_169 == 1)
							{
								if (!func_268())
								{
									func_272(&uLocal_182, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_2", 7, 0, 0);
									iLocal_169 = 2;
								}
							}
						}
						else
						{
							if (!iLocal_378)
							{
								if (func_318(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 30f, 1) && !func_268())
								{
									if (func_213(&uLocal_182, "EXT4AUD", "EXT4_COMM", 7, 0, 0, 0))
									{
										iLocal_378 = 1;
									}
								}
	...
	if (!func_268())
	{
		if (iLocal_368 < 5)
		{
			if (MISC::GET_GAME_TIMER() > (iLocal_369 + (8000 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))))
			{
				...
				{
					if (func_213(&uLocal_182, "EXT4AUD", "EXT4_DOM", 6, 0, 0, 0))
					{
...
int func_279(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_282()
{
	...
	{
		func_292(1732,133f, 91,9424f, 169,7872f, 128,6917f, 1, 0);
		func_290(0, -1, 1);
...
void func_283()
{
	if (func_230(Local_82.f_28[0]))
	{
		func_287(Local_82.f_28[0], 1737,453f, 101,7498f, 170,0243f, 288,5211f, 0, 1);
	}
	else
	{
		func_284(&(Local_82.f_28[0]), 1737,453f, 101,7498f, 170,0243f, 288,5211f);
	}
	...
	if (func_319(Local_155.f_0))
	{
		...
		func_232(&uLocal_182, 4, Local_155.f_0, "DOM", 0, 1);
...
void func_284(int* iParam0, struct<3> Param1, float fParam4)
{
	func_285(iParam0, iLocal_81, Param1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_285(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_286(iParam0);
...
int func_287(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_292(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_337())
	{
...
void func_293()
{
	switch (iLocal_150)
	{
		case 0:
			...
			if (func_295(1, 1093140480, 0))
			{
				if (!iLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3500)
				{
					...
					SYSTEM::WAIT(0);
					CAM::STOP_GAMEPLAY_HINT(false);
					func_253(1729,922f, 89,4162f, 174,0123f, 1739,745f, 101,2816f, 167,8282f, 7f, 1739,956f, 97,8651f, 169,9797f, 140,876f, 1, 1, 1, 0, 0);
					func_253(1743,115f, 105,833f, 169,6362f, 1732,029f, 93,77112f, 172,6075f, 4f, 1739,956f, 97,8651f, 169,9797f, 140,876f, 1, 1, 1, 0, 0);
					func_249(1733,315f, 95,2246f, 169,9192f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
					iLocal_150 = 1;
				}
			}
			break;
		...
		case 2:
			func_287(PLAYER::PLAYER_PED_ID(), 1732,222f, 92,0087f, 169,7867f, 138,1854f, 0, 1);
			PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Walk"), false, 1, false);
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1723,452f, 80,729f, 169,6701f, 1f, -1, 1f, 2113, 40000f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
...
void func_298()
{
	...
	fVar3 = -0,85f;
	fVar4 = 0f;
	if (((!func_337() && func_319(Local_82.f_28[0])) && func_319(PLAYER::PLAYER_PED_ID())) && iLocal_383 == 1)
	{
		...
		{
			if (func_318(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 4f, 1))
			{
...
{
	if (((!func_315(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_314(0)) || func_313(1))
			{
			}
			else
			{
...
{
	return func_317(iParam0, Global_42602);
}
...
void func_320()
{
	...
	{
		func_321(&Local_155, 52, Local_155.f_1, Local_155.f_4, "Ext4-Dom", 1);
...
int func_321(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_322(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_325(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 160)
	{
		...
		{
			if (func_329(iParam0, iParam1) == 1 && func_328(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
		...
		if (bParam2)
		{
			if (!Global_77858)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_327(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_327(iParam0) };
...
int func_332(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_336(&(uParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_79 = 1;
			break;
		...
		case 2:
			func_284(&(uParam0->f_28[0]), 1732,27f, 96,36f, 170,29f, -98,56f);
...
void func_336(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_338(int iParam0)
{
	...
	func_350(&iLocal_176, 0);
	func_350(&iLocal_177, 0);
	func_350(&iLocal_178, 0);
	TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", true);
	func_339(&Local_82, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_339(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_347(uParam0, iParam1);
	func_342(uParam0, bParam2);
	func_340(uParam0, bParam3);
}

void func_340(var uParam0, bool bParam1)
{
	func_341(&(uParam0->f_41), bParam1);
}
...
void func_349(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
{
	func_339(&Local_82, 1, 0, 0);
	func_349(&(Local_82.f_28[0]), 1, 0, 1);
...
int func_357()
{
	...
	iVar0 = func_358(&(Global_99980.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_361()
{
	...
	{
		if (func_356(&(Global_99980.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_378(&(uParam0->f_28));
	func_378(&(uParam0->f_35));
	func_378(&(uParam0->f_41));
}
