...
void main() // Position - 0x0
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		while (iLocal_39 == 0)
		{
			...
			{
				iLocal_39.f_1 = func_46(uScriptParam_0);
				iLocal_39.f_2 = func_45();
				iLocal_39 = 1;
			}
			else
			{
	...
	while (true)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1579668 == 0 || func_28())
			func_25();
...
void func_1() // Position - 0xE4
{
	...
	if (iLocal_38 == 1)
	{
		...
		if (num > -1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_42[num /*47*/]) && !ENTITY::IS_ENTITY_DEAD(uLocal_42[num /*47*/], false))
			{
				AUDIO::PLAY_STREAM_FROM_PED(uLocal_42[num /*47*/]);
				iLocal_38 = iLocal_38 + 1;
			}
		}
	}
	...
	if (iLocal_38 == 2)
	{
		...
		{
			num2 = SYSTEM::TO_FLOAT(iLocal_39.f_1) / 5f;
...
int func_2() // Position - 0x16F
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		if (uLocal_42[i /*47*/].f_46 <= iLocal_39.f_1)
		{
			num2 = SYSTEM::VDIST(uLocal_42[i /*47*/].f_40, 945f, 15f, 117f);
...
void func_3() // Position - 0x1D4
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		if (func_22(&uLocal_42[i /*47*/]))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_42[i /*47*/]))
				func_12(&uLocal_42[i /*47*/]);
			else if (ENTITY::IS_ENTITY_DEAD(uLocal_42[i /*47*/], false))
				func_11(&uLocal_42[i /*47*/]);
		
			func_4(&uLocal_42[i /*47*/]);
		}
	}
...
BOOL func_6(var uParam0) // Position - 0x42F
{
	switch (uParam0->f_44)
	{
		case 2:
...
BOOL func_7(var uParam0) // Position - 0x44B
{
	switch (uParam0->f_44)
	{
		case 0:
...
BOOL func_9(var uParam0) // Position - 0x704
{
	switch (uParam0->f_2)
	{
		case 0:
...
void func_11(Ped* ppedParam0) // Position - 0xB76
{
...
Hash func_16(var uParam0) // Position - 0xF5C
{
	switch (uParam0->f_44)
	{
		case 1:
...
BOOL func_17(var uParam0) // Position - 0xFCE
{
	switch (uParam0->f_44)
	{
		case 1:
...
Hash func_19(var uParam0) // Position - 0x10BE
{
	switch (uParam0->f_2)
	{
		case 0:
...
BOOL func_20(var uParam0) // Position - 0x125B
{
	if (func_22(uParam0))
	{
...
BOOL func_22(var uParam0) // Position - 0x131E
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1357
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x13E3
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1467
{
	switch (func_32())
	{
		case 0:
...
int func_46(var uParam0) // Position - 0x83DE
{
	if (uParam0 >= Global_262145.f_27054)
		return 5;
	else if (uParam0 >= Global_262145.f_27053)
		return 4;
	else if (uParam0 >= Global_262145.f_27052)
		return 3;
	else if (uParam0 >= Global_262145.f_27051)
		return 2;
...
void func_47() // Position - 0x8430
{
	...
	Global_1579683 = Global_1579683 + 1;
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_39, 3, 0);
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x8469
{
	int i;
