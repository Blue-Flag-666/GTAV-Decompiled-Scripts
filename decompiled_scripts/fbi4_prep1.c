	...
	switch (iLocal_684)
	{
		case 0:
			...
			if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			{
				...
				if (func_37(num) && unk_0x504B9BB48D41C264(num) == joaat("towtruck"))
					func_36(num, 2);
			}
...
void func_3() // Position - 0x274
{
	...
	func_6(&iLocal_109);
	func_5(&uLocal_111[0 /*11*/], 1, 0, 1);
	func_5(&uLocal_111[1 /*11*/], 1, 0, 1);
...
void func_39() // Position - 0x1626
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			if (!func_107(unk_0xC1A5EC5C986B98AD(), uLocal_827, 270f, 1))
				iLocal_684 = 2;
...
void func_43(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1822
{
	...
	else
	{
		...
		if (unk_0xA26A9A07F761D8F8())
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_48(unk_0x93E99A2DBCBA9CFA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !func_44() && !bParam4 && !bParam5 && !unk_0x8253CEEA17ED481B())
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x1989
{
	BOOL flag;
...
BOOL func_48(int iParam0) // Position - 0x1A21
{
...
int func_50(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1A6E
{
	int num;
...
BOOL func_78(int iParam0, int iParam1) // Position - 0x25C4
{
	return false;
}

int func_79(eCharacter echParam0) // Position - 0x261D
{
...
BOOL func_87(int iParam0, int iParam1) // Position - 0x2ACF
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, eCharacter echParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2F17
{
...
BOOL func_106(char* sParam0, int iParam1, int iParam2) // Position - 0x314D
{
...
BOOL func_107(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x316B
{
...
{
	func_215(&iLocal_874, &uLocal_875, &iLocal_686, &uLocal_822, &uLocal_821, uLocal_827, iLocal_868, false, 1090519040);
	func_214();
	func_155();
	...
	switch (iLocal_684)
	{
		...
		case 1:
			...
			if (func_113(iLocal_874, uLocal_827, &uLocal_821, iLocal_686, iLocal_685, &iLocal_836, &iLocal_839, &iLocal_835, &iLocal_834, &iLocal_820, 1090519040))
			{
				if (!func_112())
				{
					if (func_67(&uLocal_687, &uLocal_1044, &uLocal_879))
		...
		case 3:
			if (func_37(iLocal_868))
			{
				if (!unk_0xE0D346789C5160EB(unk_0xC1A5EC5C986B98AD(), iLocal_868, 0))
				{
					unk_0x4C18E9202CF6CACA(unk_0xC1A5EC5C986B98AD(), iLocal_868, -1);
				}
				else
				{
					func_109(iLocal_868, uLocal_827, 126.0705f, false, 1);
					func_40(1, 1, 1);
					iLocal_684 = 1;
				}
			}
...
BOOL func_109(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x32DC
{
	BOOL flag;
	float num;
...
BOOL func_113(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12) // Position - 0x33BF
{
	float num;
		...
		if (iParam6 == 0)
		{
			...
			else
			{
				if (*uParam7)
				{
					...
					if (func_107(unk_0xC1A5EC5C986B98AD(), uParam1, num, 1))
					{
						*uParam7 = 0;
	...
	else
	{
		...
		if (!*uParam8)
		{
			if (func_106(func_115(func_77(), false), 0, 0))
				unk_0x4A77CD96EFFC63F4(func_115(func_77(), false));
...
void func_117(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x36AF
{
	if (!unk_0xCE4AAA035282336C(*uParam0))
		*uParam0 = func_118(uParam1, 5, iParam4);

	return;
}

int func_118(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x36D0
{
	int num;
...
void func_120(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, var uParam7) // Position - 0x3757
{
	switch (*uParam4)
	{
		case 0:
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_149(1, uLocal_824, 0))
			{
				...
				else if (func_149(2, iLocal_868.f_1, iLocal_868.f_4) && func_149(3, iLocal_840.f_1, iLocal_840.f_4) && func_149(4, iLocal_854.f_1, iLocal_854.f_4) && func_141(false))
				{
					func_142();
					func_147(33);
				
					if (func_343(iLocal_840))
						func_140(iLocal_840);
				
					if (func_343(iLocal_854))
						func_139(iLocal_854);
				
					func_138(iLocal_868);
				
					if (func_343(iLocal_854) && func_343(iLocal_840))
					...
					if (unk_0x083A079256401BA8(iLocal_868) != 0)
					{
						unk = unk_0x083A079256401BA8(iLocal_868);
						unk_0xC9BB10E64C4DE9F9(1);
						func_7(&unk);
						unk_0xC9BB10E64C4DE9F9(0);
					}
				
					func_125(&uLocal_821, iLocal_868, 1);
					func_144(190, 1244.338f, -339.3197f, 68.0823f);
					unk_0x2112CE9FD54D593A("DRIVE", 0);
					unk_0x2112CE9FD54D593A("WORLD_VEHICLE_ATTRACTOR", 0);
					unk_0x2112CE9FD54D593A("WORLD_VEHICLE_DRIVE_PASSENGERS", 0);
		...
		case 1:
			if (bParam1)
			{
				if (func_149(2, iLocal_868.f_1, iLocal_868.f_4) && func_149(3, iLocal_840.f_1, iLocal_840.f_4) && func_149(4, iLocal_854.f_1, iLocal_854.f_4))
				{
					func_124(unk_0xC1A5EC5C986B98AD(), 1197.8611f, -353.011f, 68.0929f, 278.9647f);
					func_123();
					bLocal_28 = false;
					unk_0x2112CE9FD54D593A("DRIVE", 0);
					unk_0x2112CE9FD54D593A("WORLD_VEHICLE_ATTRACTOR", 0);
		...
		case 2:
			if (bParam1)
			{
				if (func_149(2, iLocal_868.f_1, iLocal_868.f_4))
				{
					func_123();
					func_142();
					unk_0x4C18E9202CF6CACA(unk_0xC1A5EC5C986B98AD(), iLocal_868, -1);
		...
		case 3:
			if (bParam1)
			{
				if (func_149(2, uLocal_827, iLocal_868.f_4))
				{
					func_123();
					unk_0x4C18E9202CF6CACA(unk_0xC1A5EC5C986B98AD(), iLocal_868, -1);
					func_142();
...
void func_124(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x3BB0
{
	if (func_343(iParam0))
		unk_0x909F139DC199D8E0(iParam0);

	func_109(iParam0, fParam1, fParam4, false, 1);
	return;
}

void func_125(var uParam0, int iParam1, int iParam2) // Position - 0x3BD6
{
	if (!unk_0xCE4AAA035282336C(*uParam0))
		*uParam0 = func_126(iParam1, iParam2, 5);

	return;
}

int func_126(int iParam0, int iParam1, int iParam2) // Position - 0x3BF5
{
	int num;
...
void func_127(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x3C2A
{
	...
	unk_0x8386356641D0DED1(uLocal_111[0 /*11*/], uLocal_80);
	unk_0x8386356641D0DED1(uLocal_111[1 /*11*/], uLocal_80);
	unk_0xB0F23B683F51C9F0(uLocal_111[0 /*11*/], 1, 0);
	unk_0xB0F23B683F51C9F0(uLocal_111[1 /*11*/], 1, 0);
...
{
	if (!unk_0xE0D346789C5160EB(uLocal_111[0 /*11*/], iLocal_109, 0))
	{
		unk_0x7D9A648CC1936BDA(uLocal_111[0 /*11*/], unk_0x7394CB479CCA24AF(iLocal_109, func_137(true)), 1f, -1, 1048576000, 0, 1193033728);
...
void func_130(BOOL bParam0) // Position - 0x3D81
{
	if (!unk_0x9CFCDD9C62B56708(iLocal_109, 0, 0))
	{
		...
		{
			if (iLocal_661 == 4)
				unk_0x7F2FC190789087ED(uLocal_111[0 /*11*/], iLocal_109, uLocal_134[iLocal_661 /*25*/], 15f, 2883755, uLocal_134[iLocal_661 /*25*/].f_6);
			else
				unk_0xC562419B5DA3BB96(uLocal_111[0 /*11*/], iLocal_109, uLocal_134[iLocal_661 /*25*/], 15f, 0, 0, 2883755, uLocal_134[iLocal_661 /*25*/].f_6, uLocal_134[iLocal_661 /*25*/].f_7);
		...
		{
			unk_0xA6B22576A5268171(uLocal_111[0 /*11*/], iLocal_109, 15f, 786599);
			uLocal_111[0 /*11*/].f_8 = uLocal_111[0 /*11*/].f_7;
...
void func_131(BOOL bParam0) // Position - 0x3E63
{
	if (iLocal_661 != -1)
		if (!_IS_NULL_VECTOR(uLocal_134[iLocal_661 /*25*/].f_11) && !_IS_NULL_VECTOR(uLocal_134[iLocal_661 /*25*/].f_14))
			unk_0x8E09E8C52602EBB2(uLocal_134[iLocal_661 /*25*/].f_11 - uLocal_134[iLocal_661 /*25*/].f_14, uLocal_134[iLocal_661 /*25*/].f_11 + uLocal_134[iLocal_661 /*25*/].f_14, 1, 1);
	...
	if (iLocal_661 != -1)
		if (!_IS_NULL_VECTOR(uLocal_134[iLocal_661 /*25*/].f_11) && !_IS_NULL_VECTOR(uLocal_134[iLocal_661 /*25*/].f_14))
			unk_0x8E09E8C52602EBB2(uLocal_134[iLocal_661 /*25*/].f_11 - uLocal_134[iLocal_661 /*25*/].f_14, uLocal_134[iLocal_661 /*25*/].f_11 + uLocal_134[iLocal_661 /*25*/].f_14, 0, 1);
...
int func_132() // Position - 0x3F45
{
	...
	{
		unk = { unk_0x30BE8A934C020461(iLocal_109, 1) };
	
		for (i = 0; i <= iLocal_81 - 1; i = i + 1)
		{
			num3 = unk_0x2E496FE654DA4166(unk, uLocal_134[i /*25*/], 1);
		
			if (!_IS_NULL_VECTOR(uLocal_134[i /*25*/]) && num3 > 25f)
				unk4[i] = num3;
			else
				unk4[i] = -1f;
		}
		...
		num5 = func_133(uLocal_134[num /*25*/] - unk, unk_0x26A9C8234C71B669(iLocal_109));
		num2 = num;
		...
		for (j = 0; num5 < 0f && j < 40; j = j + 1)
		{
			...
			unk = { unk_0x30BE8A934C020461(iLocal_109, 1) };
			num5 = func_133(uLocal_134[num2 /*25*/] - unk, unk_0x26A9C8234C71B669(iLocal_109));
		}
...
int func_135() // Position - 0x41A9
{
	...
	for (i = unk_0x15A88CFAAFFC6C4B(0, iLocal_81 - 1); uLocal_134[i /*25*/].f_18; i = unk_0x15A88CFAAFFC6C4B(0, iLocal_81 - 1))
	{
	}
...
Vector3 func_137(BOOL bParam0) // Position - 0x4201
{
	...
	if (!bParam0)
		unk4 = unk_0xD854D152961C41A9(iLocal_109, "wheel_rf");
	else
		unk4 = unk_0xD854D152961C41A9(iLocal_109, "wheel_lf");

	unk = { unk_0x3C289AF334341CC6(iLocal_109, unk4) };
	unk = { unk_0x5DC36ABEC3A264E9(iLocal_109, unk) };
...
void func_145(var uParam0, char* sParam1, int iParam2) // Position - 0x4415
{
	char* str;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x44EF
{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (func_37(Global_97178[0]))
			{
				...
				iLocal_868 = Global_97178[0];
			
				if (func_37(iLocal_868))
				{
					func_36(iLocal_868, 0);
					unk_0x5BC68FEFF4902C2B(iLocal_868, 1);
					unk_0xAD02BD8A749B79F9(iLocal_868, 1);
					return true;
				}
			}
			else if (func_153(&iLocal_868, iLocal_868.f_5, iLocal_868.f_1, iLocal_868.f_4, true))
			{
				func_36(iLocal_868, 0);
				unk_0x5BC68FEFF4902C2B(iLocal_868, 1);
				unk_0xAD02BD8A749B79F9(iLocal_868, 1);
		...
		case 3:
			if (unk_0x7DE17ACDD8BA2642(Global_97178.f_9[0]))
			{
				if (!unk_0xE678B2045145CE41(Global_97178.f_9[0], 1))
				{
					...
					iLocal_840 = Global_97178.f_9[0];
				
					if (func_343(iLocal_840))
					{
						unk_0xC5B2830898581862(iLocal_840, 1);
						unk_0x598D91BBD045C1F3(iLocal_840, 170, 0);
						unk_0x474AA9EF29305EA8(iLocal_840, 65536, 1);
						unk_0x7FE5E05BE63F6CB8(iLocal_840, 50, 1);
						return true;
					}
				}
				else
			...
			else if (func_150(&iLocal_840, iLocal_840.f_5, iLocal_840.f_1, iLocal_840.f_4, true, false, true, true))
			{
				if (func_37(iLocal_868))
				{
					unk_0x4C18E9202CF6CACA(iLocal_840, iLocal_868, -1);
					unk_0xC5B2830898581862(iLocal_840, 1);
					unk_0x598D91BBD045C1F3(iLocal_840, 170, 0);
					unk_0x474AA9EF29305EA8(iLocal_840, 65536, 1);
					unk_0x7FE5E05BE63F6CB8(iLocal_840, 50, 1);
		...
		case 4:
			if (unk_0x7DE17ACDD8BA2642(Global_97178.f_9[1]))
			{
				if (!unk_0xE678B2045145CE41(Global_97178.f_9[1], 1))
				{
					...
					iLocal_854 = Global_97178.f_9[1];
				
					if (func_343(iLocal_854))
					{
						unk_0x598D91BBD045C1F3(iLocal_854, 170, 0);
						unk_0x474AA9EF29305EA8(iLocal_854, 65536, 1);
						unk_0x7FE5E05BE63F6CB8(iLocal_854, 50, 1);
						unk_0xC5B2830898581862(iLocal_854, 1);
						unk_0x351E6B9FD37CFF33(iLocal_854, 1, 1);
						return true;
					}
				}
				else
			...
			else if (func_150(&iLocal_854, iLocal_854.f_5, iLocal_854.f_1, iLocal_854.f_4, true, false, true, true))
			{
				if (func_37(iLocal_868))
				{
					unk_0x4C18E9202CF6CACA(iLocal_854, iLocal_868, 0);
					unk_0x598D91BBD045C1F3(iLocal_854, 170, 0);
					unk_0x474AA9EF29305EA8(iLocal_854, 65536, 1);
					unk_0x7FE5E05BE63F6CB8(iLocal_854, 50, 1);
					unk_0xC5B2830898581862(iLocal_854, 1);
...
BOOL func_150(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x483F
{
	if (!unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_151(var uParam0, BOOL bParam1) // Position - 0x48C9
{
	if (bParam1)
...
BOOL func_152(var uParam0, char* sParam1, int iParam2) // Position - 0x48EE
{
...
BOOL func_153(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x491D
{
	if (!unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_156(var uParam0, int iParam1) // Position - 0x4A73
{
	if (func_343(*uParam0))
	{
		func_202(uParam0, iParam1, false);
		...
		if (unk_0x7BB3D8F4F6310EB8(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			...
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_134[iLocal_661 /*25*/].f_17) && unk_0xDC116D955A63BDBE(uLocal_134[iLocal_661 /*25*/].f_17))
				{
					...
					unk_0xA81AA70A4D25E140(uLocal_134[iLocal_661 /*25*/].f_17, 1, 0);
					unk_0xCA9BC8284D91B406(uLocal_134[iLocal_661 /*25*/].f_17, 1, unk_0x26A9C8234C71B669(*uParam0), 0, 1, 1, 0);
				}
			}
		}
	...
	else
	{
		...
		{
			if (unk_0xDC116D955A63BDBE(uLocal_134[iLocal_661 /*25*/].f_17))
			{
				unk_0xA81AA70A4D25E140(uLocal_134[iLocal_661 /*25*/].f_17, 1, 0);
				unk_0xCA9BC8284D91B406(uLocal_134[iLocal_661 /*25*/].f_17, 1, unk_0x26A9C8234C71B669(*uParam0), 0, 1, 1, 0);
			}
...
BOOL func_157(int iParam0, int iParam1, float fParam2, int iParam3) // Position - 0x4BF1
{
	return SYSTEM::VDIST2(unk_0x30BE8A934C020461(iParam0, iParam3), unk_0x30BE8A934C020461(iParam1, iParam3)) <= fParam2 * fParam2;
}

void func_158(var uParam0) // Position - 0x4C13
{
	var unk;
	var unk2;
	...
	switch (uParam0->f_6)
	{
		...
		case 21:
			...
			if (unk_0xA5E11AF0A2B928C1() - uParam0->f_1 > uParam0->f_3)
			{
				...
				if (!unk_0xCE4AAA035282336C(uParam0->f_4))
					uParam0->f_4 = func_173(*uParam0, true, 145);
		...
		case 11:
			...
			if (unk_0xA5E11AF0A2B928C1() - uParam0->f_1 > 5000)
			{
				if (!func_184(*uParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
					if (unk_0x7DE17ACDD8BA2642(uLocal_111[func_171(uParam0->f_10) /*11*/]))
						unk_0x7D9A648CC1936BDA(*uParam0, uLocal_667, 1f, -1, 2f, 0, 1193033728);
		...
		case 18:
			if (!func_184(*uParam0, joaat("SCRIPT_TASK_PLAY_ANIM")))
			{
				...
				unk_0x3D7110D966B0CEA2(*uParam0, unk2);
		...
		case 13:
			if (unk_0xA5E11AF0A2B928C1() - uParam0->f_1 >= uParam0->f_2)
			{
				...
				else if (func_177(uLocal_111[func_171(uParam0->f_10) /*11*/], *uParam0, 1126825984, 1, 250, 7))
				{
					func_176(uParam0, 0);
				}
				else
		...
		case 20:
			...
			{
				if (!unk_0x9DC9E896F189AAA5(*uParam0, unk_0x7394CB479CCA24AF(iLocal_109, 5f, 0f, -2f), unk_0x30BE8A934C020461(iLocal_109, 1) + { 2f, 0f, 0f }, 9f, 0, 1, 0))
				{
					func_163(uParam0);
				}
				else
				{
					func_168(uParam0);
					func_168(&uLocal_111[func_171(uParam0->f_10) /*11*/]);
				}
		...
		case 23:
			func_202(uParam0, uParam0->f_10, true);
			func_172(uParam0);
		
			if (func_107(*uParam0, uLocal_667, 2f, 1))
			{
				if (func_159(*uParam0, uLocal_667, 1126825984, 0))
				{
					unk_0x909F139DC199D8E0(*uParam0);
					uParam0->f_6 = 19;
					uParam0->f_5 = 1;
...
BOOL func_159(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0x5560
{
	var unk;
	var unk4;
	float num;

	unk = { func_160(uParam1 - unk_0x30BE8A934C020461(iParam0, 1)) };
	...
	if (iParam5 == 0)
		...
		unk4 = { func_160(unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 0f, 0f)) };

	num = func_133(unk4, unk);
...
BOOL func_161(var uParam0) // Position - 0x562D
{
...
void func_162(var uParam0) // Position - 0x566F
{
	int num;
	...
	if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
	{
		...
		if (func_37(num))
		{
			if (!unk_0x73D13C05CA29773A(*uParam0, num, -1, 0, 0))
			{
				uParam0->f_6 = 18;
				uParam0->f_1 = unk_0xA5E11AF0A2B928C1();
			}
...
void func_163(var uParam0) // Position - 0x56B5
{
		...
		case 3:
			if (!func_184(*uParam0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				...
				if (!unk_0xE0D346789C5160EB(*uParam0, iLocal_109, 0))
				{
					if (uParam0->f_10 == 0)
					{
						unk_0x7D9A648CC1936BDA(*uParam0, unk_0x7394CB479CCA24AF(iLocal_109, func_137(true)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
					else
					{
						unk_0x7D9A648CC1936BDA(*uParam0, unk_0x7394CB479CCA24AF(iLocal_109, func_137(false)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
				}
			}
...
void func_164(var uParam0) // Position - 0x58E0
{
	if (!func_184(*uParam0, joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE")))
	{
		if (uLocal_134[iLocal_661 /*25*/].f_23 != 0)
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_134[iLocal_661 /*25*/].f_17))
				unk_0x22219303C0648071(*uParam0, uLocal_134[iLocal_661 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
		else
			unk_0x7D9A648CC1936BDA(*uParam0, uLocal_134[iLocal_661 /*25*/].f_19, 1f, 20000, -1f, 0, func_165(uLocal_134[iLocal_661 /*25*/].f_19, unk_0x30BE8A934C020461(*uParam0, 1), 1));
...
BOOL func_167() // Position - 0x5A39
{
	...
	for (i = 0; i <= 5; i = i + 1)
	{
		if (unk_0xE95D0CF0802593FC(iLocal_109, i, 0))
			num = num + 1;
	}
...
void func_168(var uParam0) // Position - 0x5A73
{
...
void func_172(var uParam0) // Position - 0x5B2A
{
...
int func_173(var uParam0, BOOL bParam1, int iParam2) // Position - 0x5B84
{
	int num;

	num = func_174(uParam0, !bParam1, false);
...
int func_174(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5BCE
{
	int num;
...
void func_176(var uParam0, int iParam1) // Position - 0x5C89
{
	func_169(uParam0);
...
BOOL func_177(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x5D45
{
	BOOL flag;
	var unk;
	int num;
	...
	if (!func_181(iParam0, iParam1, iParam2, iParam3))
		return false;
	...
	flag = func_178(&iLocal_38[num /*4*/], unk, iParam1, &(iLocal_38[num /*4*/].f_3), iParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_38[num /*4*/].f_3 < iParam4;
}

BOOL func_178(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, var uParam5, int iParam6, int iParam7) // Position - 0x5E06
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_181(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6041
{
	var unk;
	var unk4;
	float num;

	unk = { func_160(unk_0x30BE8A934C020461(iParam1, 1) - unk_0x30BE8A934C020461(iParam0, 1)) };
...
int func_183(int iParam0, var uParam1) // Position - 0x60ED
{
	int i;

	for (i = 0; i < iLocal_38; i = i + 1)
	{
		if (iLocal_38[i /*4*/].f_1 == iParam0 && iLocal_38[i /*4*/].f_2 == uParam1)
			return i;
	}
...
BOOL func_184(int iParam0, int iParam1) // Position - 0x612C
{
	if (func_343(iParam0))
	...
	switch (uParam0->f_7)
	{
		...
		case 3:
			...
			if (bLocal_664)
				if (iLocal_661 <= 20 && iLocal_661 != -1)
					if (!uLocal_134[iLocal_661 /*25*/].f_18)
						if (func_107(*uParam0, uLocal_134[iLocal_661 /*25*/], 20f, 1))
							if (uLocal_134[iLocal_661 /*25*/].f_9 && unk_0xF193A4B306E6BF93(iLocal_109))
								func_195();
				else
					uParam0->f_7 = 10;
			break;
		...
		case 4:
			if (func_107(*uParam0, uLocal_134[iLocal_661 /*25*/], 25f, 1))
			{
		...
		case 5:
			if (func_37(iLocal_109))
			{
				...
				num = unk_0xDC58AE028CB223BA(iLocal_109);
		...
		case 7:
			if (func_343(uLocal_111[1 /*11*/]))
				if (unk_0xE0D346789C5160EB(uLocal_111[1 /*11*/], iLocal_109, 0) && uLocal_111[1 /*11*/].f_7 == 3)
					func_130(false);
			break;
	...
	switch (uParam0->f_9)
	{
		case 1:
			if (!func_184(*uParam0, joaat("SCRIPT_TASK_GOTO_ENTITY_OFFSET")))
			{
				...
				if (func_170(unk_0x30BE8A934C020461(*uParam0, 1), uLocal_134[iLocal_661 /*25*/].f_19) > 1.5f)
					unk_0x195020A03AE6C628(0, uLocal_134[iLocal_661 /*25*/].f_19, 0);
			...
			else if (func_191(uLocal_134[iLocal_661 /*25*/].f_19, *uParam0, 1f, 1f, 8f))
			{
				func_190(uParam0);
				return;
			}
			...
			if (func_184(*uParam0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				if (unk_0x7BB3D8F4F6310EB8(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (unk_0x92377426879E21FF(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						...
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_134[iLocal_661 /*25*/].f_17) && !unk_0xDC116D955A63BDBE(uLocal_134[iLocal_661 /*25*/].f_17))
							unk_0xBD02C9D4D7076ECC(uLocal_134[iLocal_661 /*25*/].f_17, *uParam0, unk_0xCF99BEF1317B66DA(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
					}
				}
			
				if (func_191(uLocal_134[iLocal_661 /*25*/].f_19, *uParam0, 1f, 1f, 8f))
				{
					func_190(uParam0);
					return;
				}
				...
				if (!func_191(unk_0x7394CB479CCA24AF(iLocal_109, 0f, -5.5f, 0f), iLocal_109, 1.9f, 1.9f, 8f))
				{
					if (unk_0x1C4E4DC1EFE24DF1(*uParam0, unk_0x7394CB479CCA24AF(iLocal_109, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, 0, 1, 0))
					{
						if (!func_184(*uParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
						{
							...
							unk_0x3EE48ADC8C7F5CC4(0, "missfbi4prepp1", "_bag_throw_garbage_man", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							unk_0xF2CFC6EC8C85FA78(unk2);
							unk_0x3D7110D966B0CEA2(*uParam0, unk2);
							unk_0x63EF69C6969A3D26(&unk2);
							uParam0->f_9 = 4;
						...
						if (unk_0x92377426879E21FF(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_134[iLocal_661 /*25*/].f_17))
							{
								if (unk_0xDC116D955A63BDBE(uLocal_134[iLocal_661 /*25*/].f_17))
								{
									...
									unk_0x5FA868BAA9EEFED7(*uParam0);
									unk_0xA81AA70A4D25E140(uLocal_134[iLocal_661 /*25*/].f_17, 1, 0);
									unk_0xC86E66BD231706E6(uLocal_134[iLocal_661 /*25*/].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1082130432, -1082130432, -1082130432);
									unk_0xCA9BC8284D91B406(uLocal_134[iLocal_661 /*25*/].f_17, 1, unk_0x26A9C8234C71B669(*uParam0), 0, 1, 1, 0);
								}
							
								if (unk_0x110B96B5C67CC73B(uLocal_134[iLocal_661 /*25*/].f_17, iLocal_109))
...
void func_187(var uParam0) // Position - 0x680F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
BOOL func_191(var uParam0, var uParam1, var uParam2, int iParam3, float fParam4, float fParam5, float fParam6) // Position - 0x6A45
{
	iLocal_82.f_2 = { uParam0 };
	iLocal_82.f_8 = { fParam4 };
	func_192(&iLocal_82, iParam3);

	if (iLocal_82.f_26)
		if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			if (unk_0xA6B591D40DE982B5(iLocal_82.f_18))
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iLocal_82.f_18))
					if (unk_0x4DFB7A1A6909D574(iLocal_82.f_18) == unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 1))
						return true;
		else if (unk_0x71904BD37B848CAF(iLocal_82.f_18))
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iLocal_82.f_18))
				if (unk_0x9C8D7679C15E75FF(iLocal_82.f_18) == unk_0xC1A5EC5C986B98AD())
					return true;
...
void func_192(var uParam0, int iParam1) // Position - 0x6AD7
{
	...
	num2 = unk_0x5A2817B89A8ECCD2(*uParam0, &num, &(uParam0->f_20), &(uParam0->f_23), &(uParam0->f_18));
	uParam0->f_19 = 2 == num2;
...
void func_193(var uParam0, int iParam1) // Position - 0x6B26
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			*uParam0 = unk_0xB4C9A1D39D0533BF(uParam0->f_2, uParam0->f_5, 511, iParam1, 7);
			break;
...
void func_194(var uParam0) // Position - 0x6BEB
{
	...
	{
		unk_0xDBC7406226B5540E(&unk);
		unk_0xC562419B5DA3BB96(0, iLocal_109, uLocal_134[iLocal_661 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		unk_0x267F4694BB0C680B(0, iLocal_109, uLocal_134[iLocal_661 /*25*/].f_3, uLocal_134[iLocal_661 /*25*/].f_8, uLocal_134[iLocal_661 /*25*/].f_10, 5f, 1);
		unk_0xF2CFC6EC8C85FA78(unk);
		unk_0x3D7110D966B0CEA2(*uParam0, unk);
		unk_0x63EF69C6969A3D26(&unk);
		uParam0->f_7 = 6;
...
void func_196(var uParam0, BOOL bParam1) // Position - 0x6C7E
{
	...
	{
		if (unk_0x9DC9E896F189AAA5(*uParam0, unk_0x7394CB479CCA24AF(iLocal_109, 5f, 0f, -2f), unk_0x30BE8A934C020461(iLocal_109, 1) + { 2f, 0f, 0f }, 9f, 0, 1, 0) && unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), unk_0x7394CB479CCA24AF(iLocal_109, 5f, 0f, -2f), unk_0x30BE8A934C020461(iLocal_109, 1) + { 2f, 0f, 0f }, 9f, 0, 1, 0))
		{
			func_197(uParam0);
		}
		else if (!func_184(*uParam0, joaat("SCRIPT_TASK_GO_TO_ENTITY")) && unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), unk_0x7394CB479CCA24AF(iLocal_109, 5f, 0f, -2f), unk_0x30BE8A934C020461(iLocal_109, 1) + { 2f, 0f, 0f }, 9f, 0, 1, 0))
		{
			unk_0x909F139DC199D8E0(*uParam0);
	...
	else if (func_107(*uParam0, unk_0x7394CB479CCA24AF(iLocal_109, func_137(bParam1)), 5f, 1))
	{
		...
		unk_0xD30E9CAE1FEA1C7E(*uParam0, iLocal_109, -1, num, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
...
void func_199() // Position - 0x6F11
{
	...
	for (i = 0; i <= iLocal_81 - 1; i = i + 1)
	{
		if (uLocal_134[i /*25*/].f_23 != 0)
		{
			...
			{
				if (i != iLocal_661 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_134[i /*25*/].f_17) && func_201(uLocal_134[i /*25*/].f_17, unk_0xC1A5EC5C986B98AD(), 1) > 200f)
				{
					unk_0xEF078F1FEE785D3E(&(uLocal_134[i /*25*/].f_17));
					uLocal_134[i /*25*/].f_24 = 0;
				}
			}
			else if (uLocal_134[i /*25*/].f_23 != 0)
			{
				if (func_107(unk_0xC1A5EC5C986B98AD(), uLocal_134[i /*25*/], 100f, 1) || func_107(uLocal_111[0 /*11*/], uLocal_134[i /*25*/], 120f, 1))
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6) // Position - 0x7004
{
	if (!unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (func_152(uParam1, "Loading", 0))
...
float func_201(var uParam0, var uParam1, int iParam2) // Position - 0x7071
{
	var unk;
	var unk4;
...
void func_202(var uParam0, int iParam1, BOOL bParam2) // Position - 0x70CF
{
	if (uParam0->f_5 != 1 || bParam2)
	{
		if (!func_343(uLocal_111[func_171(iParam1) /*11*/]))
		{
			if (!bLocal_665)
			{
				if (unk_0x7DE17ACDD8BA2642(uLocal_111[func_171(iParam1) /*11*/]))
				{
					if (func_181(*uParam0, uLocal_111[func_171(iParam1) /*11*/], 140f, 0) || func_157(uLocal_111[func_171(iParam1) /*11*/], *uParam0, 3f, 1))
					{
						func_176(uParam0, 0);
						bLocal_665 = true;
						return;
					...
					{
						uLocal_667 = { unk_0x30BE8A934C020461(uLocal_111[func_171(iParam1) /*11*/], 1) };
						uParam0->f_1 = unk_0xA5E11AF0A2B928C1();
						uParam0->f_8 = uParam0->f_7;
						uParam0->f_5 = 1;
						uParam0->f_6 = 11;
		...
		{
			if (func_181(*uParam0, uLocal_111[func_171(iParam1) /*11*/], 140f, 0) && func_157(uLocal_111[func_171(iParam1) /*11*/], unk_0xC1A5EC5C986B98AD(), 15f, 1))
			{
				uParam0->f_5 = 1;
				uParam0->f_6 = 21;
			}
		...
		{
			if (func_157(uLocal_111[func_171(iParam1) /*11*/], *uParam0, 10f, 1))
				func_176(uParam0, 0);
		}
		...
		if (func_204(*uParam0, true, 70f, 170f, false, true, false, false) && !func_203(uParam0))
		{
			if (unk_0x2D1125ABF6C8F8C4(unk_0xC1A5EC5C986B98AD(), 6))
			{
				if (func_37(iLocal_109))
				{
					if (unk_0xE0D346789C5160EB(*uParam0, iLocal_109, 0))
					{
						if (unk_0xDC58AE028CB223BA(iLocal_109) > 5f)
						{
							if (iParam1 == 0)
							{
								...
								uParam0->f_6 = 7;
								unk_0xA2C73FAE5789EC05(uLocal_111[func_171(iParam1) /*11*/], -1);
								uLocal_111[func_171(iParam1) /*11*/].f_6 = 10;
								uLocal_111[func_171(iParam1) /*11*/].f_5 = 1;
								uParam0->f_5 = 1;
								uParam0->f_1 = unk_0xA5E11AF0A2B928C1();
								uLocal_111[func_171(iParam1) /*11*/].f_1 = unk_0xA5E11AF0A2B928C1();
							}
							else
							{
								unk_0xA2C73FAE5789EC05(*uParam0, -1);
								uParam0->f_6 = 12;
								unk_0xB8194851FFF54D3B(uLocal_111[func_171(iParam1) /*11*/], iLocal_109, unk_0xC1A5EC5C986B98AD(), 8, 30f, 786469, 300f, 2f, 1);
						...
						else
						{
							...
							if (unk_0x7DE17ACDD8BA2642(uLocal_111[func_171(iParam1) /*11*/]))
								if (func_181(uLocal_111[func_171(iParam1) /*11*/], unk_0xC1A5EC5C986B98AD(), 1126825984, 0))
									func_176(&uLocal_111[func_171(iParam1) /*11*/], 0);
						}
					...
					else
					{
						...
						if (unk_0x7DE17ACDD8BA2642(uLocal_111[func_171(iParam1) /*11*/]))
							if (func_177(uLocal_111[func_171(iParam1) /*11*/], *uParam0, 1126825984, 1, 250, 7))
								func_176(&uLocal_111[func_171(iParam1) /*11*/], 0);
					}
				}
			}
			else
			{
				...
				{
					uLocal_111[func_171(iParam1) /*11*/].f_1 = unk_0xA5E11AF0A2B928C1();
					uLocal_111[func_171(iParam1) /*11*/].f_8 = uParam0->f_7;
					uLocal_111[func_171(iParam1) /*11*/].f_5 = 1;
					uLocal_111[func_171(iParam1) /*11*/].f_6 = 21;
					unk_0x5CE354E3C73D2002(uLocal_111[func_171(iParam1) /*11*/]);
				}
			}
	...
	if (uParam0->f_5 != 1)
	{
		if (func_343(uLocal_111[func_171(iParam1) /*11*/]))
		{
			if (unk_0xF276A75C8A36B189(uLocal_111[func_171(iParam1) /*11*/]))
			{
				func_169(uParam0);
...
BOOL func_203(var uParam0) // Position - 0x75F7
{
...
BOOL func_204(int iParam0, BOOL bParam1, float fParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x763F
{
	float num;
...
BOOL func_205(int iParam0, float fParam1) // Position - 0x76FA
{
	float num;
...
BOOL func_208(var uParam0, int iParam1, float fParam2) // Position - 0x77B0
{
	float num;
	Vector3 vector;
...
BOOL func_209(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77F7
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_212(iParam0, bParam1, num, num2))
				return true;
		
			if (func_210(iParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_210(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x78F2
{
	float num;
	float num2;
...
BOOL func_211(int iParam0, float fParam1) // Position - 0x79FE
{
	var unk;
	var unk2;
	...
	if (unk_0x96E845EE39BF3453(iParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(iParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(iParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(iParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(iParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_159(iParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_212(int iParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x7A93
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_213(var uParam0) // Position - 0x7ADB
{
	if (func_157(uParam0, unk_0xC1A5EC5C986B98AD(), 6f, 1))
		if (!unk_0x3C3D6D026CF7F51B(uParam0, 0))
			if (unk_0x110B96B5C67CC73B(uParam0, unk_0xC1A5EC5C986B98AD()))
				return true;
...
void func_214() // Position - 0x7B0F
{
	if (func_37(iLocal_868))
	{
		if (func_157(unk_0xC1A5EC5C986B98AD(), iLocal_868, 100f, 1) && !bLocal_837)
		{
		...
		else if (!func_157(unk_0xC1A5EC5C986B98AD(), iLocal_868, 120f, 1) && bLocal_837)
		{
...
void func_215(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, BOOL bParam9, int iParam10) // Position - 0x7B86
{
	if (func_37(*uParam0))
	{
		switch (*uParam2)
		{
			case 0:
				...
				else if (func_220(*uParam0) || func_219(*uParam0))
				{
					func_7(uParam3);
			...
			case 2:
			case 1:
				if (!unk_0xE0D346789C5160EB(unk_0xC1A5EC5C986B98AD(), *uParam0, 0) && !func_220(*uParam0) && !func_219(*uParam0))
				{
					func_7(uParam4);
				
					if (!unk_0x1C4E4DC1EFE24DF1(*uParam0, uParam5, iParam10, iParam10, 2f, 0, 1, 2))
						func_125(uParam3, *uParam0, 1);
			...
			case 3:
				if (!func_220(*uParam0) && !func_219(*uParam0))
				{
					func_7(uParam4);
...
void func_216(var uParam0, var uParam1) // Position - 0x7D3A
{
	int num;
	int num2;
	int num3;
...
void func_217(var uParam0) // Position - 0x7E27
{
	int num;
	...
	if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
	{
		...
		if (num != *uParam0)
		{
			if (func_37(num))
			{
				if (unk_0x504B9BB48D41C264(num) == func_218(func_77()))
				{
					func_6(uParam0);
					*uParam0 = num;
					func_36(*uParam0, 1);
...
BOOL func_219(int iParam0) // Position - 0x7EDD
{
	int num;
	int num2;
...
BOOL func_220(int iParam0) // Position - 0x7F60
{
	int num;
	int num2;
	...
	switch (iLocal_684)
	{
		case 0:
			if (func_122(iLocal_683, bLocal_28))
			{
				...
				{
					func_117(&uLocal_821, uLocal_827, 1);
		...
		case 1:
			...
			if (func_225(iLocal_874, uLocal_827, &uLocal_821, iLocal_685, iLocal_686, &iLocal_820, &iLocal_839, false, false, 1086324736))
			{
		...
		case 3:
			if (func_37(iLocal_874))
			{
				...
				{
					func_109(iLocal_874, uLocal_827, 146.5443f, false, 1);
					func_40(1, 1, 1);
					iLocal_684 = 1;
				}
			}
...
BOOL func_224(int iParam0) // Position - 0x81BB
{
	return false;
}

BOOL func_225(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, var uParam7, var uParam8, BOOL bParam9, BOOL bParam10, int iParam11) // Position - 0x8201
{
	...
	for (i = CHAR_MICHAEL; i < CHAR_MULTIPLAYER; i = i + 1)
	{
		...
		if (!unk_0x66599E73DBA5A850(num))
		{
			if (func_78(num, 0))
			{
				if (!flag)
				{
					if (func_157(unk_0xC1A5EC5C986B98AD(), num, 5f, 1))
					{
				...
				{
					if (i == CHAR_MICHAEL)
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_879, i, num, "MICHAEL", 0, 1);
					else if (i == CHAR_FRANKLIN)
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_879, i, num, "FRANKLIN", 0, 1);
					else if (i == CHAR_TREVOR)
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_879, i, num, "TREVOR", 0, 1);
			...
			else if (unk_0xAE770DDB34967EC3(num, 1))
			{
				if (func_231(num))
					if (unk_0xF5F493B789EA063E(num, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1 && unk_0xF5F493B789EA063E(num, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 0)
						if (unk_0x9ADDEEB34545AD94(623.3781f, -172.26003f, 1700.7317f, -2115.8428f))
							unk_0xC562419B5DA3BB96(num, unk_0x95DC39736F6748E3(num, 0), uLocal_827, 20f, 0, 0, 34340901, 2f, 10f);
						else
							unk_0x350F65B0612C7A16(623.3781f, -172.26003f, 1700.7317f, -2115.8428f);
				else if (func_229(num))
					if (func_37(iLocal_868))
						if (!func_157(num, iLocal_868, 17f, 1))
							if (unk_0xF5F493B789EA063E(num, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1 && unk_0xF5F493B789EA063E(num, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 0)
								unk_0x3DFE9C7902334B74(num, unk_0x95DC39736F6748E3(num, 0), iLocal_868, 3, 20f, 786468, 2f, 0.5f, 1);
				else
					func_223(num);
			}
		}
...
BOOL func_228(int iParam0, int iParam1) // Position - 0x8512
{
	return false;
}

BOOL func_229(int iParam0) // Position - 0x8593
{
	int num;
	...
	if (!func_230())
	{
		if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0) && unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) == 0)
		{
			...
			if (func_37(num))
			{
				if (unk_0x091E6E360116B927(num, joaat("trash")))
					return 0;
			
				if (unk_0xE0D346789C5160EB(iParam0, num, 0) && unk_0xA66E176E5772E965(num, -1, 0) == iParam0)
					return 1;
			}
		}
	}
...
BOOL func_231(int iParam0) // Position - 0x862F
{
	if (!func_230())
		if (unk_0x7DE17ACDD8BA2642(iLocal_868) && unk_0xFBD273FDBCF0C5BD(iLocal_868, 0) && !unk_0x1C4E4DC1EFE24DF1(iLocal_868, uLocal_827, 2f, 2f, 2f, 0, 1, 0))
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && unk_0xE0D346789C5160EB(unk_0xC1A5EC5C986B98AD(), iLocal_868, 0) && unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) == 0)
				if (unk_0xE0D346789C5160EB(iParam0, iLocal_868, 0) && unk_0xA66E176E5772E965(iLocal_868, -1, 0) == iParam0)
					return true;
			...
			if (!IS_BIT_SET(uLocal_688[echParam0 /*8*/].f_7, 0) && iLocal_686 == 1)
				if (!unk_0x70CDFE65A7D509C2())
					if (_CONVERSATION_ADD_LINE(&uLocal_879, sLocal_878, uLocal_688[echParam0 /*8*/][0], 8, 0, 0, 0))
						unk_0xECDAB41968FF21A8(&(uLocal_688[echParam0 /*8*/].f_7), 0);
		}
		else
		{
			if (IS_BIT_SET(uLocal_688[echParam0 /*8*/].f_7, 0) && !IS_BIT_SET(uLocal_688[echParam0 /*8*/].f_7, 1) && iLocal_686 == 1)
				if (!unk_0x70CDFE65A7D509C2())
					if (_CONVERSATION_ADD_LINE(&uLocal_879, sLocal_878, uLocal_688[echParam0 /*8*/][1], 7, 0, 0, 0))
						unk_0xECDAB41968FF21A8(&(uLocal_688[echParam0 /*8*/].f_7), 1);
		
			if (!IS_BIT_SET(uLocal_688[echParam0 /*8*/].f_7, 5))
				if (func_235(iLocal_874, uLocal_827, 1) < 15f && iLocal_686 == 1)
					if (!unk_0x70CDFE65A7D509C2())
						if (_CONVERSATION_ADD_LINE(&uLocal_879, sLocal_878, uLocal_688[echParam0 /*8*/][5], 7, 0, 0, 0))
							unk_0xECDAB41968FF21A8(&(uLocal_688[echParam0 /*8*/].f_7), 5);
		...
		if (iLocal_1052 != -1)
			if (!unk_0x70CDFE65A7D509C2())
				if (_CONVERSATION_ADD_LINE(&uLocal_879, sLocal_878, uLocal_688[echParam0 /*8*/][iParam1], 7, 0, 0, 0))
					unk_0xECDAB41968FF21A8(&(uLocal_688[echParam0 /*8*/].f_7), iParam1);
...
float func_235(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x8942
{
	var unk;
...
{
	if (func_107(unk_0xC1A5EC5C986B98AD(), uLocal_827, 220f, 1))
	{
		if (!bLocal_877 && !func_107(unk_0xC1A5EC5C986B98AD(), uLocal_827, 100f, 1))
			bLocal_877 = func_153(&uLocal_876, joaat("cavalcade2"), 1370.9122f, -2060.055f, 50.9983f, 312.8686f, true);
	}
	else if (func_107(unk_0xC1A5EC5C986B98AD(), uLocal_827, 240f, 1))
	{
		if (bLocal_877)
		{
			func_6(&uLocal_876);
...
void func_239() // Position - 0x8A78
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			...
			if (func_37(iLocal_868))
				func_242(&uLocal_671, iLocal_868, 0, 0, true, true, true);
		
			if (!bLocal_833)
			{
				if (func_343(iLocal_840) && unk_0xF276A75C8A36B189(iLocal_840))
					func_241();
			
				if (func_343(iLocal_854) && unk_0xF276A75C8A36B189(iLocal_854))
					func_241();
			}
...
void func_242(var uParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x8C7C
{
	func_243(uParam0, iParam1, 0f, 0f, 0f, iParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_243(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x8C99
{
	func_244(uParam0, iParam1, fParam2, iParam5, iParam6, bParam7, bParam8, bParam9);
	return;
}

void func_244(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x8CB7
{
	if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 1))
		func_145(uParam0, 0, 0);

	uParam0->f_6 = 2;
	func_245(uParam0, iParam1, uParam2, iParam5, iParam6, bParam7, bParam8, bParam9);
	return;
}

void func_245(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x8CEF
{
	char* str;
	BOOL flag;
	...
	if (func_268(iParam1) && unk_0x51DF6895C236B231(iParam1))
	{
		...
		if (!unk_0x3FACE5B6ACB3A4AA())
		{
			if (func_263(uParam0, bParam7, bParam9, false))
				func_260(uParam0, iParam1, uParam2, iParam6);
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x919A
{
...
BOOL func_250(char* sParam0) // Position - 0x91B1
{
...
BOOL func_251(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x924A
{
	...
	if (func_258() || func_257(*Global_4718592.f_166301) || func_256())
	{
		if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
		{
			...
			if (unk_0xC78C3E6F7A5988D9(unk, num) || unk_0x504B9BB48D41C264(unk) == joaat("apc") && num != -1 || unk_0x504B9BB48D41C264(unk) == joaat("akula") && num != -1 || unk_0x504B9BB48D41C264(unk) == joaat("riot2") && num == 0 && func_254(unk, 10) && unk_0xCA36A30E79A35222(unk, 10) != -1)
				return false;
		}
	}
...
BOOL func_254(var uParam0, int iParam1) // Position - 0x9569
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x95CB
{
	var unk;
	int num;
	int i;
...
void func_260(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x968E
{
	var unk;
	int num;
	int num2;
...
BOOL func_262(var uParam0) // Position - 0x97AE
{
...
BOOL func_268(int iParam0) // Position - 0x9C89
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
		...
		case 0:
			if (func_122(iLocal_683, false))
			{
				...
				else
				{
					if (_IS_MISSION_REPEAT_ACTIVE(false))
					{
						func_124(unk_0xC1A5EC5C986B98AD(), 1228.6351f, -348.4277f, 68.0929f, 86.7244f);
...
void func_284() // Position - 0xA12E
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk))
		if (unk_0xFBD273FDBCF0C5BD(unk, 0))
			func_285(unk, unk_0x30BE8A934C020461(unk, 1), unk_0xD850DD08D5434072(unk), 24, false);

	return;
}

void func_285(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6) // Position - 0xA16B
{
	var unk;
	...
	if (unk_0x7DE17ACDD8BA2642(iParam0) && unk_0xFBD273FDBCF0C5BD(iParam0, 0))
	{
		...
		func_322(iParam5, &unk, uParam1, uParam4, func_328(iParam0));
...
void func_287(int iParam0, eCharacter echParam1) // Position - 0xA3AB
{
	var unk;
	int i;
	int j;
...
BOOL func_288(int iParam0) // Position - 0xA5AD
{
	if (!unk_0x7DE17ACDD8BA2642(iParam0) || !unk_0xFBD273FDBCF0C5BD(iParam0, 0) || func_305(iParam0, 0, false) || func_305(iParam0, 1, false) || func_305(iParam0, 2, false) || func_328(iParam0) != 145 || func_304(iParam0) || func_303(iParam0) || func_302(iParam0) || func_301(iParam0) || !func_289(unk_0x504B9BB48D41C264(iParam0)))
	{
		func_303(iParam0);
		func_303(iParam0);
...
BOOL func_289(int iParam0) // Position - 0xA68A
{
	if (iParam0 == 0)
		return false;

	if (!func_290(iParam0, false, -1))
		return false;
...
BOOL func_290(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA83C
{
	int i;
	var unk;
...
BOOL func_291(int iParam0) // Position - 0xA9BE
{
	int num;
	var unk;
	var unk2;
...
BOOL func_293(int iParam0, int iParam1) // Position - 0xAAA1
{
	BOOL num;
	var unk;
...
BOOL func_301(int iParam0) // Position - 0xE1EA
{
	int num;
	var unk;
	...
	if (!func_290(num, false, -1))
		return true;

	return false;
}

BOOL func_302(int iParam0) // Position - 0xE231
{
	int i;
...
BOOL func_303(int iParam0) // Position - 0xE26C
{
	int i;
...
BOOL func_304(int iParam0) // Position - 0xE2E8
{
	int i;
...
BOOL func_305(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE3D0
{
	int i;
	var unk;
	int num;
...
var func_308() // Position - 0xE532
{
	...
	func_318(&unk, unk_0x731F95B6458DCF80());
	func_317(&unk, unk_0x77BBAAED3E25322C());
	func_316(&unk, unk_0x30DFE1FFD2CC7420());
	func_311(&unk, unk_0x8C0F17CAC308A14B());
	func_310(&unk, unk_0x61117764C67882B7());
	func_309(&unk, unk_0x367F557725B53815());
	return unk;
}
		...
		*uParam1 = unk_0x46177D0BA2953EC5(iParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x175FDAC9EB940479(iParam0, i + 1))
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_330(i + 1));
		}
...
void func_340() // Position - 0x10C41
{
	...
	if (!func_37(iLocal_874))
	{
		if (!func_37(uLocal_875) && !func_37(iLocal_868))
		{
			func_342(1);
			return;
		}
	
		if (func_37(iLocal_868) && !func_157(unk_0xC1A5EC5C986B98AD(), iLocal_868, num, 1))
			func_342(2);
	}
	else
	{
		...
		if (!func_157(unk_0xC1A5EC5C986B98AD(), iLocal_874, num, 1))
			num2 = num2 + 1;
	
		if (func_37(uLocal_875))
			if (!func_157(unk_0xC1A5EC5C986B98AD(), uLocal_875, num, 1))
				num2 = num2 + 1;
		else
			num2 = num2 + 1;
	
		if (func_37(iLocal_868))
			if (!func_157(unk_0xC1A5EC5C986B98AD(), iLocal_868, num, 1))
				num2 = num2 + 1;
		else
			num2 = num2 + 1;
...
BOOL func_341(int iParam0) // Position - 0x10D87
{
	if (func_37(iParam0))
...
BOOL func_343(int iParam0) // Position - 0x10E3A
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
...
void func_347(int iParam0, int iParam1, BOOL bParam2) // Position - 0x10F4D
{
	...
	else if (unk_0xA26A9A07F761D8F8())
	{
		if (func_352() == 0)
		{
			num = _MPCHAR_STAT_GET_INT(func_351(iParam0), -1, 0);
			unk_0x061B1200C95204CB(&num, iParam1);
			_MPCHAR_STAT_SET_INT(func_351(iParam0), num, -1, 1, false);
		}
	}
	else
	{
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x10FBF
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_349(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x11023
{
	...
	{
		iParam2 == 0;
		unk = Global_2805027[empsParam0 /*3*/][func_349(iParam1)];
...
{
	iLocal_840 = { func_374(1200.6096f, -344.2721f, 68.0424f, 269.2015f, joaat("S_M_Y_Garbage")) };
	iLocal_854 = { func_374(1202.4204f, -341.6034f, 67.9378f, 273.1125f, joaat("S_M_Y_Garbage")) };
	return;
}
...
{
	iLocal_868 = { func_376(1203.1462f, -337.3543f, 67.9314f, 189.7047f, joaat("trash")) };
	return;
}
...
void func_379() // Position - 0x127BE
{
	...
	func_6(&uLocal_875);
	func_6(&iLocal_874);
	func_5(&iLocal_840, 1, 0, 1);
	func_5(&iLocal_854, 1, 0, 1);
	func_6(&uLocal_876);
	return;
}
...
{
	unk_0xE0A291F406691F03(iLocal_868.f_5);
	return;
}
