...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112009[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_112009[Var0.f_0 /*10*/].f_9));
			}
		}
		func_272(&Var0, 1);
	}
	if (!func_269(&iVar64, &Var0, Var61, 5f))
	{
		func_268();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 47)
		{
			func_199(&Var0, Var61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0.f_0 == 51)
		{
			func_199(&Var0, Var61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_198(Var0.f_0);
		func_190(&iLocal_95, &(Var0.f_9), Var61);
		if (func_175(&Var0, 0))
		{
			if (func_174(Var0.f_0))
			{
				func_171(Var0.f_0, &iLocal_97);
			}
			if (!func_2(&Var0))
			{
				func_272(&Var0, 1);
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_203(var uParam0, bool bParam1)
{
	...
	if ((func_240(*uParam0) || func_238(*uParam0)) || Global_78103 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_239() && Global_99980.f_11 == 6) && iParam0 == func_169(&(Global_99980.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_243(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
...
void func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_209(iParam0);
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_248(iParam0);
...
int func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_250(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_257(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			func_258(46, 1);
