...
void main() // Position - 0x0
{
	...
	if (!func_272(&unk63, &num, vector, 5f))
	{
		func_271();
	...
	while (true)
	{
		...
		if (num == 47)
			func_202(&num, vector, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		else if (num == 51)
			func_202(&num, vector, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
	
		func_201(num);
		func_193(&iLocal_95, &(num.f_9), vector);
	
		if (func_178(&num, 0))
		{
			if (func_177(num))
				func_174(num, &blLocal_97);
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39A6
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EEF
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x4255
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x4348
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x484B
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x54AC
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x54E7
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x575B
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CE6
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6970
{
	int i;
...
int func_93(Player plParam0) // Position - 0x8637
{
...
void func_122(Ped pedParam0) // Position - 0xA998
{
	int num;
	int num2;
	int num3;
...
int func_124(Ped pedParam0) // Position - 0xAA74
{
	int i;
...
int func_130(Ped pedParam0) // Position - 0xABD4
{
	int i;
...
BOOL func_131(Vehicle veParam0) // Position - 0xAC1D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC3D
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_136(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAD81
{
	int i;
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF20
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_143(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_140() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xB087
{
	BOOL flag;
...
BOOL func_143(Player plParam0) // Position - 0xB113
{
...
int func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB160
{
	int num;
...
BOOL func_148(const char* sParam0) // Position - 0xB1DD
{
...
void func_153() // Position - 0xB2B8
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			if (func_154(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, false, true, false))
...
BOOL func_154(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB310
{
...
void func_155(Vehicle veParam0) // Position - 0xB4A8
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_172(const char* sParam0, int iParam1) // Position - 0xBB2D
{
	int num;
	const char* str;
	Hash hashKey;
...
void func_174(int iParam0, var uParam1) // Position - 0xBB9A
{
	...
	{
		case 0:
			*uParam1 = func_175(-1604.668f, 5239.1f, 3.01f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 42);
			break;
	
		case 1:
			*uParam1 = func_175(-1592.84f, 5214.04f, 3.01f, false);
		...
		case 2:
		case 3:
			*uParam1 = func_175(190.26f, -956.35f, 29.63f, false);
		...
		case 4:
			*uParam1 = func_175(414f, -761f, 29f, false);
		...
		case 9:
			*uParam1 = func_175(-1622.89f, 4204.87f, 83.3f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
				*uParam1 = func_175(1835.53f, 4705.86f, 38.1f, false);
			else if (iParam0 == 12)
				*uParam1 = func_175(1826.13f, 4698.88f, 38.92f, false);
			else
				*uParam1 = func_175(637.02f, 119.7093f, 89.5f, false);
		...
		case 19:
			if (iParam0 == 18)
				*uParam1 = func_175(-954.19f, -2760.05f, 14.64f, false);
			else
				*uParam1 = func_175(-63.8f, -809.5f, 321.8f, false);
		...
		case 23:
			if (iParam0 == 21)
				*uParam1 = func_175(-1877.82f, -440.649f, 45.05f, false);
			else
				*uParam1 = func_175(-915.6f, 6139.2f, 5.5f, false);
		...
		case 27:
			*uParam1 = func_175(-1104.93f, 291.25f, 64.3f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 44);
			break;
		...
		case 34:
			*uParam1 = func_175(-303.82f, 6211.29f, 31.05f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_MINUTE);
			HUD::SET_BLIP_COLOUR(*uParam1, 44);
			break;
	
		case 43:
			*uParam1 = func_175(-44.75f, -1288.67f, 28.21f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_CELEBRITY_THEFT);
			HUD::SET_BLIP_COLOUR(*uParam1, 44);
			break;
	
		case 46:
			*uParam1 = func_175(-149.75f, 285.81f, 93.67f, false);
			HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
			HUD::SET_BLIP_COLOUR(*uParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
				*uParam1 = func_175(-70.71f, 301.43f, 106.79f, false);
			else
				*uParam1 = func_175(-257.22f, 292.85f, 90.63f, false);
...
Blip func_175(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC00A
{
...
BOOL func_183(Vehicle veParam0) // Position - 0xCA63
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
void func_193(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD290
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_197(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_196(uParam0, 1);
			}
			else
			{
				...
				if (func_197(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_199(uParam0);
			}
		}
	}
...
float func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD494
{
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD601
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_197(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void func_207(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDA25
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_212(Object* pobParam0) // Position - 0xE0DE
{
...
BOOL func_215(Ped pedParam0, Vehicle veParam1) // Position - 0xE347
{
...
BOOL func_218(Vehicle veParam0, int iParam1) // Position - 0xE667
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		if (func_229(veParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), veParam0))
		{
...
BOOL func_219(Vehicle veParam0, int iParam1) // Position - 0xE6DD
{
	return func_220(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_220(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE6F5
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_228(veParam0, pedParam1);
	...
	if (!func_224(veParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_221(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), veParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_221(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE7B6
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_222(Ped pedParam0, int iParam1) // Position - 0xE8E2
{
...
BOOL func_224(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE9F1
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_226(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_226(PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 0f, 0f)) };
...
int func_228(Vehicle veParam0, Ped pedParam1) // Position - 0xEAFD
{
	int i;
...
BOOL func_229(Vehicle veParam0) // Position - 0xEB3C
{
...
BOOL func_230(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEB64
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		...
		if (!bParam2)
		{
			if (func_234(veParam0, bParam1, radius, num))
				return true;
		
			if (func_231(veParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_231(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEC5F
{
	float entityCoords;
	float num;
...
BOOL func_232(Vehicle veParam0, float fParam1) // Position - 0xED6B
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_233(veParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_233(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEE00
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_226(uParam1 - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
...
BOOL func_234(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEE8E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_236(Vehicle veParam0) // Position - 0xEF20
{
	int taskSequenceId;
...
BOOL func_246(var uParam0) // Position - 0xF23C
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_250(&uParam0->f_28[1], num[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, PED_TYPE_MISSION);
			...
			{
				func_250(&uParam0->f_28[2], num[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, PED_TYPE_MISSION);
...
void func_247(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF801
{
	func_212(pobParam0);
...
void func_248(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF828
{
	func_249(pveParam0);
...
void func_249(Vehicle* pveParam0) // Position - 0xF86A
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_250(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0xF906
{
	func_251(ppedParam0);
...
void func_251(Ped* ppedParam0) // Position - 0xF927
{
...
BOOL func_252(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF968
{
...
BOOL func_253(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF9C4
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_291(echParam1);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (func_131(uParam0->f_28[0]))
			{
				...
				{
					func_247(&uParam0->f_41[3], num[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", animDict, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, animDict, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[1]))
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", animDict, 8f, -8f, 0, 1148846080);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[2]))
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", animDict, 8f, -8f, 0, 1148846080);
			}
...
BOOL func_259(var uParam0) // Position - 0x10129
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (func_131(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_247(&uParam0->f_41[0], num[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
			{
				...
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
...
void func_275(var uParam0, BOOL bParam1) // Position - 0x10D74
{
	if (bParam1)
	{
		...
		{
			case 46:
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hLocal_93);
	...
	if (HUD::DOES_BLIP_EXIST(blLocal_97))
		HUD::REMOVE_BLIP(&blLocal_97);
...
void func_280(Object* pobParam0, BOOL bParam1) // Position - 0x10F88
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_283(Vehicle* pveParam0) // Position - 0x11012
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_285(var uParam0, int iParam1) // Position - 0x1105C
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_286(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_286(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1109D
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
Hash func_291(eCharacter echParam0) // Position - 0x11189
{
	if (!func_36(echParam0))
