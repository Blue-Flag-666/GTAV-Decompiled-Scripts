...
void main() // Position - 0x0
{
	...
	iLocal_92 = func_291(CHAR_BEVERLY);
	iLocal_93 = joaat("pcj");
	iLocal_95 = -1;
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_287(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (!func_272(&unk64, &num, unk61, 5f))
	{
		func_271();
	...
	while (true)
	{
		...
		if (num == 47)
			func_202(&num, unk61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		else if (num == 51)
			func_202(&num, unk61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
	
		func_201(num);
		func_193(&iLocal_95, &(num.f_9), unk61);
	
		if (func_178(&num, 0))
		{
			if (func_177(num))
				func_174(num, &uLocal_97);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x38FD
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x393A
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x397A
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39A6
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EEF
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4131
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x45D0
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4671
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CE6
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64A9
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x64F0
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x655B
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x65BC
{
	switch (iParam0)
	{
		case 0:
...
int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6970
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x746C
{
...
BOOL func_81(Player plParam0) // Position - 0x7496
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7598
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x762D
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x82CD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x834F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x83A7
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x8654
{
...
int func_102(int iParam0) // Position - 0x8B90
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BB2
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8BC9
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8C87
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8D25
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8D67
{
...
BOOL func_118(Any* panParam0) // Position - 0xA7FA
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAB6D
{
...
BOOL func_131(var uParam0) // Position - 0xAC1D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAC3D
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL func_133(int iParam0) // Position - 0xAC5E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135(int iParam0) // Position - 0xAD2E
{
	switch (iParam0)
	{
		case 5:
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAD81
{
	int i;
...
BOOL func_137(int iParam0) // Position - 0xAE76
{
	switch (iParam0)
	{
		case 5:
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF20
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB087
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB113
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB160
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB1DD
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB281
{
...
void func_153() // Position - 0xB2B8
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
		if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			if (func_154(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB310
{
...
void func_155(var uParam0) // Position - 0xB4A8
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_161(int iParam0) // Position - 0xB664
{
	if (iParam0 == 1)
...
BOOL func_163(int iParam0) // Position - 0xB6CA
{
...
BOOL func_164(int iParam0) // Position - 0xB70B
{
	int num;
...
int func_166(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB782
{
	int i;
	...
	if (*iParam0 == -1)
	{
		...
		*iParam0 = Global_43221;
		...
		if (iParam4 != 0)
			func_167(iParam0, iParam4);
	}

	return 2;
}

void func_167(int iParam0, int iParam1) // Position - 0xB8B9
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB908
{
	return func_169(iParam0, Global_43257);
}

BOOL func_169(int iParam0, int iParam1) // Position - 0xB919
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_170(int iParam0) // Position - 0xBAFA
{
	if (Global_43257 == 15)
		return false;
...
int func_172(var uParam0, int iParam1) // Position - 0xBB2D
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBB76
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_174(int iParam0, var uParam1) // Position - 0xBB9A
{
	switch (iParam0)
	{
		case 0:
...
var func_175(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC00A
{
	var unk;
...
var func_176(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC036
{
	if (bParam0)
		return uParam1;
...
BOOL func_177(int iParam0) // Position - 0xC04D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_178(var uParam0, int iParam1) // Position - 0xC0DC
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_180(var uParam0) // Position - 0xC8DA
{
	float num;
...
void func_181(int iParam0, var uParam1) // Position - 0xC968
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_182(BOOL bParam0) // Position - 0xC9CC
{
	var unk;
...
BOOL func_183(var uParam0) // Position - 0xCA63
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_184(int iParam0) // Position - 0xCA8D
{
	eCharacter character;
...
BOOL func_185() // Position - 0xD1AA
{
	return Global_100720.f_1;
}

BOOL func_186() // Position - 0xD1B8
{
	if (Global_97603 != -1)
...
BOOL func_191() // Position - 0xD268
{
	return Global_1575060;
}

BOOL func_192() // Position - 0xD274
{
	if (!unk_0xA26A9A07F761D8F8())
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD290
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_197(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_196(uParam0, 1);
			}
			else
			{
				...
				if (func_197(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_199(uParam0);
			}
		}
	}
...
void func_196(var uParam0, int iParam1) // Position - 0xD3F6
{
	BOOL flag;
	int i;
...
float func_197(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD494
{
	var unk;
...
void func_199(var uParam0) // Position - 0xD4DA
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_200(uParam0);
...
void func_200(var uParam0) // Position - 0xD4F1
{
	BOOL flag;
	int num;
	int i;
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD601
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_197(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD689
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD71A
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD7B5
{
	var unk;
	...
	if (func_243(*panParam0) || func_241(*panParam0) || Global_78804 == 1)
		return true;
...
BOOL func_208(int iParam0) // Position - 0xDD7D
{
...
BOOL func_209(var uParam0) // Position - 0xDD9D
{
...
BOOL func_210(var uParam0) // Position - 0xDDB5
{
...
void func_212(var uParam0) // Position - 0xE0DE
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE189
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_215(var uParam0, var uParam1) // Position - 0xE347
{
	var unk;
...
BOOL func_216(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE377
{
	int i;
	int num;
...
BOOL func_217(int iParam0) // Position - 0xE633
{
...
BOOL func_218(var uParam0, int iParam1) // Position - 0xE667
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_229(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_219(var uParam0, int iParam1) // Position - 0xE6DD
{
	return func_220(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_220(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE6F5
{
	BOOL flag;
	var unk;
	int num;

	num = func_228(uParam0, uParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam1))
	{
		if (num != -1)
			func_227(&iLocal_37[num /*4*/]);
	...
	flag = func_221(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_221(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE7B6
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_222(var uParam0, int iParam1) // Position - 0xE8E2
{
	int num;
...
BOOL func_224(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE9F1
{
	var unk;
	var unk4;
	float num;

	unk = { func_226(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_226(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_225(unk4, unk);
...
float func_225(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEA82
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_226(float fParam0, var uParam1, var uParam2) // Position - 0xEAA3
{
	float num;
	float num2;
...
int func_228(var uParam0, var uParam1) // Position - 0xEAFD
{
	int i;
...
int func_229(var uParam0) // Position - 0xEB3C
{
...
BOOL func_230(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEB64
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_234(uParam0, bParam1, num, num2))
				return true;
		
			if (func_231(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_231(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEC5F
{
	float num;
	float num2;
...
BOOL func_232(var uParam0, float fParam1) // Position - 0xED6B
{
	var unk;
	var unk2;
	...
	if (unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_233(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_233(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEE00
{
	var unk;
	var unk4;
	float num;

	unk = { func_226(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_234(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEE8E
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_235(int iParam0) // Position - 0xEED6
{
...
void func_236(var uParam0) // Position - 0xEF20
{
	var unk;
...
BOOL func_237(int iParam0) // Position - 0xEFBD
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_238(int iParam0) // Position - 0xF052
{
...
BOOL func_241(int iParam0) // Position - 0xF0D1
{
...
BOOL func_243(int iParam0) // Position - 0xF143
{
...
var func_244() // Position - 0xF16B
{
	return unk_0x54ECDA2DAB9CFB10(-74.8392f, 300.5241f, 104f, -62.467f, 318.6961f, 109f, 0, 1, 1, 1);
}

BOOL func_245(var uParam0) // Position - 0xF199
{
	switch (*uParam0)
	{
		case 46:
...
BOOL func_246(var uParam0) // Position - 0xF23C
{
	int num;
	char* str;
	int i;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&num) || !unk_0x2BBF749E555360DC(str))
				return false;
		...
		case 2:
			...
			{
				if (func_252(&uParam0->f_28[0], CHAR_BEVERLY, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_250(&uParam0->f_28[1], num[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, 26);
			...
			{
				func_250(&uParam0->f_28[2], num[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, 26);
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_248(&uParam0->f_35[0], num[1], -497.99f, 224.97f, 82.67f, 266.5f);
			...
			{
				func_248(&uParam0->f_35[1], num[2], -501.55f, 230.7f, 83.1f, 233.93f);
			...
			{
				func_247(&uParam0->f_41[0], num[5], -490.11f, 233.15f, 82.1f, 0f);
			...
			{
				func_247(&uParam0->f_41[1], num[6], -490.11f, 233.15f, 82.1f, 0f);
...
void func_247(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF801
{
	func_212(uParam0);
...
void func_248(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF828
{
	func_249(uParam0);
...
void func_249(var uParam0) // Position - 0xF86A
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_250(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0xF906
{
	func_251(uParam0);
...
void func_251(var uParam0) // Position - 0xF927
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_252(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF968
{
...
BOOL func_253(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF9C4
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_291(echParam1);
...
int func_254(var uParam0, eCharacter echParam1) // Position - 0xFA52
{
	int num;
...
BOOL func_255(var uParam0) // Position - 0xFA98
{
	int i;
...
BOOL func_256(var uParam0) // Position - 0xFAC9
{
	uParam0->f_16 = 3;
...
BOOL func_257(var uParam0) // Position - 0xFAFD
{
	int num;
	int i;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			func_248(&uParam0->f_35[0], num[0], 307.02f, 143.17f, 103.3f, 250.08f);
			unk_0x7A1950259E8A78CC(uParam0->f_35[0], 2);
...
BOOL func_258(var uParam0) // Position - 0xFBE8
{
	int num;
	var unk6;
	var unk10;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				if (func_252(&uParam0->f_28[0], CHAR_BEVERLY, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					unk_0x87EDBB907BE25521(uParam0->f_28[0]);
					unk_0xFECAE061D8C80757(uParam0->f_28[0], 9, 1, 0, 0);
					unk_0xC5B2830898581862(uParam0->f_28[0], 1);
			...
			if (func_131(uParam0->f_28[0]))
			{
				...
				{
					func_247(&uParam0->f_41[3], num[1], unk_0x7394CB479CCA24AF(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
			{
				uLocal_94 = unk_0x191673E3F99212B2(unk_0x30BE8A934C020461(uParam0->f_41[0], 1), unk_0x000D018EA42688BA(uParam0->f_41[0], 2), 2);
				unk_0xA2CBB04560DD6361(uParam0->f_41[0], uLocal_94, "idle_closed_pap_3_rcm_dumpster", str, 8f, -8f, 0, 1148846080);
				unk_0x5F243F8265BB664F(uLocal_94, 1);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
					unk_0x468D976993BF7FE1(uParam0->f_28[0], uLocal_94, str, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[1]))
					unk_0xA2CBB04560DD6361(uParam0->f_41[1], uLocal_94, "idle_closed_pap_3_rcm_lid_l", str, 8f, -8f, 0, 1148846080);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[2]))
					unk_0xA2CBB04560DD6361(uParam0->f_41[2], uLocal_94, "idle_closed_pap_3_rcm_lid_r", str, 8f, -8f, 0, 1148846080);
			}
...
BOOL func_259(var uParam0) // Position - 0x10129
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x28818732C8F0F80E("rcmpaparazzo_2");
			iLocal_91 = 1;
			break;
	
		case 1:
			if (!func_255(&num) || !unk_0x2BBF749E555360DC("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				if (func_252(&uParam0->f_28[0], CHAR_BEVERLY, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					unk_0x87EDBB907BE25521(uParam0->f_28[0]);
					unk_0xFECAE061D8C80757(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_131(uParam0->f_28[0]))
			{
				if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
				{
					func_247(&uParam0->f_41[0], num[2], unk_0x7394CB479CCA24AF(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_248(&uParam0->f_35[0], num[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
				unk_0x7A1950259E8A78CC(uParam0->f_35[0], 7);
				unk_0x6350D33B12812585(uParam0->f_35[0], 0);
				unk_0x3C5D12D7D1DA0113(uParam0->f_35[0], 0);
				unk_0x9D66740241AFDC4C(uParam0->f_35[0], 0);
				unk_0x33A7FF7A4EECCA59(uParam0->f_35[0], "P4P4R4Z0");
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()))
			{
				unk_0xEDB03CCB50D11479(uParam0->f_28[0], unk_0xC1A5EC5C986B98AD(), -1, 0, 2);
				uLocal_94 = unk_0x191673E3F99212B2(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				unk_0x5F243F8265BB664F(uLocal_94, 1);
				unk_0x468D976993BF7FE1(uParam0->f_28[0], uLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
				unk_0x1B58D923DDA17255(uParam0->f_28[0], 0);
				unk_0x598D91BBD045C1F3(uParam0->f_28[0], 185, 1);
			}
		
			unk_0x0B34FA69ECCE3927("rcmpaparazzo_2");
			unk_0x2112CE9FD54D593A("WORLD_HUMAN_PAPARAZZI", 0);
			unk_0x6FCA8E220FB1053D(-70.12f, 298.33f, 105.25f, 30f, 0);
...
BOOL func_260(var uParam0) // Position - 0x1046B
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				if (func_252(&uParam0->f_28[0], CHAR_BEVERLY, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					unk_0x87EDBB907BE25521(uParam0->f_28[0]);
					unk_0xFECAE061D8C80757(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_248(&uParam0->f_35[0], num[1], -159.56f, 275.41f, 93.14f, 102.75f);
			
				if (func_183(uParam0->f_35[0]))
					unk_0xDED5B7E9594C5D3B(uParam0->f_35[0], 62, 62);
				else
					flag = false;
			}
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				if (unk_0x2BBF749E555360DC("rcmpaparazzo1beckon"))
				{
					unk_0xDBC7406226B5540E(&unk4);
					unk_0x3EE48ADC8C7F5CC4(0, str, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3EE48ADC8C7F5CC4(0, str, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3EE48ADC8C7F5CC4(0, str, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3EE48ADC8C7F5CC4(0, str, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x00E06E21BBC8227A(unk4, 1);
					unk_0xF2CFC6EC8C85FA78(unk4);
					unk_0x3D7110D966B0CEA2(uParam0->f_28[0], unk4);
...
void func_261(int iParam0, BOOL bParam1) // Position - 0x1078F
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				unk_0x8E09E8C52602EBB2(-190.01993f, 260.10822f, 85f, -131.57199f, 285.8091f, 102f, 0, 1);
				unk_0xC6AD633F6B896D88(-190.01993f, 260.10822f, 85f, -131.57199f, 285.8091f, 102f, 0);
			}
			else
			{
				unk_0x8E09E8C52602EBB2(-190.01993f, 260.10822f, 85f, -131.57199f, 285.8091f, 102f, 1, 1);
			}
			break;
	}
...
BOOL func_262(int iParam0) // Position - 0x1081A
{
	var unk;
	eCharacter character;
...
BOOL func_263(int iParam0) // Position - 0x1086B
{
	var unk;
...
BOOL func_264(int iParam0) // Position - 0x10924
{
	var unk;
...
BOOL func_265(int iParam0) // Position - 0x109E5
{
	int i;
	var unk;
	int num;
...
BOOL func_267(int iParam0) // Position - 0x10B4C
{
...
BOOL func_268(int iParam0) // Position - 0x10B77
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_269(int iParam0) // Position - 0x10BA2
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_270(int iParam0) // Position - 0x10BCD
{
	if (func_238(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_272(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10C1C
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_273(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_273(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_273(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10C81
{
	int num;
	char* str;
	...
	if (func_274(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_274(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10CF9
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_275(var uParam0, BOOL bParam1) // Position - 0x10D74
{
	if (bParam1)
	{
		...
		{
			case 46:
				unk_0xE0A291F406691F03(iLocal_93);
				func_277(uParam0, 0, false, false);
				break;
		
			case 47:
				unk_0x2112CE9FD54D593A("WORLD_HUMAN_PAPARAZZI", 1);
				unk_0x17D46728E18012D3(uLocal_96, 0);
				func_277(uParam0, 0, false, false);
				break;
		
			case 48:
				unk_0x82EC7C3BD3DA9941(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), 1);
				unk_0x82EC7C3BD3DA9941(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), 1);
				unk_0x82EC7C3BD3DA9941(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), 1);
				func_212(&uParam0->f_41[3]);
				func_277(uParam0, 1, false, false);
				unk_0x2112CE9FD54D593A("WORLD_HUMAN_PAPARAZZI", 1);
				break;
		
			case 51:
				unk_0x0B34FA69ECCE3927("rcmpaparazzo_4");
				func_277(uParam0, 0, false, false);
				break;
	...
	if (unk_0xCE4AAA035282336C(uLocal_97))
		unk_0x45533C09A6C9B409(&uLocal_97);
	...
	if (!bParam1)
	{
		if (*uParam0 == 48)
		{
			...
			while (unk_0x24B651D85CCE5EB4(joaat("paparazzo3")) > 0)
			{
				SYSTEM::WAIT(0);
			}
		}
...
void func_279(var uParam0, BOOL bParam1) // Position - 0x10F4A
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_280(&uParam0->[i], false);
	}

	return;
}

void func_280(var uParam0, BOOL bParam1) // Position - 0x10F88
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_283(var uParam0) // Position - 0x11012
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_285(var uParam0, int iParam1) // Position - 0x1105C
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_286(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_286(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1109D
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_287(int iParam0) // Position - 0x110ED
{
	if (*iParam0 == -1)
		return;
...
int func_291(eCharacter echParam0) // Position - 0x11189
{
	if (!func_36(echParam0))
