...
void main() // Position - 0x0
{
	...
	iLocal_90 = func_296(CHAR_BEVERLY);
	hLocal_91 = joaat("pcj");
	iLocal_93 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_292(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	if (!func_277(&unk63, &num, vector, 5f))
	{
		func_276();
	...
	while (true)
	{
		...
		if (num == 47)
			func_207(&num, vector, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		else if (num == 51)
			func_207(&num, vector, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
	
		func_206(num);
		func_198(&iLocal_93, &(num.f_9), vector);
	
		if (func_183(&num, 0))
		{
			if (func_182(num))
				func_179(num, &blLocal_95);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x485F
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5510
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x554B
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57BF
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D4A
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x650D
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6554
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65BF
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x69D2
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69E2
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74F9
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7523
{
...
BOOL func_85(Player plParam0) // Position - 0x754F
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7651
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76E6
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8384
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8406
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x845E
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x86E3
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8700
{
...
int func_106(int iParam0) // Position - 0x8C49
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C6B
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8C82
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D40
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DB2
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DC8
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8DDE
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E20
{
...
BOOL func_122(Any* panParam0) // Position - 0xA8B3
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA51
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAB2D
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAC26
{
...
int func_134(Ped pedParam0) // Position - 0xAC8D
{
	int i;
...
BOOL func_135(Vehicle veParam0) // Position - 0xACD6
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xACF6
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAD17
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xADE7
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE3A
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAF2F
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFD9
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB140
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB1DA
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB1FC
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB249
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB2C6
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB36A
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3F9
{
...
void func_160(Vehicle veParam0) // Position - 0xB591
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB74D
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB7B3
{
...
BOOL func_169(int iParam0) // Position - 0xB7F4
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB86B
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB9A2
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9F1
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBA02
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBBE3
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBC16
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC5F
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBC83
{
	switch (iParam0)
	{
		case 0:
...
Blip func_180(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC0F3
{
	Blip blip;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC11F
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC136
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC1C5
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_185(var uParam0) // Position - 0xC9C3
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCA51
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_187(BOOL bParam0) // Position - 0xCAB5
{
...
BOOL func_188(Vehicle veParam0) // Position - 0xCB4C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_189(int iParam0) // Position - 0xCB76
{
	eCharacter character;
...
BOOL func_190() // Position - 0xD293
{
	return Global_100872.f_1;
}

BOOL func_191() // Position - 0xD2A1
{
	if (Global_97735 != -1)
...
BOOL func_195(int iParam0, int iParam1) // Position - 0xD319
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Position - 0xD351
{
	return Global_1575063;
}

BOOL func_197() // Position - 0xD35D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_198(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD379
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_201(var uParam0, int iParam1) // Position - 0xD4DF
{
	BOOL flag;
	int i;
...
float func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD57D
{
...
void func_204(var uParam0) // Position - 0xD5C3
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_205(uParam0);
...
void func_205(var uParam0) // Position - 0xD5DA
{
	BOOL flag;
	int num;
	int i;
...
int func_207(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD6EA
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD772
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD803
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD89E
{
	var unk;
	...
	if (func_248(*panParam0) || func_246(*panParam0) || Global_78935 == 1)
		return true;
...
void func_212(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDB0E
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_213(int iParam0) // Position - 0xDE66
{
...
BOOL func_214(var uParam0) // Position - 0xDE86
{
...
BOOL func_215(var uParam0) // Position - 0xDE9E
{
...
void func_217(Object* pobParam0) // Position - 0xE1C7
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE272
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_220(Ped pedParam0, Vehicle veParam1) // Position - 0xE430
{
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE460
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE71C
{
...
BOOL func_223(Vehicle veParam0, int iParam1) // Position - 0xE750
{
	float xSize;
...
BOOL func_224(Vehicle veParam0, int iParam1) // Position - 0xE7C6
{
	return func_225(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_225(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE7DE
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_226(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE89F
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_227(Ped pedParam0, int iParam1) // Position - 0xE9CB
{
...
BOOL func_229(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEADA
{
	var unk;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEB6B
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xEB8C
{
	float num;
	float num2;
...
int func_233(Vehicle veParam0, Ped pedParam1) // Position - 0xEBE6
{
	int i;
...
BOOL func_234(Vehicle veParam0) // Position - 0xEC25
{
...
BOOL func_235(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEC4D
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_236(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xED48
{
	float entityCoords;
	float num;
...
BOOL func_237(Vehicle veParam0, float fParam1) // Position - 0xEE54
{
	var outProjectile;
	var outCoords;
...
BOOL func_238(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEEE9
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_239(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEF77
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_240(int iParam0) // Position - 0xEFBF
{
...
void func_241(Vehicle veParam0) // Position - 0xF009
{
	int taskSequenceId;
...
BOOL func_242(int iParam0) // Position - 0xF0A6
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_243(int iParam0) // Position - 0xF13B
{
...
BOOL func_246(int iParam0) // Position - 0xF1BA
{
...
BOOL func_248(int iParam0) // Position - 0xF22C
{
...
BOOL func_250(var uParam0) // Position - 0xF282
{
	switch (*uParam0)
	{
		case 46:
...
BOOL func_251(var uParam0) // Position - 0xF325
{
	int num;
	char* animDict;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict))
				return false;
		...
		case 2:
			...
			{
				if (func_257(&uParam0->f_28[0], CHAR_BEVERLY, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_255(&uParam0->f_28[1], num[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, PED_TYPE_MISSION);
			...
			{
				func_255(&uParam0->f_28[2], num[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, PED_TYPE_MISSION);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_253(&uParam0->f_35[0], num[1], -497.99f, 224.97f, 82.67f, 266.5f);
			...
			{
				func_253(&uParam0->f_35[1], num[2], -501.55f, 230.7f, 83.1f, 233.93f);
			...
			{
				func_252(&uParam0->f_41[0], num[5], -490.11f, 233.15f, 82.1f, 0f);
			...
			{
				func_252(&uParam0->f_41[1], num[6], -490.11f, 233.15f, 82.1f, 0f);
...
void func_252(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF8EA
{
	func_217(pobParam0);
...
void func_253(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF911
{
	func_254(pveParam0);
...
void func_254(Vehicle* pveParam0) // Position - 0xF953
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_255(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0xF9EF
{
	func_256(ppedParam0);
...
void func_256(Ped* ppedParam0) // Position - 0xFA10
{
...
BOOL func_257(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA51
{
...
BOOL func_258(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAAD
{
	Hash model;
...
int func_259(var uParam0, eCharacter echParam1) // Position - 0xFB3B
{
	int num;
...
BOOL func_260(var uParam0) // Position - 0xFB81
{
	int i;
...
BOOL func_261(var uParam0) // Position - 0xFBB2
{
	uParam0->f_16 = 3;
...
BOOL func_262(var uParam0) // Position - 0xFBE6
{
	int num;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_253(&uParam0->f_35[0], num[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
BOOL func_263(var uParam0) // Position - 0xFCD1
{
	int num;
	var unk6;
	var unk10;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_257(&uParam0->f_28[0], CHAR_BEVERLY, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_135(uParam0->f_28[0]))
			{
				...
				{
					func_252(&uParam0->f_41[3], num[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
BOOL func_264(var uParam0) // Position - 0x10213
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_257(&uParam0->f_28[0], CHAR_BEVERLY, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
				}
			...
			if (func_135(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_252(&uParam0->f_41[0], num[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_253(&uParam0->f_35[0], num[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
...
BOOL func_265(var uParam0) // Position - 0x10555
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_257(&uParam0->f_28[0], CHAR_BEVERLY, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_253(&uParam0->f_35[0], num[1], -159.56f, 275.41f, 93.14f, 102.75f);
...
BOOL func_267(int iParam0) // Position - 0x10904
{
	var unk;
	eCharacter character;
...
BOOL func_268(int iParam0) // Position - 0x10955
{
	const char* string2;
...
BOOL func_269(int iParam0) // Position - 0x10A0E
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0x10ACF
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_273(int iParam0) // Position - 0x10C61
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x10C8C
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x10CB7
{
	if (func_243(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10D06
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10D6B
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10DE3
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x10E5E
{
	if (bParam1)
	{
		...
		switch (*uParam0)
		{
			case 46:
				...
				func_282(uParam0, 0, false, false);
				break;
			...
			case 48:
				...
				func_217(&uParam0->f_41[3]);
				func_282(uParam0, 1, false, false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", true);
				break;
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x11034
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_285(&uParam0->[i], false);
	}

	return;
}

void func_285(Object* pobParam0, BOOL bParam1) // Position - 0x11072
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_288(Vehicle* pveParam0) // Position - 0x110FC
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_291(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11187
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_292(int iParam0) // Position - 0x111D7
{
	if (*iParam0 == -1)
		return;
...
Hash func_296(eCharacter echParam0) // Position - 0x11273
{
	if (!func_36(echParam0))
