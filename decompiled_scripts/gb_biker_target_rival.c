					...
					if (_NETWORK_IS_PLAYER_VALID(unk_0xB850F932D03EF34D(unk), false, true))
						if (iParam1 > -1 && unk_0x1758F8A8511510AB() && iParam1 < 4)
							if (Global_4718592.f_108449[iParam1] != -1)
								...
								return func_40(plParam0, unk_0xB850F932D03EF34D(unk), iParam1, bParam2, bParam3);
						else
							return func_40(plParam0, unk_0xB850F932D03EF34D(unk), iParam1, bParam2, bParam3);
...
BOOL func_70(var uParam0, var uParam1, var uParam2, BOOL bParam3, Player plParam4, BOOL bParam5, var uParam6) // Position - 0x2151
{
	if (bParam5)
	{
