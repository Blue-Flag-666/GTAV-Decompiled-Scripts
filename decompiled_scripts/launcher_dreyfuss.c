...
void main() // Position - 0x0
{
	...
	iLocal_90 = func_301(CHAR_DREYFUSS);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_297(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		if (num == 8)
			func_197(&num, vector, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
	
		if (func_191(&num, 0) || func_179())
		{
			if (!func_2(&num))
				func_279(&num, true);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4816
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x54C7
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5502
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5776
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D01
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64C4
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x650B
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6576
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6989
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6999
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74B0
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x74DA
{
...
BOOL func_85(Player plParam0) // Position - 0x7506
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7608
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x769D
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x833B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x83BD
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8415
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x869A
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x86B7
{
...
int func_106(int iParam0) // Position - 0x8C00
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C22
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8C39
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8CF7
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D69
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D7F
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D95
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8DD7
{
...
BOOL func_122(Any* panParam0) // Position - 0xA86A
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA08
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAAE4
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xABDD
{
...
int func_134(Ped pedParam0) // Position - 0xAC44
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAC8D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xACAD
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xACCE
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAD9E
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xADF1
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAEE6
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF90
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB0F7
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB191
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB1B3
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB200
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB27D
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB321
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3B0
{
...
void func_160(Vehicle veParam0) // Position - 0xB548
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB704
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB76A
{
...
BOOL func_169(int iParam0) // Position - 0xB7AB
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB822
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB959
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9A8
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xB9B9
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBB9A
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBBCD
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC16
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
int func_179() // Position - 0xBC3A
{
	if (func_182(2))
	{
		if (func_181(PLAYER::PLAYER_PED_ID(), -1459.68f, 485.26f, 116.22f, true) < 6f && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
			...
			else if (!func_180(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_159(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_180(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xBCDB
{
...
float func_181(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xBD0E
{
...
BOOL func_182(int iParam0) // Position - 0xBD48
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_190() || Global_112857 || Global_32286 || func_189() || func_188(8, -1) || func_100() || func_187() || func_186() || func_185() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_190() || Global_32286 || func_189() || func_188(8, -1) || func_186() || func_100() || func_187() || func_185() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_190() || Global_112857 || Global_32286 || func_189() || func_188(8, -1) || func_186() || func_100() || func_187() || func_185() || Global_113810.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_190() || Global_112857 || Global_32286 || func_189() || func_188(8, -1) || func_100() || func_187() || func_185() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_190() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_188(8, -1) || func_185() || func_184() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_190() || func_187() || Global_112857 || Global_32286 || func_189() || Global_44569 || func_188(8, -1) || func_186() || func_184() || func_185() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_183() // Position - 0xC467
{
	return Global_100872.f_1;
}

BOOL func_184() // Position - 0xC475
{
	if (Global_97735 != -1)
...
BOOL func_188(int iParam0, int iParam1) // Position - 0xC4ED
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_189() // Position - 0xC525
{
	return Global_1575063;
}

BOOL func_190() // Position - 0xC531
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_191(var uParam0, int iParam1) // Position - 0xC54D
{
	switch (uParam0->f_16)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_182(2))
							{
								if (func_195(uParam0->f_27))
								{
									func_194(uParam0->f_27, *uParam0);
...
BOOL func_193(var uParam0) // Position - 0xCD4B
{
	float num;
...
void func_194(int iParam0, var uParam1) // Position - 0xCDD9
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_195(BOOL bParam0) // Position - 0xCE3D
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_196(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_196(Vehicle veParam0) // Position - 0xCED4
{
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCEFE
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_181(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCF86
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD017
{
...
void func_201(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD0B2
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_181(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_204(uParam0, 1);
			}
			else
			{
				...
				if (func_181(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_206(uParam0);
			}
		}
	}
...
void func_204(var uParam0, int iParam1) // Position - 0xD218
{
	BOOL flag;
	int i;
...
void func_206(var uParam0) // Position - 0xD2C2
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_207(uParam0);
...
void func_207(var uParam0) // Position - 0xD2D9
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD3E9
{
	var unk;
	...
	if (func_246(*panParam0) || func_244(*panParam0) || Global_78935 == 1)
		return true;
...
void func_210(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD659
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_211(int iParam0) // Position - 0xD9B1
{
...
BOOL func_212(var uParam0) // Position - 0xD9D1
{
...
BOOL func_213(var uParam0) // Position - 0xD9E9
{
...
void func_215(Object* pobParam0) // Position - 0xDD12
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDDBD
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_196(playersLastVehicle2))
						{
...
BOOL func_218(Ped pedParam0, Vehicle veParam1) // Position - 0xDF7B
{
...
BOOL func_219(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDFAB
{
	int i;
	int num;
...
BOOL func_220(int iParam0) // Position - 0xE267
{
...
BOOL func_221(Ped pedParam0, int iParam1) // Position - 0xE29B
{
	float xSize;
...
BOOL func_222(Ped pedParam0, int iParam1) // Position - 0xE311
{
	return func_223(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_223(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE329
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_224(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE3EA
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_225(Ped pedParam0, int iParam1) // Position - 0xE516
{
...
BOOL func_227(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE625
{
	var unk;
...
float func_228(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE6B6
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_229(float fParam0, var uParam1, var uParam2) // Position - 0xE6D7
{
	float num;
	float num2;
...
int func_231(Ped pedParam0, Ped pedParam1) // Position - 0xE731
{
	int i;
...
BOOL func_232(Ped pedParam0) // Position - 0xE770
{
...
BOOL func_233(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE798
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_234(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE893
{
	float entityCoords;
	float num;
...
BOOL func_235(Ped pedParam0, float fParam1) // Position - 0xE99F
{
	var outProjectile;
	var outCoords;
...
BOOL func_236(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEA34
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_237(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEAC2
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_238(int iParam0) // Position - 0xEB0A
{
...
void func_239(Vehicle veParam0) // Position - 0xEB54
{
	int taskSequenceId;
...
BOOL func_240(int iParam0) // Position - 0xEBF1
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_241(int iParam0) // Position - 0xEC86
{
...
BOOL func_244(int iParam0) // Position - 0xED05
{
...
BOOL func_246(int iParam0) // Position - 0xED77
{
...
BOOL func_248(var uParam0) // Position - 0xEDCD
{
	if (!func_249(uParam0))
		return false;
...
BOOL func_249(var uParam0) // Position - 0xEDEC
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_260(&uParam0->f_28[0], CHAR_DREYFUSS, -1459.68f, 485.26f, 116.22f, -131.3f, "DREYFUSS LAUNCHER RC", 1))
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_258(&uParam0->f_35[0], num[1], uLocal_92, fLocal_95);
...
void func_251(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF059
{
	if (iParam0 != 198)
	{
		if (Global_78689)
		...
		func_254(iParam0, bParam3, iParam4, false);
...
void func_258(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13777
{
	func_259(pveParam0);
...
void func_259(Vehicle* pveParam0) // Position - 0x137B9
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x13855
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x138B1
{
	Hash model;
...
int func_262(var uParam0, eCharacter echParam1) // Position - 0x1393F
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0x13985
{
	if (func_213(uParam0))
	{
...
BOOL func_264(var uParam0) // Position - 0x139AF
{
	int i;
...
BOOL func_266(int iParam0) // Position - 0x13A1C
{
	var unk;
	eCharacter character;
...
BOOL func_267(int iParam0) // Position - 0x13A6D
{
	const char* string2;
...
BOOL func_268(int iParam0) // Position - 0x13B26
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0x13BE7
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_271(int iParam0) // Position - 0x13D4E
{
...
BOOL func_272(int iParam0) // Position - 0x13D79
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_273(int iParam0) // Position - 0x13DA4
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x13DCF
{
	if (func_241(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13E1E
{
	int i;
...
BOOL func_277(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x13E83
{
	int num;
	char* str;
...
BOOL func_278(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x13EFB
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_279(var uParam0, BOOL bParam1) // Position - 0x13F76
{
	char* str;
...
BOOL func_283(char* sParam0) // Position - 0x14050
{
	var string1;
...
void func_289(Object* pobParam0, BOOL bParam1) // Position - 0x1413A
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_292(Vehicle* pveParam0) // Position - 0x141C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_295(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1424F
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_296(Ped* ppedParam0) // Position - 0x1429F
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_297(int iParam0) // Position - 0x142E0
{
	if (*iParam0 == -1)
		return;
...
Hash func_301(eCharacter echParam0) // Position - 0x1437C
{
	if (!func_36(echParam0))
