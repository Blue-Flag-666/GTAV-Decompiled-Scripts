...
void main() // Position - 0x0
{
	...
	uLocal_94 = { -1473.3762f, 517.8441f, 116.8854f };
	fLocal_97 = 97.3011f;
	iLocal_98 = -1;
	...
	if (!func_271(&unk64, &num, unk61, 1f))
	{
		func_270();
	...
	while (true)
	{
		...
		func_203(num);
		func_196(&iLocal_98, &(num.f_9), unk61);
	
		if (num == 8)
			func_192(&num, unk61, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x395D
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EA6
{
	eCharacter character;
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C9D
{
	var unk;
	var unk2;
...
int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6927
{
	int i;
	float num;
	float num2;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x75E4
{
	float num;
	float num2;
	float num3;
...
var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B67
{
	if (bParam0)
		return uParam1;
...
BOOL func_131(var uParam0) // Position - 0xABD2
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xABF2
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAD36
{
	int i;
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAED5
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB03C
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB0C8
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB115
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB192
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB2C5
{
...
void func_155(var uParam0) // Position - 0xB45D
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
int func_172(var uParam0, int iParam1) // Position - 0xBAE2
{
	int num;
	var unk;
	var unk33;
...
int func_174() // Position - 0xBB4F
{
	if (func_177(2))
	{
		if (func_176(unk_0xC1A5EC5C986B98AD(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			{
			...
			else if (!func_175(unk_0xC1A5EC5C986B98AD(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0)) && func_154(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x6FE9A0C01D25F413(unk_0xC1A5EC5C986B98AD(), 0, 0);
			}
		}
...
BOOL func_175(var uParam0, int iParam1) // Position - 0xBBF0
{
	if (func_131(uParam0))
...
float func_176(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xBC23
{
	var unk;
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_185() || Global_112695 || Global_32166 || func_184() || func_183(8, -1) || func_96() || func_182() || func_181() || func_180() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_185() || Global_32166 || func_184() || func_183(8, -1) || func_181() || func_96() || func_182() || func_180() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_185() || Global_112695 || Global_32166 || func_184() || func_183(8, -1) || func_181() || func_96() || func_182() || func_180() || Global_113648.f_7690.f_919[character] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_185() || Global_112695 || Global_32166 || func_184() || func_183(8, -1) || func_96() || func_182() || func_180() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_185() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 || func_183(8, -1) || func_180() || func_179() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
BOOL func_191(var uParam0) // Position - 0xCDE8
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
int func_192(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCE12
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_176(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCF2B
{
...
void func_196(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCFC6
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_176(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_199(uParam0, 1);
			}
			else
			{
				...
				if (func_176(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_201(uParam0);
			}
		}
	}
...
void func_210(var uParam0) // Position - 0xDC26
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_213(var uParam0, var uParam1) // Position - 0xDE8F
{
	var unk;
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xE1AF
{
	float num;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE225
{
	return func_218(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_218(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE23D
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE2FE
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_220(var uParam0, int iParam1) // Position - 0xE42A
{
	int num;
...
BOOL func_222(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE539
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_224(float fParam0, var uParam1, var uParam2) // Position - 0xE5EB
{
	float num;
	float num2;
...
int func_226(var uParam0, var uParam1) // Position - 0xE645
{
	int i;
...
int func_227(var uParam0) // Position - 0xE684
{
...
BOOL func_228(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE6AC
{
	float num;
	float num2;
	int num3;
...
BOOL func_229(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE7A7
{
	float num;
	float num2;
...
BOOL func_230(var uParam0, float fParam1) // Position - 0xE8B3
{
	var unk;
	var unk2;
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE948
{
	var unk;
	var unk4;
	float num;
...
BOOL func_232(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE9D6
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
void func_234(var uParam0) // Position - 0xEA68
{
	var unk;
...
BOOL func_244(var uParam0) // Position - 0xED00
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_259(&num) || !func_258(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_255(&uParam0->f_28[0], CHAR_DREYFUSS, -1459.68f, 485.26f, 116.22f, -131.3f, "DREYFUSS LAUNCHER RC", 1))
					flag = false;
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
				{
					...
					unk_0x9C56520AE72AFDBF(iLocal_93, 1);
				}
			}
...
void func_245(int iParam0) // Position - 0xEF1B
{
...
void func_253(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x132B8
{
	func_254(uParam0);
...
void func_254(var uParam0) // Position - 0x132FA
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_255(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x13396
{
...
BOOL func_256(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x133F2
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_296(echParam1);
...
BOOL func_271(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1395F
{
	...
	if (*uParam0 == 1)
	{
		if (func_272(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
...
void func_274(var uParam0, BOOL bParam1) // Position - 0x13AB7
{
	...
	func_275(str);
	unk_0x9C56520AE72AFDBF(iLocal_93, 0);
	unk_0x17D46728E18012D3(uLocal_99, 0);
	func_245(1);
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x13C76
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_287(var uParam0) // Position - 0x13D00
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_289(var uParam0, int iParam1) // Position - 0x13D4A
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_290(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_290(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13D8B
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_291(var uParam0) // Position - 0x13DDB
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
int func_296(eCharacter echParam0) // Position - 0x13EB8
{
	if (!func_36(echParam0))
