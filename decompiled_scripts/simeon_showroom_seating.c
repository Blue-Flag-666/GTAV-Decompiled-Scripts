...
BOOL func_28(Player plParam0) // Position - 0x11BC
{
...
BOOL func_33(Ped pedParam0) // Position - 0x153C
{
	int weaponHash;
...
void func_54(int* piParam0, int iParam1) // Position - 0x1A8B
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x225B
{
	int i;
...
BOOL func_66(Player plParam0) // Position - 0x239F
{
	return func_67(plParam0) == joaat("WEAPON_MINIGUN");
}

int func_67(Player plParam0) // Position - 0x23B3
{
...
BOOL func_75(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x257D
{
...
BOOL func_76(Ped pedParam0, var uParam1) // Position - 0x25DD
{
...
void func_79(int* piParam0, int iParam1) // Position - 0x267B
{
...
void func_83(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x2743
{
	int offset;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x283F
{
	switch (func_89())
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x28E2
{
