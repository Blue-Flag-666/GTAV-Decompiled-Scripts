...
void main() // Position - 0x0
{
	...
	iLocal_42 = 49;
	iLocal_43 = 64;
	uLocal_51 = { 928.0903f, 1733.12f, 165.1067f };
	uLocal_54 = { 2374.21f, 316.6781f, 180.4001f };
	uLocal_57 = { -804.8174f, 4051.37f, 159.6384f };
	...
	if (func_91(uLocal_48, 29, iLocal_60, false, false))
		func_88(29);
	else
		unk_0x675D9C12C73D3DE7();
	...
	while (true)
	{
		...
		if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
		{
			...
			unk_0x350F65B0612C7A16(num - 2000f, num.f_1 - 2000f, num + 2000f, num.f_1 + 2000f);
		...
		if (!func_85())
		{
			if (unk_0xCBE2EC2868A6C438())
			{
				...
				unk_0x385C3C9C52E9D548("RE_BP", 0);
...
void func_3(int iParam0, int iParam1) // Position - 0x217
{
	...
	if (iParam1 <= func_28(iParam0))
	{
		...
		if (func_13(iParam0, iParam1) != 322)
			func_5(func_13(iParam0, iParam1), uLocal_44, uLocal_44.f_1);
...
BOOL func_33() // Position - 0x159C
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0x66599E73DBA5A850(uLocal_85[i]))
			num = 0;
	}
...
int func_34() // Position - 0x15CC
{
	...
	if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		for (i = 0; i < 3; i = i + 1)
		{
			if (!unk_0x66599E73DBA5A850(uLocal_85[i]))
			{
				if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), unk_0x30BE8A934C020461(uLocal_85[i], 0)) < 400f)
				{
					if (!bLocal_62)
					{
						if (iLocal_83 == 2)
						{
							if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0) && unk_0xDC58AE028CB223BA(unk_0xC1A5EC5C986B98AD()) < 2f)
							{
								bLocal_62 = true;
								iLocal_83 = 3;
							}
							else if (unk_0x4FBDBA15B9C41492(unk_0xC1A5EC5C986B98AD()) && unk_0xDC58AE028CB223BA(unk_0xC1A5EC5C986B98AD()) < 1f)
							{
								bLocal_62 = true;
								iLocal_83 = 3;
							}
						...
						if (unk_0x7559C38E6535AB89(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), 1) || unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uLocal_85[i]) || unk_0xBAE1E5327FD0C1E3(unk_0x93E99A2DBCBA9CFA(), uLocal_85[i]))
						{
							bLocal_62 = true;
							bLocal_65 = true;
							bLocal_64 = true;
					...
					if (!bLocal_62 || iLocal_83 < 3)
					{
						...
						{
							if (!unk_0x7B5C0F0BBFDEA237(uLocal_85[i]))
							{
								func_54(&uLocal_99, 1);
								_CONVERSATION_INITIALIZE_ACTOR(&uLocal_99, 1, uLocal_85[i], "BorderPatrol", 0, 1);
								...
								if (iLocal_83 == 0)
								{
									...
									{
										if (_GET_RANDOM_BOOL())
											_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_INS1", 4, 0, 0, 0);
										else
											_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_INS2", 4, 0, 0, 0);
								...
								{
									_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_STOP", 4, 0, 0, 0);
									iLocal_83 = iLocal_83 + 1;
								}
								else
								{
									_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_PULL", 4, 0, 0, 0);
								}
					...
					{
						if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0x7B5C0F0BBFDEA237(uLocal_85[i]))
						{
							unk_0x0133FF6E23A1DCA4(5, uLocal_97, joaat("PLAYER"));
							unk_0x7FE5E05BE63F6CB8(uLocal_85[i], 2, 1);
							func_54(&uLocal_99, 1);
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_99, 1, uLocal_85[i], "BorderPatrol", 0, 1);
						
							if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_ATTM", 4, 0, 0, 0);
							else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_ATTF", 4, 0, 0, 0);
							else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_ATTT", 4, 0, 0, 0);
					...
					else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						...
						{
							if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_REACTM", 4, 0, 0, 0);
							else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_REACTF", 4, 0, 0, 0);
							else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_REACTT", 4, 0, 0, 0);
						
							bLocal_66 = true;
						}
					
						if (SYSTEM::TIMERA() > 5000 && !unk_0x7B5C0F0BBFDEA237(uLocal_85[i]))
						{
							func_54(&uLocal_99, 1);
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_99, 1, uLocal_85[i], "BorderPatrol", 0, 1);
						
							if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_CONM", 4, 0, 0, 0);
							else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_CONF", 4, 0, 0, 0);
							else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
								_CONVERSATION_ADD_LINE(&uLocal_99, "REBORAU", "REBOR_COTT", 4, 0, 0, 0);
...
BOOL func_56() // Position - 0x21AB
{
	...
	{
		if (!unk_0x66599E73DBA5A850(uLocal_85[i]))
			if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), unk_0x30BE8A934C020461(uLocal_85[i], 0)) < 62500f)
				return true;
			else
...
void func_57() // Position - 0x2205
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0x66599E73DBA5A850(uLocal_85[i]))
		{
			...
			{
				if (unk_0x3C3D6D026CF7F51B(uLocal_85[i], 0))
				{
					if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0) && !uLocal_67[i])
					{
						if (!unk_0x055111B11E6624FD(uLocal_89[i], 0))
							unk_0x3DFE9C7902334B74(uLocal_85[i], uLocal_89[i], unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), i + 10, 30f, 786469, 10f, 5f, 1);
					
						if (!bLocal_65)
							SYSTEM::WAIT(unk_0x15A88CFAAFFC6C4B(400, 800));
						else
							SYSTEM::WAIT(0);
						...
						if (!unk_0x66599E73DBA5A850(uLocal_85[i]))
						{
							if (unk_0x3C3D6D026CF7F51B(uLocal_85[i], 0))
							{
								unk_0x6855D2807847D85A(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), 0, 0f, 0f, 0f, 1000f, 60, 1, joaat("FIRING_PATTERN_BURST_FIRE_DRIVEBY"));
								unk_0x71A535529C1CA5DF(uLocal_85[i], 1);
							}
						}
					...
					else if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0) && !uLocal_71[i])
					{
						if (!unk_0x66599E73DBA5A850(uLocal_85[i]) && !unk_0x055111B11E6624FD(uLocal_89[i], 0))
						{
							unk_0xB8194851FFF54D3B(uLocal_85[i], uLocal_89[i], unk_0xC1A5EC5C986B98AD(), i + 10, 30f, 786469, 10f, 5f, 1);
				...
				else if (!unk_0x3C3D6D026CF7F51B(uLocal_85[i], 0))
				{
					unk_0xCAC2B0C65B18E755(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), 0, 16);
					unk_0x71A535529C1CA5DF(uLocal_85[i], 1);
				}
			}
			else if (unk_0x3C3D6D026CF7F51B(uLocal_85[i], 0))
			{
				if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0) && !uLocal_75[i])
				{
					if (unk_0xF5F493B789EA063E(uLocal_85[i], joaat("SCRIPT_TASK_VEHICLE_CHASE")) != 1 && unk_0xF5F493B789EA063E(uLocal_85[i], joaat("SCRIPT_TASK_VEHICLE_CHASE")) != 0)
					{
						unk_0x909F139DC199D8E0(uLocal_85[i]);
					
						if (!unk_0x055111B11E6624FD(uLocal_89[i], 0))
						{
							unk_0x3DFE9C7902334B74(uLocal_85[i], uLocal_89[i], unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), i + 10, 30f, 786469, 10f, 5f, 1);
							unk_0xEDB03CCB50D11479(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), -1, 2096, 4);
						}
				...
				else if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0) && !uLocal_79[i])
				{
					if (!unk_0x66599E73DBA5A850(uLocal_85[i]) && !unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !unk_0x055111B11E6624FD(uLocal_89[i], 0))
					{
						unk_0x909F139DC199D8E0(uLocal_85[i]);
						unk_0xB8194851FFF54D3B(uLocal_85[i], uLocal_89[i], unk_0xC1A5EC5C986B98AD(), i + 10, 30f, 786469, 10f, 5f, 1);
						unk_0xEDB03CCB50D11479(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), -1, 2096, 4);
			...
			{
				unk_0xCF2A28DE0B1118AA(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), 1f, 0f, 0f, 2f, -1, 1036831949, 1);
			}
		
			if (!unk_0x66599E73DBA5A850(uLocal_85[i]))
			{
				if (unk_0x1589BC95A4C50F21(uLocal_85[i]))
				{
					if (unk_0x3C3D6D026CF7F51B(uLocal_85[i], 0))
						unk_0x6FE9A0C01D25F413(uLocal_85[i], 0, 0);
				
					if (!unk_0xB8C39D031C377E33(uLocal_85[i], 0))
						unk_0xCAC2B0C65B18E755(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), 0, 16);
				}
			}
		
			if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0) && unk_0x3C3D6D026CF7F51B(uLocal_85[i], 0))
				if (unk_0xDC58AE028CB223BA(unk_0xC1A5EC5C986B98AD()) > 13f)
					if (unk_0x110B96B5C67CC73B(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), unk_0x95DC39736F6748E3(uLocal_85[i], 0)))
						unk_0x0ED11C03A622AA2B(uLocal_85[i], 3);
					else
						unk_0x0ED11C03A622AA2B(uLocal_85[i], 1);
				else
					unk_0x0ED11C03A622AA2B(uLocal_85[i], 1);
		
			if (func_133())
				unk_0xC6C9BF71106ABCAC(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), 1000f, -1, 0, 0);
		}
		else if (unk_0x7DE17ACDD8BA2642(uLocal_85[i]))
		{
			bLocal_65 = true;
			bLocal_64 = true;
		}
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0x66599E73DBA5A850(uLocal_85[i]))
			if (bLocal_63 || bLocal_62)
				if (!unk_0xCE4AAA035282336C(uLocal_93[i]))
					uLocal_93[i] = func_59(uLocal_85[i], true, 145);
		else if (unk_0xCE4AAA035282336C(uLocal_93[i]))
			unk_0x45533C09A6C9B409(&uLocal_93[i]);
	}
...
{
	switch (func_67(&Global_32223, 0, 5, false, unk_0xAF908D5E2416DA93()))
	{
		case 1:
			return true;
...
BOOL func_72() // Position - 0x2DA8
{
	...
	unk_0x852EC2A7DE66202D(num5);
	unk_0x852EC2A7DE66202D(num3);
	unk_0x852EC2A7DE66202D(num4);

	if (unk_0x0CBB7C273DED26E7(num5) && unk_0x0CBB7C273DED26E7(num3) && unk_0x0CBB7C273DED26E7(num4))
	{
		if (unk_0xFBD273FDBCF0C5BD(uLocal_89[0], 0) && unk_0xFBD273FDBCF0C5BD(uLocal_89[1], 0) && unk_0xFBD273FDBCF0C5BD(uLocal_89[2], 0))
		{
			return true;
		}
		else
		{
			...
			{
				unk_0xEFF38E898AA25D77(unk_0x7394CB479CCA24AF(unk_0xC1A5EC5C986B98AD(), 0f, -25f, 0f), unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), 1, &num, &unk3, 1, 1077936128, 0);
			
				if (!unk_0x67670574D396B9A8(num, 5f))
				{
					unk_0xDA95D0C19E737224("re_border badGuys", &uLocal_97);
					unk_0x0133FF6E23A1DCA4(3, uLocal_97, joaat("PLAYER"));
					...
					for (i = 0; i < 3; i = i + 1)
					{
						...
						if (num2 > 1)
							uLocal_89[i] = unk_0xABEEDBEF2BBDF5B3(num3, num, unk3, 1, 1, 0);
						else
							uLocal_89[i] = unk_0xABEEDBEF2BBDF5B3(num4, num, unk3, 1, 1, 0);
					
						uLocal_85[i] = unk_0x4FA078B1B32445FD(uLocal_89[i], 22, num5, -1, 1, 1);
						unk_0xEDB03CCB50D11479(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), -1, 2096, 4);
						unk_0x71A535529C1CA5DF(uLocal_85[i], 1);
						unk_0xC5B2830898581862(uLocal_85[i], 1);
						unk_0x8386356641D0DED1(uLocal_85[i], uLocal_97);
						unk_0xCBDC2B59922F92C3(uLocal_85[i], joaat("WEAPON_SAWNOFFSHOTGUN"), -1, 1, 1);
						unk_0xC75D5CC27D850469(uLocal_89[i], unk_0xDC58AE028CB223BA(unk_0xC1A5EC5C986B98AD()));
						unk_0x8F758E95FCF28E36(uLocal_85[i], 2);
						unk_0x7FE5E05BE63F6CB8(uLocal_85[i], 50, 1);
						unk_0x7FE5E05BE63F6CB8(uLocal_85[i], 2, 1);
						unk_0x7FE5E05BE63F6CB8(uLocal_85[i], 1, 1);
						unk_0x7FE5E05BE63F6CB8(uLocal_85[i], 52, 1);
						unk_0x55B25C3B4CEEEF4B(uLocal_85[i], 5);
						unk_0x8980E75D09DCDE5F(uLocal_85[i], joaat("FIRING_PATTERN_SINGLE_SHOT"));
						unk_0x5DDC305DCF8431AC(uLocal_85[i], unk_0x15A88CFAAFFC6C4B(50, 100));
						unk_0x0ED11C03A622AA2B(uLocal_85[i], 1);
						unk_0x598D91BBD045C1F3(uLocal_85[i], 42, 1);
						unk_0x45583CDA541E788E(uLocal_85[i], 0);
						unk_0xCFFDA1550DF82B52(uLocal_85[i], 233);
						unk_0xEE72EF85581D1171(uLocal_85[i], "A_M_M_HILLBILLY_02_WHITE_MINI_04");
						unk_0x57B1A0850EB7F1F4(uLocal_85[i], 1);
					}
				
					unk_0x7A1950259E8A78CC(uLocal_89[0], 0);
					unk_0x7A1950259E8A78CC(uLocal_89[1], 1);
					unk_0x7A1950259E8A78CC(uLocal_89[2], 2);
				}
			}
			...
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_99, 0, unk_0xC1A5EC5C986B98AD(), sLocal_98, 0, 1);
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_99, 1, uLocal_85[0], "BorderPatrol", 0, 1);
		}
	}
...
BOOL func_73() // Position - 0x3080
{
	...
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
		if (SYSTEM::VMAG2(unk_0x7A2C98D06C9C1956(unk_0xC1A5EC5C986B98AD())) > 1369f && !func_80())
			return false;
...
int func_108() // Position - 0x5604
{
	...
	func_114(&unk, unk_0x731F95B6458DCF80());
	func_113(&unk, unk_0x77BBAAED3E25322C());
	func_112(&unk, unk_0x30DFE1FFD2CC7420());
	func_111(&unk, unk_0x8C0F17CAC308A14B());
	func_110(&unk, unk_0x61117764C67882B7());
	func_109(&unk, unk_0x367F557725B53815());
	return unk;
}
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_125() || Global_112695 || Global_32166 || func_124() || func_49(8, -1) || func_123() || func_122() || func_121() || func_120() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_125() || Global_32166 || func_124() || func_49(8, -1) || func_121() || func_123() || func_122() || func_120() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_125() || Global_112695 || Global_32166 || func_124() || func_49(8, -1) || func_121() || func_123() || func_122() || func_120() || Global_113648.f_7690.f_919[character] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_125() || Global_112695 || Global_32166 || func_124() || func_49(8, -1) || func_123() || func_122() || func_120() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_125() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 || func_49(8, -1) || func_120() || func_119() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
	...
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
		if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			if (unk_0xFBD273FDBCF0C5BD(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 0))
				if (unk_0x36AEE6FB36B84B00(unk_0xC1A5EC5C986B98AD(), joaat("rhino")) || unk_0x36AEE6FB36B84B00(unk_0xC1A5EC5C986B98AD(), joaat("ambulance")) || unk_0x36AEE6FB36B84B00(unk_0xC1A5EC5C986B98AD(), joaat("firetruk")) || unk_0x6AE0E79C82A558ED(unk_0xC1A5EC5C986B98AD()) || unk_0xA87ECD5E2653C4A9(unk_0xC1A5EC5C986B98AD()) || Global_112695 == true)
					return true;
...
void func_134() // Position - 0x6407
{
	...
	if (bLocal_61)
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			if (!unk_0x66599E73DBA5A850(uLocal_85[i]) && !unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				unk_0xC6C9BF71106ABCAC(uLocal_85[i], unk_0xC1A5EC5C986B98AD(), 1000f, -1, 0, 0);
				unk_0x71A535529C1CA5DF(uLocal_85[i], 1);
			}
...
void func_135(int iParam0) // Position - 0x6484
{
	...
	if (func_85())
	{
		...
		func_138(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_137(Global_113637, true), 64);
...
Vector3 func_146() // Position - 0x6C57
{
	...
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		num = unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_51, 1);
		iLocal_60 = 1;
	
		if (unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_54, 1) < num)
		{
			num = unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_54, 1);
			iLocal_60 = 2;
		}
	
		if (unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_57, 1) < num)
		{
			num = unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_57, 1);
			iLocal_60 = 3;
		}
