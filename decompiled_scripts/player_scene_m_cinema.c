...
BOOL func_2() // Position - 0x10C
{
	...
	{
		func_3(iLocal_72[i], i);
	}

	if (SYSTEM::VDIST(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_104) > 100f)
		return true;
	...
	if (unk_0x7DE17ACDD8BA2642(uParam0))
	{
		switch (iLocal_82[iParam1])
		{
			case 0:
				...
				if (unk_0xF5F493B789EA063E(uParam0, joaat("SCRIPT_TASK_WANDER_STANDARD")) != 1)
				{
					unk_0x984708151807AC6D(uParam0, 1193033728, 0);
					unk_0x71A535529C1CA5DF(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x2AC37494BBF1DB16(&uLocal_87[iParam1 /*4*/]))
				{
					SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&uLocal_87[iParam1 /*4*/], &iLocal_72[iParam1], 1, DEFAULT);
					iLocal_82[iParam1] = 4;
					return 0;
				}
				...
				if (!unk_0xA239AFE8684C2BD1(uParam0))
				{
					unk_0x2B8574FAEA21141B(uParam0, str, 0, 1);
					unk_0x71A535529C1CA5DF(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 2:
				...
				{
					if (iParam1 != i)
						if (iLocal_82[i] < 2 && iLocal_82[iParam1] >= 0)
							iLocal_82[i] = 2;
				}
			...
			case 3:
				...
				if (unk_0xF5F493B789EA063E(uParam0, joaat("SCRIPT_TASK_SMART_FLEE_PED")) != 1)
				{
					...
					unk_0xC6C9BF71106ABCAC(uParam0, unk_0xC1A5EC5C986B98AD(), 50f, 20000, 1, 0);
					return 1;
				}
			
				if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(uParam0, 1), unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1)) > 50f * 50f)
				{
					iLocal_82[iParam1] = 0;
					return 1;
				}
...
void func_11() // Position - 0x574
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_12(character) && !func_16(14) || Global_112599)
			{
...
void func_21() // Position - 0x769
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_77; i = i + 1)
		{
			...
			if (!unk_0x2AC37494BBF1DB16(&uLocal_87[i /*4*/]))
			{
				unk_0x3EC562D93709C894(&uLocal_87[i /*4*/]);
			
				if (!unk_0x6CAF14BE58B4BFF8(&uLocal_87[i /*4*/]))
					flag = false;
			}
		}
	...
	for (i = 0; i < iLocal_72; i = i + 1)
	{
		if (iLocal_77[i] != 0)
		{
			iLocal_72[i] = unk_0x69FDD9508259E5B5(4, iLocal_77[i], uLocal_104 + uLocal_108[i /*3*/], 0, 1, 1);
			unk_0x692C3FDAD7DB53CC(iLocal_72[i], fLocal_107 + uLocal_121[i]);
			...
			unk_0xAC2C285C82A9244C(iLocal_72[i], 0);
		}
	}
...
void func_22() // Position - 0x896
{
	...
	func_26(iLocal_70, &uLocal_104, &fLocal_107, &unk);
	num.f_1 = -1;
	num.f_17 = 4;
	num.f_17.f_8 = 4;
	num.f_17.f_13 = 4;
	...
	{
		case 97:
			uLocal_108[0 /*3*/] = { { 45.5004f, -205.8167f, -1416.5402f } - uLocal_104 };
			uLocal_108[1 /*3*/] = { { 45.5004f, -207.5375f, -1423.8984f } - uLocal_104 };
			uLocal_108[2 /*3*/] = { { 45.5004f, -210.4254f, -1428.5013f } - uLocal_104 };
			uLocal_108[3 /*3*/] = { { 45.5004f, unk_0xD88C7A93096DA0F7(-205.8167f, -210.4254f), unk_0xD88C7A93096DA0F7(-1416.5402f, -1428.5013f) } - uLocal_104 };
			uLocal_121[0] = 5.8017f - fLocal_107;
			uLocal_121[1] = 2.582f - fLocal_107;
			uLocal_121[2] = -47.7025f - fLocal_107;
			uLocal_121[3] = 65.2818f - fLocal_107;
			iLocal_77[0] = joaat("A_F_M_Tourist_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[0 /*4*/], "", 16);
			iLocal_77[1] = joaat("A_M_Y_Hipster_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[1 /*4*/], "", 16);
			iLocal_77[2] = joaat("A_M_M_BevHills_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[2 /*4*/], "", 16);
			iLocal_77[3] = joaat("A_M_M_GenFat_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[3 /*4*/], "", 16);
			iLocal_82[0] = 0;
			iLocal_82[1] = 0;
			iLocal_82[2] = 0;
			iLocal_82[3] = 0;
		...
		case 158:
			uLocal_108[0 /*3*/] = { 1.2712f, 6.071f, -0.75f };
			uLocal_108[1 /*3*/] = { 3.8061f, 5.7599f, -0.5f };
			uLocal_108[2 /*3*/] = { 4.541f, 7.8487f, -0.4f };
			uLocal_108[3 /*3*/] = { 3.1051f, 13.7474f, -0.3463f };
			uLocal_121[0] = 123.059f;
			uLocal_121[1] = 134.0498f;
			uLocal_121[2] = 58.663f;
			uLocal_121[3] = 89.5592f;
			iLocal_77[0] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[0 /*4*/], "pb_prostitute", 16);
			iLocal_77[1] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[1 /*4*/], "pb_prostitute", 16);
			iLocal_77[2] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[2 /*4*/], "pb_prostitute", 16);
			iLocal_77[3] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[3 /*4*/], "pb_prostitute", 16);
			iLocal_82[0] = 1;
			iLocal_82[1] = 1;
			iLocal_82[2] = 1;
			iLocal_82[3] = 1;
		...
		default:
			uLocal_108[0 /*3*/] = { 0f, 0f, 0f };
			uLocal_108[1 /*3*/] = { 0f, 0f, 0f };
			uLocal_108[2 /*3*/] = { 0f, 0f, 0f };
			uLocal_108[3 /*3*/] = { 0f, 0f, 0f };
			uLocal_121[0] = 0f;
			uLocal_121[1] = 0f;
			uLocal_121[2] = 0f;
			uLocal_121[3] = 0f;
