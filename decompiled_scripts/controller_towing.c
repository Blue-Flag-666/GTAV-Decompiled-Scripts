#region Local Var
	...
	BOOL bLocal_270 = 0;
	int iLocal_271 = 0;
	eCharacter echLocal_272 = CHAR_MICHAEL;
	var uLocal_273 = 0;
	int iLocal_274 = 0;
	int iLocal_275 = 0;
	var uLocal_276 = 0;
...
void main() // Position - 0x0
{
	...
	while (true)
	{
		if (func_155())
		{
			...
			{
				iLocal_279 = 0;
				func_2(&iLocal_278, unk2, &unk, &iLocal_279, flag);
			}
...
void func_2(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x19A
{
	...
	*uParam3 = 500;
	...
	if (!unk_0x055111B11E6624FD(uParam1, 0))
	{
		...
		func_152(Global_113648.f_19975.f_3, &unk4, &unk8, &unk, &unk7);
	
		if (Global_113648.f_19975.f_3 >= 5 || bLocal_263)
		{
			func_151(uParam1, unk4, unk8, uParam0);
		...
		switch (*uParam0)
		{
			...
			case 14:
				if (func_153(uParam0, false, true))
				{
					if (func_146(uParam1))
					{
						iLocal_74 = 1;
				...
				if (func_153(uParam0, false, true))
				{
					...
					*uParam3 = 0;
					...
					if (unk_0x87644B1F984197FE(0, 86) || unk_0x992AACDC3C066F55(0, 86))
					{
						func_120();
						func_118();
						iLocal_53 = iLocal_274;
						iLocal_53.f_1 = iLocal_275;
						*uParam0 = 16;
					}
				}
				break;
						...
						if (Global_113648.f_19975.f_3 >= 5)
						{
							if (unk_0x0CBB7C273DED26E7(iLocal_271))
							{
								...
								if (!unk_0x7DE17ACDD8BA2642(iLocal_275))
								{
									...
									{
										iLocal_271 == joaat("towtruck2");
									}
								
									iLocal_275 = unk_0xABEEDBEF2BBDF5B3(iLocal_271, 408.8376f, -1638.9524f, 28.2928f, 230.2387f, 1, 1, 0);
								...
								if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0) && !unk_0x055111B11E6624FD(iLocal_275, 0))
								{
									...
									unk_0x303E64EEE09DFD71(unk_0xC1A5EC5C986B98AD(), 408.8376f, -1638.9524f, 28.2928f);
...
{
	if (func_22(iLocal_251, 1))
	{
		func_147(&iLocal_251, 1);
		func_21(&iLocal_250);
	}
...
void func_25(char* sParam0, int iParam1, int iParam2) // Position - 0x1056
{
	if (Global_100681 != 10 && Global_100681 != 9)
	{
		...
		func_27(&Global_104212, sParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_94859 = 0;
	}
		...
		if (unk_0x7DE17ACDD8BA2642(Global_98012[i]))
			if (Global_98012[i] == uParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98022[i])
					if (iParam2 == 0 || unk_0x504B9BB48D41C264(uParam0) == func_36(echParam1, iParam2))
						return 1;
	}
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3B6B
{
	var unk;
	int num;
...
int func_51(int iParam0) // Position - 0x3BA8
{
	int num;
	int num2;
...
int func_52() // Position - 0x3BDC
{
	return Global_1574918;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3BE8
{
	var unk;
	BOOL num;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3C14
{
	eCharacter character;
...
void func_55(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x415F
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x43A0
{
	func_57();
...
void func_57() // Position - 0x43B9
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_38(character) && !func_58(14) || Global_112599)
			{
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x44C4
{
	eCharacter character;
	var unk;
	int i;
...
void func_60(var uParam0, var uParam1) // Position - 0x45B7
{
	int i;
	int j;
	int k;
...
BOOL func_61(int iParam0) // Position - 0x483F
{
	switch (iParam0)
	{
...
BOOL func_62(int iParam0) // Position - 0x48E0
{
...
void func_66(var uParam0) // Position - 0x59CA
{
	eCharacter character;
...
BOOL func_68(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F55
{
	var unk;
	var unk2;
...
BOOL func_70(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6718
{
	if (bParam6)
...
BOOL func_71(var uParam0) // Position - 0x675F
{
...
BOOL func_73(int iParam0, int iParam1, BOOL bParam2) // Position - 0x67CA
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_74(int iParam0) // Position - 0x682B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_76(int iParam0) // Position - 0x6BCF
{
	return func_73(iParam0, 5, true);
}

int func_77(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BDF
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x76DB
{
...
BOOL func_82(Player plParam0) // Position - 0x7705
{
...
BOOL func_84(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7807
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_85(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x789C
{
	float num;
	float num2;
	float num3;
...
BOOL func_89(int iParam0, var uParam1) // Position - 0x853E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_90(Player plParam0) // Position - 0x85C0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8618
{
	return -1;
}
...
BOOL func_95(int iParam0) // Position - 0x88C5
{
...
int func_103(int iParam0) // Position - 0x8E01
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_104(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E23
{
	if (bParam0)
		return uParam1;
...
int func_105(int iParam0) // Position - 0x8E3A
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EF8
{
	func_57();
	return Global_113648.f_2365.f_539.f_4321;
}
...
int func_110() // Position - 0x8F11
{
	...
	{
		num = func_113(&iLocal_45, 6, 4, false, 0);
		...
		if (num == 1)
		{
			...
			iLocal_53.f_2 = 1;
			iLocal_249 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &iLocal_53, 9, 54000);
			unk_0x037A80676B8FF0F5("Towing");
...
void func_111(int iParam0, int iParam1) // Position - 0x8FAE
{
	func_112(iParam0, iParam1);
	return;
}

void func_112(int iParam0, int iParam1) // Position - 0x8FBE
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

int func_113(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x8FCF
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x9155
{
	return func_116(iParam0, Global_43257);
}

BOOL func_116(int iParam0, int iParam1) // Position - 0x9166
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_117(int iParam0) // Position - 0x9347
{
	if (Global_43257 == 15)
		return false;
...
void func_119(var uParam0) // Position - 0x9388
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_121() // Position - 0x93AC
{
	switch (iLocal_74)
	{
		...
		case 0:
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_84, 4, 0, "TOWDISPATCH", 0, 1);
			
				if (_CONVERSATION_ADD_LINE(&uLocal_84, "TOWAUD", "TOW_DISP_GEN", 9, 0, 0, 0))
					iLocal_74 = 2;
			}
			break;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x94FB
{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x9512
{
...
BOOL func_124(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x9560
{
	Global_21726 = 0;
...
BOOL func_128(int iParam0, int iParam1) // Position - 0x98D8
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x9A76
{
	if (func_58(14))
	{
...
void func_137(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x9BFE
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9C54
{
...
float func_139(var uParam0) // Position - 0x9CEF
{
	if (func_144(uParam0))
		if (func_141(uParam0))
			return uParam0->f_2;
...
BOOL func_141(var uParam0) // Position - 0x9D83
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_142(var uParam0) // Position - 0x9D90
{
	func_143(uParam0, 0f);
	return;
}

void func_143(var uParam0, float fParam1) // Position - 0x9D9F
{
...
BOOL func_144(var uParam0) // Position - 0x9DCA
{
	return IS_BIT_SET(*uParam0, 1);
}

BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x9DD7
{
...
BOOL func_146(var uParam0) // Position - 0x9DF9
{
	var unk;
	int num;
...
void func_147(int iParam0, int iParam1) // Position - 0x9E79
{
	func_148(iParam0, iParam1);
	return;
}

void func_148(var uParam0, int iParam1) // Position - 0x9E89
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_149(var uParam0, var uParam1) // Position - 0x9E9E
{
	if (!func_153(uParam0, false, true))
	{
		if (func_146(uParam1))
		{
			if (unk_0x87644B1F984197FE(0, 86) || unk_0x992AACDC3C066F55(0, 86))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xF0E4B64AC0B5660E() && !func_117(0) && !func_58(6) && !func_58(7) && !unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 && _GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_FRANKLIN)
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_84, 1, unk_0xC1A5EC5C986B98AD(), "FRANKLIN", 0, 1);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_84, 4, 0, "TOWDISPATCH", 0, 1);
				
					if (_CONVERSATION_ADD_LINE(&uLocal_84, "TOWAUD", "TOW_JOBS_AVL", 4, 0, 0, 0))
					{
	...
	if (bLocal_270)
		if (func_144(&uLocal_71))
			if (func_139(&uLocal_71) > 4f)
				if (_CONVERSATION_ADD_LINE(&uLocal_84, "TOWAUD", "TOW_NO_JOBS", 4, 0, 0, 0))
					bLocal_270 = false;

	return;
}

void func_150(var uParam0) // Position - 0x9FA4
{
	if (!func_144(uParam0))
		func_142(uParam0);
...
void func_151(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x9FBC
{
	float num;
	var unk;
	int num2;

	num = SYSTEM::VDIST2(vParam1, unk_0x30BE8A934C020461(uParam0, 1));
	...
	switch (iLocal_75)
	{
		case 0:
			...
			if (num < 25f && !func_22(Global_113648.f_19975.f_1, 1073741824))
				return;
			...
			if (unk_0x3C3D6D026CF7F51B(uParam0, 0))
			{
				...
				if (!unk_0x055111B11E6624FD(unk, 0))
				{
					...
					if (num2 == joaat("towtruck") || num2 == joaat("towtruck2") && unk_0x2935B4D6CE81318D(unk) > 400)
						return;
				}
			}
		
			if (!func_153(uParam5, false, true))
				return;
		...
		case 2:
			...
			{
				if (!unk_0x67670574D396B9A8(uLocal_258, fLocal_261) || func_22(Global_113648.f_19975.f_1, 1073741824))
				{
					if (!unk_0x7DE17ACDD8BA2642(iLocal_275))
					{
						iLocal_275 = unk_0xABEEDBEF2BBDF5B3(joaat("towtruck"), vParam1, uParam4, 1, 1, 0);
						unk_0xE0A291F406691F03(joaat("towtruck"));
						iLocal_75 = 3;
					}
				}
		...
		case 3:
			if (unk_0x3C3D6D026CF7F51B(uParam0, 0))
				if (unk_0x95DC39736F6748E3(uParam0, 0) == iLocal_275)
					iLocal_75 = 0;
...
BOOL func_153(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA222
{
	if (!bParam1)
	{
		if (func_117(9))
		{
			uLocal_252 = unk_0xA5E11AF0A2B928C1();
			iLocal_253 = 10000;
			return false;
		}
	...
	if (bParam2)
	{
		echLocal_272 = _GET_CURRENT_PLAYER_CHARACTER_0();
	
		if (echLocal_272 != CHAR_FRANKLIN)
			return false;
	}

	if (unk_0xA5E11AF0A2B928C1() - uLocal_252 < iLocal_253)
		return false;

	return true;
}

BOOL func_154(int iParam0) // Position - 0xA2C1
{
	int i;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0xA380
{
	BOOL flag;
