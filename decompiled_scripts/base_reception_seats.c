...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(var message) // Position - 0x137
{
...
void func_11(var uParam0) // Position - 0x219
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 1:
			if (func_51(uParam0))
			{
				uParam0->f_85.f_6 = unk_0xA5E11AF0A2B928C1();
				func_52(uParam0, 2);
			}
			break;
	
		case 2:
			if (func_50(unk_0xC1A5EC5C986B98AD(), &uParam0->[uParam0->f_85.f_2 /*14*/]))
			{
				...
				{
					if (unk_0xA5E11AF0A2B928C1() - uParam0->f_85.f_6 > 150)
		...
		case 4:
			...
			if (num != 3)
			{
				unk34 = { unk_0xFC2542C169B039F2(&unk, &unk17, func_39(uParam0), func_38(uParam0), 0, 2) };
				unk37 = { unk_0xEF996771DB3B2061(&unk, &unk17, func_39(uParam0), func_38(uParam0), 0, 2) };
				unk40 = unk37.f_2;
		...
		case 5:
			...
			if (num2 != 1 && num2 != 0)
			{
				uParam0->f_85.f_1 = unk_0x62E15BEBEB67DC6D(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
				unk_0xA499ADFC7EB2E4DB(unk_0xC1A5EC5C986B98AD(), uParam0->f_85.f_1, &unk, &unk17, 2f, -1000f, 13, 16, 1.5f, 0);
				unk_0x16410571CFB5ED71(uParam0->f_85.f_1);
				uParam0->f_85.f_8.f_4 = unk_0xA5E11AF0A2B928C1();
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			unk41 = unk_0x7E80728A2E77D8E8(uParam0->f_85.f_1);
			...
			if (unk_0x411B750250543BD0(unk41))
			{
				if (unk_0xABF98B1999FE64CA(unk41) >= 1f)
				{
					...
					func_40(uParam0, &unk17);
					uParam0->f_85.f_1 = unk_0x62E15BEBEB67DC6D(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					unk_0xA499ADFC7EB2E4DB(unk_0xC1A5EC5C986B98AD(), uParam0->f_85.f_1, &unk, &unk17, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0x16410571CFB5ED71(uParam0->f_85.f_1);
					func_25(&(uParam0->f_85), 8);
		...
		case 7:
			unk_0x5A691093FF311F77(uParam0->f_85.f_1);
			func_52(uParam0, 8);
			break;
	
		case 8:
			unk42 = unk_0x7E80728A2E77D8E8(uParam0->f_85.f_1);
...
void func_12(var uParam0, BOOL bParam1) // Position - 0x62F
{
	...
	else
	{
		...
		if (unk_0xA5E11AF0A2B928C1() - uParam0->f_85.f_8.f_4 >= 90000)
		{
			num2 = func_13(uParam0);
...
var func_15(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7D1
{
	if (bParam0)
		return uParam1;
...
{
	return func_17(unk_0x93E99A2DBCBA9CFA());
}

BOOL func_17(var uParam0) // Position - 0x7F8
{
...
void func_18(var uParam0) // Position - 0x817
{
	...
	if (uParam0->f_85.f_4 == 6)
	{
		...
		if (uParam0->f_85.f_4 == 6 && !unk_0x18D781E5FEB0E5E3(unk_0xC1A5EC5C986B98AD(), joaat("block_interrupt")) && !func_8(&(uParam0->f_85), 12))
			if (num >= 0.35f)
				func_23(uParam0);
		...
		else
		{
			...
			if (!unk_0xFEE065E56A9BEF3F() && !func_8(&(uParam0->f_85), 0) && !func_8(&(uParam0->f_85), 4) && !func_21() && !func_19(true) && uParam0->f_85.f_8.f_2 != 3)
			{
...
BOOL func_19(BOOL bParam0) // Position - 0x98B
{
	if (unk_0x8FF4A425D460D6C6())
		if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			if (func_20(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_20(var uParam0) // Position - 0xA76
{
	int num;
...
void func_24(var uParam0) // Position - 0xBC0
{
	...
	uParam0->f_85.f_1 = unk_0x62E15BEBEB67DC6D(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
	func_41(uParam0, &unk);
	unk_0xA499ADFC7EB2E4DB(unk_0xC1A5EC5C986B98AD(), uParam0->f_85.f_1, &unk, "exit", 4f, -4f, 13, 16, 1000f, 0);
	unk_0x16410571CFB5ED71(uParam0->f_85.f_1);
	_CONTEXT_REMOVE_HELP_TEXT(&(uParam0->f_85.f_5));
	func_52(uParam0, 8);
	return;
...
void func_25(var uParam0, int iParam1) // Position - 0xC32
{
...
int func_43(var uParam0) // Position - 0x11B6
{
	...
	switch (uParam0->f_85.f_8)
	{
		...
		default:
			num = unk_0x15A88CFAAFFC6C4B(0, func_14(uParam0->f_85.f_8));
	}
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x1242
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x139C
{
	...
	for (i = 0; i < unk_0x1C57E792CD67EF97(); i = i + 1)
	{
		if (unk_0x9A45DBB669E889B7(unk_0x74A08123C183740A(i)))
		{
			...
			if (unk != unk_0x93E99A2DBCBA9CFA() && _NETWORK_IS_PLAYER_VALID(unk, true, true) && func_50(unk_0xF2CFBB1105511E1A(unk), &uParam0->[uParam0->f_85.f_2 /*14*/]))
				return 1;
		}
	}
...
BOOL _NETWORK_IS_PLAYER_VALID(int player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1407
{
	int num;
...
BOOL func_50(var uParam0, var uParam1) // Position - 0x1478
{
...
void func_53(var uParam0, int iParam1) // Position - 0x14F4
{
...
void func_54(var uParam0) // Position - 0x1504
{
	...
	else if (uParam0->f_85.f_4 > 4)
	{
		...
		unk_0x188EE482FAFEF565(unk_0xC1A5EC5C986B98AD(), func_55(uParam0));
		uParam0->f_85.f_7 = unk_0xE16824A2A0B2A6D8();
	}
	...
	else if (unk_0xE16824A2A0B2A6D8() - uParam0->f_85.f_7 < 5)
	{
		unk_0x188EE482FAFEF565(unk_0xC1A5EC5C986B98AD(), func_55(uParam0));
	}
...
void func_56(var uParam0) // Position - 0x15DA
{
	...
	func_57(&(uParam0->f_85), 1, unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0));
	func_57(&(uParam0->f_85), 3, unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 1));
	func_57(&(uParam0->f_85), 0, func_36(0));
	func_57(&(uParam0->f_85), 2, unk_0x5C50456CDB486BD0(unk_0xC1A5EC5C986B98AD()));
	return;
}

void func_57(var uParam0, int iParam1, BOOL bParam2) // Position - 0x1632
{
	int num;
...
{
	if (!func_69(unk_0xC1A5EC5C986B98AD()))
		return true;
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1722
{
	switch (func_64())
	{
		case 0:
...
BOOL func_69(var uParam0) // Position - 0x17C5
{
	return unk_0x9DC9E896F189AAA5(uParam0, 416.24573f, 4826.312f, -59.999702f, 376.93875f, 4827.6587f, -56.954235f, 15f, 0, 1, 0);
}
...
BOOL func_70() // Position - 0x17F9
{
	if (Global_1853753 != _INVALID_PLAYER_INDEX())
	{
		if (unk_0x269C91515A1405D5("base_reception_seats", Global_1853753, 1, 0))
			return false;
...
void func_71() // Position - 0x1845
{
	...
	unk[0] = 0;
	unk[1] = 1;
	func_74(2, &uLocal_95, &unk);
	unk[0] = 2;
	unk[1] = 3;
	func_74(3, &uLocal_95, &unk);
	unk[0] = 4;
	unk[1] = 5;
	func_74(4, &uLocal_95, &unk);
...
{
	if (iParam1 == 0 || iParam1 == 1 && unk_0xACC2F57D4FC0353D("FACILITY_MAIN_3") || unk_0xACC2F57D4FC0353D("FACILITY_MAIN_2"))
		return 0;

	return 1;
}

void func_74(int iParam0, var uParam1, var uParam2) // Position - 0x18ED
{
	var unk;
	float num;
	int i;
...
Vector3 func_77(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x1A38
{
	float num;
	float num2;
	float num3;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x1C95
{
	int i;
