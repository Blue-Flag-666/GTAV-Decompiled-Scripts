...
void main() // Position - 0x0
{
	...
	if (Global_2883694)
	{
		if (unk_0x24B651D85CCE5EB4(-43879923) == 0)
		{
			unk_0xD9C38C2E8E7C8C13(-43879923);
		
			while (!unk_0xAF83A305E6D700D3(-43879923))
			{
				SYSTEM::WAIT(0);
			}
	...
	{
		if (unk_0x24B651D85CCE5EB4(1179280373) == 0)
		{
			unk_0xD9C38C2E8E7C8C13(1179280373);
		
			while (!unk_0xAF83A305E6D700D3(1179280373))
			{
				SYSTEM::WAIT(0);
			}
	...
	switch (iScriptParam_0)
	{
		case 1:
			switch (iScriptParam_0.f_1)
			{
				...
				case 76:
					func_32(iScriptParam_0.f_3, 0);
					break;
			
				case 52:
					if (iScriptParam_0.f_2 == 52)
						unk_0x0C9DCB19E2D3BB18(iScriptParam_0.f_3);
					break;
			...
			switch (iScriptParam_0.f_1)
			{
				...
				case 76:
					if (Global_78825 != -1)
					{
						...
						unk_0xD35F67FEB222A982();
					
						if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
							if (unk_0xFBD273FDBCF0C5BD(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 0))
								Global_78810 = { unk_0x7A2C98D06C9C1956(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0)) };
...
void func_1(int iParam0, int iParam1) // Position - 0x320
{
	...
	unk_0xECDAB41968FF21A8(&Global_78807, 0);
	return;
}
...
void func_3(int iParam0) // Position - 0x395
{
	func_28(1, iParam0);
	func_28(2, iParam0);
	return;
...
{
	unk_0xA3C681843B51A4CC("MISHSTA", 8);
...
BOOL func_5(int iParam0) // Position - 0x3D0
{
	switch (iParam0)
	{
		case 1:
...
int func_8() // Position - 0x476
{
	...
	if (unk_0xB53553DC4AAC7D8A() || func_9())
		return 2;
...
BOOL func_12(int iParam0, int iParam1, BOOL bParam2) // Position - 0x633
{
	if (iParam0 == -1)
		return false;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x694
{
	var unk;
	int num;
...
int func_14(int iParam0) // Position - 0x6D1
{
	int num;
	int num2;
...
int func_15() // Position - 0x705
{
	return Global_1574918;
}

eMPStat func_16(int iParam0) // Position - 0x711
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_23(int iParam0, int iParam1) // Position - 0xC6A
{
	return iParam0 && iParam1 != false;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC79
{
...
void func_28(int iParam0, int iParam1) // Position - 0xCD2
{
	if (iParam1 == 1)
		func_29(0, 1);

	unk_0x67E249DE642CF95F("SHOW_COLUMN");
...
void func_29(int iParam0, int iParam1) // Position - 0xD01
{
	char* str;
	char* str2;
	int num;
	...
	unk_0x67E249DE642CF95F("SHOW_WARNING_MESSAGE");
...
void func_35() // Position - 0xF63
{
	...
	{
		case 1:
			Global_78809 = func_36(&uLocal_30, 1, 0, 1);
			break;
	
		case 7:
			Global_78809 = func_36(&uLocal_30, 0, 1, 1);
			break;
...
int func_36(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFA3
{
	...
	if (iParam1 == 1)
	{
		if (iParam2 == 1)
		{
			func_37(uParam0, &num, 1, iParam3, 0);
			func_37(uParam0, &num, 7, iParam3, 0);
		}
		else
		{
			func_37(uParam0, &num, 1, iParam3, 1);
		}
	}
	else if (iParam2 == 1)
	{
		func_37(uParam0, &num, 7, iParam3, 1);
	}

	return num;
}

void func_37(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0xFFB
{
	int num;
	int i;
	int num2;
	...
	if (iParam4 == 0)
	{
		for (i = 0; i < num; i = i + 1)
		{
			if (func_42(i, iParam2))
			{
				num2 = func_41(i, iParam2);
				...
				{
					if (iParam3 == 0 || func_39(i, iParam2) == true)
					{
						uParam0->[num2 /*2*/] = i;
						uParam0->[num2 /*2*/].f_1 = iParam2;
					}
				
					if (func_39(i, iParam2) == true)
						*uParam1 = *uParam1 + 1;
				}
			}
		}
	...
	else
	{
		...
		{
			num4 = func_38(num3, iParam3, iParam2);
		
			if (num4 != -1)
			{
				num3 = func_41(num4, iParam2) + 1;
				uParam0->[j /*2*/] = num4;
				uParam0->[j /*2*/].f_1 = iParam2;
			
				if (func_39(num4, iParam2))
					*uParam1 = *uParam1 + 1;
			}
			else
			{
...
int func_38(int iParam0, int iParam1, int iParam2) // Position - 0x10E9
{
	...
	num = -1;
	num2 = -1;
	num4 = func_45(iParam2);

	for (i = 0; i < num4; i = i + 1)
	{
		if (func_42(i, iParam2) == true)
		{
			if (iParam1 == 0 || func_39(i, iParam2) == true)
			{
				num3 = func_41(i, iParam2);
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x1165
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_40(int iParam0) // Position - 0x11A3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_42(int iParam0, int iParam1) // Position - 0x1531
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_44(int iParam0) // Position - 0x15EC
{
	int num;
...
void func_46(int iParam0) // Position - 0x1655
{
	...
	for (i = 0; i < func_75(iParam0, Global_78808); i = i + 1)
	{
		num5 = func_73(iParam0, Global_78808, i);
		flag = true;
		...
		if (!Global_63587[num5 /*13*/].f_7 && flag)
		{
	...
	func_52(iParam0, &num2);
	func_48(num4, num3, false, num, num2);
	func_47(2);
	return;
}
...
float func_48(int iParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x17B6
{
	...
	num = func_51(iParam0, iParam1, false);
	num2 = func_50(num);
	...
	else
	{
		unk_0x67E249DE642CF95F("SET_DESCRIPTION");
		unk_0xC6A3EF6C4A3412C1(2);
		unk_0xC6A3EF6C4A3412C1(func_49(num2));
		unk_0xC49D258FBF3BF214(num);
...
void func_52(int iParam0, var uParam1) // Position - 0x1958
{
	int num;
	...
	if (Global_78808 == 7)
	{
		...
		{
			case 52:
				*uParam1 = Global_113648.f_2354[0 /*2*/];
			...
			case 53:
				*uParam1 = Global_113648.f_2354[1 /*2*/];
			...
			case 54:
				*uParam1 = Global_113648.f_2354[2 /*2*/];
			...
			case 55:
				*uParam1 = Global_113648.f_2354[3 /*2*/];
			...
			case 56:
				*uParam1 = Global_113648.f_2354[4 /*2*/];
...
BOOL func_53(int iParam0, int iParam1, int iParam2) // Position - 0x1A18
{
	...
	if (iParam2 != 0)
		if (!unk_0x5FAF55B1F052A2E6(iParam2))
			return false;

	if (Global_63587[iParam0 /*13*/].f_7)
		return true;

	num = { Global_63587[iParam0 /*13*/] };
...
void func_54(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1C7E
{
	if (iParam5 != 0)
	{
		unk_0x9FD96C5DE6EDFC15(iParam5, "SET_DATA_SLOT");
	}
	else
	{
	...
	if (iParam5 == 0)
	{
		unk_0x2AF11E92DE43CDE3("PM_RP_STATD" /*~a~~n~~a~*/);
		unk_0x48849374B34BB7B9(sParam3);
		unk_0x48849374B34BB7B9(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam4));
		unk_0xF8FCA9E7130CE1C8();
	}
	else
	{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x1CEE
{
	switch (iParam0)
	{
		case 0:
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x2F39
{
	...
	if (iParam6 != 0)
	{
		unk_0x9FD96C5DE6EDFC15(iParam6, "SET_DATA_SLOT");
	}
	else
	{
		unk_0x67E249DE642CF95F("SET_DATA_SLOT");
	...
	if (iParam6 == 0)
	{
		...
		unk_0x48849374B34BB7B9(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam5));
		unk_0xF8FCA9E7130CE1C8();
	}
	else
	{
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x2FBE
{
	...
	unk_0xC6A3EF6C4A3412C1(SYSTEM::CEIL(value));
...
void func_59(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x3047
{
	if (iParam4 != 0)
	{
		unk_0x9FD96C5DE6EDFC15(iParam4, "SET_DATA_SLOT");
	}
	else
	{
		unk_0x67E249DE642CF95F("SET_DATA_SLOT");
	...
	if (iParam4 == 0)
	{
		...
		unk_0x48849374B34BB7B9(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam3));
		unk_0xF8FCA9E7130CE1C8();
	}
	else
	{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x31BB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x4391
{
	if (iParam1 < 0)
		return false;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x445B
{
	func_66();
...
void func_66() // Position - 0x4474
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_67(character) && !func_25(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != character && func_67(Global_113648.f_2365.f_539.f_4321))
...
BOOL func_67(eCharacter echParam0) // Position - 0x4571
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x457D
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x45BA
{
	if (func_67(character))
...
int func_70(eCharacter echParam0) // Position - 0x45DF
{
...
int func_72(int iParam0) // Position - 0x4617
{
	...
	num = func_71(Global_63587[iParam0 /*13*/].f_4);
...
void func_83() // Position - 0x555F
{
	...
	for (i = 0; i < Global_78809; i = i + 1)
	{
		...
		func_52(num, &num7);
		num5 = func_51(num3, num2, false);
		num6 = func_50(num5);
	
		if (num7 > -1)
			num6 = num7;
	
		func_84(1, i, 1076, num, true, &uLocal_28, func_49(num6));
	}
