		...
		else
		{
			...
			switch (iLocal_150)
			{
				...
				case 1:
					...
					if (iLocal_151 == 0 && !IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 30))
					{
					...
					{
						if (IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 29))
							if (func_2())
								func_1();
...
void func_3() // Position - 0x348
{
	...
	if (Global_1853988[player /*867*/].f_136.f_1 != 0)
	{
		Global_1853988[player /*867*/].f_136.f_1 = 0;
		Global_1853988[player /*867*/].f_136 = 0;
	}
...
{
	if (IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 30))
		return false;

	if (IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 29))
		return true;

	if (func_30() == 0 && !func_29() && !func_2() && !func_28() && !func_27() && !func_26() && !func_25() && !func_24() && !func_23() && func_20() && func_12() && Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_95 != 8 && Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_95 != 9 && !func_10(PLAYER::PLAYER_ID()) && !func_9() && !func_7(PLAYER::PLAYER_ID(), true, false))
		return true;
...
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_16(iParam1));
}
				...
				switch (iParam5)
				{
					case 0:
						switch (iParam4)
						{
							...
							case 3:
							case 4:
								func_281(&Global_948106, false, true, 0);
							...
							case 0:
								switch (iParam2)
								{
									...
									case 1:
										if (bParam10)
											func_280(&Global_986059, true, false, true, 0, true);
										else
											func_280(&Global_980531, true, false, true, 0, false);
										break;
								
									case 7:
										func_279(&Global_997115, false, true, 0);
										break;
								
									case 8:
										if (bParam10)
											func_280(&Global_991587, true, false, true, 0, true);
										else
											func_280(&Global_980531, false, false, true, 0, false);
										break;
						...
						switch (iParam5)
						{
							case 0:
								switch (iParam4)
								{
									...
									case 3:
									case 4:
										func_220(&Global_948106, uParam0, false, iParam4, 0);
										break;
								
									case 5:
									case 6:
										func_220(&Global_948106, uParam0, false, iParam4, Global_948106.f_32423);
										break;
							...
							case 1:
								...
								{
									case 8:
										func_64(uParam0, &Global_1052643, true, 0);
										break;
									...
									default:
										switch (iParam4)
										{
											...
											case 5:
											case 6:
												func_63(uParam0, &Global_1054521, true, iParam4);
												break;
										
											default:
												func_64(uParam0, &Global_1051704, true, iParam4);
												break;
										}
										break;
								}
	...
	if (bParam0)
	{
		for (i = 0; i < num2; i = i + 1)
		{
			...
			if (IS_BIT_SET(Global_1835450[num], offset))
			{
				...
				{
					Global_991587.f_4[j /*88*/] = { Global_991587.f_4[j + 1 /*88*/] };
				}
	...
	else
	{
		for (i = 0; i < num2; i = i + 1)
		{
			...
			if (IS_BIT_SET(Global_1835450[num], offset))
			{
				for (j = i; j <= num2 - 2; j = j + 1)
				{
					Global_980531.f_4[j /*88*/] = { Global_980531.f_4[j + 1 /*88*/] };
				}
	...
	switch (iParam0)
	{
		case 0:
			switch (iParam2)
			{
				...
				case 5:
				case 6:
					func_281(&Global_948106, true, false, iParam3);
					break;
				...
				case 0:
					switch (iParam1)
					{
						...
						case 1:
							if (bParam4)
								func_280(&Global_986059, true, true, false, iParam3, bParam4);
							else
								func_280(&Global_980531, true, true, false, iParam3, false);
							break;
					
						case 8:
							if (bParam4)
							{
								func_280(&Global_991587, true, true, false, iParam3, bParam4);
							...
							{
								func_280(&Global_980531, false, true, false, iParam3 + 31, false);
							}
							break;
					
						case 7:
						case 2:
							func_279(&Global_997115, true, false, iParam3);
							break;
					}
					break;
			}
...
void func_55(var uParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x17A6
{
	...
	TEXT_LABEL_ASSIGN_STRING(&Global_1053582.f_354[uParam0->f_8 /*16*/], DATAFILE::DATADICT_GET_STRING(dict, "crewnm"), 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_1053582[uParam0->f_8 /*16*/], NETWORK::UGC_GET_CONTENT_NAME(uParam0->f_6), 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_1053582.f_257[uParam0->f_8 /*6*/], NETWORK::UGC_GET_CONTENT_ID(uParam0->f_6), 24);
	Global_1053582.f_884[uParam0->f_8] = DATAFILE::DATADICT_GET_INT(dict, "cash");
	Global_1053582.f_901[uParam0->f_8] = DATAFILE::DATADICT_GET_INT(dict2, "scr");
	Global_1053582.f_918[uParam0->f_8] = DATAFILE::DATADICT_GET_INT(dict2, "time");
...
BOOL IS_XBOX_PLATFORM() // Position - 0x1AF3
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_61(int iParam0) // Position - 0x1B09
{
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x1B4E
{
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x1E18
{
	...
	unk.f_66 = -1;
	unk.f_67 = 2;
	Global_997115.f_33[num /*88*/] = { unk };
	Global_997115.f_33[num /*88*/].f_65 = int;
	Global_997115.f_33[num /*88*/].f_56 = { func_108(dict2) };

	if (DATAFILE::DATADICT_GET_TYPE(dict2, "cam") == 5)
	{
		Global_997115.f_33[num /*88*/].f_59 = { func_107(dict2, "cam") };
	}
	else if (DATAFILE::DATADICT_GET_TYPE(dict2, "cam") == 6)
	{
		...
		if (DATAFILE::DATADICT_GET_TYPE(dict3, "x") == 2)
			Global_997115.f_33[num /*88*/].f_59 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict3, "x"));
		else
			Global_997115.f_33[num /*88*/].f_59 = DATAFILE::DATADICT_GET_FLOAT(dict3, "x");
	
		if (DATAFILE::DATADICT_GET_TYPE(dict3, "y") == 2)
			Global_997115.f_33[num /*88*/].f_59.f_1 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict3, "y"));
		else
			Global_997115.f_33[num /*88*/].f_59.f_1 = DATAFILE::DATADICT_GET_FLOAT(dict3, "y");
	
		if (DATAFILE::DATADICT_GET_TYPE(dict3, "z") == 2)
			Global_997115.f_33[num /*88*/].f_59.f_2 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict3, "z"));
		else
			Global_997115.f_33[num /*88*/].f_59.f_2 = DATAFILE::DATADICT_GET_FLOAT(dict3, "z");
	}

	Global_997115.f_33[num /*88*/].f_62 = { func_106(dict2) };
	Global_997115.f_33[num /*88*/].f_69 = DATAFILE::DATADICT_GET_INT(dict2, "min");
	Global_997115.f_33[num /*88*/].f_71 = DATAFILE::DATADICT_GET_INT(dict2, "num");

	if (Global_997115.f_33[num /*88*/].f_71 == -1)
		Global_997115.f_33[num /*88*/].f_71 = func_105();

	TEXT_LABEL_ASSIGN_STRING(&(Global_997115.f_33[num /*88*/].f_22), NETWORK::UGC_GET_CONTENT_NAME(uParam0->f_6), 64);
	Global_997115.f_33[num /*88*/].f_81 = NETWORK::UGC_GET_CONTENT_CATEGORY(uParam0->f_6);
	Global_997115.f_33[num /*88*/].f_68 = DATAFILE::DATADICT_GET_INT(dict2, "subtype");
	Global_997115.f_33[num /*88*/].f_80 = DATAFILE::DATADICT_GET_INT(dict2, "adverm");
	Global_997115.f_33[num /*88*/].f_70 = DATAFILE::DATADICT_GET_INT(dict2, "rank");
	Global_997115.f_33[num /*88*/].f_73 = func_104(NETWORK::UGC_GET_CONTENT_RATING(uParam0->f_6, 0), NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam0->f_6, 0));
	TEXT_LABEL_ASSIGN_STRING(&Global_997115.f_33[num /*88*/], NETWORK::UGC_GET_CONTENT_ID(uParam0->f_6), 24);
	Global_997115.f_33[num /*88*/].f_55 = NETWORK::UGC_GET_CONTENT_IS_USING_SC_NICKNAME(uParam0->f_6);

	if (func_103() != 2)
	{
		if (Global_997115.f_33[uParam0->f_8 /*88*/].f_71 > Global_262145.f_4606)
			Global_997115.f_33[uParam0->f_8 /*88*/].f_71 = Global_262145.f_4606;
	
		if (Global_997115.f_33[uParam0->f_8 /*88*/].f_69 > Global_262145.f_4606)
			Global_997115.f_33[uParam0->f_8 /*88*/].f_69 = Global_262145.f_4606;
	}

	TEXT_LABEL_ASSIGN_STRING(&(Global_997115.f_33[num /*88*/].f_6), NETWORK::UGC_GET_CONTENT_USER_NAME(uParam0->f_6), 64);
	NETWORK::UGC_GET_CONTENT_UPDATED_DATE(uParam0->f_6, &(Global_997115.f_33[num /*88*/].f_82));
	Global_997115.f_2762[num] = false;

	if (!func_315())
	{
		if (NETWORK::UGC_IS_LANGUAGE_SUPPORTED(NETWORK::UGC_GET_CONTENT_LANGUAGE(uParam0->f_6)))
			Global_997115.f_33[num /*88*/].f_54 = NETWORK::UGC_GET_CONTENT_DESCRIPTION_HASH(uParam0->f_6);
		else
			Global_997115.f_33[num /*88*/].f_54 = -1;
	
		Global_997115.f_33[num /*88*/].f_67 = func_102(uParam0->f_6);
		Global_997115.f_33[num /*88*/].f_66 = NETWORK::UGC_GET_CONTENT_FILE_VERSION(uParam0->f_6, Global_997115.f_33[num /*88*/].f_67);
	
		if (NETWORK::UGC_GET_CONTENT_HAS_PLAYER_RECORD(uParam0->f_6))
			Global_997115.f_2762[num] = NETWORK::UGC_GET_CONTENT_HAS_PLAYER_BOOKMARKED(uParam0->f_6);
	}

	Global_997115.f_33[num /*88*/].f_75 = DATAFILE::DATADICT_GET_INT(dict2, "charcon");
	Global_997115.f_33[num /*88*/].f_72 = DATAFILE::DATADICT_GET_INT(dict2, "tnum");
	Global_997115.f_1[num] = hashKey;
	func_101(Global_997115.f_33[num /*88*/].f_65, &(Global_997115.f_33[num /*88*/].f_71), &(Global_997115.f_33[num /*88*/].f_69));
	Global_997115.f_33[num /*88*/].f_76 = DATAFILE::DATADICT_GET_INT(dict2, "optbs");

	if (IS_BIT_SET(Global_997115.f_33[num /*88*/].f_76, 27))
		flag = true;

	Global_997115.f_33[num /*88*/].f_76 = 0;
	MISC::SET_BIT(&(Global_997115.f_33[num /*88*/].f_76), 13);

	if (flag)
		MISC::SET_BIT(&(Global_997115.f_33[num /*88*/].f_76), 27);

	MISC::CLEAR_BIT(&(Global_997115.f_33[num /*88*/].f_76), 15);
	MISC::CLEAR_BIT(&(Global_997115.f_33[num /*88*/].f_76), 18);
	MISC::CLEAR_BIT(&(Global_997115.f_33[num /*88*/].f_76), 19);
	MISC::CLEAR_BIT(&(Global_997115.f_33[num /*88*/].f_76), 29);
	MISC::CLEAR_BIT(&(Global_997115.f_33[num /*88*/].f_76), 28);
	func_67(MISC::GET_HASH_KEY(NETWORK::UGC_GET_ROOT_CONTENT_ID(uParam0->f_6)), &(Global_997115.f_33[num /*88*/].f_76), &(Global_997115.f_33[num /*88*/].f_77), Global_997115.f_33[num /*88*/].f_80);
	MISC::SET_BIT(&(Global_997115.f_33[num /*88*/].f_76), 13);

	if (MISC::IS_STRING_NULL_OR_EMPTY(&Global_997115.f_33[num /*88*/]))
		MISC::CLEAR_BIT(&(Global_997115.f_33[num /*88*/].f_76), 13);

	if (_IS_NULL_VECTOR(Global_997115.f_33[num /*88*/].f_56))
		MISC::CLEAR_BIT(&(Global_997115.f_33[num /*88*/].f_76), 13);

	Global_997115 = Global_997115 + 1;
	uParam0->f_8 = uParam0->f_8 + 1;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2600
{
...
void func_67(Hash hParam0, int iParam1, int* piParam2, Hash hParam3) // Position - 0x262A
{
	if (func_100(hParam0))
...
BOOL func_68(Hash hParam0) // Position - 0x28D0
{
	return hParam0 == 17;
}

BOOL func_69(Hash hParam0) // Position - 0x28DD
{
	return hParam0 == 16;
}

BOOL func_70(Hash hParam0) // Position - 0x28EA
{
	return hParam0 == 15;
}

BOOL func_71(Hash hParam0) // Position - 0x28F7
{
	return hParam0 == 14;
}

BOOL func_72(Hash hParam0) // Position - 0x2904
{
	return hParam0 == 13;
}

BOOL func_73(Hash hParam0) // Position - 0x2911
{
	return hParam0 == 12;
}

BOOL func_74(Hash hParam0) // Position - 0x291E
{
	return hParam0 == 11;
}

BOOL func_75(Hash hParam0) // Position - 0x292B
{
	return hParam0 == 9;
}

BOOL func_76(Hash hParam0) // Position - 0x2938
{
	return hParam0 == 1 || hParam0 == 67;
}

BOOL func_77(Hash hParam0) // Position - 0x294F
{
	return hParam0 == 6;
}

BOOL func_78(Hash hParam0) // Position - 0x295B
{
	return hParam0 == 4;
}

BOOL func_79(Hash hParam0) // Position - 0x2967
{
	return hParam0 == 2;
}

BOOL func_80(Hash hParam0) // Position - 0x2973
{
	return hParam0 == 8;
}

BOOL func_81(Hash hParam0) // Position - 0x2980
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9893[i])
			return true;
	}
...
BOOL func_82(Hash hParam0) // Position - 0x29CD
{
	return hParam0 == 3;
}

BOOL func_83(Hash hParam0) // Position - 0x29D9
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9882[i])
			return true;
	}
...
BOOL func_84(Hash hParam0) // Position - 0x2A26
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9871[i])
			return true;
	}
...
BOOL func_85(Hash hParam0) // Position - 0x2A73
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9860[i])
			return true;
	}
...
BOOL func_86(Hash hParam0) // Position - 0x2AC0
{
	int i;
	...
	for (i = 0; i <= 11; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9847[i])
			return true;
	}
...
BOOL func_87(Hash hParam0) // Position - 0x2B0D
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9836[i])
			return true;
	}
...
BOOL func_88(Hash hParam0) // Position - 0x2B5A
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9825[i])
			return true;
	}
...
BOOL func_89(Hash hParam0) // Position - 0x2BA7
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9814[i])
			return true;
	}
...
BOOL func_90(Hash hParam0) // Position - 0x2BF4
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9717[i])
			return true;
	}
...
BOOL func_91(Hash hParam0) // Position - 0x2C41
{
	int i;
...
BOOL func_92(Hash hParam0) // Position - 0x2C8E
{
	int i;
...
BOOL func_93(Hash hParam0) // Position - 0x2CDB
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9706[i])
			return true;
	}
...
BOOL func_94(Hash hParam0) // Position - 0x2D28
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9695[i])
			return true;
	}
...
BOOL func_95(Hash hParam0) // Position - 0x2D75
{
	int i;
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9684[i])
			return true;
	}
...
BOOL func_96(Hash hParam0, BOOL bParam1) // Position - 0x2DC2
{
	int i;
	...
	for (i = 0; i <= 6; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9658[i])
			return true;
	}
...
BOOL func_97(Hash hParam0) // Position - 0x2E13
{
	int i;
	...
	for (i = 0; i <= 6; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9650[i])
			return true;
	}
...
BOOL func_98(Hash hParam0) // Position - 0x2E5F
{
	if (*Global_4718592.f_171044 == 18)
		return true;

	if (hParam0 == Global_262145.f_9645 || hParam0 == Global_262145.f_9646 || hParam0 == Global_262145.f_9647 || hParam0 == Global_262145.f_9648 || hParam0 == Global_262145.f_9649)
		return true;

	return false;
}

BOOL func_99(Hash hParam0) // Position - 0x2ECC
{
	if (*Global_4718592.f_171044 == 20)
		return true;

	if (hParam0 == Global_262145.f_9640 || hParam0 == Global_262145.f_9641 || hParam0 == Global_262145.f_9642 || hParam0 == Global_262145.f_9643 || hParam0 == Global_262145.f_9644)
		return true;

	return false;
}

BOOL func_100(Hash hParam0) // Position - 0x2F39
{
	if (*Global_4718592.f_171044 == 19)
		return true;

	if (hParam0 == Global_262145.f_9633 || hParam0 == Global_262145.f_9634 || hParam0 == Global_262145.f_9635 || hParam0 == Global_262145.f_9636 || hParam0 == Global_262145.f_9637 || hParam0 == Global_262145.f_9638 || hParam0 == Global_262145.f_9639)
		return true;

	return false;
}

void func_101(int iParam0, int iParam1, int iParam2) // Position - 0x2FC6
{
	if (iParam0 == 1)
		if (*iParam2 < 2)
			*iParam2 = 2;
...
BOOL func_109(Hash hParam0) // Position - 0x325F
{
	int i;
	int j;
	...
	if (hParam0 != 0)
	{
		for (j = 0; j < 20; j = j + 1)
		{
			if (Global_262145.f_6971[j] == 2)
			{
				...
				{
					if (hParam0 == Global_262145.f_5067[j /*51*/][i])
						return 1;
				}
			}
		}
...
BOOL func_110(Hash hParam0) // Position - 0x32C4
{
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9666[i] || hParam0 == Global_262145.f_9675[i])
			return true;
	}
...
BOOL func_111(Hash hParam0) // Position - 0x3313
{
	int i;

	for (i = 0; i < 11; i = i + 1)
	{
		if (Global_262145.f_30140[i] == hParam0)
			return true;
	}
...
BOOL func_112(Player plParam0) // Position - 0x3343
{
	return Global_2657704[plParam0 /*463*/].f_272;
}

BOOL func_113(Hash hParam0) // Position - 0x3357
{
	int i;
...
Hash func_114(int iParam0) // Position - 0x3381
{
	return Global_262145.f_29471[iParam0];
}

BOOL func_115(Hash hParam0) // Position - 0x3394
{
	int i;
	...
	if (hParam0 != 0)
	{
		...
		{
			if (hParam0 == Global_262145.f_5067[19 /*51*/][i])
				return true;
		}
	}
...
BOOL func_116(Hash hParam0) // Position - 0x33D7
{
...
Hash func_117(int iParam0) // Position - 0x342A
{
	if (iParam0 != -1)
...
BOOL func_118(Hash hParam0) // Position - 0x3449
{
...
BOOL func_119(Hash hParam0) // Position - 0x34A7
{
	int i;

	for (i = 0; i < 6; i = i + 1)
	{
		if (Global_262145.f_31922[i] == hParam0)
			return true;
	}
...
BOOL func_120(Hash hParam0) // Position - 0x34D6
{
	if (Global_262145.f_6139[0] == hParam0 || Global_262145.f_6139[6] == hParam0 || Global_262145.f_6139[13] == hParam0)
		return true;

	return false;
}

BOOL func_121(Hash hParam0) // Position - 0x351A
{
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_262145.f_31258[i] == hParam0)
			return true;
	}
...
BOOL func_122(Hash hParam0) // Position - 0x3554
{
	int i;
...
int func_123(Hash hParam0) // Position - 0x358E
{
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_262145.f_5034[i] == hParam0)
			return 1;
	}
...
int func_124(Hash hParam0) // Position - 0x35C8
{
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_262145.f_5025[i] == hParam0)
			return 1;
	}
...
void func_125(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x3602
{
	...
	if (iParam1 != 0 && iParam1 != 1)
	{
		...
		if (!func_59(uParam0->f_23, uParam0->f_24, NETWORK::UGC_GET_CONTENT_USER_ID(uParam0->f_6), NETWORK::UGC_GET_CONTENT_CATEGORY(uParam0->f_6)))
		{
			if (bParam5 && IS_XBOX_PLATFORM())
			{
				...
				if (bParam4)
					Global_991587.f_5461[value] = NETWORK::NETWORK_START_USER_CONTENT_PERMISSIONS_CHECK(&netHandle);
				else
					Global_980531.f_5461[value] = NETWORK::NETWORK_START_USER_CONTENT_PERMISSIONS_CHECK(&netHandle);
			}
			else
			{
				func_284();
	...
	if (bParam4)
	{
		if (bParam5)
		{
			if (func_216(uParam0, &Global_991587.f_4[value /*88*/], iParam1, true, iParam2, bParam5))
			{
				Global_991587 = Global_991587 + 1;
				uParam0->f_8 = uParam0->f_8 + 1;
			}
		}
		else if (func_216(uParam0, &Global_986059.f_4[value /*88*/], iParam1, true, iParam2, false))
		{
			Global_986059 = Global_986059 + 1;
			func_131(uParam0, iParam1);
			func_126(uParam0, iParam1, value);
			MISC::SET_BIT(&(Global_986059.f_4[value /*88*/].f_76), 16);
			uParam0->f_8 = uParam0->f_8 + 1;
		}
	}
	else if (bParam3)
	{
		if (iParam1 == 1)
		{
			if (Global_980531 < 62)
			{
				func_216(uParam0, &Global_980531.f_4[Global_980531 /*88*/], iParam1, false, iParam2, false);
				Global_980531 = Global_980531 + 1;
			}
		}
		else if (Global_997115 < 31)
		{
			if (func_216(uParam0, &Global_997115.f_33[Global_997115 /*88*/], iParam1, false, iParam2, false))
				Global_997115 = Global_997115 + 1;
		}
	
		uParam0->f_8 = uParam0->f_8 + 1;
	}
	else if (func_216(uParam0, &Global_980531.f_4[value /*88*/], iParam1, true, iParam2, false))
	{
		func_131(uParam0, iParam1);
		...
		{
			Global_980531.f_3 = Global_980531.f_3 + 1;
			MISC::SET_BIT(&(Global_980531.f_4[value /*88*/].f_76), 16);
		}
...
void func_127(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x38DF
{
	int num;

	num = func_128(4);
	Global_2645174[num /*83*/] = 4;
	Global_2645174[num /*83*/].f_1 = { uParam0 };
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[0 /*16*/], "-FromLiveArea", 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[1 /*16*/], "-LiveAreaContentType=UGC_TYPE_GTA5_MISSION", 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[2 /*16*/], "-LiveAreaLoadContent=", 64);
	TEXT_LABEL_COPY(&Global_2645174[num /*83*/].f_18[3 /*16*/], { Global_4718592.f_117878 }, 16);
	return;
}
...
void func_129(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x39A8
{
	int num;

	num = func_128(3);
	Global_2645174[num /*83*/] = 3;
	Global_2645174[num /*83*/].f_1 = { uParam0 };
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[0 /*16*/], "-FromLiveArea", 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[1 /*16*/], "-LiveAreaContentType=UGC_TYPE_GTA5_MISSION", 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[2 /*16*/], "-LiveAreaLoadContent=", 64);
...
void func_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x3A24
{
	int num;

	num = func_128(2);
	Global_2645174[num /*83*/] = 2;
	Global_2645174[num /*83*/].f_1 = { uParam0 };
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[0 /*16*/], "-FromLiveArea", 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[1 /*16*/], "-LiveAreaContentType=UGC_TYPE_GTA5_MISSION", 64);
	TEXT_LABEL_ASSIGN_STRING(&Global_2645174[num /*83*/].f_18[2 /*16*/], "-LiveAreaLoadContent=", 64);
...
int func_133(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3C65
{
	...
	{
		if (func_137(iParam1, Global_78472[1 /*14*/].f_2, &num))
		{
			address = func_136(num, Global_78469);
			...
			func_134(num, address, Global_78469, true);
			return 1;
		}
	}
...
Hash func_135(int iParam0, int iParam1) // Position - 0x3D0E
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_16(iParam1));
}
...
struct<14> func_138(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x4157
{
	func_181();
...
void func_139(int iParam0, int iParam1, Hash hParam2) // Position - 0x4198
{
	switch (iParam0)
	{
		case 2:
...
void func_140(int iParam0) // Position - 0x42A4
{
	...
	func_141(&Global_78472[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_141(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x445F
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_136(func_143(iParam1, iParam0->f_2), Global_78469);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_136(func_142(iParam1, iParam0->f_2), Global_78469);
			...
			{
				num = func_136(num2, Global_78469);
...
BOOL func_144(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4FF6
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_145(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5E99
{
	int num;
	int num2;
	int num3;
...
BOOL func_146(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5ED7
{
...
void func_149(int iParam0, Hash hParam1) // Position - 0x89B8
{
	int num;
...
void func_150(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x89D8
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_141(&Global_78472[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_141(&Global_78472[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_141(&Global_78472[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78670)
		{
			...
			func_141(&Global_78472[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_152(int iParam0, Hash hParam1) // Position - 0x8D0E
{
	BOOL flag;
	int num;
	var unk;
...
void func_153(int iParam0, Hash hParam1) // Position - 0x8E10
{
	BOOL flag;
	int num;
	var unk;
...
void func_154(int iParam0, Hash hParam1) // Position - 0x90EF
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		func_141(&Global_78472[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_155(int iParam0, Hash hParam1) // Position - 0xBEC4
{
	BOOL flag;
	int num;
	var unk;
...
void func_156(int iParam0, Hash hParam1) // Position - 0xBFC9
{
	BOOL flag;
	int value;
	var unk;
...
void func_157(int iParam0, Hash hParam1) // Position - 0xC7BF
{
	BOOL flag;
	int value;
	var unk;
...
void func_158(int iParam0, Hash hParam1) // Position - 0xCAA4
{
	BOOL flag;
	int value;
	var unk;
...
void func_159(int iParam0, Hash hParam1) // Position - 0xE0CB
{
	BOOL flag;
	int value;
	var unk;
...
void func_160(int iParam0, Hash hParam1) // Position - 0xF72A
{
	BOOL flag;
	int num;
	var unk;
...
void func_161(int iParam0, Hash hParam1) // Position - 0xF885
{
	BOOL flag;
	int num;
	var unk;
...
void func_162(int iParam0, Hash hParam1) // Position - 0xFB05
{
	BOOL flag;
	int value;
	var unk;
...
void func_163(int iParam0, Hash hParam1) // Position - 0x10EA8
{
	BOOL flag;
	int value;
	var unk;
...
void func_164(int iParam0, Hash hParam1) // Position - 0x1260D
{
	BOOL flag;
	int value;
	var unk;
...
void func_165(int iParam0, int iParam1, Hash hParam2) // Position - 0x134DE
{
	switch (iParam0)
	{
		case 2:
...
void func_167(int iParam0, Hash hParam1) // Position - 0x137B4
{
	int num;
...
void func_168(int iParam0, Hash hParam1) // Position - 0x137D4
{
	BOOL flag;
	int num;
	var unk;
...
void func_169(int iParam0, Hash hParam1) // Position - 0x138D7
{
	BOOL flag;
	int num;
	var unk;
...
void func_170(int iParam0, Hash hParam1) // Position - 0x13B88
{
	BOOL flag;
	int value;
	var unk;
...
void func_171(int iParam0, Hash hParam1) // Position - 0x16949
{
	BOOL flag;
	int num;
	var unk;
...
void func_172(int iParam0, Hash hParam1) // Position - 0x16A6A
{
	BOOL flag;
	int value;
	var unk;
...
void func_173(int iParam0, Hash hParam1) // Position - 0x17362
{
	BOOL flag;
	int value;
	var unk;
...
void func_174(int iParam0, Hash hParam1) // Position - 0x17619
{
	BOOL flag;
	int value;
	var unk;
...
void func_175(int iParam0, Hash hParam1) // Position - 0x18C58
{
	BOOL flag;
	int value;
	var unk;
...
void func_176(int iParam0, Hash hParam1) // Position - 0x1A28B
{
	BOOL flag;
	int num;
	var unk;
...
void func_177(int iParam0, Hash hParam1) // Position - 0x1A3E2
{
	BOOL flag;
	int num;
	var unk;
...
void func_178(int iParam0, Hash hParam1) // Position - 0x1A6FE
{
	BOOL flag;
	int value;
	var unk;
...
void func_179(int iParam0, Hash hParam1) // Position - 0x1CBF1
{
	BOOL flag;
	int value;
	var unk;
...
void func_180(int iParam0, Hash hParam1) // Position - 0x1E17C
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_183(Player plParam0) // Position - 0x1F0BE
{
...
void func_184(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1F0DD
{
	if (bParam4 || bParam1)
...
int func_192(int iParam0, int iParam1) // Position - 0x1F686
{
	...
	num2 = func_136(num, iParam1);
	return num2;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0x1F6CC
{
	int num;
	int num2;
...
void func_194(int iParam0, int iParam1, int iParam2) // Position - 0x1F70B
{
	...
	num = func_136(iParam0, func_16(iParam2));
	num = num + iParam1;
	func_134(iParam0, num, iParam2, true);
	return;
}
...
void func_196(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1F768
{
	int address;
	int num;
...
int func_197(int iParam0) // Position - 0x1F7B4
{
	int num;
	int num2;
...
int func_198(int iParam0) // Position - 0x1FB11
{
	int num;

	num = func_136(func_197(iParam0), -1);
	return num;
}

BOOL func_199(int iParam0) // Position - 0x1FB28
{
	int num;
	int num2;
	...
	num2 = iParam0;
	return IS_BIT_SET(num, func_191(num2));
}
...
void func_200(int iParam0, BOOL bParam1) // Position - 0x1FB45
{
	...
	if (num > -1)
		if (bParam1)
			MISC::SET_BIT(&Global_2804776.f_1032[func_189(num)], func_191(num));
		else
			MISC::CLEAR_BIT(&Global_2804776.f_1032[func_189(num)], func_191(num));

	return;
}

void func_201(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, const char* sParam8, int iParam9, int iParam10) // Position - 0x1FB94
{
	int num;

	num = func_202(&Global_1662687);
...
BOOL func_207(int iParam0) // Position - 0x20C52
{
	int num;
	int num2;
...
int func_208(int iParam0) // Position - 0x20C6F
{
	var unk;

	unk = Global_2804776.f_1032[func_189(iParam0)];
	return unk;
}
...
int func_210(int iParam0, int iParam1) // Position - 0x20CE6
{
	int num;

	num = func_136(func_211(iParam0), iParam1);
	return num;
}

int func_211(int iParam0) // Position - 0x20CFE
{
	int num;
	int num2;
...
void func_212(int iParam0, int iParam1) // Position - 0x2105B
{
	int num;

	num = func_136(iParam0, func_16(iParam1));
	num = num + 1;
	func_134(iParam0, num, iParam1, true);
	return;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x21082
{
	if (iParam2 == -1)
		iParam2 = func_17();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x210A0
{
	if (iParam1 == -1)
		iParam1 = func_17();
...
BOOL func_215(int iParam0, int iParam1) // Position - 0x210BC
{
	int num;
	int num2;
...
BOOL func_216(var uParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x210EB
{
	var unk;
	Any* fileDict;
	Any* dict;
	...
	*sParam1 = { unk };
	...
	if (iParam2 == 0 && !bParam5)
	{
		...
		Global_980531.f_5524 = Global_980531.f_5524 + contentRatingPositiveCount;
	
		if (Global_980531.f_5525 < contentRatingPositiveCount)
			Global_980531.f_5525 = contentRatingPositiveCount;
	}
...
BOOL func_217(var uParam0, var uParam1, var uParam2) // Position - 0x215CD
{
	if (uParam0.f_2 < 0f || func_219(uParam0, 999, 2f) || func_218(uParam0) || Global_4718592.f_102106[0 /*60*/].f_2 < -2f && !IS_BIT_SET(Global_4718592.f_102106[0 /*60*/].f_31, 5))
		return true;

	return false;
}

BOOL func_218(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x21633
{
	int i;
	...
	if (Global_2766128)
	{
		for (i = 0; i < 10; i = i + 1)
		{
			if (OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, Global_2766128.f_1[i /*3*/], Global_2766128.f_32[i /*3*/], Global_2766128.f_63[i], false, true))
				return true;
		}
	}
...
BOOL func_219(Vector3 vParam0, var uParam1, var uParam2, int iParam3, float fParam4) // Position - 0x217C1
{
	int i;
	var unk;
	var unk11;
...
void func_220(var uParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x21B15
{
	...
	unk.f_66 = -1;
	unk.f_67 = 2;
	uParam0->f_1804[num /*88*/] = { unk };

	if (!func_315())
	{
		uParam0->f_1804[num /*88*/].f_67 = func_102(uParam1->f_6);
		uParam0->f_1804[num /*88*/].f_66 = NETWORK::UGC_GET_CONTENT_FILE_VERSION(uParam1->f_6, uParam0->f_1804[num /*88*/].f_67);
		uParam0->f_28205[num /*13*/].f_6 = NETWORK::UGC_GET_CONTENT_LANGUAGE(uParam1->f_6);
	}

	uParam0->f_1804[num /*88*/].f_56 = { func_108(dict2) };
	uParam0->f_1804[num /*88*/].f_59 = { func_107(dict2, "cam") };
	uParam0->f_1804[num /*88*/].f_62 = { func_106(dict2) };

	if (DATAFILE::DATADICT_GET_TYPE(dict2, "optbs") == 2)
		uParam0->f_1804[num /*88*/].f_76 = DATAFILE::DATADICT_GET_INT(dict2, "optbs");

	if (!func_315())
		if (NETWORK::UGC_IS_LANGUAGE_SUPPORTED(NETWORK::UGC_GET_CONTENT_LANGUAGE(uParam1->f_6)))
			uParam0->f_1804[num /*88*/].f_54 = NETWORK::UGC_GET_CONTENT_DESCRIPTION_HASH(uParam1->f_6);
		else
			uParam0->f_1804[num /*88*/].f_54 = -1;
	...
	if (uParam0->f_1804[num /*88*/].f_71 == -1)
		uParam0->f_1804[num /*88*/].f_71 = func_105();

	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_1804[num /*88*/].f_22), NETWORK::UGC_GET_CONTENT_NAME(uParam1->f_6), 64);
	...
	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_1804[num /*88*/].f_6), NETWORK::UGC_GET_CONTENT_USER_ID(uParam1->f_6), 64);
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(&uParam0->f_3[num /*6*/]))
		if (uParam0->f_1804[num /*88*/].f_81 == 3 || uParam0->f_1804[num /*88*/].f_81 == 4)
	...
	if (!func_315())
	{
		uParam0->f_1804[num /*88*/].f_73 = func_104(NETWORK::UGC_GET_CONTENT_RATING(uParam1->f_6, 0), NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam1->f_6, 0));
		uParam0->f_28205[num /*13*/].f_4 = NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam1->f_6, 0);
	}

	TEXT_LABEL_ASSIGN_STRING(&uParam0->f_1804[num /*88*/], NETWORK::UGC_GET_CONTENT_ID(uParam1->f_6), 24);
	...
	func_101(uParam0->f_1804[num /*88*/].f_65, &(uParam0->f_1804[num /*88*/].f_71), &(uParam0->f_1804[num /*88*/].f_69));
	...
	if (!func_315())
	{
		if (NETWORK::UGC_GET_CONTENT_HAS_PLAYER_RECORD(uParam1->f_6))
		{
			...
			uParam0->f_28205[num /*13*/].f_7 = NETWORK::UGC_GET_CONTENT_HAS_PLAYER_BOOKMARKED(uParam1->f_6);
		}
	
		uParam0->f_32107[num] = NETWORK::UGC_GET_CONTENT_IS_USING_SC_NICKNAME(uParam1->f_6);
		uParam0->f_28205[num /*13*/].f_1 = MISC::GET_HASH_KEY(NETWORK::UGC_GET_ROOT_CONTENT_ID(uParam1->f_6));
		MISC::SET_CONTENT_ID_INDEX(uParam0->f_28205[num /*13*/].f_1, num + 1518);
	}

	if (func_103() != 2)
	{
		if (uParam0->f_1804[num /*88*/].f_71 > Global_262145.f_4606)
			uParam0->f_1804[num /*88*/].f_71 = Global_262145.f_4606;
	
		if (uParam0->f_1804[num /*88*/].f_69 > Global_262145.f_4606)
			uParam0->f_1804[num /*88*/].f_69 = Global_262145.f_4606;
	}

	if (!bParam2)
	{
		func_232(uParam0->f_1804[num /*88*/].f_65, uParam0->f_1804[num /*88*/].f_68, IS_BIT_SET(uParam0->f_1804[num /*88*/].f_76, 14), uParam0->f_1804[num /*88*/].f_70, true);
		func_221(uParam0->f_1804[num /*88*/].f_65, uParam0->f_1804[num /*88*/].f_68, uParam0->f_1804[num /*88*/].f_70, true);
	}
...
void func_221(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x21FC4
{
	...
	if (func_20())
	{
		...
		hash = func_225(iParam0, iParam1, bParam3);
...
void func_222(Hash hParam0, int iParam1) // Position - 0x22028
{
	int num;
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x22047
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x22063
{
	Hash statHash;
	int outValue;
...
Hash func_225(int iParam0, int iParam1, BOOL bParam2) // Position - 0x22081
{
	switch (iParam0)
	{
		case 2:
...
int func_226(Player plParam0) // Position - 0x221E2
{
	int num;
...
int func_227(int iParam0, int iParam1) // Position - 0x22203
{
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_228(num) == iParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_228(num) < iParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
int func_229(Player plParam0) // Position - 0x227F9
{
...
BOOL func_230(Player plParam0) // Position - 0x22850
{
...
BOOL func_231(Player plParam0) // Position - 0x2286F
{
	Player player;
...
void func_232(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x22891
{
	...
	hash = func_233(iParam0, iParam1, bParam4);
...
Hash func_233(int iParam0, int iParam1, BOOL bParam2) // Position - 0x22916
{
	switch (iParam0)
	{
		case 2:
...
const char* func_234() // Position - 0x22A77
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("CREATOR_RSC" /*Rockstar*/);
}

const char* func_235() // Position - 0x22A87
{
...
void func_236(var uParam0, BOOL bParam1) // Position - 0x22A97
{
	...
	if (uParam0->f_8 == 0 && bParam1 == false)
	{
		...
		for (i = 0; i < 13; i = i + 1)
		{
			Global_794709.f_153383[i] = 0;
			Global_794709.f_153369[i] = 0;
		}
	...
	unk.f_66 = -1;
	unk.f_67 = 2;
	Global_794709.f_4[uParam0->f_8 /*88*/] = { unk };
	...
	Global_794709.f_4[uParam0->f_8 /*88*/].f_56 = { func_108(dict2) };

	if (DATAFILE::DATADICT_GET_TYPE(dict2, "optbs") == 2)
		Global_794709.f_4[uParam0->f_8 /*88*/].f_76 = DATAFILE::DATADICT_GET_INT(dict2, "optbs");
	...
	Global_794709.f_4[uParam0->f_8 /*88*/].f_59 = { func_107(dict2, "cam") };
	Global_794709.f_4[uParam0->f_8 /*88*/].f_62 = { func_106(dict2) };
	...
	if (DATAFILE::DATADICT_GET_TYPE(dict2, "mgrk") == 2)
		Global_794709.f_133589[uParam0->f_8 /*13*/].f_8 = DATAFILE::DATADICT_GET_INT(dict2, "mgrk");

	if (DATAFILE::DATADICT_GET_TYPE(dict2, "mght") == 2)
		Global_794709.f_133589[uParam0->f_8 /*13*/].f_9 = DATAFILE::DATADICT_GET_INT(dict2, "mght");

	Global_794709.f_133589[uParam0->f_8 /*13*/].f_11 = DATAFILE::DATADICT_GET_INT(dict2, "cncmbs");
	Global_794709.f_4[uParam0->f_8 /*88*/].f_69 = DATAFILE::DATADICT_GET_INT(dict2, "min");
	Global_794709.f_4[uParam0->f_8 /*88*/].f_71 = DATAFILE::DATADICT_GET_INT(dict2, "num");

	if (Global_794709.f_4[uParam0->f_8 /*88*/].f_71 == -1)
		Global_794709.f_4[uParam0->f_8 /*88*/].f_71 = func_105();

	TEXT_LABEL_ASSIGN_STRING(&(Global_794709.f_4[uParam0->f_8 /*88*/].f_22), NETWORK::UGC_GET_CONTENT_NAME(uParam0->f_6), 64);
	Global_794709.f_4[uParam0->f_8 /*88*/].f_65 = DATAFILE::DATADICT_GET_INT(dict2, "type");

	if (func_315())
		TEXT_LABEL_ASSIGN_STRING(&(Global_794709.f_4[uParam0->f_8 /*88*/].f_6), func_266(), 64);
	else
		TEXT_LABEL_ASSIGN_STRING(&(Global_794709.f_4[uParam0->f_8 /*88*/].f_6), NETWORK::UGC_GET_CONTENT_USER_ID(uParam0->f_6), 64);

	Global_794709.f_4[uParam0->f_8 /*88*/].f_70 = DATAFILE::DATADICT_GET_INT(dict2, "rank");
	Global_794709.f_133589[uParam0->f_8 /*13*/] = DATAFILE::DATADICT_GET_INT(dict2, "tnum");
	...
	Global_794709.f_4[uParam0->f_8 /*88*/].f_75 = DATAFILE::DATADICT_GET_INT(dict2, "charcon");
	Global_794709.f_4[uParam0->f_8 /*88*/].f_78 = DATAFILE::DATADICT_GET_INT(dict2, "ltm");
	TEXT_LABEL_ASSIGN_STRING(&Global_794709.f_4[uParam0->f_8 /*88*/], NETWORK::UGC_GET_CONTENT_ID(uParam0->f_6), 24);
	hashKey = MISC::GET_HASH_KEY(&Global_794709.f_4[uParam0->f_8 /*88*/]);
	Global_794709.f_133589[uParam0->f_8 /*13*/].f_3 = hashKey;
	...
	if (Global_794709.f_4[uParam0->f_8 /*88*/].f_65 == 6 && !bParam1)
	{
		if (Global_999913.f_684 < 85)
		{
			...
			Global_999913[Global_999913.f_684 /*3*/] = { func_107(dict2, "area") };
		
			if (DATAFILE::DATADICT_GET_TYPE(dict2, "rad") == 2)
				Global_999913.f_512[Global_999913.f_684] = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict2, "rad"));
			else
				Global_999913.f_512[Global_999913.f_684] = DATAFILE::DATADICT_GET_FLOAT(dict2, "rad");
		
			Global_999913.f_256[Global_999913.f_684 /*3*/] = { Global_794709.f_4[uParam0->f_8 /*88*/].f_56 };
			Global_999913.f_598[Global_999913.f_684] = hashKey;
			Global_794709.f_4[uParam0->f_8 /*88*/].f_56 = { Global_794709.f_4[uParam0->f_8 /*88*/].f_59 };
			Global_999913.f_684 = Global_999913.f_684 + 1;
		}
	}
	else
	{
		Global_794709.f_4[uParam0->f_8 /*88*/].f_68 = DATAFILE::DATADICT_GET_INT(dict2, "subtype");
		Global_794709.f_4[uParam0->f_8 /*88*/].f_80 = DATAFILE::DATADICT_GET_INT(dict2, "adverm");
	}
	...
	Global_794709.f_133589[uParam0->f_8 /*13*/].f_2 = func_261(Global_794709.f_133589[uParam0->f_8 /*13*/].f_1, true);
	...
	flag = func_109(Global_794709.f_133589[uParam0->f_8 /*13*/].f_1);
	num = func_258(Global_794709.f_133589[uParam0->f_8 /*13*/].f_1);

	if (num != -1)
		Global_1969079[num] = uParam0->f_8;

	if (Global_794709.f_4[uParam0->f_8 /*88*/].f_65 < 13 && !bParam1 && !flag)
	{
		if (Global_794709.f_4[uParam0->f_8 /*88*/].f_70 <= 1000)
		{
			Global_794709.f_153369[Global_794709.f_4[uParam0->f_8 /*88*/].f_65] = Global_794709.f_153369[Global_794709.f_4[uParam0->f_8 /*88*/].f_65] + 1;
		
			if (func_257(uParam0->f_8))
				Global_794709.f_153369[7] = Global_794709.f_153369[7] + 1;
			else if (func_256(uParam0->f_8))
				Global_794709.f_153369[4] = Global_794709.f_153369[4] + 1;
			else if (func_255(uParam0->f_8))
				Global_794709.f_153369[10] = Global_794709.f_153369[10] + 1;
			else if (func_254(uParam0->f_8))
				Global_794709.f_153369[12] = Global_794709.f_153369[12] + 1;
		}
	}
	...
	if (!func_315())
	{
		...
		if (*Global_794709.f_153368 < 5 && Global_794709.f_4[uParam0->f_8 /*88*/].f_65 == 0 && Global_794709.f_4[uParam0->f_8 /*88*/].f_68 == 1)
		{
			...
			TEXT_LABEL_ASSIGN_STRING(&Global_794709.f_153337[*Global_794709.f_153368 /*6*/], NETWORK::UGC_GET_ROOT_CONTENT_ID(uParam0->f_6), 24);
			Global_794709.f_153368 = *Global_794709.f_153368 + 1;
		}
		...
		else if (!flag)
		{
			if (func_247(Global_794709.f_133589[uParam0->f_8 /*13*/].f_1, Global_794709.f_4[uParam0->f_8 /*88*/].f_80))
				Global_794709.f_153369[11] = Global_794709.f_153369[11] + 1;
		
			if (NETWORK::UGC_GET_CONTENT_HAS_PLAYER_RECORD(uParam0->f_6))
			{
				MISC::SET_BIT(&(Global_794709.f_4[uParam0->f_8 /*88*/].f_76), 14);
			
				if (IS_BIT_SET(Global_794709.f_4[uParam0->f_8 /*88*/].f_76, 1) || Global_794709.f_4[uParam0->f_8 /*88*/].f_68 == 2)
					Global_794709.f_153369[9] = Global_794709.f_153369[9] + 1;
			
				if (Global_794709.f_4[uParam0->f_8 /*88*/].f_70 <= 1000)
					if (Global_794709.f_4[uParam0->f_8 /*88*/].f_65 < 13)
						Global_794709.f_153383[Global_794709.f_4[uParam0->f_8 /*88*/].f_65] = Global_794709.f_153383[Global_794709.f_4[uParam0->f_8 /*88*/].f_65] + 1;
	...
	if (!bParam1 && !flag)
	{
		if (func_20())
		{
			func_232(Global_794709.f_4[uParam0->f_8 /*88*/].f_65, Global_794709.f_4[uParam0->f_8 /*88*/].f_68, IS_BIT_SET(Global_794709.f_4[uParam0->f_8 /*88*/].f_76, 14), Global_794709.f_4[uParam0->f_8 /*88*/].f_70, false);
			func_221(Global_794709.f_4[uParam0->f_8 /*88*/].f_65, Global_794709.f_4[uParam0->f_8 /*88*/].f_68, Global_794709.f_4[uParam0->f_8 /*88*/].f_70, false);
			func_245(Global_794709.f_4[uParam0->f_8 /*88*/].f_65, Global_794709.f_4[uParam0->f_8 /*88*/].f_68, Global_794709.f_4[uParam0->f_8 /*88*/].f_75, Global_794709.f_4[uParam0->f_8 /*88*/].f_70, IS_BIT_SET(Global_794709.f_4[uParam0->f_8 /*88*/].f_76, 14));
	...
	if (Global_794709.f_4[uParam0->f_8 /*88*/].f_65 == 6)
		Global_1000598[0 /*50*/] = Global_1000598[0 /*50*/] + 1;
...
void func_237(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x23748
{
	...
	if (!func_239(iParam0, iParam1, iParam2, &unk, iParam3))
		return;
...
Hash func_238(int iParam0) // Position - 0x2377D
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_239(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4) // Position - 0x237EF
{
	int num;
...
Hash func_246(int iParam0) // Position - 0x23DBD
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_247(Hash hParam0, Hash hParam1) // Position - 0x23E2F
{
	if (hParam1 > 0)
		return true;
...
BOOL func_248(Hash hParam0) // Position - 0x23F40
{
	return hParam0 == 65;
}

BOOL func_249(Hash hParam0) // Position - 0x23F4D
{
	return hParam0 == 57;
}

void func_250(Hash hParam0, int iParam1) // Position - 0x23F5A
{
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (hParam0 == Global_262145.f_9666[i])
		{
			Global_794709.f_153324[0 /*11*/][i] = iParam1;
			Global_794709.f_4[iParam1 /*88*/].f_56 = { func_253(0, i) };
			Global_794709.f_4[iParam1 /*88*/].f_59 = { func_252(0, i) };
			Global_794709.f_4[iParam1 /*88*/].f_62 = { func_251(0, i) };
			...
			if (Global_794709.f_153324[0 /*11*/].f_9 <= i)
				Global_794709.f_153324[0 /*11*/].f_9 = i + 1;
		}
		else if (hParam0 == Global_262145.f_9675[i])
		{
			Global_794709.f_133589[iParam1 /*13*/].f_12 = 0;
			Global_794709.f_4[iParam1 /*88*/].f_68 = 8;
			Global_794709.f_4[iParam1 /*88*/].f_75 = 0;
...
int func_258(Hash hParam0) // Position - 0x243CC
{
	int i;
...
int func_259(Hash hParam0) // Position - 0x24407
{
	int i;
	...
	if (hParam0 != 0)
	{
		...
		{
			if (hParam0 == Global_262145.f_5067[18 /*51*/][i])
				return 1;
		}
	}
...
int func_260(Hash hParam0) // Position - 0x2444A
{
	int i;
	int j;
...
int func_261(Hash hParam0, BOOL bParam1) // Position - 0x244B0
{
	int i;
	int j;
...
BOOL func_263(Hash hParam0) // Position - 0x2471A
{
	int i;
...
Hash func_264(int iParam0) // Position - 0x24744
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_265(Hash hParam0) // Position - 0x247AC
{
	int i;

	for (i = 0; i < 6; i = i + 1)
	{
		if (Global_262145.f_5060[i] == hParam0)
			return true;
	}
...
const char* func_266() // Position - 0x247DB
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("CREATOR_RSC" /*Rockstar*/);
}
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x247FE
{
	Hash statName;
...
void func_270() // Position - 0x24A51
{
	...
	for (i = 0; i <= 84; i = i + 1)
	{
		Global_999913[i /*3*/] = { 0f, 0f, 0f };
		Global_999913.f_256[i /*3*/] = { 0f, 0f, 0f };
		Global_999913.f_512[i] = 0f;
	}
...
void func_271() // Position - 0x24A9D
{
	...
	for (j = 0; j < 1; j = j + 1)
	{
		Global_794709.f_153324[i /*11*/].f_9 = 0;
	
		for (i = 0; i < 8; i = i + 1)
		{
			Global_794709.f_153324[j /*11*/][i] = 0;
		}
	}
...
BOOL func_272(const char* sParam0) // Position - 0x24AEC
{
...
BOOL func_273(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, Any* panParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x24C06
{
	switch (iParam0)
	{
		case 0:
...
int func_274(Player plParam0) // Position - 0x24E2D
{
	var gamerHandle;
	int clanDesc;
...
void func_279(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x2502B
{
	int i;
	var unk;
...
void func_280(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x2507A
{
	int i;
	var unk;
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x2523B
{
	uParam0->f_1 = 0;
	return;
}
...
void func_286() // Position - 0x25248
{
	...
	for (i = 0; i < 62; i = i + 1)
	{
		Global_991587.f_5461[i] = -1;
		Global_980531.f_5461[i] = -1;
	}

	return;
}

BOOL func_287() // Position - 0x2527B
{
	if (!func_288())
		return true;
...
BOOL func_288() // Position - 0x25290
{
	if (func_289())
		return false;
...
BOOL func_290(var uParam0) // Position - 0x252BC
{
	var gamerHandle;
	Any* fileDict;
	int int;
...
void func_292(int iParam0, int iParam1) // Position - 0x2539F
{
	...
	hash = Global_1665476[iParam0];
	statName = hash;
	STATS::STAT_SET_INT(statName, iParam1, true);
	return;
}

struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0x253BF
{
	var gamerHandle;
...
void func_294(int iParam0, var uParam1) // Position - 0x253D4
{
	int i;
	int j;
	var unk;
	...
	for (j = 0; j <= 30; j = j + 1)
	{
		if (IS_BIT_SET(Global_980531.f_4[j /*88*/].f_76, 13))
		{
			for (i = iParam0; i <= (iParam0 + uParam1) - 1; i = i + 1)
			{
				if (i < 1500 && func_295(Global_980531.f_4[j /*88*/].f_56, Global_794709.f_4[i /*88*/].f_56, 1082130432))
					Global_980531.f_4[j /*88*/] = { unk };
			}
			...
			if (iParam0 == 0)
			{
				for (i = 0; i <= 299; i = i + 1)
				{
					if (func_295(Global_980531.f_4[j /*88*/].f_56, Global_948106.f_1804[i /*88*/].f_56, 1082130432))
						Global_980531.f_4[j /*88*/] = { unk };
				}
			}
		}
...
BOOL func_295(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x254C9
{
...
BOOL func_297() // Position - 0x2553A
{
	BOOL num;
	int profileSetting;
	int profileSetting2;
...
void func_298(int iParam0, int iParam1) // Position - 0x255C6
{
	int i;
	int j;
	var unk;
	...
	for (j = 0; j <= 299; j = j + 1)
	{
		if (IS_BIT_SET(Global_948106.f_1804[j /*88*/].f_76, 13))
		{
			for (i = iParam0; i <= iParam1 - 1; i = i + 1)
			{
				if (IS_BIT_SET(Global_794709.f_4[i /*88*/].f_76, 13))
				{
					if (func_295(Global_794709.f_4[i /*88*/].f_56, Global_948106.f_1804[j /*88*/].f_56, 1082130432))
					{
						MISC::CLEAR_BIT(&(Global_948106.f_1804[j /*88*/].f_76), 13);
						Global_948106.f_1804[j /*88*/] = { unk };
						i = 1500;
					}
				}
			}
...
BOOL func_306(var uParam0) // Position - 0x2572E
{
	int i;
	...
	switch (uParam0->f_3)
	{
			...
			for (i = 0; i <= 63; i = i + 1)
			{
				if (i < 35)
				{
					if (Global_786550.f_3538[i /*132*/].f_129 != 0)
						NETWORK::UGC_RELEASE_CACHED_DESCRIPTION(Global_786550.f_3538[i /*132*/].f_129);
		...
		case 24:
			...
			for (i = 0; i <= 63; i = i + 1)
			{
				if (i < 35)
				{
					Global_1050140.f_1179[i /*6*/] = { func_313(i + uParam0->f_11) };
				
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_1050140.f_1179[i /*6*/]))
	...
	for (i = uParam0->f_11; i <= uParam0->f_11 + 63; i = i + 1)
	{
		if (i < 35)
			if (Global_786550.f_1[i /*88*/].f_54 != 0)
				if (!func_310(Global_786550.f_1[i /*88*/].f_54, &(Global_786550.f_3538[i /*132*/].f_129)))
					flag = false;
	...
	if (flag)
	{
		for (i = uParam0->f_11; i <= uParam0->f_11 + 63; i = i + 1)
		{
			if (i < 35)
			{
				...
				j = 0;
				flag2 = false;
				text = func_308(Global_786550.f_1[i /*88*/].f_54, 500);
...
const char* func_308(int iParam0, int iParam1) // Position - 0x25BE4
{
	if (iParam0 == -1)
		return func_309();
...
const char* func_309() // Position - 0x25C04
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("CREATOR_NO_T" /*No translation.*/);
}

BOOL func_310(int iParam0, int iParam1) // Position - 0x25C14
{
	if (*iParam1 != iParam0)
	{
		if (*iParam1 != 0)
...
void func_311(var uParam0) // Position - 0x25CBF
{
	...
	unk.f_66 = -1;
	unk.f_67 = 2;
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/] = { unk };
	...
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_56 = { func_108(dict2) };

	if (DATAFILE::DATADICT_GET_TYPE(dict2, "optbs") == 2)
		Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_76 = DATAFILE::DATADICT_GET_INT(dict2, "optbs");
	...
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_59 = { func_107(dict2, "cam") };
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_62 = { func_106(dict2) };
	...
	if (DATAFILE::DATADICT_GET_TYPE(dict2, "mgrk") == 2)
		Global_786550.f_3082[uParam0->f_8 + uParam0->f_11 /*13*/].f_8 = DATAFILE::DATADICT_GET_INT(dict2, "mgrk");

	if (DATAFILE::DATADICT_GET_TYPE(dict2, "mght") == 2)
		Global_786550.f_3082[uParam0->f_8 + uParam0->f_11 /*13*/].f_9 = DATAFILE::DATADICT_GET_INT(dict2, "mght");

	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_69 = DATAFILE::DATADICT_GET_INT(dict2, "min");
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_71 = DATAFILE::DATADICT_GET_INT(dict2, "num");

	if (Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_71 == -1)
		Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_71 = func_105();

	TEXT_LABEL_ASSIGN_STRING(&(Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_22), NETWORK::UGC_GET_CONTENT_NAME(uParam0->f_6), 64);
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_65 = DATAFILE::DATADICT_GET_INT(dict2, "type");

	if (func_315())
		TEXT_LABEL_ASSIGN_STRING(&(Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_6), func_266(), 64);
	else
		TEXT_LABEL_ASSIGN_STRING(&(Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_6), NETWORK::UGC_GET_CONTENT_USER_ID(uParam0->f_6), 64);

	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_70 = DATAFILE::DATADICT_GET_INT(dict2, "rank");
	Global_786550.f_3082[uParam0->f_8 + uParam0->f_11 /*13*/] = DATAFILE::DATADICT_GET_INT(dict2, "tnum");
	...
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_75 = DATAFILE::DATADICT_GET_INT(dict2, "charcon");
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_78 = DATAFILE::DATADICT_GET_INT(dict2, "ltm");
	Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/].f_68 = DATAFILE::DATADICT_GET_INT(dict2, "subtype");
	TEXT_LABEL_ASSIGN_STRING(&Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/], NETWORK::UGC_GET_CONTENT_ID(uParam0->f_6), 24);
	hashKey = MISC::GET_HASH_KEY(&Global_786550.f_1[uParam0->f_8 + uParam0->f_11 /*88*/]);
	Global_786550.f_3082[uParam0->f_8 + uParam0->f_11 /*13*/].f_3 = hashKey;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x262AC
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2662C
{
...
BOOL func_322() // Position - 0x266AC
{
...
BOOL func_324() // Position - 0x26715
{
