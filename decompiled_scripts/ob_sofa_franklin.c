...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	Global_43753 = 0,25f;
	StringCopy(&Global_43754, func_30(iParam3), 16);
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, Param0, 2f))
			{
				...
				{
					if ((Global_96908 && Global_96909) || func_92())
					{
						return 0;
					}
...
void func_102()
{
	...
	{
		if (func_105(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_104(PLAYER::PLAYER_PED_ID());
			if (func_103(iVar0) && (!func_16(14) || Global_111873))
			{
				if (Global_112922.f_2363.f_539.f_4321 != iVar0 && func_103(Global_112922.f_2363.f_539.f_4321))
				{
...
{
	return func_111(iParam0, Global_42602);
}
