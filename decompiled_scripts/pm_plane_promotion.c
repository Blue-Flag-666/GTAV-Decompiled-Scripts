...
void func_1() // Position - 0xC8
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_241))
	{
		if (!VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_241, false))
		{
			func_143();
		}
		else if (iLocal_47 == 2)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_241, false))
			{
				if (!HUD::DOES_BLIP_EXIST(blLocal_50))
				{
					_SHOW_SUBTITLE_CLEAR_EXISTING("BK_PLANE", 7500, 1);
					blLocal_50 = func_141(veLocal_241, false, false);
				}
			
				if (func_140(PLAYER::PLAYER_PED_ID(), veLocal_241, true) > 300f)
					func_143();
			}
			else if (HUD::DOES_BLIP_EXIST(blLocal_50))
			{
				HUD::CLEAR_PRINTS();
				HUD::REMOVE_BLIP(&blLocal_50);
			}
		}
	}

	if (ENTITY::DOES_ENTITY_EXIST(veLocal_241) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_241, false) && ENTITY::IS_ENTITY_IN_AIR(veLocal_241) && bLocal_325 && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false, -1))
	{
		if (!bLocal_326)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_VEH_FLY_ATTACK))
			{
				if (iLocal_324 == -1 || MISC::GET_GAME_TIMER() - iLocal_324 > 2000)
				{
					...
					{
						iLocal_332 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", veLocal_241, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, false, false, false);
						fLocal_330 = 0f;
					}
					...
					AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "PROPERTIES_PLANE_PROMO_MASTER", veLocal_241, 0, false, 0);
	...
	switch (iLocal_47)
	{
		case 0:
			...
			{
				veLocal_241 = Global_112358.f_222[0];
			
				if (!ENTITY::DOES_ENTITY_EXIST(veLocal_241))
				{
					veLocal_241 = VEHICLE::CREATE_VEHICLE(joaat("stunt"), vector, 121.2244f, true, true, false);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(veLocal_241, 1084227584);
				}
				else
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(veLocal_241, true, true);
				}
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(veLocal_241) && VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_241, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_241, false))
				{
					HUD::CLEAR_PRINTS();
		...
		case 3:
			if (func_30(&uLocal_51, uLocal_36, -1067.083f, -2922.6008f, 12.824183f, -1091.8535f, -2965.4033f, 23.94564f, 31.5625f, true, veLocal_241, "LAND", "", "BK_PLANE", true, 0, true, INVALID) && !ENTITY::IS_ENTITY_IN_AIR(veLocal_241))
			{
				func_135(&uLocal_51, true, false);
				iLocal_47 = iLocal_47 + 1;
			}
		...
		case 4:
			if (func_28(veLocal_241, 1093140480, 1, 0f, false, true, false))
				iLocal_47 = iLocal_47 + 1;
			break;
	
		case 5:
			TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(veLocal_241, false);
			func_27();
			break;
	}
	...
	switch (iLocal_48)
	{
		case 0:
			...
			else if (func_26() && MISC::GET_GAME_TIMER() - iLocal_49 > 5000 && bLocal_329)
			{
				...
				TEXT_LABEL_APPEND_STRING(&unk3, &uLocal_43, 16);
			
				if (func_25(49) && MISC::GET_RANDOM_INT_IN_RANGE(0, 3) == 0)
					TEXT_LABEL_APPEND_STRING(&unk3, "M", 16);
				else if (iLocal_331 > 0)
					TEXT_LABEL_APPEND_INT(&unk3, iLocal_331 + 1, 16);
			
				if (_CONVERSATION_ADD_LINE(&uLocal_76, &uLocal_39, &unk3, 8, 0, 0, 0))
				{
...
void func_29(Vehicle veParam0) // Position - 0x104F
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_30(Blip* pblParam0, var uParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, BOOL bParam11, Vehicle veParam12, char* sParam13, char* sParam14, char* sParam15, BOOL bParam16, int iParam17, BOOL bParam18, eBlipSprite ebsParam19) // Position - 0x107B
{
	return func_31(pblParam0, uParam1, func_75(), fParam4, fParam7, bParam11, 5, 0, 0, 0, veParam12, sParam13, func_74(), func_74(), func_74(), func_74(), sParam14, false, bParam16, sParam15, true, iParam17, bParam18, ebsParam19, func_74(), func_74(), func_74(), true, fParam10);
}

BOOL func_31(Blip* pblParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6, Vector3 vParam7, var uParam8, var uParam9, Vector3 vParam10, var uParam11, var uParam12, BOOL bParam13, int iParam14, int iParam15, int iParam16, int iParam17, Vehicle veParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, BOOL bParam25, BOOL bParam26, char* sParam27, BOOL bParam28, int iParam29, BOOL bParam30, eBlipSprite ebsParam31, char* sParam32, char* sParam33, char* sParam34, BOOL bParam35, float fParam36) // Position - 0x10D0
{
	...
	if (func_54(pblParam0, pblParam0->f_17[0], pblParam0->f_17[1], pblParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, pblParam0->f_8, bParam25, veParam18, false, false, sParam32, sParam33, sParam34, iParam14, bParam26))
	{
		func_53(sParam20);
		func_53(sParam21);
		func_53(sParam22);
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (flag)
			{
				...
				if (bParam26 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if (!func_48(pblParam0, 1) && !func_47(pblParam0) && !IS_BIT_SET(pblParam0->f_13, 0))
					{
						if (bParam30)
						{
							func_46(pblParam0, "LOSE_WANTED" /*Lose the Cops.*/, false);
						
							if (!PED::IS_PED_INJURED(pblParam0->f_17[0]))
								func_44(pblParam0->f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
						}
				...
				else
				{
					...
					{
						if (!func_48(pblParam0, 1))
						{
							if (!PED::IS_PED_INJURED(pblParam0->f_17[0]))
								func_44(pblParam0->f_17[0], "LOSE_WANTED_LEVEL", 3);
					...
					if (!HUD::DOES_BLIP_EXIST(pblParam0->f_5))
					{
						...
						pblParam0->f_5 = func_43(vector, false);
					
						if (!ebsParam31 == INVALID)
							HUD::SET_BLIP_SPRITE(pblParam0->f_5, ebsParam31);
					
						if (bParam35)
							func_42(pblParam0->f_5, pblParam0);
					}
					else if (!func_41(vector, HUD::GET_BLIP_COORDS(pblParam0->f_5), 0.1f, false))
					{
					...
					if (!func_48(pblParam0, 2))
					{
						if (!IS_BIT_SET(pblParam0->f_13, 2))
						{
							func_46(pblParam0, sParam19, false);
					...
					if (flag)
					{
						...
						for (i = 0; i < 3; i = i + 1)
						{
							if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_40()) || !func_38(pblParam0->f_17[i], true))
								{
									flag = false;
								}
							}
				...
				else
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam18, false))
					{
						if (!HUD::DOES_BLIP_EXIST(*pblParam0))
						{
							...
							*pblParam0 = func_32(veParam18, false, false);
							HUD::SET_BLIP_DISPLAY(*pblParam0, 2);
						
							if (!IS_BIT_SET(pblParam0->f_13, 4))
								func_42(*pblParam0, pblParam0);
						}
						...
						if (!func_48(pblParam0, 2))
						{
							...
							{
								func_46(pblParam0, sParam24, false);
								MISC::SET_BIT(&(pblParam0->f_13), 3);
								MISC::CLEAR_BIT(&(pblParam0->f_13), 4);
							}
							else if (IS_BIT_SET(pblParam0->f_13, 9))
							{
								if (!MISC::IS_STRING_NULL(sParam27))
								{
									if (!IS_BIT_SET(pblParam0->f_13, 4))
									{
										func_46(pblParam0, sParam27, false);
								...
								{
									if (!PED::IS_PED_INJURED(pblParam0->f_17[0]))
										func_44(pblParam0->f_17[0], "GET_IN_CAR", 3);
							...
							if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								if (!IS_BIT_SET(pblParam0->f_13, 13))
								{
									...
									if (!PED::IS_PED_INJURED(pblParam0->f_17[randomIntInRange]))
										func_44(pblParam0->f_17[randomIntInRange], "NEED_A_BIGGER_VEHICLE", 3);
								
									func_46(pblParam0, "MORE_SEATS" /*A vehicle with more seats is needed.*/, false);
...
Blip func_32(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19D5
{
	return func_33(veParam0, !bParam1, bParam2);
}

Blip func_33(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19E8
{
	Blip blip;
...
BOOL func_35(Blip* pblParam0) // Position - 0x1AA3
{
	if (IS_BIT_SET(pblParam0->f_13, 12))
		if (func_37(PLAYER::PLAYER_PED_ID()))
			if (func_36(true, false, true) || IS_BIT_SET(pblParam0->f_13, 7))
				return true;
	else if (func_36(true, false, true) || IS_BIT_SET(pblParam0->f_13, 7))
		return true;
...
BOOL func_37(Ped pedParam0) // Position - 0x1BDD
{
	float entitySpeed;
...
BOOL func_38(Ped pedParam0, BOOL bParam1) // Position - 0x1C14
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && bParam1)
		{
			if (func_39(PLAYER::PLAYER_PED_ID(), pedParam0))
			{
...
BOOL func_39(Ped pedParam0, Ped pedParam1) // Position - 0x1C7F
{
	Vehicle vehiclePedIsIn;
...
void func_42(Blip blParam0, Blip* pblParam1) // Position - 0x1D52
{
...
Blip func_43(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1D8D
{
...
void func_44(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x1DB9
{
...
void func_46(Blip* pblParam0, char* sParam1, BOOL bParam2) // Position - 0x1FC4
{
	if (!bParam2)
...
BOOL func_47(Blip* pblParam0) // Position - 0x1FFB
{
...
BOOL func_48(Blip* pblParam0, int iParam1) // Position - 0x201F
{
...
BOOL func_50(Blip* pblParam0) // Position - 0x208E
{
	int num;
	int gameTimer;
...
BOOL func_51(Blip* pblParam0, int iParam1) // Position - 0x20B1
{
	Vehicle vehiclePedIsIn;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_52(vehiclePedIsIn, pblParam0, iParam1))
			return true;
	}
...
BOOL func_52(Vehicle veParam0, Blip* pblParam1, int iParam2) // Position - 0x20E2
{
	int num;
...
BOOL func_54(Blip* pblParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, BOOL bParam9, Vehicle veParam10, BOOL bParam11, BOOL bParam12, var uParam13, var uParam14, var uParam15, int iParam16, BOOL bParam17) // Position - 0x218E
{
	int i;
	int num;
	int num2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(pblParam0->f_21, false))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pblParam0->f_21, true)) < 400f)
			{
				if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (func_52(pblParam0->f_21, pblParam0, num3))
						{
							for (i = 0; i < 3; i = i + 1)
							{
								if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
								{
									...
									if (TASK::GET_SCRIPT_TASK_STATUS(pblParam0->f_17[i], SCRIPT_TASK_ENTER_VEHICLE) == 7 && !func_70(pblParam0->f_17[i], pblParam0->f_21))
									{
		...
		if (flag4)
		{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
				{
					...
					if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_40()))
						if (func_68(pblParam0, pblParam0->f_17[i], fParam8, true))
	...
	if (!IS_BIT_SET(pblParam0->f_13, 26))
	{
		if (!func_67(pblParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !ENTITY::DOES_ENTITY_EXIST(veParam10))
		{
			vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(veParam10))
		{
			if (!PED::IS_PED_INJURED(pblParam0->f_17[0]) || !PED::IS_PED_INJURED(pblParam0->f_17[1]) || !PED::IS_PED_INJURED(pblParam0->f_17[2]))
			{
				...
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_48(pblParam0, 2))
					{
						vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
					
						if (func_66(vehiclePedIsIn, pblParam0))
						{
							func_46(pblParam0, "CMN_VEHSUIT" /*~s~Vehicle is not suitable.*/, false);
			...
			if (ENTITY::DOES_ENTITY_EXIST(pblParam0->f_17[i]))
			{
				if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
				{
					...
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false))
							if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_40()))
								if (!func_67(pblParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
									if (!func_65(pblParam0->f_17[i]))
										PED::REMOVE_PED_FROM_GROUP(pblParam0->f_17[i]);
					...
					if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_40()))
					{
						...
						{
							if (func_52(vehiclePedIsUsing, pblParam0, 0))
							{
								if (func_64(i, pblParam0) || !IS_BIT_SET(pblParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(pblParam0->f_17[i], i);
									func_63(i, pblParam0);
									num4 = num4 + 1;
					...
					if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_40()) && !func_61(pblParam0->f_17[i], veParam10) && !func_60(pblParam0->f_17[i], veParam10))
					{
						if (func_68(pblParam0, pblParam0->f_17[i], fParam8, bParam11))
						{
							if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_40()))
							{
						...
						if (flag2)
						{
							if (!HUD::DOES_BLIP_EXIST(pblParam0->f_1[i]))
							{
								...
								pblParam0->f_1[i] = func_32(pblParam0->f_17[i], false, false);
								HUD::SET_BLIP_DISPLAY(pblParam0->f_1[i], 2);
							
								if (bParam9)
									func_42(pblParam0->f_1[i], pblParam0);
							}
						}
					...
					{
						if (func_38(pblParam0->f_17[i], true) || func_61(pblParam0->f_17[i], veParam10) || bParam12 || VEHICLE::IS_VEHICLE_DRIVEABLE(veParam10, false) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veParam10, false))
						{
							if (HUD::DOES_BLIP_EXIST(pblParam0->f_1[i]))
							{
						...
						if (!PED::IS_PED_SITTING_IN_VEHICLE(pblParam0->f_17[i], veParam10))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(pblParam0->f_17[i], veParam10, 20f, 20f, 5f, false, true, 0) && !IS_BIT_SET(pblParam0->f_13, 11) && !(bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veParam10, false)))
							{
								if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(pblParam0->f_17[i]))
								{
									...
									{
										if (!func_38(pblParam0->f_17[i], true))
										{
											if (func_37(pblParam0->f_17[i]))
											{
								...
								else
								{
									...
									if (scriptTaskStatus == 7 && !func_70(pblParam0->f_17[i], veParam10))
									{
										if (!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(pblParam0->f_17[i]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_59(pblParam0->f_17[i], 2f) && !PED::IS_PED_RAGDOLL(pblParam0->f_17[i]) && !TASK::IS_PED_GETTING_UP(pblParam0->f_17[i]) && !FILES::GET_DLC_VEHICLE_FLAGS(veParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pblParam0->f_17[i], true);
			...
			if (num > 0)
			{
				for (i = 0; i < 3; i = i + 1)
				{
					if (unk[i])
					{
						if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
						{
							if (func_65(pblParam0->f_17[i]) || ENTITY::IS_ENTITY_AT_ENTITY(pblParam0->f_17[i], PLAYER::PLAYER_PED_ID(), pblParam0->f_8, pblParam0->f_8, pblParam0->f_8, false, true, 0))
							{
								num = num - 1;
								unk[i] = 0;
							}
					...
					{
						!ENTITY::IS_ENTITY_AT_ENTITY(pblParam0->f_17[i], PLAYER::PLAYER_PED_ID(), pblParam0->f_8 * 0.85f, pblParam0->f_8 * 0.85f, pblParam0->f_8, false, true, 0) && !func_65(pblParam0->f_17[i]);
					}
				}
			}
				...
				if (num > 0)
				{
					if (pblParam0->f_12 < num)
					{
						if (num == num3 || num2 + num == num3 && num3 > 1)
						{
							...
							{
								func_46(pblParam0, sParam7, false);
							...
							for (i = 0; i < 3; i = i + 1)
							{
								if (unk[i])
								{
									if (!func_58(i, pblParam0))
									{
										...
										if (!func_58(i, pblParam0))
										{
											func_46(pblParam0, unk5[i], false);
											func_55(i, pblParam0);
											pblParam0->f_12 = num;
										}
									}
...
void func_55(int iParam0, Blip* pblParam1) // Position - 0x31D1
{
	switch (iParam0)
	{
		case 0:
...
void func_56(Blip* pblParam0, const char* sParam1, const char* sParam2, BOOL bParam3) // Position - 0x3219
{
	if (!bParam3)
		if (!MISC::IS_STRING_NULL(sParam1))
			if (!MISC::ARE_STRINGS_EQUAL(sParam1, ""))
...
void func_57(const char* sParam0, const char* sParam1, int iParam2, int iParam3) // Position - 0x3252
{
	iParam3 = iParam3;
...
BOOL func_58(int iParam0, Blip* pblParam1) // Position - 0x3271
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_59(Ped pedParam0, float fParam1) // Position - 0x32B1
{
	Vehicle vehiclePedIsIn;
...
BOOL func_60(Ped pedParam0, Vehicle veParam1) // Position - 0x32E8
{
...
BOOL func_61(Ped pedParam0, Vehicle veParam1) // Position - 0x334F
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_62(int iParam0, Blip* pblParam1) // Position - 0x3384
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, Blip* pblParam1) // Position - 0x33CC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_64(int iParam0, Blip* pblParam1) // Position - 0x3414
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_65(Ped pedParam0) // Position - 0x3454
{
	Vehicle vehiclePedIsUsing;
...
BOOL func_66(Vehicle veParam0, Blip* pblParam1) // Position - 0x34E1
{
	int num;
	int num2;
	int i;
...
BOOL func_67(Blip* pblParam0) // Position - 0x3641
{
	Vehicle vehiclePedIsIn;
	...
	if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_52(vehiclePedIsIn, pblParam0, 0))
			return true;
	}
...
BOOL func_68(Blip* pblParam0, Ped pedParam1, float fParam2, BOOL bParam3) // Position - 0x3670
{
	Vehicle vehiclePedIsIn;
...
BOOL func_69(Vehicle veParam0) // Position - 0x374E
{
	float entitySpeed;
...
BOOL func_70(Ped pedParam0, Vehicle veParam1) // Position - 0x3786
{
	Vehicle vehiclePedIsUsing;
...
void func_72(Blip* pblParam0) // Position - 0x3823
{
	int i;
...
void func_73(Blip* pblParam0) // Position - 0x38C3
{
	int i;
...
BOOL func_76(var uParam0) // Position - 0x396E
{
	...
	if (!uParam0->f_6)
	{
		num = func_79(PLAYER::PLAYER_PED_ID(), *uParam0, false);
		...
		if (!uParam0->f_6)
		{
			if (!HUD::DOES_BLIP_EXIST(uParam0->f_4))
			{
				uParam0->f_4 = func_43(*uParam0, false);
...
Blip func_77(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x3AAC
{
	Blip blip;
...
float func_79(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3AFD
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_134(24) != Global_104212.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_131(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam5, &unk, &num))
					{
						fParam0 = { unk };
						fParam3 = num;
					}
...
void func_81(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x3BB2
{
	var unk;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		func_117(iParam5, &unk, uParam1, fParam4, func_123(veParam0));
		func_82(iParam5, veParam0, 0);
	}

	return;
}

void func_82(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x3CDB
{
	Vehicle vehicle;
...
void func_83(Vehicle veParam0, int iParam1) // Position - 0x3DF2
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	func_125(veParam0, &(Global_113648.f_32751.f_5510));
	return;
}

BOOL func_84(Vehicle veParam0) // Position - 0x3FF4
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_101(veParam0, 0, false) || func_101(veParam0, 1, false) || func_101(veParam0, 2, false) || func_123(veParam0) != 145 || func_100(veParam0) || func_99(veParam0) || func_98(veParam0) || func_97(veParam0) || !func_85(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_99(veParam0);
		func_99(veParam0);
		func_101(veParam0, 0, false);
		func_101(veParam0, 1, false);
		func_101(veParam0, 2, false);
		func_123(veParam0) != 145;
		return false;
	}
...
BOOL func_85(Hash hParam0) // Position - 0x40D2
{
	if (hParam0 == 0)
		return false;

	if (!func_86(hParam0, false, -1))
		return false;
...
BOOL func_86(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x4284
{
	int i;
	Hash outData;
...
BOOL func_87(Hash hParam0) // Position - 0x4406
{
	int num;
	var unk;
	var unk2;
...
BOOL func_89(Hash hParam0, int iParam1) // Position - 0x44E9
{
	BOOL num;
	int cloudTimeAsInt;
...
BOOL func_97(Vehicle veParam0) // Position - 0x7C31
{
	Hash entityModel;
	...
	if (!func_86(entityModel, false, -1))
		return true;

	return false;
}

BOOL func_98(Vehicle veParam0) // Position - 0x7C78
{
	int i;
...
BOOL func_99(Vehicle veParam0) // Position - 0x7CB3
{
	int i;
...
BOOL func_100(Vehicle veParam0) // Position - 0x7D2F
{
	int i;
...
BOOL func_101(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x7E17
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_102(iParam1, i, &garageName, &num); i = i + 1)
	{
...
int func_123(Vehicle veParam0) // Position - 0x9EC7
{
	int i;
...
void func_125(Vehicle veParam0, var uParam1) // Position - 0x9F71
{
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0);
		...
		func_127(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
	
		for (i = 0; i <= 11; i = i + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1))
				MISC::SET_BIT(&(uParam1->f_77), func_126(i + 1));
		}
...
int func_132(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0xA6CC
{
	int i;
...
Vehicle func_134(int iParam0) // Position - 0xA770
{
	if (iParam0 == -1)
		return 0;
...
void func_135(Blip* pblParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA78C
{
	int i;
...
void func_136(int iParam0, Blip* pblParam1) // Position - 0xA937
{
	switch (iParam0)
	{
		case 0:
...
void func_137(Blip* pblParam0) // Position - 0xA97F
{
	if (HUD::DOES_BLIP_EXIST(pblParam0->f_5))
		HUD::REMOVE_BLIP(&(pblParam0->f_5));
...
float func_140(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xA9D4
{
	Vector3 entityCoords;
...
Blip func_141(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAA32
{
	return func_33(veParam0, !bParam1, bParam2);
}
...
void func_145() // Position - 0xAA91
{
	...
	for (i = 0; i <= 9; i = i + 1)
	{
		...
		{
			groundZ = 0f;
			MISC::GET_GROUND_Z_FOR_3D_COORD(iLocal_242[i /*8*/], &groundZ, false, false);
			iLocal_242[i /*8*/].f_2 = groundZ;
		}
	}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xACE1
{
...
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_241))
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&veLocal_241);

	if (HUD::DOES_BLIP_EXIST(iLocal_242[0 /*8*/].f_4))
		HUD::REMOVE_BLIP(&(iLocal_242[0 /*8*/].f_4));

	if (HUD::DOES_BLIP_EXIST(iLocal_242[0 /*8*/].f_5))
		HUD::REMOVE_BLIP(&(iLocal_242[0 /*8*/].f_5));

	if (HUD::DOES_BLIP_EXIST(iLocal_242[1 /*8*/].f_4))
		HUD::REMOVE_BLIP(&(iLocal_242[1 /*8*/].f_4));

	if (HUD::DOES_BLIP_EXIST(iLocal_242[1 /*8*/].f_5))
		HUD::REMOVE_BLIP(&(iLocal_242[1 /*8*/].f_5));
