...
void func_1()
{
	...
	switch (iLocal_47)
	{
		case 0:
			...
			{
				iLocal_241 = Global_111632.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_241))
				{
...
void func_80(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103486.f_4))
	{
		...
		{
			if (func_134(24) != Global_103486.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_131(ENTITY::GET_ENTITY_COORDS(Global_103486.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_81(Global_103486.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_82(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_114(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_112922.f_32749.f_4801 = func_103();
			}
...
void func_83(int iParam0, int iParam1)
{
	...
	func_125(iParam0, &(Global_112922.f_32749.f_5510));
}
...
void func_117(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_114(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_122(iParam0);
			func_121(uParam1, &(Global_112922.f_32749.f_69[Global_76676.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_131(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
int func_132(struct<3> Param0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
