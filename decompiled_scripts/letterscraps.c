				...
				if (unk_0x35DF833D93BCC488())
				{
					if (!func_20())
					{
						if (!unk_0xE444FD7526C8BB46() && !func_14() && !func_13() && !func_12())
						{
							...
							func_7(1);
							func_6(1, 1, true, 0);
							unk_0xE686DF32889D09AE("LETTERS_HELP2" /*Press ~INPUT_FRONTEND_RIGHT~ or ~INPUT_FRONTEND_LEFT~ to cycle between pages, or press ~INPUT_FRONTEND_CANCEL~ to stop reading.*/, 0);
	...
	if (!unk_0x4310A0DB886F9FED(&Global_112300[iParam0 /*28*/], "") && !unk_0xB71C73D0269747D5(&Global_112300[iParam0 /*28*/]))
		if (IS_BIT_SET(Global_112300[iParam0 /*28*/].f_27, 1))
			if (IS_BIT_SET(Global_112300[iParam0 /*28*/].f_27, 2))
				return func_19(num, &Global_112300[iParam0 /*28*/], &(Global_112300[iParam0 /*28*/].f_4), Global_112300[iParam0 /*28*/].f_20);
			else
				return func_18(num, &Global_112300[iParam0 /*28*/], &(Global_112300[iParam0 /*28*/].f_4));
		else if (IS_BIT_SET(Global_112300[iParam0 /*28*/].f_27, 2))
			return func_17(num, &Global_112300[iParam0 /*28*/], Global_112300[iParam0 /*28*/].f_20);
		else
			return func_16(num, &Global_112300[iParam0 /*28*/]);
...
void func_21() // Position - 0x712
{
	switch (iLocal_43)
	{
		case 0:
			func_62();
			func_61(&uLocal_44, 1, joaat("prop_ld_scrap"), "LETTERS_COLLECT" /*~1~/50 letter scraps collected.*/);
			func_59(&uLocal_44, joaat("NUM_HIDDEN_PACKAGES_0"), 705, 50);
			iLocal_43 = 1;
			bLocal_621 = true;
			break;
		...
		case 1:
			...
			{
				if (func_23(&uLocal_44, &iLocal_57) || bLocal_620)
					iLocal_43 = 2;
			
				if (uLocal_44.f_1.f_4 == uLocal_44.f_1.f_3)
				{
					if (func_71(106) == 0)
					{
						func_66(106, 1);
...
BOOL func_23(var uParam0, var uParam1) // Position - 0x7DA
{
		...
		if (!uParam1->[uParam0->f_10 /*11*/].f_10)
		{
			if (!flag)
			{
				...
				else if (uParam0->f_10 == iLocal_608)
				{
					...
					if (unk_0x0E0433D7F75E162D(uParam1->[uParam0->f_10 /*11*/].f_1))
						unk_0x34CACBA26D1C2DED(uParam1->[uParam0->f_10 /*11*/].f_1, sLocal_609);
				}
				else
				{
	...
	if (uParam0->f_11)
		if (!Global_78819)
			func_24(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 1, &iLocal_610, &uLocal_611, "LETTERS_TITLE" /*Scrap Collected~s~*/, "LETTERS_COLLECT" /*~1~/50 letter scraps collected.*/);
...
int func_26(int iParam0) // Position - 0xB70
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_113648.f_10051.f_108, func_30(func_31(iParam0), i)))
				num = num + 1;
		}
	}
	else if (iParam0 == 6)
...
BOOL func_38(var uParam0, var uParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0x10B6
{
	...
	if (uParam1->[num /*11*/].f_10)
	{
		...
		{
			if (unk_0x923599D48C8BCBED(uParam1->[num /*11*/].f_1) || func_53(uParam1->[num /*11*/].f_1))
			{
	...
	{
		if (SYSTEM::VDIST2(vParam2, unk_0x55AE93A6E3B0AE8F(uParam1->[num /*11*/].f_1)) > 60f * 60f || func_58(13) || func_58(14))
		{
...
void func_44() // Position - 0x12C2
{
	...
	num4 = 0;
	unk_0xDD7756E2742E0F6D(func_46(0), &num, -1);
	num2 = num2 + num;

	if (num > 0)
		func_45(18, num);

	unk_0xDD7756E2742E0F6D(func_46(1), &num, -1);
	num2 = num2 + num;

	if (num > 0)
		func_45(19, num);

	unk_0xDD7756E2742E0F6D(func_46(3), &num, -1);
	num2 = num2 + num;
...
void func_62() // Position - 0x196F
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		iLocal_57[i /*11*/].f_3 = { func_63(i, 0) };
		iLocal_57[i /*11*/].f_10 = 0;
	}

	iLocal_610 = 0;
	iLocal_57[0 /*11*/].f_9 = 179.4746f;
	iLocal_57[1 /*11*/].f_6 = { 0f, 0f, 198f };
	iLocal_57[2 /*11*/].f_9 = 104f;
	iLocal_57[3 /*11*/].f_9 = 321.5f;
	iLocal_57[4 /*11*/].f_6 = { 0f, 0f, 49f };
