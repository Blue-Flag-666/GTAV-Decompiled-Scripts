...
BOOL func_2() // Position - 0x108
{
	...
	func_3(&iLocal_72, &uLocal_112);
	num = SYSTEM::VDIST2(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), uLocal_82);
...
int func_3(var uParam0, var uParam1) // Position - 0x142
{
	...
	for (i = 0; i < *uParam0; i = i + 1)
	{
		...
		{
			unk_0x7DE17ACDD8BA2642(uParam0->[i]);
		}
	}
...
void func_10() // Position - 0x35A
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_11(character) && !func_15(14) || Global_112599)
			{
...
void func_20() // Position - 0x54F
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_77; i = i + 1)
		{
			if (iLocal_77[i] != 0)
			{
				unk_0x852EC2A7DE66202D(iLocal_77[i]);
			
				if (!unk_0x0CBB7C273DED26E7(iLocal_77[i]))
				{
					unk_0x852EC2A7DE66202D(iLocal_77[i]);
					flag = false;
				}
		...
		if (!unk_0x2AC37494BBF1DB16(&uLocal_117))
		{
			unk_0x28818732C8F0F80E(&uLocal_117);
		
			if (!unk_0x2BBF749E555360DC(&uLocal_117))
			{
				unk_0x28818732C8F0F80E(&uLocal_117);
				flag = false;
			}
	...
	for (i = 0; i < iLocal_72; i = i + 1)
	{
		if (iLocal_77[i] != 0)
		{
			iLocal_72[i] = unk_0x69FDD9508259E5B5(26, iLocal_77[i], uLocal_82 + uLocal_86[i /*3*/], 0, 1, 1);
			unk_0x464B5B0F22497FC5(iLocal_72[i], { fLocal_85, 0f, 0f } + uLocal_99[i /*3*/], 2, 1);
			unk_0x90FF6DBE9D84E401(iLocal_72[i], 0);
		
			if (iLocal_70 == 288)
			{
				unk_0xFECAE061D8C80757(iLocal_72[i], 3, 1, 0, 0);
				unk_0xFECAE061D8C80757(iLocal_72[i], 4, 0, 0, 0);
			}
			else
			{
				unk_0x90FF6DBE9D84E401(iLocal_72[i], 0);
			...
			unk_0x7FE5E05BE63F6CB8(iLocal_72[i], 13, 0);
			unk_0x7FE5E05BE63F6CB8(iLocal_72[i], 17, 1);
			unk_0xC5B2830898581862(iLocal_72[i], 1);
			unk_0xD14067404D35AAE7(iLocal_72[i], 0);
			unk_0xC4F7B29AE0A7D629(iLocal_72[i], &uLocal_117, &uLocal_125[i /*8*/], uLocal_82 + uLocal_86[i /*3*/], { fLocal_85, 0f, 0f } + uLocal_99[i /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
			unk_0xBB6027D1D193CBA6(iLocal_72[i], 0, 0);
			unk_0x71A535529C1CA5DF(iLocal_72[i], 1);
			unk_0x992BB708B4B7A005(iLocal_72[i], 55, 1);
		
			if (uLocal_166[i] > 0)
			{
				unk_0x245E21EB8407EDF3(iLocal_72[i], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x579219057CE01A80(iLocal_72[i], 1, 0.81f, 0.733f, 4);
				unk_0x579219057CE01A80(iLocal_72[i], 0, 0.94f, 0.59f, 3);
				unk_0x579219057CE01A80(iLocal_72[i], 3, 0.24f, 0.62f, 4);
				unk_0x579219057CE01A80(iLocal_72[i], 2, 0f, 0.15f, 2);
				unk_0x579219057CE01A80(iLocal_72[i], 5, 0.46f, 0.853f, 3);
				unk_0x579219057CE01A80(iLocal_72[i], 4, 0.308f, 0.786f, 3);
	...
	for (i = 0; i < iLocal_159; i = i + 1)
	{
		if (uLocal_166[i] > 0)
		{
			...
			num7 = 1f;
			num8 = -1f;
			iLocal_159[i] = unk_0x3586A7FFD72654F0(uLocal_166[i], uLocal_82 + uLocal_173[i /*3*/], unk, unk4, num2, num3, num4, num5, num6, num7, num8, 0, 0, 0);
			SYSTEM::WAIT(0);
		}
	}
...
void func_22() // Position - 0x916
{
	...
	func_26(iLocal_70, &uLocal_82, &fLocal_85, &unk);
	num.f_1 = -1;
	num.f_17 = 4;
	num.f_17.f_8 = 4;
	num.f_17.f_13 = 4;
	...
	{
		case 280:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_117, "DEAD", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[0 /*8*/], "Dead_A", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[1 /*8*/], "Dead_D", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[2 /*8*/], "Dead_E", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[3 /*8*/], "Dead_G", 32);
			uLocal_86[0 /*3*/] = { 14.613f, 8.4563f, 0.9751f };
			uLocal_86[1 /*3*/] = { 10.6489f, 8.6708f, 0.7701f };
			uLocal_86[2 /*3*/] = { 6.3982f, 1.4604f, 1.1f };
			uLocal_86[3 /*3*/] = { 4.2327f, 5.864f, 0.9f - 0.15f };
			uLocal_99[0 /*3*/] = { 0f, 0f, 23.047f };
			uLocal_99[1 /*3*/] = { 0f, 0f, 97.2582f };
			uLocal_99[2 /*3*/] = { 0f, 0f, 34.2158f };
			uLocal_99[3 /*3*/] = { 0f, 0f, 61.2158f };
			...
			uLocal_166[2] = 1110;
			uLocal_166[3] = 1110;
			uLocal_173[0 /*3*/] = { ({ 0.37364f, -1445.5344f, 2803.7603f } - uLocal_82) + { 0.1f, 0f, 0f } };
			uLocal_173[1 /*3*/] = { ({ 0.28778f, -1444.8633f, 2800.022f } - uLocal_82) + { 0.1f, 0f, 0f } };
			uLocal_173[2 /*3*/] = { ({ 0.6045f, -1452.4043f, 2795.9336f } - uLocal_82) + { 0.1f, 0f, 0f } };
			uLocal_173[3 /*3*/] = { ({ 0.28483f, -1448.0331f, 2794.3005f } - uLocal_82) + { 0.1f, 0f, 0f } };
			uLocal_166[4] = joaat("XMAS_LIVERY_8");
			uLocal_166[5] = joaat("XMAS_LIVERY_8");
			uLocal_173[4 /*3*/] = { ((uLocal_173[0 /*3*/] + uLocal_173[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, unk_0xD88C7A93096DA0F7(0.5f, 0.5f), unk_0xD88C7A93096DA0F7(0.5f, 0.5f) } };
			uLocal_173[5 /*3*/] = { ((uLocal_173[1 /*3*/] + uLocal_173[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, unk_0xD88C7A93096DA0F7(0.5f, 0.5f), unk_0xD88C7A93096DA0F7(0.5f, 0.5f) } };
			break;
	
		default:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_117, "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[0 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[1 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[2 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[3 /*8*/], "", 32);
			iLocal_77[0] = 0;
			uLocal_86[0 /*3*/] = { 0f, 0f, 0f };
			uLocal_99[0 /*3*/] = { 0f, 0f, 0f };
			iLocal_77[1] = 0;
			uLocal_86[1 /*3*/] = { 0f, 0f, 0f };
			uLocal_99[1 /*3*/] = { 0f, 0f, 0f };
			iLocal_77[2] = 0;
			uLocal_86[2 /*3*/] = { 0f, 0f, 0f };
			uLocal_99[2 /*3*/] = { 0f, 0f, 0f };
			iLocal_77[3] = 0;
			uLocal_86[3 /*3*/] = { 0f, 0f, 0f };
			uLocal_99[3 /*3*/] = { 0f, 0f, 0f };
			iLocal_158 = 0;
			uLocal_112[0] = -1;
			uLocal_112[1] = -1;
			uLocal_112[2] = -1;
	...
	switch (uParam0.f_2)
	{
		...
		case 155:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_24(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), unk_0xD88C7A93096DA0F7(-5f, 5f), unk_0xD88C7A93096DA0F7(-5f, 5f), 0f, unk_0xD88C7A93096DA0F7(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
		...
		case 158:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_24(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), unk_0xD88C7A93096DA0F7(-5f, 5f), unk_0xD88C7A93096DA0F7(-5f, 5f), 0f, unk_0xD88C7A93096DA0F7(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
	...
	switch (uParam0.f_2)
	{
		...
		case 196:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_24(uParam109, 43, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), unk_0xD88C7A93096DA0F7(-5f, 5f), unk_0xD88C7A93096DA0F7(-5f, 5f), 0f, unk_0xD88C7A93096DA0F7(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_113648.f_2365.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_113648.f_2365.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_113648.f_2365.f_539.f_2314[2]), 32);
			return true;
...
void func_34() // Position - 0x91FB
{
	...
	{
		if (iLocal_77[i] != 0)
			unk_0xE0A291F406691F03(iLocal_77[i]);
	}

	if (!unk_0x2AC37494BBF1DB16(&uLocal_117))
		unk_0x0B34FA69ECCE3927(&uLocal_117);

	for (i = 0; i < iLocal_159; i = i + 1)
	{
		unk_0x29FEE5A574879EDA(iLocal_159[i]);
	}
