				...
				case 8:
					...
					switch (num3)
					{
						case 0:
							...
							{
								if (!IS_BIT_SET(Global_113771, 10))
...
void func_60(int iParam0) // Position - 0x5FB7
{
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_62() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), iParam0);
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x6131
{
	switch (iParam0)
	{
		case 0:
...
Hash func_64(int iParam0, int iParam1) // Position - 0x6264
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_65(iParam1));
}

int func_65(int iParam0) // Position - 0x6279
{
	int num;
	int num2;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x62B9
{
	if (iParam2 == -1)
		iParam2 = func_66();
...
BOOL func_69(int iParam0) // Position - 0x62F7
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x64C6
{
	if (iParam1 == -1)
		iParam1 = func_66();
...
BOOL func_75(var uParam0, int iParam1) // Position - 0x6651
{
	int i;
	var unk;
...
void func_80(var uParam0, int iParam1) // Position - 0x67D2
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_85(int iParam0) // Position - 0x6848
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_87(int iParam0, int iParam1) // Position - 0x68A6
{
...
void func_88(Hash hParam0, int iParam1) // Position - 0x68F7
{
	int outValue;
...
int func_91(eCharacter echParam0) // Position - 0x69EC
{
	return Global_2058[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x69FD
{
	func_93();
...
void func_93() // Position - 0x6A16
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_94(character) && !func_86(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != character && func_94(Global_113810.f_2366.f_539.f_4321))
...
BOOL func_94(eCharacter echParam0) // Position - 0x6B13
{
	return echParam0 < CHAR_MULTIPLAYER;
}

Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x6B1F
{
...
Hash func_96(eCharacter echParam0) // Position - 0x6B44
{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x6C31
{
	uParam0->f_1 = 0;
	return;
}
...
void func_101(int iParam0) // Position - 0x6DAA
{
	int i;
...
void func_107(Any* panParam0) // Position - 0x710A
{
	*panParam0 = 0;
	panParam0->f_1 = 0;
	panParam0->f_2 = 0;
...
void func_108(Any* panParam0) // Position - 0x7152
{
	int i;
...
int func_111(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x71C6
{
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (!func_3(&(uParam0->f_666), 14))
		{
			if (bParam1)
			{
				if (!bParam2)
				{
					func_114(uParam0->f_668 < uParam0->f_669 ? uParam0->f_668 : uParam0->f_669, uParam0->f_668 < uParam0->f_669 ? &(uParam0->f_648) : &(uParam0->f_654), -1, 1, 2, 1, 0, 1, 0, 0, 0, 0, 0, 0, -1);
					func_114(uParam0->f_668 >= uParam0->f_669 ? uParam0->f_668 : uParam0->f_669, uParam0->f_668 >= uParam0->f_669 ? &(uParam0->f_648) : &(uParam0->f_654), -1, 1, 2, 1, 0, 1, 0, 0, 0, 0, 0, 0, -1);
				}
				else
				{
...
void func_114(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, const char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14) // Position - 0x743B
{
	int num;
	int i;
...
BOOL func_115(const char* sParam0) // Position - 0x757D
{
...
var func_116(BOOL bParam0, var uParam1, var uParam2) // Position - 0x75B7
{
	if (bParam0)
		return uParam1;
...
var func_117(BOOL bParam0, var uParam1, var uParam2) // Position - 0x75CE
{
	if (bParam0)
		return uParam1;
...
BOOL func_123(var uParam0) // Position - 0x7774
{
...
void func_124(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x77A8
{
...
var func_125(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7A62
{
	if (bParam0)
		return uParam1;
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x7A79
{
	return iParam0 && iParam1 != false;
}

BOOL func_127(var uParam0) // Position - 0x7A88
{
	if (*uParam0 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
...
BOOL func_131(var uParam0, eControlAction ecaParam1) // Position - 0x8E1D
{
	var unk;
	int num;
	var unk2;
...
int func_139(Hash hParam0) // Position - 0x950A
{
	Hash value;
	float num;
	int num2;
...
struct<4> func_142(Hash hParam0) // Position - 0x9635
{
	var unk;
...
char* func_144(var uParam0) // Position - 0xA556
{
	return uParam0;
}

int func_145(int iParam0, Any* panParam1) // Position - 0xA560
{
	int i;
	int numDlcWeapons;
...
int func_146(Hash hParam0) // Position - 0xA59B
{
	if (hParam0 == 600)
...
void func_147(int iParam0, int iParam1, int iParam2, int iParam3, const char* sParam4, const char* sParam5) // Position - 0xA70E
{
...
BOOL func_148(Any* panParam0, Any* panParam1) // Position - 0xA760
{
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xA79A
{
...
void func_153(int iParam0) // Position - 0xABD5
{
	var unk;
	int i;
...
BOOL func_154(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xAC4B
{
	int num;
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0xAEF4
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xAF52
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
void func_157(int iParam0, int iParam1, int iParam2, const char* sParam3) // Position - 0xAF97
{
...
BOOL func_158(var uParam0) // Position - 0xAFCB
{
	if (!Global_2097532)
	{
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0xB36B
{
...
BOOL func_163(var uParam0) // Position - 0xB48D
{
	int i;
	int j;
...
BOOL func_164(var uParam0, int iParam1, Any* panParam2, var uParam3) // Position - 0xB63A
{
	var unk;
	int i;
...
void func_165(Any* panParam0, char* sParam1) // Position - 0xB6F3
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(panParam0, 35, sParam1);
	return;
}

BOOL func_166(Any* panParam0, Any* panParam1) // Position - 0xB705
{
	int i;
...
BOOL IS_XBOX_PLATFORM() // Position - 0xB744
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xB75A
{
...
BOOL func_170(var uParam0) // Position - 0xB7E1
{
	int i;
...
BOOL func_171(var uParam0, Any* panParam1, char* sParam2) // Position - 0xB84F
{
	if (*uParam0 == 2)
		return true;
...
BOOL func_172(var uParam0) // Position - 0xB960
{
...
BOOL func_173(var uParam0) // Position - 0xBAF6
{
	int i;
...
BOOL func_174(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, char* sParam17) // Position - 0xBB93
{
	var gamerHandle;
...
BOOL func_175(var uParam0, const char* sParam1, char* sParam2, Any anParam3, var uParam4) // Position - 0xBCB5
{
	int displaynamesFromHandles;
	var unk;
...
BOOL func_176(var uParam0) // Position - 0xBDBB
{
	var unk;
	var unk99;
	int i;
...
BOOL func_178(var uParam0, var uParam1, Any* panParam2, int iParam3, int iParam4) // Position - 0xCD06
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_183(int iParam0) // Position - 0xCE62
{
...
BOOL func_187(var uParam0, var uParam1, Any* panParam2, int iParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0xD093
{
	int any;
	float num;
...
BOOL func_189(var uParam0) // Position - 0xD1E5
{
	var unk;
	var unk99;
	int i;
...
BOOL func_190(var uParam0, var uParam1, Any* panParam2, Any* panParam3, Any anParam4, BOOL bParam5, int iParam6, int iParam7) // Position - 0xDBDF
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_191(var uParam0) // Position - 0xDC9B
{
	var unk;
	var unk14;
	var unk112;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xEBAF
{
	return uParam0->f_1;
}
...
void func_196(int iParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEBDB
{
	char* componentType;
	var clanDesc;
	var unk35;
...
void func_198(int iParam0, char* sParam1, const char* sParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0xEEF5
{
...
BOOL func_199(int iParam0) // Position - 0xEF85
{
...
BOOL func_203(Player plParam0) // Position - 0xEFE4
{
...
int func_204(Player plParam0) // Position - 0xF044
{
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xF10D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
int func_211(int* piParam0, BOOL bParam1) // Position - 0xF14A
{
...
BOOL func_220(var uParam0, BOOL bParam1, var uParam2) // Position - 0xF739
{
	if (!bLocal_256)
	{
...
BOOL func_221(var uParam0) // Position - 0xF7A2
{
	var unk;
	var unk99;
	Any any;
...
BOOL func_223() // Position - 0xFBD6
{
	return Global_2692776.f_3;
}

BOOL func_224(int iParam0) // Position - 0xFBE4
{
	switch (iParam0)
	{
		case 817:
...
BOOL func_226(int iParam0, int iParam1, int iParam2) // Position - 0xFD15
{
	int columnType;
...
BOOL func_227(int iParam0, int iParam1) // Position - 0xFE17
{
...
BOOL func_228(var uParam0, var uParam1, Any* panParam2, Any* panParam3) // Position - 0xFE72
{
	switch (*uParam0)
	{
		case 0:
...
BOOL _LEADERBOARDS2_TRY_BEGIN_WRITE_DATA(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x10132
{
	int num;
	int i;
	var gamerHandle;
...
Hash func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0x152F5
{
	var unk;
...
BOOL func_237(int iParam0) // Position - 0x15423
{
...
BOOL func_242() // Position - 0x155ED
{
...
BOOL func_243(var uParam0, int iParam1) // Position - 0x156EA
{
...
void func_244(var uParam0, int iParam1) // Position - 0x157ED
{
...
void func_245(var uParam0) // Position - 0x15813
{
	int randomIntInRange;
...
void func_246(var uParam0, BOOL bParam1) // Position - 0x1588C
{
	int randomIntInRange;
...
int func_251(Object* pobParam0) // Position - 0x15A76
{
...
void func_252(Ped pedParam0) // Position - 0x15AC6
{
...
void func_253(var uParam0, var uParam1, var uParam2, var uParam3, int* piParam4) // Position - 0x15B2A
{
	BOOL flag;
...
BOOL func_257(BOOL bParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1684A
{
	int address;
	int randomIntInRange;
...
BOOL func_258(BOOL bParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x16A3B
{
	int address;
	int randomIntInRange;
	int randomIntInRange2;
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x16C88
{
	iParam2 = iParam2;
...
void func_264(Ped pedParam0) // Position - 0x17298
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
BOOL func_265(Ped pedParam0, BOOL bParam1) // Position - 0x172B6
{
	int randomIntInRange;
...
BOOL _GET_RANDOM_BOOL() // Position - 0x17335
{
...
BOOL func_267(Ped pedParam0, BOOL bParam1) // Position - 0x17353
{
	int randomIntInRange;
...
int func_268(Ped pedParam0) // Position - 0x173D2
{
	int randomIntInRange;
	BOOL flag;
...
BOOL func_269(Ped pedParam0) // Position - 0x17415
{
	int randomIntInRange;
...
BOOL func_271(Ped pedParam0) // Position - 0x17456
{
	BOOL flag;
...
void func_272(int iParam0) // Position - 0x17482
{
	...
	{
		case 0:
			Global_113810.f_18973 = Global_113810.f_18973 + 1;
			func_273("DARTS_STAT_NUM_BULLSEYES", Global_113810.f_18973);
			break;
	
		case 1:
			Global_113810.f_18973.f_1 = Global_113810.f_18973.f_1 + 1;
			func_273("DARTS_STAT_NUM_180S", Global_113810.f_18973.f_1);
			break;
	
		case 2:
			Global_113810.f_18973.f_2 = Global_113810.f_18973.f_2 + 1;
			func_273("DARTS_STAT_NUM_WINS", Global_113810.f_18973.f_2);
			break;
	
		case 3:
			Global_113810.f_18973.f_3 = Global_113810.f_18973.f_3 + 1;
			func_273("DARTS_STAT_NUM_LOSS", Global_113810.f_18973.f_3);
			break;
	
		case 4:
			Global_113810.f_18973.f_4 = Global_113810.f_18973.f_4 + 1;
			func_273("DARTS_STAT_DARTS_THROWN", Global_113810.f_18973.f_4);
			break;
	
		case 5:
			Global_113810.f_18973.f_5 = Global_113810.f_18973.f_5 + 1;
...
void func_273(char* sParam0, int iParam1) // Position - 0x175F9
{
	return;
}
...
BOOL func_276(var uParam0) // Position - 0x1781D
{
	int num;
	int num2;
...
float func_278(float fParam0, var uParam1, var uParam2) // Position - 0x17B13
{
...
BOOL func_280(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x17BF4
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
	var unk3;
	float frameTime;
...
float func_282(float fParam0) // Position - 0x17E1B
{
	return fParam0;
}

float func_283(float fParam0) // Position - 0x17E25
{
	return fParam0;
}

BOOL func_284() // Position - 0x17E2F
{
	if (func_285())
		return true;
...
int func_297(Ped pedParam0) // Position - 0x184C5
{
	int randomIntInRange;
...
void func_298(int* piParam0) // Position - 0x184F1
{
	func_299(piParam0, 0f);
	return;
}

void func_299(int* piParam0, float fParam1) // Position - 0x18500
{
...
BOOL func_300(var uParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0x1852B
{
	float randomFloatInRange;
	int randomIntInRange;
...
BOOL func_301(var uParam0) // Position - 0x187A0
{
	BOOL num;
	float controlNormal;
...
void func_308(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x18F5B
{
	float num;
...
BOOL func_309(var uParam0, var uParam1, BOOL bParam2) // Position - 0x18FAF
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x190E6
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_311(int iParam0, BOOL bParam1) // Position - 0x190F9
{
	if (iParam0 == 0)
	{
		if (!IS_BIT_SET(Global_113771, 9))
		{
		...
		else if (bParam1 && !IS_BIT_SET(Global_113771, 7))
		{
...
BOOL func_312(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x19242
{
	Vector3 vector;
...
void func_314(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x192CF
{
	Vector3 vector;
...
float func_318(int iParam0) // Position - 0x1938D
{
	int i;
	int num;
	float num2;
...
BOOL func_319(var uParam0) // Position - 0x193C9
{
	switch (*uParam0)
	{
		case 0:
...
void func_320(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x194BC
{
	var unk;
	float controlUnboundNormal;
	float controlUnboundNormal2;
...
void func_323(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, float fParam11, int iParam12, int iParam13, float fParam14, BOOL bParam15) // Position - 0x19B39
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_335(Ped pedParam0) // Position - 0x1A303
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_338(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x1A3CB
{
	if (bParam2)
...
BOOL func_339(int iParam0, var uParam1) // Position - 0x1A3EB
{
	if (iParam0 >= 10)
	{
		if (!IS_BIT_SET(Global_113810.f_18973.f_6, 12))
		{
			*uParam1 = 12;
			return true;
		}
...
BOOL func_340(var uParam0, var uParam1, var uParam2) // Position - 0x1A414
{
	int i;
	int j;
...
void func_347(BOOL bParam0, int iParam1) // Position - 0x1A62E
{
	...
	if (bParam0)
	{
		func_348(&Global_23390.f_6103[num /*10*/]);
...
BOOL func_349(var uParam0, BOOL bParam1, int iParam2) // Position - 0x1A718
{
	var unk;
	Hash hashKey;
	int i;
...
BOOL func_351(var uParam0, var uParam1, var uParam2) // Position - 0x1A7E5
{
	char* gxt;
	int num;
	int num2;
...
BOOL func_353() // Position - 0x1B0E8
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
...
void func_354(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x1B107
{
	int num;
	int r;
	int g;
	...
	if (bParam3)
	{
		...
		{
			func_374(Global_23390.f_5661 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
		...
		if (i == 1 && Global_23390.f_6171)
		{
			...
			else
			{
				if (Global_23390)
				{
					...
					{
						func_373(Global_23387, Global_23388, iParam5, height3, 0, 0, 0, 255);
				...
				func_373(Global_23387, Global_23388 + height3, iParam5, 0.034722f, r, g, b, a);
			...
			if (Global_23390.f_6174 > Global_23390.f_5668)
			{
				...
				func_373(Global_23387, num28 + 0f, iParam5, 0.034722f, r, g, b, a);
			...
			if (MISC::GET_HASH_KEY(&(Global_23390.f_5081)) != 0 && Global_23390.f_5163 != -1)
			{
				...
				{
					func_19(Global_23390.f_5165, true, true, &width, &height, bParam7);
				...
				func_373(Global_23387, num28 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				if (Global_23390.f_5165 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_5165), func_23(Global_23390.f_5165, true), Global_23387 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4540958.f_21)) != 0 && Global_4540958.f_65 != -1)
			{
				...
				{
					func_19(Global_4540958.f_67, true, true, &width, &height, bParam7);
					x = (Global_23387 + width + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				if (Global_4540958.f_67 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_26(Global_4540958.f_67), func_23(Global_4540958.f_67, true), Global_23387 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
						...
						switch (Global_23390.f_5499[k])
						{
								...
								if (flag2)
								{
									if (!Global_23390.f_6172)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23390.f_79[num16 /*6*/]) != 0)
										{
											...
											func_360(flag, Global_23390.f_1616[num16], Global_23390.f_1873[num16], flag7, num36, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_19(Global_23390.f_4824[num14 + l], flag, false, &width, &height, bParam7))
												{
													num25 = num25 + width;
									...
									if (MISC::GET_HASH_KEY(&Global_23390.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_360(flag, Global_23390.f_1616[num16], Global_23390.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_23390.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_19(Global_23390.f_4824[num14 + num20], flag, false, &width, &height, bParam7))
												{
													x = x + (width * 0.5f);
												
													if (func_19(Global_23390.f_4824[num14 + num20], flag, true, &width, &height, bParam7))
													{
														func_368(Global_23390.f_4824[num14 + num20], flag, &red, &green, &blue, &alpha);
													
														if (i == 1)
															if (Global_23390.f_5526[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[num14 + num20]), func_23(Global_23390.f_4824[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[num14 + num20]), func_23(Global_23390.f_4824[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_360(false, Global_23390.f_1616[num16], Global_23390.f_1873[num16], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_23390.f_4824[num14 + l] != 2 && Global_23390.f_4824[num14 + l] != 52 && Global_23390.f_4824[num14 + l] != 62)
											{
												if (func_19(Global_23390.f_4824[num14 + l], flag, false, &width, &height, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_19(Global_23390.f_4824[num14 + l], flag, true, &width, &height, bParam7))
														{
															func_368(Global_23390.f_4824[num14 + l], flag, &red, &green, &blue, &alpha);
														
															if (Global_23390.f_4824[num14 + l] == 30)
																GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[num14 + l]), func_23(Global_23390.f_4824[num14 + l], flag), Global_23387 + (width * 0.5f), (y + 0.00277776f + (height * 0.5f)) - (0.00078125f * 11f), width, height, 0f, red, green, blue, alpha, false, 0);
															else if (Global_23390.f_5526[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[num14 + l]), func_23(Global_23390.f_4824[num14 + l], flag), ((num24 + x + screenWidthOfDisplayText) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[num14 + l]), func_23(Global_23390.f_4824[num14 + l], flag), (num24 + x + screenWidthOfDisplayText) - (0.00078125f * 12f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_23390.f_6172)
									{
										func_360(flag, Global_23390.f_1616[num16], Global_23390.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_360(flag, Global_23390.f_1616[num16], Global_23390.f_1873[num16], flag7, 0, false, false);
										func_357(num24 + x, y, "NUMBER" /*~1~*/, Global_23390.f_4309[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_360(flag, Global_23390.f_1616[num16], Global_23390.f_1873[num16], flag7, 0, false, false);
									func_356(num24 + x, y, "NUMBER" /*~1~*/, Global_23390.f_4566[num13], Global_23390.f_4695[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_19(Global_23390.f_4824[num14], flag, false, &width, &height, bParam7))
									{
										if (!Global_23390.f_6172)
										{
											num25 = width;
										...
										if (i == 1)
										{
											if (func_19(Global_23390.f_4824[num14], flag, true, &width, &height, bParam7))
											{
												func_368(Global_23390.f_4824[num14], flag, &red, &green, &blue, &alpha);
												GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[num14]), func_23(Global_23390.f_4824[num14], flag), num24 + x + (width * 0.5f), (y - 0.00277776f) + (height2 * 0.5f), width * func_355(Global_23390.f_4824[num14]), height * func_355(Global_23390.f_4824[num14]), 0f, red, green, blue, alpha, false, 0);
											}
										}
									}
								}
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x1E312
{
...
void func_360(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1E369
{
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_361(Global_23390.f_6454[iParam4], &r, &g, &b);
...
void func_362(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x1E7A1
{
	int num;
	int i;
	int j;
...
BOOL func_363(Player plParam0, int iParam1) // Position - 0x1ECA6
{
	BOOL flag;
...
BOOL func_365(Player plParam0) // Position - 0x1ED40
{
	Player player;
...
BOOL func_366() // Position - 0x1ED62
{
	var position;
...
BOOL func_367() // Position - 0x1EDD0
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("cellphone_flashhand")) > 0)
		return true;
...
void func_368(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x1EDEA
{
...
void func_373(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1F059
{
...
void func_374(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x1F088
{
	...
	if (!bParam3)
		func_377(Global_23390.f_5661, true);
	else
		func_377(Global_23390.f_5661, false);

	if (iParam2 == 0)
	{
		num2 = func_376(&Global_23390.f_79[Global_23390.f_5663 /*6*/]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_375(&Global_23390.f_79[Global_23390.f_5663 /*6*/]);
...
BOOL func_378(BOOL bParam0, BOOL bParam1) // Position - 0x1F349
{
...
BOOL func_380(int iParam0, int iParam1) // Position - 0x1F3F2
{
	switch (iParam0)
	{
		case 5:
...
int func_382(int* piParam0, int iParam1, int iParam2) // Position - 0x1F4B1
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
void func_383(int* piParam0) // Position - 0x1F529
{
	if (!func_428(piParam0))
		func_443(piParam0);
...
int func_384(int* piParam0) // Position - 0x1F541
{
	float controlNormal;
...
void func_386(eControlAction ecaParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x1F6C0
{
	const char* controlInstructionalButtonsString;
...
void func_389(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1F7B3
{
	...
	if (num != 2)
	{
		while (Global_23390.f_5662 < 4 && num != 2)
		{
			Global_23390.f_5662 = Global_23390.f_5662 + 1;
			num = Global_23390.f_5499[Global_23390.f_5662];
		}
...
void func_395(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1FA0C
{
...
int func_399(int* piParam0, int iParam1, int iParam2) // Position - 0x1FB64
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
int func_400(int* piParam0) // Position - 0x1FBDC
{
	float controlNormal;
...
BOOL func_401(int* piParam0) // Position - 0x1FC54
{
	float controlNormal;
...
BOOL func_402(int* piParam0) // Position - 0x1FCCC
{
	float controlNormal;
...
int func_403(int iParam0) // Position - 0x1FD44
{
	float x;
	float y;
	float x2;
...
BOOL func_404() // Position - 0x1FE11
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
...
BOOL func_407() // Position - 0x1FFE3
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		if (Global_4541034 > -1)
...
int func_408(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x2000B
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
	...
	if (num4 >= x && num4 <= x2 && num5 >= y && num5 <= y2)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || num10 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_373(num, num2 + ((float)num10 * 0.034722f), Global_23389, 0.034722f - 0.0015f, 255, 255, 255, num7);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_410(BOOL bParam0) // Position - 0x20397
{
	...
	if (Global_4541034 == -2)
		func_373(num, num2, Global_23389, num3, 255, 255, 255, num4);
	else if (Global_4541034 == -3)
		func_373(num, num2 + num3, Global_23389, num3, 255, 255, 255, num4);
...
BOOL func_415(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5) // Position - 0x205AC
{
	int i;
	int j;
...
void func_416(Object* pobParam0) // Position - 0x209C8
{
	Vector3 vector;
...
void func_417(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Vector3 vParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x20A08
{
...
BOOL func_418(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20A51
{
	if (!func_428(&(uParam0->f_2)))
		func_443(&(uParam0->f_2));
...
void func_419(var uParam0, char* sParam1, const char* sParam2, int iParam3, eHudColour ehcParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x20AE3
{
	char* methodName;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x20B72
{
	switch (iParam0)
	{
		case 0:
...
void func_423(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Vector3 vParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, BOOL bParam11) // Position - 0x20CFB
{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x20E06
{
...
int func_427(Ped pedParam0) // Position - 0x20E1D
{
	if (!ENTITY::IS_ENTITY_DEAD(func_506(), false))
...
BOOL func_428(int* piParam0) // Position - 0x20E50
{
	return IS_BIT_SET(*piParam0, 1);
}

void func_429(int* piParam0) // Position - 0x20E5D
{
	piParam0->f_1 = 0f;
	piParam0->f_2 = 0f;
	*piParam0 = 0;
...
void func_430(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x20E73
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam2), 1);
	return;
}

float func_431(int* piParam0) // Position - 0x20E8A
{
	if (func_428(piParam0))
		if (func_9(piParam0))
			return piParam0->f_2;
...
void func_432(int* piParam0) // Position - 0x20EC3
{
	if (!func_428(piParam0))
		func_383(piParam0);
	else
...
BOOL func_436() // Position - 0x20FD5
{
...
BOOL func_439() // Position - 0x2107E
{
	if (HUD::IS_PAUSE_MENU_ACTIVE())
		return false;
...
BOOL func_440(var uParam0) // Position - 0x210B0
{
...
BOOL func_441(Vehicle veParam0) // Position - 0x21123
{
...
void func_443(int* piParam0) // Position - 0x2118A
{
	func_444(piParam0, 0f);
	return;
}

void func_444(int* piParam0, float fParam1) // Position - 0x21199
{
	piParam0->f_1 = func_8(IS_BIT_SET(*piParam0, 4)) - fParam1;
	MISC::SET_BIT(piParam0, 1);
	MISC::CLEAR_BIT(piParam0, 2);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x211C4
{
...
void func_447(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, Any* panParam7, var uParam8) // Position - 0x21283
{
	int int;
	Hash entityModel;
	...
	else
	{
		...
		{
			int = DECORATOR::DECOR_GET_INT(uLocal_262[1], "Darts_name");
...
void func_448(Hash hParam0) // Position - 0x2147C
{
	int randomIntInRange;
...
BOOL func_449(Any* panParam0) // Position - 0x2151B
{
	int i;
...
eCharacter func_450(Ped pedParam0) // Position - 0x21604
{
	eCharacter i;
	Hash entityModel;
	eCharacter character;
...
Hash func_451(eCharacter echParam0) // Position - 0x2164A
{
...
BOOL func_457(var uParam0, var uParam1) // Position - 0x218C1
{
...
BOOL func_458(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x219A5
{
	...
	flag2 = func_459(&Global_23390.f_6103[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_459(int iParam0) // Position - 0x21A9B
{
	switch (iParam0->f_9)
	{
		case 0:
...
void func_463(var uParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x21BCB
{
	int i;
	int j;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x21CE7
{
...
void func_468(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x21E34
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
...
int func_472(eCharacter echParam0, int iParam1) // Position - 0x22183
{
	var outValue;
	Hash statHash;
...
Hash func_473(eCharacter echParam0, int iParam1) // Position - 0x221A1
{
	var unk;
	var unk2;
...
void func_474(eCharacter echParam0, int iParam1, var uParam2, var uParam3) // Position - 0x221B7
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
void func_477(var uParam0, var uParam1, var uParam2) // Position - 0x2249A
{
	int i;
	int j;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x22641
{
...
Vector3 func_487(BOOL bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x22EAA
{
	if (bParam0)
		return uParam1;
...
void func_488(int iParam0, int iParam1) // Position - 0x22EC5
{
...
void func_490(int* piParam0) // Position - 0x22EFD
{
...
BOOL func_497(int iParam0) // Position - 0x230F6
{
	int num;
	int num2;
	...
	PLAYER::SPECIAL_ABILITY_DEACTIVATE(PLAYER::PLAYER_ID(), 0);
	func_498(&(Global_113810.f_2366.f_539), num2);
...
void func_498(var uParam0, int iParam1) // Position - 0x23206
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_500(Global_113810.f_18536[i], &unk, &num2))
			{
...
BOOL func_500(int iParam0, var uParam1, var uParam2) // Position - 0x233DA
{
	switch (iParam0)
	{
		case 11:
...
BOOL func_503() // Position - 0x23DB9
{
...
Ped func_505() // Position - 0x23E5C
{
	return Global_96646;
}

Ped func_506() // Position - 0x23E68
{
	return Global_96645;
}
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x23E97
{
	eCharacter i;
	Hash entityModel;
