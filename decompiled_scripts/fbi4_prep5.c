...
void main() // Position - 0x0
{
	...
	sLocal_193 = "FBIPRE";
	uLocal_202 = { 0f, 0f, 0f };
	uLocal_205 = { 20.8336f, -1113.7928f, 28.797f };
	sLocal_209 = "FBIPRAU";
	iLocal_380 = -1;
...
void func_1() // Position - 0x1C9
{
	switch (iLocal_85)
	{
		case 0:
			...
			if (!unk_0x2AC37494BBF1DB16(sLocal_192))
			{
				if (unk_0x4310A0DB886F9FED(sLocal_192, "PRE_FKICKOFF"))
				{
					while (unk_0xA5E11AF0A2B928C1() - iLocal_380 < 2000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_23() // Position - 0x1296
{
	switch (iLocal_85)
	{
		...
		case 1:
			if (!func_87(28))
			{
				uLocal_379 = unk_0xA5E11AF0A2B928C1();
				func_86(true, 824);
				iLocal_85 = 2;
			}
			break;
		...
		case 2:
			if (func_85("PRE_LEAVE", 0, 0))
				unk_0x4A77CD96EFFC63F4("PRE_LEAVE");
		
			if (unk_0xA5E11AF0A2B928C1() - uLocal_379 > 2000)
			{
				func_22(&uLocal_200);
			
				if (func_45(&uLocal_86, &uLocal_375, &uLocal_210))
					func_40();
			}
			break;
	
		case 3:
			func_38(unk_0xC1A5EC5C986B98AD(), 16.0317f, -1118.4553f, 27.8667f, 170.4274f);
			func_24(1, 1, 1);
			iLocal_85 = 2;
			break;
	}
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x15FD
{
	BOOL flag;
...
BOOL func_33(int iParam0) // Position - 0x1695
{
...
int func_35(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x16E2
{
	int num;
...
void func_38(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x175F
{
	if (func_253(uParam0))
		unk_0x909F139DC199D8E0(uParam0);

	func_39(uParam0, fParam1, fParam4, false, 1);
	return;
}

BOOL func_39(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x1785
{
	BOOL flag;
	float num;
...
void func_41(BOOL bParam0, BOOL bParam1) // Position - 0x1800
{
	int num;
	int num2;
	int num3;
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_78805.f_1 == 1 && func_42(Global_78805))
		{
		}
		else
		{
...
BOOL func_42(int iParam0) // Position - 0x18D0
{
	switch (iParam0)
	{
		case 71:
...
BOOL func_45(var uParam0, char* sParam1, var uParam2) // Position - 0x1975
{
	switch (*uParam0)
	{
		case 0:
			if (func_83())
			{
				if (func_82(74) || func_82(75) && func_81())
				{
					...
					else
					{
						...
						if (func_62(uParam2, func_77(), _GET_CURRENT_PLAYER_CHARACTER(), "FBIPRAU", func_76(), 9, 1, 0, 0, false))
						{
							*sParam1 = { func_61(true) };
							func_79(46, true);
							*uParam0 = 1;
						}
					}
...
BOOL func_47(int iParam0) // Position - 0x1B27
{
	if (iParam0 == 1)
...
void func_52() // Position - 0x1BFB
{
	...
	func_53(func_56(), 0, _GET_CURRENT_PLAYER_CHARACTER(), func_77(), 9, 6000, 6000, -1, 0, -1, 0);
	return;
}

int func_53(int iParam0, int iParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1C52
{
	int num;
	int num2;
...
void func_54(eCharacter echParam0) // Position - 0x1DA3
{
	int i;
	int num;
	int j;
...
BOOL func_58(int iParam0, int iParam1) // Position - 0x1FFD
{
	return false;
}

int func_59(eCharacter echParam0) // Position - 0x2056
{
	...
	return Global_98159[func_60(echParam0)];
}

int func_60(eCharacter echParam0) // Position - 0x2087
{
...
BOOL func_62(var uParam0, eCharacter echParam1, eCharacter echParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x2128
{
...
BOOL func_63(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2190
{
	Global_21726 = 0;
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x2508
{
	return IS_BIT_SET(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x2520
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2688
{
	if (func_13(14))
	{
...
void func_75(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27B9
{
...
eCharacter func_77() // Position - 0x2914
{
	eCharacter num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x294D
{
...
void func_79(int iParam0, BOOL bParam1) // Position - 0x29E8
{
...
{
	if (bParam0)
		func_53(1527885205, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 0, -1, 0);
	else if (!func_82(3))
		func_53(-224691627, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 50, -1, 0);
	else
		func_53(-224691627, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 0, -1, 0);

	return;
}

BOOL func_81() // Position - 0x2A9E
{
...
BOOL func_82(int iParam0) // Position - 0x2AC9
{
...
BOOL func_84(int iParam0) // Position - 0x2B3D
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
BOOL func_85(char* sParam0, int iParam1, int iParam2) // Position - 0x2B6A
{
...
BOOL func_88(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2C32
{
	if (iParam0 == -1)
		return false;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x2C93
{
	var unk;
	int num;
...
int func_90(int iParam0) // Position - 0x2CD0
{
	int num;
	int num2;
...
eMPStat func_91(int iParam0) // Position - 0x2D04
{
	switch (iParam0)
	{
		case 0:
...
void func_93(char* sParam0, var uParam1) // Position - 0x30A8
{
	if (!*uParam1)
	{
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x30C5
{
	iParam2 = iParam2;
...
BOOL func_95(int iParam0, BOOL bParam1) // Position - 0x30DE
{
	func_98();
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_96(1, uLocal_202, 0))
			{
				return true;
			}
			break;
		...
		case 1:
			if (bParam1)
			{
				func_38(unk_0xC1A5EC5C986B98AD(), uLocal_205, 354.7487f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
BOOL func_96(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3189
{
	switch (iParam0)
	{
		case 0:
			if (func_97(uParam1, uLocal_202, 1056964608, false) && iParam4 == 0f)
				return true;
			break;
	
		case 1:
			unk_0xA3C681843B51A4CC(sLocal_193, 0);
			unk_0xA3C681843B51A4CC(sLocal_209, 6);
...
BOOL func_97(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, int iParam6, BOOL bParam7) // Position - 0x31F1
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
void func_100() // Position - 0x32D0
{
	...
	switch (iLocal_85)
	{
		case 0:
			if (func_95(iLocal_84, bLocal_28))
			{
				func_108(&uLocal_200, uLocal_205, 1, true, "PRE_BLIP");
			
				if (unk_0xCE4AAA035282336C(uLocal_200))
				{
					unk_0x1886753DA39F38F8(uLocal_200, 2);
					unk_0xE10463386FE47156(uLocal_200, 2);
				}
		...
		case 1:
			...
			if (func_105(unk_0xC1A5EC5C986B98AD(), uLocal_205, 2f, 1) && func_104(28))
			{
				if (!bLocal_199)
				{
					unk_0xE90EAC9EC6471EB9(unk_0x93E99A2DBCBA9CFA());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(unk_0xC1A5EC5C986B98AD(), uLocal_205, 75f, 1))
					{
						if (!bLocal_198)
						{
							func_22(&uLocal_200);
						...
						func_108(&uLocal_200, uLocal_205, 1, true, "PRE_SHOP");
					}
					else if (func_105(unk_0xC1A5EC5C986B98AD(), uLocal_205, 12f, 1))
					{
						if (bLocal_198)
						{
							func_22(&uLocal_200);
...
BOOL func_104(int iParam0) // Position - 0x37F0
{
	return func_88(iParam0, 6, true);
}

BOOL func_105(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x3800
{
...
void func_108(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, char* sParam6) // Position - 0x388A
{
	if (!unk_0xCE4AAA035282336C(*uParam0))
	{
		*uParam0 = func_109(uParam1, 5, iParam4);
...
int func_109(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x38B9
{
	int num;
		...
		case 0:
			if (func_95(iLocal_84, false))
			{
				if (_IS_MISSION_REPLAY_IN_PROGRESS())
				{
					...
					func_116(&unk5, unk2, num, 0, 0, 0, 0, 0, joaat("asterope"), 0, _CHAR_NULL, 1);
					func_113(0, -1, 1);
					unk = unk_0xA5E11AF0A2B928C1();
				
					while (!func_112(28) && unk_0xA5E11AF0A2B928C1() - unk < 2000)
					{
						SYSTEM::WAIT(0);
					}
				...
				else
				{
					if (_IS_MISSION_REPEAT_ACTIVE(false))
					{
						func_38(unk_0xC1A5EC5C986B98AD(), 16.5342f, -1122.5829f, 27.8635f, 354.7487f);
...
void func_111(var uParam0) // Position - 0x3A19
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_115() // Position - 0x3B4E
{
	return IS_BIT_SET(Global_100681.f_20, 13);
}

void func_116(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x3B5F
{
	int num;

	num = 1;

	if (!_IS_MISSION_REPLAY_IN_PROGRESS() || !func_236())
		num = 0;
	...
	if (num == 1)
	{
		...
		*uParam0 = func_205(uParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_204(uParam1, 0f, 0f, 0f, false))
		{
		...
		func_195(uParam1, 5f, 0);
	
		if (func_14(echParam12))
		{
			func_193(echParam12, 0);
		
			while (!func_117(uParam0, echParam12, uParam1, fParam4, true, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
BOOL func_117(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3CF3
{
	var unk;
	var unk2;
	int num;
	...
	if (func_14(echParam1))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_192(echParam1, &num, iParam7);
		...
		if (Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == num)
		{
			...
			if (unk_0x0CBB7C273DED26E7(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = unk_0xABEEDBEF2BBDF5B3(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_184(uParam0, &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == num)
		{
			...
			if (unk_0x0CBB7C273DED26E7(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = unk_0xABEEDBEF2BBDF5B3(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_184(uParam0, &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				unk_0x6251E3530642F38E(*uParam0, num.f_96);
		...
		else
		{
			...
			if (unk_0x0CBB7C273DED26E7(num))
			{
				...
				*uParam0 = unk_0xABEEDBEF2BBDF5B3(num, uParam2, fParam5, 1, 1, 0);
				...
				func_184(uParam0, &(num.f_31), &(num.f_81));
				unk_0x6251E3530642F38E(*uParam0, num.f_96);
...
void func_118(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x4B15
{
	var unk;
	var unk2;
	int num;
	...
	if (func_14(echParam0) && unk_0x7DE17ACDD8BA2642(*uParam1) && unk_0xFBD273FDBCF0C5BD(*uParam1, 0))
	{
		...
		if (unk_0x5764B6FBEED065BB(*uParam1) >= 0 && func_123(*uParam1, false, &unk))
		{
			func_122(uParam1, &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_113648.f_20120[echParam0 /*43*/].f_31 = func_121(*uParam1);
				...
				func_119(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num2, true, &(Global_113648.f_20120[echParam0 /*43*/].f_1));
				...
				func_119(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num2, false, &(Global_113648.f_20120[echParam0 /*43*/].f_2));
			}
		}
	}
...
float func_121(var uParam0) // Position - 0x6C8E
{
	int num;
	int num2;
	int num3;
...
int func_122(var uParam0, var uParam1, var uParam2) // Position - 0x6D3E
{
	int i;
	int num;
...
BOOL func_123(var uParam0, BOOL bParam1, var uParam2) // Position - 0x6F31
{
	int num;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_155(num, bParam1, uParam2) && !func_154(unk_0x93E99A2DBCBA9CFA()) && !func_135(uParam0))
		return false;
	...
	if (func_132(unk_0x93E99A2DBCBA9CFA()) && unk_0x2D92D1084D213DC4(num) || unk_0xAF4434A9F7368F35(num))
		flag = true;

	if (unk_0xCC4A4E244DA78599(uParam0) && !func_129(uParam0) && !flag && !(func_128(unk_0x504B9BB48D41C264(uParam0)) && func_125(unk_0x93E99A2DBCBA9CFA())))
	{
	...
	if (!unk_0xA26A9A07F761D8F8())
	{
		if (func_124(uParam0) && unk_0x504B9BB48D41C264(uParam0) != joaat("sentinel2") && unk_0x504B9BB48D41C264(uParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
BOOL func_124(var uParam0) // Position - 0x709F
{
	int i;
...
BOOL func_125(Player plParam0) // Position - 0x70DA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_126(Global_2657589[plParam0 /*466*/].f_321.f_7) == 11;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x75D5
{
	int num;
...
BOOL func_128(int iParam0) // Position - 0x7635
{
...
BOOL func_129(var uParam0) // Position - 0x7677
{
	switch (unk_0x504B9BB48D41C264(uParam0))
	{
...
BOOL func_130(Player plParam0) // Position - 0x773F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_126(Global_2657589[plParam0 /*466*/].f_321.f_7) == 26;

	return false;
}

BOOL func_131(Player plParam0) // Position - 0x7786
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_126(Global_2657589[plParam0 /*466*/].f_321.f_7) == 13;

	return false;
}

BOOL func_132(Player plParam0) // Position - 0x77CD
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_126(Global_2657589[plParam0 /*466*/].f_321.f_7) == 7;

	return false;
}

BOOL func_133(int iParam0) // Position - 0x7813
{
	if (iParam0 == joaat("oppressor2"))
		return false;

	if (!func_134(unk_0x93E99A2DBCBA9CFA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger"))
		return false;

	return true;
}

BOOL func_134(Player plParam0) // Position - 0x7854
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_135(var uParam0) // Position - 0x787A
{
	if (func_153(unk_0x93E99A2DBCBA9CFA()) || func_152(unk_0x93E99A2DBCBA9CFA()))
		if (func_136(uParam0))
			return true;
...
BOOL func_136(var uParam0) // Position - 0x78A9
{
	...
	if (func_139(unk_0x93E99A2DBCBA9CFA()) && !func_133(unk_0x504B9BB48D41C264(uParam0)) || unk_0x091E6E360116B927(uParam0, joaat("thruster")))
		return false;
...
BOOL func_137(var uParam0) // Position - 0x795A
{
	int num;
	...
	if (unk_0x7DE17ACDD8BA2642(uParam0) && unk_0xFBD273FDBCF0C5BD(uParam0, 0))
	{
		...
		if (unk_0xCC4A4E244DA78599(uParam0) && !func_129(uParam0) || func_138(num))
			return true;
...
BOOL func_138(int iParam0) // Position - 0x79D1
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_139(Player plParam0) // Position - 0x7A21
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_154(plParam0) && Global_2657589[plParam0 /*466*/].f_321.f_10 == plParam0)
		return true;

	return false;
}

BOOL func_140(var uParam0, BOOL bParam1) // Position - 0x7A5A
{
	switch (unk_0x504B9BB48D41C264(uParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_142(unk_0x504B9BB48D41C264(uParam0), 0))
				if (Global_2793044.f_304 == uParam0)
					return true;
				else if (func_141(uParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_141(var uParam0) // Position - 0x7AB5
{
	int i;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x7AEE
{
	if (iParam1 == 0)
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x7FF5
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_152(Player plParam0) // Position - 0x83D8
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[plParam0 /*466*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_126(Global_2657589[plParam0 /*466*/].f_321.f_7) == 5;

	return false;
}

BOOL func_153(Player plParam0) // Position - 0x8437
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[plParam0 /*466*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_126(Global_2657589[plParam0 /*466*/].f_321.f_7) == 8;

	return false;
}

BOOL func_154(Player plParam0) // Position - 0x8497
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0 /*466*/].f_321.f_7 != -1)
				return func_126(Global_2657589[plParam0 /*466*/].f_321.f_7) == 9;

	return false;
}

BOOL func_155(int iParam0, BOOL bParam1, var uParam2) // Position - 0x84DE
{
	BOOL flag;
	...
	if (func_132(unk_0x93E99A2DBCBA9CFA()) && unk_0x2D92D1084D213DC4(iParam0) || unk_0xAF4434A9F7368F35(iParam0))
		flag = true;
...
BOOL func_156(int iParam0) // Position - 0x892A
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_157(var uParam0, eCharacter echParam1) // Position - 0x8953
{
	var unk;
	int i;
	int j;
	...
	func_158(uParam0, &(Global_113648.f_32751.f_5510));
	return;
}

void func_158(var uParam0, var uParam1) // Position - 0x8B55
{
	int i;
	...
	if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
	{
		...
		*uParam1 = unk_0x46177D0BA2953EC5(uParam0);
		...
		func_122(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
	
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x175FDAC9EB940479(uParam0, i + 1))
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(i + 1));
		}
...
BOOL func_160(int iParam0) // Position - 0x8EB0
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_162(var uParam0) // Position - 0x8F80
{
	if (!unk_0x7DE17ACDD8BA2642(uParam0) || !unk_0xFBD273FDBCF0C5BD(uParam0, 0) || func_179(uParam0, 0, false) || func_179(uParam0, 1, false) || func_179(uParam0, 2, false) || func_178(uParam0) != _CHAR_NULL || func_177(uParam0) || func_176(uParam0) || func_124(uParam0) || func_175(uParam0) || !func_163(unk_0x504B9BB48D41C264(uParam0)))
	{
		func_176(uParam0);
		func_176(uParam0);
		func_179(uParam0, 0, false);
		func_179(uParam0, 1, false);
		func_179(uParam0, 2, false);
		func_178(uParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_163(int iParam0) // Position - 0x905D
{
	if (iParam0 == 0)
		return false;

	if (!func_164(iParam0, false, -1))
		return false;
...
BOOL func_164(int iParam0, BOOL bParam1, int iParam2) // Position - 0x920F
{
	int i;
	var unk;
	...
	if (iParam0 == joaat("blimp"))
		if (!func_173() && !func_172() && !func_171() && !func_170() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED())
			return false;

	if (iParam0 == joaat("hotknife") || iParam0 == joaat("carbonrs") || iParam0 == joaat("khamelion"))
	{
		if (func_169() || unk_0xCC17806DB0C41C19() || func_168())
		{
		}
		else if (!func_171())
		{
...
BOOL func_165(int iParam0) // Position - 0x9391
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x945D
{
	if (unk_0xCC17806DB0C41C19())
...
BOOL func_167(int iParam0, int iParam1) // Position - 0x9474
{
	BOOL num;
	var unk;
...
BOOL func_170() // Position - 0xCAD1
{
	return false;
}

BOOL func_171() // Position - 0xCADA
{
	return true;
}

BOOL func_172() // Position - 0xCAE3
{
	return true;
}

BOOL func_173() // Position - 0xCAEC
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xCB05
{
	var unk;
...
BOOL func_175(var uParam0) // Position - 0xCBBD
{
	int num;
	var unk;
	...
	if (!func_164(num, false, -1))
		return true;

	return false;
}

BOOL func_176(var uParam0) // Position - 0xCC04
{
	int i;
...
BOOL func_177(var uParam0) // Position - 0xCC80
{
	int i;
...
eCharacter func_178(var uParam0) // Position - 0xCD68
{
	int i;
...
BOOL func_179(var uParam0, int iParam1, BOOL bParam2) // Position - 0xCDCB
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_180(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_180(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xCE39
{
...
void func_181(var uParam0, eCharacter echParam1) // Position - 0xCF11
{
	int i;
...
void func_182(var uParam0) // Position - 0xCF93
{
	if (!func_183(*uParam0))
...
BOOL func_183(var uParam0) // Position - 0xCFBE
{
	return unk_0x175FDAC9EB940479(uParam0, 5);
}

int func_184(var uParam0, var uParam1, var uParam2) // Position - 0xCFCD
{
	int i;
	int num;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (unk_0xCA36A30E79A35222(*uParam0, num) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_189(*uParam0, num, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_151(unk_0x504B9BB48D41C264(*uParam0), 1) && unk_0xCA36A30E79A35222(*uParam0, 24) != func_187(*uParam0, uParam1->[38] - 1))
		unk_0x886F6B56E2966139(*uParam0, 24, func_187(*uParam0, uParam1->[38] - 1), 0);
...
BOOL func_185(var uParam0) // Position - 0xD1A7
{
	int i;
	int num;
	int num2;
...
int func_187(var uParam0, int iParam1) // Position - 0xD2DA
{
	int value;
	int value2;
	float num;
...
int func_188(var uParam0, int iParam1) // Position - 0xD3C3
{
	int i;
	...
	for (i = unk_0xF66CFEE3C6DDCF4D(uParam0, iParam1) - 1; i >= 0 && func_189(uParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_189(var uParam0, int iParam1, int iParam2) // Position - 0xD425
{
	if (!func_190() && unk_0x96AF6537AE293DDE(uParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_190() // Position - 0xD449
{
	return false;
}

BOOL func_191(var uParam0, var uParam1) // Position - 0xD452
{
	if (unk_0xA26A9A07F761D8F8())
	{
	}
...
void func_192(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xD493
{
	int num;
...
void func_193(eCharacter echParam0, int iParam1) // Position - 0xD6EF
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (unk_0x7DE17ACDD8BA2642(Global_98012[i]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x504B9BB48D41C264(Global_98012[i]) == func_194(echParam0, iParam1))
				{
...
int func_194(eCharacter echParam0, int iParam1) // Position - 0xD78D
{
	int num;
	...
	if (func_14(echParam0))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_192(echParam0, &num, iParam1);
		return num;
	}
	else
	{
...
void func_195(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xD7CF
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_203(&Global_77348.f_555[0 /*21*/], i))
...
void func_197(int iParam0, BOOL bParam1) // Position - 0xD98E
{
	...
	if (bParam1)
	{
		...
		{
			func_198(iParam0, 1, false);
			func_198(iParam0, 2, false);
			func_198(iParam0, 3, false);
			func_198(iParam0, 4, false);
			func_198(iParam0, 0, true);
			Global_77348[iParam0] = 1;
		}
	}
	else
	{
		func_198(iParam0, 0, false);
	}
...
BOOL func_200(int iParam0, int iParam1) // Position - 0xDAF2
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_201(&Global_113648.f_32751.f_5038[num /*157*/]))
		return false;

	return func_164(Global_113648.f_32751.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}
...
BOOL func_202(int iParam0, int iParam1) // Position - 0xDB70
{
	if (iParam0 == -1)
		return false;
...
BOOL func_203(var uParam0, int iParam1) // Position - 0xDB90
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	switch (iParam1)
	{
		case 0:
			*uParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			uParam0->f_4 = func_194(CHAR_MICHAEL, 1);
			uParam0->f_12 = 0;
		...
		case 2:
			*uParam0 = { -22.6297f, -1439.1368f, 29.6549f };
			...
			uParam0->f_4 = func_194(CHAR_FRANKLIN, 1);
			uParam0->f_12 = 1;
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 20);
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 7);
			num = 1;
		...
		case 3:
			*uParam0 = { -22.5229f, -1434.6986f, 29.6552f };
			...
			uParam0->f_4 = func_194(CHAR_FRANKLIN, 2);
			uParam0->f_12 = 1;
		...
		case 6:
			*uParam0 = { 1981.4163f, 3808.1313f, 31.1384f };
			...
			uParam0->f_4 = func_194(CHAR_TREVOR, 1);
			uParam0->f_12 = 2;
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 20);
			unk_0xECDAB41968FF21A8(&(uParam0->f_9), 7);
			num = 1;
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_204(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_204(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_204(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
BOOL func_204(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xF27E
{
	if (bParam6)
...
var func_205(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF2C5
{
	return func_206(&(Global_107196.f_2890), uParam0, fParam3, false);
}

var func_206(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF2DF
{
	var unk;
	Vector3 vector;
	BOOL flag;
	...
	if (func_229(uParam0))
	{
		...
		if (func_228(uParam0))
		{
			...
			if (unk_0x7DE17ACDD8BA2642(unk))
			{
				...
				func_210(unk, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_181(unk, uParam0->f_11);
				}
				else if (!func_208(unk, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && unk_0x4310A0DB886F9FED(unk_0x688846D56810779A(), "startup_positioning"))
				{
					num = func_207(unk);
...
int func_207(var uParam0) // Position - 0xF591
{
	int i;
	var unk;
	var unk2;
...
BOOL func_208(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xF654
{
	int num;
	var unk;
	int num2;
	...
	{
		case joaat("cargobob"):
			if (func_209(uParam0, Global_77348.f_139[38], false))
			{
				func_196(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_209(uParam0, Global_77348.f_139[43], true))
			{
				func_196(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_209(uParam0, unk[i], true) && func_97(unk_0x30BE8A934C020461(unk[i], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_204(uParam1, 0f, 0f, 0f, false) || unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(uParam0, 1), unk_0x30BE8A934C020461(unk[i], 1), 1) < 10f)
					{
...
BOOL func_209(var uParam0, var uParam1, BOOL bParam2) // Position - 0xF85C
{
	var unk;
	var unk2;
	var unk3;
...
void func_210(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF8BD
{
	int num;
	int num2;
	int i;
	...
	if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(num + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(num2 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			for (i = 1; i <= 9; i = i + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(i));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			for (j = 1; j <= 6; j = j + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(j));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			for (k = 1; k <= 11; k = k + 1)
			{
				if (k != 9 && k != 10)
				{
					...
					{
						unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(k));
					}
				}
			}
		}
		else if (uParam1->f_66 == -1035489563)
		{
			for (l = 1; l <= 2; l = l + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(l));
				}
			}
		}
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(4));
			}
		}
		...
		{
			unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			for (m = 1; m <= 2; m = m + 1)
			{
				...
				{
					unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_159(m));
				}
			}
		}
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_218(uParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_217())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
			func_184(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		...
		if (func_211() && unk_0xAF4434A9F7368F35(uParam1->f_66) && unk_0xDA1D0C30C85358D4(uParam0) && !unk_0x091E6E360116B927(uParam0, joaat("avenger")))
...
BOOL func_212(int iParam0) // Position - 0x10034
{
	int num;
...
BOOL func_213(int iParam0) // Position - 0x10058
{
	int num;
...
BOOL func_215(var uParam0, int iParam1) // Position - 0x1008A
{
	int num;
	int num2;
	int num3;
...
void func_216(var uParam0, var uParam1) // Position - 0x100AD
{
	int num;
	int num2;
...
BOOL func_218(var uParam0) // Position - 0x10136
{
	int num;
...
int func_219(var uParam0) // Position - 0x1017E
{
	if (!func_190() && func_220(uParam0))
		return 1;

	return 0;
}

BOOL func_220(int iParam0) // Position - 0x1019E
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_221(var uParam0) // Position - 0x101F1
{
	...
	if (func_223(unk_0x93E99A2DBCBA9CFA()) == 3)
		if (unk_0x7DE17ACDD8BA2642(uParam0) && unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
int func_222(var uParam0) // Position - 0x10278
{
...
BOOL func_225(int iParam0, BOOL bParam1) // Position - 0x102E7
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x10345
{
	var unk;
...
BOOL func_228(var uParam0) // Position - 0x10392
{
	if (func_229(uParam0))
	{
...
BOOL func_229(var uParam0) // Position - 0x103C7
{
	if (uParam0->f_12.f_66 == 0)
		return 0;

	if (!func_164(uParam0->f_12.f_66, false, -1))
		return 0;

	if (uParam0->f_12.f_66 == joaat("stunt") && func_97(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false))
		return 0;
...
BOOL func_233(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1046B
{
...
BOOL func_234() // Position - 0x104F9
{
	float num;
...
BOOL func_235(int iParam0) // Position - 0x1056E
{
	switch (iParam0)
	{
		case joaat("police"):
...
BOOL func_237(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x105DA
{
	return func_238(Global_107196.f_2890.f_12.f_66, fParam0, iParam3);
}

BOOL func_238(int iParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x105F7
{
	var unk;
	float num;
	...
	if (!bLocal_28 && iLocal_84 != 3)
	{
		if (iLocal_84 > 0)
		{
			if (!bLocal_196)
			{
				...
				{
					iLocal_380 = unk_0xA5E11AF0A2B928C1();
					func_247(4);
					return;
				}
			}
			...
			if (!bLocal_196)
			{
				if (!func_105(unk_0xC1A5EC5C986B98AD(), uLocal_205, 150f, 1))
				{
					func_247(2);
				}
				else if (!func_105(unk_0xC1A5EC5C986B98AD(), uLocal_205, 75f, 1))
				{
					if (!bLocal_208)
					{
						unk_0x8581263F2F024518();
...
void func_241(char* sParam0, var uParam1) // Position - 0x10731
{
	if (!*uParam1)
	{
		_SHOW_SUBTITLE_CLEAR_EXISTING(sParam0, 7500, 0);
...
BOOL func_242() // Position - 0x1074E
{
	int num;
	...
	if (!func_243(bLocal_196, num) && !bLocal_196)
		return false;

	return true;
}

BOOL func_243(BOOL bParam0, int iParam1) // Position - 0x1078B
{
	int num;
...
BOOL func_248() // Position - 0x1086C
{
	func_249();
		...
		switch (_GET_CURRENT_PLAYER_CHARACTER())
		{
			case CHAR_MICHAEL:
				if (Global_113648.f_2365.f_539.f_2403[0] == -99)
					func_250(uLocal_80[0], uLocal_80[1], uLocal_80[2]);
				else if (Global_113648.f_2365.f_539.f_2403[1] == -99)
					func_250(uLocal_80[1], uLocal_80[0], uLocal_80[2]);
				else if (Global_113648.f_2365.f_539.f_2403[2] == -99)
					func_250(uLocal_80[2], uLocal_80[1], uLocal_80[0]);
				break;
...
void func_250(var uParam0, var uParam1, var uParam2) // Position - 0x10A6A
{
	if (func_85(uParam1, 0, 0) || func_85(uParam2, 0, 0))
		unk_0x8581263F2F024518();

	if (!func_85(uParam0, 0, 0))
...
int func_252() // Position - 0x10ABB
{
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (Global_113648.f_2365.f_539.f_2403[i] != -99)
			num = num + 1;
	}
...
BOOL func_253(var uParam0) // Position - 0x10AF7
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void func_254() // Position - 0x10B17
{
	...
	if (func_245(num) < 315)
		func_255(_GET_CURRENT_PLAYER_CHARACTER(), 96, 315, false, false);

	return;
}

void func_255(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x10B67
{
	int num;
	int num2;
...
void func_259(int iParam0) // Position - 0x11514
{
	BOOL flag;
	var unk;
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_261() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x061B1200C95204CB(&(Global_113648.f_20566.f_471), iParam0);
		unk_0x061B1200C95204CB(&(Global_2359296[func_261() /*5568*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x11693
{
	switch (iParam0)
	{
		case 0:
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x117A2
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x117D2
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
BOOL func_265(int iParam0) // Position - 0x11810
{
	int num;
	int num2;
	int num3;
	...
	return IS_BIT_SET(Global_2359296[func_261() /*5568*/].f_681.f_10, iParam0);
}
...
BOOL func_270(var uParam0, int iParam1) // Position - 0x11B41
{
	int i;
	var unk;
...
void func_275(var uParam0, int iParam1) // Position - 0x11CC2
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_280(int iParam0) // Position - 0x11D38
{
	switch (iParam0)
	{
		case 60:
...
int func_285(eCharacter echParam0) // Position - 0x11ECE
{
...
void func_286(int iParam0) // Position - 0x11EDF
{
	...
	{
		func_287(iParam0, 10, true);
		func_287(iParam0, 19, true);
	}
...
void func_287(int iParam0, int iParam1, BOOL bParam2) // Position - 0x11F06
{
	...
	else if (unk_0xA26A9A07F761D8F8())
	{
		if (func_92() == 0)
		{
			num = _MPCHAR_STAT_GET_INT(func_91(iParam0), -1, 0);
			unk_0xECDAB41968FF21A8(&num, iParam1);
			_MPCHAR_STAT_SET_INT(func_91(iParam0), num, -1, 1, false);
		}
	}
	else
	{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x11F78
{
...
{
	if (!func_82(36))
		func_290(21, false, false);

	return;
}

void func_290(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x11FBA
{
	if (bParam1)
	{
		if (!func_88(iParam0, 0, false))
		{
			if (bParam2 && Global_100733.f_18[iParam0])
			{
				...
				{
					func_286(iParam0);
					func_287(iParam0, 0, false);
					func_292(iParam0, 1, false);
					func_291(iParam0);
				}
				else
				{
					func_287(iParam0, 1, false);
					func_291(iParam0);
				}
			}
			else
	...
	else if (func_88(iParam0, 0, false))
	{
...
void func_294(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x1242E
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x124C3
{
...
BOOL func_298(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1260C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_301(int iParam0) // Position - 0x135F1
{
	...
	func_302(&Global_78341[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_302(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1486A
{
	int num;
	eMPStat stat;
	...
	*iParam0 = iParam9;
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_298(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			unk_0xECDAB41968FF21A8(&(iParam0->f_6), 1);
	
		if (func_298(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			unk_0xECDAB41968FF21A8(&(iParam0->f_6), 2);
	
		if (!func_298(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			unk_0xECDAB41968FF21A8(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = _MPCHAR_STAT_GET_INT(func_305(iParam1, iParam0->f_2), Global_78338, 0);
			...
			if (func_303(iParam1, iParam0->f_2, &stat))
			{
...
eMPStat func_304(int iParam0, int iParam1) // Position - 0x15014
{
	switch (iParam1)
	{
		case 0:
...
eMPStat func_305(int iParam0, int iParam1) // Position - 0x1540F
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_306(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1580A
{
	int num;
	int num2;
	eMPStat stat;
...
void func_309(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1812E
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_302(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_302(&Global_78341[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_302(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x7FEA86016BC12607(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_302(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x7FEA86016BC12607(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
		...
		if (num7 >= 0)
		{
			num8 = unk_0xDAEB80C06A5C96B9(unk, 10, -1, 0, -1, func_310(iParam0));
...
void func_367(var uParam0, int iParam1) // Position - 0x296FB
{
	...
	{
		func_371(&uLocal_87, uParam0->[i /*3*/]);
	}
...
BOOL func_369(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x2984C
{
	BOOL flag;
	int num;
	int num2;
...
void func_371(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x299A8
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
{
	uLocal_80[0] = "PRE_BUYM";
	uLocal_80[1] = "PRE_BUYF";
	uLocal_80[2] = "PRE_BUYT";
	return;
}
...
void func_376(BOOL bParam0) // Position - 0x29A49
{
	...
	if (unk_0xF57C1326FD40C8A7(uLocal_201))
	{
		unk_0x9E2404A25985615A(0, 0, 3000, 1, 0, 0);
		unk_0x42B9FA814615C4F9(uLocal_201, 0);
	}
...
BOOL func_390() // Position - 0x29C87
{
	if (Global_100681 == 13 || Global_100681 == 10 || Global_100681 == 11 || Global_100681 == 12)
		return false;
