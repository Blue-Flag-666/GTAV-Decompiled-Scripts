...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0x15FD
{
	BOOL flag;
...
BOOL func_33(Player plParam0) // Position - 0x1695
{
...
int func_35(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x16E2
{
	int num;
...
void func_38(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x175F
{
	if (func_253(pedParam0))
		TASK::CLEAR_PED_TASKS(pedParam0);

	func_39(pedParam0, fParam1, fParam4, false, true);
	return;
}

BOOL func_39(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1785
{
...
BOOL func_58(Ped pedParam0, int iParam1) // Position - 0x1FFD
{
	return false;
}

Ped func_59(eCharacter echParam0) // Position - 0x2056
{
...
BOOL func_66(Player plParam0) // Position - 0x24F8
{
	return func_67(plParam0, 20);
}

BOOL func_67(Player plParam0, int iParam1) // Position - 0x2508
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x294D
{
...
BOOL func_85(const char* sParam0, int iParam1, const char* sParam2) // Position - 0x2B6A
{
...
BOOL func_95(int iParam0, BOOL bParam1) // Position - 0x30DE
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_38(PLAYER::PLAYER_PED_ID(), uLocal_205, 354.7487f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_100() // Position - 0x32D0
{
	...
	switch (iLocal_85)
	{
		case 0:
			if (func_95(iLocal_84, bLocal_28))
			{
				func_108(&blLocal_200, uLocal_205, true, true, "PRE_BLIP");
			
				if (HUD::DOES_BLIP_EXIST(blLocal_200))
				{
					HUD::SET_BLIP_COLOUR(blLocal_200, 2);
					HUD::SET_BLIP_ROUTE_COLOUR(blLocal_200, 2);
				}
		...
		case 1:
			...
			if (func_105(PLAYER::PLAYER_PED_ID(), uLocal_205, 2f, true) && func_104(28))
			{
				if (!bLocal_199)
				{
					PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(PLAYER::PLAYER_PED_ID(), uLocal_205, 75f, true))
					{
						if (!bLocal_198)
						{
							func_22(&blLocal_200);
						...
						func_108(&blLocal_200, uLocal_205, true, true, "PRE_SHOP");
					}
					else if (func_105(PLAYER::PLAYER_PED_ID(), uLocal_205, 12f, true))
					{
						if (bLocal_198)
						{
							func_22(&blLocal_200);
...
BOOL func_105(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x3800
{
...
void func_108(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, char* sParam6) // Position - 0x388A
{
	if (!HUD::DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_109(uParam1, 5, bParam4);
...
Blip func_109(var uParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x38B9
{
		...
		case 0:
			if (func_95(iLocal_84, false))
			{
				if (_IS_MISSION_REPLAY_IN_PROGRESS())
				{
					...
					func_116(&unk4, unk, num, 0, 0, 0, 0, 0, joaat("asterope"), 0, _CHAR_NULL, 1);
					func_113(0, -1, 1);
					gameTimer = MISC::GET_GAME_TIMER();
				
					while (!func_112(28) && MISC::GET_GAME_TIMER() - gameTimer < 2000)
					{
						SYSTEM::WAIT(0);
					}
...
void func_111(Vehicle* pveParam0) // Position - 0x3A19
{
...
void func_113(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x3A61
{
...
void func_116(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x3B5F
{
	int num;
	...
	if (num == 1)
	{
		...
		*uParam0 = func_205(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_204(vParam1, 0f, 0f, 0f, false))
		{
		...
		func_195(vParam1, 5f, false);
	
		if (func_14(echParam12))
		{
			func_193(echParam12, 0);
		
			while (!func_117(uParam0, echParam12, vParam1, fParam4, true, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
BOOL func_117(var uParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3CF3
{
	int plateIndex;
	var plateText;
	Hash model;
	...
	if (func_14(echParam1))
	{
		...
		model.f_31 = 49;
		model.f_81 = 2;
		func_192(echParam1, &model, iParam7);
		...
		if (Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[0 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				if (func_191(&plateText, &plateIndex))
				{
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(model))
			{
				...
				*uParam0 = VEHICLE::CREATE_VEHICLE(model, vParam2, fParam5, true, true, false);
				...
				func_184(uParam0, &(model.f_31), &(model.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
	...
	if (func_14(echParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_123(*uParam1, false, &unk))
		{
			...
			if (bParam3)
			{
				...
				func_119(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num, true, &(Global_113648.f_20120[echParam0 /*43*/].f_1));
				...
				func_119(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num, false, &(Global_113648.f_20120[echParam0 /*43*/].f_2));
			}
		}
	}
...
float func_121(Vehicle veParam0) // Position - 0x6C8E
{
	int num;
	int num2;
	int num3;
...
BOOL func_123(Vehicle veParam0, BOOL bParam1, var uParam2) // Position - 0x6F31
{
	Hash entityModel;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_155(entityModel, bParam1, uParam2) && !func_154(PLAYER::PLAYER_ID()) && !func_135(veParam0))
		return false;
...
BOOL func_124(Vehicle veParam0) // Position - 0x709F
{
	int i;
...
BOOL func_128(Hash hParam0) // Position - 0x7635
{
...
BOOL func_129(Vehicle veParam0) // Position - 0x7677
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
BOOL func_133(Hash hParam0) // Position - 0x7813
{
	if (hParam0 == joaat("oppressor2"))
		return false;

	if (!func_134(PLAYER::PLAYER_ID()) && hParam0 != joaat("thruster") && hParam0 != joaat("avenger"))
		return false;
...
BOOL func_135(Vehicle veParam0) // Position - 0x787A
{
...
BOOL func_136(Vehicle veParam0) // Position - 0x78A9
{
	...
	if (func_140(veParam0, false))
		return true;

	if (func_139(PLAYER::PLAYER_ID()) && !func_133(ENTITY::GET_ENTITY_MODEL(veParam0)) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("thruster")))
		return false;
...
BOOL func_137(Vehicle veParam0) // Position - 0x795A
{
	Hash entityModel;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_129(veParam0) || func_138(entityModel))
			return true;
...
BOOL func_138(Hash hParam0) // Position - 0x79D1
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_140(Vehicle veParam0, BOOL bParam1) // Position - 0x7A5A
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_142(ENTITY::GET_ENTITY_MODEL(veParam0), 0))
				if (Global_2793044.f_304 == veParam0)
					return true;
				else if (func_141(veParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_141(Vehicle veParam0) // Position - 0x7AB5
{
	int i;
...
BOOL func_142(Hash hParam0, int iParam1) // Position - 0x7AEE
{
	if (iParam1 == 0)
		if (func_151(hParam0, 0))
			return true;
...
BOOL func_151(Hash hParam0, int iParam1) // Position - 0x7FF5
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_155(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x84DE
{
	BOOL flag;
...
BOOL func_156(Hash hParam0) // Position - 0x892A
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_157(Vehicle veParam0, eCharacter echParam1) // Position - 0x8953
{
	...
	func_158(veParam0, &(Global_113648.f_32751.f_5510));
	return;
}

void func_158(Vehicle veParam0, var uParam1) // Position - 0x8B55
{
	int i;
...
BOOL func_162(Vehicle veParam0) // Position - 0x8F80
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_179(veParam0, 0, false) || func_179(veParam0, 1, false) || func_179(veParam0, 2, false) || func_178(veParam0) != _CHAR_NULL || func_177(veParam0) || func_176(veParam0) || func_124(veParam0) || func_175(veParam0) || !func_163(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_176(veParam0);
		func_176(veParam0);
		func_179(veParam0, 0, false);
		func_179(veParam0, 1, false);
		func_179(veParam0, 2, false);
...
BOOL func_163(Hash hParam0) // Position - 0x905D
{
	if (hParam0 == 0)
		return false;

	if (!func_164(hParam0, false, -1))
		return false;
...
BOOL func_164(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x920F
{
	int i;
	Hash outData;
...
BOOL func_165(Hash hParam0) // Position - 0x9391
{
	int num;
	var unk;
	var unk2;
...
BOOL func_167(Hash hParam0, int iParam1) // Position - 0x9474
{
	BOOL num;
	int cloudTimeAsInt;
...
BOOL func_175(Vehicle veParam0) // Position - 0xCBBD
{
	Hash entityModel;
	...
	if (!func_164(entityModel, false, -1))
		return true;

	return false;
}

BOOL func_176(Vehicle veParam0) // Position - 0xCC04
{
	int i;
...
BOOL func_177(Vehicle veParam0) // Position - 0xCC80
{
	int i;
...
eCharacter func_178(Vehicle veParam0) // Position - 0xCD68
{
	int i;
...
BOOL func_179(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0xCDCB
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_180(iParam1, i, &garageName, &num); i = i + 1)
	{
...
void func_181(Vehicle veParam0, eCharacter echParam1) // Position - 0xCF11
{
	int i;
...
BOOL func_183(Vehicle veParam0) // Position - 0xCFBE
{
...
int func_184(var uParam0, var uParam1, var uParam2) // Position - 0xCFCD
{
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, modType) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_189(*uParam0, modType, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_151(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_187(*uParam0, uParam1->[38] - 1))
...
BOOL func_185(Vehicle veParam0) // Position - 0xD1A7
{
	int i;
	int modType;
	Hash hashKey;
...
int func_187(Vehicle veParam0, int iParam1) // Position - 0xD2DA
{
	int value;
	int value2;
	float num;
...
int func_188(Vehicle veParam0, int iParam1) // Position - 0xD3C3
{
	int i;
	...
	for (i = VEHICLE::GET_NUM_VEHICLE_MODS(veParam0, iParam1) - 1; i >= 0 && func_189(veParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_189(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xD425
{
	if (!func_190() && PED::APPLY_PED_BLOOD_SPECIFIC(veParam0, iParam1, iParam2))
		return true;
...
void func_193(eCharacter echParam0, int iParam1) // Position - 0xD6EF
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98012[i]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98012[i]) == func_194(echParam0, iParam1))
				{
...
Hash func_194(eCharacter echParam0, int iParam1) // Position - 0xD78D
{
	int num;
...
void func_195(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xD7CF
{
	int i;
...
Vehicle func_205(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF2C5
{
	return func_206(&(Global_107196.f_2890), uParam0, fParam3, false);
}

Vehicle func_206(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF2DF
{
	Vehicle vehicle;
	...
	if (func_229(uParam0))
	{
		if (func_204(fParam1, 0f, 0f, 0f, false))
		{
			fParam1 = { *uParam0 };
			fParam4 = uParam0->f_6;
		}
		...
		if (func_228(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehicle))
			{
				...
				func_210(vehicle, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_181(vehicle, uParam0->f_11);
				}
				else if (!func_208(vehicle, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					num = func_207(vehicle);
...
int func_207(Vehicle veParam0) // Position - 0xF591
{
	int i;
	var colorPrimary;
	var colorSecondary;
...
BOOL func_208(Vehicle veParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xF654
{
	Hash entityModel;
	var sizeAndVehs;
	...
	{
		case joaat("cargobob"):
			if (func_209(veParam0, Global_77348.f_139[38], false))
			{
				func_196(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_209(veParam0, Global_77348.f_139[43], true))
			{
				func_196(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_209(veParam0, sizeAndVehs[i], true) && func_97(ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_204(uParam1, 0f, 0f, 0f, false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(veParam0, true), ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), true) < 10f)
					{
...
BOOL func_209(Vehicle veParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xF85C
{
	var colorPrimary;
	var colorSecondary;
	var colorPrimary2;
...
void func_210(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF8BD
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_218(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_217())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (uParam1->f_69 > -1 && uParam1->f_69 < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_69 == 6)
						func_216(veParam0, uParam1->f_69);
				else
					func_216(veParam0, uParam1->f_69);
		...
		if (func_211() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")))
...
void func_216(Vehicle veParam0, int iParam1) // Position - 0x100AD
{
	int vehicleMod;
...
BOOL func_218(Vehicle veParam0) // Position - 0x10136
{
	int int;
...
BOOL func_221(Vehicle veParam0) // Position - 0x101F1
{
	...
	if (func_223(PLAYER::PLAYER_ID()) == 3)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
			if (func_222(veParam0) != -1)
				return true;

	return false;
}

int func_222(Vehicle veParam0) // Position - 0x10278
{
...
int func_223(Player plParam0) // Position - 0x102A7
{
	if (func_226(plParam0) == 233)
		return func_224(plParam0);

	return -1;
}

int func_224(Player plParam0) // Position - 0x102C4
{
	if (func_225(plParam0, false))
		return Global_1894573[plParam0 /*608*/].f_10.f_182;

	return -1;
}

BOOL func_225(Player plParam0, BOOL bParam1) // Position - 0x102E7
{
...
int func_226(Player plParam0) // Position - 0x10322
{
	if (func_225(plParam0, false))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0x10345
{
...
BOOL func_235(Hash hParam0) // Position - 0x1056E
{
	switch (hParam0)
	{
		case joaat("police"):
...
BOOL func_238(Hash hParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x105F7
{
	var minimum;
	float maximum;
...
void func_240() // Position - 0x10678
{
	if (!bLocal_28 && iLocal_84 != 3)
	{
		if (iLocal_84 > 0)
		{
			...
			if (!bLocal_196)
			{
				if (!func_105(PLAYER::PLAYER_PED_ID(), uLocal_205, 150f, true))
				{
					func_247(2);
				}
				else if (!func_105(PLAYER::PLAYER_PED_ID(), uLocal_205, 75f, true))
				{
					if (!bLocal_208)
					{
						HUD::CLEAR_PRINTS();
...
void func_250(const char* sParam0, const char* sParam1, const char* sParam2) // Position - 0x10A6A
{
...
BOOL func_253(Ped pedParam0) // Position - 0x10AF7
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
...
void func_259(int iParam0) // Position - 0x11514
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_261() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_261() /*5568*/].f_681.f_10), iParam0);
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x117A2
{
	Hash statName;
...
BOOL func_281(int iParam0, int iParam1) // Position - 0x11D88
{
...
void func_282(Hash hParam0, int iParam1) // Position - 0x11DD9
{
	int outValue;
...
void func_287(int iParam0, int iParam1, BOOL bParam2) // Position - 0x11F06
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_92() == 0)
		{
			address = _MPCHAR_STAT_GET_INT(func_91(iParam0), -1, 0);
			MISC::SET_BIT(&address, iParam1);
			_MPCHAR_STAT_SET_INT(func_91(iParam0), address, -1, true, false);
		}
	}
	else
	{
...
BOOL func_306(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1580A
{
	int num;
	int num2;
	eMPStat stat;
...
BOOL func_307(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x15849
{
...
void func_309(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1812E
{
	int num;
	int num2;
	Hash hash;
	...
	if (iParam0 == 12)
	{
		...
		if (ped >= 0)
		{
			...
			if (ped2 > ped)
			{
				...
				Global_2883589 = hash;
				func_302(&Global_78341[0 /*14*/], iParam0, iParam1, &(hash.f_7), 0, 0, hash.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num4 > componentId)
			{
				...
				func_302(&Global_78341[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num3, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78539)
		{
			...
			func_302(&Global_78341[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_310(iParam0));
...
void func_376(BOOL bParam0) // Position - 0x29A49
{
	...
	if (CAM::DOES_CAM_EXIST(caLocal_201))
	{
		CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
		CAM::DESTROY_CAM(caLocal_201, false);
	}
