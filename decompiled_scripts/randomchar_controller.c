					...
					else if (func_23(iLocal_96))
					{
						...
						for (i = 243; i <= 262; i = i + 1)
						{
							...
							if (func_16(unk.f_6, func_17(num, 0), false))
							{
								if (unk_0xCE4AAA035282336C(Global_32543[num /*23*/].f_19))
								{
									unk_0x37B37B8045788E6A(Global_32543[num /*23*/].f_19, 1);
									unk_0xD48486CAAB189227(Global_32543[num /*23*/].f_19, 10000);
...
void func_10() // Position - 0x765
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_12(character) && !func_11(14) || Global_112599)
			{
...
int func_42() // Position - 0x2A04
{
	...
	func_38(&unk, unk_0x61117764C67882B7());
	func_36(&unk, unk_0x367F557725B53815());
	return unk;
}
...
void func_49() // Position - 0x2B9C
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
		if (!func_45(55))
			if (func_53(5) && func_51(unk_0xC1A5EC5C986B98AD(), func_52(5), 1) < func_50(5) || func_53(6) && func_51(unk_0xC1A5EC5C986B98AD(), func_52(6), 1) < func_50(6))
...
void func_76() // Position - 0x3997
{
	...
	if (!func_82(num) || num == 52)
	{
		if (!IS_BIT_SET(Global_113648.f_18576.f_390[iLocal_52], iLocal_51))
		{
			...
			if (num == 58)
				unk_0xECDAB41968FF21A8(&Global_113648.f_18576.f_390[iLocal_52], iLocal_51);
			else if (unk_0x4F8096A7EB0A57DB(unk.f_6))
				unk_0xECDAB41968FF21A8(&Global_113648.f_18576.f_390[iLocal_52], iLocal_51);
...
void func_83(int iParam0) // Position - 0x3D0C
{
	...
	if (!IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 1))
		if (!unk.f_23)
			unk_0xECDAB41968FF21A8(&Global_113648.f_18576[iParam0 /*6*/], 1);
	...
	if (IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 0) && !IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 3))
	{
		if (!Global_113648.f_18576[iParam0 /*6*/].f_1)
		{
			...
			if (iParam0 == 57)
			{
				num = unk_0x15A88CFAAFFC6C4B(3, 11);
				num = num * 30;
		...
		if (IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 1))
		{
			if (!IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 2))
			{
				...
				if (unk.f_15 > 0 && flag)
				{
					...
					{
						func_122(Global_113648.f_18576[iParam0 /*6*/].f_2, &unk34, &unk35, &unk36, &num2, &num3, &num4);
				...
				if (flag)
				{
					unk_0xECDAB41968FF21A8(&Global_113648.f_18576[iParam0 /*6*/], 2);
					...
					if (iParam0 == 35)
					{
						...
						unk_0xD8BBE0A7F21F6B8C("launcher_MrsPhilips");
					}
					else if (iParam0 == 58)
					{
						Global_112735[iParam0 /*10*/].f_3 = 0;
						unk_0xD8BBE0A7F21F6B8C("launcher_Tonya");
					}
					else
					{
	...
	if (IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 3))
	{
		...
		if (!flag2)
			unk_0x061B1200C95204CB(&Global_113648.f_18576[iParam0 /*6*/], 2);
	}
	...
	else if (Global_112735[iParam0 /*10*/].f_3)
	{
		...
		if (!func_120() && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), unk.f_6, 0) > num5)
		{
			Global_112735[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	if (Global_112735[iParam0 /*10*/].f_7 != num6)
	{
		if (func_105(&(Global_112735[iParam0 /*10*/].f_8)))
		{
			...
			{
				num7 = uLocal_74[Global_112735[iParam0 /*10*/].f_8];
			...
			Global_112735[iParam0 /*10*/].f_7 = num6;
		}
	}

	if (!IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 4))
	{
		if (unk_0x14580F20CBCE4FA9(&(unk.f_10)) == unk_0x14580F20CBCE4FA9(""))
		{
			unk_0xECDAB41968FF21A8(&Global_113648.f_18576[iParam0 /*6*/], 4);
		}
		else if (num6 == 2)
		{
			if (func_94(unk.f_26, _GET_CURRENT_PLAYER_CHARACTER()))
			{
				if (!func_89() && !unk_0xB53553DC4AAC7D8A())
				{
	...
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!func_45(35))
		{
			if (IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 3))
			{
				if (!func_94(unk.f_26, _GET_CURRENT_PLAYER_CHARACTER()) && !func_103(iParam0) && !func_82(iParam0) && !func_86(iParam0) && !func_85(iParam0) && !Global_112735[iParam0 /*10*/].f_3)
				{
					if (SYSTEM::VDIST2(unk.f_6, unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1)) < 81f)
					{
						str = "";
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4E9E
{
	...
	if (bParam1)
		unk_0xECDAB41968FF21A8(&(Global_32543[num /*23*/].f_11), 28);
	else
		unk_0x061B1200C95204CB(&(Global_32543[num /*23*/].f_11), 28);
...
BOOL func_112(int iParam0) // Position - 0x5905
{
	int num;
	...
	if (iParam0 == 40 || iParam0 == 49 || iParam0 == 52)
	{
		if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
		{
			...
			{
				num = unk_0x504B9BB48D41C264(func_113(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 1)));
...
var func_113(var uParam0) // Position - 0x5971
{
	return uParam0;
}
...
void func_114(int iParam0, var uParam1) // Position - 0x597B
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_115(iParam0) && unk_0x24B651D85CCE5EB4(Global_91469[26 /*34*/].f_6) == 0)
			{
				Global_113648.f_7263[iParam0] = 1;
				unk_0x289D605FFACC399B(uParam1->f_5, Global_113648.f_7263[iParam0], 1, 1);
			}
