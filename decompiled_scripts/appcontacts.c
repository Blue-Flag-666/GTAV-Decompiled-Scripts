#region Local Var
	...
	eCharacter echLocal_73 = CHAR_MICHAEL;
	var uLocal_74 = 0;
	int iLocal_75 = 0;
	var uLocal_76 = 0;
	eCharacter echLocal_77 = CHAR_MICHAEL;
	int iLocal_78 = 0;
	var uLocal_79 = 0;
	int iLocal_80 = 0;
	int iLocal_81 = 0;
...
void main() // Position - 0x0
{
	...
	unk_0x061B1200C95204CB(&Global_8254, 18);
	unk_0x061B1200C95204CB(&Global_8254, 20);
	iLocal_278 = func_318(12);
	iLocal_279 = func_318(2);
	iLocal_280 = func_318(0);
	uLocal_79 = unk_0x9F2C1BA4F2BF5CF8();
	...
	uLocal_106 = unk_0xA5E11AF0A2B928C1();
	func_295(147, 1320);
	func_295(74, 180);
	func_295(75, 190);
	...
	while (true)
	{
		...
		if (iLocal_91 == 1 && Global_20383.f_1 == 10 && uLocal_306.f_2999 == 1)
			func_190();
			...
			switch (Global_20383.f_1)
			{
				case 7:
					...
					if (!IS_BIT_SET(Global_8253, 9))
					{
						if (func_163(2, Global_20355, 0))
						{
							...
							else if (Global_20326 == false)
							{
								if (!IS_BIT_SET(Global_8254, 19))
								{
									func_161();
									func_160(Global_20364, "SET_DATA_SLOT_EMPTY", 11f, -1082130432, -1082130432, -1082130432, -1082130432);
									iLocal_81 = 0;
									TEXT_LABEL_ASSIGN_STRING(&uLocal_84, "", 16);
									func_159();
									Global_20363 = 0;
									iLocal_91 = 0;
									func_160(Global_20364, "DISPLAY_VIEW", 11f, -1082130432, -1082130432, -1082130432, -1082130432);
									func_158(Global_20364, "SET_HEADER", "CELL_221" /*Enter number:*/, 0, 0, 0, 0);
								
									if (Global_20371)
									{
										func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
										func_157(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 5f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
										unk_0xECDAB41968FF21A8(&Global_8253, 17);
										func_157(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
									}
									else
									{
				...
				case 8:
					...
					else
					{
						...
						{
							for (iLocal_304 = 0; iLocal_304 < 4; iLocal_304 = iLocal_304 + 1)
							{
								if (unk_0x4310A0DB886F9FED(&(Global_2028[Global_7568 /*29*/].f_3), &Global_8091[iLocal_304 /*16*/]))
								{
									if (!unk_0x4310A0DB886F9FED(&(Global_8091[iLocal_304 /*16*/].f_8), "CELL_SFUN_NULL" /*This is a dummy and should not be displayed but is referenced by script. Please leave.*/))
									{
										bLocal_301 = true;
							...
							if (bLocal_90 == false)
							{
								...
								uLocal_74 = unk_0x08320883763BEFA3();
							
								while (!unk_0x4F815B9C87A967FD(uLocal_74))
								{
									SYSTEM::WAIT(0);
								}
							
								iLocal_75 = unk_0x67FFE44BB8589F1E(uLocal_74);
								func_134();
							}
						}
								...
								if (bLocal_301 == true)
								{
									...
									else
									{
										...
										if (func_127("AM_H_BBUDDY" /*Backup from friends can be arranged through the "Help With Prep" option when making a phone call.*/) == 0)
											func_120("AM_H_BBUDDY" /*Backup from friends can be arranged through the "Help With Prep" option when making a phone call.*/, 1);
									}
								}
							}
						}
						...
						if (unk_0x1B82EF141CC65934(unk_0x93E99A2DBCBA9CFA()))
						{
							if (func_163(2, Global_20351, 0))
							{
								...
								else
								{
									...
									else if (Global_7568 == CHAR_CHAT_CALL)
									{
										if (Global_2800023.f_1 || IS_BIT_SET(Global_8254, 20))
										{
											...
											if (IS_BIT_SET(Global_8254, 0))
												func_158(Global_20364, "SET_HEADER", "CELL_7000" /*Your choice?*/, 0, 0, 0, 0);
											else
												func_158(Global_20364, "SET_HEADER", "CELL_0" /*Contacts*/, 0, 0, 0, 0);
										
											unk_0xA13B5B0EF7402391(uLocal_79);
											iLocal_102 = 0;
										}
									}
									else
	...
	if (!Global_20383.f_1 == 10 && !Global_20383.f_1 == 9)
	{
		...
		if (Global_20383.f_1 > 6)
		{
			...
			if (IS_BIT_SET(Global_8253, 9))
			{
				if (Global_20371)
				{
					func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_210" /*SEND TO*/, 0, 0, 0, 0);
					func_157(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
				}
				else
				{
			...
			else if (IS_BIT_SET(Global_8254, 0))
			{
				if (Global_20371)
				{
					func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_210" /*SEND TO*/, 0, 0, 0, 0);
					func_157(Global_20364, "SET_SOFT_KEYS", 3f, 0f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
				}
				else
				{
					func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
			...
			{
				if (echLocal_69 > CHAR_MICHAEL)
					func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
				else
					func_157(Global_20364, "SET_SOFT_KEYS", 2f, 0f, 5f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
			
				if (Global_20326 == false)
				{
					func_157(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 9f, -1f, -1f, "CELL_207" /*ENTER NO.*/, 0, 0, 0, 0);
					unk_0xECDAB41968FF21A8(&Global_8253, 17);
				}
				else
				{
...
void func_3() // Position - 0x9C0
{
	...
	{
		case 0:
			if (Global_7568 == CHAR_CARSITE3)
			{
				if (Global_1835499 == 0)
					Global_1835499 = 1;
			
				if (unk_0xFB6C798A13C4039E("LOWCAAU"))
				{
					unk_0x97867FB5A0A8EB15("LOWCAAU", 15);
				...
				TEXT_LABEL_ASSIGN_STRING(&uLocal_109, "LOWCA_CALL10_1", 16);
			}
			else
			{
				if (unk_0xFB6C798A13C4039E(&Global_22748))
				{
					unk_0xA3C681843B51A4CC(&Global_22748, 1);
				...
				uLocal_109 = { Global_117[Global_7568 /*10*/] };
				TEXT_LABEL_APPEND_STRING(&uLocal_109, "_1", 16);
			}
		
			if (unk_0x42FA33BDEDF21186(&uLocal_109) || iLocal_281 == 1)
			{
			...
			if (iLocal_281 == 1 && unk_0x4310A0DB886F9FED(&uLocal_282, "CELLPHONE_CHEAT") && Global_78558 == false)
			{
				if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_SEAPLANE") || unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_DUELC") || unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_BUBBLE"))
					bLocal_95 = true;
				...
				if (iLocal_96 == 0)
				{
					...
					unk_0xC4F0FA07E16A4C2B(&uLocal_84, -1);
					unk_0xF8FCA9E7130CE1C8();
					func_81("CELL_300" /*CHAR_DEFAULT*/);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_MONOC"))
						func_81("CELL_MONOSIGNAL" /*Black Cellphones*/);
					else if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_DIRECTOR"))
						func_81("CELL_DRCT" /*Acting Up*/);
					else
						func_81("CELL_CHEAT" /*Cheat processing.*/);
				
					func_81("CELL_195" /*Unknown*/);
		...
		case 2:
			...
			if (iLocal_103 != Global_22744)
				if (unk_0x209C5E3492025E4B(uLocal_79))
					if (Global_2800023.f_37 == false)
						if (Global_20326)
							unk_0x531D638530A8DB97(uLocal_79, "Dial_and_Remote_Ring", &Global_20372, 1);
						else if (iLocal_105 - uLocal_104 > 1700)
							unk_0x531D638530A8DB97(uLocal_79, "Remote_Ring", &Global_20372, 1);
			else if (func_83(_CHAR_TAXI_IS) || func_83(CHAR_CHAT_CALL) || func_83(_CHAR_DETONATEBOMB_2))
				if (unk_0x209C5E3492025E4B(uLocal_79))
					if (Global_2800023.f_37 == false)
						if (Global_20326)
							unk_0x531D638530A8DB97(uLocal_79, "Dial_and_Remote_Ring", &Global_20372, 1);
			...
			if (iLocal_105 - uLocal_104 > iLocal_103)
			{
				if (iLocal_103 == Global_22744)
				{
					bLocal_92 = false;
				
					if (Global_7568 == _CHAR_TAXI_IS || Global_7568 == CHAR_CHAT_CALL || Global_7568 == _CHAR_DETONATEBOMB_2)
					{
						if (!IS_BIT_SET(Global_8254, 20))
						{
							bLocal_92 = true;
						
							if (iLocal_105 - uLocal_104 > iLocal_103 + 10000)
								if (Global_20383.f_1 == 10)
									if (Global_7568 == _CHAR_TAXI_IS)
										Global_20383.f_1 = 3;
						}
					}
					...
					if (!bLocal_92)
					{
						...
						if (func_80(Global_7568, Global_20383) == 0)
						{
							if (Global_7568 == CHAR_CHAT_CALL)
							{
								...
								unk_0xF8FCA9E7130CE1C8();
								func_81("CELL_300" /*CHAR_DEFAULT*/);
								func_81("CELL_220" /*BUSY*/);
								func_81("CELL_219" /*CONNECTED*/);
								unk_0xAE3413B0654A0035();
							}
							else
							{
								func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(5), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_220" /*BUSY*/, "CELL_195" /*Unknown*/, 0);
							}
						}
						else
						{
							func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(5), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), "CELL_220" /*BUSY*/, &(Global_2028[Global_7568 /*29*/].f_3), 0);
						}
		...
		case 3:
			if (iLocal_281 == 1)
			{
				if (unk_0x4310A0DB886F9FED(&uLocal_282, "CELLPHONE_CHEAT") && Global_78558 == false)
				{
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_MONOC"))
					{
						if (Global_9057 == 0)
						{
							...
							if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
								if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 1))
									if (!unk_0xD612176B6DC58EF7(4, unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), 40f))
										unk_0x06791F908899E862(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1) + { 2f, 0f, 0f }, 4, 0.1f, 1, 0, 1065353216, 0);
						}
						else
						{
							Global_9057 = 0;
					...
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_SUPJUM"))
						func_79(0, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_HEALA"))
						func_79(6, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_SLIDEYC"))
						func_79(1, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_FASTR"))
						func_79(2, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_WANTDN"))
						func_79(9, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_WANTUP"))
						func_79(8, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_WEATHER"))
						func_79(5, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_FASTS"))
						func_79(3, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_POWER"))
						func_79(7, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_CHUTE"))
						func_79(10, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_BANG"))
						func_79(11, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_FLAMB"))
						func_79(12, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_EXPMEL"))
						func_79(13, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_ZEROG"))
						func_79(14, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_INVINC"))
						func_79(15, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_SLOWMO"))
						func_79(16, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_SKYFA"))
						func_79(17, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_DRUNK" /*Drunk mode.*/))
						func_79(18, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_DEADEYE"))
						func_79(19, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_WEAPONS"))
						func_79(4, 0);
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_BUZZARD"))
						func_79(20, joaat("buzzard"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_COMET2"))
						func_79(20, joaat("comet2"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_BMX"))
						func_79(20, joaat("bmx"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_CADDY"))
						func_79(20, joaat("caddy"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_DUSTER"))
						func_79(20, joaat("duster"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_PCJ"))
						func_79(20, joaat("pcj"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_RAPIDGT"))
						func_79(20, joaat("rapidgt"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_STRETCH"))
						func_79(20, joaat("stretch"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_STUNT"))
						func_79(20, joaat("stunt"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_TRASH"))
						func_79(20, joaat("trash"));
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_SANCHEZ"))
						func_79(20, joaat("sanchez"));
				
					if (_IS_EXCLUSIVE_CONTENT_UNLOCKED())
					{
						if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_SEAPLANE"))
							func_79(20, joaat("dodo"));
					
						if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_DUELC"))
							func_79(20, joaat("dukes2"));
					
						if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_BUBBLE"))
							func_79(20, joaat("submersible2"));
					}
				
					if (unk_0x4310A0DB886F9FED(&uLocal_286, "CHEAT_DIRECTOR"))
					{
				...
				else if (unk_0x4310A0DB886F9FED(&uLocal_282, "CELLPHONE_CHEAT"))
				{
					func_36(0);
				}
				else
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_113, 1, 0, &uLocal_286, 0, 1);
					Global_22746 = 0;
					func_34(&uLocal_113, Global_7568, &Global_22748, &uLocal_282, 2, 0, 0, 0, false);
				}
			}
			else
			{
				...
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_113, 1, 0, &unk, 0, 1);
				Global_22746 = 0;
			
				switch (Global_7568)
				{
					case CHAR_CARSITE3:
						func_9(&uLocal_113, CHAR_CARSITE3, "LOWCAAU", "LOWCA_CALL10", 2, 0, 0, 0, false);
						break;
				
					case CHAR_LESTER_DEATHWISH:
						func_9(&uLocal_113, CHAR_LESTER, &Global_22748, "LES_APH2", 2, 0, 0, 0, false);
						break;
				
					case CHAR_DR_FRIEDLANDER:
						num2 = unk_0x30DFE1FFD2CC7420();
					
						if (num2 > 17 || num2 < 9)
							func_9(&uLocal_113, Global_7568, &Global_22748, "SHR_APH3", 2, 0, 0, 0, false);
					
						if (num2 > 8 && num2 < 13)
							func_9(&uLocal_113, Global_7568, &Global_22748, "SHR_APH1", 2, 0, 0, 0, false);
					
						if (num2 > 12 && num2 < 18)
							func_9(&uLocal_113, Global_7568, &Global_22748, "SHR_APH2", 2, 0, 0, 0, false);
						break;
				
					case CHAR_AMANDA:
						if (func_8(21) && !func_8(22))
							func_9(&uLocal_113, Global_7568, &Global_22748, "AMA_APH2", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, &Global_117[Global_7568 /*10*/], 2, 0, 0, 0, false);
						break;
				
					case CHAR_RON:
						if (Global_78558)
							func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_RBusy", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, &Global_117[Global_7568 /*10*/], 2, 0, 0, 0, false);
						break;
					...
					case CHAR_DENISE:
						if (func_7(126))
							func_9(&uLocal_113, Global_7568, &Global_22748, "DEN_APH3", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, &Global_117[Global_7568 /*10*/], 2, 0, 0, 0, false);
						break;
					...
					case CHAR_TRACEY:
						if (!func_8(19))
							func_9(&uLocal_113, Global_7568, &Global_22748, "TRA_APH1", 2, 0, 0, 0, false);
						else if (!func_8(20))
							func_9(&uLocal_113, Global_7568, &Global_22748, "TRA_APH2", 2, 0, 0, 0, false);
						else if (!func_8(22))
							func_9(&uLocal_113, Global_7568, &Global_22748, "TRA_APH3", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, "TRA_APH4", 2, 0, 0, 0, false);
						break;
				
					case CHAR_LAMAR:
						if (!func_8(19))
							func_9(&uLocal_113, Global_7568, &Global_22748, "LAM_APH1", 2, 0, 0, 0, false);
						else if (!func_8(20))
							func_9(&uLocal_113, Global_7568, &Global_22748, "LAM_APH2", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, "LAM_APH3", 2, 0, 0, 0, false);
						break;
				
					case CHAR_JIMMY:
						if (!func_8(19))
							func_9(&uLocal_113, Global_7568, &Global_22748, "JIM_APH1", 2, 0, 0, 0, false);
						else if (!func_8(21))
							func_9(&uLocal_113, Global_7568, &Global_22748, "JIM_APH3", 2, 0, 0, 0, false);
						else if (!func_8(22))
							func_9(&uLocal_113, Global_7568, &Global_22748, "JIM_APH2", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, "JIM_APH4", 2, 0, 0, 0, false);
						break;
				
					case CHAR_BARRY:
						if (func_6(7))
							func_9(&uLocal_113, Global_7568, &Global_22748, "BAR_APH2", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, "BAR_APH1", 2, 0, 0, 0, false);
						break;
				
					case CHAR_MP_MERRYWEATHER:
						iLocal_305 = unk_0x15A88CFAAFFC6C4B(0, 100);
					
						if (iLocal_305 <= 50)
							func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_MWBusy", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_MWBusy2", 2, 0, 0, 0, false);
						break;
					...
					case CHAR_PEGASUS_DELIVERY:
						...
						if (iLocal_305 <= 50)
							func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_PGbusy", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_PGbusy2", 2, 0, 0, 0, false);
						break;
					...
					case CHAR_MP_MORS_MUTUAL:
						...
						if (iLocal_305 <= 50)
							func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_INSbusy", 2, 0, 0, 0, false);
						else
							func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_INSbusy2", 2, 0, 0, 0, false);
						break;
				
					case CHAR_MP_GERALD:
						func_9(&uLocal_113, Global_7568, &Global_22748, "ANS_GBusy", 2, 0, 0, 0, false);
						break;
				...
				unk_0xECDAB41968FF21A8(&Global_8254, 31);
			}
			break;
	
		case 4:
			if (unk_0x209C5E3492025E4B(uLocal_79))
				unk_0x531D638530A8DB97(uLocal_79, "Remote_Engaged", &Global_20372, 1);
			...
			if (SYSTEM::TIMERB() > 1500)
			{
				if (iLocal_93 == 0)
				{
					if (Global_20383 == CHAR_TREVOR)
					{
						...
						{
							func_4(unk_0xC1A5EC5C986B98AD(), "PHONE_CALL_NOT_CONNECTED", 24);
							iLocal_93 = 1;
						}
					}
				}
...
void func_9(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x1CC5
{
	if (Global_78558 || func_33(false))
	{
		...
		{
			func_34(uParam0, echParam1, &Global_22748, sParam3, iParam4, iParam5, iParam6, iParam7, bParam8);
		}
		else
		{
			func_10(uParam0, echParam1, &Global_22748, sParam3, iParam4, iParam5, iParam6, iParam7, bParam8);
		}
	}
	else
	{
...
void func_23() // Position - 0x239D
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_24(character) && !func_28(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != character && func_24(Global_113648.f_2365.f_539.f_4321))
...
int func_44(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2AB0
{
	...
	if (unk_0xB53553DC4AAC7D8A() || func_58())
		return 4;
...
BOOL func_45(BOOL bParam0) // Position - 0x2DEC
{
	...
	if (func_57() || Global_23131.f_4 || func_46() || unk_0x7B052E9CA5CE2D88() || unk_0x6FF497D385A9B7BF() || func_58() || func_77())
		return false;
...
int func_48(int iParam0) // Position - 0x2F23
{
	...
	if (SYSTEM::VDIST2(vector, 1081.9506f, -1976.7618f, 30.47218f) < 6f && func_55(26))
		return 9;
	...
	if (num == 0)
		...
		return 9;
	else if (num == Global_112619 || num == Global_112620 && func_8(67))
		return 9;
...
void func_49(int iParam0) // Position - 0x334B
{
	...
	for (i = 0; i <= 19 - 1; i = i + 1)
	{
		Global_112621[i] = unk_0x9CE0235348AE4A4D(func_50(i));
	}
...
BOOL func_55(int iParam0) // Position - 0x6BE8
{
	int i;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x6C50
{
...
{
	return func_65(iParam0, 20, true);
}

BOOL func_65(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6E92
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_70() == 0)
			return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_69(iParam0), -1, 0), iParam1);
	else
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x6EF3
{
	var unk;
	int num;
...
int func_67(int iParam0) // Position - 0x6F30
{
	int num;
	int num2;
...
eMPStat func_69(int iParam0) // Position - 0x6F70
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_73(int iParam0, int iParam1) // Position - 0x7336
{
	return iParam0 && iParam1 != false;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x7345
{
...
{
	unk_0xECDAB41968FF21A8(&Global_32415, iParam0);
	Global_32416 = iParam1;
	return;
}

int func_80(eCharacter echParam0, eCharacter echParam1) // Position - 0x73DC
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x7418
{
	var unk;
...
BOOL func_83(eCharacter echParam0) // Position - 0x74D0
{
...
void func_85() // Position - 0x7556
{
	if (Global_20361 == 0)
	{
		...
		{
			unk_0x061B1200C95204CB(&Global_8254, 0);
			bLocal_90 = false;
			func_161();
			Global_20361 = 1;
			unk_0x9FD96C5DE6EDFC15(Global_20364, "GET_CURRENT_SELECTION");
			...
			iLocal_78 = unk_0x67FFE44BB8589F1E(uLocal_74);
...
void func_86() // Position - 0x76D1
{
	...
	func_157(Global_20364, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
	unk_0x061B1200C95204CB(&Global_8253, 17);
	func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_270" /*Yes*/, 0, 0, 0, 0);
	func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_271" /*No*/, 0, 0, 0, 0);
	func_160(Global_20364, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_158(Global_20364, "SET_HEADER", "CELL_269" /*Cancel?*/, 0, 0, 0, 0);
	return;
}

BOOL func_87(eCharacter echParam0, eCharacter echParam1) // Position - 0x77F4
{
	eCharacter character;
	...
	if (!func_28(6) && !func_28(7))
		if (func_88(echParam0, echParam1))
			return true;

	return false;
}

BOOL func_88(eCharacter echParam0, eCharacter echParam1) // Position - 0x7848
{
	eCharacter character;
	int num;
	int num2;
	...
	if (!func_93(6))
	{
		num = func_91(echParam0);
		num2 = func_91(echParam1);
	
		if (num != 7 && num2 != 7)
		{
			num3 = func_90(num, num2);
...
int func_91(eCharacter echParam0) // Position - 0x7A78
{
	if (echParam0 == _CHAR_NULL)
		return 7;

	if (echParam0 < func_96())
...
int func_92(eCharacter echParam0) // Position - 0x7AD0
{
	return Global_2028[echParam0 /*29*/].f_11;
}

BOOL func_93(int iParam0) // Position - 0x7AE1
{
	if (Global_43257 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x7B03
{
	return func_95(iParam0, Global_43257);
}

BOOL func_95(int iParam0, int iParam1) // Position - 0x7B14
{
	if (iParam1 == 15)
		return 1;
...
eCharacter func_96() // Position - 0x7CF5
{
...
void func_97() // Position - 0x7D17
{
	...
	if (func_80(Global_7568, Global_20383) == 0)
		func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_211" /*DIALING...*/, "CELL_195" /*Unknown*/, 0);
	else
		func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), "CELL_211" /*DIALING...*/, &(Global_2028[Global_7568 /*29*/].f_3), 0);

	func_102();

	if (Global_78558)
		_MPCHAR_STAT_INCREMENT_INT(MP_STAT_CALLS_MADE_TO_NPC, 1, -1);

	return;
}

void _MPCHAR_STAT_INCREMENT_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x7E40
{
	int num;

	num = _MPCHAR_STAT_GET_INT(empsParam0, func_67(iParam2), 0);
	num = num + iParam1;

	if (!func_101(empsParam0))
		_MPCHAR_STAT_SET_INT(empsParam0, num, iParam2, 1, false);
	else
		func_99(empsParam0, num, iParam2, 1);

	return;
}

void func_99(eMPStat empsParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7E82
{
	int num;
	...
	switch (empsParam0)
	{
		case MP_STAT_BRONZE_INTCHAR_0:
			Global_1665566[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_BRONZE_INTCHAR_1:
			Global_1665572[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_BRONZE_INTCHAR_2:
			Global_1665578[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_BRONZE_INTCHAR_3:
			Global_1665584[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_BRONZE_INTCHAR_4:
			Global_1665590[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_SILVER_INTCHAR_0:
			Global_1665536[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_SILVER_INTCHAR_1:
			Global_1665542[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_SILVER_INTCHAR_2:
			Global_1665548[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_SILVER_INTCHAR_3:
			Global_1665554[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_SILVER_INTCHAR_4:
			Global_1665560[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_GOLD_INTCHAR_0:
			Global_1665506[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_GOLD_INTCHAR_1:
			Global_1665512[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_GOLD_INTCHAR_2:
			Global_1665518[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_GOLD_INTCHAR_3:
			Global_1665524[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_GOLD_INTCHAR_4:
			Global_1665530[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_INTCHAR_0:
			Global_1665596[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_INTCHAR_1:
			Global_1665602[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_INTCHAR_2:
			Global_1665608[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_INTCHAR_3:
			Global_1665614[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_INTCHAR_4:
			Global_1665620[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_FM_CUT_DONE:
			Global_1665626[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_FM_CUT_DONE_2:
			Global_1665632[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CHAR_XP_FM:
			Global_1665638[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROPERTY_HOUSE:
			Global_1665644[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_MULTI_PROPERTY_1:
			Global_2851323[0 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_MULTI_PROPERTY_2:
			Global_2851323[1 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_MULTI_PROPERTY_3:
			Global_2851323[2 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_MULTI_PROPERTY_4:
			Global_2851323[3 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_BRUISER2_LAS_HITS:
			Global_2851502[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_BOOLCHAR_0:
			Global_1665650[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_BOOLCHAR_1:
			Global_1665656[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_BOOLCHAR_2:
			Global_1665662[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_BOOLCHAR_3:
			Global_1665668[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PLATINUM_BOOLCHAR_4:
			Global_1665674[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_INSURGENT3_TURR_HITS:
			Global_1665680[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_NO_CLOTHES_UNLOCK:
			Global_1665686[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_0:
			Global_2851411[0 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_1:
			Global_2851411[1 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_2:
			Global_2851411[2 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_3:
			Global_2851411[3 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_4:
			Global_2851411[4 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_WARHOUSESLOT0:
			Global_2851505[0 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_WARHOUSESLOT1:
			Global_2851505[1 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_WARHOUSESLOT2:
			Global_2851505[2 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_WARHOUSESLOT3:
			Global_2851505[3 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_WARHOUSESLOT4:
			Global_2851505[4 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CONTOTALFORWHOUSE0:
			Global_2851521[0 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CONTOTALFORWHOUSE1:
			Global_2851521[1 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CONTOTALFORWHOUSE2:
			Global_2851521[2 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CONTOTALFORWHOUSE3:
			Global_2851521[3 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CONTOTALFORWHOUSE4:
			Global_2851521[4 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE_VAR:
			Global_2851411[5 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE:
			Global_2851323[4 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_NUMBUYMISSIONSCOMPLETED:
			Global_2851537[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_LIFETIME_BUY_COMPLETE:
			Global_2851546[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_LIFETIME_BUY_UNDERTAKEN:
			Global_2851540[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_LIFETIME_SELL_COMPLETE:
			Global_2851549[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_LIFETIME_SELL_UNDERTAKEN:
			Global_2851543[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_LIFETIME_CONTRA_EARNINGS:
			Global_2851552[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_DELIVERY_VEH_UPGRADES:
			Global_2851555[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_CLUBHOUSE_VAR:
			Global_2851411[6 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_CLUBHOUSE:
			Global_2851323[5 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_5:
			Global_2851411[7 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_MULTI_PROPERTY_5:
			Global_2851323[6 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE_GAR1_VAR:
			Global_2851411[8 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE_GAR1:
			Global_2851323[7 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE_GAR2_VAR:
			Global_2851411[9 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE_GAR2:
			Global_2851323[8 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE_GAR3_VAR:
			Global_2851411[10 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_OFFICE_GAR3:
			Global_2851323[9 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_IE_WAREHOUSE_VAR:
			Global_2851411[11 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_IE_WAREHOUSE:
			Global_2851323[10 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_HANGAR_VAR:
			Global_2851411[12 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_HANGAR:
			Global_2851323[11 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_DEFUNCBASE_VAR:
			Global_2851411[13 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_DEFUNCBASE:
			Global_2851323[12 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_NIGHTCLUB_VAR:
			Global_2851411[14 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_NIGHTCLUB:
			Global_2851323[13 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_MEGAWARE_GAR1_VAR:
			Global_2851411[15 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_MEGAWARE_GAR1:
			Global_2851323[14 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_MEGAWARE_GAR2_VAR:
			Global_2851411[16 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_MEGAWARE_GAR2:
			Global_2851323[15 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_MEGAWARE_GAR3_VAR:
			Global_2851411[17 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_MEGAWARE_GAR3:
			Global_2851323[16 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_ARENAWARS_GAR1:
			Global_2851323[17 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_ARENAWARS_GAR2:
			Global_2851323[18 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_ARENAWARS_GAR3:
			Global_2851323[19 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_CASINO_GAR1:
			Global_2851323[20 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_1:
			Global_2851558[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_2:
			Global_2851561[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_3:
			Global_2851564[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_4:
			Global_2851567[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_5:
			Global_2851570[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_6:
			Global_2851573[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_7:
			Global_2851576[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_8:
			Global_2851579[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_9:
			Global_2851582[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_10:
			Global_2851585[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_11:
			Global_2851588[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_12:
			Global_2851591[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_13:
			Global_2851594[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_CASINO_APT_DECORATION_14:
			Global_2851597[func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_ARCADE_GAR1:
			Global_2851323[21 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_6:
			Global_2851411[23 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_MULTI_PROPERTY_6:
			Global_2851323[22 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_APPARTMENT_VAR_7:
			Global_2851411[24 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_MULTI_PROPERTY_7:
			Global_2851323[23 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_AUTO_SHOP:
			Global_2851323[24 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case MP_STAT_PROP_SECURITY_OFFICE_GAR:
			Global_2851323[25 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case _0x2065457610:
			Global_2851411[27 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case _0x1055556065:
			Global_2851323[26 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case _0x1335233214:
			Global_2851411[28 /*3*/][func_67(iParam2)] = iParam1;
			break;
	
		case _0x2129461717:
			Global_2851323[27 /*3*/][func_67(iParam2)] = iParam1;
			break;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x8B08
{
	int num;
...
BOOL func_101(eMPStat empsParam0) // Position - 0x8B38
{
	if (Global_1665487)
	{
		switch (empsParam0)
	...
	switch (Global_20383.f_1)
	{
		case 6:
			...
			else
			{
				if (Global_20585 == 1)
					if (Global_20371)
						func_157(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
					else
						func_157(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_20371)
					func_157(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
				else
		...
		case 10:
			...
			{
				func_157(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /*END CALL*/, 0, 0, 0, 0);
		...
		case 9:
			if (Global_20382 == 1)
			{
				...
				if (Global_21738)
				{
					...
					unk_0xF8FCA9E7130CE1C8();
					func_81("CELL_300" /*CHAR_DEFAULT*/);
					func_81("CELL_217" /*INCOMING CALL*/);
					func_81("CELL_217" /*INCOMING CALL*/);
					unk_0xAE3413B0654A0035();
				}
				else if (func_80(Global_7568, Global_20383) == 0)
				{
					func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2028[Global_7568 /*29*/].f_3), 0);
				}
			...
			else if (Global_21725 == 4 || Global_21725 == 3)
			{
				...
				else
				{
					...
					if (func_80(Global_7568, Global_20383) == 0)
					{
						...
						func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_160(Global_20364, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), &unk, &(Global_2028[Global_7568 /*29*/].f_3), 0);
					}
				}
...
void func_103() // Position - 0x93D8
{
	if (unk_0x5FAF55B1F052A2E6(Global_20364))
	{
		...
		{
			if (Global_20371)
				func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /*ANSWER*/, 0, 0, 0, 0);
			else
				func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, 0, 0, 0, 0, 0);
			...
			if (Global_21772)
				...
				func_157(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /*REJECT*/, 0, 0, 0, 0);
			else
				func_157(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
				...
				if (iParam0 == Global_8260[num /*15*/].f_11)
				{
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (Global_2694519)
								if (num == 14)
									func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8260[num /*15*/].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78558)
								{
									...
									func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8260[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
							}
...
void func_111() // Position - 0xA0A4
{
	...
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
		if (func_112() && unk_0x8DEE51D44B32DE1F(unk_0xC1A5EC5C986B98AD(), 0))
			num2 = 1;
...
BOOL func_114(eCharacter echParam0) // Position - 0xA213
{
	int i;
	...
	{
		if (Global_113648.f_7690.f_199[i /*15*/].f_6 == echParam0)
			return true;
	}

	for (i = 0; i < Global_113648.f_7690.f_136; i = i + 1)
	{
		if (Global_113648.f_7690[i /*15*/].f_6 == echParam0)
			if (IS_BIT_SET(Global_113648.f_7690[i /*15*/].f_1, 7))
				return true;
	}
...
BOOL func_115(eCharacter echParam0) // Position - 0xA29E
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < 7; i = i + 1)
	{
		num = Global_91433[i /*5*/];
	
		if (num != -1)
		{
			num2 = -1;
			num2 = Global_78828.f_109[Global_91433[i /*5*/] /*4*/];
		
			if (num2 != -1)
				if (func_116(Global_91469[num2 /*34*/].f_12, echParam0))
					return true;
		}
	}
...
BOOL func_116(int iParam0, eCharacter echParam1) // Position - 0xA2FB
{
	switch (echParam1)
	{
		case CHAR_LAMAR:
...
BOOL func_117(int iParam0, eCharacter echParam1) // Position - 0xA34E
{
	switch (echParam1)
	{
		case CHAR_MICHAEL:
...
BOOL func_118(int iParam0, int iParam1) // Position - 0xA378
{
	return iParam0 && iParam1 != false;
}
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xA777
{
...
void func_126(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA7AB
{
	int i;
...
BOOL func_128(char* sParam0) // Position - 0xA9A5
{
	int i;
...
BOOL func_129(var uParam0) // Position - 0xA9E0
{
	return false;
}

BOOL func_130(eCharacter echParam0, eCharacter echParam1) // Position - 0xAA1A
{
	return false;
}

BOOL func_131(eCharacter echParam0, eCharacter echParam1, var uParam2) // Position - 0xAAB8
{
	int num;
	int num2;
...
void func_134() // Position - 0xAB18
{
	...
	if (func_114(Global_7568))
	{
		if (bLocal_301)
		{
			...
			func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_208" /*Call*/, 0, 0, 0, 0);
		
			if (bLocal_302)
			{
				if (func_135(Global_7568, Global_20383))
					func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_209" /*Hang Out*/, 0, 0, 0, 0);
			
				if (func_87(Global_7568, Global_20383))
					func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_222" /*Cancel Activity*/, 0, 0, 0, 0);
			}
		}
		else
		{
			func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_208" /*Call*/, 0, 0, 0, 0);
		
			if (bLocal_302)
			{
				if (func_135(Global_7568, Global_20383))
					func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_209" /*Hang Out*/, 0, 0, 0, 0);
			
				if (func_87(Global_7568, Global_20383))
					func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_222" /*Cancel Activity*/, 0, 0, 0, 0);
			}
		}
	}
	else if (bLocal_301)
	...
	{
		if (func_135(Global_7568, Global_20383))
			func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_209" /*Hang Out*/, 0, 0, 0, 0);
	
		if (func_87(Global_7568, Global_20383))
			func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_222" /*Cancel Activity*/, 0, 0, 0, 0);
	}
...
BOOL func_135(eCharacter echParam0, eCharacter echParam1) // Position - 0xAE77
{
	eCharacter character;
	int num;
	...
	if (!func_93(6))
		if (func_131(echParam0, echParam1, &num) && func_89(num) == 0)
			return true;
...
void func_136() // Position - 0xAF0B
{
	...
	if (func_163(2, Global_20352, 0))
	{
		...
		num = unk_0x67FFE44BB8589F1E(uLocal_74);
		iLocal_80 = Global_9044[num];
		uLocal_82[0] = unk_0x45816CECE89B5B19(&Global_8961[iLocal_80 /*5*/]);
	
		if (unk_0x4310A0DB886F9FED(uLocal_82[0], "*"))
		{
			uLocal_84 = { Global_9027[Global_20383 /*4*/] };
			iLocal_81 = unk_0xA7D1818D200CD09B(&uLocal_84);
		}
		else if (unk_0xA7D1818D200CD09B(&uLocal_84) < 14)
		{
			TEXT_LABEL_APPEND_STRING(&uLocal_84, uLocal_82[0], 16);
			iLocal_81 = iLocal_81 + 1;
		}
	
		unk_0x9FD96C5DE6EDFC15(Global_20364, "SET_HEADER");
		unk_0x2AF11E92DE43CDE3("STRING");
		unk_0xC4F0FA07E16A4C2B(&uLocal_84, -1);
		unk_0xF8FCA9E7130CE1C8();
		unk_0xAE3413B0654A0035();
	...
	if (func_163(2, 178, 0))
	{
		...
		if (unk_0xA7D1818D200CD09B(&uLocal_84) > 0)
		{
			TEXT_LABEL_ASSIGN_STRING(&uLocal_84, unk_0x8B26749839E18CBE(&uLocal_84, 0, iLocal_81 - 1), 16);
			iLocal_81 = iLocal_81 - 1;
		}
	...
	if (func_163(2, Global_20355, 0))
	{
		...
		{
			func_161();
			Global_9027[Global_20383 /*4*/] = { uLocal_84 };
			Global_7568 = _CHAR_VIRTUAL_MP;
			iLocal_281 = 0;
			...
			while (character < character2)
			{
				...
				{
					unk = unk_0x45816CECE89B5B19(&(Global_117[character /*10*/].f_4));
				
					if (unk_0x4310A0DB886F9FED(unk, &uLocal_84))
						if (func_145(character3, Global_20383) == 1 || func_145(character3, Global_20383) == 2 || unk_0x4310A0DB886F9FED(unk, unk_0x45816CECE89B5B19(&(Global_117[130 /*10*/].f_4))))
							Global_7568 = character3;
						else
							iLocal_94 = 1;
				}
			...
			if (Global_7568 == _CHAR_VIRTUAL_MP && iLocal_281 == 0 && iLocal_94 == 0)
			{
				unk_0x9FD96C5DE6EDFC15(Global_20364, "SET_DATA_SLOT");
				unk_0xC6A3EF6C4A3412C1(4);
				unk_0xC6A3EF6C4A3412C1(0);
				...
				for (i = 0; i < 37; i = i + 1)
				{
					unk2 = unk_0x45816CECE89B5B19(&Global_7572[i /*14*/]);
				
					if (unk_0x4310A0DB886F9FED(unk2, &uLocal_84))
					{
						iLocal_281 = 1;
						uLocal_282 = { Global_7572[i /*14*/].f_4 };
						uLocal_286 = { Global_7572[i /*14*/].f_8 };
					}
				}
			
				if (iLocal_281 == 0)
				{
					iLocal_88 = unk_0xA7D1818D200CD09B(&uLocal_84);
				
					if (iLocal_88 > 6)
					{
						TEXT_LABEL_ASSIGN_STRING(&uLocal_292[0], unk_0x8B26749839E18CBE(&uLocal_84, 0, 1), 4);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_292[1], unk_0x8B26749839E18CBE(&uLocal_84, 1, 2), 4);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_292[2], unk_0x8B26749839E18CBE(&uLocal_84, 2, 3), 4);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_292[3], unk_0x8B26749839E18CBE(&uLocal_84, 3, 4), 4);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_292[4], unk_0x8B26749839E18CBE(&uLocal_84, 4, 5), 4);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_292[5], unk_0x8B26749839E18CBE(&uLocal_84, 5, 6), 4);
					
						if (unk_0x4310A0DB886F9FED(&uLocal_292[0], "1") && unk_0x4310A0DB886F9FED(&uLocal_292[1], "9") && unk_0x4310A0DB886F9FED(&uLocal_292[2], "9") && unk_0x4310A0DB886F9FED(&uLocal_292[3], "9"))
						{
							num2 = func_144(&uLocal_292[4]);
							num3 = func_144(&uLocal_292[5]);
							func_143(num2, num3);
							iLocal_281 = 1;
						}
						...
						if (iLocal_281 == 0)
						{
							if (iLocal_88 == 10 || iLocal_88 == 7)
							{
								if (iLocal_88 == 10)
								{
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[0], unk_0x8B26749839E18CBE(&uLocal_84, 3, 4), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[1], unk_0x8B26749839E18CBE(&uLocal_84, 4, 5), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[2], unk_0x8B26749839E18CBE(&uLocal_84, 5, 6), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[3], unk_0x8B26749839E18CBE(&uLocal_84, 6, 7), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[4], unk_0x8B26749839E18CBE(&uLocal_84, 7, 8), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[5], unk_0x8B26749839E18CBE(&uLocal_84, 8, 9), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[6], unk_0x8B26749839E18CBE(&uLocal_84, 9, 10), 4);
								}
								else
								{
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[0], unk_0x8B26749839E18CBE(&uLocal_84, 0, 1), 4);
									...
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[4], unk_0x8B26749839E18CBE(&uLocal_84, 4, 5), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[5], unk_0x8B26749839E18CBE(&uLocal_84, 5, 6), 4);
									TEXT_LABEL_ASSIGN_STRING(&uLocal_292[6], unk_0x8B26749839E18CBE(&uLocal_84, 6, 7), 4);
								}
							
								if (unk_0x4310A0DB886F9FED(&uLocal_292[0], "5") && unk_0x4310A0DB886F9FED(&uLocal_292[1], "5") && unk_0x4310A0DB886F9FED(&uLocal_292[2], "5") && unk_0x4310A0DB886F9FED(&uLocal_292[3], "0") && unk_0x4310A0DB886F9FED(&uLocal_292[4], "1"))
								{
									num4 = func_144(&uLocal_292[5]);
									num5 = func_144(&uLocal_292[6]);
									func_143(num4, num5);
									iLocal_281 = 1;
								}
							}
			...
			{
				if (func_145(Global_7568, Global_20383) == 2 || Global_7568 == _CHAR_TAXI_IS)
				{
...
BOOL func_137(eCharacter echParam0, eCharacter echParam1) // Position - 0xB56E
{
...
void func_138(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xB58A
{
	eCharacter character;
	...
	if (Global_117[echParam0 /*10*/].f_8 != 169)
	{
		...
		{
			if (func_145(echParam0, echParam1) == 1 && func_80(echParam0, echParam1) == 1)
				bParam2 = false;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xB77D
{
	return Global_2028[character /*29*/].f_3;
}

void func_141(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0xB790
{
...
void func_142(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0xB7D5
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return;
...
void func_143(int iParam0, int iParam1) // Position - 0xB81A
{
	...
	{
		case 7:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN1", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANS_M_USA1", 24);
			break;
	
		case 8:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN2", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANS_F_USA1", 24);
			break;
	
		case 9:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN3", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANS_M_ENG1", 24);
			break;
	
		case 10:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN4", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANS_M_USA2", 24);
			break;
	
		case 11:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN5", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANS_M_ASIAN", 24);
			break;
	
		case 12:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN6", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANS_F_USA2", 24);
			break;
	
		case 13:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN7", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANSWER_FX", 24);
			break;
	
		case 14:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN8", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANSWER_FX", 24);
			break;
	
		case 15:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN9", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANSWER_FX", 24);
			break;
	
		case 16:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_282, "ANS_RAN10", 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_286, "ANSWER_FX", 24);
			break;
...
int func_144(var uParam0) // Position - 0xBA53
{
...
int func_145(eCharacter echParam0, eCharacter echParam1) // Position - 0xBCF0
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;

	return Global_2028[echParam0 /*29*/].f_12[echParam1];
}

BOOL func_146() // Position - 0xBD1A
{
	if (Global_78558)
		return false;
...
void func_152() // Position - 0xC118
{
	if (func_150())
		if (Global_20589 == 0)
			unk_0x8C27BB4299B24A0D(3);
		else
			unk_0x8C27BB4299B24A0D(4);
...
void func_157(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0xC1FB
{
...
void func_158(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6) // Position - 0xC2AE
{
	unk_0x9FD96C5DE6EDFC15(uParam0, sParam1);
	func_81(sParam2);
...
void func_159() // Position - 0xC309
{
	...
	unk = 12;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[0 /*5*/], "CELL_900" /*0*/, 16);
	Global_8961[0 /*5*/].f_4 = 10;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[1 /*5*/], "CELL_901" /*1*/, 16);
	Global_8961[1 /*5*/].f_4 = 0;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[2 /*5*/], "CELL_902" /*2*/, 16);
	Global_8961[2 /*5*/].f_4 = 1;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[3 /*5*/], "CELL_903" /*3*/, 16);
	Global_8961[3 /*5*/].f_4 = 2;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[4 /*5*/], "CELL_904" /*4*/, 16);
	Global_8961[4 /*5*/].f_4 = 3;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[5 /*5*/], "CELL_905" /*5*/, 16);
	Global_8961[5 /*5*/].f_4 = 4;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[6 /*5*/], "CELL_906" /*6*/, 16);
	Global_8961[6 /*5*/].f_4 = 5;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[7 /*5*/], "CELL_907" /*7*/, 16);
	Global_8961[7 /*5*/].f_4 = 6;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[8 /*5*/], "CELL_908" /*8*/, 16);
	Global_8961[8 /*5*/].f_4 = 7;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[9 /*5*/], "CELL_909" /*9*/, 16);
	Global_8961[9 /*5*/].f_4 = 8;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[10 /*5*/], "CELL_910" /***/, 16);
	Global_8961[10 /*5*/].f_4 = 9;
	TEXT_LABEL_ASSIGN_STRING(&Global_8961[11 /*5*/], "CELL_911" /*#*/, 16);
...
void func_160(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xC4B5
{
	unk_0x9FD96C5DE6EDFC15(uParam0, sParam1);
	unk_0xC6A3EF6C4A3412C1(SYSTEM::ROUND(fParam2));
...
BOOL func_163(int iParam0, int iParam1, int iParam2) // Position - 0xC552
{
...
void func_164() // Position - 0xC5C4
{
	...
	{
		bLocal_108 = false;
		unk_0xECDAB41968FF21A8(&Global_8254, 0);
		func_84();
		Global_20361 = 1;
		...
		if (func_163(2, Global_20352, 0))
		{
			if (!func_146())
			{
				...
				if (echLocal_69 > CHAR_MICHAEL)
				{
					...
					echLocal_77 = unk_0x67FFE44BB8589F1E(uLocal_74);
					flag = false;
				
					if (unk_0x67EBFCF2F78761B9())
						if (Global_78558)
							if (echLocal_77 < echLocal_72)
								flag = true;
						else if (echLocal_77 == echLocal_71 || echLocal_77 > echLocal_71)
							flag = true;
					...
					if (flag)
					{
						uLocal_306.f_2936 = echLocal_77 - echLocal_71;
						func_170();
					}
					else
					{
						if (echLocal_77 < CHAR_MICHAEL)
							echLocal_77 = CHAR_MICHAEL;
					
						Global_7568 = Global_20389[echLocal_77];
						...
						if (iLocal_65 == 0)
						{
							if (IS_BIT_SET(Global_8253, 9))
							{
								if (!IS_BIT_SET(Global_8253, 29))
								{
									func_169(Global_7568, 1);
								
									if (func_80(Global_7568, Global_20383) == 0)
										func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(1), -1f, -1f, "CELL_288" /*Photo(s) sent.*/, "CELL_300" /*CHAR_DEFAULT*/, &(Global_117[Global_7568 /*10*/].f_4), "CELL_195" /*Unknown*/, 0);
									else
										func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(1), -1f, -1f, "CELL_288" /*Photo(s) sent.*/, &(Global_2028[Global_7568 /*29*/].f_7), &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_3), 0);
								
									func_157(Global_20364, "SET_SOFT_KEYS", 2f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
									func_160(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
									unk_0xECDAB41968FF21A8(&Global_8253, 29);
								}
							}
							else
							{
								...
								if (Global_78558)
								{
									for (i = 0; i < 4; i = i + 1)
									{
										if (unk_0x4310A0DB886F9FED(&(Global_2028[Global_7568 /*29*/].f_3), &Global_8156[i /*24*/]))
										{
											if (!unk_0x4310A0DB886F9FED(&(Global_8156[i /*24*/].f_8), "CELL_SFUN_NULL" /*This is a dummy and should not be displayed but is referenced by script. Please leave.*/))
											{
												bLocal_301 = true;
												iLocal_303 = i;
											}
								...
								else
								{
									for (j = 0; j < 4; j = j + 1)
									{
										if (unk_0x4310A0DB886F9FED(&(Global_2028[Global_7568 /*29*/].f_3), &Global_8091[j /*16*/]))
										{
											if (!unk_0x4310A0DB886F9FED(&(Global_8091[j /*16*/].f_8), "CELL_SFUN_NULL" /*This is a dummy and should not be displayed but is referenced by script. Please leave.*/))
											{
												bLocal_301 = true;
												iLocal_303 = j;
												iLocal_303 == iLocal_303;
											}
										}
									}
								}
							
								if (func_167(Global_7568) && IS_BIT_SET(Global_8254, 0) == false)
									if (func_135(Global_7568, Global_20383) == false && func_87(Global_7568, Global_20383) == false)
										bLocal_302 = false;
									else
										bLocal_302 = true;
								...
								else if (bLocal_302 == false && bLocal_301 == false)
								{
									Global_22839 = 0;
									Global_22838 = 0;
									Global_22840 = false;
								
									if (IS_BIT_SET(Global_8254, 19) && Global_7568 == _CHAR_DETONATEBOMB_JAY_NORRIS)
									{
									}
									else
									{
...
void func_166() // Position - 0xC92C
{
	...
	{
		case CHAR_TREVOR:
			func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(0), 0f, -1f, -1f, "CELL_7001" /*  A: Kill Trevor*/, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), 0, 0);
			break;
	
		case CHAR_MICHAEL:
			func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(0), 0f, -1f, -1f, "CELL_7002" /*  B: Kill Michael*/, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), 0, 0);
			break;
	
		case CHAR_LESTER:
			func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(0), 0f, -1f, -1f, "CELL_7003" /*  C: Deathwish*/, &(Global_2028[Global_7568 /*29*/].f_3), "CELL_E_311" /*CHAR_LESTER_DEATHWISH*/, 0, 0);
			break;
	}

	if (Global_20371)
		func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_212" /*YES*/, 0, 0, 0, 0);
	else
		func_157(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);

	if (Global_20371)
		func_157(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	else
		func_157(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, 0, 0, 0, 0, 0);

	func_157(Global_20364, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
	func_160(Global_20364, "DISPLAY_VIEW", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_158(Global_20364, "SET_HEADER", "CELL_249" /*Are you sure?*/, 0, 0, 0, 0);
	return;
}

BOOL func_167(eCharacter echParam0) // Position - 0xCACD
{
	switch (Global_20383)
	{
		case CHAR_MICHAEL:
...
BOOL func_168(eCharacter echParam0, eCharacter echParam1) // Position - 0xCB3F
{
	eCharacter character;
	int num;
	int num2;
...
void func_169(eCharacter echParam0, int iParam1) // Position - 0xCBAF
{
	Global_2028[echParam0 /*29*/].f_18 = iParam1;

	if (echParam0 < _CHAR_UNUSED)
		Global_113648.f_28052[echParam0 /*29*/].f_18 = iParam1;
...
void func_170() // Position - 0xCBD8
{
	...
	if (Global_20383.f_1 > 3)
	{
		...
		if (func_173(&uLocal_306))
			str = unk_0x1D25117F71EE3811(uLocal_306[uLocal_306.f_2936]);
		else
			str = func_171(&(uLocal_306.f_34[func_172(uLocal_306.f_2936, &uLocal_306) /*29*/].f_13));
...
char* func_171(var uParam0) // Position - 0xCD4D
{
	return uParam0;
}
...
BOOL func_173(var uParam0) // Position - 0xCD75
{
...
void func_174(var uParam0) // Position - 0xCD8E
{
	...
	if (func_184(uParam0, &unk35))
	{
		if (func_173(uParam0))
		{
			...
			str = unk_0x1D25117F71EE3811(uParam0->[uParam0->f_2936]);
		}
		else
		{
			uParam0->f_2963 = { uParam0->f_34[func_172(uParam0->f_2936, uParam0) /*29*/] };
			str = func_171(&(uParam0->f_34[func_172(uParam0->f_2936, uParam0) /*29*/].f_13));
		}
	
		TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_2983), str, 64);
		flag = false;
	
		if (unk_0xE4E414D9542FB0F6())
			if (!Global_1836619)
				if (func_182(unk_0x93E99A2DBCBA9CFA()))
					flag = true;
	
		if (func_173(uParam0))
			if (unk_0x764F83C4E9B8EC98(uParam0->[uParam0->f_2936]) || unk_0xFC6DD04E4AEEDC5C(uParam0->[uParam0->f_2936]) || unk_0xDB4A1C7F0B5AE3BB(uParam0->[uParam0->f_2936]) || unk_0x54C0260489231CA3(uParam0->[uParam0->f_2936]))
				flag = false;
	
		if (!unk_0x1D05BD8EFF80B3E3())
			flag = false;
	
		if (unk_0x18AAD5971C8018AE(0))
			flag = false;
	
		if (unk_0xC35AE9D997FE51CE(&(uParam0->f_2963)) || unk_0xE2B60D8572F75482(&(uParam0->f_2963)))
			flag = false;
	
		if (unk_0xB87D84A47AA15946(&(uParam0->f_2963)) || unk_0x2B9D0D80BB05E4C7(&(uParam0->f_2963)))
			flag = false;
		...
		if (flag)
		{
			if (Global_78558)
			{
				unk_0x9FD96C5DE6EDFC15(Global_20364, "SET_DATA_SLOT_EMPTY");
				unk_0xC6A3EF6C4A3412C1(num);
				unk_0xAE3413B0654A0035();
				unk_0x9FD96C5DE6EDFC15(Global_20364, "SET_DATA_SLOT");
				unk_0xC6A3EF6C4A3412C1(18);
				unk_0xC6A3EF6C4A3412C1(num);
				unk_0xC6A3EF6C4A3412C1(0);
			
				if (!Global_2800023.f_1 || Global_2800023.f_38)
				{
					unk_0x2AF11E92DE43CDE3("CELL_MP_1000" /*Call*/);
					unk_0xF8FCA9E7130CE1C8();
				}
				else
				{
					unk_0x2AF11E92DE43CDE3("CELL_MP_1000b" /*End Call*/);
					unk_0xF8FCA9E7130CE1C8();
				}
		...
		if (func_173(uParam0))
		{
			unk36 = { func_183(uParam0->[uParam0->f_2936]) };
		
			if (func_182(unk_0x93E99A2DBCBA9CFA()) && func_182(uParam0->[uParam0->f_2936]) && unk_0xB5A253A41752D095(&unk36))
				flag = true;
		}
		...
		if (flag)
		{
			...
			unk_0xC6A3EF6C4A3412C1(num);
			unk_0xC6A3EF6C4A3412C1(0);
			unk_0x2AF11E92DE43CDE3("CELL_MP_1009" /*Send Message*/);
			unk_0xF8FCA9E7130CE1C8();
			unk_0xAE3413B0654A0035();
		...
		if (func_173(uParam0))
			if (unk_0x8220292E15406027() < unk_0x32AE1B0EEB0BAE00())
				if (!unk_0xF27423FF2D483551(&(uParam0->f_2963)))
					flag = true;
		...
		if (flag)
		{
			...
			unk_0xC6A3EF6C4A3412C1(num);
			unk_0xC6A3EF6C4A3412C1(0);
			unk_0x2AF11E92DE43CDE3("PIM_DFRQ2" /*Send Friend Request*/);
			unk_0xF8FCA9E7130CE1C8();
			unk_0xAE3413B0654A0035();
		...
		if (flag)
		{
			...
			unk_0xC6A3EF6C4A3412C1(num);
			unk_0xC6A3EF6C4A3412C1(0);
			unk_0x2AF11E92DE43CDE3("CELL_MP_1007" /*View Profile*/);
			unk_0xF8FCA9E7130CE1C8();
			unk_0xAE3413B0654A0035();
		...
		if (unk_0xE52BCF7D5014E06E())
			if (unk_0x7DD2CE58D33238D9(&(uParam0->f_2963)))
				unk_0xEB463FCE742A28B2(&num2, 35, &(uParam0->f_2963));
	
		if (num2 != -1)
		{
			if (num2.f_21 == 1)
			{
				if (unk_0x56046AEC15223442() && !func_179(num2))
				{
					flag = true;
		...
		if (flag)
		{
			...
			unk_0xC6A3EF6C4A3412C1(num);
			unk_0xC6A3EF6C4A3412C1(0);
			unk_0x2AF11E92DE43CDE3("CELL_MP_1003" /*Join Crew*/);
			unk_0xF8FCA9E7130CE1C8();
			unk_0xAE3413B0654A0035();
		...
		unk_0x061B1200C95204CB(&Global_8255, 6);
		flag = false;
		...
		if (func_173(uParam0))
		{
			...
			{
				if (unk_0x44C1C56CBB49373F(unk_0x93E99A2DBCBA9CFA(), uParam0->[uParam0->f_2936]))
				{
					if (!func_177(uParam0->[uParam0->f_2936], 0))
					{
						if (!IS_BIT_SET(Global_2657589[uParam0->[uParam0->f_2936] /*466*/].f_199, 2))
						{
							flag = true;
							unk_0xECDAB41968FF21A8(&Global_8255, 6);
						}
					}
				}
			}
		...
		if (flag)
		{
			...
			if (!IS_BIT_SET(Global_2672505.f_985, uParam0->[uParam0->f_2936]))
				unk_0x2AF11E92DE43CDE3("CELL_MP_1008" /*Highlight*/);
			else
				unk_0x2AF11E92DE43CDE3("CELL_MP_1008b" /*Remove Highlight*/);
	...
	{
		unk_0xD30970E11AD0FF0D("CELL_LEFT_SESS" /*The selected contact is no longer available.*/);
...
BOOL func_175(int iParam0, int iParam1) // Position - 0xD31E
{
...
BOOL func_176(int iParam0) // Position - 0xD33E
{
	int num;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0xD377
{
	int num;
...
BOOL func_179(int iParam0) // Position - 0xD3D7
{
	int num;
	int i;

	if (unk_0xE52BCF7D5014E06E() && unk_0x56046AEC15223442())
	{
		...
		if (num > 0)
		{
			for (i = 0; i < num; i = i + 1)
			{
				unk_0x0CCFD7CFEE4C0567(&Global_2764131, i);
...
BOOL func_182(int iParam0) // Position - 0xD453
{
	int num;
	var unk;
	...
	if (unk_0x674D69D3896862C7() || func_180())
		if (unk_0x29F2DE8E71A61D03(0, num))
			if (unk_0x1D05BD8EFF80B3E3())
				return true;

	if (unk_0xCCE9BCDAB8B7FAED() || func_181())
	{
		if (iParam0 == unk_0x93E99A2DBCBA9CFA())
		{
...
struct<13> func_183(Player plParam0) // Position - 0xD52C
{
	var unk;
...
BOOL func_184(var uParam0, var uParam1) // Position - 0xD543
{
	int num;
	...
	else
	{
		...
		if (unk_0x109791441E629B4E(&uParam0->f_34[num /*29*/]))
			return true;
		else
			*uParam1 = 0;
	}
...
void func_186() // Position - 0xD5E5
{
	...
	if (unk_0x42AAFCB5B7854AA9(2))
	{
		if (func_163(2, 181, 0))
		{
			if (echLocal_73 > CHAR_MICHAEL)
				echLocal_73 = echLocal_73 - 1;
			else
				echLocal_73 = echLocal_69 - 1;
		...
		if (func_163(2, 180, 0))
		{
			...
			if (echLocal_73 == echLocal_69)
				echLocal_73 = CHAR_MICHAEL;
...
void func_189() // Position - 0xD793
{
	...
	{
		echLocal_73 = CHAR_MICHAEL;
		unk_0x061B1200C95204CB(&Global_8253, 16);
	}
	...
	if (Global_78558)
		if (echLocal_77 > echLocal_72 || echLocal_77 == echLocal_72)
			if (Global_22756 == Global_20389[echLocal_77])
				unk_0x061B1200C95204CB(&Global_8253, 16);
	else if (Global_22756 == Global_20389[echLocal_77])
		unk_0x061B1200C95204CB(&Global_8253, 16);
...
void func_190() // Position - 0xD835
{
	...
	if (IS_BIT_SET(Global_8255, 6))
	{
		if (!unk_0xB4D0EFD6A033F949(&(uLocal_306.f_2963)))
		{
			unk_0x061B1200C95204CB(&Global_8255, 6);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_84, "", 16);
			Global_20383.f_1 = 3;
	...
	switch (uLocal_306.f_2999)
	{
		case 0:
			if (IS_BIT_SET(iLocal_300, 1))
			{
				if (!Global_100733.f_1474)
				{
					unk_0x061B1200C95204CB(&iLocal_300, 0);
					unk_0x061B1200C95204CB(&iLocal_300, 1);
				}
			
				return;
			}
		
			if (uLocal_306.f_2976)
			{
				if (uLocal_306.f_2981)
				{
					instructionalKey = 2;
					...
					if (uLocal_306.f_2982)
					{
						if (func_163(2, Global_20352, 0) || unk_0x51EB177CA0562B62(2, 201))
							Global_20383.f_1 = 3;
					}
					else if (func_163(2, Global_20352, 0) || unk_0x51EB177CA0562B62(2, 201))
					{
					}
					else
					{
				...
				{
					iLocal_75 = uLocal_306.f_2946;
				
					switch (uLocal_306.f_2937[uLocal_306.f_2946])
					{
						case 1:
							if (!Global_2800023.f_1)
							{
								if (!unk_0x6FABEE1878F226F1() && !unk_0x2592BB24A6BD966B())
								{
									uLocal_306.f_2976 = 0;
									func_292();
									uLocal_306.f_2977 = 0;
									...
									func_291(str);
									uLocal_306.f_2999 = 1;
									_STOPWATCH_DESTROY(&(uLocal_306.f_2979));
									func_289(false);
								
									if (Global_78558)
									{
										num4 = Global_262145.f_172;
									
										if (!unk_0x6C14306DA3F08F67(num4, 0, 1, 0, &unk50, -1, 0))
											num4 = num4 - unk50;
									
										unk37 = { func_183(unk_0x93E99A2DBCBA9CFA()) };
										...
										if (num4 > 0)
										{
											if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
											{
												...
												Global_4535172[num /*85*/].f_14 = { unk37 };
											}
											else
											{
												unk_0x1DC0E583651677AE(num4, &unk37, 0, 1);
											}
										}
									
										_MPCHAR_STAT_INCREMENT_INT(MP_STAT_CALLS_MADE_TO_PLAYERS, 1, -1);
									}
								}
								else if (unk_0x6FABEE1878F226F1())
								{
								}
								else if (unk_0x2592BB24A6BD966B())
								{
						...
						case 2:
							if (_STOPWATCH_IS_INITIALIZED(&Global_2793044.f_369[uLocal_306[uLocal_306.f_2936] /*2*/]))
							{
								if (!_STOPWATCH_HAS_TIME_PASSED(&Global_2793044.f_369[uLocal_306[uLocal_306.f_2936] /*2*/], 30000, false))
								{
									if (func_259(false, false, 1, true))
										func_249("CELL_MP_1009H" /*There is a short wait before you can send another message to ~a~.*/, unk_0x1D25117F71EE3811(uLocal_306[uLocal_306.f_2936]), func_250(uLocal_306[uLocal_306.f_2936], -2, false, false, false), -1);
							...
							unk51 = { func_183(uLocal_306[uLocal_306.f_2936]) };
						
							if (!func_182(unk_0x93E99A2DBCBA9CFA()) || !func_182(uLocal_306[uLocal_306.f_2936]) || !unk_0xB5A253A41752D095(&unk51))
							{
								if (func_259(true, true, 1, true))
									if (!unk_0x4310A0DB886F9FED(unk_0x1D25117F71EE3811(uLocal_306[uLocal_306.f_2936]), "**Invalid**"))
										func_249("CELL_MP_1009M" /*It is currently not possible to send a message to ~a~.*/, unk_0x1D25117F71EE3811(uLocal_306[uLocal_306.f_2936]), func_250(uLocal_306[uLocal_306.f_2936], -2, false, false, false), -1);
									else
						...
						case 3:
							if (!unk_0x26D34C9D3149CF26())
							{
								if (unk_0x674D69D3896862C7() && !unk_0xF27423FF2D483551(&(uLocal_306.f_2963)))
								{
									if (unk_0xBAD78A70D4F44C01(&(uLocal_306.f_2963), ""))
									{
										uLocal_306.f_2976 = 0;
										Global_20383.f_1 = 3;
									}
								...
								{
									unk_0xE2D2481921E7139F(&(uLocal_306.f_2963));
									uLocal_306.f_2976 = 0;
									Global_20383.f_1 = 3;
								}
							}
						...
						case 5:
							if (unk_0xE52BCF7D5014E06E())
								if (unk_0x7DD2CE58D33238D9(&(uLocal_306.f_2963)))
									unk_0xEB463FCE742A28B2(&num3, 35, &(uLocal_306.f_2963));
							...
							if (num3 != -1)
							{
								if (num3.f_21 == 1)
								{
									if (!func_179(num3))
									{
										if (unk_0x7AF7C8E1B0F72B85(num3))
										{
											uLocal_306.f_2976 = 0;
											unk_0xD30970E11AD0FF0D("CREW_JOIN" /*You are now a member of Crew ~a~.*/);
											unk_0x76B34CBB6F5FA1BB(&(num3.f_1));
											unk_0xEAFC6135DF75DE92(1, 1);
											Global_20383.f_1 = 3;
										}
										else
						...
						case 7:
							if (IS_BIT_SET(Global_2672505.f_985, uLocal_306[uLocal_306.f_2936]))
							{
								unk_0x061B1200C95204CB(&(Global_2672505.f_985), uLocal_306[uLocal_306.f_2936]);
							}
							else
							{
								Global_2672505.f_985 = 0;
								unk_0xECDAB41968FF21A8(&(Global_2672505.f_985), uLocal_306[uLocal_306.f_2936]);
							}
			...
			else if (Global_20361 == 0)
			{
				if (func_163(2, Global_20352, 0))
				{
					...
					uLocal_306.f_2946 = unk_0x67FFE44BB8589F1E(uLocal_74);
				
					if (!func_184(&uLocal_306, &num2))
					{
						switch (num2)
						{
							case 0:
		...
		case 1:
			...
			else if (uLocal_306.f_2977)
			{
				if (!uLocal_306.f_2978)
				{
					if (!Global_2800023.f_1 || !unk_0xF75616BEC61DE790())
					{
						func_289(true);
						func_275();
						uLocal_306.f_2978 = 1;
					...
					if (unk_0x67EBFCF2F78761B9())
					{
						...
						if (IS_GAMER_HANDLE_VALID(Global_2800023.f_20))
						{
					...
					if (!Global_2800023.f_37)
					{
						...
						{
							if (_STOPWATCH_HAS_TIME_PASSED(&(uLocal_306.f_2979), 40000, true))
							{
								func_289(true);
								func_275();
								uLocal_306.f_2978 = 1;
			...
			else if (!_STOPWATCH_IS_INITIALIZED(&(uLocal_306.f_2979)))
			{
				_STOPWATCH_DESTROY(&(uLocal_306.f_2979));
				_STOPWATCH_INITIALIZE(&(uLocal_306.f_2979), true, false);
			}
			else
			{
				if (_STOPWATCH_HAS_TIME_PASSED(&(uLocal_306.f_2979), 15000, true))
				{
					func_275();
					func_84();
					func_294();
				...
				if (Global_2800023.f_1)
				{
					if (func_242(&uLocal_306, &(uLocal_306.f_2983)))
					{
						_STOPWATCH_RESET(&(uLocal_306.f_2979), true, false);
						uLocal_306.f_2978 = 0;
						uLocal_306.f_2977 = 1;
		...
		case 2:
			if (iLocal_3325 == 1)
			{
				if (func_233(&iLocal_3306, &(iLocal_3306.f_1), &(iLocal_3306.f_2), false, false, &uLocal_3309, false, 0, true, false, 0, false, false, false, false, false, 0, false, 0, false, false, false, true, false, false, false, false, false, false, false, -1, -1, false, 0, false, -1, false, false))
				{
					TEXT_LABEL_ASSIGN_STRING(&uLocal_3309, unk_0x40A7A06EA6080731(), 64);
					iLocal_3306 = 0;
					iLocal_3306.f_2 = 0;
					iLocal_3306.f_1 = 0;
					iLocal_3325 = 0;
					_STOPWATCH_RESET(&Global_2793044.f_369[uLocal_306[uLocal_306.f_2936] /*2*/], false, false);
				
					if (unk_0x2AC37494BBF1DB16(&uLocal_3309))
					{
					}
					else
					{
						uLocal_3326 = unk_0xA7D1818D200CD09B(&uLocal_3309);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_3309, unk_0x86EAEFF7B19AC59D(&uLocal_3309, 0, uLocal_3326, 63), 64);
						unk64 = { func_183(uLocal_306[uLocal_306.f_2936]) };
						unk_0xC04A28EC77E3E0F8(&uLocal_3309, &unk64);
						_THEFEED_SHOW_PLAYER_MESSAGE("CP_TM_SENT" /*Your message has been sent to ~a~.*/, uLocal_306[uLocal_306.f_2936], false, 0, false, true, false);
						_MPCHAR_STAT_INCREMENT_INT(MP_STAT_TEXTS_SENT_TO_PLAYERS, 1, -1);
					}
...
int _THEFEED_SHOW_PLAYER_MESSAGE(char* sParam0, Player plParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xE1DF
{
	int num;
	int num2;
	var unk;
	...
	if (unk_0x44C1C56CBB49373F(unk_0x93E99A2DBCBA9CFA(), plParam1) || iParam3)
	{
		...
		if (num2 != -1 && unk_0x1758F8A8511510AB() && num2 < 4)
			if (Global_4718592.f_108449[num2] != -1)
				unk_0x35451336B8B420D6(func_201(num2, plParam1, false));
			else
				unk_0x35451336B8B420D6(func_250(plParam1, -2, true, false, false));
		else
			unk_0x35451336B8B420D6(func_250(plParam1, -2, true, false, false));
	
		unk_0x76B34CBB6F5FA1BB(func_199(&unk));
		...
		{
			Global_2764201 = { func_183(plParam1) };
		...
		func_192(14, sParam0, 1, &unk, 0, 0, 0, 0, 1, 0, 0, 0);
	}
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xE542
{
	BOOL flag;
...
var func_200(var uParam0) // Position - 0xE62E
{
	return uParam0;
}

int func_201(int iParam0, Player plParam1, BOOL bParam2) // Position - 0xE638
{
	int num;
	int num2;
	int num3;
	...
	if (iParam0 > -1 && plParam1 != _INVALID_PLAYER_INDEX())
	{
		...
		if (IS_BIT_SET(Global_4718592.f_15, 26) && !func_203(iParam0, unk_0x4292F1DE8BA2D22E(plParam1), 0, -1))
			num = func_202(true);
	}
	else
	{
...
BOOL func_203(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE7CF
{
	int num;
	int num2;
...
BOOL func_204(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xEB1A
{
	BOOL num;
	Player player;
	var unk;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(player, true, true) || _NETWORK_IS_PLAYER_IN_SCTV(player, 0) || IS_BIT_SET(Global_2657589[player /*466*/].f_199, 2) || func_205(player))
		{
		}
...
BOOL func_205(Player plParam0) // Position - 0xEC46
{
...
int func_207(Player plParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xED33
{
	int num;
	...
	{
		if (iParam2 > -1)
			if (func_203(num, iParam2, 0, -1) && !IS_BIT_SET(Global_4718592.f_15, 18))
				if (num == iParam2)
				...
				return func_208(num, iParam2, true, 4);
			else
				return func_208(num, iParam2, false, 4);
...
int func_208(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xEE35
{
	...
	if (func_209(*Global_4718592.f_113724, true))
		if (num == 1)
			num = 0;
...
BOOL func_209(int iParam0, BOOL bParam1) // Position - 0xEF4D
{
	int i;
...
int func_219(Player plParam0) // Position - 0xF1BD
{
	if (!plParam0 == _INVALID_PLAYER_INDEX())
		if (_IS_PLAYER_IN_AN_ORGANIZATION(plParam0, true))
			return Global_2648605.f_818.f_11[func_220(plParam0)];

	return -1;
}

Player func_220(Player plParam0) // Position - 0xF1EF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL _IS_PLAYER_IN_AN_ORGANIZATION(Player plParam0, BOOL bCanBeBoss) // Position - 0xF212
{
	if (!bCanBeBoss)
...
BOOL _IS_PLAYER_BOSS_OF_ORGANIZATION(Player plParam0) // Position - 0xF23D
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_224() // Position - 0xF2DA
{
	return func_225(*Global_4718592.f_113724);
}

BOOL func_225(var uParam0) // Position - 0xF2F0
{
	int i;
...
BOOL func_226() // Position - 0xF31F
{
	return func_227(*Global_4718592.f_113724);
}

BOOL func_227(int iParam0) // Position - 0xF335
{
	int i;
...
BOOL func_228() // Position - 0xF36F
{
	return Global_2683862.f_24;
}

BOOL func_229() // Position - 0xF37D
{
	return Global_2683862.f_21;
}

BOOL func_230() // Position - 0xF38B
{
	...
	switch (*uParam2)
	{
		case 0:
			if (bParam3)
			{
				...
				if (unk_0x2AC37494BBF1DB16(uParam5))
					unk_0x184596BE84DF2E5D(num4, str, str2, "", "", "", "", num3);
				else
					unk_0x184596BE84DF2E5D(num4, str, str2, uParam5, iParam10, "", "", num3);
			}
			else
			{
				if (unk_0xCC17806DB0C41C19())
				...
				if (bParam4)
				{
					...
					if (unk_0x2AC37494BBF1DB16(&(Global_4718592.f_113731)))
						unk_0x184596BE84DF2E5D(num5, str, str2, "", "", "", "", num6);
					else
						unk_0x184596BE84DF2E5D(num5, str, str2, &(Global_4718592.f_113731), "", "", "", num6);
				}
				else if (bParam32)
				{
					str = "CST_KEY_TEXT";
					...
					if (unk_0x2AC37494BBF1DB16(&(Global_4718592.f_166915)))
						...
						unk_0x184596BE84DF2E5D(num5, str, str2, &(Global_4718592.f_166915), "", "", "", num6);
				}
				else if (bParam25)
				{
					if (*uParam1 == 0)
				...
				else if (iParam30 != -1)
				{
					...
					num6 = 60;
					unk_0xA2BF191A93E2DA88(2);
					unk2 = { Global_4718592.f_166947[iParam30 /*16*/] };
				
					if (iParam31 > -1)
						unk2 = { Global_4718592.f_167028[iParam30 /*65*/][iParam31 /*16*/] };
					...
					if (unk_0x2AC37494BBF1DB16(&unk2))
						...
						unk_0x184596BE84DF2E5D(num5, str, str2, &unk2, "", "", "", num6);
				}
				else if (bParam27)
				{
					if (*uParam1 == 0)
				...
				else if (bParam13)
				{
					...
					if (unk_0x2AC37494BBF1DB16(uParam5))
						...
						unk_0x184596BE84DF2E5D(num5, str, str2, uParam5, "", "", "", num6);
				}
				else if (bParam9)
				{
					...
					for (j = 0; j <= 7; j = j + 1)
					{
						if (unk_0xB71C73D0269747D5(&Global_4718592.f_113882[j /*16*/]))
							TEXT_LABEL_ASSIGN_STRING(&Global_4718592.f_113882[j /*16*/], "", 64);
					}
				
					unk_0x5C75DEF222A16610(num5, str, str2, &Global_4718592.f_113882[0 /*16*/], &Global_4718592.f_113882[1 /*16*/], &Global_4718592.f_113882[2 /*16*/], &Global_4718592.f_113882[3 /*16*/], &Global_4718592.f_113882[4 /*16*/], &Global_4718592.f_113882[5 /*16*/], &Global_4718592.f_113882[6 /*16*/], &Global_4718592.f_113882[7 /*16*/], num6);
				}
				else if (bParam6)
				{
					if (*uParam1 == 0)
					...
					else
					{
						for (k = 0; k <= 1; k = k + 1)
						{
							if (unk_0xB71C73D0269747D5(&Global_4718592.f_96024[iParam16 /*43*/].f_6[k /*16*/]))
								TEXT_LABEL_ASSIGN_STRING(&Global_4718592.f_96024[iParam16 /*43*/].f_6[k /*16*/], "", 64);
						}
					
						unk_0x184596BE84DF2E5D(num5, str, str2, &Global_4718592.f_96024[iParam16 /*43*/].f_6[0 /*16*/], &Global_4718592.f_96024[iParam16 /*43*/].f_6[1 /*16*/], "", "", num6);
					}
				}
				else if (bParam8)
				{
				...
				else if (bParam14)
				{
					...
					if (unk_0x2AC37494BBF1DB16(uParam5))
						unk_0x184596BE84DF2E5D(0, str, str2, "", "", "", "", num6);
					else
						unk_0x184596BE84DF2E5D(0, str, str2, uParam5, "", "", "", num6);
				}
				else if (bParam28)
				{
					if (*uParam1 == 0)
				...
				else
				{
					...
					for (l = 0; l <= 7; l = l + 1)
					{
						if (unk_0xB71C73D0269747D5(&Global_4718592.f_113753[l /*16*/]))
							TEXT_LABEL_ASSIGN_STRING(&Global_4718592.f_113753[l /*16*/], "", 64);
					}
					...
					if (bParam11)
						unk_0x5C75DEF222A16610(num5, str, str2, uParam5, iParam10, "", "", "", "", "", "", num6);
					else
						unk_0x5C75DEF222A16610(num5, str, str2, &Global_4718592.f_113753[0 /*16*/], &Global_4718592.f_113753[1 /*16*/], &Global_4718592.f_113753[2 /*16*/], &Global_4718592.f_113753[3 /*16*/], &Global_4718592.f_113753[4 /*16*/], &Global_4718592.f_113753[5 /*16*/], &Global_4718592.f_113753[6 /*16*/], &Global_4718592.f_113753[7 /*16*/], num6);
				}
			}
		
			TEXT_LABEL_ASSIGN_STRING(&Global_1925757, "", 64);
			*uParam1 = 0;
			*uParam2 = 1;
			break;
			...
			switch (*uParam0)
			{
				...
				case 1:
					if (bParam4 || bParam13 || bParam29)
					{
						...
						{
							TEXT_LABEL_ASSIGN_STRING(&Global_1925757, unk_0x40A7A06EA6080731(), 64);
							...
							num2 = unk_0xA7D1818D200CD09B(unk_0x40A7A06EA6080731());
							...
							for (i = 0; i <= num2 - 1; i = i + 1)
							{
								if (*uParam2 != 0)
								{
									if (!unk_0x2AC37494BBF1DB16(&Global_1925757))
									{
										...
										{
											unk = unk_0xA7D1818D200CD09B(&Global_1925757);
											TEXT_LABEL_ASSIGN_STRING(&Global_1925757, unk_0x8B26749839E18CBE(&Global_1925757, 1, unk), 64);
										}
									}
									else
									{
					...
					if (unk_0x48CA9F455EF6AE00(*uParam1))
					{
						if (!unk_0xD49793AA007D176B(*uParam1))
						{
							...
							num = unk_0x9EE5F114168DA207(*uParam1);
							...
							switch (num)
							{
								case 0:
									...
									{
										TEXT_LABEL_ASSIGN_STRING(&Global_1925757, unk_0x40A7A06EA6080731(), 64);
										num2 = unk_0xA7D1818D200CD09B(&Global_1925757);
									
										for (i = 0; i <= num2 - 1; i = i + 1)
										{
											if (*uParam2 != 0)
												if (!unk_0x2AC37494BBF1DB16(&Global_1925757))
													if (unk_0x4310A0DB886F9FED(" ", unk_0x8B26749839E18CBE(&Global_1925757, i, i + 1)))
														*uParam1 = -3;
										}
									}
					...
					if (func_181())
					{
						if (!unk_0x67EBFCF2F78761B9() || func_235() == false || func_234() == 1)
						{
							*uParam1 = 0;
							*uParam2 = 0;
							*uParam0 = 3;
					...
					if (bParam17)
					{
						unk_0xCB4985E4432AAAC3("ERROR_CHECKYACHTNAME" /*Registering your yacht's name.  Please wait...*/);
						unk_0x287337934DFDC8C3(1);
					}
					else if (bParam29)
					{
						unk_0xCB4985E4432AAAC3("ERROR_CHECKVEHICLENAME" /*Registering your vehicle's name.  Please wait...*/);
						unk_0x287337934DFDC8C3(1);
					}
					else
					{
						unk_0xCB4985E4432AAAC3("ERROR_CHECKPROFANITY" /*Checking your text for profanity.  Please wait...*/);
						unk_0x287337934DFDC8C3(1);
					}
...
BOOL func_235() // Position - 0x1070C
{
	if (func_236())
		return false;
...
BOOL func_238() // Position - 0x10746
{
...
void func_239(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10790
{
	int num;

	if (func_240())
	{
		num = Global_2848280[iParam0 /*3*/][func_67(iParam2)];
...
BOOL func_240() // Position - 0x107C2
{
	return true;
}

void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x107CF
{
...
BOOL func_242(var uParam0, char* sParam1) // Position - 0x1080C
{
	if (Global_2800023.f_1)
	{
		if (unk_0xF75616BEC61DE790())
		{
			unk_0x761F5AECC611F87E(&(uParam0->f_2963));
			Global_2800023.f_20 = { uParam0->f_2963 };
			TEXT_LABEL_ASSIGN_STRING(&(Global_2800023.f_4), sParam1, 64);
			return true;
		}
	}
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x1084D
{
	if (pStopwatch->f_1 == 0)
	{
		if (unk_0xA26A9A07F761D8F8() && !useLocalTimer)
...
void func_244() // Position - 0x10892
{
	if (Global_20383.f_1 > 3)
	{
		...
		if (Global_78558)
		{
			if (!unk_0xCC17806DB0C41C19())
			{
				func_157(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 8f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x1094A
{
	return unk_0x73EC603A60C832F3(&uParam0, 13);
}

void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x1095A
{
	iParam2 = iParam2;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x10973
{
...
void func_249(char* sParam0, var uParam1, int iParam2, int iParam3) // Position - 0x1098A
{
...
int func_250(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x109B5
{
	int num;
	var unk;

	if (func_257(plParam0) && !bParam4)
		if (bParam2)
			return 0;
		else
			return 1;
	...
	if (func_257(unk_0x93E99A2DBCBA9CFA()) || func_256() && func_255() && !IS_BIT_SET(Global_2793044.f_4690, 31) && !bParam4)
	{
		unk = func_254();
					...
					if (_NETWORK_IS_PLAYER_VALID(unk_0xB850F932D03EF34D(unk), false, true))
						if (iParam1 > -1 && unk_0x1758F8A8511510AB() && iParam1 < 4)
							if (Global_4718592.f_108449[iParam1] != -1)
								...
								return func_252(plParam0, unk_0xB850F932D03EF34D(unk), iParam1, bParam2, bParam3);
						else
							return func_252(plParam0, unk_0xB850F932D03EF34D(unk), iParam1, bParam2, bParam3);
	...
	if (iParam1 > -1 && unk_0x1758F8A8511510AB() && iParam1 < 4)
		if (Global_4718592.f_108449[iParam1] != -1)
			...
			return func_252(plParam0, unk_0x93E99A2DBCBA9CFA(), iParam1, bParam2, bParam3);
...
{
	return func_207(unk_0x93E99A2DBCBA9CFA(), bParam0, iParam1, bParam2);
}

int func_252(Player plParam0, Player plParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x10BA8
{
	int num;
	BOOL flag;
	Player player;
	...
	if (!flag)
	{
		if (num != -1)
		{
			...
			if (func_253(plParam1, plParam0, num, 0) && !IS_BIT_SET(Global_4718592.f_15, 18) || func_203(unk_0x4292F1DE8BA2D22E(plParam1), unk_0x4292F1DE8BA2D22E(plParam0), 0, -1) && IS_BIT_SET(Global_4718592.f_15, 23) && !IS_BIT_SET(Global_4718592.f_15, 18))
				return func_211(true);
			else if (IS_BIT_SET(Global_4718592.f_15, 26))
				return func_202(true);
			else
				return func_207(plParam1, true, num, bParam4);
		}
...
BOOL func_253(Player plParam0, Player plParam1, int iParam2, int iParam3) // Position - 0x10D40
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
BOOL func_255() // Position - 0x10DC6
{
	return IS_BIT_SET(Global_2621446, 4);
}

BOOL func_256() // Position - 0x10DD4
{
	return IS_BIT_SET(Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_36.f_18, 14);
}

BOOL func_257(Player plParam0) // Position - 0x10DEE
{
...
BOOL func_259(BOOL bParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x10E3B
{
	...
	if (bParam1)
		if (func_266(unk_0x93E99A2DBCBA9CFA(), true, false))
			return false;
...
BOOL _IS_FMMC_ACTIVE() // Position - 0x10F40
{
...
BOOL func_265(int iParam0) // Position - 0x10F87
{
...
BOOL func_266(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10FA3
{
	if (bParam1)
		if (func_267(iParam0))
			return true;
...
BOOL func_268(int iParam0) // Position - 0x10FE3
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x11013
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x11035
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x11093
{
	return uParam0->f_1;
}
...
void _NETSHOPPING_PROCESS_TRANSACTION(int iParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x111F8
{
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SERVICE_SPEND_MAKE_IT_RAIN"):
			if (iParam1 > 0 || Global_262145.f_28375)
				func_277(uParam2, -1135378931, 537254313, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), iParam0, iParam1, num, 7);
			break;
		...
		case joaat("SERVICE_EARN_SPIN_THE_WHEEL_CASH"):
			func_277(uParam2, -1135378931, 1445302971, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), iParam0, iParam1, num, 7);
			break;
	}
...
int func_277(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x11A99
{
	...
	if (!flag)
	{
		if (!unk_0x366262A55539062C(func_68()) || unk_0xF0773A1CAE4717D9())
		{
			Global_4536674 = 1;
			return 0;
		}
	...
	*uParam0 = 15;
	...
	if (flag || flag2 || unk_0x8C722BABE4726C11(&num, iParam3, iParam4, iParam2, iParam5, iParam6))
	{
		...
		{
			*uParam0 = func_284(num, iParam1, iParam4, iParam2, iParam3, iParam5, false, iParam6, iParam7, 1, true);
...
BOOL func_282(int iParam0) // Position - 0x11E26
{
...
int func_284(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x11E65
{
	int i;
	...
	for (i = 0; i < 15; i = i + 1)
	{
		if (Global_4535172[i /*85*/].f_66.f_2 == 0)
		{
			...
			if (iParam1 == -1135378931 && bParam10)
				func_285(Global_4535172[i /*85*/], i);
...
int _GET_PLAYER_SCRIPT_EVENT_BITS(int iParam0) // Position - 0x12044
{
	var unk;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x1205C
{
	if (unk_0xCC17806DB0C41C19())
...
{
	if (bParam0)
		unk_0xECDAB41968FF21A8(&Global_8254, 20);
	else
		unk_0x061B1200C95204CB(&Global_8254, 20);
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x12095
{
	uParam0->f_1 = 0;
	return;
}
...
{
	Global_7568 = CHAR_CHAT_CALL;
	TEXT_LABEL_ASSIGN_STRING(&Global_21740, sParam0, 64);
...
{
	unk_0xA13B5B0EF7402391(uLocal_79);
	unk_0x8A1B9F78F1F46A12(uLocal_79);
	uLocal_306.f_2978 = 0;
	unk_0x061B1200C95204CB(&Global_8253, 16);
	unk_0x061B1200C95204CB(&Global_8253, 9);
	unk_0x061B1200C95204CB(&Global_8253, 29);
	unk_0x061B1200C95204CB(&Global_8254, 20);
	unk_0x061B1200C95204CB(&Global_8254, 0);
	unk_0x061B1200C95204CB(&Global_8254, 18);
...
void func_296() // Position - 0x12274
{
	...
	func_160(Global_20364, "SET_DATA_SLOT_EMPTY", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
	SYSTEM::WAIT(0);
	echLocal_69 = CHAR_MICHAEL;
	bLocal_108 = false;
	iLocal_91 = 0;
	func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(0), 0f, -1f, -1f, "CELL_232" /*-No Contacts-*/, "CELL_233" /*No Role*/, "CELL_393" /*CHAR_MIKE_TREV_CONF*/, 0, 0);
	unk = 191;

	for (i = CHAR_MICHAEL; i < 190; i = i + 1)
	{
		character = CHAR_MICHAEL;
		character2 = 190;
		func_295(character2, 5000);
		_UPDATE_CURRENT_PLAYER_CHARACTER();
		...
		while (character < 190)
		{
			...
			else if (func_145(character, Global_20383) == 1)
			{
				bLocal_66 = true;
			}
			else
			...
			if (bLocal_66)
			{
				if (character != Global_20383)
				{
					if (unk[character] == 0)
					{
						if (func_307(character, Global_20383) == 1 || func_88(character, Global_20383))
							fLocal_67 = SYSTEM::TO_FLOAT(func_318(character)) / 100f;
						else
							fLocal_67 = SYSTEM::TO_FLOAT(func_318(character));
					
						if (func_307(character2, Global_20383) == 1 || func_88(character2, Global_20383))
							fLocal_68 = SYSTEM::TO_FLOAT(func_318(character2)) / 100f;
						else
							fLocal_68 = SYSTEM::TO_FLOAT(func_318(character2));
						...
						if (fLocal_67 < fLocal_68)
						{
							...
							if (IS_BIT_SET(Global_8254, 0))
							{
								if (character2 == CHAR_TREVOR)
									func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(i), 0f, -1f, -1f, "CELL_7001" /*  A: Kill Trevor*/, &(Global_2028[character2 /*29*/].f_3), &(Global_2028[character2 /*29*/].f_7), 0, 0);
							
								if (character2 == CHAR_MICHAEL)
									func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(i), 0f, -1f, -1f, "CELL_7002" /*  B: Kill Michael*/, &(Global_2028[character2 /*29*/].f_3), &(Global_2028[character2 /*29*/].f_7), 0, 0);
							
								if (character2 == CHAR_LESTER)
									func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(i), 0f, -1f, -1f, "CELL_7003" /*  C: Deathwish*/, &(Global_2028[character2 /*29*/].f_3), "CELL_E_311" /*CHAR_LESTER_DEATHWISH*/, 0, 0);
							}
						}
					}
				}
		...
		Global_20389[i] = character2;
		unk[character2] = 1;
	
		if (!IS_BIT_SET(Global_8254, 0))
			if (func_145(character2, Global_20383) == 1)
				if (character != Global_20383)
					if (func_80(character2, Global_20383) == 0)
						if (func_307(character2, Global_20383) == 1 || func_88(character2, Global_20383))
							func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(i), 1f, -1f, -1f, &(Global_117[character2 /*10*/].f_4), "CELL_195" /*Unknown*/, "CELL_300" /*CHAR_DEFAULT*/, 0, 0);
						else
							func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(i), 0f, -1f, -1f, &(Global_117[character2 /*10*/].f_4), "CELL_195" /*Unknown*/, "CELL_300" /*CHAR_DEFAULT*/, 0, 0);
					else if (func_307(character2, Global_20383) == 1 || func_88(character2, Global_20383))
						func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(i), 1f, -1f, -1f, &(Global_2028[character2 /*29*/].f_3), &(Global_2028[character2 /*29*/].f_3), &(Global_2028[character2 /*29*/].f_7), 0, 0);
					else
						func_157(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(i), 0f, -1f, -1f, &(Global_2028[character2 /*29*/].f_3), &(Global_2028[character2 /*29*/].f_3), &(Global_2028[character2 /*29*/].f_7), 0, 0);
	
		if (func_145(i, Global_20383) == 1)
			if (i != Global_20383)
...
void func_298() // Position - 0x128EE
{
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (_NETWORK_IS_PLAYER_VALID(num, false, true))
		{
			if (num3 == 0)
			{
				if (!num == unk_0x93E99A2DBCBA9CFA())
				{
					uLocal_306[num2] = num;
					func_300(unk_0x1D25117F71EE3811(num));
					num2 = num2 + 1;
				}
			}
		}
	...
	uLocal_306.f_33 = num2;
	i = 0;
	num2 = 0;

	if (func_182(unk_0x93E99A2DBCBA9CFA()))
	{
		num4 = unk_0x8220292E15406027();
		...
		{
			if (unk_0x0B92BA8F0D497C38(unk_0xC5D4FFA2FB6BD937(i)))
			{
				if (unk_0xC979ABB49E689182(unk_0xC5D4FFA2FB6BD937(i)))
				{
					unk = { func_299(i) };
					...
					if (!unk_0xB4D0EFD6A033F949(&unk))
					{
						if (num3 == 0)
						{
							if (num2 < 100)
							{
								uLocal_306.f_34[num2 /*29*/] = { unk };
							
								if (func_181())
									TEXT_LABEL_ASSIGN_STRING(&(uLocal_306.f_34[num2 /*29*/].f_13), unk_0x3AA475A7768E1C81(i), 64);
								else
									TEXT_LABEL_ASSIGN_STRING(&(uLocal_306.f_34[num2 /*29*/].f_13), unk_0xC5D4FFA2FB6BD937(i), 64);
							
								func_300(&(uLocal_306.f_34[num2 /*29*/].f_13));
								num2 = num2 + 1;
							}
						}
					}
	...
	uLocal_306.f_2935 = uLocal_306.f_33 + num2;
	return;
}
...
struct<13> func_299(int iParam0) // Position - 0x12A68
{
	...
	unk_0x79AE4B03DADF79C1(iParam0, &unk, 13);
	return unk;
}

void func_300(var uParam0) // Position - 0x12A7F
{
	unk_0x9FD96C5DE6EDFC15(Global_20364, "SET_DATA_SLOT");
	unk_0xC49D258FBF3BF214(SYSTEM::TO_FLOAT(2));
	unk_0xC49D258FBF3BF214(SYSTEM::TO_FLOAT(echLocal_70));
	unk_0xC49D258FBF3BF214(0f);
	unk_0x2AF11E92DE43CDE3("STRING");
	unk_0x76B34CBB6F5FA1BB(uParam0);
	unk_0xF8FCA9E7130CE1C8();
	func_81("CELL_MP_999" /*CHAR_HUMANDEFAULT*/);
	func_81("CELL_MP_999" /*CHAR_HUMANDEFAULT*/);
	unk_0xAE3413B0654A0035();
	echLocal_70 = echLocal_70 + 1;
	echLocal_69 = echLocal_69 + 1;
	return;
}
...
BOOL func_302() // Position - 0x12AF2
{
	if (Global_1574612)
		return true;
...
BOOL func_303(int iParam0, int iParam1) // Position - 0x12B22
{
	var unk;
	int num;

	unk = Global_2848280[iParam0 /*3*/][func_67(iParam1)];
...
int func_307(eCharacter echParam0, eCharacter echParam1) // Position - 0x12C27
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
void func_308() // Position - 0x12C51
{
	...
	if (!IS_BIT_SET(Global_8254, 0))
		if (unk_0x67EBFCF2F78761B9())
			if (Global_20326 == false && func_317(0))
				func_315();

	echLocal_72 = echLocal_69;
	bLocal_108 = false;
	iLocal_91 = 0;
	unk = 191;

	for (i = echLocal_69; i < 190; i = i + 1)
	{
		character = 0;
		character2 = 190;
		func_295(character2, 5000);
		...
		while (character < 190)
		{
			...
			if (func_314())
			{
				if (Global_1836500 == 1 && character == 19)
					bLocal_66 = false;
			
				if (Global_1836499 == true && character == 175)
					bLocal_66 = false;
			}
		
			character3 = character;
		
			if (func_313(character3) && !func_310(character3) && !func_309(character3))
				bLocal_66 = false;
...
BOOL func_309(eCharacter echParam0) // Position - 0x13087
{
	if (IS_BIT_SET(Global_8253, 16))
		return Global_22756 == echParam0;

	return false;
}

BOOL func_310(eCharacter echParam0) // Position - 0x130A2
{
	int num;
	int num2;
	int num3;
	...
	if (num != -1)
	{
		...
		{
			case 0:
				return !IS_BIT_SET(_MPCHAR_STAT_GET_INT(MP_STAT_HVYPISTOL_KILLS, -1, 0), num3);
		
			case 1:
				return !IS_BIT_SET(_MPCHAR_STAT_GET_INT(MP_STAT_HVYPISTOL_DEATHS, -1, 0), num3);
...
int func_311(eCharacter echParam0) // Position - 0x13106
{
	switch (echParam0)
	{
		case 12:
...
BOOL func_313(eCharacter echParam0) // Position - 0x133C0
{
	return func_311(echParam0) != -1;
}

BOOL func_314() // Position - 0x133D0
{
	if (Global_78558)
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (_NETWORK_IS_PLAYER_VALID(num, false, true))
		{
			if (num3 == 0)
			{
				...
				{
					uLocal_306[num2] = num;
					func_316(unk_0x1D25117F71EE3811(num));
					num2 = num2 + 1;
				}
			}
		}
					...
					if (!unk_0xB4D0EFD6A033F949(&unk))
					{
						if (num3 == 0)
						{
							if (num2 < 100)
							{
								...
								func_316(&(uLocal_306.f_34[num2 /*29*/].f_13));
								num2 = num2 + 1;
							}
						}
					}
...
void func_316(var uParam0) // Position - 0x13571
{
	unk_0x9FD96C5DE6EDFC15(Global_20364, "SET_DATA_SLOT");
	unk_0xC49D258FBF3BF214(SYSTEM::TO_FLOAT(2));
	unk_0xC49D258FBF3BF214(SYSTEM::TO_FLOAT(echLocal_70));
...
BOOL func_317(int iParam0) // Position - 0x135CF
{
	int num;
	int num2;
	...
	{
		case 0:
			return !IS_BIT_SET(_MPCHAR_STAT_GET_INT(MP_STAT_HVYPISTOL_KILLS, -1, 0), num2);
	
		case 1:
			return !IS_BIT_SET(_MPCHAR_STAT_GET_INT(MP_STAT_HVYPISTOL_DEATHS, -1, 0), num2);
...
int func_318(eCharacter echParam0) // Position - 0x13625
{
	return Global_2028[echParam0 /*29*/].f_1;
}
