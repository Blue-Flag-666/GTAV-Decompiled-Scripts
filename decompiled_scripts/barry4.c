...
void __EntryFunction__()
{
	...
	{
		func_399("Force cleanup [TERMINATING]");
		func_376(1);
		func_359();
	}
	if (func_358())
	{
		Global_78103 = 1;
		iLocal_79 = 0;
		while (!func_357(&Local_83))
		{
			SYSTEM::WAIT(0);
		}
		func_250(&iVar0, 236,1378f, -369,3902f, 43,2497f, 251,2f, 0, 0, 0, 1, 0, joaat("asterope"), 0, 145, 1);
		Global_78103 = 0;
	}
	while (true)
	{
		...
		func_233(Local_83.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_81)
		{
			case 0:
				func_1();
...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			if (func_358())
			{
				func_232(243,367f, -387,3153f, 44,4046f, 175,2f, 1, 0);
				func_230(0, -1, 1);
			}
			func_229(500, 1);
			iLocal_82 = 1;
		...
		case 1:
			...
			func_223(&uLocal_145, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_223(&uLocal_145, 3, 0, "BARRY", 0, 1);
			iLocal_144 = 0;
			iLocal_82 = 2;
			break;
		...
		case 2:
			if (!iLocal_144)
			{
				if (func_206(&uLocal_145, 49, "BARR4AU", "BAR4_RCM_LI", 11, 1, 0, 0, 0))
				{
...
void func_7()
{
	...
	{
		func_9(13, SYSTEM::FLOOR(Global_112922.f_10194.f_3853));
	}
...
int func_32(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_75(iParam1), Global_77669[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, 0);
		}
	}
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_77669[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_77667 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
		}
		if (Global_77667 == 1)
		{
			iVar2 = 0;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_86(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_86(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_77669[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)) && Global_77669[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_153(char* sParam0, var uParam1)
{
...
void func_155()
{
	...
	{
		if (func_150(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_161(&sVar32, Var0.f_3, Global_100017, bParam1, bParam2);
	}
}
...
void func_166()
{
	...
	{
		func_155();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_167(Global_112922.f_2363.f_539.f_4321));
	}
	else
	{
...
{
	func_222(uParam0, iParam1, sParam2, iParam6, iParam7, 0);
	Global_21333 = 0;
	Global_21292 = 1;
	Global_21299 = 0;
	Global_21294 = 0;
...
void func_222(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (Global_78112 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_235(Global_78113, Global_78115, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
{
	if (((!func_247(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
...
{
	return func_249(iParam0, Global_42602);
}
...
void func_250(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_358() || !func_356())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_353(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_329(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_328(Param1, 0f, 0f, 0f, 0))
		{
			Param1 = { Global_106470.f_2890 };
			fParam4 = Global_106470.f_2890.f_6;
		}
		MISC::CLEAR_AREA(Param1, 5f, true, false, false, false);
		func_322(Param1, 5f, 0);
		if (func_152(iParam12))
		{
			func_320(iParam12, 0);
			while (!func_251(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_251(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_112922.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112922.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112922.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_311(iParam0, &(Global_112922.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_112922.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_112922.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112922.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112922.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_311(iParam0, &(Global_112922.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_112922.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_311(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_252(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_257(*iParam1, 0, &uVar0))
		{
			func_256(iParam1, &(Global_112922.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_112922.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_112922.f_20118[iParam0 /*43*/].f_31 = func_255(*iParam1);
				...
				func_253(Global_112922.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_112922.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_112922.f_20118[iParam0 /*43*/].f_1));
				...
				func_253(Global_112922.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_112922.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_253(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_254(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_254(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_257(int iParam0, bool bParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_285(iVar0, bParam1, uParam2) && !func_284(PLAYER::PLAYER_ID())) && !func_267(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_265(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_263(iParam0)) && !bVar1) && !(func_262(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_259(PLAYER::PLAYER_ID())))
	{
	...
	{
		if ((func_258(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_259(int iParam0)
{
	if (iParam0 != func_212())
	{
		if (func_261(iParam0, 1, 1))
		{
			...
			{
				return func_260(Global_2689224[iParam0 /*451*/].f_317.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_264(int iParam0)
{
	if (iParam0 != func_212())
	{
		if (func_261(iParam0, 1, 1))
		{
			if (Global_2689224[iParam0 /*451*/].f_317.f_6 != -1)
			{
				return func_260(Global_2689224[iParam0 /*451*/].f_317.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_265(int iParam0)
{
	if (iParam0 != func_212())
	{
		if (func_261(iParam0, 1, 1))
		{
			if (Global_2689224[iParam0 /*451*/].f_317.f_6 != -1)
			{
				return func_260(Global_2689224[iParam0 /*451*/].f_317.f_6) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_283(PLAYER::PLAYER_ID()) || func_282(PLAYER::PLAYER_ID()))
	{
		if (func_268(iParam0))
		{
			return 1;
...
int func_269(int iParam0)
{
	...
	if (func_270(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
	{
		return 1;
	}
	return 0;
...
int func_271(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_273(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2810701.f_303 == iParam0)
				{
					return 1;
				}
				else if (func_272(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_282(int iParam0)
{
	if (iParam0 != func_212())
	{
		if (func_261(iParam0, 1, 1))
		{
			if (Global_2689224[iParam0 /*451*/].f_317.f_6 != -1 && Global_2689224[iParam0 /*451*/].f_317.f_9 != func_212())
			{
				return func_260(Global_2689224[iParam0 /*451*/].f_317.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_283(int iParam0)
{
	if (iParam0 != func_212())
	{
		if (func_261(iParam0, 1, 1))
		{
			if (Global_2689224[iParam0 /*451*/].f_317.f_6 != -1 && Global_2689224[iParam0 /*451*/].f_317.f_9 != func_212())
			{
				return func_260(Global_2689224[iParam0 /*451*/].f_317.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_284(int iParam0)
{
	if (iParam0 != func_212())
	{
		if (func_261(iParam0, 1, 1))
		{
			if (Global_2689224[iParam0 /*451*/].f_317.f_6 != -1)
			{
				return func_260(Global_2689224[iParam0 /*451*/].f_317.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_285(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_265(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
void func_287(int iParam0, int iParam1)
{
	...
	func_288(iParam0, &(Global_112922.f_32749.f_5510));
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_306(iParam0, 0, 0)) || func_306(iParam0, 1, 0)) || func_306(iParam0, 2, 0)) || func_305(iParam0) != 145) || func_304(iParam0)) || func_303(iParam0)) || func_258(iParam0)) || func_302(iParam0)) || !func_292(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_303(iParam0))
		{
		}
...
int func_311(int iParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_315(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_281(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_314(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_314(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_313(iParam0);
	if (func_312(*iParam0))
	{
...
{
	if (!func_317() && func_316(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_320(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97311[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97311[iVar0]) == func_321(iParam0, iParam1))
				{
...
void func_322(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_327(&(Global_76676.f_555[0 /*21*/]), iVar0))
		{
...
void func_323(int iParam0)
{
	...
	if (func_327(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_183(iParam0, 0)) && Global_77585.f_66 == 0) && Global_112922.f_32749.f_1958[Global_76676.f_555[0 /*21*/].f_14] != 0) && Global_112922.f_32749.f_1958[Global_76676.f_555[0 /*21*/].f_14] > 3) && (!func_325(0, Global_76676.f_555[0 /*21*/].f_12) || !func_325(1, Global_76676.f_555[0 /*21*/].f_12)))
			{
				func_324(&(Global_112922.f_32749.f_69[Global_76676.f_555[0 /*21*/].f_14 /*78*/]), &Global_77585);
...
int func_325(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_326(&(Global_112922.f_32749.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_293(Global_112922.f_32749.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_327(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_328(Global_112922.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_328(Global_112922.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_328(Global_112922.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_328(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
{
	return func_330(&(Global_106470.f_2890), Param0, fParam3, 0);
}

int func_330(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_349(uParam0))
	{
		...
		if (func_348(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_335(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
					{
						...
						{
							func_320(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_320(uParam0->f_11, 2);
						}
					}
					...
					func_308(iVar0, uParam0->f_11);
				}
				else if ((!func_332(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_331(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_332(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_334(iParam0, Global_76676.f_139[38], 0))
			{
				func_323(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_334(iParam0, Global_76676.f_139[43], 1))
			{
				func_323(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_334(iParam0, uVar1[iVar6], 1) && func_333(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
					if ((!bParam4 || func_328(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_333(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_335(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_289(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_289(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_289(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_289(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_289(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_289(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_289(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_289(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_289(iVar4));
					}
				}
				iVar4++;
			}
		...
		{
			if (BitTest(uParam1->f_77, func_289(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_289(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_289(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_289(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_289(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar6 <= 11)
			{
				if (BitTest(uParam1->f_77, func_289(iVar6 + 1)))
				{
...
int func_349(var uParam0)
{
	...
	if (!func_293(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
	if (uParam0->f_12.f_66 == joaat("stunt") && func_333(*uParam0, 1694,62f, 3276,27f, 41,31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_350()
{
	return func_348(&(Global_106470.f_2890));
}

void func_351()
{
	func_352(&(Global_106470.f_2890));
}
...
int func_353(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_355(Global_106470.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_356()
{
	return func_349(&(Global_106470.f_2890));
}
...
void func_368(int* iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		...
		if (func_370(*iParam0))
		{
			if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(*iParam0, true))
			{
				if (func_369(PLAYER::PLAYER_PED_ID()))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, false))
					{
						ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(iParam0);
...
void func_373(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_376(bool bParam0)
{
	...
	if (!func_397())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_377(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112009[iVar0 /*10*/].f_9 == -1)
...
int func_378(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_384())
	{
		...
		{
			iVar33 = func_379(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_380()
{
	...
	iVar0 = func_381(&(Global_99980.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_384()
{
	...
	{
		if (func_379(&(Global_99980.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_402(&(uParam0->f_28));
	func_402(&(uParam0->f_35));
	func_402(&(uParam0->f_41));
}
