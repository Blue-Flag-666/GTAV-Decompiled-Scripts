...
void main() // Position - 0x0
{
	...
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		...
		while (!func_273(&uLocal_79))
		{
			SYSTEM::WAIT(0);
		}
	
		func_272(&uLocal_79, false, true);
		Global_78935 = 0;
	}
	...
	while (true)
	{
		...
		func_254(uLocal_79.f_9, 0, 0, 0, 0, 0);
...
void func_46() // Position - 0x1016
{
	switch (iLocal_141)
	{
		case 0:
			func_220(23, true);
			iLocal_336 = Global_32534;
			Global_32534 = 0;
			func_219("SCRAP_2_RCM", false);
...
int func_65(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E1
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_118(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_118(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_118(entityModel, 14, unk18[j], -1) };
							func_85(pedParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_108(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_75(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_118(entityModel, i, func_74(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_118(entityModel, 14, unk59[j], -1) };
			func_85(pedParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_108(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_75(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_66(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1FF2
{
	...
	{
		if (!func_182(pedParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
{
	Global_78472[1 /*14*/] = { func_118(hParam0, iParam1, iParam2, -1) };
...
BOOL func_73(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x28E6
{
	...
	{
		if (!func_182(pedParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
Hash func_111(int iParam0, int iParam1) // Position - 0x8856
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_112(iParam1));
}

int func_112(int iParam0) // Position - 0x886B
{
	int num;
	int num2;
...
BOOL func_115(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x88DA
{
...
BOOL func_116(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB2D8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_117(int iParam0) // Position - 0xC17F
{
	if (!IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_118(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC1C7
{
	func_181();
...
void func_120(int iParam0) // Position - 0xC309
{
	...
	func_121(&Global_78472[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_121(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD53C
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_114(func_124(iParam1, iParam0->f_2), Global_78469);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_114(func_123(iParam1, iParam0->f_2), Global_78469);
			...
			{
				num = func_114(num2, Global_78469);
...
BOOL func_125(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE4D8
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE5EA
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_121(&Global_78472[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_121(&Global_78472[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_121(&Global_78472[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78670)
		{
			...
			func_121(&Global_78472[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_182(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F975
{
	Hash entityModel;
	int num;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_182(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_182(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_118(entityModel, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_182(pedParam0, 14, k))
											if (!func_71(entityModel, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_118(entityModel, i, num, -1) };
					
						if (!func_71(entityModel, iParam2, i, num, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_75(iParam1)) && Global_78472[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_75(iParam1)))
	{
		return true;
	}
...
void func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1FC0D
{
	if (bParam0)
	{
...
BOOL func_186(Player plParam0, int iParam1) // Position - 0x1FD74
{
	BOOL flag;
...
BOOL func_188(Player plParam0) // Position - 0x1FE0E
{
	Player player;
...
BOOL func_189(Player plParam0) // Position - 0x1FE30
{
...
int func_191(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1FE7D
{
	int num;
...
void func_193(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15) // Position - 0x1FED3
{
	func_194(fParam0, fParam3, fParam6, fParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
	return;
}

void func_194(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x1FEFC
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x202F3
{
...
BOOL func_196(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2031D
{
	int i;
	var garageName;
	int num;
...
BOOL func_197(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x2038B
{
...
BOOL func_198(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x20463
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_199(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x20759
{
	float num;
	float num2;
	float num3;
...
Vector3 func_200(float fParam0, var uParam1, var uParam2) // Position - 0x2080D
{
	float num;
	float num2;
...
void func_201(Vehicle veParam0) // Position - 0x2084C
{
...
int func_204(const char* sParam0, int iParam1) // Position - 0x208E2
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_210(int iParam0, int iParam1, int iParam2) // Position - 0x2233A
{
	int num;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x22441
{
...
BOOL func_215(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x224B4
{
...
BOOL func_216(Ped pedParam0) // Position - 0x224E7
{
...
BOOL func_217(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x22507
{
...
void func_218(Vehicle veParam0) // Position - 0x2269F
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_221() // Position - 0x22703
{
	...
	if (func_223())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_144 && !func_222(PLAYER::PLAYER_PED_ID(), uLocal_79.f_28[0], 5f, true))
		{
...
BOOL func_223() // Position - 0x227C0
{
	...
	{
		if (func_225(uLocal_79.f_28[0], true, 1116471296, 1126825984, false, false, false, false) || func_224(PLAYER::PLAYER_PED_ID(), uLocal_79.f_28[0], true))
		{
...
BOOL func_224(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x22876
{
...
BOOL func_225(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x228C1
{
	float num;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (func_238(pedParam0, bParam1, bParam5, bParam6, bParam7))
			return true;
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				if ((num * num) + (num.f_1 * num.f_1) + (num.f_2 * num.f_2) <= 5f)
					return func_237(PLAYER::PLAYER_PED_ID(), pedParam0, iParam2);
			}
		}
	
		if (bParam4)
			return false;
		else if (func_226(pedParam0, iParam3))
			return true;
	}
...
BOOL func_226(Ped pedParam0, int iParam1) // Position - 0x2297C
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		if (func_236(pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
				xSize = 40f;
			else
...
BOOL func_227(Ped pedParam0, int iParam1) // Position - 0x229F2
{
	return func_228(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_228(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22A0A
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_235(pedParam0, pedParam1);
...
BOOL func_229(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0x22ACB
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_230(Ped pedParam0, int iParam1) // Position - 0x22BF7
{
...
BOOL func_232(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x22D06
{
	var unk;
...
float func_233(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x22D97
{
...
int func_235(Ped pedParam0, Ped pedParam1) // Position - 0x22DD3
{
	int i;
...
BOOL func_236(Ped pedParam0) // Position - 0x22E12
{
...
BOOL func_237(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x22E3A
{
...
BOOL func_238(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x22E81
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_239(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x22F7C
{
	float entityCoords;
	float num;
...
BOOL func_240(Ped pedParam0, float fParam1) // Position - 0x23088
{
	var outProjectile;
	var outCoords;
...
BOOL func_241(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x2311D
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_242(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x231AB
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_250(int iParam0) // Position - 0x23455
{
	if (iParam0 == 1)
		if (Global_20500.f_1 > 3)
...
void func_254(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x235B8
{
	float num;
	int value;
	int alpha;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_257(Global_78945, Global_78947, iParam10) };
				y == -0.014f;
...
float func_256(const char* sParam0) // Position - 0x238D5
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (num)
			{
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_258(num), 8);
					break;
			}
			break;
...
BOOL func_266(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x23CB6
{
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_250(0) || func_267(true))
			{
			}
			else
			{
...
BOOL func_268(int iParam0) // Position - 0x23DF7
{
	if (Global_43377 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x23E19
{
	return func_270(iParam0, Global_43377);
}

BOOL func_270(int iParam0, int iParam1) // Position - 0x23E2A
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_273(var uParam0) // Position - 0x241AC
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_77)
	{
		...
		case 1:
			if (!func_280(&num) || !func_278(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_275(&uParam0->f_28[0], CHAR_OMEGA, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_274(&uParam0->f_35[0], num[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
...
void func_274(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x2437A
{
	func_38(pveParam0);
...
BOOL func_275(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x243BC
{
...
BOOL func_276(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x24418
{
	Hash model;
...
int func_277(var uParam0, eCharacter echParam1) // Position - 0x244A6
{
	int num;
...
BOOL func_278(var uParam0) // Position - 0x244EC
{
	if (func_279(uParam0))
	{
...
BOOL func_279(var uParam0) // Position - 0x24516
{
...
BOOL func_280(var uParam0) // Position - 0x2453B
{
	int i;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x245A8
{
...
BOOL func_284() // Position - 0x24641
{
	int num;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x246E2
{
...
void func_287(int iParam0, BOOL bParam1) // Position - 0x24719
{
	...
	{
		func_328(&(Global_112897[num /*10*/].f_9));
	}
	...
	func_318(num, 1, false, false);
	func_317(0, 0);
	TEXT_LABEL_COPY(&unk, { func_208(num) }, 4);
	func_315(&unk, func_316());
	func_313();
...
void func_290() // Position - 0x2497E
{
	...
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_78689)
		{
			if (func_291() == 2 == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
BOOL func_292(int iParam0, int iParam1) // Position - 0x24E47
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x24E98
{
	if (iParam2 == -1)
		iParam2 = func_113();
...
void func_304(var uParam0) // Position - 0x2506B
{
	...
	*uParam0 = 145;
	...
	for (j = 0; j < 3; j = j + 1)
	{
		...
		uParam0->f_17[j] = 0;
		uParam0->f_21[j] = 0;
		func_309(&uParam0->f_25[0 /*295*/][j /*98*/]);
		func_309(&uParam0->f_25[1 /*295*/][j /*98*/]);
...
BOOL func_314(Ped pedParam0, int iParam1, int iParam2) // Position - 0x25958
{
	Hash entityModel;
	int i;
	var unk;
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			if (!func_314(pedParam0, 14, unk18[j]))
				flag = 0;
		}
	...
	{
		unk28 = { func_98(entityModel, 0) };
		Global_78472[1 /*14*/] = { func_118(entityModel, iParam1, unk28[iParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, 0);
	}
...
void func_315(const char* sParam0, int iParam1) // Position - 0x25B15
{
...
void func_319(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25C93
{
	...
	if (iParam0 != -1)
	{
		...
		func_320(&unk33, unk.f_3, Global_100870, bParam1, bParam2);
	}

	return;
}

void func_320(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x25CD2
{
...
char* func_323(eCharacter echParam0) // Position - 0x25D5A
{
	echParam0 = echParam0;
	return "";
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x25DAC
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x25DC2
{
...
void func_328(int iParam0) // Position - 0x25DEC
{
	if (*iParam0 == -1)
		return;
...
void func_333(int iParam0, BOOL bParam1) // Position - 0x2637F
{
	int num;
	int num2;
	int num3;
...
void func_336(int iParam0, BOOL bParam1) // Position - 0x2670B
{
	...
	if (bParam1)
	{
		...
		{
			func_337(iParam0, 1, false);
			func_337(iParam0, 2, false);
			func_337(iParam0, 3, false);
			func_337(iParam0, 4, false);
			func_337(iParam0, 0, true);
			Global_77479[iParam0] = 1;
		}
	}
	else
	{
		func_337(iParam0, 0, false);
	}
...
BOOL func_338(int iParam0, int iParam1) // Position - 0x267A3
{
	if (iParam0 == -1)
		return false;
...
void func_339(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x267C3
{
	if (iParam0 != 198)
	{
		if (Global_78689)
		...
		func_342(iParam0, bParam3, iParam4, false);
...
BOOL func_343() // Position - 0x2727C
{
	...
	if (offset >= 0 && offset <= 31)
	{
		if (!func_355(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_352(68))
					func_349("DI_HLP_STRY" /*Story characters become available in Rockstar Editor's 'Director Mode' as the GTAV story progresses.*/, 2, 0, 20000, 10000, 7, 0, 208, 0);
			}
		}
	}
...
void func_350(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x2AC1D
{
	int i;
...
BOOL func_352(int iParam0) // Position - 0x2AF07
{
	int num;
	int i;
...
BOOL func_355(int iParam0) // Position - 0x2B13E
{
...
BOOL func_357(const char* sParam0) // Position - 0x2B1A5
{
...
void func_359(const char* sParam0, int iParam1) // Position - 0x2B2D5
{
	if (Global_100833 != 12)
...
BOOL func_360(const char* sParam0, int iParam1, int iParam2) // Position - 0x2B2FD
{
...
int func_362() // Position - 0x2B4E2
{
	...
	num = func_363(&(Global_100833.f_3), false);
	num2 = 0;
...
int func_364(Hash hParam0, BOOL bParam1) // Position - 0x2B530
{
	int i;
...
BOOL func_365() // Position - 0x2B566
{
...
BOOL func_366() // Position - 0x2B5B6
{
...
BOOL func_375() // Position - 0x2B764
{
...
Hash func_380(eCharacter echParam0) // Position - 0x2B8FB
{
