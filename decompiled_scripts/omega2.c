...
void main() // Position - 0x0
{
	...
	hLocal_166 = joaat("prop_cs_power_cell");
...
void func_5() // Position - 0x280
{
	switch (iLocal_143)
	{
		case 0:
			...
			func_44(&pedLocal_171, &uLocal_81.f_35[0]);
			bLocal_337 = false;
		...
		case 1:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_171) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), pedLocal_171, true))
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_208(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_81.f_28[0], sLocal_147, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Franklin", 0, 0, 0);
				}
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_153[2]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_153[2], uLocal_149[2], 1, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_153[0]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_153[0], uLocal_149[0], 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_153[1]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_153[1], uLocal_149[1], 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_148, 0, 0, 0);
			
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_158, sLocal_157, 2, joaat("p_cs_saucer_01_s"), 0);
				func_200();
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(uLocal_149[0], 0))
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_153[0], true);
		
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(uLocal_149[1], 0))
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_153[1], true);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_158))
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_157, 0)))
					pedLocal_158 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_157, 0));
			else if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_157, 0))
				ENTITY::FREEZE_ENTITY_POSITION(pedLocal_158, true);
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(obLocal_159) && STREAMING::HAS_MODEL_LOADED(hLocal_166))
				{
					obLocal_159 = OBJECT::CREATE_OBJECT_NO_OFFSET(hLocal_166, uLocal_160, true, true, false);
					ENTITY::SET_ENTITY_ROTATION(obLocal_159, uLocal_163, 2, false);
				}
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x17CE
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

int func_65(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E1
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_117(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1 /*14*/] = { func_117(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1 /*14*/] = { func_117(entityModel, 14, unk18[j], -1) };
							func_85(pedParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_108(14);
			...
			{
				Global_78341[1 /*14*/] = { func_117(entityModel, i, func_74(pedParam0, i, PV_COMP_INVALID), -1) };
		...
		if (iParam7 == 1)
		{
			unk45 = { func_117(entityModel, 8, num3, -1) };
			...
			unk45 = { func_117(entityModel, 9, num4, -1) };
			...
			unk45 = { func_117(entityModel, 14, num5, -1) };
			...
			unk45 = { func_117(entityModel, 14, num6, -1) };
			...
			unk45 = { func_117(entityModel, 14, num7, -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1 /*14*/] = { func_117(entityModel, 14, unk59[j], -1) };
			func_85(pedParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_108(14);
...
BOOL func_66(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1FF2
{
	int num;
	...
	{
		if (!func_181(pedParam0, Global_113648.f_2365.f_539[num /*65*/].f_64, Global_113648.f_2365.f_539[num /*65*/].f_63))
		{
...
int func_67(Hash hParam0) // Position - 0x207E
{
	switch (hParam0)
	{
...
void func_68(Hash hParam0, int iParam1, int iParam2) // Position - 0x20B9
{
	int num;
	int num2;
...
BOOL func_69(Hash hParam0, int iParam1, int iParam2) // Position - 0x2143
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_70(Hash hParam0, int iParam1, int iParam2) // Position - 0x2221
{
	Global_78341[1 /*14*/] = { func_117(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_78341[1 /*14*/].f_6, 2);
}

BOOL func_71(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x2249
{
	var unk;
	int i;
...
BOOL func_72(Hash hParam0, int iParam1, int iParam2) // Position - 0x284D
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_73(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x28E6
{
	int num;
	...
	{
		if (!func_181(pedParam0, Global_113648.f_2365.f_539[num /*65*/].f_61, Global_113648.f_2365.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_74(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2991
{
	int i;
	int j;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (iParam1 == 12)
		{
			for (i = 0; i <= 53; i = i + 1)
			{
				if (func_181(pedParam0, iParam1, i))
					return i;
			}
		}
		else if (iParam1 == 13)
		{
			for (j = 0; j <= 19; j = j + 1)
			{
				if (func_181(pedParam0, iParam1, j))
					return j;
			}
...
ePedComponentType func_75(int iParam0) // Position - 0x2A32
{
	switch (iParam0)
	{
		case 0:
...
int func_76(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x2AE2
{
	int num;
...
int func_77(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2DE9
{
	int num;
	int num2;
	int num3;
...
int func_79(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3C80
{
	int num;
...
int func_80(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3F47
{
	int i;
	int num;
...
BOOL func_81(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3F7E
{
	int num;
...
BOOL func_82(Hash hParam0, int iParam1, var uParam2) // Position - 0x3FA7
{
	*uParam2 = -99;
...
int func_83(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4273
{
	int num;
...
int func_84(Hash hParam0, int iParam1, int iParam2) // Position - 0x44FD
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_85(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x4654
{
	int num;
...
BOOL func_86(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x46EE
{
	switch (hParam0)
	{
...
Hash func_87(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x47BC
{
	var outProp;
	int componentId;
	int num;
...
int func_88(Hash hParam0, int iParam1) // Position - 0x48D6
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_89(Hash hParam0) // Position - 0x4C7D
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_90(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x4CDE
{
	Hash entityModel;
...
int func_91(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x4DDA
{
	Hash entityModel;
...
int func_92(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4F18
{
	var unk;
	Ped i;
	Ped ped;
...
int func_93(Hash hParam0) // Position - 0x4FD3
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_94(ePedComponentType epctParam0) // Position - 0x5032
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
struct<10> func_95(Hash hParam0, int iParam1) // Position - 0x50B8
{
	int i;
	var unk;
...
void func_96(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x59E7
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_98(Hash hParam0, int iParam1) // Position - 0x5B59
{
	int i;
	var unk;
...
void func_99(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x79A1
{
	int num;
	Hash itemHash;
...
BOOL func_102(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x7CAC
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_103(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x7F29
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_104(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x834E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_105(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x8641
{
	int pedPropIndex;
...
int func_106(Ped pedParam0, int iParam1) // Position - 0x8688
{
...
int func_107(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x86E8
{
	ePedComponentType componentId;
...
void func_109(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x87EB
{
	int num;
	int offset;
	eMPStat stat;
	...
	if (func_114(hParam0, iParam1, &stat, &offset, bParam2, bParam3))
	{
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8835
{
	Hash statName;

	bParam4;
	statName = Global_2805027[empsParam0 /*3*/][func_111(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x88A5
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805027[empsParam0 /*3*/][func_111(iParam1)];
...
BOOL func_114(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x88E2
{
...
struct<14> func_117(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBFDC
{
	func_180();
...
BOOL func_124(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE2F4
{
	int num;
	int num2;
	eMPStat stat;
	...
	if (func_114(hParam0, iParam1, &stat, &num2, bParam2, bParam3))
	{
...
void func_126(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE407
{
	int num;
	int num2;
	Hash hash;
	...
	if (iParam0 == 12)
	{
		...
		if (ped >= 0)
		{
			...
			if (ped2 > ped)
			{
				...
				Global_2883589 = hash;
				func_120(&Global_78341[0 /*14*/], iParam0, iParam1, &(hash.f_7), 0, 0, hash.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num4 > componentId)
			{
				...
				func_120(&Global_78341[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num3, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78539)
		{
			...
			func_120(&Global_78341[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_181(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F683
{
	Hash entityModel;
	int num;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_181(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_181(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2 /*14*/] = { func_117(entityModel, 14, k, -1) };
								
									if (Global_78341[2 /*14*/].f_12 == j)
										if (func_181(pedParam0, 14, k))
											if (!func_71(entityModel, iParam2, 14, k, &unk, &Global_78341[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78341[2 /*14*/] = { func_117(entityModel, i, num, -1) };
					
						if (!func_71(entityModel, iParam2, i, num, &unk, &Global_78341[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (iParam1 == 13)
	{
		...
		for (l = 0; l <= 8; l = l + 1)
		{
			if (!func_181(pedParam0, 14, unk28[l]))
				return false;
		}
...
void func_182(BOOL bParam0) // Position - 0x1F8DC
{
	...
	func_183(true, true, false, false, false, false, false);
	return;
}

void func_183(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1F91B
{
	if (bParam0)
	{
		...
		func_189(true, bParam3, bParam2, false);
		Global_63368 = 1;
		Global_75696 = 1;
		Global_78556 = 1;
	}
	else
	{
		...
		func_189(false, bParam3, bParam2, false);
	
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_187(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_184() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0x1FA82
{
	BOOL flag;
...
BOOL func_187(Player plParam0) // Position - 0x1FB0E
{
...
int func_189(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1FB5B
{
	int num;
...
void func_192(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x1FBDA
{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false))
		{
			...
			else
			{
				...
				if (entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)
					if (func_196(playersLastVehicle, vParam0, vParam3, fParam6))
						flag = true;
			}
			...
			if (bParam16)
				if (func_194(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL func_194(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x1FFFA
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_195(echParam1, i, &garageName, &num); i = i + 1)
	{
...
BOOL func_196(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x20141
{
	float num;
	var unk3;
	var unk6;
...
void func_199(Vehicle veParam0) // Position - 0x2052A
{
...
int func_202(const char* sParam0, int iParam1) // Position - 0x205C0
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_208(int iParam0, int iParam1, int iParam2) // Position - 0x22018
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_215(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iParam1, 1, 1056964608, false, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
			{
				...
				if (!func_213(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE))
...
BOOL func_213(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x22192
{
	if (func_214(pedParam0))
...
BOOL func_214(Ped pedParam0) // Position - 0x221C5
{
...
BOOL func_215(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x221E5
{
...
void func_216(Vehicle veParam0) // Position - 0x2237D
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_219() // Position - 0x223E1
{
	...
	if (func_221())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_146 && !func_220(PLAYER::PLAYER_PED_ID(), uLocal_81.f_28[0], 5f, true))
		{
			CAM::SET_GAMEPLAY_ENTITY_HINT(uLocal_81.f_28[0], 0f, 0f, 0f, true, 2000, 2500, 2000, 0);
...
BOOL func_220(Ped pedParam0, Entity eParam1, float fParam2, BOOL bParam3) // Position - 0x2247C
{
...
BOOL func_221() // Position - 0x2249E
{
	...
	else if (PED::IS_PED_INJURED(uLocal_81.f_28[0]) || PED::IS_PED_RAGDOLL(uLocal_81.f_28[0]))
	{
		iLocal_144 = 2;
		func_47(4);
		return false;
	...
	{
		if (func_223(uLocal_81.f_28[0], true, 1116471296, 1126825984, false, false, false, false) || func_222(PLAYER::PLAYER_PED_ID(), uLocal_81.f_28[0], true))
		{
...
BOOL func_222(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x22554
{
	if (func_214(pedParam0) && PED::IS_PED_IN_ANY_VEHICLE(pedParam0, false))
		if (func_214(pedParam1))
...
BOOL func_223(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2259F
{
	float num;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (func_236(pedParam0, bParam1, bParam5, bParam6, bParam7))
			return true;
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				if ((num * num) + (num.f_1 * num.f_1) + (num.f_2 * num.f_2) <= 5f)
					return func_235(PLAYER::PLAYER_PED_ID(), pedParam0, iParam2);
			}
		}
	
		if (bParam4)
			return false;
		else if (func_224(pedParam0, iParam3))
			return true;
	}
...
BOOL func_224(Ped pedParam0, int iParam1) // Position - 0x2265A
{
	float xSize;
...
BOOL func_225(Ped pedParam0, int iParam1) // Position - 0x226D0
{
	return func_226(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_226(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x226E8
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_227(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_227(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0x227A9
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_228(Ped pedParam0, int iParam1) // Position - 0x228D5
{
...
BOOL func_230(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x229E4
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_198(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_198(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };
...
int func_233(Ped pedParam0, Ped pedParam1) // Position - 0x22AB1
{
	int i;
...
BOOL func_234(Ped pedParam0) // Position - 0x22AF0
{
...
BOOL func_235(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x22B18
{
...
BOOL func_236(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x22B5F
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_237(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x22C5A
{
	float entityCoords;
	float num;
...
BOOL func_238(Ped pedParam0, float fParam1) // Position - 0x22D66
{
	var outProjectile;
	var outCoords;
...
BOOL func_239(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x22DFB
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_198(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_240(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x22E89
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_241() // Position - 0x22ED1
{
	...
	if (!bLocal_167)
	{
		...
		{
			inLocal_170 = INTERIOR::GET_INTERIOR_AT_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_35[0], true));
		
			if (INTERIOR::IS_VALID_INTERIOR(inLocal_170))
			{
				INTERIOR::PIN_INTERIOR_IN_MEMORY(inLocal_170);
				bLocal_167 = true;
			}
		}
	}
	...
	{
		if (INTERIOR::IS_INTERIOR_READY(inLocal_170))
			bLocal_168 = true;
	}
	else if (!bLocal_169)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_35[0]))
		{
			entityCoords = { ENTITY::GET_ENTITY_COORDS(uLocal_81.f_35[0], true) };
			entityHeading = ENTITY::GET_ENTITY_HEADING(uLocal_81.f_35[0]);
			func_38(&uLocal_81.f_35[0]);
			uLocal_81.f_35[0] = VEHICLE::CREATE_VEHICLE(joaat("dune2"), entityCoords, entityHeading, true, true, false);
			INTERIOR::UNPIN_INTERIOR(inLocal_170);
			bLocal_169 = true;
		}
	}
...
void func_243() // Position - 0x22F9C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			if (func_215(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, false, true, false))
...
void func_250() // Position - 0x23199
{
	...
	if (func_221())
	{
		if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			...
			if (func_214(PLAYER::PLAYER_PED_ID()) && func_214(uLocal_81.f_28[0]))
			{
				hLocal_145 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_81.f_28[0], hLocal_145);
			}
...
{
	uLocal_153[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2333.23f, 2574.97f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_l"), true, false, true);
	uLocal_153[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2329.65f, 2576.64f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_r"), true, false, true);
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_255(Global_78814, Global_78816, iParam10) };
				y == -0.014f;
...
float func_254(const char* sParam0) // Position - 0x235B3
{
...
BOOL func_264(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x23994
{
	...
	switch (Global_78813)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_248(0) || func_265(true))
			{
			}
			else
			{
...
void func_269(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x23CE9
{
	...
	func_183(false, true, false, false, false, false, false);
...
void func_272(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x24059
{
	func_38(pveParam0);
...
BOOL func_273(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2409B
{
	if (func_274(ppedParam0, echParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_274(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x240F7
{
	Hash model;
...
void func_281() // Position - 0x242AB
{
	...
	func_33(&pedLocal_158, false);
	func_33(&obLocal_159, false);
	func_37(&pedLocal_171);
...
void func_288() // Position - 0x2465D
{
	...
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_78558)
		{
			if (func_289() == 2 == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
BOOL func_290(int iParam0, int iParam1) // Position - 0x24B26
{
...
BOOL func_312(Ped pedParam0, int iParam1, int iParam2) // Position - 0x25637
{
	Hash entityModel;
	int i;
	var unk;
	...
	if (!func_181(pedParam0, iParam1, iParam2))
		return false;
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			if (!func_312(pedParam0, 14, unk18[j]))
				flag = 0;
		}
	...
	{
		unk28 = { func_98(entityModel, 0) };
		Global_78341[1 /*14*/] = { func_117(entityModel, iParam1, unk28[iParam1], -1) };
...
void func_313(const char* sParam0, int iParam1) // Position - 0x257F4
{
...
void func_317(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25972
{
	...
	if (iParam0 != -1)
	{
		...
		func_318(&unk33, unk.f_3, Global_100718, bParam1, bParam2);
	}

	return;
}

void func_318(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x259B1
{
...
void func_357(const char* sParam0, int iParam1) // Position - 0x2AFB1
{
	if (Global_100681 != 12)
...
BOOL func_358(const char* sParam0, int iParam1, int iParam2) // Position - 0x2AFD9
{
...
int func_362(Hash hParam0, BOOL bParam1) // Position - 0x2B20C
{
	int i;
...
Hash func_378(eCharacter echParam0) // Position - 0x2B5D7
{
