...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_269(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	if (!func_253(&unk63, &num, vector, 1f))
	{
		func_252();
	...
	func_241(&num);
	iLocal_90 = PED::ADD_SCENARIO_BLOCKING_AREA(vector - { 20f, 20f, 20f }, vector + { 20f, 20f, 20f }, false, true, true, true);
	...
	while (true)
	{
		...
		func_202(num);
		func_194(&iLocal_89, &(num.f_9), vector);
...
var func_15(Hash hParam0) // Position - 0xBBB
{
	var outValue;
...
void func_21(const char* sParam0) // Position - 0xCB0
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xCE0
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19B8
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2863
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x28EB
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x292B
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2959
{
...
int func_31(Vehicle veParam0) // Position - 0x2A35
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2A77
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2ADA
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2B68
{
	Hash num;
...
void func_37(Vehicle veParam0, var uParam1) // Position - 0x2E11
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x342F
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x355E
{
	int i;
	var garageName;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x36A4
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36E1
{
...
Hash func_47(eCharacter echParam0) // Position - 0x3706
{
	return Global_2058[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3715
{
...
Hash func_50(int iParam0, int iParam1) // Position - 0x38DE
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x38F3
{
	int num;
	int num2;
...
BOOL func_53(int iParam0, int iParam1) // Position - 0x3933
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3957
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396C
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB5
{
	eCharacter character;
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4818
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x54C9
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5504
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5778
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D03
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64C6
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x650D
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6578
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x698B
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x699B
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74B2
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x74DC
{
...
BOOL func_85(Player plParam0) // Position - 0x7508
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x760A
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x769F
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x833E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x83C0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8418
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x869D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x86BA
{
...
int func_106(int iParam0) // Position - 0x8C03
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C25
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8C3C
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8CFA
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D6C
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D82
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D98
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8DD9
{
...
BOOL func_122(Any* panParam0) // Position - 0xA7D9
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xA977
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAA53
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAB4C
{
...
int func_134(Ped pedParam0) // Position - 0xABB3
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xABFC
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC1C
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAC3D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAD0D
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAD60
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAE55
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAEFF
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB066
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB100
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB122
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB16F
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB1EC
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB290
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB31F
{
...
void func_160(Vehicle veParam0) // Position - 0xB4B7
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB673
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB6D9
{
...
BOOL func_169(int iParam0) // Position - 0xB71A
{
	int num;
	...
	num = func_171(&(Global_112897[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB791
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB8C8
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB917
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xB928
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBB09
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBB3C
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBB85
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0xBBA9
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_181(var uParam0) // Position - 0xC3A8
{
	float num;
...
void func_182(int iParam0, var uParam1) // Position - 0xC436
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_183(BOOL bParam0) // Position - 0xC49A
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_184(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_184(Vehicle veParam0) // Position - 0xC531
{
...
BOOL func_185(int iParam0) // Position - 0xC55B
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_193() || Global_112857 || Global_32286 || func_192() || func_191(8, -1) || func_100() || func_190() || func_189() || func_188() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_193() || Global_32286 || func_192() || func_191(8, -1) || func_189() || func_100() || func_190() || func_188() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_193() || Global_112857 || Global_32286 || func_192() || func_191(8, -1) || func_189() || func_100() || func_190() || func_188() || Global_113810.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_193() || Global_112857 || Global_32286 || func_192() || func_191(8, -1) || func_100() || func_190() || func_188() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_193() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_191(8, -1) || func_188() || func_187() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_186() // Position - 0xCC78
{
	return Global_100872.f_1;
}

BOOL func_187() // Position - 0xCC86
{
	if (Global_97735 != -1)
...
BOOL func_191(int iParam0, int iParam1) // Position - 0xCCFE
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_192() // Position - 0xCD36
{
	return Global_1575063;
}

BOOL func_193() // Position - 0xCD42
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_197(var uParam0, int iParam1) // Position - 0xCEC4
{
	BOOL flag;
	int i;
...
float func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xCF62
{
...
void func_200(var uParam0) // Position - 0xCFA8
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_201(uParam0);
...
void func_201(var uParam0) // Position - 0xCFBF
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD0CF
{
	var unk;
	...
	if (func_240(*panParam0) || func_238(*panParam0) || Global_78935 == 1)
		return true;
	...
	if (func_207(&(panParam0->f_48)) && bParam1)
		func_204(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_204(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD33F
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_206(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_205(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_205(int iParam0) // Position - 0xD697
{
...
BOOL func_206(var uParam0) // Position - 0xD6B7
{
...
BOOL func_207(var uParam0) // Position - 0xD6CF
{
...
void func_209(Object* pobParam0) // Position - 0xD9F8
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDAA3
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_184(playersLastVehicle2))
						{
						...
						if (*uParam0 == 16)
						{
							if (func_212(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
...
BOOL func_212(Ped pedParam0, Vehicle veParam1) // Position - 0xDC61
{
...
BOOL func_213(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDC91
{
	int i;
	int num;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					...
					if (func_232(*uParam0))
					{
						if (!func_168(*uParam0))
						{
							if (func_227(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_208(uParam0);
								else
						...
						if (func_215(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_208(uParam0);
							else
...
BOOL func_214(int iParam0) // Position - 0xDF4D
{
...
BOOL func_215(Ped pedParam0, int iParam1) // Position - 0xDF81
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		if (func_226(pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
		{
...
BOOL func_216(Ped pedParam0, int iParam1) // Position - 0xDFF7
{
	return func_217(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_217(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE00F
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_225(pedParam0, pedParam1);
	...
	if (!func_221(pedParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_218(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_218(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE0D0
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_219(pedParam4, iParam7) };
...
Vector3 func_219(Ped pedParam0, int iParam1) // Position - 0xE1FC
{
...
BOOL func_221(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE30B
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_223(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_223(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };

	num = func_222(entityForwardVector, unk);
...
float func_222(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE39C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_223(float fParam0, var uParam1, var uParam2) // Position - 0xE3BD
{
	float num;
	float num2;
...
int func_225(Ped pedParam0, Ped pedParam1) // Position - 0xE417
{
	int i;
...
BOOL func_226(Ped pedParam0) // Position - 0xE456
{
...
BOOL func_227(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE47E
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (!bParam2)
		{
			if (func_231(pedParam0, bParam1, radius, num))
				return true;
		
			if (func_228(pedParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_228(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE579
{
	float entityCoords;
	float num;
...
BOOL func_229(Ped pedParam0, float fParam1) // Position - 0xE685
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_230(pedParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_230(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE71A
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_223(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_231(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE7A8
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_232(int iParam0) // Position - 0xE7F0
{
...
void func_233(Vehicle veParam0) // Position - 0xE83A
{
	int taskSequenceId;
...
BOOL func_234(int iParam0) // Position - 0xE8D7
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_235(int iParam0) // Position - 0xE96C
{
...
BOOL func_238(int iParam0) // Position - 0xE9EB
{
...
void func_241(var uParam0) // Position - 0xEA85
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_242(var uParam0) // Position - 0xEAB2
{
	uParam0->f_16 = 5;
...
BOOL func_243(int iParam0) // Position - 0xEB07
{
	var unk;
	eCharacter character;
...
BOOL func_244(int iParam0) // Position - 0xEB58
{
	const char* string2;
...
BOOL func_245(int iParam0) // Position - 0xEC11
{
	var unk;
...
BOOL func_246(int iParam0) // Position - 0xECD2
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_248(int iParam0) // Position - 0xEE37
{
...
BOOL func_249(int iParam0) // Position - 0xEE62
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_250(int iParam0) // Position - 0xEE8D
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_251(int iParam0) // Position - 0xEEB8
{
	if (func_235(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_253(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xEF07
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_254(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_254(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_254(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xEF6C
{
	int num;
	char* str;
	...
	if (func_255(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_255(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xEFE4
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_256(var uParam0, BOOL bParam1) // Position - 0xF05F
{
	if (bParam1)
	{
		func_270("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_257(uParam0, 0, false, false);
	}
...
void func_260(Object* pobParam0, BOOL bParam1) // Position - 0xF123
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_263(Vehicle* pveParam0) // Position - 0xF1AD
{
...
void func_264(Vehicle* pveParam0) // Position - 0xF1E5
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_266(var uParam0, int iParam1) // Position - 0xF293
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_267(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_267(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF2D4
{
...
void func_268(Ped* ppedParam0) // Position - 0xF324
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_269(int iParam0) // Position - 0xF365
{
	if (*iParam0 == -1)
		return;
