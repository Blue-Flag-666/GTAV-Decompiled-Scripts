...
void main() // Position - 0x0
{
	...
	if (!func_248(&unk63, &num, vector, 1f))
	{
		func_247();
	...
	func_236(&num);
	iLocal_92 = PED::ADD_SCENARIO_BLOCKING_AREA(vector - { 20f, 20f, 20f }, vector + { 20f, 20f, 20f }, false, true, true, true);
	...
	while (true)
	{
		...
		func_197(num);
		func_189(&iLocal_91, &(num.f_9), vector);
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x395E
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EA7
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x420D
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x4300
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x4803
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x5464
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x549F
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x5713
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C9E
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6928
{
	int i;
...
int func_93(Player plParam0) // Position - 0x85F1
{
...
void func_122(Ped pedParam0) // Position - 0xA8BE
{
	int num;
	int num2;
	int num3;
...
int func_124(Ped pedParam0) // Position - 0xA99A
{
	int i;
...
int func_130(Ped pedParam0) // Position - 0xAAFA
{
	int i;
...
BOOL func_131(Ped pedParam0) // Position - 0xAB43
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAB63
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_136(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xACA7
{
	int i;
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAE46
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xAFAD
{
	BOOL flag;
...
BOOL func_143(Player plParam0) // Position - 0xB039
{
...
int func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB086
{
	int num;
...
BOOL func_148(const char* sParam0) // Position - 0xB103
{
...
BOOL func_154(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB236
{
...
void func_155(Vehicle veParam0) // Position - 0xB3CE
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_172(const char* sParam0, int iParam1) // Position - 0xBA53
{
	int num;
	const char* str;
	Hash hashKey;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_179(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_179(Vehicle veParam0) // Position - 0xC44A
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_188() || Global_32166 || func_187() || func_186(8, -1) || func_184() || func_96() || func_185() || func_183() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_188() || Global_112695 || Global_32166 || func_187() || func_186(8, -1) || func_96() || func_185() || func_183() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_188() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_186(8, -1) || func_183() || func_182() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_188() || func_185() || Global_112695 || Global_32166 || func_187() || Global_44446 || func_186(8, -1) || func_184() || func_182() || func_183() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
void func_189(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCC77
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_193(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_192(uParam0, 1);
			}
			else
			{
				...
				if (func_193(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_195(uParam0);
			}
		}
	}
...
float func_193(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xCE7B
{
...
void func_199(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD258
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_201(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_200(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_201(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_200(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
void func_204(Object* pobParam0) // Position - 0xD911
{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_179(playersLastVehicle2))
						{
						...
						if (*uParam0 == 16)
						{
							if (func_207(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
...
BOOL func_207(Ped pedParam0, Vehicle veParam1) // Position - 0xDB7A
{
...
BOOL func_210(Ped pedParam0, int iParam1) // Position - 0xDE9A
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		if (func_221(pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
		{
...
BOOL func_211(Ped pedParam0, int iParam1) // Position - 0xDF10
{
	return func_212(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_212(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF28
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_220(pedParam0, pedParam1);
	...
	if (!func_216(pedParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_213(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_213(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xDFE9
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_214(pedParam4, iParam7) };
...
Vector3 func_214(Ped pedParam0, int iParam1) // Position - 0xE115
{
...
BOOL func_216(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE224
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_218(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_218(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };

	num = func_217(entityForwardVector, unk);
...
int func_220(Ped pedParam0, Ped pedParam1) // Position - 0xE330
{
	int i;
...
BOOL func_221(Ped pedParam0) // Position - 0xE36F
{
...
BOOL func_222(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE397
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (!bParam2)
		{
			if (func_226(pedParam0, bParam1, radius, num))
				return true;
		
			if (func_223(pedParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_223(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE492
{
	float entityCoords;
	float num;
...
BOOL func_224(Ped pedParam0, float fParam1) // Position - 0xE59E
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_225(pedParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE633
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_218(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_226(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE6C1
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_228(Vehicle veParam0) // Position - 0xE753
{
	int taskSequenceId;
...
void func_255(Object* pobParam0, BOOL bParam1) // Position - 0xF03C
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_258(Vehicle* pveParam0) // Position - 0xF0C6
{
...
void func_259(Vehicle* pveParam0) // Position - 0xF0FE
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_261(var uParam0, int iParam1) // Position - 0xF1AC
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_262(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_262(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF1ED
{
...
void func_263(Ped* ppedParam0) // Position - 0xF23D
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
