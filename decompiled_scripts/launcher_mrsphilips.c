...
void main() // Position - 0x0
{
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_264(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (!func_248(&unk64, &num, unk61, 1f))
	{
		func_247();
	...
	func_236(&num);
	uLocal_92 = unk_0x54ECDA2DAB9CFB10(unk61 - { 20f, 20f, 20f }, unk61 + { 20f, 20f, 20f }, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_197(num);
		func_189(&iLocal_91, &(num.f_9), unk61);
		...
		if (func_174(&num, 0))
		{
			if (num == 35)
			{
				if (iLocal_93 == 0)
				{
					if (!unk_0xB2FB1E59B6F71D15(joaat("DOORHASH_T_TRAILER_CS")))
						unk_0xC6DABC9B8ADA3309(joaat("DOORHASH_T_TRAILER_CS"), joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, 1, 0);
				
					if (unk_0xB2FB1E59B6F71D15(joaat("DOORHASH_T_TRAILER_CS")))
					{
						unk_0xE34512C3600D64F2(joaat("DOORHASH_T_TRAILER_CS"), 0f, 1, 0);
						unk_0x289D605FFACC399B(joaat("DOORHASH_T_TRAILER_CS"), 1, 1, 0);
						iLocal_93 = 1;
					}
				}
			}
...
void func_17(BOOL bParam0) // Position - 0xBF9
{
...
void func_21(var uParam0) // Position - 0xCB0
{
	unk_0x4310A0DB886F9FED(uParam0, uParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xCC3
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xCE0
{
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x28EB
{
...
BOOL func_29(var uParam0) // Position - 0x292B
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2959
{
...
int func_31(var uParam0) // Position - 0x2A35
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2A77
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2ADA
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2B68
{
	int num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2BAA
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E05
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(var uParam0, var uParam1) // Position - 0x2E11
{
	int i;
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x316C
{
	int i;
	int num;
...
BOOL func_40(int iParam0) // Position - 0x335F
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x342F
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x355E
{
	int i;
	var unk;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x35CC
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x36A4
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36E1
{
...
int func_47(eCharacter echParam0) // Position - 0x3706
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x38B5
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x38F2
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x3932
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x395E
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EA7
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x40E9
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x4588
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4629
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C9E
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6461
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x64A8
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6513
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x6574
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6918
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6928
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7424
{
...
BOOL func_81(Player plParam0) // Position - 0x744E
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7550
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x75E5
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x8287
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x8309
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8361
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x860E
{
...
int func_102(int iParam0) // Position - 0x8B4A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B6C
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8B83
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8C41
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8CDF
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8D20
{
...
BOOL func_118(Any* panParam0) // Position - 0xA720
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAA93
{
...
BOOL func_131(var uParam0) // Position - 0xAB43
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAB63
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL func_133(int iParam0) // Position - 0xAB84
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135(int iParam0) // Position - 0xAC54
{
	switch (iParam0)
	{
		case 5:
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xACA7
{
	int i;
...
BOOL func_137(int iParam0) // Position - 0xAD9C
{
	switch (iParam0)
	{
		case 5:
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAE46
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xAFAD
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB039
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB086
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB103
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB1A7
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB236
{
...
void func_155(var uParam0) // Position - 0xB3CE
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_161(int iParam0) // Position - 0xB58A
{
	if (iParam0 == 1)
...
BOOL func_163(int iParam0) // Position - 0xB5F0
{
...
BOOL func_164(int iParam0) // Position - 0xB631
{
	int num;
...
int func_166(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB6A8
{
	int i;
...
void func_167(int iParam0, int iParam1) // Position - 0xB7DF
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB82E
{
	return func_169(iParam0, Global_43257);
}

BOOL func_169(int iParam0, int iParam1) // Position - 0xB83F
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_170(int iParam0) // Position - 0xBA20
{
	if (Global_43257 == 15)
		return false;
...
int func_172(var uParam0, int iParam1) // Position - 0xBA53
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBA9C
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
BOOL func_174(var uParam0, int iParam1) // Position - 0xBAC0
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_176(var uParam0) // Position - 0xC2C1
{
	float num;
...
void func_177(int iParam0, var uParam1) // Position - 0xC34F
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_178(BOOL bParam0) // Position - 0xC3B3
{
	var unk;
...
BOOL func_179(var uParam0) // Position - 0xC44A
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_180(int iParam0) // Position - 0xC474
{
	eCharacter character;
...
BOOL func_181() // Position - 0xCB91
{
	return Global_100720.f_1;
}

BOOL func_182() // Position - 0xCB9F
{
	if (Global_97603 != -1)
...
BOOL func_186(int iParam0, int iParam1) // Position - 0xCC17
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_187() // Position - 0xCC4F
{
	return Global_1575060;
}

BOOL func_188() // Position - 0xCC5B
{
	if (!unk_0xA26A9A07F761D8F8())
...
void func_189(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCC77
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
...
void func_192(var uParam0, int iParam1) // Position - 0xCDDD
{
	BOOL flag;
	int i;
...
float func_193(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCE7B
{
	var unk;
...
void func_195(var uParam0) // Position - 0xCEC1
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_196(uParam0);
...
void func_196(var uParam0) // Position - 0xCED8
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xCFE8
{
	var unk;
	...
	if (func_235(*panParam0) || func_233(*panParam0) || Global_78804 == 1)
		return true;
	...
	if (func_202(&(panParam0->f_48)) && bParam1)
		func_199(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
...
BOOL func_200(int iParam0) // Position - 0xD5B0
{
...
BOOL func_201(var uParam0) // Position - 0xD5D0
{
...
BOOL func_202(var uParam0) // Position - 0xD5E8
{
...
void func_204(var uParam0) // Position - 0xD911
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD9BC
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_207(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_207(var uParam0, var uParam1) // Position - 0xDB7A
{
	var unk;
...
BOOL func_208(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDBAA
{
	int i;
	int num;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_28[i]))
			{
				if (!unk_0x66599E73DBA5A850(uParam0->f_28[i]))
				{
					...
					if (func_227(*uParam0))
					{
						if (!func_163(*uParam0))
						{
							if (func_222(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_203(uParam0);
								else
						...
						if (func_210(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_203(uParam0);
							else
...
BOOL func_209(int iParam0) // Position - 0xDE66
{
...
BOOL func_210(var uParam0, int iParam1) // Position - 0xDE9A
{
	float num;
...
BOOL func_211(var uParam0, int iParam1) // Position - 0xDF10
{
	return func_212(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_212(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF28
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_213(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xDFE9
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_214(var uParam0, int iParam1) // Position - 0xE115
{
	int num;
...
BOOL func_216(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE224
{
	var unk;
	var unk4;
	float num;
...
float func_217(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE2B5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_218(float fParam0, var uParam1, var uParam2) // Position - 0xE2D6
{
	float num;
	float num2;
...
int func_220(var uParam0, var uParam1) // Position - 0xE330
{
	int i;
...
int func_221(var uParam0) // Position - 0xE36F
{
...
BOOL func_222(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE397
{
	float num;
	float num2;
	int num3;
...
BOOL func_223(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE492
{
	float num;
	float num2;
...
BOOL func_224(var uParam0, float fParam1) // Position - 0xE59E
{
	var unk;
	var unk2;
...
BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE633
{
	var unk;
	var unk4;
	float num;
...
BOOL func_226(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE6C1
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_227(int iParam0) // Position - 0xE709
{
...
void func_228(var uParam0) // Position - 0xE753
{
	var unk;
...
BOOL func_229(int iParam0) // Position - 0xE7F0
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_230(int iParam0) // Position - 0xE885
{
...
BOOL func_233(int iParam0) // Position - 0xE904
{
...
BOOL func_235(int iParam0) // Position - 0xE976
{
...
void func_236(var uParam0) // Position - 0xE99E
{
	if (!unk_0xCBE2EC2868A6C438())
	{
...
void func_237(var uParam0) // Position - 0xE9CB
{
	uParam0->f_16 = 5;
...
BOOL func_238(int iParam0) // Position - 0xEA20
{
	var unk;
	eCharacter character;
...
BOOL func_239(int iParam0) // Position - 0xEA71
{
	var unk;
...
BOOL func_240(int iParam0) // Position - 0xEB2A
{
	var unk;
...
BOOL func_241(int iParam0) // Position - 0xEBEB
{
	int i;
	var unk;
	int num;
...
BOOL func_243(int iParam0) // Position - 0xED50
{
...
BOOL func_244(int iParam0) // Position - 0xED7B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_245(int iParam0) // Position - 0xEDA6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_246(int iParam0) // Position - 0xEDD1
{
	if (func_230(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_248(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xEE20
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_249(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_249(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_249(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xEE85
{
	int num;
	char* str;
	...
	if (func_250(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_250(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xEEFD
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_251(var uParam0, BOOL bParam1) // Position - 0xEF78
{
	if (bParam1)
	{
		func_265("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_252(uParam0, 0, false, false);
	}
...
void func_255(var uParam0, BOOL bParam1) // Position - 0xF03C
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_258(var uParam0) // Position - 0xF0C6
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_259(var uParam0) // Position - 0xF0FE
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_261(var uParam0, int iParam1) // Position - 0xF1AC
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_262(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_262(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF1ED
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_263(var uParam0) // Position - 0xF23D
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
void func_264(int iParam0) // Position - 0xF27E
{
	if (*iParam0 == -1)
		return;
