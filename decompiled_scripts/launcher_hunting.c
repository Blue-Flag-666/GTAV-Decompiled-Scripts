...
void main() // Position - 0x0
{
	...
	iLocal_92 = func_281(CHAR_HUNTER);
	iLocal_93 = joaat("dune");
	uLocal_94 = unk_0x823FFE0ED27D2780(joaat("WEAPON_SNIPERRIFLE"));
	uLocal_95 = unk_0x1BF6E110CDFA29AD(joaat("COMPONENT_AT_SCOPE_LARGE"));
	uLocal_96 = unk_0x1BF6E110CDFA29AD(joaat("COMPONENT_AT_AR_SUPP_02"));
	uLocal_97 = { -683.8261f, 5840.8096f, 16.566f };
	iLocal_101 = -1;
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_277(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	unk_0xF82BC5193AF62796(vector, 3f, 1, 0, 0, 0);
	...
	while (true)
	{
		...
		func_201(num);
		func_194(&iLocal_101, &(num.f_9), vector);
	
		if (num == 25)
			func_189(&num, vector, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		...
		if (num == 25)
			if (SYSTEM::VDIST2(vector, vector2) < 10f * 10f)
				...
				unk_0xC99325818121C4B9(unk_0xC1A5EC5C986B98AD(), 3f);
	
		if (func_174(&num, 0) && unk_0x2655A8EC638E4FD1(vector.f_2 - vector2.f_2) < 2.5f)
		{
			if (!func_2(&num))
				func_265(&num, true);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3931
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x396E
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x39AE
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39DA
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F23
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4164
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x4603
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x46A4
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D19
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64DC
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x6523
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x658E
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x65EF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6993
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69A3
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x749F
{
...
BOOL func_81(Player plParam0) // Position - 0x74C9
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x75CB
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7660
{
	float num;
	float num2;
	float num3;
...
var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BE3
{
	if (bParam0)
		return uParam1;
...
BOOL func_131(var uParam0) // Position - 0xAC4E
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAC6E
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xADB2
{
	int i;
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF51
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB0B8
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB144
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB191
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB20E
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB341
{
...
void func_155(var uParam0) // Position - 0xB4D9
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
int func_172(var uParam0, int iParam1) // Position - 0xBB5E
{
	int num;
	var unk;
	var unk33;
...
BOOL func_179(var uParam0) // Position - 0xC554
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_180(int iParam0) // Position - 0xC57E
{
	eCharacter character;
...
BOOL func_181() // Position - 0xCC9B
{
	return Global_100720.f_1;
}

BOOL func_182() // Position - 0xCCA9
{
	if (Global_97603 != -1)
...
BOOL func_186(int iParam0, int iParam1) // Position - 0xCD21
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_187() // Position - 0xCD59
{
	return Global_1575060;
}

BOOL func_188() // Position - 0xCD65
{
	if (!unk_0xA26A9A07F761D8F8())
...
int func_189(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCD81
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_193(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCE09
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCE9A
{
...
float func_193(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCF35
{
	var unk;
...
void func_194(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCF6F
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_193(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_197(uParam0, 1);
			}
			else
			{
				...
				if (func_193(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_199(uParam0);
			}
		}
	}
...
void func_197(var uParam0, int iParam1) // Position - 0xD0D5
{
	BOOL flag;
	int i;
...
void func_199(var uParam0) // Position - 0xD17F
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_200(uParam0);
...
void func_200(var uParam0) // Position - 0xD196
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD2A6
{
	var unk;
	...
	if (func_239(*panParam0) || func_237(*panParam0) || Global_78804 == 1)
		return true;
	...
	if (func_233(*panParam0))
	{
		if (*panParam0 == 19)
			func_232(panParam0->f_28[0]);
	...
	if (panParam0->f_25 == 1)
		if (!func_212(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_212(panParam0, false, 0))
			return false;
...
void func_203(int iParam0, var uParam1, int iParam2) // Position - 0xD516
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_205(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_204(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_205(uParam1) && uParam1->f_4 == 0 && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_204(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_204(int iParam0) // Position - 0xD86E
{
...
BOOL func_205(var uParam0) // Position - 0xD88E
{
...
BOOL func_206(var uParam0) // Position - 0xD8A6
{
...
void func_208(var uParam0) // Position - 0xDBCF
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDC7A
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_211(var uParam0, var uParam1) // Position - 0xDE38
{
	var unk;
...
BOOL func_212(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDE68
{
	int i;
	int num;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_28[i]))
			{
				if (!unk_0x66599E73DBA5A850(uParam0->f_28[i]))
				{
					...
					if (func_231(*uParam0))
					{
						if (!func_163(*uParam0))
						{
							if (func_226(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_207(uParam0);
								else
						...
						if (func_214(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_207(uParam0);
							else
...
BOOL func_213(int iParam0) // Position - 0xE124
{
...
BOOL func_214(var uParam0, int iParam1) // Position - 0xE158
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_225(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_215(var uParam0, int iParam1) // Position - 0xE1CE
{
	return func_216(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_216(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE1E6
{
	BOOL flag;
	var unk;
	int num;

	num = func_224(uParam0, uParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam1))
	{
		if (num != -1)
			func_223(&iLocal_37[num /*4*/]);
	
		return false;
	}

	if (!func_220(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_217(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_217(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE2A7
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_218(var uParam0, int iParam1) // Position - 0xE3D3
{
	int num;
...
BOOL func_220(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE4E2
{
	var unk;
	var unk4;
	float num;

	unk = { func_222(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_222(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_221(unk4, unk);
...
float func_221(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE573
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_222(float fParam0, var uParam1, var uParam2) // Position - 0xE594
{
	float num;
	float num2;
...
int func_224(var uParam0, var uParam1) // Position - 0xE5EE
{
	int i;
...
int func_225(var uParam0) // Position - 0xE62D
{
...
BOOL func_226(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE655
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_230(uParam0, bParam1, num, num2))
				return true;
		
			if (func_227(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_227(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE750
{
	float num;
	float num2;
...
BOOL func_228(var uParam0, float fParam1) // Position - 0xE85C
{
	var unk;
	var unk2;
	...
	if (unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_229(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_229(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE8F1
{
	var unk;
	var unk4;
	float num;

	unk = { func_222(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_230(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE97F
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_231(int iParam0) // Position - 0xE9C7
{
...
void func_232(var uParam0) // Position - 0xEA11
{
	var unk;
...
BOOL func_233(int iParam0) // Position - 0xEAAE
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_234(int iParam0) // Position - 0xEB43
{
...
BOOL func_237(int iParam0) // Position - 0xEBC2
{
...
BOOL func_239(int iParam0) // Position - 0xEC34
{
...
BOOL func_240(var uParam0) // Position - 0xEC5C
{
	switch (*uParam0)
	{
		case 25:
...
BOOL func_241(var uParam0) // Position - 0xECA3
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x28818732C8F0F80E("rcmhunting2");
			iLocal_91 = 1;
			break;
	
		case 1:
			if (!func_248(&num) || !unk_0x2BBF749E555360DC("rcmhunting2"))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (func_245(&uParam0->f_28[0], CHAR_HUNTER, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 1))
					unk_0xCBDC2B59922F92C3(uParam0->f_28[0], joaat("WEAPON_PUMPSHOTGUN"), 0, 1, 1);
				else
					flag = false;
			...
			if (!unk_0x7DE17ACDD8BA2642(uLocal_100))
			{
				uLocal_100 = unk_0x9A27CA9A0DA58E5D(joaat("WEAPON_SNIPERRIFLE"), 0, uLocal_97, 0, 1065353216, 0, 0, 1);
				unk_0xDAE94EB7AAFB39B9(uLocal_100, joaat("COMPONENT_AT_SCOPE_LARGE"));
				unk_0xDAE94EB7AAFB39B9(uLocal_100, joaat("COMPONENT_AT_AR_SUPP_02"));
			}
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
				if (unk_0x2BBF749E555360DC("rcmhunting2"))
					unk_0xC4F7B29AE0A7D629(uParam0->f_28[0], "rcmhunting2", "_idle_loop", -683.152f, 5841.281f, 17.32f, 0f, 0f, 17.024f, 1000f, -8f, -1, 790537, 0f, 2, 1);
		
			unk_0xEDB03CCB50D11479(uParam0->f_28[0], unk_0xC1A5EC5C986B98AD(), -1, 3088, 2);
		
			if (unk_0x17AE936FF608BF89(uLocal_97, 1f, uLocal_94, 0))
				unk_0x464B5B0F22497FC5(uLocal_100, 0f, -90f, -162.64f, 2, 1);
...
void func_242(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xEED8
{
	func_243(uParam0, iLocal_93, fParam1, fParam4);
...
void func_243(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xEF3E
{
	func_244(uParam0);
...
void func_244(var uParam0) // Position - 0xEF80
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_245(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF01C
{
...
BOOL func_246(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF078
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_281(echParam1);
...
int func_247(var uParam0, eCharacter echParam1) // Position - 0xF106
{
	int num;
...
BOOL func_248(var uParam0) // Position - 0xF14C
{
	int i;
...
BOOL func_249(var uParam0) // Position - 0xF17D
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&num) || !func_250(&(uParam0->f_48)) || !unk_0x2BBF749E555360DC("special_ped@cletus@base"))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (func_245(&uParam0->f_28[0], CHAR_HUNTER, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
...
BOOL func_250(var uParam0) // Position - 0xF433
{
	if (func_206(uParam0))
	{
...
BOOL func_252(int iParam0) // Position - 0xF499
{
	var unk;
	eCharacter character;
...
BOOL func_253(int iParam0) // Position - 0xF4EA
{
	var unk;
...
BOOL func_254(int iParam0) // Position - 0xF5A3
{
	var unk;
...
BOOL func_255(int iParam0) // Position - 0xF664
{
	int i;
	var unk;
	int num;
...
BOOL func_257(int iParam0) // Position - 0xF7CB
{
...
BOOL func_258(int iParam0) // Position - 0xF7F6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_259(int iParam0) // Position - 0xF821
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_260(int iParam0) // Position - 0xF84C
{
	if (func_234(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_262(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF89B
{
	int i;
...
BOOL func_263(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF900
{
	int num;
	char* str;
...
BOOL func_264(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF978
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_265(var uParam0, BOOL bParam1) // Position - 0xF9F3
{
	if (bParam1)
	{
...
void func_269(var uParam0, BOOL bParam1) // Position - 0xFAB0
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_272(var uParam0) // Position - 0xFB3A
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_274(var uParam0, int iParam1) // Position - 0xFB84
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_275(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_275(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFBC5
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_276(var uParam0) // Position - 0xFC15
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
void func_277(int iParam0) // Position - 0xFC56
{
	if (*iParam0 == -1)
		return;
...
int func_281(eCharacter echParam0) // Position - 0xFCF2
{
	if (!func_36(echParam0))
