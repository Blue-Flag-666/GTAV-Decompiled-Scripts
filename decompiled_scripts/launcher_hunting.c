...
void main() // Position - 0x0
{
	...
	iLocal_90 = func_286(CHAR_HUNTER);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_206(num);
		func_199(&iLocal_99, &(num.f_9), vector);
	
		if (num == 25)
			func_194(&num, vector, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		...
		if (func_179(&num, 0) && MISC::ABSF(vector.f_2 - entityCoords.f_2) < 2.5f)
		{
			if (!func_2(&num))
				func_270(&num, true);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4894
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5545
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5580
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57F4
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D7F
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6542
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6589
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65F4
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A07
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A17
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x752E
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7558
{
...
BOOL func_85(Player plParam0) // Position - 0x7584
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7686
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x771B
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x83BD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x843F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8497
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x871C
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8739
{
...
int func_106(int iParam0) // Position - 0x8C82
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CA4
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8CBB
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D79
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DEB
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E01
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E17
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E59
{
...
BOOL func_122(Any* panParam0) // Position - 0xA8EC
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA8A
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAB66
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAC5F
{
...
int func_134(Ped pedParam0) // Position - 0xACC6
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAD0F
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAD2F
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAD50
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAE20
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE73
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAF68
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB012
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB179
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB213
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB235
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB282
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB2FF
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB3A3
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB432
{
...
void func_160(Vehicle veParam0) // Position - 0xB5CA
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB786
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB7EC
{
...
BOOL func_169(int iParam0) // Position - 0xB82D
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB8A4
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB9DB
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA2A
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBA3B
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBC1C
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBC4F
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC98
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0xBCBC
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_181(var uParam0) // Position - 0xC4BB
{
	float num;
...
void func_182(int iParam0, var uParam1) // Position - 0xC549
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_183(BOOL bParam0) // Position - 0xC5AD
{
...
BOOL func_184(Vehicle veParam0) // Position - 0xC644
{
...
BOOL func_185(int iParam0) // Position - 0xC66E
{
	eCharacter character;
...
BOOL func_186() // Position - 0xCD8B
{
	return Global_100872.f_1;
}

BOOL func_187() // Position - 0xCD99
{
	if (Global_97735 != -1)
...
BOOL func_191(int iParam0, int iParam1) // Position - 0xCE11
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_192() // Position - 0xCE49
{
	return Global_1575063;
}

BOOL func_193() // Position - 0xCE55
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_194(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCE71
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCEF9
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCF8A
{
...
float func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD025
{
	Vector3 entityCoords;
...
void func_199(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD05F
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_202(var uParam0, int iParam1) // Position - 0xD1C5
{
	BOOL flag;
	int i;
...
void func_204(var uParam0) // Position - 0xD26F
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_205(uParam0);
...
void func_205(var uParam0) // Position - 0xD286
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD396
{
	var unk;
	...
	if (func_244(*panParam0) || func_242(*panParam0) || Global_78935 == 1)
		return true;
	...
	if (func_238(*panParam0))
	{
		if (*panParam0 == 19)
			func_237(panParam0->f_28[0]);
	...
	if (panParam0->f_25 == 1)
		if (!func_217(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_217(panParam0, false, 0))
			return false;
	...
	if (func_211(&(panParam0->f_48)) && bParam1)
		func_208(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_208(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD606
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_210(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_209(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_210(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_209(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_209(int iParam0) // Position - 0xD95E
{
...
BOOL func_210(var uParam0) // Position - 0xD97E
{
...
BOOL func_211(var uParam0) // Position - 0xD996
{
...
void func_213(Object* pobParam0) // Position - 0xDCBF
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDD6A
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_216(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
...
BOOL func_216(Ped pedParam0, Vehicle veParam1) // Position - 0xDF28
{
...
BOOL func_217(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDF58
{
	int i;
	int num;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					...
					if (func_236(*uParam0))
					{
						if (!func_168(*uParam0))
						{
							if (func_231(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_212(uParam0);
								else
						...
						if (func_219(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_212(uParam0);
							else
...
BOOL func_218(int iParam0) // Position - 0xE214
{
...
BOOL func_219(Ped pedParam0, int iParam1) // Position - 0xE248
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		if (func_230(pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
		{
...
BOOL func_220(Ped pedParam0, int iParam1) // Position - 0xE2BE
{
	return func_221(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_221(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE2D6
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_229(pedParam0, pedParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam1))
	{
		if (num != -1)
			func_228(&iLocal_35[num /*4*/]);
	
		return false;
	}

	if (!func_225(pedParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_222(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_222(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE397
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_223(pedParam4, iParam7) };
...
Vector3 func_223(Ped pedParam0, int iParam1) // Position - 0xE4C3
{
...
BOOL func_225(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE5D2
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_227(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_227(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };

	num = func_226(entityForwardVector, unk);
...
float func_226(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE663
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_227(float fParam0, var uParam1, var uParam2) // Position - 0xE684
{
	float num;
	float num2;
...
int func_229(Ped pedParam0, Ped pedParam1) // Position - 0xE6DE
{
	int i;
...
BOOL func_230(Ped pedParam0) // Position - 0xE71D
{
...
BOOL func_231(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE745
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (!bParam2)
		{
			if (func_235(pedParam0, bParam1, radius, num))
				return true;
		
			if (func_232(pedParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_232(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE840
{
	float entityCoords;
	float num;
...
BOOL func_233(Ped pedParam0, float fParam1) // Position - 0xE94C
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_234(pedParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_234(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE9E1
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_227(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_235(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEA6F
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_236(int iParam0) // Position - 0xEAB7
{
...
void func_237(Vehicle veParam0) // Position - 0xEB01
{
	int taskSequenceId;
...
BOOL func_238(int iParam0) // Position - 0xEB9E
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_239(int iParam0) // Position - 0xEC33
{
...
BOOL func_242(int iParam0) // Position - 0xECB2
{
...
BOOL func_244(int iParam0) // Position - 0xED24
{
...
BOOL func_245(var uParam0) // Position - 0xED4C
{
	switch (*uParam0)
	{
		case 25:
...
BOOL func_246(var uParam0) // Position - 0xED93
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_253(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmhunting2"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_250(&uParam0->f_28[0], CHAR_HUNTER, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 1))
...
void func_247(Vehicle* pveParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xEFC8
{
	func_248(pveParam0, hLocal_91, fParam1, fParam4);
...
void func_248(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF02E
{
	func_249(pveParam0);
...
void func_249(Vehicle* pveParam0) // Position - 0xF070
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_250(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF10C
{
	if (func_251(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_251(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF168
{
	Hash model;
...
int func_252(var uParam0, eCharacter echParam1) // Position - 0xF1F6
{
	int num;
...
BOOL func_253(var uParam0) // Position - 0xF23C
{
	int i;
...
BOOL func_254(var uParam0) // Position - 0xF26D
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_253(&num) || !func_255(&(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_250(&uParam0->f_28[0], CHAR_HUNTER, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
...
BOOL func_255(var uParam0) // Position - 0xF523
{
	if (func_211(uParam0))
	{
...
BOOL func_257(int iParam0) // Position - 0xF589
{
	var unk;
	eCharacter character;
...
BOOL func_258(int iParam0) // Position - 0xF5DA
{
	const char* string2;
...
BOOL func_259(int iParam0) // Position - 0xF693
{
	var unk;
...
BOOL func_260(int iParam0) // Position - 0xF754
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_262(int iParam0) // Position - 0xF8BB
{
...
BOOL func_263(int iParam0) // Position - 0xF8E6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_264(int iParam0) // Position - 0xF911
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_265(int iParam0) // Position - 0xF93C
{
	if (func_239(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_267(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF98B
{
	int i;
...
BOOL func_268(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF9F0
{
	int num;
	char* str;
...
BOOL func_269(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFA68
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_270(var uParam0, BOOL bParam1) // Position - 0xFAE3
{
	if (bParam1)
	{
...
void func_274(Object* pobParam0, BOOL bParam1) // Position - 0xFBA0
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_277(Vehicle* pveParam0) // Position - 0xFC2A
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_280(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFCB5
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_281(Ped* ppedParam0) // Position - 0xFD05
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_282(int iParam0) // Position - 0xFD46
{
	if (*iParam0 == -1)
		return;
...
Hash func_286(eCharacter echParam0) // Position - 0xFDE2
{
	if (!func_36(echParam0))
