...
void func_42(int* iParam0, bool bParam1, bool bParam2)
{
	...
	while (bVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(iParam0->f_17[bVar0]))
		{
			...
			if (bParam1)
			{
				if (PED::IS_PED_GROUP_MEMBER(iParam0->f_17[bVar0], func_43()) && iParam0->f_17[bVar0] != PLAYER::PLAYER_PED_ID())
				{
...
{
	func_110(&Global_106470, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_133(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2860791[iParam0 /*3*/][func_131(iParam1)];
...
void func_229()
{
	...
	switch (iLocal_2129)
	{
		case 0:
			...
			{
				iLocal_378 = func_279(Local_169[2 /*2*/]);
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103486.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103486.f_4, false))
		{
			if (func_262(24) != Global_103486.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_259(ENTITY::GET_ENTITY_COORDS(Global_103486.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_231(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_252(iParam5, &Var0, Param1, fParam4, func_117(iParam0));
...
void func_252(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_251(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		...
		case 1:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240,513f, -2880,356f, 2,10339f, 1240,559f, -3057,271f, 17,4f, 29,45f, false, true, 0))
			{
				if (func_107(Local_64[4 /*10*/]))
				{
					...
					{
						AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
						if (!func_285(Local_64[4 /*10*/], 1464580341, 1))
						{
...
void func_296()
{
	...
	if (iLocal_2132 == 1)
	{
		...
		else if (iLocal_2127 == 3)
		{
			...
			if (!func_312())
			{
				func_311(iLocal_2133, &Var0, &fVar3);
...
void func_327()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96477.f_28[2]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96477.f_28[2], true, true);
			Local_169[2 /*2*/] = Global_96477.f_28[2];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96477.f_28[3]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96477.f_28[3], true, true);
			Local_169[3 /*2*/] = Global_96477.f_28[3];
		}
	}
	if (Global_96477.f_357)
	{
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_96477.f_37[0])))
		{
			PHYSICS::ROPE_CHANGE_SCRIPT_OWNER(Global_96477.f_37[0], true, true);
			Local_145[0 /*5*/] = Global_96477.f_37[0];
			Global_96477.f_37[0] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_96477.f_37[1])))
		{
			PHYSICS::ROPE_CHANGE_SCRIPT_OWNER(Global_96477.f_37[1], true, true);
			Local_145[1 /*5*/] = Global_96477.f_37[1];
			Global_96477.f_37[1] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_96477.f_37[2])))
		{
			PHYSICS::ROPE_CHANGE_SCRIPT_OWNER(Global_96477.f_37[2], true, true);
			Local_145[2 /*5*/] = Global_96477.f_37[2];
			Global_96477.f_37[2] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_96477.f_37[3])))
		{
			PHYSICS::ROPE_CHANGE_SCRIPT_OWNER(Global_96477.f_37[3], true, true);
