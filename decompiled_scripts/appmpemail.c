...
void func_5() // Position - 0x398
{
	...
	if (bLocal_37 == false)
	{
		if (func_3(FRONTEND_CONTROL, Global_20476, 0))
		{
			func_9();
			bLocal_37 = true;
			SYSTEM::SETTIMERA(0);
		...
		if (func_3(FRONTEND_CONTROL, Global_20477, 0))
		{
			func_6();
			bLocal_37 = true;
			SYSTEM::SETTIMERA(0);
...
void func_12() // Position - 0x51C
{
	if (Global_4541037[iLocal_34 /*104*/].f_24 == 1)
	{
		if (Global_20478 == 0)
		{
			if (PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, Global_20471))
			{
				func_2();
				Global_20478 = 1;
	...
	{
		if (PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, Global_20472))
		{
			if (iLocal_36 == 1)
			{
				if (Global_20500.f_1 > 3)
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_75799, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&Global_22886), 64);
	...
	if (Global_4541037[iLocal_34 /*104*/].f_31 == 1)
	{
		if (Global_20478 == 0)
		{
			if (func_3(FRONTEND_CONTROL, Global_20472, 0))
			{
				func_27();
				Global_20478 = 1;
	...
	{
		if (func_3(FRONTEND_CONTROL, Global_20469, 0))
		{
			Global_20478 = 1;
			...
			else if (Global_4541037[iLocal_34 /*104*/].f_30 == 1)
			{
				...
				if (func_23(Global_7685, Global_20500) == 0)
					func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_211" /*DIALING...*/, "CELL_195" /*Unknown*/, 0);
				else
					func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), "CELL_211" /*DIALING...*/, &(Global_2058[Global_7685 /*29*/].f_3), 0);
...
void func_13() // Position - 0x86A
{
	...
	switch (Global_20500.f_1)
	{
		case 6:
			...
			if (Global_20488)
			{
				func_22(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
				func_22(Global_20481, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_20705 == 1)
					if (Global_20488)
						func_22(Global_20481, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
					else
						func_22(Global_20481, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_20488)
					func_22(Global_20481, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
				else
		...
		case 10:
			...
			{
				func_22(Global_20481, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /*END CALL*/, 0, 0, 0, 0);
		...
		case 9:
			if (Global_20499 == 1)
			{
				...
				{
					func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2058[Global_7685 /*29*/].f_3), 0);
				}
			...
			else if (Global_21845 == 4 || Global_21845 == 3)
			{
				...
				else
				{
					...
					if (func_23(Global_7685, Global_20500) == 0)
					{
						...
						func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_57(Global_20481, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), &unk, &(Global_2058[Global_7685 /*29*/].f_3), 0);
					}
				}
...
void func_14() // Position - 0xE1F
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20481))
	{
		...
		{
			if (Global_20488)
				func_22(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /*ANSWER*/, 0, 0, 0, 0);
			else
			...
			if (Global_21892)
				...
				func_22(Global_20481, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /*REJECT*/, 0, 0, 0, 0);
			else
				func_22(Global_20481, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
				...
				if (iParam0 == Global_8377[num /*15*/].f_11)
				{
					if (i == Global_8377[num /*15*/].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (Global_2694571)
								if (num == 14)
									func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22908), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8377[num /*15*/].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22913), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
									...
									func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8377[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
							}
...
void func_22(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x1835
{
...
void func_32() // Position - 0x1BC4
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_33(character) && !func_21(14) || Global_112760)
			{
...
void func_37() // Position - 0x1D3E
{
	...
	if (Global_20478 == 0)
	{
		if (func_3(FRONTEND_CONTROL, Global_20469, 0) || Global_4542287 == 1 || Global_22905 == 1)
		{
			...
			if (iLocal_32 == iLocal_31 || iLocal_32 > iLocal_31)
			{
				...
				{
					if (IS_BIT_SET(Global_4542302, 25))
						MISC::CLEAR_BIT(&Global_4542302, 25);
				
					if (Global_4541036 > 0)
					{
						func_39(12517, iLocal_1367, -1, true);
			...
			if (Global_4541037[iLocal_34 /*104*/].f_24 != 0)
			{
				...
				gxt = { Global_4541037[iLocal_34 /*104*/] };
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&gxt))
				{
					...
					if (Global_20488)
						func_22(Global_20481, "SET_SOFT_KEYS", 1f, 1f, 16f, -1f, -1f, "CELL_267" /*LINK*/, 0, 0, 0, 0);
					else
				...
				if (Global_4541037[iLocal_34 /*104*/].f_29 > 0)
					if (Global_20488)
						func_22(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_212" /*YES*/, 0, 0, 0, 0);
					else
						func_22(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_4541037[iLocal_34 /*104*/].f_30 == 1)
					if (Global_20488)
						func_22(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
					else
						func_22(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, 0, 0, 0, 0, 0);
				else
					func_22(Global_20481, "SET_SOFT_KEYS", 2f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
				...
				if (Global_4541037[iLocal_34 /*104*/].f_29 > 0)
					if (MISC::ARE_STRINGS_EQUAL(&Global_4541037[iLocal_34 /*104*/], "CELL_FINV"))
						if (Global_20488)
							func_22(Global_20481, "SET_SOFT_KEYS", 3f, 0f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
						else
				...
				if (Global_4541037[iLocal_34 /*104*/].f_24 == 2)
				{
					if (Global_4541037[iLocal_34 /*104*/].f_31 == 1)
					{
						...
						if (Global_20488)
							func_22(Global_20481, "SET_SOFT_KEYS", 1f, 1f, 11f, -1f, -1f, "CELL_264" /*BARTER*/, 0, 0, 0, 0);
						else
				...
				{
					func_22(Global_20481, "SET_SOFT_KEYS", 1f, 1f, 12f, -1f, -1f, "CELL_216" /*DELETE*/, 0, 0, 0, 0);
					MISC::SET_BIT(&Global_8370, 17);
				}
				else
				{
...
void func_38(int iParam0) // Position - 0x296C
{
	...
	while (num < Global_113810.f_14144[iParam0 /*104*/].f_49)
	{
		switch (Global_113810.f_14144[iParam0 /*104*/].f_32)
		{
			case 4:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_2794162.f_1762[num /*4*/]);
				break;
		
			case 5:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1935891[num /*4*/]);
				break;
		
			case 6:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1935932[num /*4*/]);
				break;
		
			case 7:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1935953[num /*4*/]);
				break;
		
			case 8:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1935970[num /*4*/]);
				break;
		
			case 9:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1935983[num /*4*/]);
				break;
		
			case 10:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1935996[num /*4*/]);
				break;
		
			case 11:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_1936009[num /*4*/]);
				break;
		}
...
Hash func_40(int iParam0, int iParam1) // Position - 0x2B30
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_41(iParam1));
}

int func_41(int iParam0) // Position - 0x2B45
{
	int num;
	int num2;
...
void func_43() // Position - 0x2B85
{
	...
	if (Global_4541037[iLocal_34 /*104*/].f_24 != 0)
	{
		for (i = 0; i < 59; i = i + 1)
		{
			if (MISC::ARE_STRINGS_EQUAL(&Global_4541037[iLocal_34 /*104*/], &uLocal_60[i /*6*/]))
			{
				if (func_44(&uLocal_60[i /*6*/]))
				{
					TEXT_LABEL_ASSIGN_STRING(&uLocal_44, "BAT_CASE_", 64);
					TEXT_LABEL_APPEND_INT(&uLocal_44, Global_1969130, 64);
				}
				else
				{
...
BOOL func_44(const char* sParam0) // Position - 0x2C20
{
...
void func_46() // Position - 0x2D5D
{
	...
	num = func_47(uLocal_1364, fLocal_1361, Global_20460, -90f, 0f, 90f, 350f, false);
...
float func_47(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, BOOL bParam13) // Position - 0x2DAB
{
	var position;
	float num;
	float num2;
	...
	if (num < 1f)
	{
		...
		Global_20428 = { func_48(uParam0, uParam3, num2) };
		Global_20431 = { func_48(fParam6, fParam9, num2) };
	}
	else
	{
...
Vector3 func_48(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x2EBA
{
...
void func_51() // Position - 0x3144
{
	...
	num = func_47(fLocal_1361, uLocal_1364, -90f, 0f, 90f, Global_20460, 350f, false);
...
void func_52() // Position - 0x3198
{
	if (Global_4542287 == 0)
	{
		...
		func_53(Global_20481, "SET_HEADER", "CELL_INBOX" /*Inbox*/, 0, 0, 0, 0);
		func_57(Global_20481, "DISPLAY_VIEW", 8f, SYSTEM::TO_FLOAT(iLocal_33), -1082130432, -1082130432, -1082130432);
	
		if (Global_20488)
		{
			if (iLocal_30 > 0)
				func_22(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_214" /*OPTIONS*/, 0, 0, 0, 0);
			else
...
void func_53(int iParam0, char* sParam1, char* sParam2, const char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6) // Position - 0x32CA
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	func_16(sParam2);
...
void func_54() // Position - 0x3325
{
	...
	while (value < 11)
	{
		...
		num2 = 0;
		num3 = 11;
		Global_4541037[num3 /*104*/].f_18 = -1;
		Global_4541037[num3 /*104*/].f_18.f_1 = 0;
		Global_4541037[num3 /*104*/].f_18.f_2 = 0;
		Global_4541037[num3 /*104*/].f_18.f_3 = 0;
		Global_4541037[num3 /*104*/].f_18.f_5 = 0;
		...
		while (num2 < 12)
		{
			...
			if (unk[num2] == 0)
			{
				if (Global_4541037[num2 /*104*/].f_24 != 0)
				{
					if (Global_4541037[num2 /*104*/].f_99[Global_20500] == 1)
					{
						if (func_56(Global_4541037[num2 /*104*/].f_18, Global_4541037[num3 /*104*/].f_18))
						{
							num3 = num2;
						
							if (Global_4541037[num3 /*104*/].f_28 == 0)
								iLocal_35 = 0;
							else
								iLocal_35 = 1;
						}
		...
		if (Global_4541037[num3 /*104*/].f_24 != 0)
		{
			if (Global_4541037[num3 /*104*/].f_99[Global_20500] == 1)
			{
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20481, "SET_DATA_SLOT");
				...
				if (Global_4541037[num3 /*104*/].f_17 == 145)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_2000" /*~a~*/);
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4541037[num3 /*104*/].f_50));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
					func_16(&(Global_2058[Global_4541037[num3 /*104*/].f_17 /*29*/].f_3));
				}
			
				unk14 = { Global_4541037[num3 /*104*/] };
			
				if (func_44(&Global_4541037[num3 /*104*/]))
				{
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0x3661
{
	if (iParam1 == -1)
		iParam1 = func_42();
...
BOOL func_56(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x367D
{
	int num;
	int num2;
	int num3;
...
void func_57(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3768
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
void func_58() // Position - 0x37CB
{
	...
	while (bLocal_1368 && Global_20500.f_1 > 3)
	{
		SYSTEM::WAIT(0);
...
BOOL func_64(int iParam0) // Position - 0x40B5
{
	if (iParam0 == 1)
		if (Global_20500.f_1 > 3)
