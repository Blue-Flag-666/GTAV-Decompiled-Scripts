...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		num = unk_0xA980353149A4E801() + 5f;
	
		if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), 1973.3237f, 3815.594f, 31.42936f) < num * num)
...
BOOL func_3() // Position - 0x1B8
{
	...
	func_119();
	func_116(36, &unk);
	TEXT_LABEL_COPY(&unk33, { func_115(36) }, 4);
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3836
{
	eCharacter character;
...
void func_55(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3D7F
{
	eCharacter character;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x40E6
{
	eCharacter character;
	var unk;
	int i;
...
void func_60(var uParam0, var uParam1) // Position - 0x41D9
{
	int i;
	int j;
	int k;
...
void func_66(var uParam0) // Position - 0x55EC
{
	eCharacter character;
...
BOOL func_68(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5B77
{
	var unk;
	var unk2;
...
int func_77(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6801
{
	int i;
	float num;
	float num2;
...
Vector3 func_85(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x74BE
{
	float num;
	float num2;
	float num3;
...
var func_104(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8A44
{
	if (bParam0)
		return uParam1;
...
BOOL func_132(var uParam0) // Position - 0xA9C2
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0xA9E2
{
	if (unk_0x7DE17ACDD8BA2642(uParam0))
...
int func_142(var uParam0, int iParam1) // Position - 0xAC2D
{
	int num;
	var unk;
	var unk33;
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_161() || Global_32166 || func_160() || func_159(8, -1) || func_157() || func_97() || func_158() || func_156() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_161() || Global_112695 || Global_32166 || func_160() || func_159(8, -1) || func_157() || func_97() || func_158() || func_156() || Global_113648.f_7690.f_919[character] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_161() || Global_112695 || Global_32166 || func_160() || func_159(8, -1) || func_97() || func_158() || func_156() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_161() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 || func_159(8, -1) || func_156() || func_155() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
