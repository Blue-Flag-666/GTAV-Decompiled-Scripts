...
{
	return IS_BIT_SET(Global_1895156[plParam0 /*609*/].f_10.f_6, iParam1);
}
...
BOOL func_12(int iParam0) // Position - 0x30A
{
	...
	num = iParam0 / 32;
	num2 = iParam0 % 32;
	return IS_BIT_SET(iLocal_86.f_2[num], num2);
}
...
void func_18(int iParam0) // Position - 0x4DB
{
	...
	iLocal_86.f_6.f_1 = iParam0;
	return;
}

int func_19() // Position - 0x4F6
{
	return iLocal_86.f_6.f_1;
}
...
BOOL func_23() // Position - 0x547
{
	...
	if (!func_314(0))
		if (func_118(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), &uLocal_139, &(uLocal_139.f_3)))
			func_117(0);

	if (func_115(func_116()) && func_314(0))
	{
		MISC::CLEAR_AREA(uLocal_139, 5f, true, false, false, false);
	
		if (func_112(&(iLocal_86.f_6), func_116(), uLocal_139, uLocal_139.f_3, true, true, true, false, true, true, false, false, false, false))
		{
			vehicle = func_16();
			...
			if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MPBitset", INT))
			{
				if (DECORATOR::DECOR_EXIST_ON(vehicle, "MPBitset"))
					int = DECORATOR::DECOR_GET_INT(vehicle, "MPBitset");
...
void func_24(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x655
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veParam0) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (func_82(uParam1->f_66, &num) && uParam1->f_80 != num)
				uParam1->f_80 = num;
			...
			if (func_81(veParam0))
				func_75(veParam0, func_78(uParam1->f_74, uParam1->f_75, uParam1->f_76));
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xB34
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_26(Hash hParam0) // Position - 0xB44
{
	return func_83(hParam0);
}

BOOL func_27(Hash hParam0) // Position - 0xB52
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_28(Vehicle veParam0) // Position - 0xC59
{
	Hash entityModel;
...
void func_29(var uParam0, var uParam1, var uParam2) // Position - 0xCE4
{
	struct<5> eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0xD23
{
	int address;
	int i;
	Player player;
...
BOOL func_31(Player plParam0, int iParam1) // Position - 0xD88
{
	BOOL flag;
...
BOOL func_34(Player plParam0) // Position - 0xE2E
{
	Player player;
...
BOOL func_35(int iParam0) // Position - 0xE50
{
	int i;
...
{
	return func_37(iParam0, 6, true);
}

BOOL func_37(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE9B
{
	if (iParam0 == -1)
		return false;
...
Hash func_39(int iParam0, int iParam1) // Position - 0xF2A
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_40(iParam1));
}

int func_40(int iParam0) // Position - 0xF3F
{
	int num;
	int num2;
...
int func_45(Vehicle veParam0, Any* panParam1) // Position - 0x166D
{
	int vehicleCrewEmblemRequestState;
	Player playerFromGamerHandle;

	if (!func_55(veParam0, panParam1))
		return 1;
	...
	if (vehicleCrewEmblemRequestState == 0)
	{
		if (!func_53(veParam0))
		{
			...
			if (func_48(&veParam0, playerFromGamerHandle))
			{
			}
			else
			{
...
BOOL func_46(Vehicle veParam0) // Position - 0x16EA
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_47(Vehicle veParam0) // Position - 0x1777
{
	int int;
...
BOOL func_48(var uParam0, Player plParam1) // Position - 0x17CF
{
	func_52();
	...
	{
		if (func_49(uParam0, plParam1, Global_1950733, Global_1950733.f_1, Global_1950733.f_4, Global_1950733.f_7, Global_1950733.f_10, 0, Global_1950733.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1950733.f_23 == 0 && func_49(uParam0, plParam1, Global_1950733, Global_1950733.f_1, Global_1950733.f_4, Global_1950733.f_7, Global_1950733.f_10, 0, Global_1950733.f_13) || Global_1950733.f_23 != 0 && Global_1950733.f_24 == 0 && func_49(uParam0, plParam1, Global_1950733, Global_1950733.f_14, Global_1950733.f_17, Global_1950733.f_20, Global_1950733.f_10, 1, Global_1950733.f_13) || Global_1950733.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577932 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_49(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x1A7A
{
...
int func_50(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1AA3
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_51(Global_1950759, 0f, 0f, 0f, false) && !func_51(Global_1950762, 0f, 0f, 0f, false) && !func_51(Global_1950765, 0f, 0f, 0f, false) && !(Global_1950768 == 0f))
	{
...
BOOL func_51(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x71B2
{
	if (bParam6)
...
BOOL func_53(Vehicle veParam0) // Position - 0x7272
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		if (GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(veParam0, 0) || func_54(veParam0))
			return true;

	return false;
}

BOOL func_54(Vehicle veParam0) // Position - 0x72AA
{
	int int;
...
BOOL func_55(Vehicle veParam0, Any* panParam1) // Position - 0x72EF
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
	...
	{
		num = Global_2359296[func_62() /*5568*/].f_681.f_2;
...
int func_57(Vehicle veParam0) // Position - 0x774E
{
...
int func_58(Player plParam0) // Position - 0x777A
{
	if (func_61(plParam0) == 233)
		return func_59(plParam0);

	return -1;
}

int func_59(Player plParam0) // Position - 0x7797
{
...
BOOL func_60(Player plParam0, BOOL bParam1) // Position - 0x77BA
{
	if (func_34(plParam0))
...
int func_61(Player plParam0) // Position - 0x77FE
{
	if (func_34(plParam0))
		if (func_60(plParam0, false))
...
BOOL func_64(Player plParam0, BOOL bParam1) // Position - 0x7849
{
	return func_65(plParam0, bParam1, 1);
}

int func_65(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x785A
{
	Player player;
...
BOOL func_66(Player plParam0, int iParam1) // Position - 0x78B7
{
	if (func_34(plParam0))
...
BOOL func_67(int iParam0, BOOL bParam1) // Position - 0x7906
{
	int num;
	int num2;
	...
	num = func_69(iParam0);
	num2 = iParam0;
	return IS_BIT_SET(num, func_68(num2));
}
...
int func_69(int iParam0) // Position - 0x7971
{
	int num;

	num = func_38(func_70(iParam0), -1);
	return num;
}

int func_70(int iParam0) // Position - 0x7988
{
	int num;
	int num2;
...
BOOL func_72(Player plParam0) // Position - 0x79C2
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_73(plParam0) && Global_2657704[plParam0 /*463*/].f_321.f_10 == plParam0)
			return true;

	return false;
}

BOOL func_73(Player plParam0) // Position - 0x79F7
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0 /*463*/].f_321.f_7 != -1)
				return func_74(Global_2657704[plParam0 /*463*/].f_321.f_7) == 22;
...
void func_75(Vehicle veParam0, int iParam1) // Position - 0x7EF2
{
	int num;
	int num2;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0x857F
{
	var gamerHandle;
...
BOOL func_81(Vehicle veParam0) // Position - 0x8594
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_83(Hash hParam0) // Position - 0x88B6
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_84(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8921
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (bParam3)
			func_92(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
		...
		if (func_86() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_85(true)))
...
Hash func_85(BOOL bParam0) // Position - 0x9017
{
	if (bParam0)
		return -426933872;
...
BOOL func_87(int iParam0) // Position - 0x90C0
{
	int num;
...
BOOL func_88(int iParam0) // Position - 0x90E4
{
	int num;
...
BOOL func_89(int iParam0, int iParam1) // Position - 0x9102
{
...
BOOL func_91(var uParam0, int iParam1) // Position - 0x912E
{
	int num;
	int num2;
	int num3;
...
int func_92(var uParam0, var uParam1, var uParam2) // Position - 0x9151
{
	int i;
	int modType;
...
BOOL func_93(Vehicle veParam0) // Position - 0x932B
{
	int i;
	int modType;
	Hash hashKey;
...
int func_95(Vehicle veParam0, int iParam1) // Position - 0x945C
{
	int value;
	int value2;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		value = func_96(veParam0, 38) + 1;
		value2 = func_96(veParam0, 24) + 1;
...
int func_96(Vehicle veParam0, int iParam1) // Position - 0x9545
{
	int i;
...
BOOL func_97(Hash hParam0, int iParam1) // Position - 0x95A7
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_98(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x9986
{
...
BOOL func_99() // Position - 0x99AA
{
	return false;
}

void func_100(Vehicle veParam0, int iParam1) // Position - 0x99B3
{
	int vehicleMod;
...
BOOL func_101(int iParam0) // Position - 0x9A2B
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_103(Vehicle veParam0) // Position - 0x9A5C
{
	int int;
...
int func_104(var uParam0) // Position - 0x9A9E
{
...
BOOL func_105(int iParam0) // Position - 0x9ABE
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_107(Vehicle veParam0) // Position - 0x9BC1
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0x9C48
{
	Vehicle vehiclePedIsIn;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x9C95
{
	return -1;
}
...
void func_111(Vehicle veParam0) // Position - 0x9FB4
{
...
BOOL func_112(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15) // Position - 0x9FCE
{
	float radius;
	Vehicle vehicle;
	...
	if (ENTITY::DOES_ENTITY_EXIST(vehicle))
	{
		*uParam0 = NETWORK::VEH_TO_NET(vehicle);
		...
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(*uParam0))
		{
			...
			func_113(vParam2, fParam5, hParam1, vehicle);
			return true;
		}
	}
...
void func_113(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, Vehicle veParam5) // Position - 0xA0D7
{
	int i;

	if (func_114(PLAYER::PLAYER_ID(), vParam0, hParam4) > -1)
	{
...
int func_114(Player plParam0, var uParam1, var uParam2, var uParam3, Hash hParam4) // Position - 0xA1AA
{
	Player player;
	int i;
	Vector3 vector;
...
BOOL func_115(Hash hParam0) // Position - 0xA248
{
	if (hParam0 == 0)
		return true;
...
void func_117(int iParam0) // Position - 0xA27E
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&uLocal_136[num], offset);
	return;
}

BOOL func_118(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xA2A0
{
	float num;
	...
	if (func_119(uParam0, 0f, 0f, 0f, func_116(), 1, uParam3, uParam4, &num))
		return true;

	return false;
}

BOOL func_119(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, Hash hParam6, int iParam7, var uParam8, var uParam9, var uParam10) // Position - 0xA33B
{
	BOOL flag;
	int i;
	float num;
	...
	{
		if (!(Global_2635560.f_676 == 0))
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635560.f_679) < func_252(false))
				return false;
			else
				Global_2635560.f_676 = 0;
	}
	else
	{
		...
		if (!(Global_2635560.f_676 == 0))
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635560.f_679) > func_252(true))
				Global_2635560.f_676 = 0;
	}

	if (uParam10->f_6)
		if (func_246(fParam0))
			func_245(&fParam0, true);

	if (!(Global_2635560.f_676 == 0))
	{
		if (SYSTEM::VDIST(Global_2635560.f_695, fParam0) > 50f)
			return false;
	
		if (Global_2635560.f_698 != hParam6)
			return false;
	}
	...
	if (Global_2635560.f_676 == 0)
	{
		...
		Global_2635560.f_695 = { fParam0 };
		Global_2635560.f_698 = hParam6;
		Global_2635560.f_681 = NETWORK::GET_NETWORK_TIME_ACCURATE();
		func_244();
		func_254();
	
		if (!uParam10->f_27 || func_243(fParam0, true, 1133903872) && !uParam10->f_28 && !Global_2794162.f_942 && !Global_2794162.f_930 && !Global_2794162.f_938 && !Global_2794162.f_943 && !Global_2794162.f_960 && !Global_2794162.f_972 && !Global_2794162.f_944 && !Global_2794162.f_994)
			func_223(fParam0, hParam6);
	...
	switch (Global_2635560.f_676)
	{
		case 2:
			if (PATHFIND::ARE_NODES_LOADED_FOR_AREA(fParam0 - 100f, fParam0.f_1 - 100f, fParam0 + 100f, fParam0.f_1 + 100f))
			{
				...
				if (uParam10->f_3 && func_203(fParam0, num, num2, num3, 1f, false, false, false, 1123024896, false, -1, true, 0, false, 0, false, false) && !uParam10->f_7 && !func_201(fParam0, *uParam9, hParam6, PLAYER::PLAYER_ID(), 0))
				{
					Global_2635560.f_683 = { fParam0 };
				...
				else
				{
					...
					func_145(&(Global_2635560.f_683), &(Global_2635560.f_686), &unk);
				}
			
				func_143(Global_2635560.f_683, Global_2635560.f_686, hParam6, &(Global_2635560.f_673));
				Global_2635560.f_671 = 0;
				Global_2635560.f_672 = 0;
				Global_2635560.f_682 = Global_2635560.f_682 + 1;
			...
			if (Global_2635560.f_671)
			{
				if (Global_2635560.f_673 == Global_2635560.f_674)
				{
					if (Global_2635560.f_672)
					{
						...
						{
							if (func_142(Global_2635560.f_683, Global_2635560.f_686, hParam6, true, 1036831949))
							{
				...
				if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635560.f_700) < 10000)
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2635560.f_699))
					{
						if (NETWORK::NETWORK_ENTITY_AREA_HAVE_ALL_REPLIED(Global_2635560.f_699))
						{
							...
							{
								if (func_138(Global_2635560.f_683, Global_2635560.f_686, hParam6, PLAYER::PLAYER_ID(), 0) || func_121(Global_2635560.f_683, Global_2635560.f_686, hParam6, true, false, false, false, 1, false))
								{
									func_140(Global_2635560.f_683, 0);
									func_139(-1);
								}
		...
		case 5:
			...
			func_145(&(Global_2635560.f_683), &(Global_2635560.f_686), &unk62);
...
BOOL func_121(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9, BOOL bParam10) // Position - 0xAC54
{
	Player i;
	Player player;
	float num;
			...
			if (_NETWORK_IS_PLAYER_VALID(player, bParam5, bParam6))
			{
				if (NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), player))
				{
					if (!bParam8 || !PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(player)) && func_137(player))
					{
						...
						{
							if (PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && bParam10 && bParam7 && func_132(player))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(player)))
							{
								...
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(player), false))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn, false))
									{
										...
										if (func_131(uParam0, iParam3, hParam4, entityCoords, entityHeading, entityModel, 0))
											return true;
									}
									else
									{
								...
								if (func_122(_GET_PLAYER_COORDS(player), uParam0, iParam3, hParam4, num))
									return true;
							}
						}
					}
...
BOOL func_122(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6, Hash hParam7, int iParam8) // Position - 0xADC7
{
	Vector3 vector;
	Vector3 vector2;
	float width;

	if (SYSTEM::VDIST(vParam0, vParam3) < func_130(hParam7, 1008981770))
	{
		func_123(vParam3, iParam6, hParam7, &vector, &vector2, &width, iParam8);
...
void func_123(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, var uParam5, var uParam6, Any anParam7, int iParam8) // Position - 0xAE1A
{
	Vector3 vector;
	var unk3;
	float num;
	...
	vector = { 0f, 1f, 0f };
	func_129(&vector, 0f, 0f, iParam3);
	vector = { vector / F2V(SYSTEM::VMAG(vector)) };
	func_124(hParam4, &unk3, &num, 1086324736, 1080033280, 1077936128);
...
void func_124(Hash hParam0, Vector3* pvParam1, Vector3* pvParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAEE6
{
	int num;
	...
	else
	{
		...
		if (num != 0)
		{
			func_125(num, pvParam1, pvParam2, 1086324736, 1080033280, 1077936128);
			return;
		}
	}
...
void func_125(int iParam0, Vector3* pvParam1, Vector3* pvParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAFE5
{
	int i;
...
int func_127(Hash hParam0) // Position - 0xB272
{
	int i;
	int num;
...
Hash func_128(int iParam0) // Position - 0xB2A1
{
	Hash num;
...
void func_129(var uParam0, float fParam1, float fParam2, int iParam3) // Position - 0xB2B3
{
	float num;
	float num2;
	float num3;
...
float func_130(Hash hParam0, int iParam1) // Position - 0xB38A
{
	var unk;
	var unk4;
	float num;
	...
	func_124(hParam0, &unk, &unk4, 1086324736, 1080033280, 1077936128);
	num = { unk4 - unk };
	num2 = SYSTEM::SQRT((num * 0.5f * num * 0.5f) + (num.f_1 * 0.5f * num.f_1 * 0.5f) + (num.f_2 * 0.5f * num.f_2 * 0.5f)) + iParam1;
	return num2;
}

BOOL func_131(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, var uParam5, var uParam6, var uParam7, float fParam8, Hash hParam9, int iParam10) // Position - 0xB40A
{
	if (func_122(uParam0, uParam5, fParam8, hParam9, 1036831949))
		return true;

	func_123(uParam0, iParam3, hParam4, &Global_1982109, &(Global_1982109.f_3), &(Global_1982109.f_6), 1036831949);
	func_123(uParam5, fParam8, hParam9, &(Global_1982109.f_7), &(Global_1982109.f_10), &(Global_1982109.f_13), 1036831949);
...
BOOL func_132(Player plParam0) // Position - 0xB4A8
{
...
BOOL func_133(Player plParam0, Player plParam1) // Position - 0xB4EF
{
	Player player;
...
Player func_134(Player plParam0) // Position - 0xB518
{
	if (func_34(plParam0))
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0xB53B
{
	var gamerHandle;
...
BOOL func_136(Player plParam0, Player plParam1) // Position - 0xB552
{
...
BOOL func_137(Player plParam0) // Position - 0xB5BF
{
...
BOOL func_138(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, Player plParam5, int iParam6) // Position - 0xB5EA
{
	Player i;
	Player player;
		...
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
				if (Global_2648711.f_261[i])
					if (func_122(Global_2648711.f_131[i /*3*/], uParam0, iParam3, hParam4, 1036831949))
						return true;
				else if (func_122(_GET_PLAYER_COORDS(player), uParam0, iParam3, hParam4, 1036831949))
					return true;
				...
				if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(player)))
					if (func_122(_GET_PLAYER_COORDS(player), uParam0, iParam3, hParam4, 1036831949))
						return true;
		}
	}
...
void func_140(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0xB764
{
	var unk;

	if (iParam3 == 0 && func_141(vParam0, 0.01f))
		return;

	if (iParam3 < 30 && SYSTEM::VMAG(vParam0) > 0f)
	{
		unk = { Global_2635560.f_2837[iParam3 /*3*/] };
		Global_2635560.f_2837[iParam3 /*3*/] = { vParam0 };
		func_140(unk, iParam3 + 1);
	}

	return;
}

BOOL func_141(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0xB7CD
{
	int i;
...
BOOL func_142(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0xB808
{
	var unk;
	var unk4;
	var unk7;
	...
	else
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			if (Global_2635560.f_687[i] == -1 && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
			{
				func_123(uParam0, iParam3, hParam4, &unk, &unk4, &unk7, iParam6);
				...
				Global_2635560.f_687[i] = NETWORK::NETWORK_ADD_CLIENT_ENTITY_ANGLED_AREA(unk, unk4, iParam6);
				Global_2635560.f_691[i] = SCRIPT::GET_ID_OF_THIS_THREAD();
				Global_2635560.f_699 = Global_2635560.f_687[i];
				return true;
			}
		}
	}
...
void func_143(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, var uParam5) // Position - 0xB8D9
{
	struct<8> eventData;

	*uParam5 = func_144(&uParam0, &uParam3, &hParam4);
	eventData = 323285304;
	eventData.f_1 = PLAYER::PLAYER_ID();
	eventData.f_2 = { uParam0 };
...
Hash func_144(var uParam0, var uParam1, var uParam2) // Position - 0xB929
{
	var unk;
	Hash hashKey;
...
void func_145(var uParam0, int iParam1, var uParam2) // Position - 0xB977
{
	int i;
	...
	{
		for (i = 0; func_196(uParam0, iParam1, uParam2) == 0 && i < 2; i = i + 1)
		{
		}
	...
	for (i = 0; func_146(uParam0, iParam1, uParam2) == 0 && i < 6; i = i + 1)
	{
	}
...
int func_146(var uParam0, int iParam1, var uParam2) // Position - 0xB9E6
{
	int num;
	float outPosition;
	float outPosition2;
	...
	if (uParam2->f_15)
	{
		if (func_192(uParam2->f_35, uParam0, &(uParam2->f_38), &(uParam2->f_45), true, true))
		{
			uParam2->f_6 = 9999.9f;
			uParam2->f_7 = 9999.9f;
		}
	...
	while (true)
	{
					...
					if (!func_180(&outPosition, false))
					{
						if (uParam2->f_13 || flags & 64 == 0 || uParam2->f_33 == 1)
						{
							if (uParam2->f_14 || flags & 16 == 0)
							{
								...
								{
									if (!func_177(outPosition))
									{
										outPosition = { func_172(outPosition, &outPosition2, outHeading, uParam2->f_9, *uParam2, flag, uParam2->f_11, uParam2->f_34, &flag2, flag3, true, uParam2->f_51, uParam2->f_60) };
									
										if (SYSTEM::VMAG(outPosition) > 0f)
										{
											if (!func_171(outPosition, 5f))
											{
												if (outPosition.f_2 >= uParam2->f_35.f_2 - uParam2->f_7 || uParam2->f_33 >= 2)
												{
													...
													{
														if (func_167(outPosition, uParam2))
														{
															if (uParam2->f_48 && !func_187(&outPosition, false) || uParam2->f_48 == 0)
															{
																flag4 = true;
																...
																if (SYSTEM::VMAG(outPosition) > 0f)
																{
																	...
																	{
																		if (uParam2->f_12 && !func_166(outPosition, outPosition2, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56) || !uParam2->f_12)
																		{
																			if (!uParam2->f_15 || !func_192(uParam2->f_35, &outPosition, &(uParam2->f_38), &(uParam2->f_45), false, true))
																			{
																				if (uParam2->f_8)
																				{
																					flag5 = uParam2->f_31;
																					...
																					if (!func_165(outPosition, outPosition2, uParam2->f_34))
																						if (uParam2->f_3 > 7f)
																							if (func_203(outPosition, 6f, 1f, 1f, 5f, flag5, flag6, flag7, num6, uParam2->f_58, -1, true, uParam2->f_3, false, 0, false, false))
																								flag8 = true;
																						else if (func_203(outPosition, 6f, 1f, 1f, 5f, flag5, flag6, flag7, num6, uParam2->f_58, -1, true, 0f, false, 0, false, false) && !func_121(outPosition, outPosition2, uParam2->f_34, true, true, false, false, 0, false))
																							flag8 = true;
																					...
																					if (flag8 || uParam2->f_33 >= 2)
																					{
																						if (uParam2->f_29 || uParam2->f_30 || uParam2->f_52 || uParam2->f_33 >= 2)
																						{
																							...
																							if (uParam2->f_52)
																								num7 = func_155(outPosition, uParam2->f_54, &num8);
																									...
																									else
																									{
																										for (i = 0; i < Global_2643228.f_162 + 1; i = i + 1)
																										{
																											if (i < 40)
																											{
																												...
																												{
																													func_154(outPosition, outPosition2, i);
			...
			if (num >= 40 + num4 || num >= 100)
			{
				if (Global_2643228.f_162 > 0 && uParam2->f_29 || uParam2->f_30 || uParam2->f_33 >= 2)
				{
					if (uParam2->f_30)
					{
						...
						*iParam1 = Global_2643228.f_121[0];
						return 1;
					}
					else
					{
				...
				else
				{
					...
					{
						func_151(num4, *uParam0, &num, &outPosition, &outPosition2, uParam2, flag, outHeading, nodeFlags, num2, num3, flag2);
						unk6 = { outPosition };
						num10 = outPosition2;
						...
						if (func_192(uParam2->f_35, &unk6, &(uParam2->f_38), &(uParam2->f_45), flag9, true) || func_187(&unk6, flag9))
						{
							if (!uParam2->f_50)
							{
								uParam2->f_33 = 0;
		...
		else
		{
			...
			{
				func_147(&Global_1574205, uParam0, iParam1, *uParam0);
...
void func_147(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xC416
{
	float num;
	float num2;
	int i;
	...
	for (i = 0; i < *uParam0; i = i + 1)
	{
		...
		if (num2 < num)
		{
			if (!func_148(uParam0->[i /*4*/], 5f, PLAYER::PLAYER_ID(), 0, 0))
			{
				num = num2;
				num3 = i;
			}
...
BOOL func_148(var uParam0, var uParam1, var uParam2, float fParam3, Player plParam4, int iParam5, int iParam6) // Position - 0xC49A
{
	if (func_150(uParam0, fParam3, plParam4, iParam5, false) || func_149(uParam0, plParam4, iParam6))
		return true;

	return false;
}

int func_149(var uParam0, var uParam1, var uParam2, Player plParam3, int iParam4) // Position - 0xC4CB
{
	Player i;
	int j;
	Player player;
		...
		if (!(plParam3 == i) || iParam4 == 1)
		{
			...
			for (j = 0; j < 2; j = j + 1)
			{
				if (!(Global_2648711.f_461[i /*11*/][j /*5*/].f_4 == 0))
					if (func_122(uParam0, Global_2648711.f_461[i /*11*/][j /*5*/], Global_2648711.f_461[i /*11*/][j /*5*/].f_3, Global_2648711.f_461[i /*11*/][j /*5*/].f_4, 1036831949))
...
int func_150(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Player plParam4, int iParam5, BOOL bParam6) // Position - 0xC58D
{
	Player i;
	Player player;
	BOOL flag;
...
void func_151(int iParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, Vector3* pvParam5, float* pfParam6, var uParam7, BOOL bParam8, int iParam9, int iParam10, float fParam11, float fParam12, BOOL bParam13) // Position - 0xC6AA
{
	int i;
	...
	for (i = 0; i < 30; i = i + 1)
	{
		*uParam4 = MISC::GET_RANDOM_INT_IN_RANGE(1 + iParam0, 40 + iParam0);
		...
		if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam1, *uParam4, pvParam5, pfParam6, &iParam9, iParam10, fParam11, fParam12))
		{
			...
			{
				*pvParam5 = { func_172(*pvParam5, pfParam6, iParam9, uParam7->f_9, *uParam7, bParam8, uParam7->f_11, uParam7->f_34, &bParam13, false, false, uParam7->f_51, uParam7->f_60) };
			
				if (!func_177(*pvParam5))
				{
					i = 999;
					return;
				}
...
void func_154(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xC7ED
{
	Vector3 vector;
	float num;
...
int func_155(Vector3 vParam0, var uParam1, var uParam2, float fParam3, var uParam4) // Position - 0xC85A
{
	Player i;
	Vector3 vector;
	int num;
...
BOOL func_156(Player plParam0) // Position - 0xC8C2
{
		...
		if (!func_163(plParam0))
			if (NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), plParam0))
				if (!(PLAYER::GET_PLAYER_TEAM(plParam0) == PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID())))
					if (func_160(PLAYER::PLAYER_ID(), true, false))
						if (!func_157(PLAYER::GET_PLAYER_TEAM(plParam0), PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()), 0, -1))
							return true;
					else
						return true;
...
BOOL func_157(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC970
{
	int num;
	int num2;
		...
		if (num < 17 && num > -1)
		{
			if (IS_BIT_SET(Global_4718592.f_1816[iParam0 /*24279*/].f_24064, num))
			{
				...
				if (num2 < 17 && num2 > -1)
				{
					...
					{
						case 0:
							if (!func_158(iParam0, num, iParam1, num2) || !func_158(iParam1, num2, iParam0, num))
...
BOOL func_158(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCCBB
{
	BOOL num;
	Player player;
	Ped playerPed;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(player, true, true) || func_31(player, 0) || IS_BIT_SET(Global_2657704[player /*463*/].f_199, 2) || func_159(player))
		{
		}
...
BOOL func_159(Player plParam0) // Position - 0xCDE7
{
	return IS_BIT_SET(Global_1853988[plParam0 /*867*/].f_36.f_18, 14);
}

BOOL func_160(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0xCDFF
{
	if (bParam1)
...
BOOL func_161(Player plParam0) // Position - 0xCE31
{
	return func_162(plParam0);
}

BOOL func_162(Player plParam0) // Position - 0xCE3F
{
	return IS_BIT_SET(Global_1853988[plParam0 /*867*/].f_11.f_1, 0);
}

BOOL func_163(Player plParam0) // Position - 0xCE56
{
	if (func_31(plParam0, 0))
		return true;
...
BOOL func_165(Vector3 vParam0, var uParam1, var uParam2, int iParam3, Hash hParam4) // Position - 0xCEA3
{
	int flags;
	...
	if (ENTITY::DOES_ENTITY_EXIST(closestVehicle) && !ENTITY::IS_ENTITY_DEAD(closestVehicle, false))
	{
		...
		if (func_131(vParam0, iParam3, hParam4, entityCoords, entityHeading, entityModel, 0))
			return true;
	}
...
BOOL func_166(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, Player plParam5, int iParam6, int iParam7) // Position - 0xCFAF
{
	if (func_138(uParam0, iParam3, hParam4, plParam5, iParam6) || func_201(uParam0, iParam3, hParam4, plParam5, iParam7))
		return true;

	return false;
}

BOOL func_167(Vector3 vParam0, var uParam1, var uParam2, var uParam3) // Position - 0xCFE5
{
	if (uParam3->f_18)
	{
		switch (uParam3->f_26)
		{
			case 0:
				if (func_170(vParam0, uParam3->f_19, uParam3->f_25, false, false))
					return true;
				break;
		
			case 1:
				if (func_168(vParam0, uParam3->f_19, uParam3->f_22, false, false))
					return true;
				break;
...
BOOL func_168(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, BOOL bParam9, BOOL bParam10) // Position - 0xD076
{
	func_169(&fParam3, &fParam6);
...
BOOL func_170(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD183
{
	if (bParam7 && bParam8)
	{
		vParam0.f_2 = 0f;
...
BOOL func_171(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xD236
{
	int i;
		...
		if (*Global_4980736.f_42750 > 0)
		{
			for (i = 0; i < *Global_4980736.f_42750; i = i + 1)
			{
				if (Global_4980736.f_42751[i /*160*/].f_7 != 0)
					if (func_122(uParam0, Global_4980736.f_42751[i /*160*/], Global_4980736.f_42751[i /*160*/].f_6, Global_4980736.f_42751[i /*160*/].f_7, fParam3))
						return true;
			}
		}
		...
		if (Global_4980736.f_6201 > 0)
		{
			for (i = 0; i < Global_4980736.f_6201; i = i + 1)
			{
				if (Global_4980736.f_6204[i /*546*/].f_15 != 0)
					if (func_122(uParam0, Global_4980736.f_6204[i /*546*/], Global_4980736.f_6204[i /*546*/].f_3, Global_4980736.f_6204[i /*546*/].f_15, 0.5f))
						return true;
			}
		}
		...
		if (*Global_4980736.f_91870 > 0)
		{
			for (i = 0; i < *Global_4980736.f_91870; i = i + 1)
			{
				if (Global_4980736.f_91874[i /*529*/].f_12 != 0)
					if (func_122(uParam0, Global_4980736.f_91874[i /*529*/], Global_4980736.f_91874[i /*529*/].f_3, Global_4980736.f_91874[i /*529*/].f_12, 0.5f))
						return true;
			}
		}
		...
		if (Global_1058071.f_268 > 0)
		{
			for (i = 0; i < Global_1058071.f_268; i = i + 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_1058071.f_233[i]) && !ENTITY::IS_ENTITY_DEAD(Global_1058071.f_233[i], false))
					if (func_122(uParam0, ENTITY::GET_ENTITY_COORDS(Global_1058071.f_233[i], true), ENTITY::GET_ENTITY_HEADING(Global_1058071.f_233[i]), ENTITY::GET_ENTITY_MODEL(Global_1058071.f_233[i]), 0.5f))
						return true;
			}
		}
		...
		if (Global_1058071.f_266 > 0)
		{
			for (i = 0; i < Global_1058071.f_266; i = i + 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_1058071.f_119[i]) && !ENTITY::IS_ENTITY_DEAD(Global_1058071.f_119[i], false))
					if (func_122(uParam0, ENTITY::GET_ENTITY_COORDS(Global_1058071.f_119[i], true), ENTITY::GET_ENTITY_HEADING(Global_1058071.f_119[i]), ENTITY::GET_ENTITY_MODEL(Global_1058071.f_119[i]), 0.5f))
						return true;
			}
		}
	}
...
Vector3 func_172(Vector3 vParam0, var uParam1, var uParam2, float* pfParam3, int iParam4, BOOL bParam5, Vector3 vParam6, var uParam7, var uParam8, BOOL bParam9, BOOL bParam10, Hash hParam11, var uParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16) // Position - 0xD4CA
{
	...
	if (bParam15)
	{
		if (SYSTEM::VMAG(vParam6) > 0f)
			if (!func_175(vParam0, *pfParam3, vParam6))
	...
	if (flags & 1024 == 0 && !bParam10)
	{
		...
		if (bParam14)
		{
			...
			if (VEHICLE::IS_THIS_MODEL_A_HELI(hParam11) && func_174(vParam0))
				return 0f, 0f, 0f;
		}
		...
		else
		{
			...
			{
				if (flags & 8 != 0)
					num2 = func_173(hParam11, 3.5f);
				else
					num2 = func_173(hParam11, 1.5f);
...
float func_173(Hash hParam0, float fParam1) // Position - 0xD919
{
	var unk;
	float num;
	float num2;

	func_124(hParam0, &unk, &num, 1086324736, 1080033280, 1077936128);
	num2 = num - unk;
...
BOOL func_174(float fParam0, var uParam1, var uParam2) // Position - 0xD950
{
	float groundZ;
...
BOOL func_175(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6) // Position - 0xD988
{
	var unk;
	var unk4;

	unk = { 0f, 1f, 0f };
	func_129(&unk, 0f, 0f, iParam3);
	unk4 = { uParam4 - uParam0 };

	if (func_176(unk4, unk) >= 0f)
		return true;

	return false;
}

float func_176(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xD9C4
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_177(var uParam0, var uParam1, var uParam2) // Position - 0xD9E5
{
	int i;
	int num;
	...
	{
		if (func_178(uParam0, &Global_2642232[num /*78*/][i /*7*/]))
			return true;
	}

	for (i = 0; i < Global_2642935[8]; i = i + 1)
	{
		if (func_178(uParam0, &Global_2642232[8 /*78*/][i /*7*/]))
			return true;
	}
...
BOOL func_178(Vector3 vParam0, var uParam1, var uParam2, var uParam3) // Position - 0xDA60
{
	return OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, *uParam3, uParam3->f_3, uParam3->f_6, false, true);
}

int func_179(float fParam0, var uParam1, var uParam2) // Position - 0xDA80
{
...
BOOL func_180(var uParam0, BOOL bParam1) // Position - 0xDB1B
{
	var unk;
	var unk2;
	...
	if (func_186(*uParam0))
	{
		if (bParam1)
		{
			...
			func_185(&unk2, Global_2635560.f_593, Global_2635560.f_596, 1036831949, false, randomFloatInRange);
		
			if (func_181(unk2, &unk) || func_186(unk2))
			{
				unk2 = { *uParam0 };
				func_185(&unk2, Global_2635560.f_593, Global_2635560.f_596, 1036831949, true, randomFloatInRange);
			}
...
BOOL func_181(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xDBB3
{
	int i;
	int num;
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		{
			if (func_182(uParam0, &Global_2635560.f_368[i /*12*/], 1008981770, false, false))
			{
				*uParam3 = i;
				return true;
			}
...
BOOL func_182(Vector3 vParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xDC17
{
	switch (uParam3->f_10)
	{
		case 0:
			return func_170(vParam0, *uParam3, uParam3->f_6 + iParam4 + ((float)Global_2635560.f_2835 * uParam3->f_8), bParam5, bParam6);
	
		case 1:
			return func_168(vParam0, *uParam3 + { iParam4 * -1f, iParam4 * -1f, iParam4 * -1f }, uParam3->f_3 + { iParam4, iParam4, iParam4 }, bParam5, bParam6);
...
void func_185(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6, float fParam7) // Position - 0xDDBA
{
	Vector3 vector;
	var unk3;
	...
	else
	{
		...
		if (fParam7 == 0f)
			func_129(&vector, 0f, 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f));
		else
			func_129(&vector, 0f, 0f, fParam7);
	}
...
BOOL func_186(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xDE62
{
	float num;
...
BOOL func_187(var uParam0, BOOL bParam1) // Position - 0xDE9B
{
	...
	if (Global_2635560.f_26.f_18)
	{
		...
		{
			case 0:
				if (func_170(*uParam0, Global_2635560.f_26.f_10, Global_2635560.f_26.f_16, false, false))
					flag = true;
				break;
		
			case 1:
				if (func_168(*uParam0, Global_2635560.f_26.f_10, Global_2635560.f_26.f_13, false, false))
					flag = true;
				break;
		...
		if (flag)
			if (bParam1)
				*uParam0 = { func_188(*uParam0, Global_2635560.f_26.f_10, Global_2635560.f_26.f_13, Global_2635560.f_26.f_16, Global_2635560.f_26.f_17, 1036831949, false) };
	}

	return flag;
}

Vector3 func_188(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0xDF8D
{
	int i;
	Vector3 outPosition;
	...
	{
		case 0:
			func_185(&vParam0, vParam3, fParam9, iParam11, bParam12, 0);
			break;
	
		case 1:
			func_191(&vParam0, vParam3, fParam6, iParam11, bParam12);
			break;
	
		case 2:
			func_189(&vParam0, vParam3, fParam6, fParam9, iParam11, bParam12);
			break;
	}
	...
	for (i = 0; i < 40; i = i + 1)
	{
		...
		{
			case 0:
				if (!func_170(outPosition, vParam3, fParam9, false, false))
					return outPosition;
				break;
		
			case 1:
				if (!func_168(outPosition, vParam3, fParam6, false, false))
					return outPosition;
				break;
...
void func_189(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, var uParam5, var uParam6, float fParam7, int iParam8, BOOL bParam9) // Position - 0xE090
{
	float x1;
	float x2;
	Vector3 vector;
	...
	if (num < fParam7 * 0.5f)
	{
		...
		else if (func_176(vector, x22) >= 0f)
			vector = { vector * { ((num2 * 0.5f) + num + iParam8) * -1f, ((num2 * 0.5f) + num + iParam8) * -1f, ((num2 * 0.5f) + num + iParam8) * -1f } };
		else
			vector = { vector * { (num2 * 0.5f) + num + iParam8, (num2 * 0.5f) + num + iParam8, (num2 * 0.5f) + num + iParam8 } };
...
Vector3 func_190(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE35F
{
...
void func_191(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, var uParam5, var uParam6, int iParam7, BOOL bParam8) // Position - 0xE398
{
	float num;
	float num2;
	float num3;
...
BOOL func_192(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7) // Position - 0xE497
{
	int i;
	BOOL flag;
	...
	if (func_246(uParam0))
	{
		if (func_195(uParam3, bParam6, false, true, true))
		{
			if (bParam6)
			{
			}
	...
	if (func_193(uParam3, bParam6, true))
	{
		if (bParam6)
		{
		}
	...
	for (i = 0; i < *uParam4; i = i + 1)
	{
		...
		{
			if (bParam6)
				func_185(uParam3, uParam4->[i /*3*/], uParam5->[i], 1036831949, false, 0);
...
BOOL func_193(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE553
{
	int num;
	var unk;
	var unk2;

	if (func_181(*uParam0, &num))
	{
		if (bParam1)
		{
			unk2 = { *uParam0 };
			func_194(&unk2, &Global_2635560.f_368[num /*12*/], 1036831949, false, bParam2);
		
			if (func_181(unk2, &unk) || func_186(unk2))
			{
				unk2 = { *uParam0 };
				func_194(&unk2, &Global_2635560.f_368[num /*12*/], 1036831949, true, bParam2);
			}
...
void func_194(var uParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE5D7
{
	if (bParam4)
	{
		switch (uParam1->f_10)
		{
			case 0:
				*uParam0 = { func_188(*uParam0, *uParam1, 0f, 0f, 0f, uParam1->f_6 + ((float)Global_2635560.f_2835 * uParam1->f_8), 0, iParam2, bParam3) };
				break;
		
			case 1:
				*uParam0 = { func_188(*uParam0, *uParam1, uParam1->f_3, 0f, 1, iParam2, bParam3) };
				break;
		
			case 2:
				*uParam0 = { func_188(*uParam0, *uParam1, uParam1->f_3, uParam1->f_6, 2, iParam2, bParam3) };
				break;
		}
	}
	else
	{
		...
		{
			case 0:
				func_185(uParam0, *uParam1, uParam1->f_6 + ((float)Global_2635560.f_2835 * uParam1->f_8), iParam2, bParam3, 0);
				break;
		
			case 1:
				func_191(uParam0, *uParam1, uParam1->f_3, iParam2, bParam3);
				break;
		
			case 2:
				func_189(uParam0, *uParam1, uParam1->f_3, uParam1->f_6, iParam2, bParam3);
				break;
		}
	}
...
BOOL func_195(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE6E1
{
	int i;
	var unk;
	...
	for (i = 0; i < 12; i = i + 1)
	{
		if (Global_2640611[i /*17*/].f_9 == 1)
		{
			...
			{
				if (func_182(*uParam0, &Global_2640611[i /*17*/], 1008981770, bParam4, false))
				{
					if (bParam1)
					{
						...
						{
							unk = { *uParam0 };
							func_194(&unk, &Global_2640611[i /*17*/], 1036831949, false, bParam3);
						
							if (func_195(&unk, false, false, false, true))
							{
								unk = { *uParam0 };
								func_194(&unk, &Global_2640611[i /*17*/], 1036831949, true, false);
							}
...
int func_196(var uParam0, int iParam1, var uParam2) // Position - 0xE7BC
{
	int randomIntInRange;
	int i;
	int num;
	...
	if (Global_2635560.f_1854 > 0)
	{
			...
			if (num > -1 && num < 101)
			{
				...
				if (SYSTEM::VMAG(x1) > 0f)
				{
					if (uParam2->f_57 && SYSTEM::VDIST(x1, uParam2->f_35) > uParam2->f_4 || uParam2->f_57 == 0)
					{
						...
						{
							if (uParam2->f_12 && !func_166(x1, num2, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56) || !uParam2->f_12)
							{
								if (!uParam2->f_15 || !func_192(uParam2->f_35, &x1, &(uParam2->f_38), &(uParam2->f_45), false, true))
								{
									if (uParam2->f_8)
									{
										flag = uParam2->f_31;
										...
										if (!func_165(x1, num2, uParam2->f_34))
											if (uParam2->f_3 > 7f)
												if (func_203(x1, 6f, 1f, 1f, 5f, flag, flag2, flag3, num3, uParam2->f_58, -1, true, uParam2->f_3, false, 0, false, false))
													flag4 = true;
											else if (func_203(x1, 6f, 1f, 1f, 5f, flag, flag2, flag3, num3, uParam2->f_58, -1, true, 0f, false, 0, false, false) && !func_121(x1, num2, uParam2->f_34, true, true, false, false, uParam2->f_58, false))
												flag4 = true;
										...
										if (flag4)
										{
											if (uParam2->f_29 || uParam2->f_30 || uParam2->f_52)
											{
												...
												if (uParam2->f_52)
													num4 = func_155(x1, uParam2->f_54, &num5);
		...
		else
		{
			...
			else if (uParam2->f_59 && Global_2635560.f_1854 > 0)
			{
				...
				*iParam1 = Global_2635560.f_1855[randomIntInRange /*4*/].f_3;
				return 1;
			}
			else
			{
...
void func_199(var uParam0, var uParam1, var uParam2) // Position - 0xEF19
{
	float num;
	int num2;
	int num3;
...
int func_200(Vector3 vParam0, var uParam1, var uParam2, float fParam3, var uParam4) // Position - 0xEF54
{
	int num;
	float num2;
	float num3;
...
BOOL func_201(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, Player plParam5, int iParam6) // Position - 0xEFB6
{
	Player i;
	int j;
	Player player;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			for (j = 0; j < 2; j = j + 1)
			{
				if (func_202(uParam0, hParam4, Global_2648711.f_461[i /*11*/][j /*5*/], Global_2648711.f_461[i /*11*/][j /*5*/].f_4))
					if (func_131(uParam0, iParam3, hParam4, Global_2648711.f_461[i /*11*/][j /*5*/], Global_2648711.f_461[i /*11*/][j /*5*/].f_3, Global_2648711.f_461[i /*11*/][j /*5*/].f_4, 0))
						if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
							return true;
						else
							return true;
...
BOOL func_202(Vector3 vParam0, var uParam1, var uParam2, Hash hParam3, Vector3 vParam4, var uParam5, var uParam6, Hash hParam7) // Position - 0xF090
{
	float num;
	float num2;
	float num3;

	num = func_130(hParam3, 1008981770);
	num2 = func_130(hParam7, 1008981770);
...
BOOL func_203(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, float fParam10, BOOL bParam11, int iParam12, BOOL bParam13, int iParam14, BOOL bParam15, int iParam16, BOOL bParam17, BOOL bParam18) // Position - 0xF0D0
{
	...
	if (iParam14 > 0f)
		if (func_208(fParam0, iParam14, true, true, bParam15, bParam17, bParam11, bParam15, false))
			return 0;
	...
	if (bParam8)
		if (fParam6 > 0f)
			if (func_204(fParam0, fParam6, bParam7, bParam9, fParam10, bParam11, iParam12, iParam16, bParam17))
				return 0;
...
BOOL func_204(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xF1E2
{
	Player i;
	Player player;
	int num;
	...
	if (bParam4 && !bParam7)
	{
		if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_205(PLAYER::PLAYER_ID()), vParam0, true) <= num + fParam3)
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		{
			if (!func_31(player, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), player))
			{
				if (bParam4 == true || bParam4 == false && player != PLAYER::PLAYER_ID())
				{
					if (func_137(player) || !bParam10 && !Global_2657704[player /*463*/].f_270)
					{
						num = iParam6;
						...
						if (!bParam7)
							if (bParam5 || bParam5 == false && PLAYER::GET_PLAYER_TEAM(player) != PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) || PLAYER::GET_PLAYER_TEAM(player) == -1)
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_205(player), vParam0, true) <= num + fParam3)
...
Vector3 func_205(Player plParam0) // Position - 0xF39A
{
	Player player;

	player = plParam0;

	if (func_207() && Global_1853988[player /*867*/].f_834 && !_IS_NULL_VECTOR(Global_1853988[player /*867*/].f_835))
		return Global_1853988[player /*867*/].f_835;

	return _GET_PLAYER_COORDS(plParam0);
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xF3ED
{
...
BOOL func_208(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0xF425
{
	Player i;
	Player player;
...
BOOL func_209(var uParam0, var uParam1, var uParam2) // Position - 0xF529
{
	var unk;

	if (Global_2794162.f_942 && func_210(uParam0, &unk))
		return true;

	return false;
}

BOOL func_210(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xF54F
{
	int i;
	int num;
	int num2;
	...
	*uParam3 = -1;
	...
	if (!(num2 == -1))
	{
		for (i = 83; i <= 87; i = i + 1)
		{
			...
			if (func_211(num))
			{
				if (func_222(Global_1950844.f_543[i /*3*/], 0) == num2)
				{
					*uParam3 = i + 1000;
					return true;
				}
...
BOOL func_211(int iParam0) // Position - 0xF5B3
{
	int num;
	Player player;
	...
	if (Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_293 == num)
		return true;

	player = Global_1895156[PLAYER::PLAYER_ID() /*609*/].f_10;

	if (player != _INVALID_PLAYER_INDEX())
		if (Global_1853988[player /*867*/].f_267.f_293 == num)
			return true;

	if (Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_321.f_7 == iParam0)
		return true;

	if (func_220(PLAYER::PLAYER_ID(), false) || func_217(PLAYER::PLAYER_ID()) && func_74(func_216(PLAYER::PLAYER_ID())) == 12)
		return true;
...
BOOL func_212(Player plParam0) // Position - 0xF71B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0 /*463*/].f_321.f_7 != -1)
				return func_74(Global_2657704[plParam0 /*463*/].f_321.f_7) == 6;

	return false;
}

BOOL func_213(Player plParam0) // Position - 0xF761
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0 /*463*/].f_321.f_7 != -1)
				return func_74(Global_2657704[plParam0 /*463*/].f_321.f_7) == 10;

	return false;
}

BOOL func_214(Player plParam0) // Position - 0xF7A8
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0 /*463*/].f_321.f_7 != -1 && Global_2657704[plParam0 /*463*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_74(Global_2657704[plParam0 /*463*/].f_321.f_7) == 5;

	return false;
}

BOOL func_215(Player plParam0) // Position - 0xF807
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0 /*463*/].f_321.f_7 != -1 && Global_2657704[plParam0 /*463*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_74(Global_2657704[plParam0 /*463*/].f_321.f_7) == 8;

	return false;
}

int func_216(Player plParam0) // Position - 0xF867
{
...
BOOL func_217(Player plParam0) // Position - 0xF898
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
		if (func_219(plParam0) && !func_218(plParam0))
			return true;

	return false;
}

BOOL func_218(Player plParam0) // Position - 0xF8D1
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_219(Player plParam0) // Position - 0xF902
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_220(Player plParam0, BOOL bParam1) // Position - 0xF933
{
	Vehicle vehiclePedIsIn;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0 /*463*/].f_321.f_7 != -1 && Global_2657704[plParam0 /*463*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_74(Global_2657704[plParam0 /*463*/].f_321.f_7) == 12;
...
int func_222(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xFA12
{
	int i;

	for (i = 0; i < 12; i = i + 1)
	{
		if (Global_2640611[i /*17*/].f_9 == 1 || iParam3 == 0)
			if (func_182(uParam0, &Global_2640611[i /*17*/], 0.1f, false, false))
				return i;
	}
...
void func_223(var uParam0, var uParam1, var uParam2, Hash hParam3) // Position - 0xFA66
{
	int i;
	int num;
	int num2;
	...
	if (!func_242())
	{
		...
		else
		{
			...
			if (func_234(uParam0, &num2, &unk4) || func_210(uParam0, &num2[0]) && VEHICLE::IS_THIS_MODEL_A_PLANE(hParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(hParam3))
			{
				func_253();
				...
				for (i = 0; i < num2; i = i + 1)
				{
					...
					{
						if (func_232(PLAYER::PLAYER_PED_ID()) || func_230(PLAYER::PLAYER_PED_ID()) && VEHICLE::IS_THIS_MODEL_A_PLANE(hParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(hParam3))
						{
							if (func_229(hParam3))
							{
								func_228(num2[i]);
							}
							else if (func_227(hParam3))
							{
								func_226(num2[i]);
								func_228(num2[i]);
							}
...
void func_224(int iParam0, Hash hParam1) // Position - 0x10860
{
	switch (iParam0)
	{
		case 23:
		...
		case 124:
		case 125:
			func_225(896.357f, -3.23695f, 77.7645f, 147.3987f, hParam1, false);
			func_225(899.759f, -5.54885f, 77.7645f, 147.3987f, hParam1, false);
			func_225(903.021f, -7.62495f, 77.7645f, 147.3987f, hParam1, false);
			func_225(906.474f, -9.70314f, 77.7645f, 147.3987f, hParam1, false);
			func_225(909.884f, -11.888f, 77.7645f, 147.3987f, hParam1, false);
			func_225(913.209f, -14.0965f, 77.7645f, 147.3987f, hParam1, false);
			func_225(879.578f, 7.26725f, 77.7646f, 147.3987f, hParam1, false);
			func_225(876.642f, 9.05555f, 77.7646f, 147.3987f, hParam1, false);
			func_225(873.534f, 10.8622f, 77.7646f, 147.3987f, hParam1, false);
			func_225(869.685f, -7.55887f, 77.7646f, 237.3985f, hParam1, false);
			func_225(867.866f, -10.464f, 77.7646f, 237.3985f, hParam1, false);
			func_225(866.077f, -13.4579f, 77.7646f, 237.3985f, hParam1, false);
			func_225(864.322f, -16.4335f, 77.7646f, 237.3985f, hParam1, false);
			func_225(862.534f, -19.2652f, 77.7644f, 237.3985f, hParam1, false);
			func_225(887.524f, -18.7251f, 77.7647f, 237.3985f, hParam1, false);
			func_225(885.594f, -21.7041f, 77.7647f, 237.3985f, hParam1, false);
			func_225(883.691f, -24.7685f, 77.7647f, 237.3985f, hParam1, false);
			func_225(881.827f, -27.7084f, 77.7644f, 237.3985f, hParam1, false);
			func_225(880.013f, -30.5612f, 77.7644f, 237.3985f, hParam1, false);
			func_225(884.931f, -17.2169f, 77.7646f, 57.5983f, hParam1, false);
			func_225(883.043f, -20.1063f, 77.7646f, 57.5983f, hParam1, false);
			func_225(881.118f, -22.9962f, 77.7644f, 57.5983f, hParam1, false);
			func_225(879.345f, -25.9389f, 77.7644f, 57.5983f, hParam1, false);
			func_225(877.631f, -28.8543f, 77.7644f, 57.5983f, hParam1, false);
			func_225(903.231f, -28.6965f, 77.7647f, 57.5983f, hParam1, false);
			func_225(901.368f, -31.6316f, 77.7647f, 57.5983f, hParam1, false);
			func_225(899.552f, -34.4844f, 77.7647f, 57.5983f, hParam1, false);
			func_225(897.669f, -37.4419f, 77.7647f, 57.5983f, hParam1, false);
			func_225(895.831f, -40.3309f, 77.7647f, 57.5983f, hParam1, false);
			func_225(932.842f, -25.6631f, 77.7647f, 147.798f, hParam1, false);
			func_225(935.693f, -27.516f, 77.7647f, 147.798f, hParam1, false);
			func_225(938.593f, -29.5809f, 77.7647f, 147.798f, hParam1, false);
			break;
...
void func_225(float fParam0, float fParam1, float fParam2, float fParam3, Hash hParam4, BOOL bParam5) // Position - 0x1473B
{
	var unk;
	var unk4;
	float num;
	...
	if (!(hParam4 == 0))
	{
		func_124(hParam4, &unk, &unk4, 1086324736, 1080033280, 1077936128);
		...
		func_240(offsetFromCoordAndHeadingInWorldCoords, fParam3);
	}
	else
	{
		func_240(fParam0, fParam3);
	}
...
BOOL func_227(Hash hParam0) // Position - 0x15D84
{
	switch (hParam0)
	{
		case joaat("microlight"):
...
BOOL func_229(Hash hParam0) // Position - 0x1640A
{
	switch (hParam0)
	{
		case joaat("hydra"):
...
int func_230(Ped pedParam0) // Position - 0x164B4
{
	if (func_231(pedParam0))
		return 1;

	return 0;
}

BOOL func_231(Ped pedParam0) // Position - 0x164CA
{
...
int func_232(Ped pedParam0) // Position - 0x16508
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0;
...
BOOL func_233(int iParam0, int iParam1) // Position - 0x16546
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
BOOL func_234(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x16623
{
	int i;
	int j;
	int num;
	...
	for (i = 0; i < 162; i = i + 1)
	{
		...
		if (num < *uParam3)
		{
			num3 = SYSTEM::VDIST(fParam0, fParam0.f_1, 0f, Global_1950844.f_543[i /*3*/], Global_1950844.f_543[i /*3*/].f_1, 0f);
...
BOOL func_235(int iParam0) // Position - 0x167DE
{
	int num;
	Player player;
	...
	if (Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_300 == num)
		return true;

	player = Global_1895156[PLAYER::PLAYER_ID() /*609*/].f_10;

	if (player != _INVALID_PLAYER_INDEX())
		if (Global_1853988[player /*867*/].f_267.f_300 == num)
			return true;
...
BOOL func_237(Hash hParam0) // Position - 0x168D9
{
...
void func_240(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x17B10
{
	if (Global_2635560.f_1854 < 101)
	{
		...
		Global_2635560.f_1855[Global_2635560.f_1854 /*4*/] = { fParam0 };
		Global_2635560.f_1855[Global_2635560.f_1854 /*4*/].f_3 = fParam3;
		Global_2635560.f_1854 = Global_2635560.f_1854 + 1;
	}

	return;
}

int func_241(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x17B75
{
	int i;

	if (SYSTEM::VDIST(Global_2635560.f_3009, vParam0) < Global_2635560.f_3017)
		return Global_2635560.f_3012;

	Global_2635560.f_3009 = { vParam0 };

	for (i = 0; i < 32; i = i + 1)
	{
		if (vParam0.f_2 <= 0f)
			vParam0.f_2 = (Global_2642989[i /*7*/].f_2 + Global_2642989[i /*7*/].f_3.f_2) * 0.5f;
	
		if (func_178(vParam0, &Global_2642989[i /*7*/]))
		{
			Global_2635560.f_3012 = i;
			return i;
		}
	}
...
BOOL func_242() // Position - 0x17C17
{
	if (IS_BIT_SET(Global_4718592.f_13, 0) && !Global_2684820.f_6453)
		return false;

	return false;
}

BOOL func_243(float fParam0, var uParam1, var uParam2, BOOL bParam3, int iParam4) // Position - 0x17C3F
{
	int i;
	int num;
	float num2;
	...
	for (i = 83; i <= 84 + 1; i = i + 1)
	{
		...
		num2 = SYSTEM::VDIST(fParam0, fParam0.f_1, 0f, Global_1950844.f_543[i /*3*/], Global_1950844.f_543[i /*3*/].f_1, 0f);
...
void func_244() // Position - 0x17CC1
{
	...
	for (i = 0; i < 30; i = i + 1)
	{
		Global_2635560.f_2837[i /*3*/] = { 0f, 0f, 0f };
	}

	return;
}

BOOL func_245(var uParam0, BOOL bParam1) // Position - 0x17CEC
{
	int i;
	var unk;
	...
	{
		if (unk.f_2 <= 0f)
			unk.f_2 = (Global_2642945[i /*7*/].f_2 + Global_2642945[i /*7*/].f_3.f_2) * 0.5f;
	
		if (func_178(unk, &Global_2642945[i /*7*/]))
		{
			if (bParam1)
			{
				func_189(&unk, Global_2642945[i /*7*/], Global_2642945[i /*7*/].f_3, Global_2642945[i /*7*/].f_6, 1036831949, false);
				*uParam0 = { unk };
			}
...
BOOL func_246(var uParam0, var uParam1, var uParam2) // Position - 0x17D89
{
	int num;
	var unk;
	...
	if (!Global_2635560.f_515 && !Global_2635560.f_516)
	{
		...
		{
			if (!func_250(PLAYER::PLAYER_ID(), true))
				return true;
		
			if (!func_249(uParam0, 1008981770))
			{
				if (!func_195(&uParam0, false, false, false, true))
					return true;
				else if (func_195(&uParam0, false, true, false, true))
					return true;
			}
			else
			{
				num = func_248(uParam0, 1008981770);
			
				if (num > -1)
				{
					unk = { func_247(&Global_2635560.f_45[num /*12*/]) };
...
int func_248(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x17E92
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_2635560.f_45[i /*12*/].f_9)
			if (func_182(uParam0, &Global_2635560.f_45[i /*12*/], iParam3, false, false))
				return i;
	}
...
BOOL func_249(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x17EDA
{
	int i;
	...
	{
		if (Global_2635560.f_45[i /*12*/].f_9)
			if (func_182(uParam0, &Global_2635560.f_45[i /*12*/], iParam3, false, 0))
				return true;
	}
...
BOOL func_250(Player plParam0, BOOL bParam1) // Position - 0x17F21
{
	if (func_42() != 0)
		return func_251(plParam0) != 0;

	return func_160(plParam0, bParam1, false);
}

int func_251(Player plParam0) // Position - 0x17F48
{
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
...
void func_254() // Position - 0x17FC1
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (SCRIPT::IS_THREAD_ACTIVE(Global_2635560.f_691[i]))
		{
			if (SCRIPT::GET_ID_OF_THIS_THREAD() == Global_2635560.f_691[i])
			{
				if (!(Global_2635560.f_687[i] == -1))
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2635560.f_687[i]))
					{
						NETWORK::NETWORK_REMOVE_ENTITY_AREA(Global_2635560.f_687[i]);
						Global_2635560.f_687[i] = -1;
					}
					else
					{
						Global_2635560.f_687[i] = -1;
		...
		else if (!(Global_2635560.f_687[i] == -1))
		{
			Global_2635560.f_687[i] = -1;
		}
	}
...
BOOL func_255() // Position - 0x1806E
{
	if (!(Global_2635560.f_606 == 0) && NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635560.f_611) < func_252(false))
		return true;

	return false;
}

BOOL func_256() // Position - 0x180A2
{
	...
	if (!func_258(PLAYER::PLAYER_ID()) && !func_257(false))
		return false;
...
BOOL func_258(Player plParam0) // Position - 0x1810A
{
	if (!func_34(plParam0))
		return false;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x18136
{
...
void func_261(int iParam0) // Position - 0x18149
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&iLocal_86.f_2[num], offset);
	return;
}

void func_262(Player plParam0) // Position - 0x18178
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;

	iLocal_86.f_5 = plParam0;
	return;
}
...
{
	uLocal_94[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1 = iParam0;
	return;
}

int func_265(Player plParam0) // Position - 0x18217
{
	return uLocal_94[plParam0 /*4*/].f_1;
}
...
BOOL func_271(Player plParam0) // Position - 0x182B9
{
	return func_6(plParam0, 11);
}

BOOL func_272() // Position - 0x182C9
{
	if (func_5(PLAYER::PLAYER_ID()))
		return false;
...
BOOL func_273(Player plParam0, int iParam1) // Position - 0x18323
{
	int num;
	int num2;
	...
	num = iParam1 / 32;
	num2 = iParam1 % 32;
	return IS_BIT_SET(uLocal_94[plParam0 /*4*/].f_2[num], num2);
}
...
BOOL func_276() // Position - 0x1837A
{
	if (!func_277())
		return false;
...
BOOL func_278(Player plParam0) // Position - 0x1839F
{
...
void func_279() // Position - 0x183AF
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && func_285(PLAYER::PLAYER_PED_ID(), func_16(), 120f, true))
		if (!func_273(NETWORK::PARTICIPANT_ID(), 1))
			func_284(1);
...
BOOL func_280() // Position - 0x18426
{
	if (func_277())
	{
		if (!func_285(PLAYER::PLAYER_PED_ID(), func_16(), 1000f, true))
			return true;
	
		if (func_282(PLAYER::PLAYER_ID(), true, true))
			return true;
...
BOOL func_281(Player plParam0) // Position - 0x18492
{
...
BOOL func_282(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x184CB
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
void func_283(int iParam0) // Position - 0x1852F
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::CLEAR_BIT(&uLocal_94[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[num], offset);
	return;
}
...
void func_284(int iParam0) // Position - 0x18559
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&uLocal_94[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[num], offset);
	return;
}

BOOL func_285(Ped pedParam0, Vehicle veParam1, float fParam2, BOOL bParam3) // Position - 0x18583
{
...
BOOL func_286() // Position - 0x185A5
{
	if (func_7())
		return true;
...
void func_287() // Position - 0x185B9
{
	...
	if (num != func_289())
	{
		switch (func_289())
		{
			...
			case 0:
				if (func_277() && !func_273(NETWORK::PARTICIPANT_ID(), 0) && num == 2)
					func_284(0);
				break;
		}
...
BOOL func_291(Player plParam0) // Position - 0x1866A
{
	if (func_34(plParam0))
		if (Global_1895156[plParam0 /*609*/].f_10 != _INVALID_PLAYER_INDEX())
...
BOOL func_293(Player plParam0, BOOL bParam1) // Position - 0x186B1
{
	if (!func_34(plParam0))
		return false;
...
void func_295(var uParam0) // Position - 0x18813
{
	Entity entity;
...
int func_296(Vehicle veParam0) // Position - 0x1884C
{
	int i;
	int num;
	int num2;
...
BOOL func_297(int iParam0) // Position - 0x18893
{
...
BOOL func_298(int iParam0) // Position - 0x188C8
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
...
void func_299() // Position - 0x188EA
{
	if (func_305())
	{
		if (!HUD::DOES_BLIP_EXIST(blLocal_143))
		{
			blLocal_143 = HUD::ADD_BLIP_FOR_ENTITY(func_16());
			HUD::SET_BLIP_SPRITE(blLocal_143, func_304());
			func_301(&blLocal_143, func_303());
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blLocal_143, func_300());
		}
	}
	else if (HUD::DOES_BLIP_EXIST(blLocal_143))
	{
		HUD::REMOVE_BLIP(&blLocal_143);
	}
...
void func_301(var uParam0, int iParam1) // Position - 0x18948
{
	int num;

	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
		num = func_302(iParam1);
...
int func_302(eHudColour ehcParam0) // Position - 0x1896E
{
	int r;
	int g;
	int b;
...
eBlipSprite func_304() // Position - 0x18BE0
{
	return BLIP_GANG_VEHICLE;
}

BOOL func_305() // Position - 0x18BEA
{
	if (!NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(func_10()))
		return false;
...
{
	uLocal_94[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
	return;
}

BOOL func_307() // Position - 0x18C41
{
	func_308();
	return true;
}
...
int func_310(Player plParam0) // Position - 0x18C66
{
	return uLocal_94[plParam0 /*4*/];
}
...
void func_311() // Position - 0x18C74
{
	...
	{
		uLocal_127[i] = _INVALID_PLAYER_INDEX_0();
	}
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		...
		{
			uLocal_127[i] = i;
			playerIndex = NETWORK::NETWORK_GET_PLAYER_INDEX(uLocal_127[i]);
			...
			if (_NETWORK_IS_PLAYER_VALID(playerIndex, false, true))
			{
				...
				{
					if (!flag)
						if (func_273(uLocal_127[i], 1))
							flag = true;
				
					if (!func_12(1))
						if (func_273(uLocal_127[i], 0))
							func_261(1);
				
					if (!func_12(3))
						if (func_273(uLocal_127[i], 2))
							func_261(3);
				
					if (!func_12(4))
						if (func_273(uLocal_127[i], 3))
							func_261(4);
				
					if (!func_12(5))
						if (func_273(uLocal_127[i], 4))
							func_261(5);
				}
			}
		}
...
void func_312(int iParam0) // Position - 0x18D90
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::CLEAR_BIT(&iLocal_86.f_2[num], offset);
	return;
}

Player _INVALID_PLAYER_INDEX_0() // Position - 0x18DBF
{
	return -1;
}
...
BOOL func_314(int iParam0) // Position - 0x18DC8
{
	...
	num = iParam0 / 32;
	num2 = iParam0 % 32;
	return IS_BIT_SET(uLocal_136[num], num2);
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x18DE7
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x18E6B
{
	switch (func_42())
	{
		case 0:
...
Hash func_317() // Position - 0x18E9E
{
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x18ED1
{
...
void func_325(var uParam0) // Position - 0x18F95
{
	Entity entity;
...
BOOL func_328(Player plParam0) // Position - 0x18FD5
{
...
BOOL func_330(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x19004
{
	func_333(8, uParam0);
	NETWORK::RESERVE_NETWORK_MISSION_VEHICLES(1);
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_86, 8, 0);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_94, 33, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(false);
	return true;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x1903B
{
	int i;
...
void func_333(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x1915D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_332();
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1917C
{
	Player player;
