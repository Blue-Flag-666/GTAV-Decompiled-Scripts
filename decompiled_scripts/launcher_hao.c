...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	if (!func_266(&unk63, &num, vector, 1f))
	{
		func_265();
	...
	while (true)
	{
		...
		if (func_210(num.f_35[0]))
		{
			if (!func_209(-72.323f, -1258.643f, 28.648f, ENTITY::GET_ENTITY_COORDS(num.f_35[0], true), 1056964608))
			{
		...
		func_205(num);
		func_198(&iLocal_91, &(num.f_9), vector);
		func_193(&num, vector, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
...
var func_15(Hash hParam0) // Position - 0xC2C
{
	var outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3955
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x396A
{
	int num;
	int num2;
...
BOOL func_53(int iParam0, int iParam1) // Position - 0x39AA
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x39CE
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39E3
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F2C
{
	eCharacter character;
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x488F
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5540
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x557B
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57EF
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D7A
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x653D
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6584
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65EF
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A02
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A12
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7529
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7553
{
...
BOOL func_85(Player plParam0) // Position - 0x757F
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7681
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7716
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x83B8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x843A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8492
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x8717
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8734
{
...
int func_106(int iParam0) // Position - 0x8C7D
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C9F
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8CB6
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D74
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DE6
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DFC
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E12
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E54
{
...
BOOL func_122(Any* panParam0) // Position - 0xA8E7
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA85
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAB61
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAC5A
{
...
int func_134(Ped pedParam0) // Position - 0xACC1
{
	int i;
...
BOOL func_135(Vehicle veParam0) // Position - 0xAD0A
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAD2A
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAD4B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAE1B
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE6E
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAF63
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB00D
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB174
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB20E
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB230
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB27D
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB2FA
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB39E
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB42D
{
...
void func_160(Vehicle veParam0) // Position - 0xB5C5
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB781
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB7E7
{
...
BOOL func_169(int iParam0) // Position - 0xB828
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB89F
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB9D6
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA25
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBA36
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBC17
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBC4A
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC93
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0xBCB7
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_181(var uParam0) // Position - 0xC4B7
{
	float num;
...
void func_182(int iParam0, var uParam1) // Position - 0xC545
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_183(BOOL bParam0) // Position - 0xC5A9
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_210(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_184(int iParam0) // Position - 0xC640
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112857 || Global_32286 || func_191() || func_190(8, -1) || func_100() || func_189() || func_188() || func_187() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || Global_32286 || func_191() || func_190(8, -1) || func_188() || func_100() || func_189() || func_187() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112857 || Global_32286 || func_191() || func_190(8, -1) || func_188() || func_100() || func_189() || func_187() || Global_113810.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112857 || Global_32286 || func_191() || func_190(8, -1) || func_100() || func_189() || func_187() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_190(8, -1) || func_187() || func_186() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_192() || Global_32286 || func_191() || func_190(8, -1) || func_189() || func_188() || func_187() || Global_113810.f_7691.f_919[character] == 5)
								return false;
						break;
...
BOOL func_185() // Position - 0xCD5D
{
	return Global_100872.f_1;
}

BOOL func_186() // Position - 0xCD6B
{
	if (Global_97735 != -1)
...
BOOL func_190(int iParam0, int iParam1) // Position - 0xCDE3
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_191() // Position - 0xCE1B
{
	return Global_1575063;
}

BOOL func_192() // Position - 0xCE27
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_193(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCE43
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCECB
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCF5C
{
...
float func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xCFF7
{
...
void func_198(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD031
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_201(var uParam0, int iParam1) // Position - 0xD197
{
	BOOL flag;
	int i;
...
void func_203(var uParam0) // Position - 0xD241
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_204(uParam0);
...
void func_204(var uParam0) // Position - 0xD258
{
	BOOL flag;
	int num;
	int i;
...
void func_207(Vehicle veParam0) // Position - 0xD66C
{
	int taskSequenceId;
...
void func_208(Object* pobParam0) // Position - 0xD709
{
...
BOOL func_209(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xD734
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_210(Vehicle veParam0) // Position - 0xD76D
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD797
{
	var unk;
	...
	if (func_245(*panParam0) || func_243(*panParam0) || Global_78935 == 1)
		return true;
...
void func_212(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDA07
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_213(int iParam0) // Position - 0xDD5F
{
...
BOOL func_214(var uParam0) // Position - 0xDD7F
{
...
BOOL func_215(var uParam0) // Position - 0xDD97
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDE3C
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_210(playersLastVehicle2))
						{
...
BOOL func_218(Ped pedParam0, Vehicle veParam1) // Position - 0xDFFA
{
...
BOOL func_219(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE02A
{
	int i;
	int num;
...
BOOL func_220(int iParam0) // Position - 0xE2E6
{
...
BOOL func_221(Vehicle veParam0, int iParam1) // Position - 0xE31A
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		if (func_232(veParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), veParam0))
		{
...
BOOL func_222(Vehicle veParam0, int iParam1) // Position - 0xE390
{
	return func_223(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_223(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE3A8
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_231(veParam0, pedParam1);
	...
	if (!func_227(veParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_224(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), veParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_224(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE469
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_225(Ped pedParam0, int iParam1) // Position - 0xE595
{
...
BOOL func_227(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE6A4
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_229(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_229(PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 0f, 0f)) };
...
float func_228(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE735
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_229(float fParam0, var uParam1, var uParam2) // Position - 0xE756
{
	float num;
	float num2;
...
int func_231(Vehicle veParam0, Ped pedParam1) // Position - 0xE7B0
{
	int i;
...
BOOL func_232(Vehicle veParam0) // Position - 0xE7EF
{
...
BOOL func_233(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE817
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		...
		if (!bParam2)
		{
			if (func_237(veParam0, bParam1, radius, num))
				return true;
		
			if (func_234(veParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_234(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE912
{
	float entityCoords;
	float num;
...
BOOL func_235(Vehicle veParam0, float fParam1) // Position - 0xEA1E
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_236(veParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_236(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEAB3
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_229(uParam1 - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
...
BOOL func_237(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEB41
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_238(int iParam0) // Position - 0xEB89
{
...
BOOL func_239(int iParam0) // Position - 0xEBD3
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_240(int iParam0) // Position - 0xEC68
{
...
BOOL func_243(int iParam0) // Position - 0xECE7
{
...
BOOL func_245(int iParam0) // Position - 0xED59
{
...
BOOL func_246(var uParam0) // Position - 0xED81
{
	if (!func_247(uParam0))
		return false;
...
BOOL func_247(var uParam0) // Position - 0xEDA0
{
	int num;
	int i;
	int sceneID;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_254(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_251(&uParam0->f_28[0], CHAR_HAO, -71.936844f, -1259.7f, 28.193594f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_249(&uParam0->f_35[0], num[1], -72.3226f, -1258.6433f, 28.1915f, 90.8326f);
			...
			{
				func_249(&uParam0->f_35[1], num[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[1], 10);
			}
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				func_248(&uParam0->f_41[0], num[2], -71.936844f, -1259.0775f, 28.193594f, -177.55f);
...
void func_248(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF20A
{
	func_208(pobParam0);
...
void func_249(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF231
{
	func_250(pveParam0);
...
void func_250(Vehicle* pveParam0) // Position - 0xF273
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_251(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF30F
{
...
BOOL func_252(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF36B
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_285(echParam1);
...
int func_253(var uParam0, eCharacter echParam1) // Position - 0xF3F9
{
	int num;
...
BOOL func_254(var uParam0) // Position - 0xF43F
{
	int i;
...
BOOL func_255(int iParam0) // Position - 0xF470
{
	int i;
...
BOOL func_256(int iParam0) // Position - 0xF4D8
{
	var unk;
	eCharacter character;
...
BOOL func_257(int iParam0) // Position - 0xF529
{
	const char* string2;
...
BOOL func_258(int iParam0) // Position - 0xF5E2
{
	var unk;
...
BOOL func_259(int iParam0) // Position - 0xF6A3
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_261(int iParam0) // Position - 0xF80A
{
...
BOOL func_262(int iParam0) // Position - 0xF835
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_263(int iParam0) // Position - 0xF860
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_264(int iParam0) // Position - 0xF88B
{
	if (func_240(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_266(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF8DA
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_267(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_267(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_267(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF93F
{
	int num;
	char* str;
	...
	if (func_268(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_268(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF9B7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_269(var uParam0, BOOL bParam1) // Position - 0xFA32
{
	if (bParam1)
	{
...
void func_273(Object* pobParam0, BOOL bParam1) // Position - 0xFAF6
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_276(Vehicle* pveParam0) // Position - 0xFB80
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_279(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFC0B
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_280(Ped* ppedParam0) // Position - 0xFC5B
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_281(int iParam0) // Position - 0xFC9C
{
	if (*iParam0 == -1)
		return;
...
Hash func_285(eCharacter echParam0) // Position - 0xFD38
{
	if (!func_36(echParam0))
