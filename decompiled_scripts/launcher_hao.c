...
void main() // Position - 0x0
{
	...
	if (!func_261(&unk64, &num, unk61, 1f))
	{
		func_260();
	...
	uLocal_94 = unk_0x54ECDA2DAB9CFB10(-103.0011f, -1281.6357f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_204(-72.323f, -1258.643f, 28.648f, unk_0x30BE8A934C020461(num.f_35[0], 1), 1056964608))
			{
		...
		func_200(num);
		func_193(&iLocal_93, &(num.f_9), unk61);
		func_188(&num, unk61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
...
void func_3(int iParam0, var uParam1) // Position - 0x3AA
{
	func_21(uParam1);
...
void func_21(var uParam0) // Position - 0xD23
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xD53
{
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x295F
{
...
BOOL func_29(var uParam0) // Position - 0x299F
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x29CD
{
...
int func_31(var uParam0) // Position - 0x2AA9
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2AEB
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2B4E
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2BDC
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E86
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x34A5
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35D4
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x371B
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3758
{
...
int func_47(eCharacter echParam0) // Position - 0x377D
{
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39D5
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F1E
{
	eCharacter character;
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D15
{
	var unk;
	var unk2;
...
int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x699F
{
	int i;
	float num;
	float num2;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x765C
{
	float num;
	float num2;
	float num3;
...
int func_188(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCD57
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_192(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCE70
{
...
float func_192(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCF0B
{
	var unk;
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCF45
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_192(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_196(uParam0, 1);
			}
			else
			{
				...
				if (func_192(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_198(uParam0);
			}
		}
	}
...
void func_202(var uParam0) // Position - 0xD580
{
	var unk;
...
void func_203(var uParam0) // Position - 0xD61D
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_205(var uParam0) // Position - 0xD681
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD6AB
{
	...
	if (func_240(*panParam0) || func_238(*panParam0) || Global_78804 == 1)
		return true;
...
BOOL func_213(var uParam0, var uParam1) // Position - 0xDF0E
{
	var unk;
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xE22E
{
	float num;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE2A4
{
	return func_218(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_218(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE2BC
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE37D
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_220(var uParam0, int iParam1) // Position - 0xE4A9
{
	int num;
...
BOOL func_222(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE5B8
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_224(float fParam0, var uParam1, var uParam2) // Position - 0xE66A
{
	float num;
	float num2;
...
int func_226(var uParam0, var uParam1) // Position - 0xE6C4
{
	int i;
...
int func_227(var uParam0) // Position - 0xE703
{
...
BOOL func_228(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE72B
{
	float num;
	float num2;
	int num3;
...
BOOL func_229(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE826
{
	float num;
	float num2;
...
BOOL func_230(var uParam0, float fParam1) // Position - 0xE932
{
	var unk;
	var unk2;
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE9C7
{
	var unk;
	var unk4;
	float num;
...
BOOL func_232(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEA55
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_242(var uParam0) // Position - 0xECB4
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_249(&num) || !unk_0x2BBF749E555360DC(str))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_246(&uParam0->f_28[0], CHAR_HAO, -71.936844f, -1259.7f, 28.193594f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
					flag = false;
		...
		case 3:
			...
			{
				unk6 = unk_0xD854D152961C41A9(uParam0->f_35[0], "chassis_dummy");
				unk7 = { unk_0x3C289AF334341CC6(uParam0->f_35[0], unk6) };
				unk5 = unk_0x191673E3F99212B2(unk7, unk_0x000D018EA42688BA(uParam0->f_35[0], 2), 2);
				unk_0x5F243F8265BB664F(unk5, 1);
				unk_0xE4E4F775E5660E56(unk5, 0);
				unk_0x468D976993BF7FE1(uParam0->f_28[0], unk5, str, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_243(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF11E
{
	func_203(uParam0);
...
void func_244(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF145
{
	func_245(uParam0);
...
void func_245(var uParam0) // Position - 0xF187
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_246(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF223
{
	if (func_247(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0x7DE17ACDD8BA2642(*uParam0))
		{
			if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_247(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF27F
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_280(echParam1);
...
void func_267(var uParam0, BOOL bParam1) // Position - 0xF9CC
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_268(&uParam0->[i], false);
	}

	return;
}

void func_268(var uParam0, BOOL bParam1) // Position - 0xFA0A
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_271(var uParam0) // Position - 0xFA94
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_273(var uParam0, int iParam1) // Position - 0xFADE
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_274(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_274(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFB1F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_275(var uParam0) // Position - 0xFB6F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
int func_280(eCharacter echParam0) // Position - 0xFC4C
{
	if (!func_36(echParam0))
