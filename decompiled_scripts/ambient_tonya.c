...
BOOL func_3(int iParam0) // Position - 0x1CA
{
	...
	TEXT_LABEL_COPY(&unk33, { func_114(iParam0) }, 4);
	func_113(&unk33, unk.f_3, 0);
	func_110(iParam0);
...
void func_24(char* sParam0, int iParam1, int iParam2) // Position - 0xBED
{
	if (Global_100681 != 10 && Global_100681 != 9)
	{
		...
		func_26(&Global_104212, sParam0, 0, "Start", iParam1, iParam2);
		func_25();
		Global_94859 = 0;
	}
...
void func_26(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x18C5
{
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER_0();
	...
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		...
		func_59(unk_0xC1A5EC5C986B98AD(), false);
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		{
			func_49(unk_0xC1A5EC5C986B98AD(), &uParam0->f_616[j /*65*/], 1, -1);
		}
		else
		{
			for (i = 0; i < 12; i = i + 1)
		...
		if (unk_0x7DE17ACDD8BA2642(Global_98012[i]))
			if (Global_98012[i] == uParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98022[i])
					if (iParam2 == 0 || unk_0x504B9BB48D41C264(uParam0) == func_35(echParam1, iParam2))
						return 1;
	}
		...
		*uParam1 = unk_0x46177D0BA2953EC5(uParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x175FDAC9EB940479(uParam0, i + 1))
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_39(i + 1));
		}
...
void func_49(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3613
{
	...
	if (!unk_0x66599E73DBA5A850(iParam0))
	{
		...
		for (i = 0; i < 12; i = i + 1)
		{
			func_55(iParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = 0; i < 9; i = i + 1)
		{
			func_54(iParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x37B3
{
	var unk;
	int num;
...
int func_51(int iParam0) // Position - 0x37F0
{
	int num;
	int num2;
...
int func_52() // Position - 0x3824
{
	return Global_1574918;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3830
{
	var unk;
	BOOL num;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x385C
{
	eCharacter character;
...
void func_55(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3DA5
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x3FE6
{
	func_57();
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x410B
{
	eCharacter character;
	var unk;
	int i;
	...
	if (func_37(character) && !unk_0x66599E73DBA5A850(uParam0))
	{
		if (uParam0 == unk_0xC1A5EC5C986B98AD())
		{
			func_60(uParam0, &Global_113648.f_2365.f_539.f_298[character /*477*/]);
...
void func_60(var uParam0, var uParam1) // Position - 0x41FE
{
	int i;
	int j;
	int k;
	...
	if (!unk_0x66599E73DBA5A850(uParam0))
	{
		...
		for (i = 0; i <= 44 - 1; i = i + 1)
		{
			...
			if (num != 0)
			{
				num2 = unk_0x91BEC56C475EB62C(uParam0, func_65(i));
				num2.f_1 = 0;
				num2.f_2 = 0;
				num2.f_3 = 0;
				num2.f_4 = 0;
				...
				if (num2 != 0 && num2 != joaat("WEAPON_UNARMED"))
				{
					...
					for (k = func_63(num2, j); k != 0; k = func_63(num2, j))
					{
		...
		{
			if (unk_0xA44505E95028BA80(l, &unk5) && !func_62(unk5.f_1) && num4 < 51)
			{
...
BOOL func_61(int iParam0) // Position - 0x4486
{
	switch (iParam0)
	{
...
BOOL func_62(int iParam0) // Position - 0x4527
{
...
void func_66(var uParam0) // Position - 0x5611
{
	eCharacter character;
...
BOOL func_68(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5B9C
{
	var unk;
	var unk2;
...
BOOL func_70(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x635F
{
	if (bParam6)
...
BOOL func_71(var uParam0) // Position - 0x63A6
{
	if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0) && !unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		if (func_97())
		{
			*uParam0 = func_77(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), 6, -1, false, true, -1);
...
BOOL func_73(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6411
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_75() == 0)
			return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_74(iParam0), -1, 0), iParam1);
	else
...
eMPStat func_74(int iParam0) // Position - 0x6472
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_76(int iParam0) // Position - 0x6816
{
	return func_73(iParam0, 5, true);
}

int func_77(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6826
{
	int i;
	float num;
	float num2;
	...
	for (i = 0; i <= 59; i = i + 1)
	{
		if (iParam3 == 6 || iParam3 == func_96(i))
		{
			...
			{
				num = unk_0x2E496FE654DA4166(uParam0, func_78(i, false), 1);
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7322
{
...
BOOL func_82(Player plParam0) // Position - 0x734C
{
...
BOOL func_84(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x744E
{
	var unk;
	var unk7;
	var unk13;
	...
	unk19 = { unk13 - unk };
	unk19 = { func_85(unk19, -unk.f_3.f_2) };
	unk19 = { func_85(unk19, unk7.f_3.f_2) };
	*uParam2 = { unk_0xF2A6E8EA57F9D501(unk7, 0f, unk19) };
	uParam2->f_3 = { unk13.f_3 };
	return true;
}

Vector3 func_85(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x74E3
{
	float num;
	float num2;
	float num3;
...
BOOL func_89(int iParam0, var uParam1) // Position - 0x8182
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_90(Player plParam0) // Position - 0x8204
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x825C
{
	return -1;
}
...
BOOL func_95(int iParam0) // Position - 0x8509
{
...
var func_98() // Position - 0x8853
{
	...
	func_108(&unk, unk_0x731F95B6458DCF80());
	func_107(&unk, unk_0x77BBAAED3E25322C());
	func_106(&unk, unk_0x30DFE1FFD2CC7420());
	func_101(&unk, unk_0x8C0F17CAC308A14B());
	func_100(&unk, unk_0x61117764C67882B7());
	func_99(&unk, unk_0x367F557725B53815());
	return unk;
}
...
int func_103(int iParam0) // Position - 0x8A45
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_104(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8A67
{
	if (bParam0)
		return uParam1;
...
int func_105(int iParam0) // Position - 0x8A7E
{
	return iParam0 & 15;
}
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x8B3C
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_113(char* sParam0, var uParam1, int iParam2) // Position - 0x8BE5
{
...
void func_115(int iParam0, var uParam1) // Position - 0x9072
{
	switch (iParam0)
	{
		...
		case 5:
			func_116(uParam1, "Barry3A", func_10(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_117(iParam0), 0, 1);
			break;
		...
		case 8:
			func_116(uParam1, "Dreyfuss1", func_10(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*The killer's identity and location have been revealed.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_117(iParam0), 0, 0);
			break;
		...
		case 38:
			func_116(uParam1, "Nigel1A", func_10(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_117(iParam0), 1, 1);
			break;
		...
		case 49:
			func_116(uParam1, "Paparazzo3A", func_10(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_117(iParam0), 0, 1);
			break;
		...
		case 58:
			func_116(uParam1, "Tonya1", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_117(iParam0), 0, 1);
			break;
...
void func_118(int iParam0) // Position - 0xA5FC
{
	...
	func_119(iParam0);
	iLocal_248 = SYSTEM::START_NEW_SCRIPT(scriptName, 54000);
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xA91C
{
...
BOOL func_131(var uParam0) // Position - 0xA9CC
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0xA9EC
{
	if (unk_0x7DE17ACDD8BA2642(uParam0))
...
BOOL func_133(int iParam0) // Position - 0xAA0D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_136(int iParam0) // Position - 0xAAEF
{
	if (iParam0 == -1)
		iParam0 = func_146();
...
BOOL func_137(int iParam0) // Position - 0xAB84
{
...
BOOL func_140(int iParam0) // Position - 0xAC03
{
...
int func_141(var uParam0, int iParam1) // Position - 0xAC37
{
	int num;
	var unk;
	var unk33;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xACBE
{
	return func_144(iParam0, Global_43257);
}

BOOL func_144(int iParam0, int iParam1) // Position - 0xACCF
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_145(int iParam0) // Position - 0xAEB0
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
...
BOOL func_147(int iParam0) // Position - 0xAEE9
{
	int num;
	...
	num = func_149(&(Global_112735[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
BOOL func_152(int iParam0) // Position - 0xB108
{
	eCharacter character;
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_160() || Global_112695 || Global_32166 || func_159() || func_158(8, -1) || func_97() || func_157() || func_156() || func_155() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_160() || Global_32166 || func_159() || func_158(8, -1) || func_156() || func_97() || func_157() || func_155() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_160() || Global_112695 || Global_32166 || func_159() || func_158(8, -1) || func_156() || func_97() || func_157() || func_155() || Global_113648.f_7690.f_919[character] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_160() || Global_112695 || Global_32166 || func_159() || func_158(8, -1) || func_97() || func_157() || func_155() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_160() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 || func_158(8, -1) || func_155() || func_154() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
BOOL func_153() // Position - 0xB825
{
	return Global_100720.f_1;
}

BOOL func_154() // Position - 0xB833
{
	if (Global_97603 != -1)
...
BOOL func_159() // Position - 0xB8E3
{
	return Global_1575060;
}

BOOL func_160() // Position - 0xB8EF
{
	if (!unk_0xA26A9A07F761D8F8())
...
BOOL func_162(int iParam0) // Position - 0xB923
{
	...
	switch (iLocal_80)
	{
		case 0:
			if (!func_181())
			{
				if (func_162(103))
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_81, 1, unk_0xC1A5EC5C986B98AD(), "FRANKLIN", 0, 1);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_81, 3, 0, "TONYA", 0, 1);
				
					if (func_195(60))
						func_166(&uLocal_81, 103, "TOWAUD", "TOW_CALL_02", 4, 1, 0, 0, false);
					else
						func_166(&uLocal_81, 103, "TOWAUD", "TOW_CALL_01", 4, 1, 0, 0, false);
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xBA73
{
...
BOOL func_165(int iParam0) // Position - 0xBA95
{
	if (Global_117[iParam0 /*10*/].f_8 != 169)
...
BOOL func_171(int iParam0, int iParam1) // Position - 0xBEAA
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xC049
{
	if (func_58(14))
	{
...
void func_179(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC199
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC1EF
{
...
BOOL func_184(int iParam0) // Position - 0xC35B
{
...
BOOL func_185(int iParam0) // Position - 0xC388
{
	int i;
...
{
	func_187(103, 1, false);
	iLocal_79 = 1;
	iLocal_80 = 0;
	return;
}

void func_187(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xC406
{
	int num;
	...
	if (Global_117[echParam0 /*10*/].f_8 != 169)
	{
		...
		if (echParam1 == 4)
		{
			func_193(echParam0, 0, 1);
			func_193(echParam0, 1, 1);
			func_193(echParam0, 2, 1);
			func_192(echParam0, 0, 1);
			func_192(echParam0, 1, 1);
			func_192(echParam0, 2, 1);
		}
		else
		{
			if (func_191(echParam0, echParam1) == 1 && func_190(echParam0, echParam1) == 1)
				bParam2 = false;
		
			num = echParam1;
			func_193(echParam0, num, 1);
			func_192(echParam0, num, 1);
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xC5F9
{
	return Global_2028[character /*29*/].f_3;
}

int func_190(eCharacter echParam0, int iParam1) // Position - 0xC60C
{
...
int func_191(eCharacter echParam0, int iParam1) // Position - 0xC636
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_192(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC660
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_193(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC6A5
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0xC6EA
{
	func_57();
	return Global_113648.f_2365.f_539.f_4321;
}

BOOL func_195(int iParam0) // Position - 0xC703
{
...
BOOL func_196(int iParam0, int iParam1) // Position - 0xC72E
{
	BOOL flag;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC7CF
{
