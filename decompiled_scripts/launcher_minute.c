...
void __EntryFunction__()
{
	...
	iLocal_92 = func_295(56);
	iLocal_93 = func_295(57);
	iLocal_94 = func_295(59);
	...
	if (!func_272(&iVar64, &Var0, Var61, 1f))
	{
		func_271();
	...
	while (true)
	{
		...
		func_205(Var0.f_0);
		func_198(&iLocal_96, &(Var0.f_9), Var61);
		if (Var0.f_0 == 32)
		{
			func_194(&Var0, Var61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_99);
		}
		else if (Var0.f_0 == 34)
		{
			func_189(&Var0, Var61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_175(&Var0, 0))
		{
			if (func_174(Var0.f_0))
			{
				func_171(Var0.f_0, &iLocal_98);
			}
			if (!func_2(&Var0))
			{
				func_275(&Var0, 1);
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
float func_193(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
int func_194(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
		...
		if (func_180(2))
		{
			if (!func_148())
			{
				if (((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && func_129(iParam0->f_28[1])) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					...
					{
						func_192(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_192(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_190(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (((func_196(sParam5) && !*uParam10 == 1) && func_129(PLAYER::PLAYER_PED_ID())) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_292("pause conversation");
				func_195(1);
				*uParam10 = 1;
			}
			if (func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_209(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	if ((func_245() && Global_99980.f_11 == 6) && iParam0 == func_169(&(Global_99980.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_251(iParam0);
...
void func_258(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_280(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
