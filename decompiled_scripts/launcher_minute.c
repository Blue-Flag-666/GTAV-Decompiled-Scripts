...
void main() // Position - 0x0
{
	...
	if (!func_275(&unk64, &num, unk61, 1f))
	{
		func_274();
	...
	if (num == 32)
	{
		unk_0x8E09E8C52602EBB2({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, 0, 1);
		unk_0xC6AD633F6B896D88({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, 0);
		unk_0xF82BC5193AF62796(unk61, 40f, 1, 0, 0, 0);
	}
	else if (num == 34)
	{
		uLocal_97 = func_250();
	...
	while (true)
	{
		...
		if (num == 32)
		{
			...
			if (func_213(num.f_35[1]))
			{
				if (!func_212(329.513f, 3402.691f, 36.258f, unk_0x30BE8A934C020461(num.f_35[1], 1), 1056964608))
				{
		...
		func_208(num);
		func_201(&iLocal_96, &(num.f_9), unk61);
	
		if (num == 32)
			func_197(&num, unk61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_99);
		else if (num == 34)
			func_192(&num, unk61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
	
		if (func_178(&num, 0))
		{
			if (func_177(num))
				func_174(num, &uLocal_98);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x39DC
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x3A19
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x3A59
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A85
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3FCE
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4210
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x46AF
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4750
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DC5
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6588
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x65CF
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x663A
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x669B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6A3F
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A4F
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x754B
{
...
BOOL func_81(Player plParam0) // Position - 0x7575
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7677
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x770C
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x83AD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x842F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8487
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x8734
{
...
int func_102(int iParam0) // Position - 0x8C70
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C92
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8CA9
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D67
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8E05
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E47
{
...
BOOL func_118(Any* panParam0) // Position - 0xA8DA
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAC4D
{
...
BOOL func_131(var uParam0) // Position - 0xACFD
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD1D
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL func_133(int iParam0) // Position - 0xAD3E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135(int iParam0) // Position - 0xAE0E
{
	switch (iParam0)
	{
		case 5:
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE61
{
	int i;
...
BOOL func_137(int iParam0) // Position - 0xAF56
{
	switch (iParam0)
	{
		case 5:
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB000
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB167
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB1F3
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB240
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB2BD
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB361
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3F0
{
...
void func_155(var uParam0) // Position - 0xB588
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_161(int iParam0) // Position - 0xB744
{
	if (iParam0 == 1)
...
BOOL func_163(int iParam0) // Position - 0xB7AA
{
...
BOOL func_164(int iParam0) // Position - 0xB7EB
{
	int num;
...
int func_166(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB862
{
	int i;
...
void func_167(int iParam0, int iParam1) // Position - 0xB999
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9E8
{
	return func_169(iParam0, Global_43257);
}

BOOL func_169(int iParam0, int iParam1) // Position - 0xB9F9
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_170(int iParam0) // Position - 0xBBDA
{
	if (Global_43257 == 15)
		return false;
...
int func_172(var uParam0, int iParam1) // Position - 0xBC0D
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC56
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_174(int iParam0, var uParam1) // Position - 0xBC7A
{
	switch (iParam0)
	{
		case 0:
...
var func_175(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC0EA
{
	var unk;
...
var func_176(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC116
{
	if (bParam0)
		return uParam1;
...
BOOL func_177(int iParam0) // Position - 0xC12D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_178(var uParam0, int iParam1) // Position - 0xC1BC
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_180(var uParam0) // Position - 0xC9BA
{
	float num;
...
void func_181(int iParam0, var uParam1) // Position - 0xCA48
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_182(BOOL bParam0) // Position - 0xCAAC
{
	var unk;
...
BOOL func_183(int iParam0) // Position - 0xCB43
{
	eCharacter character;
...
BOOL func_184() // Position - 0xD260
{
	return Global_100720.f_1;
}

BOOL func_185() // Position - 0xD26E
{
	if (Global_97603 != -1)
...
BOOL func_189(int iParam0, int iParam1) // Position - 0xD2E6
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_190() // Position - 0xD31E
{
	return Global_1575060;
}

BOOL func_191() // Position - 0xD32A
{
	if (!unk_0xA26A9A07F761D8F8())
...
int func_192(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD346
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_196(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD3CE
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD45F
{
...
float func_196(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD4FA
{
	var unk;
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xD534
{
	var unk;
	...
	if (!*uParam10 == 3)
	{
		if (func_183(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_196(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < 20f)
				{
			...
			else if (func_199(sParam5) && !*uParam10 == 1 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && func_196(unk_0xC1A5EC5C986B98AD(), uParam1, 1) >= 20f)
			{
			...
			if (func_196(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < 20f && *uParam10 == 1)
			{
...
BOOL func_199(char* sParam0) // Position - 0xD68C
{
	var unk;
...
void func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD6D0
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_196(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_204(uParam0, 1);
			}
			else
			{
				...
				if (func_196(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_206(uParam0);
			}
		}
	}
...
void func_204(var uParam0, int iParam1) // Position - 0xD836
{
	BOOL flag;
	int i;
...
void func_206(var uParam0) // Position - 0xD8E0
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_207(uParam0);
...
void func_207(var uParam0) // Position - 0xD8F7
{
	BOOL flag;
	int num;
	int i;
...
void func_210(var uParam0) // Position - 0xDD0B
{
	var unk;
...
void func_211(var uParam0) // Position - 0xDDA8
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_212(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xDDD3
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_213(var uParam0) // Position - 0xDE0C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
void func_214() // Position - 0xDE36
{
	...
	{
		unk_0x09910FB897E3D426("Joe", 1, 0, 0, 0);
		unk_0x09910FB897E3D426("Josef", 0, 0, 0, 0);
		unk_0x09910FB897E3D426("Josef", 1, 0, 0, 0);
	}

	return;
}

BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDE69
{
	var unk;
...
void func_216(int iParam0, var uParam1, int iParam2) // Position - 0xE0D9
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_218(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_217(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_218(uParam1) && uParam1->f_4 == 0 && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_217(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_217(int iParam0) // Position - 0xE431
{
...
BOOL func_218(var uParam0) // Position - 0xE451
{
...
BOOL func_219(var uParam0) // Position - 0xE469
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE50E
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_222(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_222(var uParam0, var uParam1) // Position - 0xE6CC
{
	var unk;
...
BOOL func_223(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE6FC
{
	int i;
	int num;
...
BOOL func_224(int iParam0) // Position - 0xE9B8
{
...
BOOL func_225(var uParam0, int iParam1) // Position - 0xE9EC
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_236(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_226(var uParam0, int iParam1) // Position - 0xEA62
{
	return func_227(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_227(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA7A
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_228(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_228(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEB3B
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_229(var uParam0, int iParam1) // Position - 0xEC67
{
	int num;
...
BOOL func_231(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xED76
{
	var unk;
	var unk4;
	float num;

	unk = { func_233(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_233(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };
...
float func_232(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEE07
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_233(float fParam0, var uParam1, var uParam2) // Position - 0xEE28
{
	float num;
	float num2;
...
int func_235(var uParam0, var uParam1) // Position - 0xEE82
{
	int i;
...
int func_236(var uParam0) // Position - 0xEEC1
{
...
BOOL func_237(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEEE9
{
	float num;
	float num2;
	int num3;
...
BOOL func_238(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEFE4
{
	float num;
	float num2;
...
BOOL func_239(var uParam0, float fParam1) // Position - 0xF0F0
{
	var unk;
	var unk2;
...
BOOL func_240(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF185
{
	var unk;
	var unk4;
	float num;

	unk = { func_233(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_241(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF213
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_242(int iParam0) // Position - 0xF25B
{
...
BOOL func_243(int iParam0) // Position - 0xF2A5
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_244(int iParam0) // Position - 0xF33A
{
...
BOOL func_247(int iParam0) // Position - 0xF3B9
{
...
BOOL func_249(int iParam0) // Position - 0xF42B
{
...
var func_250() // Position - 0xF453
{
	return unk_0x54ECDA2DAB9CFB10(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, 0, 1, 1, 1);
}

BOOL func_251(var uParam0) // Position - 0xF481
{
	switch (*uParam0)
	{
		case 32:
...
BOOL func_252(var uParam0) // Position - 0xF4DF
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_258(&uParam0->f_41[0], num[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_255(&uParam0->f_28[0], CHAR_MANUEL, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_253(&uParam0->f_35[0], num[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_253(&uParam0->f_35[1], num[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
				unk_0x7A1950259E8A78CC(uParam0->f_35[1], 0);
				unk_0x9C56520AE72AFDBF(num[1], 1);
			}
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
			{
				func_258(&uParam0->f_41[1], num[4], -303.74f, 6211.56f, 30.49f, -176.77f);
				unk_0xBD02C9D4D7076ECC(uParam0->f_41[1], uParam0->f_28[0], unk_0xCF99BEF1317B66DA(uParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1, 0);
			}
...
void func_253(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF802
{
	func_254(uParam0);
...
void func_254(var uParam0) // Position - 0xF844
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_255(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF8E0
{
	if (func_256(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0x7DE17ACDD8BA2642(*uParam0))
		{
			if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_256(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF93C
{
	int num;
...
int func_257(var uParam0, eCharacter echParam1) // Position - 0xF9CA
{
	int num;
...
void func_258(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFA10
{
	func_211(uParam0);
...
BOOL func_259(var uParam0) // Position - 0xFA37
{
	if (func_219(uParam0))
	{
...
BOOL func_260(var uParam0) // Position - 0xFA61
{
	int i;
...
BOOL func_262(var uParam0) // Position - 0xFACE
{
	int num;
	int i;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			func_253(&uParam0->f_35[0], num[0], 20.8f, 4532.65f, 104.66f, 284.7f);
		
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				unk_0x439314AD4FC79186(uParam0->f_35[0], 2);
				unk_0x8D6FA39DB069B5C9(uParam0->f_35[0], 5, 0);
				unk_0x24C146D70061EDE5(uParam0->f_35[0], 14f);
				unk_0x9C56520AE72AFDBF(num[0], 1);
			}
...
BOOL func_263(var uParam0) // Position - 0xFBE1
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x28818732C8F0F80E("rcmminute1");
			unk_0xF82BC5193AF62796(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		...
		case 1:
			...
			if (!func_260(&num) || !unk_0x2BBF749E555360DC("rcmminute1"))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (func_255(&uParam0->f_28[0], CHAR_JOE, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
			...
			{
				if (func_255(&uParam0->f_28[1], CHAR_JOSEF, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_253(&uParam0->f_35[0], num[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_264(uParam0->f_35[0], num[0]);
			}
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[1]))
			{
				func_253(&uParam0->f_35[1], num[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_264(uParam0->f_35[1], num[1]);
				unk_0x53A563E258997DA8(uParam0->f_35[1], 0);
			}
		...
		case 3:
			if (unk_0x2BBF749E555360DC("rcmminute1"))
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
				{
					if (!unk_0x7BB3D8F4F6310EB8(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0x909F139DC199D8E0(uParam0->f_28[0]);
						unk_0x3EE48ADC8C7F5CC4(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]))
				{
					...
					unk_0x3EE48ADC8C7F5CC4(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x598D91BBD045C1F3(uParam0->f_28[1], 185, 1);
				}
			}
...
void func_264(var uParam0, var uParam1) // Position - 0xFF05
{
	if (unk_0x7DE17ACDD8BA2642(uParam0))
	{
		unk_0xE89126C47B21ED30(uParam0, 0);
...
BOOL func_265(int iParam0) // Position - 0xFF3B
{
	var unk;
	eCharacter character;
...
BOOL func_266(int iParam0) // Position - 0xFF8C
{
	var unk;
...
BOOL func_267(int iParam0) // Position - 0x10047
{
	var unk;
...
BOOL func_268(int iParam0) // Position - 0x10108
{
	int i;
	var unk;
	int num;
...
BOOL func_270(int iParam0) // Position - 0x1026F
{
...
BOOL func_271(int iParam0) // Position - 0x1029A
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_272(int iParam0) // Position - 0x102C5
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_273(int iParam0) // Position - 0x102F0
{
	if (func_244(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_275(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1033F
{
	int i;
...
BOOL func_276(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x103A4
{
	int num;
	char* str;
...
BOOL func_277(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1041C
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_278(var uParam0, BOOL bParam1) // Position - 0x10497
{
	char* str;
	...
	if (*uParam0 == 32)
		unk_0x8E09E8C52602EBB2({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, 1, 1);
	else if (*uParam0 == 34)
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x1067A
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_289(var uParam0) // Position - 0x10704
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_291(var uParam0, int iParam1) // Position - 0x1074E
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_292(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_292(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1078F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_293(var uParam0) // Position - 0x107DF
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
void func_294(int iParam0) // Position - 0x10820
{
	if (*iParam0 == -1)
		return;
...
int func_298(eCharacter echParam0) // Position - 0x108BC
{
	if (!func_36(echParam0))
