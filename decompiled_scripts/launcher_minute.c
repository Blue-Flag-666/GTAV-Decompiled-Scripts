...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_299(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		if (num == 32)
		{
			...
			if (func_218(num.f_35[1]))
			{
				if (!func_217(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(num.f_35[1], true), 1056964608))
				{
		...
		func_213(num);
		func_206(&iLocal_94, &(num.f_9), vector);
	
		if (num == 32)
			func_202(&num, vector, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		else if (num == 34)
			func_197(&num, vector, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x493F
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55F0
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x562B
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x589F
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E2A
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65ED
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6634
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x669F
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6AB2
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AC2
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75D9
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7603
{
...
BOOL func_85(Player plParam0) // Position - 0x762F
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7731
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77C6
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8467
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x84E9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_97(Player plParam0) // Position - 0x87C6
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x87E3
{
...
int func_106(int iParam0) // Position - 0x8D2C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D4E
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D65
{
	return iParam0 & 15;
}
...
void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8EC1
{
...
BOOL func_122(Any* panParam0) // Position - 0xA996
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAB34
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAC10
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD09
{
...
int func_134(Ped pedParam0) // Position - 0xAD70
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xADB9
{
...
BOOL func_137(int iParam0) // Position - 0xADFA
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAECA
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF1D
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB012
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0BC
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB223
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB2BD
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB2DF
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB32C
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB3A9
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4DC
{
...
void func_160(Vehicle veParam0) // Position - 0xB674
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB830
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB896
{
...
BOOL func_169(int iParam0) // Position - 0xB8D7
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB94E
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xBA85
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAD4
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBAE5
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBCC6
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBCF9
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD42
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBD66
{
	switch (iParam0)
	{
		case 0:
...
Blip func_180(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC1D9
{
	Blip blip;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC205
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC21C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC2AB
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_185(var uParam0) // Position - 0xCAA9
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCB37
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_187(BOOL bParam0) // Position - 0xCB9B
{
...
BOOL func_188(int iParam0) // Position - 0xCC32
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD34F
{
	return Global_100872.f_1;
}

BOOL func_190() // Position - 0xD35D
{
	if (Global_97735 != -1)
...
BOOL func_194(int iParam0, int iParam1) // Position - 0xD3D5
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD40D
{
	return Global_1575063;
}

BOOL func_196() // Position - 0xD419
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD435
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_201(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD4BD
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD54E
{
...
float func_201(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD5E9
{
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xD623
{
	var unk;
	...
	if (!(*uParam10 == 3))
	{
		if (func_188(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_201(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
				{
			...
			else if (func_204(sParam5) && !(*uParam10 == 1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && func_201(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
			{
			...
			if (func_201(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f && *uParam10 == 1)
			{
...
BOOL func_204(char* sParam0) // Position - 0xD77B
{
	var string1;
...
void func_206(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD7BF
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(var uParam0, int iParam1) // Position - 0xD925
{
	BOOL flag;
	int i;
...
void func_211(var uParam0) // Position - 0xD9CF
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_212(uParam0);
...
void func_212(var uParam0) // Position - 0xD9E6
{
	BOOL flag;
	int num;
	int i;
...
void func_215(Ped pedParam0) // Position - 0xDDFA
{
	int taskSequenceId;
...
void func_216(Object* pobParam0) // Position - 0xDE97
{
...
BOOL func_217(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xDEC2
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_218(Vehicle veParam0) // Position - 0xDEFB
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDF58
{
	var unk;
	...
	if (func_254(*panParam0) || func_252(*panParam0) || Global_78935 == 1)
		return true;
...
void func_221(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE1C8
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_222(int iParam0) // Position - 0xE520
{
...
BOOL func_223(var uParam0) // Position - 0xE540
{
...
BOOL func_224(var uParam0) // Position - 0xE558
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE5FD
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_218(playersLastVehicle2))
						{
...
BOOL func_227(Ped pedParam0, Vehicle veParam1) // Position - 0xE7BB
{
...
BOOL func_228(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE7EB
{
	int i;
	int num;
...
BOOL func_229(int iParam0) // Position - 0xEAA7
{
...
BOOL func_230(Ped pedParam0, int iParam1) // Position - 0xEADB
{
	float xSize;
...
BOOL func_231(Ped pedParam0, int iParam1) // Position - 0xEB51
{
	return func_232(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_232(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEB69
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_233(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEC2A
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_234(Ped pedParam0, int iParam1) // Position - 0xED56
{
...
BOOL func_236(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEE65
{
	var unk;
...
float func_237(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEEF6
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_238(float fParam0, var uParam1, var uParam2) // Position - 0xEF17
{
	float num;
	float num2;
...
int func_240(Ped pedParam0, Ped pedParam1) // Position - 0xEF71
{
	int i;
...
BOOL func_241(Ped pedParam0) // Position - 0xEFB0
{
...
BOOL func_242(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEFD8
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_243(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF0D3
{
	float entityCoords;
	float num;
...
BOOL func_244(Ped pedParam0, float fParam1) // Position - 0xF1DF
{
	var outProjectile;
	var outCoords;
...
BOOL func_245(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF274
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_246(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF302
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_247(int iParam0) // Position - 0xF34A
{
...
BOOL func_248(int iParam0) // Position - 0xF394
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_249(int iParam0) // Position - 0xF429
{
...
BOOL func_252(int iParam0) // Position - 0xF4A8
{
...
BOOL func_254(int iParam0) // Position - 0xF51A
{
...
BOOL func_256(var uParam0) // Position - 0xF570
{
	switch (*uParam0)
	{
		case 32:
...
BOOL func_257(var uParam0) // Position - 0xF5CE
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_263(&uParam0->f_41[0], num[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_260(&uParam0->f_28[0], CHAR_MANUEL, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_258(&uParam0->f_35[0], num[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_258(&uParam0->f_35[1], num[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
			...
			{
				func_263(&uParam0->f_41[1], num[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_258(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF8F1
{
	func_259(pveParam0);
...
void func_259(Vehicle* pveParam0) // Position - 0xF933
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF9CF
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFA2B
{
	Hash model;
...
int func_262(var uParam0, eCharacter echParam1) // Position - 0xFAB9
{
	int num;
...
void func_263(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFAFF
{
	func_216(pobParam0);
...
BOOL func_264(var uParam0) // Position - 0xFB26
{
	if (func_224(uParam0))
	{
...
BOOL func_265(var uParam0) // Position - 0xFB50
{
	int i;
...
BOOL func_267(var uParam0) // Position - 0xFBBD
{
	int num;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_258(&uParam0->f_35[0], num[0], 20.8f, 4532.65f, 104.66f, 284.7f);
...
BOOL func_268(var uParam0) // Position - 0xFCD0
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			...
			if (!func_265(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_260(&uParam0->f_28[0], CHAR_JOE, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
			...
			{
				if (func_260(&uParam0->f_28[1], CHAR_JOSEF, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_258(&uParam0->f_35[0], num[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_269(uParam0->f_35[0], num[0]);
			}
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_258(&uParam0->f_35[1], num[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_269(uParam0->f_35[1], num[1]);
...
void func_269(Vehicle veParam0, Hash hParam1) // Position - 0xFFF4
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
	{
...
BOOL func_270(int iParam0) // Position - 0x1002B
{
	var unk;
	eCharacter character;
...
BOOL func_271(int iParam0) // Position - 0x1007C
{
	const char* string2;
...
BOOL func_272(int iParam0) // Position - 0x10135
{
	var unk;
...
BOOL func_273(int iParam0) // Position - 0x101F6
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_275(int iParam0) // Position - 0x1035D
{
...
BOOL func_276(int iParam0) // Position - 0x10388
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_277(int iParam0) // Position - 0x103B3
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_278(int iParam0) // Position - 0x103DE
{
	if (func_249(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1042D
{
	int i;
...
BOOL func_281(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10492
{
	int num;
	char* str;
...
BOOL func_282(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1050A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_283(var uParam0, BOOL bParam1) // Position - 0x10585
{
	char* str;
...
void func_291(Object* pobParam0, BOOL bParam1) // Position - 0x10768
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_294(Vehicle* pveParam0) // Position - 0x107F2
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_297(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1087D
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_298(Ped* ppedParam0) // Position - 0x108CD
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_299(int iParam0) // Position - 0x1090E
{
	if (*iParam0 == -1)
		return;
...
Hash func_303(eCharacter echParam0) // Position - 0x109AA
{
	if (!func_36(echParam0))
