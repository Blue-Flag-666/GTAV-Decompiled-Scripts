...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_278(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_208(num);
		func_201(&iLocal_91, &uLocal_92, &(num.f_9), vector, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_194(&num, vector, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x47F1
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x54A2
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x54DD
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5751
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CDC
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x649F
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x64E6
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6551
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6964
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6974
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x748B
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x74B5
{
...
BOOL func_85(Player plParam0) // Position - 0x74E1
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x75E3
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7678
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8316
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8398
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x83F0
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x8675
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8692
{
...
int func_106(int iParam0) // Position - 0x8BDB
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BFD
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8C14
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8CD2
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D44
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D5A
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D70
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8DB2
{
...
BOOL func_122(Any* panParam0) // Position - 0xA845
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xA9E3
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAABF
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xABB8
{
...
int func_134(Ped pedParam0) // Position - 0xAC1F
{
	int i;
...
BOOL func_135(Vehicle veParam0) // Position - 0xAC68
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC88
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xACA9
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAD79
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xADCC
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAEC1
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF6B
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB0D2
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB16C
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB18E
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB1DB
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB258
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB2FC
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB38B
{
...
void func_160(Vehicle veParam0) // Position - 0xB523
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB6DF
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB745
{
...
BOOL func_169(int iParam0) // Position - 0xB786
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB7FD
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB934
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB983
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xB994
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBB75
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBBA8
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBBF1
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0xBC15
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_181(var uParam0) // Position - 0xC413
{
	float num;
...
void func_182(int iParam0, var uParam1) // Position - 0xC4A1
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_183(BOOL bParam0) // Position - 0xC505
{
...
BOOL func_184(Vehicle veParam0) // Position - 0xC59C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_185(int iParam0) // Position - 0xC5C6
{
	eCharacter character;
...
BOOL func_186() // Position - 0xCCE3
{
	return Global_100872.f_1;
}

BOOL func_187() // Position - 0xCCF1
{
	if (Global_97735 != -1)
...
BOOL func_191(int iParam0, int iParam1) // Position - 0xCD69
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_192() // Position - 0xCDA1
{
	return Global_1575063;
}

BOOL func_193() // Position - 0xCDAD
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_194(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xCDC9
{
	var unk;
	...
	if (func_185(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_200(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
			{
				unk = 16;
		...
		else if (func_195(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
				if (func_200(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
					func_154();
		}
	}
...
BOOL func_195(char* sParam0) // Position - 0xCE8B
{
	var string1;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCECF
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCF60
{
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xCFFB
{
...
void func_201(var uParam0, var uParam1, const char* sParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD035
{
	float num;
	float num2;
	float num3;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_200(PLAYER::PLAYER_PED_ID(), uParam3, true) <= 100f)
					func_204(uParam0, 1);
			}
			else
			{
				if (func_203(*uParam0) == 2)
				{
				...
				{
					num = func_200(PLAYER::PLAYER_PED_ID(), fParam6, true);
					num2 = func_200(PLAYER::PLAYER_PED_ID(), fParam9, true);
					num3 = num - num2;
				...
				if (func_200(PLAYER::PLAYER_PED_ID(), uParam3, true) > 120f)
					func_205(uParam0);
			}
		}
	}
...
void func_204(var uParam0, int iParam1) // Position - 0xD1C8
{
	BOOL flag;
	int i;
...
void func_205(var uParam0) // Position - 0xD266
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD27D
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD399
{
	var unk;
...
void func_210(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD609
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_211(int iParam0) // Position - 0xD961
{
...
BOOL func_212(var uParam0) // Position - 0xD981
{
...
BOOL func_213(var uParam0) // Position - 0xD999
{
...
void func_215(Object* pobParam0) // Position - 0xDCC2
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDD6D
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_218(Ped pedParam0, Vehicle veParam1) // Position - 0xDF2B
{
...
BOOL func_219(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDF5B
{
	int i;
	int num;
...
BOOL func_220(int iParam0) // Position - 0xE217
{
...
BOOL func_221(Vehicle veParam0, int iParam1) // Position - 0xE24B
{
	float xSize;
...
BOOL func_222(Vehicle veParam0, int iParam1) // Position - 0xE2C1
{
	return func_223(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_223(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE2D9
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_224(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE39A
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_225(Ped pedParam0, int iParam1) // Position - 0xE4C6
{
...
BOOL func_227(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE5D5
{
	var unk;
...
float func_228(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE666
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_229(float fParam0, var uParam1, var uParam2) // Position - 0xE687
{
	float num;
	float num2;
...
int func_231(Vehicle veParam0, Ped pedParam1) // Position - 0xE6E1
{
	int i;
...
BOOL func_232(Vehicle veParam0) // Position - 0xE720
{
...
BOOL func_233(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE748
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_234(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE843
{
	float entityCoords;
	float num;
...
BOOL func_235(Vehicle veParam0, float fParam1) // Position - 0xE94F
{
	var outProjectile;
	var outCoords;
...
BOOL func_236(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE9E4
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_237(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEA72
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_238(int iParam0) // Position - 0xEABA
{
...
void func_239(Vehicle veParam0) // Position - 0xEB04
{
	int taskSequenceId;
...
BOOL func_240(int iParam0) // Position - 0xEBA1
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_241(int iParam0) // Position - 0xEC36
{
...
BOOL func_244(int iParam0) // Position - 0xECB5
{
...
BOOL func_246(int iParam0) // Position - 0xED27
{
...
BOOL func_247(var uParam0) // Position - 0xED4F
{
	if (!func_248(uParam0))
		return false;
...
BOOL func_248(var uParam0) // Position - 0xED6E
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_251(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1") || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_PUMPSHOTGUN")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_SNIPERRIFLE")))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_249(&uParam0->f_35[0], num[1], -1303.1628f, 4648.085f, 104.9664f, 293.1504f);
...
void func_249(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEF5A
{
	func_250(pveParam0);
...
void func_250(Vehicle* pveParam0) // Position - 0xEF9C
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_251(var uParam0) // Position - 0xF038
{
	int i;
...
BOOL func_252(int iParam0) // Position - 0xF069
{
	var unk;
	eCharacter character;
...
BOOL func_253(int iParam0) // Position - 0xF0BA
{
	const char* string2;
...
BOOL func_254(int iParam0) // Position - 0xF173
{
	var unk;
...
BOOL func_255(int iParam0) // Position - 0xF234
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_257(int iParam0) // Position - 0xF39B
{
...
BOOL func_258(int iParam0) // Position - 0xF3C6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_259(int iParam0) // Position - 0xF3F1
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_260(int iParam0) // Position - 0xF41C
{
	if (func_241(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_262(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF46B
{
	int i;
...
BOOL func_263(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF4D0
{
	int num;
	char* str;
...
BOOL func_264(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF548
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_265(var uParam0, BOOL bParam1) // Position - 0xF5C3
{
	if (bParam1)
	{
...
void func_270(Object* pobParam0, BOOL bParam1) // Position - 0xF6BF
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_273(Vehicle* pveParam0) // Position - 0xF749
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_276(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF7D4
{
...
void func_277(Ped* ppedParam0) // Position - 0xF824
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_278(int iParam0) // Position - 0xF865
{
	if (*iParam0 == -1)
		return;
