...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112009[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_270(&(Global_112009[Var0.f_0 /*10*/].f_9));
			}
		}
		func_257(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_200(Var0.f_0);
		func_193(&iLocal_93, &uLocal_94, &(Var0.f_9), Var61, -1295,84f, 4641,98f, 105,33f, -1301,43f, 4641,21f, 105,62f);
		func_186(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_171(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_186(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_177(2))
	{
		if (!func_148())
		{
			if (((func_129(PLAYER::PLAYER_PED_ID()) && func_129(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
...
void func_193(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_192(PLAYER::PLAYER_PED_ID(), Param6, 1);
					fVar1 = func_192(PLAYER::PLAYER_PED_ID(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
...
int func_201(var uParam0, bool bParam1)
{
	...
	func_112(*uParam0, &Var0);
	if ((func_238(*uParam0) || func_236(*uParam0)) || Global_78103 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_237() && Global_99980.f_11 == 6) && iParam0 == func_169(&(Global_99980.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_241(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_242(iParam0);
