...
void main() // Position - 0x0
{
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_273(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (!func_257(&unk64, &num, unk61, 1f))
	{
		func_256();
	...
	while (true)
	{
		...
		func_203(num);
		func_196(&iLocal_93, &uLocal_94, &(num.f_9), unk61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_189(&num, unk61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x388F
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x38CC
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x390C
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3938
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3E81
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x40C3
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x4562
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4603
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C78
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x643B
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x6482
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x64ED
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x654E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x68F2
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6902
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x73FE
{
...
BOOL func_81(Player plParam0) // Position - 0x7428
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x752A
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x75BF
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x825F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x82E1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8339
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x85E6
{
...
int func_102(int iParam0) // Position - 0x8B22
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B44
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8B5B
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8C19
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8CB7
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8CF9
{
...
BOOL func_118(Any* panParam0) // Position - 0xA78C
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAAFF
{
...
BOOL func_131(var uParam0) // Position - 0xABAF
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xABCF
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL func_133(int iParam0) // Position - 0xABF0
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135(int iParam0) // Position - 0xACC0
{
	switch (iParam0)
	{
		case 5:
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAD13
{
	int i;
...
BOOL func_137(int iParam0) // Position - 0xAE08
{
	switch (iParam0)
	{
		case 5:
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAEB2
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB019
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB0A5
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB0F2
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB16F
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB213
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB2A2
{
...
void func_155(var uParam0) // Position - 0xB43A
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_161(int iParam0) // Position - 0xB5F6
{
	if (iParam0 == 1)
...
BOOL func_163(int iParam0) // Position - 0xB65C
{
...
BOOL func_164(int iParam0) // Position - 0xB69D
{
	int num;
...
int func_166(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB714
{
	int i;
...
void func_167(int iParam0, int iParam1) // Position - 0xB84B
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB89A
{
	return func_169(iParam0, Global_43257);
}

BOOL func_169(int iParam0, int iParam1) // Position - 0xB8AB
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_170(int iParam0) // Position - 0xBA8C
{
	if (Global_43257 == 15)
		return false;
...
int func_172(var uParam0, int iParam1) // Position - 0xBABF
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBB08
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
BOOL func_174(var uParam0, int iParam1) // Position - 0xBB2C
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_176(var uParam0) // Position - 0xC32C
{
	float num;
...
void func_177(int iParam0, var uParam1) // Position - 0xC3BA
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_178(BOOL bParam0) // Position - 0xC41E
{
	var unk;
...
BOOL func_179(var uParam0) // Position - 0xC4B5
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_180(int iParam0) // Position - 0xC4DF
{
	eCharacter character;
...
BOOL func_181() // Position - 0xCBFC
{
	return Global_100720.f_1;
}

BOOL func_182() // Position - 0xCC0A
{
	if (Global_97603 != -1)
...
BOOL func_186(int iParam0, int iParam1) // Position - 0xCC82
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_187() // Position - 0xCCBA
{
	return Global_1575060;
}

BOOL func_188() // Position - 0xCCC6
{
	if (!unk_0xA26A9A07F761D8F8())
...
int func_189(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xCCE2
{
	var unk;
	...
	if (func_180(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_195(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < 20f)
			{
				unk = 16;
		...
		else if (func_190(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()))
				if (func_195(unk_0xC1A5EC5C986B98AD(), uParam1, 1) >= 20f)
					func_149();
		}
	}
...
BOOL func_190(char* sParam0) // Position - 0xCDA4
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCDE8
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCE79
{
...
float func_195(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCF14
{
	var unk;
...
void func_196(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xCF4E
{
	float num;
	float num2;
	float num3;
	...
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam2))
		{
			...
			{
				if (func_195(unk_0xC1A5EC5C986B98AD(), uParam3, 1) <= 100f)
					func_199(uParam0, 1);
			}
			else
			{
				...
				{
					num = func_195(unk_0xC1A5EC5C986B98AD(), fParam6, 1);
					num2 = func_195(unk_0xC1A5EC5C986B98AD(), fParam9, 1);
					num3 = num - num2;
					...
					if (num3 > 0.5f)
					{
						if (num < num2)
						{
							...
							{
								unk_0x423A98584B1756BF();
								unk_0x028B1EDDD6EC4C79(uParam2, 5, 8);
						...
						{
							unk_0x423A98584B1756BF();
							unk_0x028B1EDDD6EC4C79(uParam2, 6, 8);
							func_197(*uParam0, true);
							*uParam1 = 2;
						}
					}
				...
				if (func_195(unk_0xC1A5EC5C986B98AD(), uParam3, 1) > 120f)
					func_200(uParam0);
			}
		}
	}
...
void func_199(var uParam0, int iParam1) // Position - 0xD0E1
{
	BOOL flag;
	int i;
...
void func_200(var uParam0) // Position - 0xD17F
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_201(uParam0);
...
void func_201(var uParam0) // Position - 0xD196
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD2B2
{
	var unk;
	...
	if (func_241(*panParam0) || func_239(*panParam0) || Global_78804 == 1)
		return true;
...
void func_205(int iParam0, var uParam1, int iParam2) // Position - 0xD522
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_207(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_206(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_207(uParam1) && uParam1->f_4 == 0 && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_206(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_206(int iParam0) // Position - 0xD87A
{
...
BOOL func_207(var uParam0) // Position - 0xD89A
{
...
BOOL func_208(var uParam0) // Position - 0xD8B2
{
...
void func_210(var uParam0) // Position - 0xDBDB
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDC86
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_213(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_213(var uParam0, var uParam1) // Position - 0xDE44
{
	var unk;
...
BOOL func_214(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDE74
{
	int i;
	int num;
...
BOOL func_215(int iParam0) // Position - 0xE130
{
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xE164
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_227(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE1DA
{
	return func_218(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_218(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE1F2
{
	BOOL flag;
	var unk;
	int num;

	num = func_226(uParam0, uParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam1))
	{
		if (num != -1)
			func_225(&iLocal_37[num /*4*/]);
	
		return false;
	}

	if (!func_222(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_219(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE2B3
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_220(var uParam0, int iParam1) // Position - 0xE3DF
{
	int num;
...
BOOL func_222(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE4EE
{
	var unk;
	var unk4;
	float num;

	unk = { func_224(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_224(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_223(unk4, unk);
...
float func_223(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE57F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_224(float fParam0, var uParam1, var uParam2) // Position - 0xE5A0
{
	float num;
	float num2;
...
int func_226(var uParam0, var uParam1) // Position - 0xE5FA
{
	int i;
...
int func_227(var uParam0) // Position - 0xE639
{
...
BOOL func_228(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE661
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_232(uParam0, bParam1, num, num2))
				return true;
		
			if (func_229(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_229(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE75C
{
	float num;
	float num2;
...
BOOL func_230(var uParam0, float fParam1) // Position - 0xE868
{
	var unk;
	var unk2;
	...
	if (unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_231(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE8FD
{
	var unk;
	var unk4;
	float num;

	unk = { func_224(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_232(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE98B
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_233(int iParam0) // Position - 0xE9D3
{
...
void func_234(var uParam0) // Position - 0xEA1D
{
	var unk;
...
BOOL func_235(int iParam0) // Position - 0xEABA
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_236(int iParam0) // Position - 0xEB4F
{
...
BOOL func_239(int iParam0) // Position - 0xEBCE
{
...
BOOL func_241(int iParam0) // Position - 0xEC40
{
...
BOOL func_242(var uParam0) // Position - 0xEC68
{
	if (!func_243(uParam0))
		return false;
...
BOOL func_243(var uParam0) // Position - 0xEC87
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_246(&num) || !unk_0x2BBF749E555360DC("rcmlastone1") || !unk_0x4ACA2D82C1D0DB4F(joaat("WEAPON_PUMPSHOTGUN")) || !unk_0x4ACA2D82C1D0DB4F(joaat("WEAPON_SNIPERRIFLE")))
				return false;
		...
		case 2:
			flag = true;
			uParam0->f_28[0] = unk_0x69FDD9508259E5B5(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_244(&uParam0->f_35[0], num[1], -1303.1628f, 4648.085f, 104.9664f, 293.1504f);
...
void func_244(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEE73
{
	func_245(uParam0);
...
void func_245(var uParam0) // Position - 0xEEB5
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_246(var uParam0) // Position - 0xEF51
{
	int i;
...
BOOL func_247(int iParam0) // Position - 0xEF82
{
	var unk;
	eCharacter character;
...
BOOL func_248(int iParam0) // Position - 0xEFD3
{
	var unk;
...
BOOL func_249(int iParam0) // Position - 0xF08C
{
	var unk;
...
BOOL func_250(int iParam0) // Position - 0xF14D
{
	int i;
	var unk;
	int num;
...
BOOL func_252(int iParam0) // Position - 0xF2B4
{
...
BOOL func_253(int iParam0) // Position - 0xF2DF
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_254(int iParam0) // Position - 0xF30A
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_255(int iParam0) // Position - 0xF335
{
	if (func_236(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_257(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF384
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_258(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_258(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_258(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF3E9
{
	int num;
	char* str;
	...
	if (func_259(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_259(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF461
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_260(var uParam0, BOOL bParam1) // Position - 0xF4DC
{
	if (bParam1)
	{
		func_274("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_262(uParam0, 0, false, false);
	}

	func_261(&(uParam0->f_48));
...
void func_265(var uParam0, BOOL bParam1) // Position - 0xF5D8
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_268(var uParam0) // Position - 0xF662
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_270(var uParam0, int iParam1) // Position - 0xF6AC
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_271(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_271(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF6ED
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_272(var uParam0) // Position - 0xF73D
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
void func_273(int iParam0) // Position - 0xF77E
{
	if (*iParam0 == -1)
		return;
