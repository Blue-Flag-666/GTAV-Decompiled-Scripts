...
void main() // Position - 0x0
{
	...
	while (true)
	{
		if (ENTITY::DOES_ENTITY_EXIST(caLocal_423.f_2))
			func_9();
		else
			func_1(&caLocal_423);
...
void func_9() // Position - 0x4BE
{
	...
	else
	{
		...
		if (caLocal_423.f_410 > 2)
			if (!func_401(&caLocal_423))
				func_370();
			else
				func_361(&caLocal_423, "Taxi Not Driveable", func_369(&caLocal_423));
	
		if (caLocal_423.f_410 >= 21 && !bLocal_905)
			func_345();
	
		if (bLocal_907)
			VEHICLE::SET_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0.8f);
	
		if (caLocal_423.f_410 == 9 || caLocal_423.f_410 == 17)
			func_321(&caLocal_423, 0, false);
		...
		switch (caLocal_423.f_410)
		{
			...
			case 6:
				if (func_258(&caLocal_423))
				{
					...
					caLocal_423.f_17 = { 485.2039f, -1418.0643f, 28.2112f };
					func_252();
			...
			case 17:
				...
				if (!ENTITY::DOES_ENTITY_EXIST(hLocal_853.f_3))
					if (func_247())
						func_246(&hLocal_853, uLocal_937, fLocal_972);
				else
					func_245(&caLocal_423, &hLocal_853);
			
				if (func_219(&caLocal_423, 9f, 1097859072, 1117782016))
				{
					if (HUD::DOES_BLIP_HAVE_GPS_ROUTE(caLocal_423.f_9))
						HUD::SET_BLIP_ROUTE(caLocal_423.f_9, false);
			...
			case 21:
				...
				{
					HUD::REMOVE_BLIP(&(hLocal_853.f_4));
					caLocal_423.f_17 = { uLocal_925 };
				}
				else if (!HUD::DOES_BLIP_EXIST(caLocal_423.f_9))
				{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(caLocal_423.f_4, false))
				{
					if (PED::IS_PED_IN_VEHICLE(caLocal_423.f_2, caLocal_423.f_4, false))
					{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(caLocal_423.f_4, -685.0081f, -1101.2966f, 13.527f, -678.677f, -1110.6399f, 15.5871f, 2.25f, false, true, 0))
								iLocal_413 = 0;
							else
								iLocal_413 = 1;
			...
			case 22:
				...
				if (!PED::IS_PED_INJURED(caLocal_423.f_3))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(caLocal_423.f_4, false))
					{
						...
						{
							if (!HUD::DOES_BLIP_EXIST(caLocal_423.f_9))
								caLocal_423.f_9 = func_130(caLocal_423.f_17, true);
			...
			case 30:
				...
				if (!PED::IS_PED_INJURED(caLocal_423.f_3) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_890, caLocal_423.f_3, true) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(hLocal_853.f_2, caLocal_423.f_3, true))
				{
					...
					else
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_421, false))
							bLocal_910 = true;
					
						pedLocal_891 = PED::GET_RANDOM_PED_AT_COORD(uLocal_940, 5f, 5f, 5f, -1);
					
						if (!PED::IS_PED_INJURED(pedLocal_891))
							bLocal_910 = true;
				...
				else if (PED::IS_PED_INJURED(caLocal_423.f_3) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_890, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(hLocal_853.f_2, PLAYER::PLAYER_PED_ID(), true))
				{
					if (!PED::IS_PED_INJURED(caLocal_423.f_3))
					{
				...
				else if (bLocal_904 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_900 > 500)
				{
					if (!PED::IS_PED_INJURED(caLocal_423.f_3))
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(caLocal_423.f_3, true);
...
BOOL func_126(var uParam0, BOOL bParam1, int iParam2) // Position - 0x4525
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		if (PED::IS_PED_IN_VEHICLE(uParam0->f_2, uParam0->f_4, false))
		{
			...
			else if (func_127(uParam0->f_4, iParam2, 1, 1056964608, false, true, false))
			{
				if (bParam1)
			...
			if (!ENTITY::IS_ENTITY_DEAD(pedParam1, false))
				if (PED::IS_PED_BEING_JACKED(pedParam1))
					if (PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID()))
						if (caLocal_423.f_109 == 0)
							func_361(&caLocal_423, "Driver jacked the fiance", 7);
...
BOOL func_134() // Position - 0x4981
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_890))
		if (!PED::IS_PED_INJURED(pedLocal_890))
			entityCoords = { ENTITY::GET_ENTITY_COORDS(pedLocal_890, true) };
	...
	switch (iLocal_1143)
	{
		...
		case 1:
			if (func_116(&caLocal_423, 19) > 0.5f)
			{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(hLocal_853.f_3, false))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(hLocal_853.f_2, false))
						TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(hLocal_853.f_2, hLocal_853.f_3, &uLocal_976, iLocal_1124, iLocal_899 + 4, 0, -1, -1082130432, false, 1073741824);
				}
		...
		case 2:
			...
			else if (func_116(&caLocal_423, 19) > 4.7f)
			{
				if (func_137())
				{
					if (!bLocal_915)
...
void func_140(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x4E5B
{
	...
	vector = { func_38(outPosition, func_141(outHeading), iParam3, iParam3, 5f) };
	vector2 = { func_38(outPosition, outHeading, iParam3, iParam3, -5f) };
...
{
	if (func_116(&caLocal_423, 20) > 2f)
		if (!caLocal_423.f_142)
			func_188(&caLocal_423, &hLocal_853, MISC::GET_GAME_TIMER() - iLocal_975 > 15000, false);
	...
	if (func_186(pedParam1) && ENTITY::IS_ENTITY_VISIBLE(pedParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			if (func_181(uParam0, bParam7, bParam9, false))
				func_178(uParam0, pedParam1, fParam2, iParam6);
...
void func_188(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6589
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam1->f_3, false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_51(uParam0->f_4, uParam1->f_3, true) >= 120f)
		{
			...
			else if (func_51(uParam0->f_4, uParam1->f_3, true) >= 300f)
			{
				func_254(uParam0, 143, 0, false, false);
				func_361(uParam0, "Taxi let the Chasee lose him", 2);
			}
		}
		else if (func_51(uParam0->f_4, uParam1->f_3, true) < 22.5f && func_196(&(uParam1->f_3)) || func_51(uParam0->f_4, uParam1->f_3, true) < 13f && func_193(&(uParam1->f_3)) || func_51(uParam0->f_4, uParam1->f_3, true) < func_194(&(uParam1->f_3)) && func_195(&(uParam1->f_3)))
		{
...
void func_199(Vehicle veParam0, float fParam1, float fParam2, float fParam3, float fParam4, var uParam5, int iParam6) // Position - 0x6F08
{
	if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
			if (func_53(veParam0, fParam1, true) < fParam4)
				if (func_201(uParam5))
...
BOOL func_212() // Position - 0x73FA
{
	...
	switch (iLocal_1144)
	{
		...
		case 9:
			...
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(hLocal_853.f_2, false))
					PED::SET_PED_INTO_VEHICLE(hLocal_853.f_2, hLocal_853.f_3, -1);
		...
		case 11:
			...
			else if (func_116(&caLocal_423, 19) > 3.7f)
			{
				if (func_137())
				{
					if (!bLocal_914)
	...
	if (!PED::IS_PED_INJURED(hLocal_853.f_2))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(hLocal_853.f_3, false))
		{
			if (PED::IS_PED_IN_VEHICLE(hLocal_853.f_2, hLocal_853.f_3, false))
			{
				...
				if (!HUD::DOES_BLIP_EXIST(hLocal_853.f_4))
					hLocal_853.f_4 = func_214(hLocal_853.f_3, false, false);
...
BOOL func_220(var uParam0, float fParam1) // Position - 0x7DCA
{
	if (func_66(uParam0) == 2)
	{
		...
		if (func_221(uParam0->f_4, uParam0->f_17, true) <= fParam1 + 1f && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) < 1 && func_149(true, true, true) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(uParam0->f_4))
			return func_126(uParam0, true, fParam1);
	}
	else if (ENTITY::IS_ENTITY_AT_COORD(uParam0->f_4, uParam0->f_17, fParam1 + 1f, fParam1 + 1f, 2f, !uParam0->f_140, true, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) < 1 && func_149(true, true, true) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(uParam0->f_4))
	{
		return func_126(uParam0, true, fParam1);
	}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		if (!PED::IS_PED_IN_VEHICLE(uParam0->f_2, uParam0->f_4, false))
		{
			...
			else if (bParam1)
			{
				...
				{
					if (func_233(uParam0->f_4, true) > 40f)
...
void func_245(var uParam0, var uParam1) // Position - 0x88B0
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam1->f_3, false))
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam1->f_3, PLAYER::PLAYER_PED_ID(), true))
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				func_361(&caLocal_423, "Target's vehicle has been damaged by the player", 3);
			else
				func_151();
	else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		func_361(&caLocal_423, "Target's vehicle isn't driveable", 13);
	else
		func_151();
...
void func_251(float fParam0, float fParam1, float fParam2, BOOL bParam3, int iParam4) // Position - 0x8CF0
{
	...
	vector = { func_38(fParam0, 1f, -iParam4, -iParam4, -iParam4) };
	vector2 = { func_38(fParam0, 1f, iParam4, iParam4, iParam4) };
	vector.f_2 = vector.f_2 - 22f;
	vector2.f_2 = vector2.f_2 + 22f;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false))
			{
				...
				{
					case 0:
						if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, SCRIPT_TASK_PERFORM_SEQUENCE) != 1 || func_51(PLAYER::PLAYER_PED_ID(), uParam0->f_3, true) < 20f && func_221(uParam0->f_3, uParam0->f_11, true) <= 28f && func_221(uParam0->f_4, uParam0->f_11, true) <= 28f)
...
BOOL func_272(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4) // Position - 0x9E6F
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false))
	{
		if (!ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_3) && func_233(uParam0->f_3, true) < fParam2)
			if (!func_189(uParam0, 5))
				func_317(uParam0, 5, 0, false);
		else if (func_189(uParam0, 5))
			func_208(uParam0, 5, false);
	
		if (func_116(uParam0, 5) > (float)iParam1 && ENTITY::GET_ENTITY_SPEED(uParam0->f_4) < fParam4 && !ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_3) || func_233(uParam0->f_3, true) <= fParam3)
			return true;
	}
...
float func_276(var uParam0, Vehicle veParam1) // Position - 0xA3FC
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam1, false))
		if (func_207(uParam0))
			return func_51(uParam0->f_4, veParam1, true);
...
BOOL func_280(var uParam0, int iParam1) // Position - 0xA4E3
{
	...
	if (!func_283(uParam0, iParam1))
	{
		...
		if (PED::IS_PED_INJURED(uParam0->f_3) || PED::IS_PED_FLEEING(uParam0->f_3) || func_233(uParam0->f_3, true) > 400f)
...
BOOL func_325(var uParam0) // Position - 0xC31B
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false) && !func_14(&(uLocal_190[0 /*10*/].f_3)) && !func_14(&(uLocal_190[1 /*10*/].f_3)) && !func_14(&(uLocal_190[5 /*10*/].f_3)) && !func_14(&(uLocal_190[9 /*10*/].f_3)) && !func_14(&(uLocal_190[7 /*10*/].f_3)) && !func_14(&(uLocal_190[8 /*10*/].f_3)))
	{
		...
		if (MISC::ABSF(entitySpeedVector) > 2.5f && !func_14(&(uLocal_190[0 /*10*/].f_3)))
		{
			...
			else if (func_107(&(uLocal_190[11 /*10*/].f_3)) < 1.5f && MISC::ABSF(fLocal_342) - MISC::ABSF(entitySpeedVector) < 0f)
			{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false) && !func_14(&(uLocal_190[0 /*10*/].f_3)) && !func_14(&(uLocal_190[8 /*10*/].f_3)) && !func_14(&(uLocal_190[5 /*10*/].f_3)) && !func_14(&(uLocal_190[9 /*10*/].f_3)) && !func_14(&(uLocal_190[7 /*10*/].f_3)))
	{
		if (!func_14(&(uLocal_190[14 /*10*/].f_3)))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5))
				if (ENTITY::GET_ENTITY_SPEED(uParam0->f_4) > 15f && func_51(uParam0->f_5, uParam0->f_4, true) < 3f && !ENTITY::IS_ENTITY_DEAD(uParam0->f_5, false) && !VEHICLE::IS_VEHICLE_SEAT_FREE(uParam0->f_5, -1, false))
					func_117(&(uLocal_190[14 /*10*/].f_3));
		}
		else if (func_107(&(uLocal_190[14 /*10*/].f_3)) < 1.5f && func_51(uParam0->f_5, uParam0->f_4, true) > 4.5f && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_5))
		{
...
void func_345() // Position - 0xCD7D
{
	...
	if (caLocal_423.f_410 >= 28 && !bLocal_905 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(caLocal_423.f_3, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_890, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(hLocal_853.f_2, PLAYER::PLAYER_PED_ID(), true))
		bLocal_905 = true;
	else if (!ENTITY::IS_ENTITY_DEAD(caLocal_423.f_3, false))
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(hLocal_853.f_2, caLocal_423.f_3, true) && iLocal_1142 < 6)
			bLocal_905 = true;
	...
	switch (iLocal_1142)
	{
		...
		case 7:
			...
			{
				entityCoords = { ENTITY::GET_ENTITY_COORDS(hLocal_853.f_2, false) };
				TASK::OPEN_SEQUENCE_TASK(&iLocal_416);
...
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false))
		if (func_51(PLAYER::PLAYER_PED_ID(), uParam0->f_3, true) < 40f && !ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_3))
			return true;
...
void func_370() // Position - 0xE7B3
{
	...
	if (func_399(&caLocal_423, &uLocal_1052))
	{
		...
		{
			case 0:
				if (caLocal_423.f_410 == 17)
					if (!func_398(&caLocal_423))
						if (func_397("TAXI_OBJ_FTC1") || HUD::DOES_BLIP_EXIST(caLocal_423.f_9))
							uLocal_1052.f_27 = uLocal_1052.f_27 + 1;
						else if (func_198(&caLocal_423) != 10)
							func_254(&caLocal_423, 10, 1, false, true);
				break;
...
void func_390(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7) // Position - 0x126B8
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_3))
		AUDIO::INTERRUPT_CONVERSATION(uParam0->f_3, &uParam1, func_391(uParam0));
...
BOOL func_432(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x140AC
{
	...
	if (func_433(PLAYER::PLAYER_PED_ID(), pedParam0))
		return true;

	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(pedParam0) && func_233(pedParam0, true) < 1.5f)
			return true;
			...
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(veParam0, -1, false) != 0)
				if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true))
					if (weaponHash == joaat("WEAPON_STICKYBOMB"))
						if (func_51(PLAYER::PLAYER_PED_ID(), veParam0, true) < 40f)
		...
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
				if (PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 90f))
					if (func_233(pedParam0, true) < uParam1->f_2)
						if (uParam1->f_1 == 0)
...
void func_444() // Position - 0x147D3
{
	...
	caLocal_423.f_23 = { 1412.3242f, -1518.3154f, 58.4644f };
	caLocal_423.f_33 = 114.1f;
	caLocal_423.f_26 = { uLocal_925 };
