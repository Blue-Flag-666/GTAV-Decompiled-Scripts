...
void __EntryFunction__()
{
	...
	func_517(25);
	func_516();
	func_515(&uLocal_153, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	func_515(&uLocal_153, 3, iLocal_734, "CLETUS", 0, 1);
	while (true)
	{
		RECORDING::_0x208784099002BC30("SF_TP", 0);
		func_498(Local_92.f_9, 0, 0, 0, 0, 0);
...
void func_10(int iParam0, bool bParam1)
{
	...
	{
		func_180(&(Global_112009[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_14()
{
	...
	{
		func_16(13, SYSTEM::FLOOR(Global_112922.f_10194.f_3853));
	}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77669[1 /*14*/] = { func_90(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_82(iParam1), Global_77669[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, 0);
		}
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_155(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_64, Global_112922.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_77669[1 /*14*/] = { func_90(iVar10, iParam1, iParam2, -1) };
		if (!func_80(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_77669[1 /*14*/] = { func_90(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_77669[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77669[1 /*14*/] = { func_90(iVar10, 14, uVar28[iVar1], -1) };
							func_58(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
							func_73(14);
							if (Global_77667 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_77667 == 1)
						{
			...
			{
				Global_77669[1 /*14*/] = { func_90(iVar10, iVar0, func_48(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77669[1 /*14*/] = { func_90(iVar10, 14, uVar69[iVar1], -1) };
			func_58(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
			func_73(14);
			if (Global_77667 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
		}
		if (Global_77667 == 1)
		{
			iVar2 = 0;
...
{
	Global_77669[1 /*14*/] = { func_90(iParam0, iParam1, iParam2, -1) };
...
int func_77(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		iVar0 = Global_2822371[iParam0 /*3*/][func_76(iParam1)];
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_155(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_61, Global_112922.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_77(iVar1, Global_77666, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_97(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_78(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
...
int func_155(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_155(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_155(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_77669[2 /*14*/] = { func_90(iVar0, 14, iVar4, -1) };
									if (Global_77669[2 /*14*/].f_12 == iVar3)
									{
										if (func_155(iParam0, 14, iVar4))
										{
											if (!func_46(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77669[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_77669[2 /*14*/] = { func_90(iVar0, iVar2, iVar1, -1) };
						if (!func_46(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77669[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77669[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_77669[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_162()
{
	...
	{
		if (func_157(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_156(PLAYER::PLAYER_PED_ID());
			if (func_159(iVar0) && (!func_98(14) || Global_111873))
			{
				if (Global_112922.f_2363.f_539.f_4321 != iVar0 && func_159(Global_112922.f_2363.f_539.f_4321))
				{
...
void func_167(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&sVar32, Var0.f_3, Global_100017, bParam1, bParam2);
	}
}
...
void func_173()
{
	...
	{
		func_162();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_174(Global_112922.f_2363.f_539.f_4321));
	}
	else
	{
...
void func_175()
{
	...
	if (MISC::IS_XBOX360_VERSION() || func_177())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if (MISC::IS_PS3_VERSION() || func_176())
	{
...
void func_181(int iParam0, bool bParam1)
{
	...
	if (Var0.f_22 != 0)
	{
		func_208(Var0.f_22, 0);
	}
	func_199(iParam0, Global_78127);
	if (!bParam1)
	{
		iVar32 = func_198(iParam0);
		if (iVar32 != 0)
		{
...
{
	func_185(iParam0, 1);
	Global_112922.f_18574[iParam0 /*6*/].f_3 = func_184();
...
void func_191(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	if (iParam0 != 198)
	{
		if (Global_77858)
		...
		func_194(iParam0, bParam3, iParam4, 0);
...
bool func_194(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_195()
{
	if ((func_15() == -1 || func_15() == 999) && !func_196() == 0)
	{
		return 1;
	}
	return 0;
...
void func_200(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_207(iParam0))
		{
			...
			if (!bParam1)
			{
				func_205(func_206(iParam0));
				if (!func_204(68))
				{
					func_201("DI_HLP_STRY", 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
int func_210()
{
	return func_211(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}
...
void func_215(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 160)
	{
		...
		if (iParam1 == 4)
		{
			...
			func_220(iParam0, 1, 1);
			func_220(iParam0, 2, 1);
		}
		else
		{
			if (func_219(iParam0, iParam1) == 1 && func_218(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_221(iParam0, iVar0, 1);
			func_220(iParam0, iVar0, 1);
		...
		if (bParam2)
		{
			if (!Global_77858)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_217(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_217(iParam0) };
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				{
					func_233(5, "Player has finished shooting the coyote", 1, 0, 0, 1);
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
					if (!func_214())
					{
						func_231(PLAYER::PLAYER_PED_ID(), Local_913, fLocal_916, 0, 1);
					}
					if (func_310(iLocal_734))
					{
...
void func_228(bool bParam0)
{
	if (func_310(iLocal_734))
	{
		if (bParam0)
		{
			if (PED::DOES_GROUP_EXIST(func_229()))
			{
				if (!PED::IS_PED_GROUP_MEMBER(iLocal_734, func_229()))
				{
					TASK::CLEAR_PED_TASKS(iLocal_734);
					PED::SET_PED_AS_GROUP_MEMBER(iLocal_734, func_229());
					PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_734, true);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_734, false);
				}
			}
		}
		else if (PED::IS_PED_GROUP_MEMBER(iLocal_734, func_229()))
		{
			TASK::CLEAR_PED_TASKS(iLocal_734);
...
int func_231(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_233(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_211(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_304(&(Global_99980.f_3));
				if (iVar10 > -1)
				{
		...
		func_234(iParam0, sParam1, iParam4, iParam5);
...
void func_234(int iParam0, var uParam1, int iParam2, int iParam3)
{
	func_235(&Global_106470, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_235(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_223();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		func_266(&(uParam0->f_2884), 0);
		func_265(PLAYER::PLAYER_PED_ID());
		func_258(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_257())
		{
			func_253(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_237(&(uParam0->f_2890), uParam0, iParam5, 1, 1, 0);
	}
	func_236(&(uParam0->f_2980));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
void func_237(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	if (func_250(iParam2, &iVar0, iParam3, iParam5))
	{
		func_238(uParam0, uParam1, iVar0, iParam4);
	}
...
int func_238(var uParam0, var uParam1, int iParam2, int iParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam2, false))
	{
		func_240(uParam0, iParam2, iParam3);
		uParam1->f_4 = iParam2;
		if (func_239(iParam2))
		{
			uParam1->f_3 = 1;
...
{
	func_246(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_243(iParam1, 145, 0);
	uParam0->f_11 = func_242(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_241(iParam1);
		}
	}
	if (iParam2 == 1)
	{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97311[iVar0]))
		{
			if (Global_97311[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_244(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_246(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_249(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_247(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_250(int iParam0, var uParam1, int iParam2, int iParam3)
{
	char* sVar0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
				{
					if (iParam2 == 0 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(*uParam1, true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 100f)
					{
						...
						if (func_251(*uParam1, func_223(), 1))
						{
...
int func_251(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_252(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_252(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
void func_253(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
...
int func_254(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2860791[iParam0 /*3*/][func_76(iParam1)];
...
void func_258(int iParam0, bool bParam1)
{
	...
	if (func_159(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_259(iParam0, &(Global_112922.f_2363.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_259(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_264(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_261(Var11.f_1)) && iVar72 < 51)
			{
...
int func_270(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_292())
		{
			*uParam0 = func_275(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
			if (func_274(*uParam0) && !func_271(*uParam0))
			{
				return 1;
			}
		}
...
int func_272(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_15() == 0)
		{
			return BitTest(func_77(func_273(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_275(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam3 == 6 || iParam3 == func_291(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_276(iVar0, 0), true);
...
Vector3 func_276(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_287(Global_102104);
			break;
		
		case 46:
			if (Global_1852968 != func_286())
			{
				if (func_285(Global_1852968))
				{
					return func_278(2, 2);
				}
				else if (func_277(Global_1852968))
				{
...
var func_293()
{
	...
	func_303(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_302(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_301(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_296(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_295(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_294(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_299(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
int func_305(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_306(Global_112922.f_9085.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_306(Global_112922.f_9085.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_306(Global_112922.f_9085.f_99.f_205[11]);
			break;
		
		case 90:
			return func_306(Global_112922.f_9085.f_99.f_205[7]);
			break;
		
		case 93:
			return func_306(Global_112922.f_9085.f_99.f_205[9]);
			break;
	}
	return 0;
}
	...
	if (iLocal_724 < 3)
	{
		if (!bLocal_641)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, false, true, 0))
			{
				...
				if (iLocal_659[17])
				{
					if (!func_225() || MISC::GET_PROFILE_SETTING(203) == 0)
					{
						if (!iLocal_633)
						{
							if (iLocal_724 == 0)
...
void func_313()
{
	...
	if (((func_232(iLocal_975[0]) && func_232(iLocal_975[1])) && func_232(iLocal_975[2])) && func_232(iLocal_975[3]))
	{
		func_314();
	}
}
...
void func_316(bool bParam0, bool bParam1)
{
	...
	{
		iLocal_610 = func_317(iLocal_734, 1, 1, 5);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_610))
	{
		if (!bParam0)
...
void func_324()
{
	...
	while (iVar0 < 2)
	{
		...
		while (iVar1 < 3)
		{
			...
			{
				if (!func_310(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
				...
				else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, true), 2f, false))
				{
					...
					while (iLocal_716 < 3)
					{
						if (func_232(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6))
						{
...
void func_325(int iParam0, int iParam1)
{
	...
	switch (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 6:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
			{
				if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_328(iParam0), false, false, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
			{
				if (iLocal_687[iParam0])
				{
					if (func_327(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], 1) >= 45f)
					{
				...
				else if (func_327(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >= 45f)
				{
					if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
					{
		...
		case 10:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
			{
				if (func_327(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], 0) < 2f)
				{
					TASK::CLEAR_PED_TASKS(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
		...
		case 13:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
				{
					if (func_326(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
					{
						iLocal_724++;
						iLocal_624 = 0;
					}
...
int func_326(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (func_232(iParam0) || !func_232(iParam0))
		{
...
float func_327(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_329(int iParam0)
{
	...
	{
		iVar1 = 0;
		while (iVar1 < func_345())
		{
			iVar0 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_344(iVar1));
			iVar2 = 0;
			while (iVar2 < 3)
			{
		...
		{
			func_343(767);
			if (func_330(&uLocal_153, cLocal_739, "HUNT1_KILL", "HUNT1_KILL_1", 7, 0, 0))
			{
				iLocal_614 = 1;
			}
		}
...
{
	func_342(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
		if (iParam4 < 12)
		{
...
{
	return Global_54947.f_37[iParam0];
}

int func_345()
{
	return Global_54947.f_36;
}

bool func_346()
{
	return Global_54947.f_36 > 0;
}
...
void func_347(int iParam0, int iParam1)
{
	if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, false, true, 0) && ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false)) && iLocal_633) && iLocal_724 < 3)
	{
		...
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/] = func_317(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (HUD::DOES_BLIP_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
			{
...
void func_348(int iParam0, int iParam1)
{
	...
	if (!func_310(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		if (iParam1 == 1)
		{
...
void func_352()
{
	switch (iLocal_321)
	{
		...
		case 1:
			...
			{
				func_360();
				func_233(3, "Player has finished shooting all the car tyres", 1, 0, 0, 1);
				func_358();
				func_357();
				iLocal_319 = 20;
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				...
				if (!func_214())
				{
					func_231(PLAYER::PLAYER_PED_ID(), Local_803, fLocal_806, 0, 1);
					func_354();
				}
				iLocal_321 = 2;
			}
...
void func_362()
{
	...
	else
	{
		...
		while (iVar0 < 2)
		{
			...
			while (iVar1 < 3)
			{
				func_364(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6);
				iVar1++;
			}
			iVar0++;
		}
...
void func_366()
{
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_353[iVar0 /*29*/].f_13)
		{
			...
			case 4:
				if (func_310(Local_353[iVar0 /*29*/].f_12) && func_379(Local_353[iVar0 /*29*/].f_28))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 10f, 10f, 10f, false, false, 0))
					{
						if (!func_378(Local_353[iVar0 /*29*/].f_12, -1817882002))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0 /*29*/].f_12, true);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
						}
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true))
						{
							if (func_326(Local_353[iVar0 /*29*/].f_28))
							{
								if (func_377(iVar0))
								{
			...
			case 5:
				...
				{
					TASK::CLEAR_PED_TASKS(Local_353[iVar0 /*29*/].f_12);
					Var1 = { func_370(Local_353[iVar0 /*29*/].f_28) };
					if (!func_269(Var1, 0f, 0f, 0f, 0))
					{
			...
			case 6:
				if ((func_232(Local_353[iVar0 /*29*/].f_28) && func_310(Local_353[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true))
				{
			...
			case 7:
				if (func_310(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true))
				{
			...
			case 8:
				if ((func_310(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true)) && func_379(Local_353[iVar0 /*29*/].f_28))
				{
			...
			case 15:
				...
				if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0 /*29*/].f_12))
				{
					...
					func_368(&(Local_353[iVar0 /*29*/].f_12), 1, 0, 1);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0 /*29*/].f_28))
				{
					func_367(&(Local_353[iVar0 /*29*/].f_28));
				}
				Local_353[iVar0 /*29*/].f_13 = 1;
				break;
		}
		if (func_379(Local_353[iVar0 /*29*/].f_28) && func_310(Local_353[iVar0 /*29*/].f_12))
		{
...
void func_369(int iParam0)
{
	...
	if (func_310(iVar0))
	{
		if (func_379(Local_353[iParam0 /*29*/].f_28))
		{
...
{
	if (func_310(Local_353[iParam0 /*29*/].f_12))
	{
...
void func_372()
{
	...
	{
		if (func_374() && !func_225())
		{
			if (func_373(&uLocal_153, cLocal_739, "HUNT1_CARH", 7, 0, 0, 0))
			{
				iLocal_625 = 0;
			}
		}
...
bool func_373(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_374()
{
	...
	if (func_310(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_310(iLocal_734))
		{
			...
			if (func_375(PLAYER::PLAYER_PED_ID(), iLocal_734, 0) <= 10f && MISC::ABSF((Var0.f_2 - Var3.f_2)) < 1,5f)
			{
				return 1;
			}
		}
...
void func_386()
{
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				func_233(2, "Player has finished shooting all the satellite dishes", 0, 0, 0, 1);
				iLocal_319 = 13;
				...
				if (!func_214())
				{
					func_231(PLAYER::PLAYER_PED_ID(), Local_748, fLocal_691, 0, 1);
					func_354();
				}
				iLocal_321 = 2;
			}
...
void func_389()
{
	Local_353[0 /*29*/] = { func_390(joaat("habanero"), 1155,058f, 3533,135f, 33,9186f, 34,9236f, joaat("a_m_y_hippy_01"), Local_794) };
	Local_353[1 /*29*/] = { func_390(joaat("dubsta"), 1655,803f, 3492,451f, 35,5714f, 105,5303f, joaat("a_m_m_salton_01"), Local_797) };
	Local_353[2 /*29*/] = { func_390(joaat("patriot"), 1516,076f, 3376,604f, 36,6333f, 359,8644f, joaat("a_m_m_hillbilly_01"), Local_797) };
	Local_353[3 /*29*/] = { func_390(joaat("rebel"), 1140,058f, 3533,135f, 33,9186f, 269f, joaat("a_m_m_salton_01"), Local_794) };
	Local_353[4 /*29*/] = { func_390(joaat("sadler"), 1508,076f, 3372,604f, 36,6333f, 359,8644f, joaat("a_m_y_hippy_01"), Local_797) };
}

struct<29> func_390(int iParam0, struct<3> Param1, float fParam4, int iParam5, struct<3> Param6)
{
	struct<29> Var0;
...
void func_391()
{
	...
	if (!bLocal_636)
	{
		...
		else
		{
			...
			while (iVar0 < 5)
			{
				func_364(Local_353[iVar0 /*29*/].f_28);
				iVar0++;
			}
			func_392();
			if (bLocal_630)
...
void func_393()
{
	...
	{
		func_8(&iLocal_610);
		iLocal_609 = func_394(Local_745, 5, 1);
		func_321("HT_NXTLOC");
		iLocal_318 = 9;
	}
	if (func_363())
...
int func_394(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_395()
{
	...
	if (!bLocal_630)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_745, 5f, 5f, 5f, false, true, 0) && func_396(1077936128, 1))
		{
...
int func_396(float fParam0, int iParam1)
{
	int iVar0;
...
bool func_400(char* sParam0, int iParam1, char* sParam2)
{
...
void func_402()
{
	...
	while (iVar0 < 3)
	{
		if (!HUD::DOES_BLIP_EXIST(Local_322[iVar0 /*10*/].f_9))
		{
			if (func_232(Local_322[iVar0 /*10*/]))
			{
				if (!Local_322[iVar0 /*10*/].f_7)
				{
					Local_322[iVar0 /*10*/].f_9 = func_403(Local_322[iVar0 /*10*/]);
...
int func_404(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_405(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_405(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0,7f, 0,7f));
		HUD::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
float func_405(bool bParam0, float fParam1, float fParam2)
{
	if (bParam0)
	{
		return fParam1;
...
void func_406()
{
	...
	while (iVar0 < 3)
	{
		...
		if (Local_322[iVar0 /*10*/].f_7 == 1)
		{
			...
			{
				if (func_326(Local_322[iVar0 /*10*/]))
				{
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_214())
				{
					func_231(PLAYER::PLAYER_PED_ID(), Local_742, fLocal_690, 0, 1);
				}
				func_8(&iLocal_609);
				func_230(1);
				func_233(1, "Player has reached the satellite dishes", 0, 0, 0, 1);
				if (func_410())
				{
					func_354();
					func_409();
...
int func_410()
{
	...
	else
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(Local_322[0 /*10*/]) && ENTITY::DOES_ENTITY_EXIST(Local_322[1 /*10*/])) && ENTITY::DOES_ENTITY_EXIST(Local_322[2 /*10*/])) && func_411())
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_726);
			iLocal_618 = 0;
			return 1;
...
void func_413()
{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, true, true, 0))
	{
		...
		{
			func_233(1, "Player has reached the satellite dishes", 0, 0, 0, 1);
			if (func_400("HT_BKHTER", 0, 0) || func_400("HT_FOLL", 0, 0))
			{
				HUD::CLEAR_PRINTS();
			}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_214())
				{
					func_231(PLAYER::PLAYER_PED_ID(), Local_810, fLocal_813, 0, 1);
					func_354();
				}
				func_230(1);
...
void func_415()
{
	...
	switch (iLocal_321)
	{
		case 0:
			if (func_410())
			{
				func_447("Cletus_MCS_1_concat", 1);
				iLocal_321 = 1;
			}
			break;
			...
			switch (iLocal_706)
			{
				case 0:
					if (func_442(1, 1093140480, 0))
					{
						...
						if (func_232(iLocal_734))
						{
							...
							iLocal_733 = func_438(iLocal_734, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_733))
						{
						...
						func_430(Local_826, Local_829, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						func_430(Local_832, Local_835, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						func_430(Local_838, Local_841, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						func_430(Local_844, Local_847, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						if (func_232(iLocal_980))
						{
						...
						func_426(Local_807, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
						iLocal_706++;
					}
					break;
				...
				case 1:
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_741, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_623)
						{
							func_231(iLocal_734, Local_791, fLocal_698, 0, 1);
							iLocal_319 = 2;
							bLocal_623 = true;
						}
					}
...
void func_426(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_428(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_429(bool bParam0)
{
	...
	func_418(1, 1, 0, 0, 0, 0, 0);
}

void func_430(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_431(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_433(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_433(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_434(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_434(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_434(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_434(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_434(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_434(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_434(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_434(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_434(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_434(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_434(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_434(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_434(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_434(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_434(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_434(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_434(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_435(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
int func_438(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	while (func_262(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_262(iVar2, iVar8)))
			{
				if (func_441(func_262(iVar2, iVar8)))
				{
					iVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_262(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_262(iVar2, iVar10) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_262(iVar2, iVar10)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_262(iVar2, iVar10));
				func_439(iVar1, func_262(iVar2, iVar10));
			}
		}
		iVar10++;
	}
...
int func_442(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_445(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_378(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
int func_445(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_448()
{
	if (!CAM::IS_GAMEPLAY_HINT_ACTIVE() && func_375(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) > 3f)
	{
	...
	else if (func_310(iLocal_734) && func_310(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_711 || func_375(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) <= 3f)
		{
			if (func_375(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) <= 3f)
			{
			}
			iLocal_706 = 0;
			iLocal_321 = 0;
...
void func_449()
{
	...
	if (func_530())
	{
		...
		{
			case 0:
				func_450(Local_810, fLocal_813, 1, 0);
				iLocal_318 = 3;
				break;
			
			case 1:
				func_450(Local_742, fLocal_690, 1, 0);
				iLocal_318 = 5;
				break;
			
			case 2:
				func_450(Local_748, fLocal_691, 1, 0);
				iLocal_318 = 12;
				break;
			
			case 3:
				func_450(Local_803, fLocal_806, 1, 0);
				iLocal_318 = 16;
				break;
			
			case 4:
				func_450(Local_913, fLocal_916, 1, 0);
				iLocal_318 = 20;
				break;
		...
		switch (iLocal_319)
		{
			...
			case 4:
				...
				else if (!iLocal_659[0])
				{
					...
					{
						if (func_373(&uLocal_153, cLocal_739, "HUNT1_1", 7, 0, 0, 0))
						{
							iLocal_659[0] = 1;
						}
					}
				...
				{
					func_489(&uLocal_995, &uLocal_153, cLocal_739, &sLocal_996, &cLocal_1002);
				}
				break;
			...
			case 6:
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, false, true, 0) && func_374())
				{
					if (func_487())
					{
						func_382();
						if (func_373(&uLocal_153, cLocal_739, "HUNT1_DIARR", 7, 0, 0, 0))
						{
			...
			case 7:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, false, true, 0))
				{
					...
					if (func_487())
					{
						func_382();
						func_406();
						if (iLocal_637 && !func_400("HT_SHDISH", 0, 0))
						{
							func_482(0);
						}
						if (iLocal_724 == 1 && func_481())
						{
							if (!iLocal_646[0])
							{
								if (func_400("HT_SHDISH", 0, 0))
								{
									if (func_330(&uLocal_153, cLocal_739, "HUNT1_DISH", "HUNT1_DISH_1", 7, 1, 0))
									{
										iLocal_616 = 0;
										func_492(0);
										iLocal_646[0] = 1;
								...
								else if (func_330(&uLocal_153, cLocal_739, "HUNT1_DISH", "HUNT1_DISH_1", 7, 0, 0))
								{
									iLocal_616 = 0;
									func_492(0);
									iLocal_646[0] = 1;
						...
						else if (iLocal_724 == 2 && func_481())
						{
							if (!iLocal_646[1])
							{
								if (func_330(&uLocal_153, cLocal_739, "HUNT1_DISH", "HUNT1_DISH_2", 7, 0, 0))
								{
									iLocal_616 = 0;
									func_492(0);
									iLocal_646[1] = 1;
						...
						else if (iLocal_724 == 3)
						{
							...
							{
								func_318();
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_1A", 7, 0, 0, 0))
								{
									RECORDING::_0x293220DA1B46CEBC(2f, 5f, 4);
									iLocal_616 = 0;
									iLocal_646[2] = 1;
				...
				{
					if (func_373(&uLocal_153, cLocal_739, "HUNT1_LAREA", 7, 1, 0, 0))
					{
						iLocal_659[2] = 1;
					}
				}
			...
			case 11:
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), Local_823, false, true, 0))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
						{
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_ENCAR", 7, 0, 0, 0))
							{
								func_8(&iLocal_610);
								func_228(1);
			...
			case 12:
				if (func_373(&uLocal_153, cLocal_739, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_719 == -1)
					{
			...
			case 14:
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_781, 1,25f, 1,25f, 2,5f, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_763, Local_766, 10f, false, true, 0))
					{
						if (func_487())
						{
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_714 == 1)
							{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_763, Local_766, 10f, false, true, 0))
				{
					...
					if (func_487())
					{
						...
						if (iLocal_629)
						{
							if (func_351())
							{
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_TYIN", 7, 0, 0, 0))
								{
									iLocal_629 = 0;
									iLocal_624 = 0;
								}
						...
						{
							if (func_330(&uLocal_153, cLocal_739, "HUNT1_TYRE", "HUNT1_TYRE_1", 7, 0, 0))
							{
								iLocal_646[0] = 1;
							}
						}
						...
						{
							if (func_330(&uLocal_153, cLocal_739, "HUNT1_TYRE", "HUNT1_TYRE_2", 7, 0, 0))
							{
								iLocal_646[1] = 1;
							}
						}
						else if (iLocal_724 == 3)
						{
							if (!iLocal_646[2])
							{
								if (iLocal_722 <= 6 && func_373(&uLocal_153, cLocal_739, "HUNT1_TYR2", 7, 0, 0, 0))
								{
									iLocal_646[2] = 1;
								}
								else if (iLocal_722 <= 10 && func_373(&uLocal_153, cLocal_739, "HUNT1_TRY3", 7, 0, 0, 0))
								{
									iLocal_646[2] = 1;
								}
								else if (func_373(&uLocal_153, cLocal_739, "HUNT1_TYR4", 7, 0, 0, 0))
								{
									iLocal_646[2] = 1;
								}
							}
			...
			case 17:
				...
				if (!iLocal_659[15])
				{
					if (func_374())
					{
						if (!func_225())
						{
							...
							{
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_3", 8, 0, 0, 0))
								{
									iLocal_659[15] = 1;
								}
							}
				...
				{
					case 0:
						if (func_327(iLocal_734, Local_946[0 /*3*/], 0) < 2f)
						{
					...
					case 1:
						if (func_327(iLocal_734, Local_946[1 /*3*/], 0) < 2f)
						{
					...
					case 2:
						if (func_327(iLocal_734, Local_946[2 /*3*/], 0) < 2f)
						{
					...
					case 3:
						if (func_327(iLocal_734, Local_946[3 /*3*/], 0) < 2f)
						{
			...
			case 18:
				if (func_310(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (func_373(&uLocal_153, cLocal_739, "HUNT_ROOF", 7, 0, 0, 0))
						{
							TASK::CLEAR_PED_TASKS(iLocal_734);
			...
			case 21:
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, false, true, 0))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7)
					{
						if ((func_373(&uLocal_153, cLocal_739, "HUNT1_COARR", 7, 0, 0, 0) || iLocal_724 > 0) || iLocal_714 == 1)
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 5f, 4);
							iLocal_714 = 0;
							iLocal_659[17] = 1;
			...
			case 22:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, false, true, 0))
				{
					...
					if (func_487())
					{
						...
						if (iLocal_724 == 1 && !iLocal_659[18])
						{
							if (!func_225())
							{
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_FIRST", 7, 0, 0, 0))
								{
									if (iLocal_628)
									{
										iLocal_628 = 0;
						...
						if (iLocal_724 == 2 && !iLocal_659[19])
						{
							if (!func_225())
							{
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_SEC", 7, 0, 0, 0))
								{
									if (iLocal_628)
									{
										iLocal_628 = 0;
						...
						if (iLocal_628)
						{
							if (!func_225())
							{
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_COYMIS", 7, 0, 0, 0))
								{
									iLocal_628 = 0;
								}
							}
				...
				if (bLocal_626)
				{
					...
					{
						func_318();
						if (func_373(&uLocal_153, cLocal_739, "HUNT1_FIN", 8, 0, 0, 0))
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 4f, 4);
							func_492(0);
							iLocal_319 = 23;
			...
			case 23:
				if (func_479())
				{
					if (!func_225() && !func_315(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_659[20] = 1;
						iLocal_319 = 25;
			...
			case 25:
				if (!func_225())
				{
					if (!iLocal_659[21])
					{
						if (func_373(&uLocal_153, cLocal_739, "HUNT1_4", 7, 0, 0, 0))
						{
							iLocal_659[21] = 1;
						}
					}
...
void func_461()
{
	...
	{
		iVar1 = 0;
		while (iVar1 < func_463())
		{
			if (ENTITY::DOES_ENTITY_EXIST(func_462(iVar1)))
			{
				iVar0 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_462(iVar1));
				if (func_232(iVar0) || !func_232(iVar0))
				{
					if (PED::IS_PED_MODEL(iVar0, iLocal_727))
					{
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), true))
						{
							...
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_COYTYR", 7, 0, 0, 0))
							{
								iLocal_659[12] = 1;
							}
						}
...
void func_465()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_993)
		{
			if (func_374())
			{
				if (func_373(&uLocal_153, cLocal_739, "HUNT1_TYRBAN", 7, 0, 0, 0))
				{
					iLocal_659[10] = 1;
				}
			}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_703)
			{
				if (!func_225())
				{
					if (!iLocal_659[8])
					{
						if (func_468(&uLocal_153, cLocal_739, "HUNT1_BANTER", &Local_982, 7, 0, 0))
						{
...
bool func_468(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_342(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_469()
{
	...
	if (func_310(PLAYER::PLAYER_PED_ID()) && func_310(iLocal_734))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_232(iLocal_980))
			{
				if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false) == iLocal_980 && PED::GET_VEHICLE_PED_IS_IN(iLocal_734, false) == iLocal_980)
				{
					...
					else
					{
						...
						{
							func_470();
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_DAMCAR", 8, 0, 0, 0))
							{
								iLocal_990 = 0;
							}
						}
		...
		if (!iLocal_659[7])
		{
			if (!func_225())
			{
				if (func_374())
				{
					...
					{
						if (func_373(&uLocal_153, cLocal_739, "HUNT1_CLVEH", 7, 0, 0, 0))
						{
							iLocal_659[7] = 1;
						}
					}
					...
					{
						if (func_373(&uLocal_153, cLocal_739, "HUNT1_OWNVEH", 7, 0, 0, 0))
						{
							iLocal_659[7] = 1;
						}
					}
	...
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_734, true) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
			{
				if (!iLocal_644)
				{
					if (!func_400("HT_NXTLOC", 0, 0) && iLocal_659[4])
					{
				...
				{
					if (!func_225() && func_374())
					{
						if (!iLocal_659[6])
						{
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_NOVEH", 7, 0, 0, 0))
							{
								iLocal_659[6] = 1;
							}
						}
...
void func_476()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_734, true) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
	{
		if (!iLocal_988)
		{
			if (iLocal_683[1] && !func_400("HT_NXTLOC", 0, 0))
			{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_989)
		{
			if (!func_225() && func_374())
			{
				if (!iLocal_659[4])
				{
					if (func_373(&uLocal_153, cLocal_739, "HUNT1_2", 7, 0, 0, 0))
					{
						iLocal_659[4] = 1;
					}
				}
...
void func_477()
{
	...
	{
		if ((iLocal_683[1] && !func_400("HT_NXTLOC", 0, 0)) && !func_225())
		{
			if (!iLocal_643)
			{
			...
			{
				if (!iLocal_659[5] && func_374())
				{
					if (func_373(&uLocal_153, cLocal_739, "HUNT1_WAIT", 7, 0, 0, 0))
					{
						iLocal_643 = 0;
					}
				}
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, true))
			{
				if (!VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(iLocal_994))
				{
					if (func_374())
					{
						if (!func_225())
						{
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_NOCAR", 7, 0, 0, 0))
							{
								iLocal_620 = 1;
							}
						}
...
void func_480()
{
	...
	while (iVar0 < 3)
	{
		if (MISC::IS_BULLET_IN_AREA(Local_322[iVar0 /*10*/].f_1, 10f, true))
		{
			if (!func_225())
			{
				if (!func_400("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
				{
					if (!Local_322[iVar0 /*10*/].f_7)
					{
						if (func_373(&uLocal_153, cLocal_739, "HUNT_MISS", 7, 0, 0, 0))
						{
							iLocal_624 = 0;
						}
					}
	...
	if (MISC::IS_BULLET_IN_AREA(1793,305f, 3804,426f, 32,6374f, 10f, true))
	{
		if (!func_225())
		{
			if (!func_400("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
			{
				if (func_373(&uLocal_153, cLocal_739, "HUNT_MISS2", 6, 0, 0, 0))
				{
					iLocal_624 = 0;
				}
			}
...
void func_482(int iParam0)
{
	...
	if (((iLocal_724 < 3 && !func_400("HT_SHDISH", 0, 0)) && !func_400("HT_SHTYRE", 0, 0)) && !func_400("HT_SHCOY", 0, 0))
	{
		if (iLocal_624)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_712)
			{
				...
				{
					if ((func_351() || iLocal_709 > 2) || iLocal_724 == 0)
					{
						if (func_373(&uLocal_153, cLocal_739, sVar0, 7, 0, 0, 0))
						{
							iLocal_624 = 0;
						}
					}
					else
					{
						...
						{
							case 0:
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_SAT", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_709++;
								}
							...
							case 1:
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_SAT2", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_709++;
								}
							...
							case 2:
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_SAT3", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_709++;
								}
				...
				{
					if ((func_351() || iLocal_725 > 2) || iLocal_724 == 0)
					{
						if (func_373(&uLocal_153, cLocal_739, sVar0, 7, 0, 0, 0))
						{
							iLocal_624 = 0;
					...
					else
					{
						...
						{
							case 0:
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_BANT1", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_725++;
								}
							...
							case 1:
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_BANT2", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_725++;
								}
							...
							case 2:
								if (func_373(&uLocal_153, cLocal_739, "HUNT1_BANT3", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_725++;
								}
				...
				else
				{
					...
					{
						case 0:
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_COYB1", 7, 0, 0, 0))
							{
								iLocal_624 = 0;
								iLocal_981++;
							}
						...
						case 1:
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_COYB2", 7, 0, 0, 0))
							{
								iLocal_624 = 0;
								iLocal_981++;
							}
						...
						case 2:
							if (func_373(&uLocal_153, cLocal_739, "HUNT1_COYB3", 7, 0, 0, 0))
							{
								iLocal_624 = 0;
								iLocal_981++;
							}
		...
		switch (iLocal_714)
		{
			case 0:
				switch (iParam0)
				{
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_781, 1,5f, 1,5f, 1,5f, false, true, 0) || !func_484(iLocal_734, fLocal_691, 30f))
						{
							iLocal_714 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_788, 1,5f, 1,5f, 1,5f, false, true, 0) || !func_484(iLocal_734, fLocal_699, 30f))
						{
							iLocal_714 = 1;
						}
						break;
...
int func_484(int iParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	...
	if (!func_225())
	{
		if (func_374())
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				if (!iLocal_635)
				{
					if (func_373(&uLocal_153, cLocal_739, "HUNT1_UGUN", 9, 0, 0, 0))
					{
						iLocal_635 = 1;
						iLocal_634 = 0;
					}
			...
			{
				if (func_373(&uLocal_153, cLocal_739, "HUNT_UGUN2", 9, 0, 0, 0))
				{
					iLocal_634 = 1;
					iLocal_635 = 0;
				}
...
int func_487()
{
	if (func_310(PLAYER::PLAYER_PED_ID()))
	{
		if (WEAPON::GET_WEAPONTYPE_GROUP(func_488(PLAYER::PLAYER_PED_ID())) == joaat("GROUP_SNIPER"))
		{
			return 1;
		}
	}
...
void func_489(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					if (func_468(uParam1, sParam2, sParam3, sParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_468(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_493(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_310(iLocal_734) && func_310(PLAYER::PLAYER_PED_ID()))
	{
		if (func_464())
		{
			iVar1 = 0;
			...
			if (iLocal_707 == 1)
			{
				if (!iLocal_659[13])
				{
					if (func_330(&uLocal_153, cLocal_739, "HUNT1_INOC", "HUNT1_INOC_1", 8, 0, 0))
					{
						iLocal_659[13] = 1;
					}
				}
...
void func_494()
{
	if (!PED::IS_PED_INJURED(iLocal_734))
	{
		...
		if (!iLocal_619)
		{
			if (func_496() || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_734))
			{
				if (func_225())
				{
					func_318();
				}
				func_495(&uLocal_153, cLocal_739, "HUNT1_PTREAC", 6, 0, 0);
				iLocal_619 = 1;
			}
		}
		if (!bLocal_645)
...
void func_495(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_342(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
int func_496()
{
	if (func_310(iLocal_734))
	{
		if (iLocal_319 != 25)
		{
			if ((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && func_375(iLocal_734, PLAYER::PLAYER_PED_ID(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_734, 30f)) && func_375(iLocal_734, PLAYER::PLAYER_PED_ID(), 1) <= 2f)
		{
			return 1;
		}
	}
	...
	if (Global_78112 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_500(Global_78113, Global_78115, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
{
	if (((!func_512(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_511(0)) || func_510(1))
			{
			}
			else
			{
...
{
	return func_514(iParam0, Global_42602);
}
...
void func_515(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_519(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_529(&(uParam0->f_48), "special_ped@cletus@base", "cletus_base", 0);
			STREAMING::REQUEST_ANIM_DICT("special_ped@cletus@base");
			iLocal_79 = 1;
			break;
		
		case 1:
			if ((!func_528(&iVar0) || !func_526(&(uParam0->f_48))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			{
				if (func_523(&(uParam0->f_28[0]), 54, 1804,33f, 3931,33f, 33,83f, 91,63f, "RC HUNTER 1", 1))
				{
			...
			{
				func_520(&(uParam0->f_35[0]), 1806,732f, 3934,353f, 33,3275f, 76,1155f, 0);
...
void func_520(int* iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	func_521(iParam0, iLocal_81, Param1, fParam4);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_521(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_522(iParam0);
...
int func_523(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_524(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_524(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_531()
{
	...
	func_532(&Local_92, 0, 0, 0);
	HUD::CLEAR_ADDITIONAL_TEXT(6, true);
}

void func_532(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_538(uParam0, iParam1);
	func_536(uParam0, bParam2);
	func_533(uParam0, bParam3);
}

void func_533(var uParam0, bool bParam1)
{
	func_534(&(uParam0->f_41), bParam1);
}
...
int func_546()
{
	...
	iVar0 = func_307(&(Global_99980.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_548()
{
	...
	{
		if (func_304(&(Global_99980.f_3)) > -1)
		{
			return 1;
		}
	}
