...
int func_13()
{
	if (Global_19954.f_1 > 3)
	{
		MISC::CLEAR_BIT(&Global_7825, false);
		func_23(0);
		return 0;
	}
	MISC::SET_BIT(&Global_7825, false);
	if (func_14(0, 0, 1, 1))
	{
		return 1;
	}
...
void func_20()
{
	...
	if (Global_77858 == 0)
	{
		...
		func_16(4, "CELL_23", 2, "appChecklist", 39, 1, 1, 0, 0);
		if ((Global_42602 == 15 && func_2(0) == 0) && Global_7829 == 0)
		{
...
void func_31()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_33(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_17(14) || Global_111873))
			{
...
void func_40(int iParam0)
{
	...
	Global_43154[iParam0] = MISC::GET_GAME_TIMER();
}

void func_41()
{
	Global_43153 = MISC::GET_GAME_TIMER();
}
...
void func_48(int iParam0)
{
	...
	while (iVar15 < Global_112922.f_7688.f_198)
	{
		...
		{
			func_49(Global_112922.f_7688.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
