...
void main() // Position - 0x0
{
	...
	unk_0xA3C681843B51A4CC("REPORT", 0);
	...
	while (true)
	{
		switch (iLocal_52)
		{
			...
			case 1:
				...
				uLocal_53 = unk_0x2B4645565204EA06("PSYCHOLOGY_REPORT");
			
				while (!unk_0x5FAF55B1F052A2E6(uLocal_53))
				{
					func_43();
					SYSTEM::WAIT(0);
				}
			
				unk_0xA3C681843B51A4CC("REPORT", 3);
				...
				unk_0x9FD96C5DE6EDFC15(uLocal_53, "SET_PLAYER_NAME");
				unk_0x2AF11E92DE43CDE3("STRING");
				unk_0x48849374B34BB7B9("PATIENT");
				unk_0xF8FCA9E7130CE1C8();
				unk_0x2AF11E92DE43CDE3("GAMERTAG");
			
				if (unk_0x7FFBE14C34D75E19())
					unk_0x76B34CBB6F5FA1BB(unk_0x1D25117F71EE3811(unk_0x93E99A2DBCBA9CFA()));
				else
					unk_0x48849374B34BB7B9("ACCNA_MIKE" /*Michael De Santa*/);
			
				unk_0xF8FCA9E7130CE1C8();
				unk_0xAE3413B0654A0035();
				unk_0x9FD96C5DE6EDFC15(uLocal_53, "SET_LETTER_TEXT");
				func_42("HEADER_1");
				func_42("HEADER_2");
				...
				if (unk_0x72474BA05A104E1E())
				{
					...
					while (!unk_0x35DF833D93BCC488())
					{
						...
						unk_0x55CCA1B8F633F628(uLocal_53, 255, 255, 255, 255, 0);
						SYSTEM::WAIT(0);
					}
				}
			...
			case 3:
				...
				unk_0xD0AE101DBAA43C98(&uLocal_53);
...
void func_1(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3AE
{
	...
	if (!func_6(uParam0->f_1, 256) || func_6(uParam0->f_1, 8192) && unk_0x6163ED6C61AD64FC(2))
	{
		...
		if (unk_0xCC17806DB0C41C19())
		{
			...
			unk_0xD546F85F5AF0F231(func_6(uParam0->f_1, 4096));
			unk_0xAE3413B0654A0035();
		}
...
BOOL func_13(var uParam0, var uParam1, var uParam2) // Position - 0x892
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			unk_0x26124AEC857CDC1A(unk, "in", *uParam2);
			unk_0xD8B1F075AF9332AD(unk, "st", &(uParam2->f_1));
			unk_0xD8B1F075AF9332AD(unk, "mp", &(uParam2->f_2));
			unk_0xD8B1F075AF9332AD(unk, "ms", &(uParam2->f_3));
			unk_0xD8B1F075AF9332AD(unk, "sc", &(uParam2->f_5));
			unk_0xD8B1F075AF9332AD(unk, "pr", &(uParam2->f_6));
			unk_0xD8B1F075AF9332AD(unk, "fa", &(uParam2->f_7));
			unk_0xD8B1F075AF9332AD(unk, "sm", &(uParam2->f_8));
			unk_0xD8B1F075AF9332AD(unk, "kp", &(uParam2->f_9));
			unk_0xD8B1F075AF9332AD(unk, "sv", &(uParam2->f_10));
			unk_0xD8B1F075AF9332AD(unk, "yo", &(uParam2->f_11));
			unk_0xD8B1F075AF9332AD(unk, "fi", &(uParam2->f_12));
			unk_0xD8B1F075AF9332AD(unk, "rc", &(uParam2->f_13));
			unk_0xD8B1F075AF9332AD(unk, "co", &(uParam2->f_14));
			unk_0x26124AEC857CDC1A(unk, "su", uParam2->f_15);
			unk_0xBE5F0E10A7E817CB("gta5/psych/index.json", 0);
			*uParam0 = *uParam0 + 1;
			break;
...
{
	if (!unk_0xC08569894656ECC2(uParam0))
	{
		if (*uParam0)
		{
			if (unk_0xCCD4212BA2F7884E(0) != 0 && bParam1)
...
struct<4> func_20(var uParam0) // Position - 0xAB7
{
	...
	num = unk_0x15A88CFAAFFC6C4B(1, 24);
	uParam0->f_15 = num;
...
struct<4> func_21(var uParam0) // Position - 0xAE0
{
	...
	else
	{
		...
		num = unk_0x15A88CFAAFFC6C4B(1, 12);
	}
...
struct<4> func_23(var uParam0) // Position - 0xB95
{
	...
	unk_0xDD7756E2742E0F6D(joaat("NUM_RNDPEOPLE_COMPLETED"), &num2, -1);
	unk_0xDD7756E2742E0F6D(joaat("NUM_RNDEVENTS_COMPLETED"), &unk5, -1);
	num3 = num2 + unk5;
	...
	num = unk_0x15A88CFAAFFC6C4B(1, 13);
...
struct<4> func_30(var uParam0) // Position - 0xFEC
{
	...
	unk_0xDD7756E2742E0F6D(joaat("SP0_NUMBER_STOLEN_COP_VEHICLE"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP0_NUMBER_STOLEN_CARS"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP0_NUMBER_STOLEN_BIKES"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP0_NUMBER_STOLEN_BOATS"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP0_NUMBER_STOLEN_HELIS"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP0_NUMBER_STOLEN_QUADBIKES"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP0_NUMBER_STOLEN_BICYCLES"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_NUMBER_STOLEN_COP_VEHICLE"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_NUMBER_STOLEN_CARS"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_NUMBER_STOLEN_BIKES"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_NUMBER_STOLEN_BOATS"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_NUMBER_STOLEN_HELIS"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_NUMBER_STOLEN_QUADBIKES"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_NUMBER_STOLEN_BICYCLES"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_NUMBER_STOLEN_COP_VEHICLE"), &unk5, 2);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_NUMBER_STOLEN_CARS"), &unk5, 2);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_NUMBER_STOLEN_BIKES"), &unk5, 2);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_NUMBER_STOLEN_BOATS"), &unk5, 2);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_NUMBER_STOLEN_HELIS"), &unk5, 2);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_NUMBER_STOLEN_QUADBIKES"), &unk5, 2);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_NUMBER_STOLEN_BICYCLES"), &unk5, 2);
	num2 = num2 + unk5;
...
struct<4> func_31(var uParam0) // Position - 0x11E9
{
	...
	unk_0xDD7756E2742E0F6D(joaat("SP0_KILLS_INNOCENTS"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_KILLS_INNOCENTS"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_KILLS_INNOCENTS"), &unk5, 2);
	num2 = num2 + unk5;
...
struct<4> func_32(var uParam0) // Position - 0x127E
{
	...
	unk_0xDD7756E2742E0F6D(joaat("TIME_SPENT_ON_STOCKMARKET"), &num2, 0);
...
{
	if (iParam0 < 9)
		return IS_BIT_SET(Global_113648.f_18105.f_175[iParam0 /*19*/].f_18, 0);
...
struct<4> func_37(var uParam0) // Position - 0x1440
{
	...
	unk_0xDD7756E2742E0F6D(joaat("SP0_LAP_DANCED_BOUGHT"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_LAP_DANCED_BOUGHT"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_LAP_DANCED_BOUGHT"), &unk5, 2);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), &unk6, 0);
	num3 = num3 + unk6;
	unk_0xDD7756E2742E0F6D(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), &unk6, 1);
	num3 = num3 + unk6;
	unk_0xDD7756E2742E0F6D(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), &unk6, 2);
	num3 = num3 + unk6;
...
struct<4> func_38(var uParam0) // Position - 0x1525
{
	...
	unk_0xDD7756E2742E0F6D(joaat("SP0_MONEY_TOTAL_SPENT"), &unk5, 0);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP1_MONEY_TOTAL_SPENT"), &unk5, 1);
	num2 = num2 + unk5;
	unk_0xDD7756E2742E0F6D(joaat("SP2_MONEY_TOTAL_SPENT"), &unk5, 2);
	num2 = num2 + unk5;
	...
	if (num2 >= 1000000)
	{
		...
		num = unk_0x15A88CFAAFFC6C4B(1, 14);
	}
	else
	{
...
struct<4> func_39(var uParam0) // Position - 0x15C5
{
	...
	num2 = 0;
	num4 = 0;
	unk_0xDD7756E2742E0F6D(joaat("SP0_TOTAL_PLAYING_TIME"), &num4, 0);
	unk_0xDD7756E2742E0F6D(joaat("SP1_TOTAL_PLAYING_TIME"), &num3, 1);
	...
	unk_0xDD7756E2742E0F6D(joaat("SP2_TOTAL_PLAYING_TIME"), &num3, 2);
...
struct<4> func_41(var uParam0) // Position - 0x171E
{
	...
	num = unk_0x15A88CFAAFFC6C4B(1, 21);
	*uParam0 = num;
	TEXT_LABEL_APPEND_INT(&unk, num, 16);
	return unk;
}
...
void func_51(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1954
{
	...
	else
	{
		...
		if (unk_0xA26A9A07F761D8F8())
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_56(unk_0x93E99A2DBCBA9CFA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !func_52() && !bParam4 && !bParam5 && !unk_0x8253CEEA17ED481B())
				unk_0x226C3A30511D5DC4(unk_0xC1A5EC5C986B98AD(), 0);
		else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_56(unk_0x93E99A2DBCBA9CFA()) && !bParam4 && !bParam5)
			unk_0x226C3A30511D5DC4(unk_0xC1A5EC5C986B98AD(), 0);
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x1ABB
{
	BOOL flag;
...
BOOL func_56(int iParam0) // Position - 0x1B53
{
...
int func_58(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1BA0
{
	int num;
