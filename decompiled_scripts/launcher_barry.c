...
void main() // Position - 0x0
{
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_315(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	if (num == 4)
	{
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_106, 3, num.f_28[0], "BARRY", 0, 1);
		uLocal_271 = unk_0xA5E11AF0A2B928C1();
	}
	...
	while (true)
	{
		...
		if (num == 2 || num == 3)
		{
			...
			if (unk_0x3B7E6BE32C24780B())
				unk_0x09910FB897E3D426("Barry", 1, 0, 0, 0);
		}
		else if (num == 4)
		{
			if (unk_0x3B7E6BE32C24780B())
		...
		func_218(num);
		func_211(&iLocal_93, &(num.f_9), unk61);
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_208(&num, unk_0x30BE8A934C020461(num.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_207(&num, uLocal_97, true, 0);
			else if (num == 3)
				func_208(&num, unk_0x30BE8A934C020461(num.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_193(&uLocal_105, unk_0x30BE8A934C020461(num.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
	
		num2 = 0;
	
		if (func_192(num))
		{
			if (unk_0xA5E11AF0A2B928C1() - uLocal_94 > 5000)
			{
				num2 = 1;
				uLocal_94 = unk_0xA5E11AF0A2B928C1();
			}
		}
	
		if (func_177(&num, num2))
		{
			if (func_176(num))
				func_173(num, &uLocal_96);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x398F
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x39CC
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x3A0C
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A38
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F81
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x41C4
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x4663
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4704
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D79
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x653C
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x6583
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65EE
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x664F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x69F3
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A03
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74FF
{
...
BOOL func_81(Player plParam0) // Position - 0x7529
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x762B
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76C0
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x835E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x83E0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8438
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x86E5
{
...
int func_102(int iParam0) // Position - 0x8C21
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C43
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8C5A
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D18
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8DB6
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8DF8
{
...
BOOL func_118(Any* panParam0) // Position - 0xA88B
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xABFE
{
...
BOOL func_131(var uParam0) // Position - 0xACAE
{
...
BOOL func_132(int iParam0) // Position - 0xACCE
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_134(int iParam0) // Position - 0xAD9E
{
	switch (iParam0)
	{
		case 5:
...
void func_135(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xADF1
{
	int i;
...
BOOL func_136(int iParam0) // Position - 0xAEE6
{
	switch (iParam0)
	{
		case 5:
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF90
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB0F7
{
	BOOL flag;
...
BOOL func_142(int iParam0) // Position - 0xB183
{
...
int func_144(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB1D0
{
	int num;
...
BOOL func_147(var uParam0) // Position - 0xB24D
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB2F1
{
...
BOOL func_153(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB380
{
...
void func_154(var uParam0) // Position - 0xB518
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_160(int iParam0) // Position - 0xB6D4
{
	if (iParam0 == 1)
...
BOOL func_162(int iParam0) // Position - 0xB73A
{
...
BOOL func_163(int iParam0) // Position - 0xB77B
{
	int num;
...
int func_165(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB7F2
{
	int i;
...
void func_166(int iParam0, int iParam1) // Position - 0xB929
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB978
{
	return func_168(iParam0, Global_43257);
}

BOOL func_168(int iParam0, int iParam1) // Position - 0xB989
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_169(int iParam0) // Position - 0xBB6A
{
	if (Global_43257 == 15)
		return false;
...
int func_171(var uParam0, int iParam1) // Position - 0xBB9D
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBBE6
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_173(int iParam0, var uParam1) // Position - 0xBC0A
{
	switch (iParam0)
	{
		case 0:
...
var func_174(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC07D
{
	var unk;
...
var func_175(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC0A9
{
	if (bParam0)
		return uParam1;
...
BOOL func_176(int iParam0) // Position - 0xC0C0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_177(var uParam0, int iParam1) // Position - 0xC14F
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_179(var uParam0) // Position - 0xC94D
{
	float num;
...
void func_180(int iParam0, var uParam1) // Position - 0xC9DB
{
	if (iParam0 == 1)
	{
		if (!func_134(uParam1))
...
BOOL func_181(BOOL bParam0) // Position - 0xCA3F
{
	var unk;
...
BOOL func_182(var uParam0) // Position - 0xCAD6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_183(int iParam0) // Position - 0xCB00
{
	eCharacter character;
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_191() || Global_112695 || Global_32166 || func_190() || func_189(8, -1) || func_96() || func_188() || func_187() || func_186() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_191() || Global_32166 || func_190() || func_189(8, -1) || func_187() || func_96() || func_188() || func_186() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD()) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD()) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA()) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_191() || Global_112695 || Global_32166 || func_190() || func_189(8, -1) || func_187() || func_96() || func_188() || func_186() || Global_113648.f_7690.f_919[character] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD()) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || func_191() || Global_112695 || Global_32166 || func_190() || func_189(8, -1) || func_96() || func_188() || func_186() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_191() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0 || func_189(8, -1) || func_186() || func_185() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
BOOL func_184() // Position - 0xD21D
{
	return Global_100720.f_1;
}

BOOL func_185() // Position - 0xD22B
{
	if (Global_97603 != -1)
...
BOOL func_190() // Position - 0xD2DB
{
	return Global_1575060;
}

BOOL func_191() // Position - 0xD2E7
{
	if (!unk_0xA26A9A07F761D8F8())
...
BOOL func_192(int iParam0) // Position - 0xD303
{
	switch (iParam0)
	{
		case 5:
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD326
{
	switch (*uParam0)
	{
		case 0:
			if (unk_0xA5E11AF0A2B928C1() - uLocal_271 > 5000)
				*uParam0 = 1;
			break;
	
		case 1:
			if (func_206(unk_0xC1A5EC5C986B98AD(), uParam1, 1) <= 20f)
				if (_CONVERSATION_ADD_LINE(&uLocal_106, sParam4, sParam5, 8, 0, 0, 0))
					*uParam0 = 2;
			break;
		...
		case 2:
			...
			else if (func_206(unk_0xC1A5EC5C986B98AD(), uParam1, 1) >= 25f)
			{
				func_148();
				*uParam0 = 0;
			}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD3C3
{
	...
	Global_22722 = 0;
	Global_2883585 = 0;
	return func_195(sParam2, iParam3, false);
}

BOOL func_195(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD411
{
	Global_21726 = 0;
...
BOOL func_199(int iParam0, int iParam1) // Position - 0xD789
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xD901
{
	if (func_57(14))
	{
		if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0))
...
float func_206(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xDA51
{
	var unk;
...
void func_207(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Position - 0xDA8B
{
	var unk;
	int num;
	...
	uParam1.f_7 = unk_0x15A88CFAAFFC6C4B(0, uParam1.f_6);
	unk_0xDBC7406226B5540E(&unk);
	unk_0x3EE48ADC8C7F5CC4(0, uParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | num, 0, 0, 0, 0);
	unk_0x3EE48ADC8C7F5CC4(0, uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 1 | num, 0, 0, 0, 0);
	unk_0xF2CFC6EC8C85FA78(unk);
	unk_0x3D7110D966B0CEA2(uParam0->f_28[iParam10], unk);
	unk_0x63EF69C6969A3D26(&unk);
	return;
}

BOOL func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDB28
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0xA5E11AF0A2B928C1() - uParam0->f_60 > iParam8 && func_206(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < fParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBB0
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDBEB
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDC0C
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam1))
		{
			...
			{
				if (func_206(unk_0xC1A5EC5C986B98AD(), uParam2, 1) <= 100f)
					func_214(uParam0, 1);
			}
			else
			{
				...
				if (func_206(unk_0xC1A5EC5C986B98AD(), uParam2, 1) > 120f)
					func_216(uParam0);
			}
		}
	}
...
void func_214(var uParam0, int iParam1) // Position - 0xDD72
{
	BOOL flag;
	int i;
...
void func_216(var uParam0) // Position - 0xDE1C
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_217(uParam0);
...
void func_217(var uParam0) // Position - 0xDE33
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDF43
{
	var unk;
	...
	if (func_256(*panParam0) || func_254(*panParam0) || Global_78804 == 1)
		return true;
...
BOOL func_221(int iParam0) // Position - 0xE50B
{
...
BOOL func_222(var uParam0) // Position - 0xE52B
{
...
BOOL func_223(var uParam0) // Position - 0xE543
{
...
void func_225(var uParam0) // Position - 0xE86C
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE917
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_228(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_228(var uParam0, var uParam1) // Position - 0xEAD5
{
	var unk;
...
BOOL func_229(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEB05
{
	int i;
	int num;
...
BOOL func_230(int iParam0) // Position - 0xEDC1
{
...
BOOL func_231(var uParam0, int iParam1) // Position - 0xEDF5
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_242(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xEE6B
{
	return func_233(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEE83
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_234(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEF44
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_235(var uParam0, int iParam1) // Position - 0xF070
{
	int num;
...
BOOL func_237(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF17F
{
	var unk;
	var unk4;
	float num;

	unk = { func_239(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_239(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };
...
float func_238(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF210
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_239(float fParam0, var uParam1, var uParam2) // Position - 0xF231
{
	float num;
	float num2;
...
int func_241(var uParam0, var uParam1) // Position - 0xF28B
{
	int i;
...
int func_242(var uParam0) // Position - 0xF2CA
{
...
BOOL func_243(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF2F2
{
	float num;
	float num2;
	int num3;
...
BOOL func_244(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF3ED
{
	float num;
	float num2;
...
BOOL func_245(var uParam0, float fParam1) // Position - 0xF4F9
{
	var unk;
	var unk2;
...
BOOL func_246(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF58E
{
	var unk;
	var unk4;
	float num;

	unk = { func_239(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_247(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF61C
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_248(int iParam0) // Position - 0xF664
{
...
void func_249(var uParam0) // Position - 0xF6AE
{
	var unk;
...
BOOL func_250(int iParam0) // Position - 0xF74B
{
	if (iParam0 == -1)
		iParam0 = func_170();
...
BOOL func_251(int iParam0) // Position - 0xF7E0
{
...
BOOL func_254(int iParam0) // Position - 0xF85F
{
...
BOOL func_256(int iParam0) // Position - 0xF8D1
{
...
void func_257() // Position - 0xF8F9
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()))
		if (func_258(unk_0xC1A5EC5C986B98AD(), unk, num, 1))
			func_155();

	return;
}

BOOL func_258(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF93C
{
	return SYSTEM::VDIST2(unk_0x30BE8A934C020461(uParam0, iParam5), vParam1) <= fParam4 * fParam4;
}

void func_259(var uParam0) // Position - 0xF95A
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
		unk_0x992BB708B4B7A005(uParam0->f_28[0], 64, 1);
		unk_0x992BB708B4B7A005(uParam0->f_28[0], 249, 1);
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		for (i = 0; i <= 5; i = i + 1)
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[i]))
				unk_0x2718E9CC165A99F6(uParam0->f_41[i], 0);
		}
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			...
			unk_0xC6C9BF71106ABCAC(uParam0->f_28[0], unk_0xC1A5EC5C986B98AD(), 10000f, -1, 0, 0);
		}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFA63
{
...
BOOL func_263(var uParam0) // Position - 0xFB2C
{
	...
	{
		func_265(&uLocal_97);
		func_264(&uLocal_97, "democ_only_works");
		func_264(&uLocal_97, "gift_from_god");
		func_264(&uLocal_97, "rigged_vote");
		func_264(&uLocal_97, "suck_my");
		func_264(&uLocal_97, "tyranny");
	}
...
BOOL func_266(var uParam0) // Position - 0xFC64
{
	uParam0->f_16 = 3;
...
BOOL func_267(var uParam0) // Position - 0xFC8F
{
	int num;
	var unk4;
	var unk7;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				func_269(&uParam0->f_35[0], num[0], unk4, num2);
			
				if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
				{
					unk_0xE89126C47B21ED30(uParam0->f_35[0], 0);
					unk_0x9C56520AE72AFDBF(num[0], 1);
					unk_0x430E66CAC97B6178(uParam0->f_35[0], "WEED STASH VEHICLE");
					unk_0x6350D33B12812585(uParam0->f_35[0], 0);
					unk_0x3C5D12D7D1DA0113(uParam0->f_35[0], 0);
					unk_0x7A1950259E8A78CC(uParam0->f_35[0], 1);
					unk_0xBF8238D446A5EAA1(uParam0->f_35[0], 1);
				}
				else
				{
					flag = false;
			...
			{
				func_268(&uParam0->f_41[0], num[1], unk4 + unk10, 0f);
			
				if (unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]) && unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
					unk_0xBD02C9D4D7076ECC(uParam0->f_41[0], uParam0->f_35[0], 0, unk10, unk13, 0, 0, 0, 0, 2, 1, 0);
				else
					flag = false;
			}
			...
			{
				func_269(&uParam0->f_35[1], num[2], unk7, num3);
				unk_0xDED5B7E9594C5D3B(uParam0->f_35[1], 39, 43);
			}
...
void func_268(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF15
{
	func_225(uParam0);
...
void func_269(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFF3C
{
	func_270(uParam0);
...
void func_270(var uParam0) // Position - 0xFF7E
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_271(var uParam0) // Position - 0x1001B
{
	int i;
...
BOOL func_272(var uParam0) // Position - 0x1004C
{
	int num;
	var unk5;
	var unk8;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			flag = true;
			func_269(&uParam0->f_35[0], num[0], unk5, num2);
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				...
				unk_0x0D14FEE68F4897C9(uParam0->f_35[0], 2, 1);
				unk_0x0D14FEE68F4897C9(uParam0->f_35[0], 3, 1);
			}
			else
			{
				flag = false;
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
			{
				func_268(&uParam0->f_41[0], num[1], unk5 + unk8, 0f);
			
				if (unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]) && unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
					unk_0xBD02C9D4D7076ECC(uParam0->f_41[0], uParam0->f_35[0], 0, unk8, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1, 0);
				else
					flag = false;
			}
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[1]))
				func_269(&uParam0->f_35[1], num[2], unk11, num3);
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				func_273(&uParam0->f_28[0], num[3], unk11, num3, 6);
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[1]))
				func_273(&uParam0->f_28[1], num[3], unk11, num3, 6);
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[1]))
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
				{
					unk_0x9213D9F34F5E77B2(uParam0->f_28[0], 1);
					unk_0x4C18E9202CF6CACA(uParam0->f_28[0], uParam0->f_35[1], -1);
					unk_0x44EBC7775DAE912E(uParam0->f_28[0], joaat("WEAPON_PISTOL"), 100, 1);
				}
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]))
				{
					unk_0x9213D9F34F5E77B2(uParam0->f_28[1], 1);
					unk_0x4C18E9202CF6CACA(uParam0->f_28[1], uParam0->f_35[1], 0);
					unk_0x44EBC7775DAE912E(uParam0->f_28[1], joaat("WEAPON_PISTOL"), 100, 1);
				}
			}
...
void func_273(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x1039C
{
	func_274(uParam0);
	*uParam0 = unk_0x69FDD9508259E5B5(iParam6, uParam1, uParam2, fParam5, 0, 0);
	return;
}

void func_274(var uParam0) // Position - 0x103BD
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_275(var uParam0) // Position - 0x103FE
{
	int num;
	var unk3;
	float num2;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_271(&num) || !func_279(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (func_276(&uParam0->f_28[0], CHAR_BARRY, unk3, num2, "RC LAUNCHER: BARRY 3", 1))
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
			{
				func_268(&uParam0->f_41[0], num[1], unk3 + { 0f, 0f, 5f }, -115.18f);
...
BOOL func_276(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x105F6
{
	if (func_277(uParam0, echParam1, uParam2, fParam5, true))
	{
		if (unk_0x7DE17ACDD8BA2642(*uParam0))
		{
			if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_277(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x10652
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_319(echParam1);
...
int func_278(var uParam0, eCharacter echParam1) // Position - 0x106E0
{
	int num;
...
BOOL func_279(var uParam0) // Position - 0x10726
{
	if (func_223(uParam0))
	{
...
BOOL func_281(var uParam0) // Position - 0x1078C
{
	int num;
	var unk6;
	float num2;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (func_276(&uParam0->f_28[0], CHAR_BARRY, unk6, num2, "RC LAUNCHER: BARRY 2", 1))
					unk_0x0A3B6B850C2EC4FD(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
			{
				unk_0x2117C3CCFF2D957A(189.5964f, -956.0344f, 29.09179f, 2f, 0);
				func_268(&uParam0->f_41[0], num[1], 189.5964f, -956.0344f, 29.09179f, func_283(-2.01f));
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
				{
					unk_0x2718E9CC165A99F6(uParam0->f_41[0], 1);
					func_268(&uParam0->f_41[2], num[3], 189.79015f, -956.1675f, 29.8229f, func_283(-2.01f));
			...
			{
				func_268(&uParam0->f_41[1], num[2], 190.417f, -956.511f, 29.09179f, -99.157f);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[1]))
				{
					unk_0x2718E9CC165A99F6(uParam0->f_41[1], 1);
					unk_0xDDE449983CE7572E(uParam0->f_41[1], 0, 0);
				}
				else
				{
					flag = false;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				unk_0xC2E3C377D893C17A(uParam0->f_28[0], unk6, 1, 0, 0, 1);
				unk_0x692C3FDAD7DB53CC(uParam0->f_28[0], num2);
				unk_0x2718E9CC165A99F6(uParam0->f_28[0], 1);
				unk_0x3EE48ADC8C7F5CC4(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 9, 0, 0, 0, 0);
			...
			{
				unk_0x2718E9CC165A99F6(uParam0->f_41[1], 1);
				unk_0xDDE449983CE7572E(uParam0->f_41[1], 1, 0);
			}
		
			func_282(&uParam0->f_41[3], num[4]);
...
void func_282(var uParam0, var uParam1) // Position - 0x10B2B
{
	var unk;
	float num;
	...
	num = 23.45f;
	func_268(uParam0, uParam1, unk, num);
	return;
}
...
BOOL func_284(var uParam0) // Position - 0x10B6B
{
	int num;
	var unk8;
	float num2;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (func_276(&uParam0->f_28[0], CHAR_BARRY, unk8, num2, "RC LAUNCHER: BARRY 1", 1))
					unk_0x0A3B6B850C2EC4FD(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
			{
				unk_0x2117C3CCFF2D957A(189.5964f, -956.0344f, 29.09179f, 5f, 0);
				func_268(&uParam0->f_41[0], num[1], 189.5964f, -956.0344f, 29.09179f, func_283(-2.01f));
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
			{
				func_268(&uParam0->f_41[1], num[2], 190.2574f, -956.3513f, 29.09179f, func_283(-1.68f));
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				unk_0x598D91BBD045C1F3(uParam0->f_28[0], 208, 1);
				unk_0x8386356641D0DED1(uParam0->f_28[0], joaat("PLAYER"));
				unk_0xC2E3C377D893C17A(uParam0->f_28[0], unk8, 1, 0, 0, 1);
				unk_0x692C3FDAD7DB53CC(uParam0->f_28[0], num2);
				unk_0x2718E9CC165A99F6(uParam0->f_28[0], 1);
				unk_0x3EE48ADC8C7F5CC4(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 9, 0, 0, 0, 0);
				unk_0xEDB03CCB50D11479(uParam0->f_28[0], unk_0xC1A5EC5C986B98AD(), -1, 0, 2);
			...
			func_268(&uParam0->f_41[4], num[5], 189.895f, -955.945f, 29.818f, 0f);
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[4]))
			{
				unk_0x464B5B0F22497FC5(uParam0->f_41[4], -90f, 0f, -30.8f, 2, 1);
				unk_0x2718E9CC165A99F6(uParam0->f_41[4], 1);
			}
		
			func_268(&uParam0->f_41[3], num[4], 189.783f, -956.015f, 29.79f, 0f);
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[3]))
			{
				unk_0x464B5B0F22497FC5(uParam0->f_41[3], -90f, 0f, 75f, 2, 1);
				unk_0x2718E9CC165A99F6(uParam0->f_41[3], 1);
			}
		
			func_282(&uParam0->f_41[5], num[6]);
...
BOOL func_285(int iParam0) // Position - 0x10FCA
{
	var unk;
	eCharacter character;
...
BOOL func_286(int iParam0) // Position - 0x1101B
{
	var unk;
...
BOOL func_287(int iParam0) // Position - 0x110D4
{
	var unk;
...
BOOL func_288(int iParam0) // Position - 0x11195
{
	int i;
	var unk;
	int num;
...
BOOL func_290(int iParam0) // Position - 0x112FC
{
...
BOOL func_291(int iParam0) // Position - 0x11327
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_292(int iParam0) // Position - 0x11352
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_293(int iParam0) // Position - 0x1137D
{
	if (func_251(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_295(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x113CC
{
	int num;
	int i;

	if (_GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_MICHAEL)
		if (func_296(2, uParam1, fParam4, uParam0))
			return true;
	else if (_GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_TREVOR)
		if (func_296(3, uParam1, fParam4, uParam0))
			return true;
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (func_296(num[i], uParam1, fParam4, uParam0))
		{
			i = num;
			return true;
		}
...
BOOL func_296(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x1145D
{
	int num;
	char* str;
	...
	if (func_297(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_297(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x114D5
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_298(var uParam0, BOOL bParam1) // Position - 0x11550
{
	char* str;
	...
	if (bParam1)
	{
		...
		func_260(uParam0);
		func_305(uParam0, 0, false, false);
	}

	if (unk_0xCE4AAA035282336C(uLocal_96))
		unk_0x45533C09A6C9B409(&uLocal_96);
...
BOOL func_302(char* sParam0) // Position - 0x11635
{
	var unk;
...
void func_307(var uParam0, BOOL bParam1) // Position - 0x116E1
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_308(&uParam0->[i], false);
	}

	return;
}

void func_308(var uParam0, BOOL bParam1) // Position - 0x1171F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_311(var uParam0) // Position - 0x117A9
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_313(var uParam0, int iParam1) // Position - 0x117F3
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_314(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_314(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11834
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_315(int iParam0) // Position - 0x11884
{
	if (*iParam0 == -1)
		return;
...
int func_319(eCharacter echParam0) // Position - 0x11920
{
	if (!func_36(echParam0))
