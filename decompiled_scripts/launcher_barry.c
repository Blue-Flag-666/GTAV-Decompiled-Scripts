...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_320(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_223(num);
		func_216(&iLocal_91, &(num.f_9), vector);
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_213(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_212(&num, uLocal_95, true, 0);
			else if (num == 3)
				func_213(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_198(&uLocal_103, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARR3AU", "BARRY3_AMB");
		...
		if (func_182(&num, num2))
		{
			if (func_181(num))
				func_178(num, &blLocal_94);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x48F2
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55A3
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55DE
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5852
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DDD
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65A0
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65E7
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6652
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A65
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A75
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x758C
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x75B6
{
...
BOOL func_85(Player plParam0) // Position - 0x75E2
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76E4
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7779
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8417
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8499
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x84F1
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x8776
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8793
{
...
int func_106(int iParam0) // Position - 0x8CDC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CFE
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D15
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DD3
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8E45
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E5B
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E71
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8EB3
{
...
BOOL func_122(Any* panParam0) // Position - 0xA946
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAAE4
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xABC0
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xACB9
{
...
int func_134(Ped pedParam0) // Position - 0xAD20
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAD69
{
...
BOOL func_136(int iParam0) // Position - 0xAD89
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAE59
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAEAC
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xAFA1
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB04B
{
	if (bParam0)
	{
...
BOOL func_144(Player plParam0, int iParam1) // Position - 0xB1B2
{
	BOOL flag;
...
BOOL func_146(Player plParam0) // Position - 0xB24C
{
	Player player;
...
BOOL func_147(Player plParam0) // Position - 0xB26E
{
...
int func_149(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB2BB
{
	int num;
...
BOOL func_152(const char* sParam0) // Position - 0xB338
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB3DC
{
...
BOOL func_158(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB46B
{
...
void func_159(Vehicle veParam0) // Position - 0xB603
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_165(int iParam0) // Position - 0xB7BF
{
	if (iParam0 == 1)
...
BOOL func_167(int iParam0) // Position - 0xB825
{
...
BOOL func_168(int iParam0) // Position - 0xB866
{
	int num;
...
int func_170(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB8DD
{
	int i;
...
void func_171(int iParam0, int iParam1) // Position - 0xBA14
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA63
{
	return func_173(iParam0, Global_43377);
}

BOOL func_173(int iParam0, int iParam1) // Position - 0xBA74
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_174(int iParam0) // Position - 0xBC55
{
	if (Global_43377 == 15)
		return false;
...
int func_176(const char* sParam0, int iParam1) // Position - 0xBC88
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBCD1
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_178(int iParam0, var uParam1) // Position - 0xBCF5
{
	switch (iParam0)
	{
		case 0:
...
Blip func_179(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC164
{
	Blip blip;
...
var func_180(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC190
{
	if (bParam0)
		return uParam1;
...
BOOL func_181(int iParam0) // Position - 0xC1A7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC236
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_184(var uParam0) // Position - 0xCA34
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xCAC2
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xCB26
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCBBD
{
...
BOOL func_188(int iParam0) // Position - 0xCBE7
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || Global_32286 || func_195() || func_194(8, -1) || func_192() || func_100() || func_193() || func_191() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_196() || Global_112857 || Global_32286 || func_195() || func_194(8, -1) || func_192() || func_100() || func_193() || func_191() || Global_113810.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_196() || Global_112857 || Global_32286 || func_195() || func_194(8, -1) || func_100() || func_193() || func_191() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_196() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_194(8, -1) || func_191() || func_190() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || func_193() || Global_112857 || Global_32286 || func_195() || Global_44569 || func_194(8, -1) || func_192() || func_190() || func_191() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_195() // Position - 0xD3C2
{
	return Global_1575063;
}

BOOL func_196() // Position - 0xD3CE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_197(int iParam0) // Position - 0xD3EA
{
	switch (iParam0)
	{
		case 5:
...
void func_198(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD40D
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_211(PLAYER::PLAYER_PED_ID(), uParam1, true) <= 20f)
		...
		case 2:
			...
			else if (func_211(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 25f)
			{
				func_153();
				*uParam0 = 0;
			}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD4AA
{
...
BOOL func_200(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD4F8
{
	Global_21846 = 0;
...
BOOL func_203(Player plParam0) // Position - 0xD860
{
	return func_204(plParam0, 20);
}

BOOL func_204(Player plParam0, int iParam1) // Position - 0xD870
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xD9E8
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
float func_211(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDB38
{
...
void func_212(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Position - 0xDB72
{
	int taskSequenceId;
	int num;
...
BOOL func_213(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDC0F
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_211(PLAYER::PLAYER_PED_ID(), uParam1, true) < fParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC97
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDCD2
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_216(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDCF3
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_211(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_219(uParam0, 1);
			}
			else
			{
				...
				if (func_211(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_221(uParam0);
			}
		}
	}
...
void func_219(var uParam0, int iParam1) // Position - 0xDE59
{
	BOOL flag;
	int i;
...
void func_221(var uParam0) // Position - 0xDF03
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_222(uParam0);
...
void func_222(var uParam0) // Position - 0xDF1A
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE02A
{
	var unk;
	...
	if (func_261(*panParam0) || func_259(*panParam0) || Global_78935 == 1)
		return true;
	...
	if (func_228(&(panParam0->f_48)) && bParam1)
		func_225(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_225(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE29A
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_227(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_226(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_227(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_226(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_226(int iParam0) // Position - 0xE5F2
{
...
BOOL func_227(var uParam0) // Position - 0xE612
{
...
BOOL func_228(var uParam0) // Position - 0xE62A
{
...
void func_230(Object* pobParam0) // Position - 0xE953
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE9FE
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_233(Ped pedParam0, Vehicle veParam1) // Position - 0xEBBC
{
...
BOOL func_234(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEBEC
{
	int i;
	int num;
...
BOOL func_235(int iParam0) // Position - 0xEEA8
{
...
BOOL func_236(Ped pedParam0, int iParam1) // Position - 0xEEDC
{
	float xSize;
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xEF52
{
	return func_238(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEF6A
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_239(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF02B
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_240(Ped pedParam0, int iParam1) // Position - 0xF157
{
...
BOOL func_242(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF266
{
	var unk;
...
float func_243(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF2F7
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_244(float fParam0, var uParam1, var uParam2) // Position - 0xF318
{
	float num;
	float num2;
...
int func_246(Ped pedParam0, Ped pedParam1) // Position - 0xF372
{
	int i;
...
BOOL func_247(Ped pedParam0) // Position - 0xF3B1
{
...
BOOL func_248(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF3D9
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_249(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF4D4
{
	float entityCoords;
	float num;
...
BOOL func_250(Ped pedParam0, float fParam1) // Position - 0xF5E0
{
	var outProjectile;
	var outCoords;
...
BOOL func_251(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF675
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_252(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF703
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_253(int iParam0) // Position - 0xF74B
{
...
void func_254(Vehicle veParam0) // Position - 0xF795
{
	int taskSequenceId;
...
BOOL func_255(int iParam0) // Position - 0xF832
{
	if (iParam0 == -1)
		iParam0 = func_175();
...
BOOL func_256(int iParam0) // Position - 0xF8C7
{
...
BOOL func_259(int iParam0) // Position - 0xF946
{
...
BOOL func_261(int iParam0) // Position - 0xF9B8
{
...
void func_262() // Position - 0xF9E0
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
		if (func_263(PLAYER::PLAYER_PED_ID(), unk, num, true))
			func_160();

	return;
}

BOOL func_263(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xFA23
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

void func_264(var uParam0) // Position - 0xFA41
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFB4A
{
...
BOOL func_268(var uParam0) // Position - 0xFC13
{
	switch (*uParam0)
	{
		case 2:
	...
	{
		func_270(&uLocal_95);
		func_269(&uLocal_95, "democ_only_works");
		func_269(&uLocal_95, "gift_from_god");
		func_269(&uLocal_95, "rigged_vote");
		func_269(&uLocal_95, "suck_my");
		func_269(&uLocal_95, "tyranny");
	}
...
BOOL func_271(var uParam0) // Position - 0xFD4B
{
	uParam0->f_16 = 3;
...
BOOL func_272(var uParam0) // Position - 0xFD76
{
	int num;
	var unk4;
	var unk7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_274(&uParam0->f_35[0], num[0], unk4, num2);
			...
			{
				func_273(&uParam0->f_41[0], num[1], unk4 + vector, 0f);
			...
			{
				func_274(&uParam0->f_35[1], num[2], unk7, num3);
...
void func_273(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFFFC
{
	func_230(pobParam0);
...
void func_274(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10027
{
	func_275(pveParam0);
...
void func_275(Vehicle* pveParam0) // Position - 0x10069
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_276(var uParam0) // Position - 0x10105
{
	int i;
...
BOOL func_277(var uParam0) // Position - 0x10136
{
	int num;
	var unk5;
	Vector3 vector;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			flag = true;
			func_274(&uParam0->f_35[0], num[0], unk5, num2);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_273(&uParam0->f_41[0], num[1], unk5 + vector, 0f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
				func_274(&uParam0->f_35[1], num[2], unk10, num3);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				func_278(&uParam0->f_28[0], num[3], unk10, num3, PED_TYPE_COP);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
				func_278(&uParam0->f_28[1], num[3], unk10, num3, PED_TYPE_COP);
...
void func_278(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0x10486
{
	func_279(ppedParam0);
...
void func_279(Ped* ppedParam0) // Position - 0x104A7
{
...
BOOL func_280(var uParam0) // Position - 0x104E8
{
	int num;
	var unk3;
	float num2;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_276(&num) || !func_284(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_281(&uParam0->f_28[0], CHAR_BARRY, unk3, num2, "RC LAUNCHER: BARRY 3", 1))
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_273(&uParam0->f_41[0], num[1], unk3 + { 0f, 0f, 5f }, -115.18f);
...
BOOL func_281(Ped* ppedParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x106E0
{
	if (func_282(ppedParam0, echParam1, uParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_282(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1073C
{
	Hash model;
...
int func_283(var uParam0, eCharacter echParam1) // Position - 0x107CA
{
	int num;
...
BOOL func_284(var uParam0) // Position - 0x10810
{
	if (func_228(uParam0))
	{
...
BOOL func_286(var uParam0) // Position - 0x10876
{
	int num;
	Vector3 vector;
	float heading;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_281(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 2", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_273(&uParam0->f_41[0], num[1], 189.5964f, -956.0344f, 29.09179f, func_288(-2.01f));
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], true);
					func_273(&uParam0->f_41[2], num[3], 189.79015f, -956.1675f, 29.8229f, func_288(-2.01f));
			...
			{
				func_273(&uParam0->f_41[1], num[2], 190.417f, -956.511f, 29.09179f, -99.157f);
...
void func_287(Object* pobParam0, Hash hParam1) // Position - 0x10C15
{
	var unk;
	float num;
	...
	num = 23.45f;
	func_273(pobParam0, hParam1, unk, num);
	return;
}
...
BOOL func_289(var uParam0) // Position - 0x10C55
{
	int num;
	Vector3 vector;
	float heading;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_281(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 1", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_273(&uParam0->f_41[1], num[2], 190.2574f, -956.3513f, 29.09179f, func_288(-1.68f));
		...
		case 3:
			...
			func_273(&uParam0->f_41[4], num[5], 189.895f, -955.945f, 29.818f, 0f);
			...
			func_273(&uParam0->f_41[3], num[4], 189.783f, -956.015f, 29.79f, 0f);
...
BOOL func_290(int iParam0) // Position - 0x110B4
{
	var unk;
	eCharacter character;
...
BOOL func_291(int iParam0) // Position - 0x11105
{
	const char* string2;
...
BOOL func_292(int iParam0) // Position - 0x111BE
{
	var unk;
...
BOOL func_293(int iParam0) // Position - 0x1127F
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_295(int iParam0) // Position - 0x113E6
{
...
BOOL func_296(int iParam0) // Position - 0x11411
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_297(int iParam0) // Position - 0x1143C
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_298(int iParam0) // Position - 0x11467
{
	if (func_256(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_300(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x114B6
{
	int num;
	int i;

	if (_GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_MICHAEL)
		if (func_301(2, uParam1, fParam4, uParam0))
			return true;
	else if (_GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_TREVOR)
		if (func_301(3, uParam1, fParam4, uParam0))
			return true;
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (func_301(num[i], uParam1, fParam4, uParam0))
		{
			i = num;
			return true;
		}
...
BOOL func_301(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x11547
{
	int num;
	char* str;
...
BOOL func_302(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x115BF
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_303(var uParam0, BOOL bParam1) // Position - 0x1163A
{
	char* str;
...
BOOL func_307(char* sParam0) // Position - 0x1171F
{
	var string1;
...
void func_313(Object* pobParam0, BOOL bParam1) // Position - 0x11809
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_316(Vehicle* pveParam0) // Position - 0x11893
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_319(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1191E
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_320(int iParam0) // Position - 0x1196E
{
	if (*iParam0 == -1)
		return;
...
Hash func_324(eCharacter echParam0) // Position - 0x11A0A
{
	if (!func_36(echParam0))
