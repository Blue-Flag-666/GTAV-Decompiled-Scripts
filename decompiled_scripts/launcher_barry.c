...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_218(num);
		func_211(&iLocal_93, &(num.f_9), vector);
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_208(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_207(&num, uLocal_97, true, 0);
			else if (num == 3)
				func_208(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_193(&uLocal_105, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARR3AU", "BARRY3_AMB");
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A38
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F81
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x42E8
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x43DB
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x48DE
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x553F
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x557A
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x57EE
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D79
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A03
{
	int i;
...
int func_93(Player plParam0) // Position - 0x86C8
{
...
void func_122(Ped pedParam0) // Position - 0xAA29
{
	int num;
	int num2;
	int num3;
...
int func_124(Ped pedParam0) // Position - 0xAB05
{
	int i;
...
int func_130(Ped pedParam0) // Position - 0xAC65
{
	int i;
...
BOOL func_131(Ped pedParam0) // Position - 0xACAE
{
...
void func_135(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xADF1
{
	int i;
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF90
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xB0F7
{
	BOOL flag;
...
BOOL func_142(Player plParam0) // Position - 0xB183
{
...
int func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB1D0
{
	int num;
...
BOOL func_147(const char* sParam0) // Position - 0xB24D
{
...
BOOL func_153(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB380
{
...
void func_154(Vehicle veParam0) // Position - 0xB518
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_171(const char* sParam0, int iParam1) // Position - 0xBB9D
{
	int num;
	const char* str;
	Hash hashKey;
...
Blip func_174(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC07D
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_182(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_182(Vehicle veParam0) // Position - 0xCAD6
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191() || Global_32166 || func_190() || func_189(8, -1) || func_187() || func_96() || func_188() || func_186() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_191() || Global_112695 || Global_32166 || func_190() || func_189(8, -1) || func_96() || func_188() || func_186() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_189(8, -1) || func_186() || func_185() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191() || func_188() || Global_112695 || Global_32166 || func_190() || Global_44446 || func_189(8, -1) || func_187() || func_185() || func_186() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD326
{
	switch (*uParam0)
	{
		...
		case 2:
			...
			else if (func_206(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 25f)
			{
				func_148();
				*uParam0 = 0;
			}
...
BOOL func_198(Player plParam0) // Position - 0xD779
{
	return func_199(plParam0, 20);
}

BOOL func_199(Player plParam0, int iParam1) // Position - 0xD789
{
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDA51
{
...
BOOL func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDB28
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_206(PLAYER::PLAYER_PED_ID(), uParam1, true) < fParam9)
	{
		unk = 16;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDBEB
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_211(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDC0C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_220(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE1B3
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_225(Object* pobParam0) // Position - 0xE86C
{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_182(playersLastVehicle2))
						{
...
BOOL func_228(Ped pedParam0, Vehicle veParam1) // Position - 0xEAD5
{
...
BOOL func_231(Ped pedParam0, int iParam1) // Position - 0xEDF5
{
	float xSize;
...
BOOL func_232(Ped pedParam0, int iParam1) // Position - 0xEE6B
{
	return func_233(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEE83
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_234(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_234(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEF44
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_235(Ped pedParam0, int iParam1) // Position - 0xF070
{
...
BOOL func_237(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF17F
{
	var unk;
...
int func_241(Ped pedParam0, Ped pedParam1) // Position - 0xF28B
{
	int i;
...
BOOL func_242(Ped pedParam0) // Position - 0xF2CA
{
...
BOOL func_243(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF2F2
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_244(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF3ED
{
	float entityCoords;
	float num;
...
BOOL func_245(Ped pedParam0, float fParam1) // Position - 0xF4F9
{
	var outProjectile;
	var outCoords;
...
BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF58E
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_247(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF61C
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_249(Vehicle veParam0) // Position - 0xF6AE
{
	int taskSequenceId;
...
void func_257() // Position - 0xF8F9
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
		if (func_258(PLAYER::PLAYER_PED_ID(), unk, num, true))
			func_155();

	return;
}

BOOL func_258(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF93C
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFA63
{
...
BOOL func_267(var uParam0) // Position - 0xFC8F
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_268(&uParam0->f_41[0], num[1], unk4 + vector, 0f);
...
void func_268(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF15
{
	func_225(pobParam0);
...
void func_269(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFF3C
{
	func_270(pveParam0);
...
void func_270(Vehicle* pveParam0) // Position - 0xFF7E
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_272(var uParam0) // Position - 0x1004C
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_268(&uParam0->f_41[0], num[1], unk5 + vector, 0f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
				func_269(&uParam0->f_35[1], num[2], unk10, num3);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				func_273(&uParam0->f_28[0], num[3], unk10, num3, PED_TYPE_COP);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
				func_273(&uParam0->f_28[1], num[3], unk10, num3, PED_TYPE_COP);
...
void func_273(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0x1039C
{
	func_274(ppedParam0);
...
void func_274(Ped* ppedParam0) // Position - 0x103BD
{
...
BOOL func_276(Ped* ppedParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x105F6
{
	if (func_277(ppedParam0, echParam1, uParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_277(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x10652
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_319(echParam1);
...
BOOL func_281(var uParam0) // Position - 0x1078C
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_276(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 2", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
...
void func_282(Object* pobParam0, Hash hParam1) // Position - 0x10B2B
{
	var unk;
	float num;
	...
	num = 23.45f;
	func_268(pobParam0, hParam1, unk, num);
	return;
}
...
BOOL func_284(var uParam0) // Position - 0x10B6B
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_276(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 1", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
...
void func_308(Object* pobParam0, BOOL bParam1) // Position - 0x1171F
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_311(Vehicle* pveParam0) // Position - 0x117A9
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_313(var uParam0, int iParam1) // Position - 0x117F3
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_314(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_314(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11834
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
Hash func_319(eCharacter echParam0) // Position - 0x11920
{
	if (!func_36(echParam0))
