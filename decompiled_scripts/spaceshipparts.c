...
void main() // Position - 0x0
{
	...
	if (unk_0x24B651D85CCE5EB4(joaat("spaceshipparts")) > 1)
		unk_0x675D9C12C73D3DE7();

	func_52(14);
	func_50();
	func_49(&uLocal_42, 0, joaat("prop_power_cell"), "SSHIP_COLLECT" /*~1~/50 spaceship parts collected.*/);
	func_47(&uLocal_42, joaat("NUM_HIDDEN_PACKAGES_1"), 755, 50);

	while (true)
	{
		SYSTEM::WAIT(0);
		func_46(unk_0xC1A5EC5C986B98AD());
	
		if (func_16(&uLocal_42, &iLocal_55) || func_15(107) == 1)
		{
			if (!bLocal_608)
...
void func_5() // Position - 0x451
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_7(character) && !func_6(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != character && func_7(Global_113648.f_2365.f_539.f_4321))
...
BOOL func_16(var uParam0, var uParam1) // Position - 0x86E
{
	...
	if (!func_6(14) && !unk_0x72474BA05A104E1E())
	{
				...
				if (!flag)
				{
					if (uParam0->f_10 == iLocal_606)
					{
						...
						if (unk_0x0E0433D7F75E162D(uParam1->[uParam0->f_10 /*11*/].f_1))
							unk_0x34CACBA26D1C2DED(uParam1->[uParam0->f_10 /*11*/].f_1, "GtaMloRoomTun5");
					}
		...
		if (!Global_78819)
			func_17(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 0, &iLocal_607, &uLocal_609, "SSHIP_TITLE" /*Part Collected~s~*/, "SSHIP_COLLECT" /*~1~/50 spaceship parts collected.*/);
	...
	if (*uParam0)
	{
		switch (*uParam4)
		{
			...
			case 1:
				...
				unk_0x64C50E40AA09A6B5(func_19(iParam3));
				unk_0xF8FCA9E7130CE1C8();
...
int func_19(int iParam0) // Position - 0xBE4
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_113648.f_10051.f_108, func_23(func_24(iParam0), i)))
				num = num + 1;
		}
	}
	else if (iParam0 == 6)
...
int func_26(var uParam0, var uParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0xD9D
{
	...
	if (uParam1->[num /*11*/].f_10)
	{
		...
		{
			if (unk_0x923599D48C8BCBED(uParam1->[num /*11*/].f_1) || func_41(uParam1->[num /*11*/].f_1))
			{
	...
	{
		if (SYSTEM::VDIST2(vParam2, unk_0x55AE93A6E3B0AE8F(uParam1->[num /*11*/].f_1)) > 60f * 60f || func_6(13) || func_6(14))
		{
...
void func_31() // Position - 0xF81
{
	...
	num4 = 0;
	unk_0xDD7756E2742E0F6D(func_33(0), &num, -1);
	num2 = num2 + num;

	if (num > 0)
		func_32(18, num);

	unk_0xDD7756E2742E0F6D(func_33(1), &num, -1);
	num2 = num2 + num;

	if (num > 0)
		func_32(19, num);

	unk_0xDD7756E2742E0F6D(func_33(3), &num, -1);
	num2 = num2 + num;
...
void func_50() // Position - 0x167B
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		iLocal_55[i /*11*/].f_3 = { func_51(i, 0) };
		iLocal_55[i /*11*/].f_10 = 0;
	}

	iLocal_55[0 /*11*/].f_9 = 179.4746f;
	iLocal_55[1 /*11*/].f_9 = 198f;
	iLocal_55[2 /*11*/].f_9 = 104f;
	iLocal_55[3 /*11*/].f_9 = 321.5f;
	iLocal_55[4 /*11*/].f_9 = 256.25f;
	iLocal_55[5 /*11*/].f_9 = 286.5f;
	iLocal_55[6 /*11*/].f_9 = 0f;
	iLocal_55[6 /*11*/].f_6 = { 0f, 0f, 1f };
	iLocal_55[7 /*11*/].f_9 = -165.6051f;
	iLocal_55[8 /*11*/].f_9 = 91.5f;
	...
	iLocal_55[21 /*11*/].f_6 = { 90f, 0f, 57f };
...
void func_53() // Position - 0x222B
{
	...
	{
		func_40(&(iLocal_55[i /*11*/].f_2));
		func_27(&(iLocal_55[i /*11*/].f_1));
	}

	if (func_58(&(uLocal_42.f_1)) || func_15(107) == 1)
	{
		func_57(107, 1);
		func_55();
		func_54(14);
