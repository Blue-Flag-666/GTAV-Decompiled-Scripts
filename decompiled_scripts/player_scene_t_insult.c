...
void main() // Position - 0x0
{
	...
	iLocal_236 = 1;
	iLocal_724 = -1;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_725, "", 16);
	fLocal_729 = 0f;
	iLocal_731 = -1;
...
BOOL func_2() // Position - 0x12E
{
	...
	if (unk_0x411B750250543BD0(Global_98011))
	{
		...
		if (!unk_0x2AC37494BBF1DB16(&uLocal_725))
		{
			if (!bLocal_730)
			{
				if (num < fLocal_729)
				...
				else if (_CONVERSATION_ADD_LINE(&uLocal_71, "PRSAUD", &uLocal_725, 3, 0, 0, 0))
				{
					bLocal_730 = true;
				}
			}
	...
	if (SYSTEM::VDIST(vector, uLocal_273) < 100f)
		return false;
	...
	for (i = 0; i < iLocal_237; i = i + 1)
	{
		...
		{
			vector2 = { unk_0x30BE8A934C020461(iLocal_237[i], 1) };
...
void func_26(var uParam0, int iParam1) // Position - 0xAF9
{
	...
	if (!unk_0x66599E73DBA5A850(uParam0))
	{
		...
		{
			case 0:
				if (unk_0x7BB3D8F4F6310EB8(uParam0, &uLocal_345, &uLocal_394[iParam1 /*16*/], 2))
				{
					num = -1f;
					num2 = -1f;
				
					if (unk_0x8EE7F4F26F4886B7(&uLocal_345, &uLocal_394[iParam1 /*16*/], "WalkInterruptible", &num, &num2) || func_35(&uLocal_345, &uLocal_394[iParam1 /*16*/], "WalkInterruptible", &num, &num2))
					{
						num3 = unk_0xABF98B1999FE64CA(Global_98011);
					
						if (num3 > num)
						{
							unk_0x909F139DC199D8E0(uParam0);
							unk_0xFB58581C53CF4C05(uParam0, -8f, 1);
							unk_0x4138C1DA9CF50A80(uParam0);
							num4 = 1f;
							...
							if (iLocal_70 == 263)
							{
								...
								func_33(uParam0, "GENERIC_FRIGHTENED_HIGH", "A_M_O_TRAMP_01_BLACK_FULL_01", 24);
							}
							...
							unk_0x7D9A648CC1936BDA(uParam0, uLocal_273 + uLocal_284[iParam1 /*3*/], num4, -1, uLocal_294[iParam1] * 0.1f, 0, 1193033728);
							unk_0xC5F9EF8F410596F9(uParam0, num5, 0, 0, 0);
				...
				else
				{
					...
					if (unk_0x2AC37494BBF1DB16(&uLocal_427[iParam1 /*16*/]))
					{
						if (func_32(uLocal_284[iParam1 /*3*/], 0f, 0f, 0f, false))
						{
							unk = { unk_0x30BE8A934C020461(uParam0, 1) };
							uLocal_284[iParam1 /*3*/] = { (unk - uLocal_273) * { 4f, 4f, 4f } };
						}
					
						if (!unk_0x2AC37494BBF1DB16(&uLocal_691[iParam1 /*16*/]))
							unk_0xFE06D34CC973CDD2(uParam0, &uLocal_691[iParam1 /*16*/], 1048576000);
					
						unk_0x7D9A648CC1936BDA(uParam0, uLocal_273 + uLocal_284[iParam1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
						iLocal_240[iParam1] = 1;
					}
					else
					{
						if (!unk_0x411B750250543BD0(iLocal_724))
						{
							iLocal_724 = unk_0x191673E3F99212B2(uLocal_273, 0f, 0f, fLocal_276, 2);
							unk_0x5F243F8265BB664F(iLocal_724, 1);
						}
						...
						if (iLocal_256[0] == joaat("p_trev_rope_01_s") || iLocal_256[1] == joaat("p_trev_rope_01_s"))
						{
							...
							unk_0xC5B2830898581862(iLocal_237[iParam1], 1);
							unk_0xD14067404D35AAE7(iLocal_237[iParam1], 0);
							unk_0x1B58D923DDA17255(iLocal_237[iParam1], 0);
							unk_0x84D39C7915D8BEE0(iLocal_237[iParam1], 1000);
							unk_0xED2BD879E739E86B(iLocal_237[iParam1], unk_0x15848AD475FC952B(iLocal_237[iParam1]), 0);
							unk_0x7D519820039E4BE9(iLocal_237[iParam1], 0);
							unk_0x992BB708B4B7A005(iLocal_237[iParam1], 64, 1);
							unk_0x992BB708B4B7A005(iLocal_237[iParam1], 249, 1);
							unk_0x992BB708B4B7A005(iLocal_237[iParam1], 335, 1);
						
							for (i = 0; i < iLocal_253; i = i + 1)
							{
								unk_0x49389483B4ABCAC3(iLocal_253[i], 0);
								unk_0x43E61A4D37019F0F(iLocal_253[i], 0);
							}
						}
						...
						unk_0x468D976993BF7FE1(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_427[iParam1 /*16*/], 1000f, -1000f, num6, num7, 1000f, num8);
					
						for (i = 0; i < iLocal_253; i = i + 1)
						{
							if (iLocal_256[i] != 0)
								if (!unk_0x2AC37494BBF1DB16(&uLocal_592[i /*16*/]))
									unk_0xA2CBB04560DD6361(iLocal_253[i], iLocal_724, &uLocal_592[i /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
						}
					
						uLocal_284[iParam1 /*3*/] = { uLocal_277[iParam1 /*3*/] };
			...
			case 1:
				if (!unk_0x29FD30D3B1A307D6(iLocal_237[iParam1], uLocal_252))
				{
					if (!unk_0xC44A95E43111EEBE(uLocal_252))
						uLocal_252 = unk_0x0003F50FFDDD8430(0);
				
					if (iParam1 == 0)
						unk_0x514333F8007B04EE(iLocal_237[iParam1], uLocal_252);
					else
						unk_0xF8463C9FBA8DCD46(iLocal_237[iParam1], uLocal_252);
				}
			
				if (unk_0xF5F493B789EA063E(uParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")) != 1)
				{
					if (uLocal_294[iParam1] == 0f)
						uLocal_294[iParam1] = SYSTEM::VMAG(uLocal_284[iParam1 /*3*/]) * 0.75f;
				
					unk_0xAE8B22E491138054(uParam0, uLocal_273 + uLocal_284[iParam1 /*3*/], uLocal_294[iParam1], 1077936128, 1086324736);
			...
			case 3:
				for (j = 0; j < iLocal_240; j = j + 1)
				{
					if (iParam1 != j)
						if (iLocal_240[j] != 3 && iLocal_240[j] != 4)
							iLocal_240[j] = 3;
				}
			...
			case 10:
				...
				if (unk_0x7BB3D8F4F6310EB8(iLocal_237[iParam1], &uLocal_345, &uLocal_427[iParam1 /*16*/], 2))
				{
					if (iLocal_70 == 288)
					{
						if (iLocal_731 <= 0)
							iLocal_731 = unk_0xA5E11AF0A2B928C1() + unk_0x15A88CFAAFFC6C4B(10000, 15000);
					
						if (unk_0x70ACD9400516DB25(uParam0))
							iLocal_731 = -1;
					
						if (iLocal_731 > 0)
						{
							if (unk_0xA5E11AF0A2B928C1() > iLocal_731)
							{
								_CONVERSATION_INITIALIZE_ACTOR(&uLocal_71, 3, iLocal_237[iParam1], "PIERWOMAN", 0, 1);
							
								if (_CONVERSATION_ADD_LINE(&uLocal_71, "PRSAUD", "TRVS_STRUG", 3, 0, 0, 0))
									iLocal_731 = -1;
							}
						}
					}
				...
				else
				{
					...
					unk_0x468D976993BF7FE1(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_427[iParam1 /*16*/], 1000f, -1000f, num9, num10, 1000f, num11);
				
					for (k = 0; k < iLocal_253; k = k + 1)
					{
						if (iLocal_256[k] != 0)
							if (!unk_0x2AC37494BBF1DB16(&uLocal_592[k /*16*/]))
								unk_0xA2CBB04560DD6361(iLocal_253[k], iLocal_724, &uLocal_592[k /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
					}
				}
			
				switch (uLocal_246[iParam1])
				{
					case -1:
						break;
				
					case 0:
						unk4 = unk_0x15A88CFAAFFC6C4B(1500, 4000);
						unk_0xEDB03CCB50D11479(iLocal_237[iParam1], unk_0xC1A5EC5C986B98AD(), unk4, 0, 2);
						uLocal_249[iParam1] = unk_0xA5E11AF0A2B928C1() + unk4 + unk_0x15A88CFAAFFC6C4B(500, 2000);
						uLocal_246[iParam1] = 1;
						break;
				
					case 1:
						if (unk_0xA5E11AF0A2B928C1() > uLocal_249[iParam1])
						{
							uLocal_249[iParam1] = 0;
							uLocal_246[iParam1] = 0;
						}
						break;
				}
			
				if (unk_0x7559C38E6535AB89(iLocal_237[iParam1], unk_0xC1A5EC5C986B98AD(), 1))
				{
				}
			
				flag = false;
			
				if (unk_0x2935B4D6CE81318D(iLocal_237[iParam1]) < unk_0x15848AD475FC952B(iLocal_237[iParam1]))
					flag = true;
			
				if (unk_0x584CD220C093B0B4(iLocal_237[iParam1]))
					flag = true;
			
				if (flag)
				{
					unk_0xE1549D437DEA008D(iLocal_724, 0f);
					unk_0xE4E4F775E5660E56(iLocal_724, 1);
					unk_0x5F243F8265BB664F(iLocal_724, 0);
					num12 = 4;
					num13 = 4276;
					num14 = 0;
					unk_0x468D976993BF7FE1(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_460[iParam1 /*16*/], 8f, -1000f, num12, num13, 8f, num14);
					unk_0x49389483B4ABCAC3(iLocal_237[iParam1], 0);
					unk_0xBB5C1E4A07AE1774(iLocal_237[iParam1], num13);
					unk_0x598D91BBD045C1F3(iLocal_237[iParam1], 208, 1);
				
					for (l = 0; l < iLocal_253; l = l + 1)
					{
						if (iLocal_256[l] != 0)
						{
							if (!unk_0x2AC37494BBF1DB16(&uLocal_625[l /*16*/]))
							{
								unk_0xA2CBB04560DD6361(iLocal_253[l], iLocal_724, &uLocal_625[l /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
								unk_0x49389483B4ABCAC3(iLocal_253[l], 0);
							}
						}
					}
			...
			case 11:
				...
				if (!unk_0x411B750250543BD0(iLocal_724))
					flag2 = false;
				else if (unk_0xABF98B1999FE64CA(iLocal_724) >= 0.99f)
					flag2 = false;
				...
				if (!flag2)
				{
					...
					unk_0xE4E4F775E5660E56(iLocal_724, 0);
					unk_0x5F243F8265BB664F(iLocal_724, 1);
					num15 = 0;
					num16 = 180;
					num17 = 0;
					unk_0x468D976993BF7FE1(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_493[iParam1 /*16*/], 1000f, -1000f, num15, num16, 1000f, num17);
				
					for (m = 0; m < iLocal_253; m = m + 1)
					{
						if (iLocal_256[m] != 0)
							if (!unk_0x2AC37494BBF1DB16(&uLocal_658[m /*16*/]))
								unk_0xA2CBB04560DD6361(iLocal_253[m], iLocal_724, &uLocal_658[m /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
					}
			...
			case 12:
				...
				if (!unk_0x7BB3D8F4F6310EB8(iLocal_237[iParam1], &uLocal_345, &uLocal_493[iParam1 /*16*/], 2))
				{
					if (!unk_0x411B750250543BD0(iLocal_724))
						iLocal_724 = unk_0x191673E3F99212B2(uLocal_273, 0f, 0f, fLocal_276, 2);
				
					unk_0x468D976993BF7FE1(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_493[iParam1 /*16*/], 1000f, -1000f, 0, 0, 1148846080, 0);
				
					for (n = 0; n < iLocal_253; n = n + 1)
					{
						if (iLocal_256[n] != 0)
							if (!unk_0x2AC37494BBF1DB16(&uLocal_658[n /*16*/]))
								unk_0xA2CBB04560DD6361(iLocal_253[n], iLocal_724, &uLocal_658[n /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
					}
				}
				break;
	...
	else
	{
		...
		if (unk_0x7DE17ACDD8BA2642(uParam0))
		{
			for (o = 0; o < iLocal_253; o = o + 1)
			{
				if (unk_0x7DE17ACDD8BA2642(iLocal_253[o]))
				{
					unk_0xFB58581C53CF4C05(iLocal_253[o], -8f, 1);
					unk_0x2718E9CC165A99F6(iLocal_253[o], 0);
					unk_0x8D62C770FD5498FA(iLocal_253[o], 1);
					unk_0xC621CC7313639986(&iLocal_253[o]);
				}
			}
		}
	}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x15EB
{
...
BOOL func_28(var uParam0) // Position - 0x1686
{
	int i;
	...
	for (i = 0; i < iLocal_237; i = i + 1)
	{
		if (uParam0 != iLocal_237[i])
			if (iLocal_240[i] < 0 && unk_0x7DE17ACDD8BA2642(iLocal_237[i]))
				return true;
	}
...
BOOL func_29(var uParam0) // Position - 0x1724
{
	int i;
	float num;
	...
	if (iLocal_70 == 237)
	{
		num = SYSTEM::VDIST2(unk_0x30BE8A934C020461(uParam0, 0), unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0));
...
void func_30(var uParam0, int iParam1) // Position - 0x17CF
{
...
BOOL func_32(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x17EF
{
	if (bParam6)
...
void func_33(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x1836
{
	unk_0xB7C28610A558761B(uParam0, sParam1, sParam2, func_34(iParam3), 0);
	return;
}

char* func_34(int iParam0) // Position - 0x184F
{
	char* str;
...
int func_35(var uParam0, var uParam1, char* sParam2, var uParam3, var uParam4) // Position - 0x1A3E
{
	if (unk_0x4310A0DB886F9FED(sParam2, "WalkInterruptible"))
	{
		if (unk_0x4310A0DB886F9FED(uParam0, "SWITCH@TREVOR@SCARES_TRAMP"))
		{
			if (unk_0x4310A0DB886F9FED(uParam1, "trev_scares_tramp_exit_tramp"))
			{
				*uParam3 = 0.8f;
				*uParam4 = 1f;
				return 1;
		...
		if (unk_0x4310A0DB886F9FED(uParam0, "SWITCH@TREVOR@CHASE_STRIPPERS"))
		{
			if (unk_0x4310A0DB886F9FED(uParam1, "EXIT_STRIPPER_01") || unk_0x4310A0DB886F9FED(uParam1, "EXIT_STRIPPER_02"))
			{
				*uParam3 = 0.4f;
				*uParam4 = 1f;
				return 1;
		...
		if (unk_0x4310A0DB886F9FED(uParam0, "SWITCH@TREVOR@THROW_FOOD"))
		{
			if (unk_0x4310A0DB886F9FED(uParam1, "EXIT_Ped"))
			{
				*uParam3 = 0.7f;
				*uParam4 = 1f;
				return 1;
		...
		if (unk_0x411B750250543BD0(Global_98011))
		{
			for (i = 0; i < iLocal_237; i = i + 1)
			{
				if (!unk_0x66599E73DBA5A850(iLocal_237[i]))
				{
					...
					if (unk_0x8EE7F4F26F4886B7(&uLocal_345, &uLocal_394[i /*16*/], "WalkInterruptible", &num6, &num7) || func_35(&uLocal_345, &uLocal_394[i /*16*/], "WalkInterruptible", &num6, &num7))
					{
						num = -8f;
						num2 = 2;
						num3 = 0;
					...
					unk_0x468D976993BF7FE1(iLocal_237[i], Global_98011, &uLocal_345, &uLocal_394[i /*16*/], 1000f, num, num2, num3, num4, num5);
					iLocal_240[i] = 0;
				}
			}
			...
			for (i = 0; i < iLocal_253; i = i + 1)
			{
				if (unk_0x7DE17ACDD8BA2642(iLocal_253[i]))
					if (!unk_0x2AC37494BBF1DB16(&uLocal_559[i /*16*/]))
						unk_0xA2CBB04560DD6361(iLocal_253[i], Global_98011, &uLocal_559[i /*16*/], &uLocal_345, 8f, -1000f, 0, 1148846080);
			}
...
BOOL func_38() // Position - 0x1C6C
{
	...
	if (unk_0x411B750250543BD0(Global_98010))
	{
		...
		{
			if (!unk_0x66599E73DBA5A850(iLocal_237[i]))
				unk_0x468D976993BF7FE1(iLocal_237[i], Global_98010, &uLocal_345, &uLocal_361[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		}
	
		for (i = 0; i < iLocal_253; i = i + 1)
		{
			if (unk_0x7DE17ACDD8BA2642(iLocal_253[i]))
				if (!unk_0x2AC37494BBF1DB16(&uLocal_526[i /*16*/]))
					unk_0xA2CBB04560DD6361(iLocal_253[i], Global_98010, &uLocal_526[i /*16*/], &uLocal_345, 8f, -1000f, 0, 1148846080);
		}
	
		if (!unk_0x2AC37494BBF1DB16(&uLocal_725))
		{
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_71, 2, unk_0xC1A5EC5C986B98AD(), "TREVOR", 0, 1);
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_71, 7, iLocal_237[0], "STRIPPER1", 0, 1);
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_71, 8, iLocal_237[1], "STRIPPER2", 0, 1);
		}
...
BOOL func_41(int iParam0, int iParam1) // Position - 0x1E56
{
	return iParam0 && iParam1 != false;
}
...
void func_47() // Position - 0x1F18
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_243; i = i + 1)
		{
			if (iLocal_243[i] != 0)
			{
				unk_0x852EC2A7DE66202D(iLocal_243[i]);
			
				if (!unk_0x0CBB7C273DED26E7(iLocal_243[i]))
				{
					flag = false;
					unk_0x852EC2A7DE66202D(iLocal_243[i]);
				}
			...
			if (!unk_0x2AC37494BBF1DB16(&uLocal_691[i /*16*/]))
			{
				unk_0x14004648CB41E983(&uLocal_691[i /*16*/]);
			
				if (!unk_0xA6FA26A80B445074(&uLocal_691[i /*16*/]))
					flag = false;
			}
		}
	
		for (i = 0; i < iLocal_256; i = i + 1)
		{
			if (iLocal_256[i] != 0)
			{
				unk_0x852EC2A7DE66202D(iLocal_256[i]);
			
				if (!unk_0x0CBB7C273DED26E7(iLocal_256[i]))
				{
					flag = false;
					unk_0x852EC2A7DE66202D(iLocal_256[i]);
				}
		...
		unk_0x28818732C8F0F80E(&uLocal_345);
	
		if (!unk_0x2BBF749E555360DC(&uLocal_345))
		{
			flag = false;
			unk_0x28818732C8F0F80E(&uLocal_345);
		}
	...
	for (i = 0; i < iLocal_237; i = i + 1)
	{
		if (iLocal_243[i] != 0)
		{
			iLocal_237[i] = unk_0x69FDD9508259E5B5(26, iLocal_243[i], uLocal_273 + uLocal_277[i /*3*/], 0, 1, 1);
			unk_0x692C3FDAD7DB53CC(iLocal_237[i], fLocal_276 + uLocal_291[i]);
			unk_0x90FF6DBE9D84E401(iLocal_237[i], 0);
		
			if (iLocal_243[i] == joaat("A_F_Y_Beach_01"))
				if (iLocal_70 == 288)
					unk_0xFECAE061D8C80757(iLocal_237[i], 8, 1, 0, 0);
		
			unk_0x7FE5E05BE63F6CB8(iLocal_237[i], 13, 0);
			unk_0x7FE5E05BE63F6CB8(iLocal_237[i], 17, 1);
			unk_0x3EE48ADC8C7F5CC4(iLocal_237[i], &uLocal_345, &uLocal_361[i /*16*/], 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
	}
	...
	for (i = 0; i < iLocal_253; i = i + 1)
	{
		if (iLocal_256[i] != 0)
		{
			iLocal_253[i] = unk_0xF19D6C0E8B56BE23(iLocal_256[i], uLocal_273 + uLocal_277[i /*3*/] + uLocal_259[i /*3*/], 1, 1, 0);
			unk_0x464B5B0F22497FC5(iLocal_253[i], { fLocal_276 + uLocal_291[i], 0f, 0f } + uLocal_266[i /*3*/], 2, 1);
		
			if (!unk_0x2AC37494BBF1DB16(&uLocal_526[i /*16*/]))
				unk_0xB07A1B0E812C8E61(iLocal_253[i], &uLocal_526[i /*16*/], &uLocal_345, 8f, 1, 0, 0, 0, 0);
		}
	}
...
void func_48() // Position - 0x217F
{
	...
	func_51(iLocal_70, &uLocal_273, &fLocal_276, &unk);
	func_49(iLocal_70, &uLocal_297, &uLocal_313, &uLocal_329, &unk9, &unk10);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_691[0 /*16*/], "", 64);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_691[1 /*16*/], "", 64);
	iLocal_256[0] = 0;
	iLocal_256[1] = 0;
	...
	{
		case 237:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@CHASE_STRIPPERS", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "LOOP_STRIPPER_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "EXIT_STRIPPER_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1 /*16*/], "LOOP_STRIPPER_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1 /*16*/], "EXIT_STRIPPER_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_725, "TRVS_IG_35", 16);
			fLocal_729 = 0.15f;
			uLocal_277[0 /*3*/] = { unk_0xD88C7A93096DA0F7(-10f, 10f), unk_0xD88C7A93096DA0F7(-10f, 10f), 0f };
			uLocal_277[1 /*3*/] = { unk_0xD88C7A93096DA0F7(-10f, 10f), unk_0xD88C7A93096DA0F7(-10f, 10f), 0f };
			uLocal_284[0 /*3*/] = { 8.2284f, -35.8652f, -1.0334f };
			uLocal_284[1 /*3*/] = { 28.4066f, -23.8848f, -0.7887f };
			uLocal_291[0] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_291[1] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_294[0] = 50f;
			uLocal_294[1] = 50f;
		...
		case 235:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@MOCKS_LAPDANCE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "001443_01_TRVS_28_EXIT_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1 /*16*/], "001443_01_TRVS_28_IDLE_MAN", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1 /*16*/], "001443_01_TRVS_28_EXIT_MAN", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1 /*16*/], "001443_01_TRVS_28_IDLE_MAN", 64);
			uLocal_277[0 /*3*/] = { -1.5421f, 0.8274f, -1.0288f };
			uLocal_277[1 /*3*/] = { -0.9636f, 1.1757f, -1.0243f };
			uLocal_284[0 /*3*/] = { 0f, 0f, 0f };
			uLocal_284[1 /*3*/] = { 0f, 0f, 0f };
			uLocal_291[0] = -130f;
			uLocal_291[1] = -130f;
			uLocal_294[0] = 0f;
			uLocal_294[1] = 0f;
		...
		case 247:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@ANNOYS_SUNBATHERS", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "trev_annoys_sunbathers_loop_girl", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "trev_annoys_sunbathers_exit_girl", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_691[0 /*16*/], "move_f@scared", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1 /*16*/], "trev_annoys_sunbathers_loop_guy", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1 /*16*/], "trev_annoys_sunbathers_exit_guy", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_691[1 /*16*/], "move_m@hurry_Butch@A", 64);
			uLocal_277[0 /*3*/] = { -0.3866f, 0.1726f, 1f };
			uLocal_277[1 /*3*/] = { -0.0726f, -0.4742f, 1f };
			uLocal_284[0 /*3*/] = { { 1.5806f, -1719.6064f, -1291.4749f } - uLocal_273 };
			uLocal_284[1 /*3*/] = { uLocal_284[0 /*3*/] };
			uLocal_291[0] = 0f;
			uLocal_291[1] = 0f;
			uLocal_294[0] = 20f;
			uLocal_294[1] = uLocal_294[0];
			iLocal_243[0] = joaat("A_F_Y_Beach_01");
			iLocal_243[1] = joaat("A_M_Y_Beach_01");
			uLocal_246[0] = -1;
			uLocal_246[1] = -1;
			iLocal_256[0] = joaat("prop_cs_beachtowel_01");
			uLocal_259[0 /*3*/] = { 0f, 0f, -1f };
			uLocal_266[0 /*3*/] = { 0f, 0f, 2.16f };
			iLocal_256[1] = joaat("prop_cs_beachtowel_01");
			uLocal_259[1 /*3*/] = { 0f, 0f, -1f };
			uLocal_266[1 /*3*/] = { 0f, 0f, -4.32f };
			break;
	
		case 286:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@RUDE_AT_CAFE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "001218_03_TRVS_23_RUDE_AT_CAFE_IDLE_FEMALE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "001218_03_TRVS_23_RUDE_AT_CAFE_EXIT_FEMALE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "", 64);
			uLocal_277[0 /*3*/] = { 4.261f, -2.388f, 0.5f };
			uLocal_284[0 /*3*/] = { 10.5918f, -34.5146f, 0f };
			uLocal_291[0] = 57.695f;
			uLocal_294[0] = 30f;
			iLocal_243[0] = joaat("A_F_Y_Hipster_03");
			uLocal_246[0] = -1;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1 /*16*/], "", 64);
			uLocal_284[1 /*3*/] = { 0f, 0f, 0f };
			uLocal_294[1] = 0f;
			iLocal_243[1] = 0;
		...
		case 263:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@SCARES_TRAMP", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "trev_scares_tramp_idle_tramp", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "trev_scares_tramp_exit_tramp", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "", 64);
			uLocal_277[0 /*3*/] = { 2.0921f, -1.5872f, 0f };
			uLocal_284[0 /*3*/] = { { 10.9545f, -1419.5369f, -605.8271f } - uLocal_273 };
			uLocal_291[0] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_294[0] = 40f;
		...
		case 244:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@THROW_FOOD", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "EXIT_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "", 64);
			uLocal_277[0 /*3*/] = { unk_0xD88C7A93096DA0F7(-5f, 5f), unk_0xD88C7A93096DA0F7(-5f, 5f), 0f };
			uLocal_284[0 /*3*/] = { { 28.2925f, -1451.7279f, 507.6885f } - uLocal_273 };
			uLocal_291[0] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_294[0] = 40f;
		...
		case 288:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@UNDER_PIER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "EXIT_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "EXIT_LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_460[0 /*16*/], "DEATH_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_493[0 /*16*/], "DEATH_LOOP_Ped", 64);
			uLocal_277[0 /*3*/] = { unk_0xD88C7A93096DA0F7(-10f, 10f), unk_0xD88C7A93096DA0F7(-10f, 10f), 0f };
			uLocal_284[0 /*3*/] = { 0f, 0f, 0f };
			uLocal_291[0] = unk_0xD88C7A93096DA0F7(-180f, 180f);
			uLocal_294[0] = 0f;
			...
			uLocal_259[0 /*3*/] = { 0f, 0f, 0f };
			TEXT_LABEL_ASSIGN_STRING(&uLocal_526[0 /*16*/], "LOOP_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_559[0 /*16*/], "EXIT_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_592[0 /*16*/], "EXIT_LOOP_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_625[0 /*16*/], "DEATH_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_658[0 /*16*/], "DEATH_LOOP_Rope", 64);
			iLocal_256[1] = joaat("prop_rolled_sock_01");
			uLocal_259[1 /*3*/] = { 0f, 0f, 0f };
			TEXT_LABEL_ASSIGN_STRING(&uLocal_526[1 /*16*/], "LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_559[1 /*16*/], "EXIT_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_592[1 /*16*/], "EXIT_LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_625[1 /*16*/], "DEATH_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_658[1 /*16*/], "DEATH_LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1 /*16*/], "", 64);
			uLocal_284[1 /*3*/] = { 0f, 0f, 0f };
		...
		default:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1 /*16*/], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1 /*16*/], "", 64);
...
BOOL func_53(int iParam0, var uParam1, char* sParam2) // Position - 0x4439
{
	var unk;
	int num;
	var unk4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_57(Global_113648.f_2365.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_57(Global_113648.f_2365.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_57(Global_113648.f_2365.f_539.f_2314[2]), 32);
			return true;
...
BOOL func_54(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x6845
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x8792
{
...
BOOL func_56(int iParam0, var uParam1, var uParam2) // Position - 0x87B0
{
	switch (iParam0)
	{
		case 11:
...
void func_58() // Position - 0x91B0
{
	...
	{
		if (iLocal_243[i] != 0)
			unk_0xE0A291F406691F03(iLocal_243[i]);
	}

	for (i = 0; i < iLocal_256; i = i + 1)
	{
		if (iLocal_256[i] != 0)
			unk_0xE0A291F406691F03(iLocal_256[i]);
	}

	unk_0x0B34FA69ECCE3927(&uLocal_345);

	if (unk_0xC44A95E43111EEBE(uLocal_252))
		unk_0x02EBF4BEE680A219(uLocal_252);
