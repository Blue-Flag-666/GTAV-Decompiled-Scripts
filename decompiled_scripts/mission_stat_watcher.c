			...
			if (Global_63355 || bLocal_638)
			{
				...
				if (!bLocal_637 == Global_63356)
				{
					...
					if (Global_63365)
					{
						...
						value = 2;
						func_97(&uLocal_45, "HISHPA", &Global_63377, 0);
					
						if (num == 69 || num == 70)
							func_96(&uLocal_45, 3, "ACTATAKE_AG", "", Global_113648.f_1.f_126[Global_63366 /*23*/], 0, 0, 0);
						else
							func_96(&uLocal_45, 3, "POTATAKE", "", Global_113648.f_1.f_126[Global_63366 /*23*/], 0, 0, 0);
					
						j = 0;
					
						for (j = 0; j < Global_96911[Global_63366 /*38*/].f_37; j = j + 1)
						{
							if (Global_96911[Global_63366 /*38*/].f_31[j] > 0)
								func_96(&uLocal_45, 3, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(Global_96911[Global_63366 /*38*/].f_25[j]), "", -1 * Global_96911[Global_63366 /*38*/].f_31[j], 0, 0, 0);
						}
					
						if (Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[0] > 0 || num == 74 || num == 75 || num == 69 || num == 70)
							func_96(&uLocal_45, 3, "ACTATAKE_M", "", Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[0], 0, 0, 0);
					
						if (Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[1] > 0 || num == 74 || num == 75)
							func_96(&uLocal_45, 3, "ACTATAKE_F", "", Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[1], 0, 0, 0);
					
						if (Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[2] > 0 || num == 74 || num == 75)
							func_96(&uLocal_45, 3, "ACTATAKE_T", "", Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[2], 0, 0, 0);
					
						if (Global_96901.f_7 > 0)
							func_96(&uLocal_45, 3, "ACTATAKE_L", "", Global_96901.f_7, 0, 0, 0);
					
						num2 = func_93(func_94(Global_63366));
						num3 = 0;
						num4 = 0;
					
						for (j = 0; j < Global_96710[num2 /*19*/]; j = j + 1)
						{
							if (!func_92(Global_113648.f_1.f_12[num2 /*6*/][j]))
								num3 = num3 + Global_113648.f_1.f_126[Global_63366 /*23*/].f_17[j];
							else
								num4 = num4 + Global_113648.f_1.f_126[Global_63366 /*23*/].f_17[j];
						}
					
						if (num == 74 || num == 75)
							func_96(&uLocal_45, 3, "LACKTAKE", "", num3, 0, 0, 0);
						else
							func_96(&uLocal_45, 3, "CREWTAKE", "", num3, 0, 0, 0);
						...
						if (num4 > 0)
						{
							if (!_IS_MISSION_REPEAT_ACTIVE(false))
							{
								...
								{
									case 90:
										unk_0x3CC35ACFFC9C730E(joaat("HCS_PENALTY_JEWEL_FUNERAL"), num4, 1);
										break;
								
									case 93:
										unk_0x3CC35ACFFC9C730E(joaat("HCS_PENALTY_PALETO_FUNERAL"), num4, 1);
										break;
								
									case 69:
									case 70:
										unk_0x3CC35ACFFC9C730E(joaat("HCS_PENALTY_BUREAU_FUNERAL"), num4, 1);
										break;
								
									case 84:
									case 85:
										unk_0x3CC35ACFFC9C730E(joaat("HCS_PENALTY_BIGS_FUNERAL"), num4, 1);
										break;
								}
							}
						
							func_96(&uLocal_45, 3, "HSTENDPFUN", "", num4, 0, 0, 0);
						}
					}
					else
					{
						func_97(&uLocal_45, "MISHPA", &Global_63377, 0);
					}
					...
					if (flag4 || Global_63382 && !flag3)
					{
						if (!Global_63364)
							func_67(&uLocal_45, false, 0);
				...
				if (bLocal_639 && !Global_63363)
				{
					...
					if (Global_75457 > 0 || Global_63352)
					{
						...
						if (flag && !Global_63352)
							Global_44200 = 1;
					
						if (!Global_63364)
						{
							if (func_21(&uLocal_45, false, SYSTEM::TO_FLOAT(value), 0, false, false))
								Global_63363 = true;
...
BOOL func_21(var uParam0, BOOL bParam1, float fParam2, int iParam3, BOOL bParam4, BOOL bParam5) // Position - 0xEFF
{
	...
	while (flag)
	{
		...
		{
			if (!uParam0->f_570 && uParam0->f_56 != 0 && unk_0x5FAF55B1F052A2E6(uParam0->f_4) && (float)uParam0->f_576 > (float)uParam0->f_562 + 1165 - (15000f * fParam2))
			{
				if (!uParam0->f_569)
				{
...
void func_26(var uParam0, float fParam1, int iParam2) // Position - 0x165E
{
	...
	if (num12 >= 0f)
	{
		...
		func_47();
		unk_0xD88E9AF5626B0121(0.5f, num2 - func_50(2f - 0.5f) - 0.0013888889f, num7, func_41(1f), unk, unk2, unk3, SYSTEM::ROUND(num13 * (float)num14), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_560 == 4)
		{
			if (i == uParam0->f_580 - 1)
			{
				...
				if (num12 >= 0f)
				{
					...
					num13 = func_25(num12 / (0.6f * func_50(25f)), 0f, 1f);
					func_47();
					unk_0xD88E9AF5626B0121(0.5f, num2 + func_50(2f * 0.5f), num7, func_41(1f), unk, unk2, unk3, SYSTEM::ROUND(num13 * (float)num14), 0);
					num2 = num2 + func_50(2f * 0.3f);
		...
		if (num12 >= 0f)
		{
			...
			switch (uParam0->f_560)
			{
				case 0:
					...
					unk_0x8E03B3A2F624EF8B(num16, num2 + func_50(2f * 2f), 0);
					break;
...
char* func_34(int iParam0, BOOL bParam1) // Position - 0x266B
{
	...
	if (!unk_0x2AC37494BBF1DB16(&Global_23270.f_7488[iParam0 /*16*/]))
	{
		...
		{
			unk20 = { func_36(unk_0x93E99A2DBCBA9CFA()) };
...
char* func_37(int iParam0) // Position - 0x2BB4
{
	...
	if (!unk_0x2AC37494BBF1DB16(&Global_23270.f_6463[iParam0 /*16*/]))
	{
		...
		{
			unk17 = { func_36(unk_0x93E99A2DBCBA9CFA()) };
...
void func_38(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0x2C29
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			unk_0xB978B5D428DA5DE9("CommonMenu", func_34(7, false), fParam4 - 0.006f, fParam2 + func_50(2f) + (0.25f * unk5), num2, unk5, 0f, 255, 255, 255, iParam5, 0, 0);
			num = num - ((num2 * 0.38f) + 0.006f);
			break;
	
		case 2:
			func_30(5, false, true, &num2, &unk5, false);
			unk_0xB978B5D428DA5DE9("CommonMenu", func_34(5, false), fParam4 - 0.006f, fParam2 + func_50(2f) + (0.25f * unk5), num2, unk5, 0f, 255, 255, 255, iParam5, 0, 0);
			num = num - ((num2 * 0.38f) + 0.006f);
			break;
	
		case 3:
			func_30(6, false, true, &num2, &unk5, false);
			unk_0xB978B5D428DA5DE9("CommonMenu", func_34(6, false), fParam4 - 0.006f, fParam2 + func_50(2f) + (0.25f * unk5), num2, unk5, 0f, 255, 255, 255, iParam5, 0, 0);
			num = num - ((num2 * 0.38f) + 0.006f);
			break;
	}
...
BOOL func_62() // Position - 0x36C1
{
	...
	{
		if (Global_75458[i /*9*/] > 0)
			if (Global_63587[Global_75458[i /*9*/] /*13*/].f_7 == false)
				return 1;
	}
...
void func_65() // Position - 0x3791
{
	...
	if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
	{
		if (_GET_CHARACTER_MODEL(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			...
			if (func_54(character) && !func_66(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != character && func_54(Global_113648.f_2365.f_539.f_4321))
...
void func_71() // Position - 0x3C86
{
	...
	for (i = 0; i < Global_75457; i = i + 1)
	{
		num3 = Global_75458[i /*9*/];
		flag = !Global_63587[num3 /*13*/].f_7;
		flag2 = Global_63587[num3 /*13*/].f_8;
		unk = Global_63587[num3 /*13*/].f_12;
		unk2 = Global_63587[num3 /*13*/].f_9;
		flag3 = false;
		flag3 = false;
	
		if (func_76(num3, Global_75458[i /*9*/].f_1))
			flag3 = true;
	...
	if (unk_0x67EBFCF2F78761B9())
	{
		if (Global_75607 == false)
		{
			...
			Global_113648.f_9087.f_330[num6 /*6*/].f_4 = Global_75603;
		}
		else
		{
...
void func_73(int iParam0) // Position - 0x41D3
{
	...
	{
		unk68 = { func_36(unk_0x93E99A2DBCBA9CFA()) };
...
int func_74(int iParam0) // Position - 0xB8EA
{
	...
	switch (iParam0)
	{
		...
		case 676:
			for (i = 0; i < 5; i = i + 1)
			{
				if (Global_113648.f_1.f_126[Global_63366 /*23*/].f_11[i] == 1)
					num = num + Global_113648.f_1.f_126[Global_63366 /*23*/].f_17[i];
			}
...
void func_77(var uParam0) // Position - 0xBAA3
{
	...
	for (i = 0; i < Global_75457; i = i + 1)
	{
		...
		switch (Global_75458[i /*9*/])
		{
			...
			case 41:
			case 54:
				value = Global_75458[i /*9*/].f_1;
				break;
		}
	}

	Global_75606 = iLocal_627;
	value2 = func_83(uParam0, iLocal_627, iLocal_628, flag);

	if (_IS_MISSION_REPEAT_ACTIVE(false))
	{
		unk_0xE70DF1D5EE190305(Global_75608);
		unk_0xE70DF1D5EE190305(SYSTEM::ROUND(value2));
...
void func_78(float fParam0, BOOL bParam1) // Position - 0xBC16
{
	...
	if (Global_75607)
	{
		...
		if (num < 100f)
			if (fParam0 >= 100f)
				Global_113648.f_10018.f_22 = Global_113648.f_10018.f_22 + 1;
...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBF5B
{
	...
	num3 = { Global_63587[Global_75458[iParam1 /*9*/] /*13*/] };
	...
	if (!num3.f_2 == 0)
	{
		num2 = SYSTEM::TO_FLOAT(SYSTEM::FLOOR((SYSTEM::TO_FLOAT(Global_75458[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f));
	...
	if (Global_75458[iParam1 /*9*/].f_3 == 0 || flag)
		if (num3.f_3)
			if (num4 > Global_75458[iParam1 /*9*/].f_1 || num4 < 0 || num4 == -1)
				func_90(Global_75458[iParam1 /*9*/].f_1, Global_75458[iParam1 /*9*/]);
		else if (Global_75458[iParam1 /*9*/].f_1 > num4 || num4 < 0 || num4 == -1)
			func_90(Global_75458[iParam1 /*9*/].f_1, Global_75458[iParam1 /*9*/]);

	num5 = Global_75458[iParam1 /*9*/].f_1;
	...
	str = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(Global_75458[iParam1 /*9*/]);
	...
	if (Global_75458[iParam1 /*9*/].f_3 != 0)
	{
		...
		func_96(uParam0, 6, str, str2, Global_75458[iParam1 /*9*/].f_1, 0, 3, 0);
	}
	else
	{
		iLocal_632 = 0;
		...
		{
			case 1:
				func_96(uParam0, 8, str, "", Global_75458[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 2:
				func_96(uParam0, 9, str, "", Global_75458[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 3:
				func_96(uParam0, 0, str, "", Global_75458[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
			...
			case 5:
				func_96(uParam0, 11, str, "", SYSTEM::CEIL((SYSTEM::TO_FLOAT(Global_75458[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f), 0, num6, 0);
				break;
			...
			case 8:
				num7 = Global_75458[iParam1 /*9*/].f_1;
			...
			case 9:
				func_96(uParam0, 11, str, "", SYSTEM::ROUND(Global_75458[iParam1 /*9*/].f_2), 0, num6, 0);
				break;
		
			case 10:
			case 15:
			case 16:
				func_96(uParam0, 1, str, "", Global_75458[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 11:
				func_96(uParam0, 11, str, "", Global_75458[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 14:
				func_96(uParam0, 12, str, "", Global_75458[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 12:
			case 13:
				func_96(uParam0, 3, str, "", Global_75458[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
...
void func_90(int iParam0, int iParam1) // Position - 0xD60D
{
	...
	num = Global_63587[iParam1 /*13*/].f_4;
	...
	num2 = iParam0 + 1;
	unk_0x3CC35ACFFC9C730E(num, num2, 1);

	if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_63354)
	{
		unk_0xE70DF1D5EE190305(num);
...
void func_98(int iParam0) // Position - 0xD824
{
	...
	num2 = Global_113648.f_1.f_126[iParam0 /*23*/].f_1;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		Global_113648.f_1.f_126[iParam0 /*23*/].f_17[i] = 0;
	}

	i = 0;
	num3 = 0;

	for (i = 0; i < Global_96911[iParam0 /*38*/].f_37; i = i + 1)
	{
		if (Global_96911[iParam0 /*38*/].f_31[i] > 0)
		{
			num3 = num3 + Global_96911[iParam0 /*38*/].f_31[i];
			Global_113648.f_1.f_126[iParam0 /*23*/].f_1 = Global_113648.f_1.f_126[iParam0 /*23*/].f_1 - Global_96911[iParam0 /*38*/].f_31[i];
		}
	}
	...
	if (iParam0 == 2)
	{
		num4 = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(Global_113648.f_1.f_126[iParam0 /*23*/].f_1) * 0.78f);
		func_100(iParam0, 3, num4);
		Global_113648.f_1.f_126[iParam0 /*23*/].f_1 = Global_113648.f_1.f_126[iParam0 /*23*/].f_1 - num4;
		num2 = num2 - num4;
	}

	for (i = 0; i < 5; i = i + 1)
	{
		num5 = Global_113648.f_1.f_12[num /*6*/][i];
	
		switch (Global_113648.f_1.f_126[iParam0 /*23*/].f_11[i])
		{
			case 1:
			case 2:
			case 0:
				Global_113648.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_96556[num5 /*5*/].f_1) * 0.01f * (float)Global_113648.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		
			case 3:
				Global_113648.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_96556[num5 /*5*/].f_1) * 0.015f * (float)Global_113648.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		}
	}
	...
	{
		num2 = num2 - Global_113648.f_1.f_126[iParam0 /*23*/].f_17[i];
	}
	...
	switch (iParam0)
	{
		case 0:
			...
			Global_113648.f_1.f_126[0 /*23*/].f_2[1] = SYSTEM::CEIL(0.12f * (float)Global_113648.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_113648.f_1.f_126[0 /*23*/].f_2[1];
			Global_96901.f_7 = SYSTEM::CEIL(0.14f * (float)Global_113648.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_96901.f_7;
			Global_96901.f_6 = 14f;
			Global_113648.f_1.f_126[0 /*23*/].f_2[0] = num2;
			break;
		...
		case 2:
			...
			Global_96901.f_7 = SYSTEM::CEIL(0.12f * (float)Global_113648.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_96901.f_7;
			Global_96901.f_6 = 12f;
			Global_113648.f_1.f_126[2 /*23*/].f_2[0] = num2 / 3;
			Global_113648.f_1.f_126[2 /*23*/].f_2[1] = num2 / 3;
			Global_113648.f_1.f_126[2 /*23*/].f_2[2] = num2 / 3;
			Global_96901.f_6 = 0f;
			break;
		...
		case 3:
			...
			num2 = num2 - Global_96901.f_7;
			Global_96901.f_6 = 12f;
			Global_113648.f_1.f_126[3 /*23*/].f_2[1] = num2;
			break;
		...
		case 4:
			...
			num2 = num2 - Global_96901.f_7;
			Global_96901.f_6 = 12f;
			Global_113648.f_1.f_126[4 /*23*/].f_2[0] = num2 / 3;
			Global_113648.f_1.f_126[4 /*23*/].f_2[1] = num2 / 3;
			Global_113648.f_1.f_126[4 /*23*/].f_2[2] = num2 / 3;
			Global_96901.f_6 = 0f;
			break;
	}

	value = Global_113648.f_1.f_126[iParam0 /*23*/].f_1;

	if (Global_113648.f_1.f_126[iParam0 /*23*/].f_6[0] != -1f)
		Global_113648.f_1.f_126[iParam0 /*23*/].f_6[0] = (SYSTEM::TO_FLOAT(Global_113648.f_1.f_126[iParam0 /*23*/].f_2[0]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_113648.f_1.f_126[iParam0 /*23*/].f_6[1] != -1f)
		Global_113648.f_1.f_126[iParam0 /*23*/].f_6[1] = (SYSTEM::TO_FLOAT(Global_113648.f_1.f_126[iParam0 /*23*/].f_2[1]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_113648.f_1.f_126[iParam0 /*23*/].f_6[2] != -1f)
		Global_113648.f_1.f_126[iParam0 /*23*/].f_6[2] = (SYSTEM::TO_FLOAT(Global_113648.f_1.f_126[iParam0 /*23*/].f_2[2]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_96901.f_6 != -1f)
		Global_96901.f_6 = (SYSTEM::TO_FLOAT(Global_96901.f_7) / SYSTEM::TO_FLOAT(value)) * 100f;
	...
	for (j = 0; j < 3; j = j + 1)
	{
		num6 = num6 + Global_113648.f_1.f_126[iParam0 /*23*/].f_2[j];
	}

	switch (iParam0)
	{
		case 0:
			func_99(810, Global_113648.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 1:
			...
			{
				case 3:
					func_99(610, Global_113648.f_1.f_126[iParam0 /*23*/].f_1, true);
					func_99(611, num6, true);
					break;
			
				case 4:
					func_99(622, Global_113648.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 2:
			func_99(734, Global_113648.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 4:
			...
			{
				case 8:
					func_99(664, Global_113648.f_1.f_126[iParam0 /*23*/].f_1, true);
					func_99(671, num6, true);
					break;
			
				case 9:
					func_99(674, Global_113648.f_1.f_126[iParam0 /*23*/].f_1, true);
...
void func_100(int iParam0, int iParam1, int iParam2) // Position - 0xE1CF
{
	...
	num2 = Global_96911[iParam0 /*38*/].f_37;
	i = 0;

	for (i = 0; i < num2; i = i + 1)
	{
		if (Global_96911[iParam0 /*38*/].f_25[i] == iParam1)
		{
			Global_96911[iParam0 /*38*/].f_25[i] = iParam1;
			Global_96911[iParam0 /*38*/].f_31[i] = num;
			return;
		}
	}
	...
	Global_96911[iParam0 /*38*/].f_31[Global_96911[iParam0 /*38*/].f_37] = num;
	Global_96911[iParam0 /*38*/].f_37 = Global_96911[iParam0 /*38*/].f_37 + 1;
	return;
}
...
void func_102() // Position - 0xE3AF
{
	...
	{
		if (Global_75458[i /*9*/].f_1 == 0)
			if (Global_75458[i /*9*/].f_2 != 0f)
				Global_75458[i /*9*/].f_1 = SYSTEM::FLOOR(Global_75458[i /*9*/].f_2);
	
		num = Global_75458[i /*9*/];
	
		if (num > 0)
		{
			if (Global_63587[num /*13*/] == 9)
				Global_75458[i /*9*/].f_1 = SYSTEM::ROUND(fLocal_634);
		
			if (Global_63587[num /*13*/] == 15)
				Global_75458[i /*9*/].f_1 = iLocal_635;
		}
	}
...
void func_103() // Position - 0xE456
{
	...
	value = 0;
	value2 = 0;
	value = func_7(joaat("SP0_SHOTS")) - Global_63385;
	value2 = func_7(joaat("SP0_HITS")) - Global_63384;
	value = value + (func_7(joaat("SP1_SHOTS")) - Global_63387);
	value2 = value2 + (func_7(joaat("SP1_HITS")) - Global_63386);
	value = value + (func_7(joaat("SP2_SHOTS")) - Global_63389);
	value2 = value2 + (func_7(joaat("SP2_HITS")) - Global_63388);
	SYSTEM::WAIT(0);
	num = 100f;
...
void func_107() // Position - 0xE5B1
{
	...
	if (flag)
		iLocal_626 = SYSTEM::ROUND(unk_0x290D4E218346D595() * 1000f);
	...
	for (i = 0; i < Global_75457; i = i + 1)
	{
		if (Global_75458[i /*9*/] >= 0)
		{
			num2 = Global_63587[Global_75458[i /*9*/] /*13*/];
		
			switch (num2)
			{
				case 6:
					if (Global_75458[i /*9*/].f_6 != 0)
					{
						if (Global_75458[i /*9*/].f_7 == 1)
						{
							Global_75458[i /*9*/].f_8 = 0;
							Global_75458[i /*9*/].f_1 = 0;
							Global_75458[i /*9*/].f_7 = 0;
						}
						else if (unk_0x7DE17ACDD8BA2642(Global_75458[i /*9*/].f_6))
						{
							if (!unk_0x055111B11E6624FD(Global_75458[i /*9*/].f_6, 0))
							{
								iLocal_630 = Global_75458[i /*9*/].f_8;
								uLocal_629 = unk_0x2935B4D6CE81318D(Global_75458[i /*9*/].f_6);
								iLocal_631 = iLocal_630 - uLocal_629;
							
								if (iLocal_631 > 0)
								{
									Global_75458[i /*9*/].f_1 = Global_75458[i /*9*/].f_1 + iLocal_631;
								
									if (Global_75458[i /*9*/].f_1 < 0)
										Global_75458[i /*9*/].f_1 = Global_75458[i /*9*/].f_1 * -1;
								}
							
								Global_75458[i /*9*/].f_8 = uLocal_629;
							}
						}
						else
						{
							Global_75458[i /*9*/].f_6 = 0;
						}
					}
					break;
			
				case 1:
					Global_75458[i /*9*/].f_1 = Global_75458[i /*9*/].f_1 + iLocal_626;
					break;
				...
				case 4:
					if (Global_63370)
						if (Global_63372 == -1 || Global_75458[i /*9*/] == Global_63372)
							if (Global_75458[i /*9*/] == 339 || Global_75458[i /*9*/] == 179 || Global_75458[i /*9*/] == 342 || Global_75458[i /*9*/] == 234)
								Global_75458[i /*9*/].f_1 = Global_75458[i /*9*/].f_1 + SYSTEM::ROUND(unk_0x290D4E218346D595() * 1000f);
							else
								Global_75458[i /*9*/].f_1 = Global_75458[i /*9*/].f_1 + iLocal_626;
					break;
				...
				case 5:
					if (flag2)
					{
						if (Global_63374 == -1 || Global_63374 == Global_75458[i /*9*/])
						{
							if (!Global_63373 == 0)
							{
								if (unk_0x7DE17ACDD8BA2642(Global_63373))
								{
									if (!unk_0x055111B11E6624FD(Global_63373, 0))
									{
										...
										{
											num = unk_0xDC58AE028CB223BA(Global_63373);
										
											if (num > Global_75458[i /*9*/].f_2)
												Global_75458[i /*9*/].f_2 = num;
										}
									}
								}
							}
...
void func_108() // Position - 0xE98C
{
	...
	if (Global_63391 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			...
			{
				if (!unk_0x7DE17ACDD8BA2642(Global_63392[i /*2*/]))
				{
					Global_63392[i /*2*/] = 0;
	...
	{
		num2 = unk_0xB09B723333956A0B(0, i);
	
		switch (num2)
		{
			case 142:
				unk_0x11DE375695504B75(0, i, &num3, 1);
			
				if (unk_0x7DE17ACDD8BA2642(num3))
				{
					unk_0x055111B11E6624FD(num3, 0);
				
					if (Global_63521 > 0)
					{
						unk2 = unk_0x504B9BB48D41C264(num3);
						j = 0;
					
						for (j = 0; j < Global_63521; j = j + 1)
						{
							if (Global_63522[j /*2*/] == unk2)
								num6 = num6 + Global_63522[j /*2*/].f_1;
						}
					}
				
					if (unk_0x71904BD37B848CAF(num3) && unk_0x9C8D7679C15E75FF(num3) != unk_0xC1A5EC5C986B98AD())
					{
						unk = unk_0xECEBAC41E869D431(unk_0x9C8D7679C15E75FF(num3));
						flag2 = false;
						...
						if (unk_0x7DE17ACDD8BA2642(unk))
						{
							if (unk_0xA6B591D40DE982B5(unk))
							{
								...
								if (unk_0x7DE17ACDD8BA2642(unk4) && unk_0x4DFB7A1A6909D574(unk) == unk4)
									flag2 = true;
							}
						}
					
						if (unk_0x71904BD37B848CAF(unk) && unk_0xF2CFBB1105511E1A(unk_0x5DC3DCA82C806319()) == unk_0x9C8D7679C15E75FF(unk) || flag2)
						{
							if (unk_0x71904BD37B848CAF(unk))
							{
								num4 = unk_0x2E33D53F4F17ACFE(unk_0x9C8D7679C15E75FF(num3));
								...
								if (Global_63391 > 0)
								{
									...
									if (num7 != -1)
									{
										unk_0x57E9EADBC4B5BB53(unk_0x9C8D7679C15E75FF(Global_63392[num7 /*2*/]), &iLocal_633);
								...
								if (Global_75653 > 0)
								{
									...
									for (j = 0; j < Global_75653; j = j + 1)
									{
										if (Global_75644[j /*2*/] == num4)
											func_99(Global_75644[j /*2*/].f_1, 1, false);
									}
								}
							}
							...
							if (Global_75609)
							{
								unk3 = unk_0x9C8D7679C15E75FF(num3);
								num8 = unk_0x1D9AC8866737E55F(unk3);
							
								if (!unk_0x1AFE963DA61006ED(num3) && !num8 == 22 && !num8 == 19 && !num8 == 17 && !num8 == 18 && !num8 == 27 && !num8 == 29 && !num8 == 28)
								{
									num5 = unk_0xFA097DD8F281D1CF(unk_0xF2CFBB1105511E1A(unk_0x5DC3DCA82C806319()), unk_0x9C8D7679C15E75FF(num3));
									...
									switch (num5)
									{
										...
										case 1:
										case 2:
											if (unk_0xF57206F53DF095CE(unk_0x9C8D7679C15E75FF(num3)))
												func_110();
											break;
							...
							if (Global_75643 > 0)
							{
								...
								while (!flag)
								{
									if (Global_75610[j /*2*/] != 0)
									{
										if (unk_0x7DE17ACDD8BA2642(Global_75610[j /*2*/]))
										{
											if (unk_0x055111B11E6624FD(Global_75610[j /*2*/], 0))
											{
												if (Global_75610[j /*2*/] == num3)
												{
													func_99(Global_75610[j /*2*/].f_1, 1, false);
													Global_75610[j /*2*/] = 0;
												}
											}
										}
...
void func_113() // Position - 0xEEC7
{
	...
	if (unk_0xE629340FA146D999())
	{
		if (unk_0x4DB2400F16D217C5() == 33)
		{
			if (unk_0x0299EA6A9023B0DE() == 33)
			{
				...
				if ((num - 4) % 3 == 0)
				{
					...
					for (i = 0; i < num; i = i + 1)
					{
						num3 = unk_0x5B05FB91524EB58B((i * 3) + 1);
						num4 = unk_0x5B05FB91524EB58B((i * 3) + 2);
					...
					unk = unk_0x5B05FB91524EB58B(num2);
					value2 = unk_0x5B05FB91524EB58B(num2 + 1);
					flag = false;
				
					if (unk_0x5B05FB91524EB58B(num2 + 2) > 0)
						flag = true;
				
					flag2 = 0;
				
					if (unk_0x5B05FB91524EB58B(num2 + 3) > 0)
						flag2 = 1;
		...
		if (unk_0x4DB2400F16D217C5() == 13)
		{
			...
			{
				num5 = unk_0x9FFBA65DDAB93B4F();
			
				if (num5 == 3)
				{
					num6 = unk_0x5B05FB91524EB58B(0);
					unk2 = unk_0x5B05FB91524EB58B(1);
					unk3 = unk_0x5B05FB91524EB58B(2);
					Global_113648.f_2354[num6 /*2*/] = unk2;
					Global_113648.f_2354[num6 /*2*/].f_1 = unk3;
					func_114();
				}
			}
		}
