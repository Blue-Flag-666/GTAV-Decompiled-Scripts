...
void main() // Position - 0x0
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		else if (MISC::ARE_STRINGS_EQUAL(&(Global_113810.f_14054[Global_20500 /*20*/].f_11), &Global_9175[Global_20500 /*2811*/][1 /*281*/].f_144[i /*6*/]))
		{
			Global_9175[Global_20500 /*2811*/][1 /*281*/].f_259 = i;
		}
	}
	...
	if (Global_78689)
	{
		...
		TEXT_LABEL_ASSIGN_STRING(&(Global_9175[3 /*2811*/][0 /*281*/].f_2), "CELL_701" /*Snapmatic*/, 16);
		Global_9175[3 /*2811*/][0 /*281*/].f_6 = 19;
		Global_9175[3 /*2811*/][0 /*281*/].f_280 = 1;
		TEXT_LABEL_ASSIGN_STRING(&Global_9175[3 /*2811*/][0 /*281*/].f_7[0 /*4*/], "CELL_704" /*Quick launch Off*/, 16);
		Global_9175[3 /*2811*/][0 /*281*/].f_124[0] = 1;
		Global_9175[3 /*2811*/][0 /*281*/].f_84[0] = 170;
		Global_9175[3 /*2811*/][0 /*281*/].f_104[0] = 19;
		TEXT_LABEL_ASSIGN_STRING(&Global_9175[3 /*2811*/][0 /*281*/].f_7[1 /*4*/], "CELL_703" /*Quick launch On*/, 16);
		Global_9175[3 /*2811*/][0 /*281*/].f_124[1] = 1;
		Global_9175[3 /*2811*/][0 /*281*/].f_84[1] = 175;
		Global_9175[3 /*2811*/][0 /*281*/].f_104[1] = 19;
		TEXT_LABEL_ASSIGN_STRING(&Global_9175[3 /*2811*/][0 /*281*/].f_7[2 /*4*/], "CELL_801" /*Sleep Mode*/, 16);
			...
			switch (Global_20500.f_1)
			{
				...
				case 8:
					...
					else
					{
						...
						if (func_10(FRONTEND_CONTROL, Global_20468, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
								AUDIO::STOP_PED_RINGTONE(PLAYER::PLAYER_PED_ID());
...
void func_12() // Position - 0x890
{
	...
	if (iLocal_41 == 1)
	{
		...
		if (func_10(FRONTEND_CONTROL, Global_20476, 0) || func_10(FRONTEND_CONTROL, Global_20477, 0) || bLocal_49 || iLocal_63 == 1 || iLocal_64 == 1)
		{
			iLocal_63 = 0;
			iLocal_64 = 0;
			bLocal_49 = false;
	...
	if (Global_20478 == 0)
	{
		if (func_10(FRONTEND_CONTROL, Global_20469, 0))
		{
			func_24();
			Global_20478 = 1;
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20481, "GET_CURRENT_SELECTION");
			...
			Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_259 = uLocal_16[iLocal_44];
		
			if (iLocal_41 == 2)
			{
				num = Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_259;
				Global_113810.f_14054[Global_20500 /*20*/].f_6 = Global_9175[Global_20500 /*2811*/][2 /*281*/].f_260[num];
				...
				if (Global_78689)
				{
					...
					func_20(2030, Global_9175[3 /*2811*/][2 /*281*/].f_259, -1, true);
				...
				func_19();
				func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_43), SYSTEM::TO_FLOAT(23), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[uLocal_16[iLocal_43] /*4*/], 0, 0, 0, 0);
				func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(48), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[uLocal_16[iLocal_44] /*4*/], 0, 0, 0, 0);
				iLocal_43 = iLocal_44;
			...
			if (iLocal_41 == 4)
			{
				...
				if (Global_78689)
				{
					...
					func_20(2029, Global_9175[3 /*2811*/][4 /*281*/].f_259, -1, true);
			...
			if (iLocal_41 == 1)
			{
				...
				if (Global_78689)
					func_20(1199, Global_9175[3 /*2811*/][1 /*281*/].f_259, -1, true);
			
				func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_43), SYSTEM::TO_FLOAT(18), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[uLocal_16[iLocal_43] /*4*/], 0, 0, 0, 0);
				func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(48), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[uLocal_16[iLocal_44] /*4*/], 0, 0, 0, 0);
				iLocal_43 = iLocal_44;
				func_47(Global_20481, "DISPLAY_VIEW", 22f, SYSTEM::TO_FLOAT(iLocal_44), -1082130432, -1082130432, -1082130432);
			}
			...
			if (iLocal_41 == 3)
			{
				...
				if (Global_78689)
					func_20(1198, Global_113810.f_14054[3 /*20*/].f_10, -1, true);
			...
			if (iLocal_41 == 0)
			{
				...
				{
					Global_9175[3 /*2811*/][iLocal_41 /*281*/].f_259 = uLocal_16[iLocal_44];
					func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_43), SYSTEM::TO_FLOAT(19), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[uLocal_16[iLocal_43] /*4*/], 0, 0, 0, 0);
					func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(48), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[uLocal_16[iLocal_44] /*4*/], 0, 0, 0, 0);
					iLocal_43 = iLocal_44;
					func_47(Global_20481, "DISPLAY_VIEW", 22f, SYSTEM::TO_FLOAT(iLocal_44), -1082130432, -1082130432, -1082130432);
					func_20(2092, Global_9175[3 /*2811*/][iLocal_41 /*281*/].f_259, -1, true);
				}
				else
				{
					Global_9175[0 /*2811*/][iLocal_41 /*281*/].f_259 = uLocal_16[iLocal_44];
					Global_9175[1 /*2811*/][iLocal_41 /*281*/].f_259 = uLocal_16[iLocal_44];
					Global_9175[2 /*2811*/][iLocal_41 /*281*/].f_259 = uLocal_16[iLocal_44];
...
Hash func_21(int iParam0, int iParam1) // Position - 0x1546
{
	return _GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_22(iParam1));
}

int func_22(int iParam0) // Position - 0x155B
{
	int num;
	int num2;
...
void func_28() // Position - 0x16ED
{
	...
	if (Global_78689)
	{
		TEXT_LABEL_ASSIGN_STRING(&Global_9175[3 /*2811*/][4 /*281*/].f_7[0 /*4*/], "CELL_CREWEMB" /*Crew Emblem*/, 16);
		gamerHandle = { GET_GAMER_HANDLE_PLAYER(PLAYER::PLAYER_ID()) };
	
		if (!NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&gamerHandle))
			TEXT_LABEL_ASSIGN_STRING(&Global_9175[3 /*2811*/][4 /*281*/].f_7[0 /*4*/], "CELL_840" /*Default*/, 16);
	}
	...
	while (value < 19)
	{
		num = 0;
		num2 = 18;
		Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_84[num2] = 5000;
	
		while (num < 19)
		{
			if (Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_124[num] == 1)
			{
				if (unk[num] == 0)
				{
					if (Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_84[num] < Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_84[num2])
					{
						num2 = num;
						func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(value), SYSTEM::TO_FLOAT(Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_104[num2]), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[num2 /*4*/], 0, 0, 0, 0);
					}
				}
			}
		...
		if (MISC::ARE_STRINGS_EQUAL(&Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_259 /*4*/], &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[num2 /*4*/]))
		{
			iLocal_46 = value;
			...
			{
				func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(value), SYSTEM::TO_FLOAT(48), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[num2 /*4*/], 0, 0, 0, 0);
				iLocal_43 = value;
			}
		
			if (iLocal_41 == 0 && Global_78689 == true)
			{
				func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(value), SYSTEM::TO_FLOAT(48), -1f, -1f, &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[num2 /*4*/], 0, 0, 0, 0);
				iLocal_43 = value;
			}
		...
		if (Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_124[value] == 1)
	...
	if (Global_20488)
	{
		func_18(Global_20481, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
		func_18(Global_20481, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
	}
	else
	{
...
void func_29() // Position - 0x1A32
{
	...
	if (bLocal_60 == false)
	{
		if (func_10(FRONTEND_CONTROL, Global_20476, 0))
		{
			if (iLocal_38 > 0)
				iLocal_38 = iLocal_38 - 1;
		...
		if (func_10(FRONTEND_CONTROL, Global_20477, 0))
		{
			iLocal_38 = iLocal_38 + 1;
...
void func_34() // Position - 0x1B9F
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		num = 0;
		num2 = 9;
		Global_9175[Global_20500 /*2811*/][num2 /*281*/] = 5000;
		...
		while (num < 9)
		{
			if (Global_9175[Global_20500 /*2811*/][num /*281*/].f_280 == 1)
			{
				if (unk[num] == 0)
				{
					if (Global_9175[Global_20500 /*2811*/][num /*281*/] < Global_9175[Global_20500 /*2811*/][num2 /*281*/])
					{
						if (Global_78689)
						{
							if (num == 0)
							{
								num2 = num;
								func_43(num, num2);
								func_18(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(iLocal_47), -1f, -1f, &(Global_9175[Global_20500 /*2811*/][num2 /*281*/].f_2), 0, 0, 0, 0);
							}
							else
							{
								num2 = num;
		...
		if (Global_9175[Global_20500 /*2811*/][i /*281*/].f_280 == 1)
			iLocal_37 = iLocal_37 + 1;
	}

	func_47(Global_20481, "DISPLAY_VIEW", 13f, SYSTEM::TO_FLOAT(iLocal_42), -1082130432, -1082130432, -1082130432);
	func_13(Global_20481, "SET_HEADER", "CELL_16" /*Settings*/, 0, 0, 0, 0);
...
BOOL func_39(eCharacter echParam0) // Position - 0x1FC5
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1FD1
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x200E
{
...
Hash func_42(eCharacter echParam0) // Position - 0x2033
{
...
void func_47(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x21BC
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
