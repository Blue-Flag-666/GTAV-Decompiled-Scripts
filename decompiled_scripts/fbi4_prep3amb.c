...
void func_133()
{
	...
	else if (func_137() == -1)
	{
		...
		{
			if (!func_78(PLAYER::PLAYER_PED_ID(), Local_106, 5f))
			{
				if (func_135())
				{
...
void func_177()
{
	if ((BitTest(uLocal_105, 0) && Global_42602 == 15) && !func_209())
	{
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_105, 1))
			...
			{
				if (!func_78(PLAYER::PLAYER_PED_ID(), Local_106, 10f))
				{
					Local_106 = { 0f, 0f, 0f };
					MISC::CLEAR_BIT(&uLocal_105, true);
					MISC::CLEAR_BIT(&uLocal_105, 20);
...
int func_189(struct<3> Param0)
{
	...
	fVar0 = SYSTEM::VDIST2(Param0, Global_95119[func_190(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_190(struct<3> Param0, bool bParam3)
{
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_95119[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, Global_95119[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_191(struct<3> Param0)
{
	...
	fVar0 = SYSTEM::VDIST2(Param0, Global_95183[func_192(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_203()
{
	...
	fVar1 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_95018[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
void func_210()
{
	...
	if ((Global_42602 == 15 && iLocal_38 == 0) && !func_209())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!BitTest(uLocal_105, 0))
		...
		case 1:
			if ((MISC::GET_GAME_TIMER() - Local_204[iLocal_1265 /*261*/].f_259) > 500)
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_1263) && !MISC::IS_STRING_NULL_OR_EMPTY(Local_204[iLocal_1265 /*261*/][iLocal_1264 /*8*/]))
				{
					...
					{
						MISC::CLEAR_BIT(&(Local_204[iLocal_1265 /*261*/].f_258), bLocal_1264);
					}
				}
				else
				{
...
void func_224()
{
	...
	if (((((((Global_42602 == 15 && iLocal_37 != 3) && BitTest(uLocal_105, 5)) && !func_209()) && Global_77855 == -1) && !func_234()) && !func_86(9)) || func_105(35))
	{
		func_233();
		func_231();
		switch (iLocal_39)
	...
	else if (((((((Global_42602 != 15 || Global_42602 != 0) || Global_42602 != 2) || Global_42602 != 4) || Global_42602 != 17) || func_209()) || Global_77855 == -1) || Global_111977)
	{
		bVar1 = false;
		if (func_134())
		{
...
int func_242()
{
	if (((((Global_42602 == 15 && !func_209()) && Global_77855 == -1) && !func_134()) && !func_243(1112014848)) && !Global_111977)
	{
		return 1;
	}
	return 0;
...
int func_248(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		iVar0 = Global_2822371[iParam0 /*3*/][func_249(iParam1)];
