...
void main() // Position - 0x0
{
	...
	if (!func_269(&unk64, &num, unk61, 1f))
	{
		func_268();
	...
	while (true)
	{
		...
		if (num == 44)
		{
			func_192(&num, unk61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_191();
		}
		else if (num == 45)
		{
			func_192(&num, unk61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_189(&num);
		}
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x38C1
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x38FE
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x393E
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396A
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB3
{
	eCharacter character;
...
BOOL func_60(int iParam0) // Position - 0x4595
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x4636
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CAB
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x646E
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x64B5
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6520
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x6581
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x6925
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6935
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7431
{
...
BOOL func_81(Player plParam0) // Position - 0x745B
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x755D
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x75F2
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x8290
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x8312
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x836A
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x8617
{
...
int func_102(int iParam0) // Position - 0x8B53
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B75
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8B8C
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8C4A
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8CE8
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8D2A
{
...
BOOL func_118(Any* panParam0) // Position - 0xA7BD
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAB30
{
...
BOOL func_131(var uParam0) // Position - 0xABE0
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAC00
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL func_133(int iParam0) // Position - 0xAC21
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135(int iParam0) // Position - 0xACF1
{
	switch (iParam0)
	{
		case 5:
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAD44
{
	int i;
...
BOOL func_137(int iParam0) // Position - 0xAE39
{
	switch (iParam0)
	{
		case 5:
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAEE3
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xB04A
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB0D6
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB123
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB1A0
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB244
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB2D3
{
...
void func_155(var uParam0) // Position - 0xB46B
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_161(int iParam0) // Position - 0xB627
{
	if (iParam0 == 1)
...
BOOL func_163(int iParam0) // Position - 0xB68D
{
...
BOOL func_164(int iParam0) // Position - 0xB6CE
{
	int num;
...
int func_166(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB745
{
	int i;
...
void func_167(int iParam0, int iParam1) // Position - 0xB87C
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB8CB
{
	return func_169(iParam0, Global_43257);
}

BOOL func_169(int iParam0, int iParam1) // Position - 0xB8DC
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_170(int iParam0) // Position - 0xBABD
{
	if (Global_43257 == 15)
		return false;
...
int func_172(var uParam0, int iParam1) // Position - 0xBAF0
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBB39
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
BOOL func_174(var uParam0, int iParam1) // Position - 0xBB5D
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_176(var uParam0) // Position - 0xC35C
{
	float num;
...
void func_177(int iParam0, var uParam1) // Position - 0xC3EA
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_178(BOOL bParam0) // Position - 0xC44E
{
	var unk;
...
BOOL func_179(var uParam0) // Position - 0xC4E5
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_180(int iParam0) // Position - 0xC50F
{
	eCharacter character;
...
BOOL func_181() // Position - 0xCC2C
{
	return Global_100720.f_1;
}

BOOL func_182() // Position - 0xCC3A
{
	if (Global_97603 != -1)
...
BOOL func_186(int iParam0, int iParam1) // Position - 0xCCB2
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_187() // Position - 0xCCEA
{
	return Global_1575060;
}

BOOL func_188() // Position - 0xCCF6
{
	if (!unk_0xA26A9A07F761D8F8())
...
void func_189(var uParam0) // Position - 0xCD12
{
	var unk;
	float num;
	float num2;
	...
	if (unk_0xA5E11AF0A2B928C1() - uLocal_98 > 1250)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !unk_0x865259F0333CAA4B(uParam0->f_28[0]))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && !func_190(unk_0xC1A5EC5C986B98AD(), uParam0->f_28[0], 50f, 1))
			{
				unk = { unk_0x30BE8A934C020461(uParam0->f_28[0], 1) };
				num = { unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1) };
				num3 = num - unk;
				num4 = num.f_1 - unk.f_1;
			
				if (num4 != 0f)
					num2 = unk_0x360118B65D6530C6(num3, num4);
				else if (num3 < 0f)
					num2 = -90f;
				else
					num2 = 90f;
		...
		uLocal_98 = unk_0xA5E11AF0A2B928C1();
	}

	return;
}

BOOL func_190(var uParam0, var uParam1, float fParam2, int iParam3) // Position - 0xCDFB
{
...
void func_191() // Position - 0xCE1D
{
	...
	unk_0x9FD96C5DE6EDFC15(uLocal_96, "SET_COLOUR");
	...
	unk_0x9FD96C5DE6EDFC15(uLocal_96, "SET_DISTANCE");
	unk_0xC49D258FBF3BF214(10f);
	unk_0xAE3413B0654A0035();
	unk_0x70546D13E82214E2(uLocal_97);
	num = 0.1f;
	num2 = 0.24f;
	num3 = 0.21f;
	num4 = 0.51f;
	...
	unk_0x20C68F87D0FDD976(uLocal_96, num, num2, num3, num4, 100, 100, 100, 255, 0);

	if (unk_0xA5E11AF0A2B928C1() - uLocal_98 > 1250)
	{
		unk_0x4473578485E594D7(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		uLocal_98 = unk_0xA5E11AF0A2B928C1();
	}
...
int func_192(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xCF0F
{
	var unk;
	...
	if (!*uParam8 == 3)
	{
		if (func_180(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && func_199(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < 20f)
				{
			...
			if (func_199(unk_0xC1A5EC5C986B98AD(), uParam1, 1) < 20f && *uParam8 == 1)
			{
...
BOOL func_194(char* sParam0) // Position - 0xD03E
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD082
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD113
{
...
float func_199(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD1AE
{
	var unk;
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD1E8
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
...
void func_203(var uParam0, int iParam1) // Position - 0xD34E
{
	BOOL flag;
	int i;
...
void func_205(var uParam0) // Position - 0xD3F8
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD40F
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD51F
{
	var unk;
	...
	if (func_245(*panParam0) || func_243(*panParam0) || Global_78804 == 1)
		return true;
...
void func_209(int iParam0, var uParam1, int iParam2) // Position - 0xD78F
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_211(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_210(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_211(uParam1) && uParam1->f_4 == 0 && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_210(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_210(int iParam0) // Position - 0xDAE7
{
...
BOOL func_211(var uParam0) // Position - 0xDB07
{
...
BOOL func_212(var uParam0) // Position - 0xDB1F
{
...
void func_214(var uParam0) // Position - 0xDE48
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDEF3
{
	int i;
	int num;
	var unk;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[i]))
							{
...
BOOL func_217(var uParam0, var uParam1) // Position - 0xE0B1
{
	var unk;
...
BOOL func_218(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE0E1
{
	int i;
	int num;
...
BOOL func_219(int iParam0) // Position - 0xE39D
{
...
BOOL func_220(var uParam0, int iParam1) // Position - 0xE3D1
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_231(uParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), uParam0))
		{
...
BOOL func_221(var uParam0, int iParam1) // Position - 0xE447
{
	return func_222(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_222(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE45F
{
	BOOL flag;
	var unk;
	int num;

	num = func_230(uParam0, uParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam1))
	{
		if (num != -1)
			func_229(&iLocal_37[num /*4*/]);
	
		return false;
	}

	if (!func_226(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_223(&iLocal_37[num /*4*/], unk, uParam1, &(iLocal_37[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0xA5E11AF0A2B928C1() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_223(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE520
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_224(var uParam0, int iParam1) // Position - 0xE64C
{
	int num;
...
BOOL func_226(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE75B
{
	var unk;
	var unk4;
	float num;

	unk = { func_228(unk_0x30BE8A934C020461(uParam1, 1) - unk_0x30BE8A934C020461(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_228(unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_227(unk4, unk);
...
float func_227(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE7EC
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_228(float fParam0, var uParam1, var uParam2) // Position - 0xE80D
{
	float num;
	float num2;
...
int func_230(var uParam0, var uParam1) // Position - 0xE867
{
	int i;
...
int func_231(var uParam0) // Position - 0xE8A6
{
...
BOOL func_232(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8CE
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0xC1A5EC5C986B98AD()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_236(uParam0, bParam1, num, num2))
				return true;
		
			if (func_233(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_233(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9C9
{
	float num;
	float num2;
...
BOOL func_234(var uParam0, float fParam1) // Position - 0xEAD5
{
	var unk;
	var unk2;
	...
	if (unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0x96E845EE39BF3453(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_235(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_235(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB6A
{
	var unk;
	var unk4;
	float num;

	unk = { func_228(uParam1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
BOOL func_236(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEBF8
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_237(int iParam0) // Position - 0xEC40
{
...
void func_238(var uParam0) // Position - 0xEC8A
{
	var unk;
...
BOOL func_239(int iParam0) // Position - 0xED27
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_240(int iParam0) // Position - 0xEDBC
{
...
BOOL func_243(int iParam0) // Position - 0xEE3B
{
...
BOOL func_245(int iParam0) // Position - 0xEEAD
{
...
{
	uLocal_96 = unk_0x2B4645565204EA06("digiscanner");

	while (!unk_0x5FAF55B1F052A2E6(uLocal_96))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (unk_0xD0D0D5AD7BA7BF17("digiscanner"))
		uLocal_97 = unk_0xFEAECD5283AE299E("digiscanner");

	uLocal_99 = unk_0x9F2C1BA4F2BF5CF8();
	uLocal_98 = unk_0xA5E11AF0A2B928C1();
	return;
}

BOOL func_248(var uParam0) // Position - 0xEF4B
{
	switch (*uParam0)
	{
		case 44:
...
BOOL func_249(var uParam0) // Position - 0xEF92
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_256(&num) || !func_255(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_252(&uParam0->f_28[0], CHAR_OMEGA, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
					flag = false;
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
				func_250(&uParam0->f_35[0], num[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
...
void func_250(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF161
{
	func_251(uParam0);
...
void func_251(var uParam0) // Position - 0xF1A3
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL func_252(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF23F
{
...
BOOL func_253(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF29B
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_292(echParam1);
...
int func_254(var uParam0, eCharacter echParam1) // Position - 0xF329
{
	int num;
...
BOOL func_255(var uParam0) // Position - 0xF36F
{
	if (func_212(uParam0))
	{
...
BOOL func_256(var uParam0) // Position - 0xF399
{
	int i;
...
BOOL func_258(var uParam0) // Position - 0xF406
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_252(&uParam0->f_28[0], CHAR_OMEGA, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
					flag = false;
...
BOOL func_259(int iParam0) // Position - 0xF68A
{
	var unk;
	eCharacter character;
...
BOOL func_260(int iParam0) // Position - 0xF6DB
{
	var unk;
...
BOOL func_261(int iParam0) // Position - 0xF794
{
	var unk;
...
BOOL func_262(int iParam0) // Position - 0xF855
{
	int i;
	var unk;
	int num;
...
BOOL func_264(int iParam0) // Position - 0xF9BC
{
...
BOOL func_265(int iParam0) // Position - 0xF9E7
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_266(int iParam0) // Position - 0xFA12
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_267(int iParam0) // Position - 0xFA3D
{
	if (func_240(iParam0))
		return false;
	else if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_269(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFA8C
{
	int i;
...
BOOL func_270(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFAF1
{
	int num;
	char* str;
...
BOOL func_271(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFB69
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_272(var uParam0, BOOL bParam1) // Position - 0xFBE4
{
	char* str;
	...
	if (bParam1)
	{
		...
		if (*uParam0 == 44 && unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
			unk_0xC621CC7313639986(&uParam0->f_41[1]);
...
void func_280(var uParam0, BOOL bParam1) // Position - 0xFDAA
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_283(var uParam0) // Position - 0xFE34
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_286(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFEBF
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_287(var uParam0) // Position - 0xFF0F
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
void func_288(int iParam0) // Position - 0xFF50
{
	if (*iParam0 == -1)
		return;
...
int func_292(eCharacter echParam0) // Position - 0xFFEC
{
	if (!func_36(echParam0))
