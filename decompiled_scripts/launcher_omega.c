...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_204(Var0.f_0);
		func_197(&iLocal_93, &(Var0.f_9), Var61);
		if (Var0.f_0 == 44)
		{
			func_189(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_188();
		}
		else if (Var0.f_0 == 45)
		{
			func_189(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_186(&Var0);
		}
		if (func_171(&Var0, 0))
		{
...
bool func_187(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
...
int func_205(int iParam0, bool bParam1)
{
	...
	func_112(*iParam0, &Var0);
	if ((func_242(*iParam0) || func_240(*iParam0)) || Global_78103 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_241() && Global_99980.f_11 == 6) && iParam0 == func_169(&(Global_99980.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_248(iParam0);
