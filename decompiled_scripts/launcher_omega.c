...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (num == 44)
		{
			func_192(&num, vector, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_191();
		}
		else if (num == 45)
		{
			func_192(&num, vector, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_189(&num);
		}
...
void func_53(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396A
{
	eCharacter character;
...
void func_54(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB3
{
	eCharacter character;
...
void func_58(Ped pedParam0, BOOL bParam1) // Position - 0x421A
{
	eCharacter character;
...
void func_59(Ped pedParam0, var uParam1) // Position - 0x430D
{
	int i;
	int j;
	Hash k;
...
Hash func_62(Hash hParam0, int iParam1) // Position - 0x4810
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_63(Hash hParam0, Any* panParam1) // Position - 0x5471
{
	int i;
	int numDlcWeapons;
...
Hash func_64(int iParam0) // Position - 0x54AC
{
	int num;
...
void func_65(Ped pedParam0) // Position - 0x5720
{
	eCharacter character;
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CAB
{
...
int func_76(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6935
{
	int i;
...
int func_93(Player plParam0) // Position - 0x85FA
{
...
void func_122(Ped pedParam0) // Position - 0xA95B
{
	int num;
	int num2;
	int num3;
...
int func_124(Ped pedParam0) // Position - 0xAA37
{
	int i;
...
int func_130(Ped pedParam0) // Position - 0xAB97
{
	int i;
...
BOOL func_131(Ped pedParam0) // Position - 0xABE0
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC00
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_136(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAD44
{
	int i;
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAEE3
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(Player player, int bCheckTeam) // Position - 0xB04A
{
	BOOL flag;
...
BOOL func_143(Player plParam0) // Position - 0xB0D6
{
...
int func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB123
{
	int num;
...
BOOL func_148(const char* sParam0) // Position - 0xB1A0
{
...
BOOL func_154(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB2D3
{
...
void func_155(Vehicle veParam0) // Position - 0xB46B
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_172(const char* sParam0, int iParam1) // Position - 0xBAF0
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_179(Vehicle veParam0) // Position - 0xC4E5
{
...
void func_189(var uParam0) // Position - 0xCD12
{
	...
	if (MISC::GET_GAME_TIMER() - iLocal_98 > 1250)
	{
		...
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && !func_190(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 50f, true))
			{
...
BOOL func_190(Ped pedParam0, Entity eParam1, float fParam2, BOOL bParam3) // Position - 0xCDFB
{
...
void func_191() // Position - 0xCE1D
{
	...
	NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(plLocal_96, "SET_COLOUR");
	...
	NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(plLocal_96, "SET_DISTANCE");
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE(plLocal_96, x, y, width, height, 100, 100, 100, 255, 0);
...
int func_192(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xCF0F
{
	...
	if (!*uParam8 == 3)
	{
		if (func_180(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && func_199(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
				{
			...
			if (func_199(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f && *uParam8 == 1)
			{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD113
{
...
float func_199(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD1AE
{
...
void func_200(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD1E8
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD78F
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_214(Object* pobParam0) // Position - 0xDE48
{
...
BOOL func_217(Ped pedParam0, Vehicle veParam1) // Position - 0xE0B1
{
...
BOOL func_220(Ped pedParam0, int iParam1) // Position - 0xE3D1
{
	float xSize;
...
BOOL func_221(Ped pedParam0, int iParam1) // Position - 0xE447
{
	return func_222(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_222(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE45F
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_223(&iLocal_37[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_37[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_37[num /*4*/].f_3 < iParam4;
}

BOOL func_223(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE520
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_224(Ped pedParam0, int iParam1) // Position - 0xE64C
{
...
BOOL func_226(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE75B
{
	var unk;
...
int func_230(Ped pedParam0, Ped pedParam1) // Position - 0xE867
{
	int i;
...
BOOL func_231(Ped pedParam0) // Position - 0xE8A6
{
...
BOOL func_232(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8CE
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_233(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9C9
{
	float entityCoords;
	float num;
...
BOOL func_234(Ped pedParam0, float fParam1) // Position - 0xEAD5
{
	var outProjectile;
	var outCoords;
...
BOOL func_235(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_236(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEBF8
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_238(Vehicle veParam0) // Position - 0xEC8A
{
	int taskSequenceId;
...
{
	plLocal_96 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");

	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(plLocal_96))
	{
		SYSTEM::WAIT(0);
	}
...
void func_250(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF161
{
	func_251(pveParam0);
...
void func_251(Vehicle* pveParam0) // Position - 0xF1A3
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_252(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF23F
{
...
BOOL func_253(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF29B
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_292(echParam1);
...
void func_280(Object* pobParam0, BOOL bParam1) // Position - 0xFDAA
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_283(Vehicle* pveParam0) // Position - 0xFE34
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_286(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFEBF
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_287(Ped* ppedParam0) // Position - 0xFF0F
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
Hash func_292(eCharacter echParam0) // Position - 0xFFEC
{
	if (!func_36(echParam0))
