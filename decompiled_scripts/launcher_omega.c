...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_293(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_212(num);
		func_205(&iLocal_91, &(num.f_9), vector);
	
		if (num == 44)
		{
			func_197(&num, vector, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_92);
			func_196();
		}
		else if (num == 45)
		{
			func_197(&num, vector, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_93);
			func_194(&num);
		}
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4824
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x54D5
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5510
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5784
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D0F
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64D2
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6519
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6584
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6997
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69A7
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74BE
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x74E8
{
...
BOOL func_85(Player plParam0) // Position - 0x7514
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7616
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76AB
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8349
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x83CB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8423
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x86A8
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x86C5
{
...
int func_106(int iParam0) // Position - 0x8C0E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C30
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8C47
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D05
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D77
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D8D
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8DA3
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8DE5
{
...
BOOL func_122(Any* panParam0) // Position - 0xA878
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xAA16
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAAF2
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xABEB
{
...
int func_134(Ped pedParam0) // Position - 0xAC52
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAC9B
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xACBB
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xACDC
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xADAC
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xADFF
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAEF4
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF9E
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB105
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB19F
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB1C1
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB20E
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB28B
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB32F
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3BE
{
...
void func_160(Vehicle veParam0) // Position - 0xB556
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB712
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB778
{
...
BOOL func_169(int iParam0) // Position - 0xB7B9
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB830
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB967
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9B6
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xB9C7
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBBA8
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBBDB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC24
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0xBC48
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_181(var uParam0) // Position - 0xC447
{
	float num;
...
void func_182(int iParam0, var uParam1) // Position - 0xC4D5
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_183(BOOL bParam0) // Position - 0xC539
{
...
BOOL func_184(Vehicle veParam0) // Position - 0xC5D0
{
...
BOOL func_185(int iParam0) // Position - 0xC5FA
{
	eCharacter character;
...
BOOL func_186() // Position - 0xCD17
{
	return Global_100872.f_1;
}

BOOL func_187() // Position - 0xCD25
{
	if (Global_97735 != -1)
...
BOOL func_191(int iParam0, int iParam1) // Position - 0xCD9D
{
	switch (iParam0)
	{
		case 5:
...
void func_194(var uParam0) // Position - 0xCDFD
{
	var entityCoords;
	float entityCoords2;
	float heading;
	...
	if (MISC::GET_GAME_TIMER() - iLocal_96 > 1250)
	{
		...
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && !func_195(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 50f, true))
			{
...
BOOL func_195(Ped pedParam0, Entity eParam1, float fParam2, BOOL bParam3) // Position - 0xCEE6
{
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xCFFA
{
	var unk;
	...
	if (!(*uParam8 == 3))
	{
		if (func_185(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && func_204(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
				{
			...
			if (func_204(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f && *uParam8 == 1)
			{
...
BOOL func_199(char* sParam0) // Position - 0xD129
{
	var string1;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD16D
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD1FE
{
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD299
{
...
void func_205(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD2D3
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_208(var uParam0, int iParam1) // Position - 0xD439
{
	BOOL flag;
	int i;
...
void func_210(var uParam0) // Position - 0xD4E3
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_211(uParam0);
...
void func_211(var uParam0) // Position - 0xD4FA
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD60A
{
	var unk;
	...
	if (func_250(*panParam0) || func_248(*panParam0) || Global_78935 == 1)
		return true;
...
void func_214(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD87A
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_215(int iParam0) // Position - 0xDBD2
{
...
BOOL func_216(var uParam0) // Position - 0xDBF2
{
...
BOOL func_217(var uParam0) // Position - 0xDC0A
{
...
void func_219(Object* pobParam0) // Position - 0xDF33
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDFDE
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_222(Ped pedParam0, Vehicle veParam1) // Position - 0xE19C
{
...
BOOL func_223(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE1CC
{
	int i;
	int num;
...
BOOL func_224(int iParam0) // Position - 0xE488
{
...
BOOL func_225(Ped pedParam0, int iParam1) // Position - 0xE4BC
{
	float xSize;
...
BOOL func_226(Ped pedParam0, int iParam1) // Position - 0xE532
{
	return func_227(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_227(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE54A
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_228(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_228(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE60B
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_229(Ped pedParam0, int iParam1) // Position - 0xE737
{
...
BOOL func_231(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE846
{
	var unk;
...
float func_232(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE8D7
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_233(float fParam0, var uParam1, var uParam2) // Position - 0xE8F8
{
	float num;
	float num2;
...
int func_235(Ped pedParam0, Ped pedParam1) // Position - 0xE952
{
	int i;
...
BOOL func_236(Ped pedParam0) // Position - 0xE991
{
...
BOOL func_237(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE9B9
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_238(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEAB4
{
	float entityCoords;
	float num;
...
BOOL func_239(Ped pedParam0, float fParam1) // Position - 0xEBC0
{
	var outProjectile;
	var outCoords;
...
BOOL func_240(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEC55
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_241(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xECE3
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_242(int iParam0) // Position - 0xED2B
{
...
void func_243(Vehicle veParam0) // Position - 0xED75
{
	int taskSequenceId;
...
BOOL func_244(int iParam0) // Position - 0xEE12
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_245(int iParam0) // Position - 0xEEA7
{
...
BOOL func_248(int iParam0) // Position - 0xEF26
{
...
BOOL func_250(int iParam0) // Position - 0xEF98
{
...
BOOL func_253(var uParam0) // Position - 0xF036
{
	switch (*uParam0)
	{
		case 44:
...
BOOL func_254(var uParam0) // Position - 0xF07D
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_257(&uParam0->f_28[0], CHAR_OMEGA, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_255(&uParam0->f_35[0], num[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
...
void func_255(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF24C
{
	func_256(pveParam0);
...
void func_256(Vehicle* pveParam0) // Position - 0xF28E
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_257(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF32A
{
...
BOOL func_258(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF386
{
	Hash model;
...
int func_259(var uParam0, eCharacter echParam1) // Position - 0xF414
{
	int num;
...
BOOL func_260(var uParam0) // Position - 0xF45A
{
	if (func_217(uParam0))
	{
...
BOOL func_261(var uParam0) // Position - 0xF484
{
	int i;
...
BOOL func_263(var uParam0) // Position - 0xF4F1
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_257(&uParam0->f_28[0], CHAR_OMEGA, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
					flag = false;
...
BOOL func_264(int iParam0) // Position - 0xF775
{
	var unk;
	eCharacter character;
...
BOOL func_265(int iParam0) // Position - 0xF7C6
{
	const char* string2;
...
BOOL func_266(int iParam0) // Position - 0xF87F
{
	var unk;
...
BOOL func_267(int iParam0) // Position - 0xF940
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_269(int iParam0) // Position - 0xFAA7
{
...
BOOL func_270(int iParam0) // Position - 0xFAD2
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_271(int iParam0) // Position - 0xFAFD
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_272(int iParam0) // Position - 0xFB28
{
	if (func_245(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_274(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFB77
{
	int i;
...
BOOL func_275(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFBDC
{
	int num;
	char* str;
...
BOOL func_276(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFC54
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_277(var uParam0, BOOL bParam1) // Position - 0xFCCF
{
	char* str;
...
void func_285(Object* pobParam0, BOOL bParam1) // Position - 0xFE95
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_288(Vehicle* pveParam0) // Position - 0xFF1F
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_291(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFFAA
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_292(Ped* ppedParam0) // Position - 0xFFFA
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_293(int iParam0) // Position - 0x1003C
{
	if (*iParam0 == -1)
		return;
...
Hash func_297(eCharacter echParam0) // Position - 0x100D8
{
	if (!func_36(echParam0))
