...
void func_11() // Position - 0x213
{
	...
	if (Global_1853753 == PLAYER::PLAYER_ID() && !IS_BIT_SET(Global_1890444[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*129*/].f_38.f_27, 5))
	{
		...
		if (func_18(&uLocal_47, false, false))
		{
			...
			if (iLocal_484 == 0 && !IS_BIT_SET(Global_1890444[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*129*/].f_38.f_27, 3) && !func_16() && !HUD::IS_PAUSE_MENU_ACTIVE() && !func_15(0) && !func_14() && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_RRIGHT))
				func_12(&uLocal_47);
		}
		else
		{
...
void func_13(int* piParam0, int iParam1) // Position - 0x348
{
...
BOOL func_25(Player plParam0) // Position - 0xA38
{
...
BOOL func_28(Ped pedParam0) // Position - 0xCC0
{
	int weaponHash;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x1442
{
	int i;
...
BOOL func_56(Ped pedParam0, var uParam1) // Position - 0x167E
{
...
void func_59(int* piParam0, int iParam1) // Position - 0x16FF
{
...
void func_63(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x1849
{
	int offset;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x192D
{
	switch (func_69())
	{
		case 0:
...
BOOL func_74(Ped pedParam0) // Position - 0x19D0
{
