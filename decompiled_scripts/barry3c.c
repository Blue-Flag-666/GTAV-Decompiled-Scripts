...
void __EntryFunction__()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_35[0]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_81.f_35[0], false))
		{
			...
			func_470(&(Local_159.f_4), &(Local_81.f_35[0]));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_159.f_4, true, 1);
			func_469(Local_159.f_4, 0);
		}
	}
	func_468(&iLocal_172, &(Local_81.f_41[0]));
	func_454();
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_35[1]))
	{
		func_470(&(Local_191[6 /*7*/].f_4), &(Local_81.f_35[1]));
	}
	if (func_453())
	{
		iVar0 = func_452();
	...
	while (true)
	{
		...
		func_400(Local_81.f_9, 0, 0, 0, 0, 0);
		if (iLocal_156 == 13)
		{
			func_381();
		}
		...
		{
			func_379();
			func_374(&uLocal_143, &uLocal_251, "BAR3CAU", &sLocal_144, &cLocal_150);
			switch (iLocal_156)
			{
				case 0:
					func_373();
...
int func_2()
{
	if (func_417(iLocal_188) && func_417(Local_159.f_4))
	{
		if (func_3())
		{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_417(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_250 <= 7)
				{
					if (func_417(Local_191[iLocal_250 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/].f_4, false))
					{
						bVar2 = true;
						Local_191[iLocal_250 /*7*/].f_6 = 1;
						func_470(&iLocal_188, &(Local_191[iLocal_250 /*7*/].f_4));
					}
					iLocal_250++;
				}
				if (!bVar2)
...
void func_19()
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			func_20();
			if (iLocal_457 && !func_417(iLocal_188))
			{
				func_47(&iLocal_158);
				HUD::CLEAR_PRINTS();
				iLocal_156 = 10;
...
void func_34()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_35(iVar0) && (!func_39(14) || Global_111873))
			{
...
void func_48()
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (iLocal_457 && !func_417(iLocal_188))
			{
				func_47(&iLocal_158);
				HUD::CLEAR_PRINTS();
				iLocal_156 = 10;
...
void func_51()
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			{
				if (!func_250(PLAYER::PLAYER_PED_ID(), Local_159.f_4, 150f, 1) && !func_15())
				{
					iLocal_157 = 2;
				}
...
void func_53(int iParam0, bool bParam1)
{
	...
	{
		func_216(&(Global_112009[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_56()
{
	...
	{
		func_58(13, SYSTEM::FLOOR(Global_112922.f_10194.f_3853));
	}
...
int func_81(int iParam0, int iParam1, int iParam2)
{
	...
	Global_77669[1 /*14*/] = { func_132(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_77669[1 /*14*/] = { func_132(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_124(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_124(iParam1), Global_77669[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, 0);
		}
	}
...
int func_82(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_196(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_64, Global_112922.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_77669[1 /*14*/] = { func_132(iVar10, iParam1, iParam2, -1) };
		if (!func_122(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_77669[1 /*14*/] = { func_132(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_77669[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77669[1 /*14*/] = { func_132(iVar10, 14, uVar28[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_124(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
						}
						func_115(iVar0);
						if (Global_77667 == 1)
						{
			...
			{
				Global_77669[1 /*14*/] = { func_132(iVar10, iVar0, func_90(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77669[1 /*14*/] = { func_132(iVar10, 14, uVar69[iVar1], -1) };
			func_100(iParam0, Global_77669[1 /*14*/].f_12, Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4);
			func_115(14);
			if (Global_77667 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_124(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
		}
		if (Global_77667 == 1)
		{
			iVar2 = 0;
...
void func_115(int iParam0)
{
	...
	{
		func_121(iParam0, Global_77669[1 /*14*/].f_5, Global_77669[1 /*14*/].f_2, 2, Global_77669[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_77669[1 /*14*/].f_6, 1) && BitTest(Global_77669[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_117(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2822371[iParam0 /*3*/][func_118(iParam2)];
	if (iVar0 != 0)
	{
...
int func_119(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		iVar0 = Global_2822371[iParam0 /*3*/][func_118(iParam1)];
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_196(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_61, Global_112922.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_131(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[0], Global_112922.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_131(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[1], Global_112922.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_131(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[2], Global_112922.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_119(func_138(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_119(func_137(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_119(iVar1, Global_77666, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_196(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_196(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_196(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_77669[2 /*14*/] = { func_132(iVar0, 14, iVar4, -1) };
									if (Global_77669[2 /*14*/].f_12 == iVar3)
									{
										if (func_196(iParam0, 14, iVar4))
										{
											if (!func_88(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77669[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_77669[2 /*14*/] = { func_132(iVar0, iVar2, iVar1, -1) };
						if (!func_88(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77669[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77669[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_124(iParam1)) && Global_77669[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_124(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_203(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_204(&sVar32, Var0.f_3, Global_100017, bParam1, bParam2);
	}
}
...
void func_209()
{
	...
	{
		func_34();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_210(Global_112922.f_2363.f_539.f_4321));
	}
	else
	{
...
{
	func_221(iParam0, 1);
	Global_112922.f_18574[iParam0 /*6*/].f_3 = func_220();
...
int func_231()
{
	if ((func_57() == -1 || func_57() == 999) && !func_232() == 0)
	{
		return 1;
	}
	return 0;
...
bool func_250(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_251()
{
	...
	{
		if (func_328(&uLocal_251, 49, "BAR3CAU", "BAR3C_P1", 9, 1, 0, 0, 0))
		{
			func_252(2, "Delivered vehicle", 1, 0, 0, 1);
			iLocal_457 = 1;
			iLocal_156 = 7;
			iLocal_157 = 0;
		}
...
void func_252(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_325(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_247(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_322(&(Global_99980.f_3));
				if (iVar10 > -1)
				{
		...
		func_253(iParam0, sParam1, iParam4, iParam5);
...
{
	func_254(&Global_106470, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_254(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_33();
	...
	if (iParam4 == 1)
	{
		func_256(&(uParam0->f_2890), uParam0, iParam5, 1, 1, 0);
	}
...
void func_256(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	if (func_269(iParam2, &iVar0, iParam3, iParam5))
	{
		func_257(uParam0, uParam1, iVar0, iParam4);
	}
...
int func_257(var uParam0, var uParam1, int iParam2, int iParam3)
{
...
{
	func_265(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_262(iParam1, 145, 0);
	uParam0->f_11 = func_261(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_260(iParam1);
		}
	}
	if (iParam2 == 1)
	{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97311[iVar0]))
		{
			if (Global_97311[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_263(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_265(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_267(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_77), func_266(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_269(int iParam0, var uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
int func_273(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2860791[iParam0 /*3*/][func_118(iParam1)];
...
int func_289(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_310())
		{
			*uParam0 = func_294(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
			if (func_293(*uParam0) && !func_290(*uParam0))
			{
				return 1;
			}
		}
...
int func_291(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_57() == 0)
		{
			return BitTest(func_119(func_292(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_294(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam3 == 6 || iParam3 == func_309(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_295(iVar0, 0), true);
...
Vector3 func_295(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_305(Global_102104);
			break;
		
		case 46:
			if (Global_1852968 != func_27())
			{
				if (func_304(Global_1852968))
				{
					return func_297(2, 2);
				}
				else if (func_296(Global_1852968))
				{
...
int func_298(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
int func_323(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_324(Global_112922.f_9085.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_324(Global_112922.f_9085.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_324(Global_112922.f_9085.f_99.f_205[11]);
			break;
		
		case 90:
			return func_324(Global_112922.f_9085.f_99.f_205[7]);
			break;
		
		case 93:
			return func_324(Global_112922.f_9085.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
bool func_328(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
void func_333()
{
	...
	switch (iLocal_157)
	{
		case 0:
			func_47(&iLocal_158);
			iLocal_158 = func_334(Local_182, 5, 1);
...
int func_334(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
		...
		case 0:
			...
			if (iLocal_248)
			{
				...
				else if (func_2())
				{
					...
					iLocal_486 = 0;
					func_336(748, 0);
					func_252(1, "Start of towing stage", 0, 0, 0, 1);
					func_47(&iLocal_158);
					iLocal_156 = 5;
					iLocal_157 = 0;
				}
		...
		case 0:
			...
			else
			{
				...
				else if (!iLocal_417 && (MISC::GET_GAME_TIMER() - iLocal_422) > 120000)
				{
					if (!func_340())
					{
						if (func_339(&uLocal_251, 49, "BAR3CAU", "BAR3C_HC", 7, 0, 0, 1))
						{
							iLocal_417 = 1;
						}
					}
...
bool func_339(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
...
void func_342(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103486.f_4))
	{
		...
		{
			if (func_369(24) != Global_103486.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_366(ENTITY::GET_ENTITY_COORDS(Global_103486.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_343(Global_103486.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_343(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_362(iParam5, &Var0, Param1, fParam4, func_261(iParam0));
		func_344(iParam5, iParam0, 0);
	}
}
...
void func_344(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_361(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_112922.f_32749.f_4801 = func_311();
			}
...
void func_345(int iParam0, int iParam1)
{
	...
	func_265(iParam0, &(Global_112922.f_32749.f_5510));
}

int func_346(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_270(iParam0, 0, 0)) || func_270(iParam0, 1, 0)) || func_270(iParam0, 2, 0)) || func_261(iParam0) != 145) || func_360(iParam0)) || func_359(iParam0)) || func_358(iParam0)) || func_357(iParam0)) || !func_347(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_359(iParam0))
		{
		}
...
int func_348(int iParam0, bool bParam1)
{
	...
	{
		if ((((!func_355() && !func_354()) && !func_353()) && !func_352()) && !func_356())
		{
			return 0;
		}
	}
	...
	{
		if ((func_213() || MISC::IS_PC_VERSION()) || func_212())
		{
		}
		else if (!func_353())
		{
...
void func_362(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_361(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_364(iParam0);
			func_363(uParam1, &(Global_112922.f_32749.f_69[Global_76676.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_370()
{
	switch (iLocal_157)
	{
		case 0:
			iLocal_428 = 0;
			bLocal_427 = false;
			if (func_328(&uLocal_251, 49, "BAR3CAU", "BAR3C_NG", 9, 1, 0, 0, 0))
			{
				iLocal_157 = 1;
			}
			break;
...
void func_374(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_375(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_381()
{
	switch (iLocal_157)
	{
		...
		case 1:
			if (func_397())
			{
				if ((func_417(Local_159.f_4) && func_417(iLocal_188)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_159.f_4, iLocal_188))
				{
...
void func_390(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_391(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_391(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_394(int iParam0, bool bParam1)
{
	...
	else if (func_291(iParam0, 2, 1))
	{
		func_395(iParam0, 2, 1);
	}
}
...
void func_395(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_57() == 0)
		{
			iVar0 = func_119(func_292(iParam0), -1, 0);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_117(func_292(iParam0), iVar0, -1, 1, 0);
		}
	}
	else
	{
...
void func_398(char* sParam0, bool bParam1)
{
	func_399(sParam0);
	func_473(bParam1);
}
...
void func_400(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78112 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_402(Global_78113, Global_78115, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
struct<2> func_402(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_403(iVar2), 8);
					break;
			}
			break;
...
int func_411(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_414(0) || Global_78127) || Global_78116 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78112)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_413(0)) || func_412(1))
			{
			}
			else
			{
...
{
	return func_416(iParam0, Global_42602);
}
...
void func_419(bool bParam0)
{
	if (bParam0)
	{
		...
		{
			func_434(-1237,962f, -1035,194f, 7,2466f, 110f, 1, 0);
		}
		else
		{
			func_434(-1074,134f, -1250,292f, 4,5293f, 199,5f, 1, 0);
		}
	}
	func_427();
	func_426();
	...
	func_337(7);
	func_337(7);
	func_425(-1151,36f, -1243,57f, 6,52f, 25,18f);
	if (bParam0)
	{
		if (iLocal_189 == joaat("towtruck") || iLocal_189 == joaat("towtruck2"))
		{
			func_422(-1237,962f, -1035,194f, 7,2466f, 110f, 0);
		}
		else
		{
			func_422(-1074,134f, -1250,292f, 4,5293f, 199,5f, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
		}
		func_420(iLocal_188, -1, 0);
	}
	else if (iLocal_189 == joaat("towtruck") || iLocal_189 == joaat("towtruck2"))
	{
		func_422(-1237,962f, -1035,194f, 7,2466f, 110f, 1);
	}
	else
	{
		func_422(-1074,134f, -1250,292f, 4,5293f, 199,5f, 1);
	}
	func_372(500, 1);
}
...
void func_422(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		func_423(PLAYER::PLAYER_PED_ID(), iLocal_188, -1, 0);
	}
...
void func_425(struct<3> Param0, float fParam3)
{
...
bool func_436()
{
	return func_437(&(Global_106470.f_2890));
}
...
int func_437(var uParam0)
{
	...
	if (!func_348(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
...
void func_439(bool bParam0)
{
	if (bParam0)
	{
		...
		if (iLocal_189 == joaat("towtruck") || iLocal_189 == joaat("towtruck2"))
		{
			func_434(-1154,224f, -1234,31f, 5,7174f, 12,45f, 1, 0);
		}
		else
		{
			func_434(-1148,183f, -1227,005f, 8,4468f, 19,2f, 1, 0);
		}
	}
	func_427();
	func_426();
	func_47(&iLocal_158);
	if (bParam0 && !Global_94157)
	{
		iLocal_457 = 1;
		iLocal_156 = 7;
	}
	...
	if (bParam0)
	{
		if (iLocal_189 == joaat("towtruck") || iLocal_189 == joaat("towtruck2"))
		{
			func_422(-1154,224f, -1234,31f, 5,7174f, 12,45f, 0);
		}
		else
		{
			func_422(-1148,183f, -1227,005f, 8,4468f, 19,2f, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_422(-1154,224f, -1234,31f, 5,7174f, 12,45f, 1);
	}
	else
	{
		func_422(-1148,183f, -1227,005f, 8,4468f, 19,2f, 1);
	}
	func_252(2, "Delivered vehicle", 1, 0, 0, 1);
}
...
void func_440(bool bParam0)
{
	if (bParam0)
	{
		...
		func_434(Local_159, Local_159.f_3, 1, 0);
	}
	...
	if (bParam0)
	{
		func_434(Local_488, fLocal_491, 1, 0);
	}
	...
	func_11(7, 0);
	func_11(7, 0);
	func_425(Local_159, Local_159.f_3);
	if (bParam0)
	{
		func_422(Local_488, fLocal_491, 0);
		if (func_417(iLocal_188) && iLocal_189 == joaat("towtruck"))
		{
	...
	{
		func_422(Local_488, fLocal_491, 1);
		if (func_417(iLocal_188) && iLocal_189 == joaat("towtruck"))
		{
			VEHICLE::SET_VEHICLE_TOW_TRUCK_ARM_POSITION(iLocal_188, 0f);
		}
...
void func_454()
{
	...
	Local_159.f_3 = -76,2f;
	Local_191[0 /*7*/] = { func_466(-552,67f, -1698,84f, 18,16f, 205,7f) };
	Local_191[1 /*7*/] = { func_466(-317,14f, -1540,72f, 26,67f, 336,5f) };
	Local_191[2 /*7*/] = { func_466(-104,41f, -1984,91f, 17,02f, 171,6f) };
	Local_191[3 /*7*/] = { func_466(-586,69f, -1774,59f, 21,67f, 145,8f) };
	Local_191[4 /*7*/] = { func_466(-1207,9f, -1334,87f, 3,77f, 204,1f) };
	Local_191[5 /*7*/] = { func_466(-1253,67f, -1210,3f, 6,03f, 10,7f) };
	Local_191[6 /*7*/] = { func_466(-426,56f, -1717,89f, 18,2f, 43,5f) };
	Local_191[7 /*7*/] = { func_466(401,64f, -1633,3f, 28,29f, 231,5f) };
	if (func_417(Local_159.f_4))
	{
		VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_159.f_4, false);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_159.f_4, false);
	...
	if (func_417(PLAYER::PLAYER_PED_ID()))
	{
		func_465(&uLocal_251, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	func_465(&uLocal_251, 3, 0, "BARRY", 0, 1);
	iLocal_419 = 0;
	func_463();
	sLocal_487 = "DEFAULT";
	iLocal_437 = 0;
		...
		if (bParam2)
		{
			if (!Global_77858)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_457(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_457(iParam0) };
...
void func_463()
{
	Local_458[0 /*3*/] = { func_464("B3CENTV", 1) };
	Local_458[1 /*3*/] = { func_464("B3CDELV", 1) };
	Local_458[2 /*3*/] = { func_464("B3CWAN1", -1) };
	Local_458[3 /*3*/] = { func_464("B3CNOGO", 1) };
	Local_458[4 /*3*/] = { func_464("B3CREVRS", 1) };
	Local_458[5 /*3*/] = { func_464("B3CLEAVE", 1) };
	Local_458[6 /*3*/] = { func_464("B3CRTTT", 1) };
	Local_458[7 /*3*/] = { func_464("B3CGBTB", 1) };
	Local_458[8 /*3*/] = { func_464("B3CRTCB", 1) };
}

Vector3 func_464(char* sParam0, int iParam1)
{
	struct<3> Var0;
...
void func_465(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
struct<7> func_466(struct<3> Param0, float fParam3)
{
	struct<7> Var0;
...
void func_473(bool bParam0)
{
	...
	if (!func_487())
	{
		...
		{
			func_203(iVar0, 1, 0);
			func_474(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112009[iVar0 /*10*/].f_9 == -1)
...
int func_475(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_478())
	{
		...
		{
			iVar33 = func_322(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_476()
{
	...
	iVar0 = func_325(&(Global_99980.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_478()
{
	...
	{
		if (func_322(&(Global_99980.f_3)) > -1)
		{
			return 1;
		}
	}
