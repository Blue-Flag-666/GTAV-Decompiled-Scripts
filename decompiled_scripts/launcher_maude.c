...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num /*10*/].f_9 != -1)
			{
				...
				func_279(&(Global_112897[num /*10*/].f_9));
			}
		}
	...
	if (!func_260(&unk63, &num, vector, 1f))
	{
		func_259();
	...
	while (true)
	{
		...
		func_202(num);
		func_194(&iLocal_91, &(num.f_9), vector);
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x47AD
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x545E
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5499
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x570D
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C98
{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x645B
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x64A2
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x650D
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6920
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6930
{
	int i;
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7471
{
...
BOOL func_85(Player plParam0) // Position - 0x749D
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x759F
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7634
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x82D2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8354
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x83AC
{
	return -1;
}
...
int func_97(Player plParam0) // Position - 0x8631
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x864E
{
...
int func_106(int iParam0) // Position - 0x8B97
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BB9
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8BD0
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8C8E
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D00
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D16
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D2C
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8D6E
{
...
BOOL func_122(Any* panParam0) // Position - 0xA801
{
	int threadId;
...
void func_126(Ped pedParam0) // Position - 0xA99F
{
	int num;
	int num2;
	int num3;
...
int func_128(Ped pedParam0) // Position - 0xAA7B
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAB74
{
...
int func_134(Ped pedParam0) // Position - 0xABDB
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAC24
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC44
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAC65
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAD35
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAD88
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAE7D
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF27
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB08E
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB128
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB14A
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB197
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB214
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB2B8
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB347
{
...
void func_160(Vehicle veParam0) // Position - 0xB4DF
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_166(int iParam0) // Position - 0xB69B
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB701
{
...
BOOL func_169(int iParam0) // Position - 0xB742
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB7B9
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xB8F0
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB93F
{
	return func_174(iParam0, Global_43377);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xB950
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBB31
{
	if (Global_43377 == 15)
		return false;
...
int func_177(const char* sParam0, int iParam1) // Position - 0xBB64
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBBAD
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0xBBD1
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_181(var uParam0) // Position - 0xC3CF
{
	float num;
...
void func_182(int iParam0, var uParam1) // Position - 0xC45D
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_183(BOOL bParam0) // Position - 0xC4C1
{
...
BOOL func_184(Vehicle veParam0) // Position - 0xC558
{
...
BOOL func_185(int iParam0) // Position - 0xC582
{
	eCharacter character;
...
BOOL func_186() // Position - 0xCC9F
{
	return Global_100872.f_1;
}

BOOL func_187() // Position - 0xCCAD
{
	if (Global_97735 != -1)
...
BOOL func_191(int iParam0, int iParam1) // Position - 0xCD25
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_192() // Position - 0xCD5D
{
	return Global_1575063;
}

BOOL func_193() // Position - 0xCD69
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_194(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCD85
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_197(var uParam0, int iParam1) // Position - 0xCEEB
{
	BOOL flag;
	int i;
...
float func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xCF89
{
...
void func_200(var uParam0) // Position - 0xCFCF
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_201(uParam0);
...
void func_201(var uParam0) // Position - 0xCFE6
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD0F6
{
	var unk;
...
void func_204(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD366
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_205(int iParam0) // Position - 0xD6BE
{
...
BOOL func_206(var uParam0) // Position - 0xD6DE
{
...
BOOL func_207(var uParam0) // Position - 0xD6F6
{
...
void func_209(Object* pobParam0) // Position - 0xDA1F
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDACA
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_212(Ped pedParam0, Vehicle veParam1) // Position - 0xDC88
{
...
BOOL func_213(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDCB8
{
	int i;
	int num;
...
BOOL func_214(int iParam0) // Position - 0xDF74
{
...
BOOL func_215(Ped pedParam0, int iParam1) // Position - 0xDFA8
{
	float xSize;
...
BOOL func_216(Ped pedParam0, int iParam1) // Position - 0xE01E
{
	return func_217(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_217(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE036
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_218(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE0F7
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_219(Ped pedParam0, int iParam1) // Position - 0xE223
{
...
BOOL func_221(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE332
{
	var unk;
...
float func_222(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE3C3
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_223(float fParam0, var uParam1, var uParam2) // Position - 0xE3E4
{
	float num;
	float num2;
...
int func_225(Ped pedParam0, Ped pedParam1) // Position - 0xE43E
{
	int i;
...
BOOL func_226(Ped pedParam0) // Position - 0xE47D
{
...
BOOL func_227(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE4A5
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_228(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE5A0
{
	float entityCoords;
	float num;
...
BOOL func_229(Ped pedParam0, float fParam1) // Position - 0xE6AC
{
	var outProjectile;
	var outCoords;
...
BOOL func_230(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE741
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_231(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE7CF
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_232(int iParam0) // Position - 0xE817
{
...
void func_233(Ped pedParam0) // Position - 0xE861
{
	int taskSequenceId;
...
BOOL func_234(int iParam0) // Position - 0xE8FE
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_235(int iParam0) // Position - 0xE993
{
...
BOOL func_238(int iParam0) // Position - 0xEA12
{
...
BOOL func_240(int iParam0) // Position - 0xEA84
{
...
BOOL func_241(var uParam0) // Position - 0xEAAC
{
	if (!func_242(uParam0))
		return false;
...
BOOL func_242(var uParam0) // Position - 0xEACB
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_247(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				func_246(&uParam0->f_41[0], num[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				func_246(&uParam0->f_41[1], num[2], 2727.686f, 4145.715f, 44.08f, 71f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_243(&uParam0->f_28[0], CHAR_MAUDE, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
					flag = false;
...
BOOL func_243(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xED63
{
	if (func_244(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_244(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEDBF
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_249(echParam1);
...
int func_245(var uParam0, eCharacter echParam1) // Position - 0xEE4D
{
	int num;
...
void func_246(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEE93
{
	func_209(pobParam0);
...
BOOL func_247(var uParam0) // Position - 0xEEBA
{
	int i;
...
void func_248(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEEEB
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_90 = PED::ADD_SCENARIO_BLOCKING_AREA(vector, vector2, false, true, true, true);
...
Hash func_249(eCharacter echParam0) // Position - 0xEFEB
{
	if (!func_36(echParam0))
...
BOOL func_250(int iParam0) // Position - 0xF011
{
	var unk;
	eCharacter character;
...
BOOL func_251(int iParam0) // Position - 0xF062
{
	const char* string2;
...
BOOL func_252(int iParam0) // Position - 0xF11B
{
	var unk;
...
BOOL func_253(int iParam0) // Position - 0xF1DC
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_255(int iParam0) // Position - 0xF343
{
...
BOOL func_256(int iParam0) // Position - 0xF36E
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_257(int iParam0) // Position - 0xF399
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_258(int iParam0) // Position - 0xF3C4
{
	if (func_235(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_260(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF413
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_261(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_261(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_261(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF478
{
	int num;
	char* str;
	...
	if (func_262(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_262(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF4F0
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_263(var uParam0, BOOL bParam1) // Position - 0xF56B
{
	if (bParam1)
	{
...
void func_268(Object* pobParam0, BOOL bParam1) // Position - 0xF676
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_271(Vehicle* pveParam0) // Position - 0xF700
{
...
void func_272(Vehicle* pveParam0) // Position - 0xF738
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_274(var uParam0, int iParam1) // Position - 0xF7E6
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_275(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_275(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF827
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_276(Ped* ppedParam0) // Position - 0xF877
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_277(var uParam0) // Position - 0xF8B8
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		...
		{
			if (func_278(uParam0->f_28[0], SCRIPT_TASK_SYNCHRONIZED_SCENE))
...
BOOL func_278(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xF929
{
...
void func_279(int iParam0) // Position - 0xF95C
{
	if (*iParam0 == -1)
		return;
