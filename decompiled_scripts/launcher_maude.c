...
void main() // Position - 0x0
{
	...
	if (unk_0x55EEDBBFDC6E810F(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num /*10*/].f_9 != -1)
			{
				...
				func_274(&(Global_112735[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_197(num);
		func_189(&iLocal_93, &(num.f_9), unk61);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x384A
{
	var unk;
	int num;
...
int func_50(int iParam0) // Position - 0x3887
{
	int num;
	int num2;
...
BOOL func_52(int iParam0, int iParam1) // Position - 0x38C7
{
	var unk;
	BOOL num;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x38F3
{
	eCharacter character;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3E3C
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x407E
{
	func_56();
...
BOOL func_60(int iParam0) // Position - 0x451D
{
	switch (iParam0)
	{
...
BOOL func_61(int iParam0) // Position - 0x45BE
{
...
BOOL func_67(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C33
{
	var unk;
	var unk2;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x63F6
{
	if (bParam6)
...
BOOL func_70(var uParam0) // Position - 0x643D
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2) // Position - 0x64A8
{
	if (iParam0 == -1)
		return false;
...
eMPStat func_73(int iParam0) // Position - 0x6509
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Position - 0x68AD
{
	return func_72(iParam0, 5, true);
}

int func_76(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x68BD
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x73B9
{
...
BOOL func_81(Player plParam0) // Position - 0x73E3
{
...
BOOL func_83(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x74E5
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x757A
{
	float num;
	float num2;
	float num3;
...
BOOL func_88(int iParam0, var uParam1) // Position - 0x821C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x829E
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x82F6
{
	return -1;
}
...
BOOL func_94(int iParam0) // Position - 0x85A3
{
...
int func_102(int iParam0) // Position - 0x8ADF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B01
{
	if (bParam0)
		return uParam1;
...
int func_104(int iParam0) // Position - 0x8B18
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8BD6
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}
...
void func_112(char* sParam0, var uParam1, int iParam2) // Position - 0x8C74
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8CB6
{
...
BOOL func_118(Any* panParam0) // Position - 0xA749
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2) // Position - 0xAABC
{
...
BOOL func_131(var uParam0) // Position - 0xAB6C
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAB8C
{
	if (unk_0x7DE17ACDD8BA2642(iParam0))
...
BOOL func_133(int iParam0) // Position - 0xABAD
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135(int iParam0) // Position - 0xAC7D
{
	switch (iParam0)
	{
		case 5:
...
void func_136(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xACD0
{
	int i;
...
BOOL func_137(int iParam0) // Position - 0xADC5
{
	switch (iParam0)
	{
		case 5:
...
void func_139(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAE6F
{
	if (bParam0)
	{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0xAFD6
{
	BOOL flag;
...
BOOL func_143(int iParam0) // Position - 0xB062
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB0AF
{
	int num;
...
BOOL func_148(var uParam0) // Position - 0xB12C
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB1D0
{
...
BOOL func_154(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB25F
{
...
void func_155(var uParam0) // Position - 0xB3F7
{
	if (!unk_0x055111B11E6624FD(uParam0, 0))
...
BOOL func_161(int iParam0) // Position - 0xB5B3
{
	if (iParam0 == 1)
...
BOOL func_163(int iParam0) // Position - 0xB619
{
...
BOOL func_164(int iParam0) // Position - 0xB65A
{
	int num;
...
int func_166(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB6D1
{
	int i;
...
void func_167(int iParam0, int iParam1) // Position - 0xB808
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB857
{
	return func_169(iParam0, Global_43257);
}

BOOL func_169(int iParam0, int iParam1) // Position - 0xB868
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_170(int iParam0) // Position - 0xBA49
{
	if (Global_43257 == 15)
		return false;
...
int func_172(var uParam0, int iParam1) // Position - 0xBA7C
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBAC5
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
BOOL func_174(var uParam0, int iParam1) // Position - 0xBAE9
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_176(var uParam0) // Position - 0xC2EA
{
	float num;
...
void func_177(int iParam0, var uParam1) // Position - 0xC378
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_178(BOOL bParam0) // Position - 0xC3DC
{
	var unk;
...
BOOL func_179(var uParam0) // Position - 0xC473
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xFBD273FDBCF0C5BD(uParam0, 0))
...
BOOL func_180(int iParam0) // Position - 0xC49D
{
	eCharacter character;
...
BOOL func_181() // Position - 0xCBBA
{
	return Global_100720.f_1;
}

BOOL func_182() // Position - 0xCBC8
{
	if (Global_97603 != -1)
...
BOOL func_186(int iParam0, int iParam1) // Position - 0xCC40
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_187() // Position - 0xCC78
{
	return Global_1575060;
}

BOOL func_188() // Position - 0xCC84
{
	if (!unk_0xA26A9A07F761D8F8())
...
void func_189(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCCA0
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
...
void func_192(var uParam0, int iParam1) // Position - 0xCE06
{
	BOOL flag;
	int i;
...
float func_193(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCEA4
{
	var unk;
...
void func_195(var uParam0) // Position - 0xCEEA
{
	unk_0xD9BE1A7D50AF0CB4(0);
	unk_0x423A98584B1756BF();
	func_196(uParam0);
...
void func_196(var uParam0) // Position - 0xCF01
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD011
{
	var unk;
...
BOOL func_200(int iParam0) // Position - 0xD5D9
{
...
BOOL func_201(var uParam0) // Position - 0xD5F9
{
...
BOOL func_202(var uParam0) // Position - 0xD611
{
...
void func_204(var uParam0) // Position - 0xD93A
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD9E5
{
	int i;
	int num;
	var unk;
...
BOOL func_207(var uParam0, var uParam1) // Position - 0xDBA3
{
	var unk;
...
BOOL func_208(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDBD3
{
	int i;
	int num;
...
BOOL func_209(int iParam0) // Position - 0xDE8F
{
...
BOOL func_210(var uParam0, int iParam1) // Position - 0xDEC3
{
	float num;
...
BOOL func_211(var uParam0, int iParam1) // Position - 0xDF39
{
	return func_212(uParam0, unk_0xC1A5EC5C986B98AD(), iParam1, 1, 250, 7);
}

BOOL func_212(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF51
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_213(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE012
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_214(var uParam0, int iParam1) // Position - 0xE13E
{
	int num;
...
BOOL func_216(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE24D
{
	var unk;
	var unk4;
	float num;
...
float func_217(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE2DE
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_218(float fParam0, var uParam1, var uParam2) // Position - 0xE2FF
{
	float num;
	float num2;
...
int func_220(var uParam0, var uParam1) // Position - 0xE359
{
	int i;
...
int func_221(var uParam0) // Position - 0xE398
{
...
BOOL func_222(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE3C0
{
	float num;
	float num2;
	int num3;
...
BOOL func_223(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE4BB
{
	float num;
	float num2;
...
BOOL func_224(var uParam0, float fParam1) // Position - 0xE5C7
{
	var unk;
	var unk2;
...
BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE65C
{
	var unk;
	var unk4;
	float num;
...
BOOL func_226(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE6EA
{
	if (bParam1)
		if (unk_0x110D030CCD4E83A6(unk_0xC1A5EC5C986B98AD()))
...
BOOL func_227(int iParam0) // Position - 0xE732
{
...
void func_228(var uParam0) // Position - 0xE77C
{
	var unk;
...
BOOL func_229(int iParam0) // Position - 0xE819
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_230(int iParam0) // Position - 0xE8AE
{
...
BOOL func_233(int iParam0) // Position - 0xE92D
{
...
BOOL func_235(int iParam0) // Position - 0xE99F
{
...
BOOL func_236(var uParam0) // Position - 0xE9C7
{
	if (!func_237(uParam0))
		return false;
...
BOOL func_237(var uParam0) // Position - 0xE9E6
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_242(&num) || !unk_0x2BBF749E555360DC("special_ped@maude@base"))
				return false;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
				func_241(&uParam0->f_41[0], num[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
				func_241(&uParam0->f_41[1], num[2], 2727.686f, 4145.715f, 44.08f, 71f);
		
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
				if (!func_238(&uParam0->f_28[0], CHAR_MAUDE, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
					flag = false;
		...
		case 3:
			if (func_131(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
			{
...
BOOL func_238(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xEC7E
{
	if (func_239(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0x7DE17ACDD8BA2642(*uParam0))
		{
			if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_239(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xECDA
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_244(echParam1);
...
int func_240(var uParam0, eCharacter echParam1) // Position - 0xED68
{
	int num;
...
void func_241(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEDAE
{
	func_204(uParam0);
...
BOOL func_242(var uParam0) // Position - 0xEDD5
{
	int i;
...
void func_243(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEE06
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0x54ECDA2DAB9CFB10(unk, unk4, 0, 1, 1, 1);
...
int func_244(eCharacter echParam0) // Position - 0xEF06
{
	if (!func_36(echParam0))
...
BOOL func_245(int iParam0) // Position - 0xEF2C
{
	var unk;
	eCharacter character;
...
BOOL func_246(int iParam0) // Position - 0xEF7D
{
	var unk;
...
BOOL func_247(int iParam0) // Position - 0xF036
{
	var unk;
...
BOOL func_248(int iParam0) // Position - 0xF0F7
{
	int i;
	var unk;
	int num;
...
BOOL func_250(int iParam0) // Position - 0xF25E
{
...
BOOL func_251(int iParam0) // Position - 0xF289
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF32E
{
	int i;
...
BOOL func_256(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF393
{
	int num;
	char* str;
...
BOOL func_257(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF40B
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_258(var uParam0, BOOL bParam1) // Position - 0xF486
{
	if (bParam1)
	{
...
void func_263(var uParam0, BOOL bParam1) // Position - 0xF591
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (unk_0xEFF022A75A217E08(*uParam0))
...
void func_266(var uParam0) // Position - 0xF61B
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_267(var uParam0) // Position - 0xF653
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
...
void func_269(var uParam0, int iParam1) // Position - 0xF701
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_270(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_270(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF742
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x66599E73DBA5A850(*uParam0))
...
void func_271(var uParam0) // Position - 0xF792
{
	if (unk_0x7DE17ACDD8BA2642(*uParam0))
	{
		if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
BOOL func_273(var uParam0, int iParam1) // Position - 0xF844
{
	if (func_131(uParam0))
...
void func_274(int iParam0) // Position - 0xF877
{
	if (*iParam0 == -1)
		return;
