...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_459(PLAYER::PLAYER_PED_ID()))
		{
			func_455();
...
void func_19()
{
	...
	{
		if (func_23(Global_112922.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_77669[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_64(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iVar0), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
						}
						func_96(iVar0);
						if (Global_77667 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_64(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iParam1), Global_77669[1 /*14*/].f_3, Global_77669[1 /*14*/].f_4, iParam4);
		}
		if (Global_77667 == 1)
		{
			iVar2 = 0;
...
int func_55(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_168(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_64, Global_112922.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_168(iParam0, Global_112922.f_2363.f_539[iVar0 /*65*/].f_61, Global_112922.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_100(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		iVar0 = Global_2822371[iParam0 /*3*/][func_99(iParam1)];
...
void func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_107(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_107(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_168(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_77669[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_64(iParam1)) && Global_77669[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_64(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_192(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2860791[iParam0 /*3*/][func_99(iParam1)];
...
void func_247()
{
	if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_2_CAR_CHASE"))
	{
		if (iLocal_91 == 2)
		{
			if ((func_8(Local_251.f_0) && func_459(Local_237.f_0)) && PED::IS_PED_IN_VEHICLE(Local_237.f_0, Local_251.f_0, false))
			{
...
{
	func_270(&Global_106470, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_360(int iParam0)
{
	if (iParam0 != func_259())
	{
		...
		else if ((Global_1575054 && iParam0 == PLAYER::PLAYER_ID()) && func_361(iParam0, 1, 0))
		{
			return Global_2689224[iParam0 /*451*/].f_317.f_6 != -1;
		}
	}
...
void func_387()
{
	...
	else
	{
		if (!bLocal_449)
		{
			...
			if (func_459(Local_237.f_0) && ENTITY::DOES_ENTITY_EXIST(Local_244.f_0))
			{
...
void func_391()
{
	...
	{
		if (func_459(Local_244.f_0) && ENTITY::DOES_ENTITY_EXIST(Local_237.f_0))
		{
...
int func_393()
{
	if (func_8(Local_251.f_0) && func_459(PLAYER::PLAYER_PED_ID()))
	{
...
int func_408(int iParam0, float fParam1)
{
	...
	if (func_459(PLAYER::PLAYER_PED_ID()) && func_459(iParam0))
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103486.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103486.f_4, false))
		{
			if (func_443(24) != Global_103486.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_440(ENTITY::GET_ENTITY_COORDS(Global_103486.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_412(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_433(iParam5, &Var0, Param1, fParam4, func_277(iParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_173(iParam0, 0, 0)) || func_173(iParam0, 1, 0)) || func_173(iParam0, 2, 0)) || func_277(iParam0) != 145) || func_431(iParam0)) || func_430(iParam0)) || func_429(iParam0)) || func_428(iParam0)) || !func_416(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_430(iParam0))
		{
		}
...
int func_417(int iParam0, bool bParam1)
{
	...
	{
		if ((func_422() || MISC::IS_PC_VERSION()) || func_421())
		{
		}
		else if (!func_424())
		{
...
void func_433(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_432(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
...
void func_445(int iParam0, int iParam1)
{
	...
	StringCopy(&(Global_31671[iParam0 /*6*/]), SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
