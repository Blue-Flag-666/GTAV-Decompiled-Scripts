...
Blip func_29(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xFC9
{
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x667B
{
	...
	bParam4;
	statName = Global_2805027[empsParam0 /*3*/][func_131(iParam2)];
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_174() || Global_32166 || func_173() || func_24(8, -1) || func_170() || func_172() || func_171() || func_169() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_174() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_24(8, -1) || func_169() || func_168() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
