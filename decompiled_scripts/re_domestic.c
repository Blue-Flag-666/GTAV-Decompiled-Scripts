...
BOOL func_14(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC46
{
	if (iParam0 == -1)
		return false;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xD42
{
...
BOOL func_23(int iParam0, int iParam1) // Position - 0x141F
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1470
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
BOOL func_26(int iParam0) // Position - 0x1802
{
	switch (iParam0)
	{
		case 29:
...
void func_29(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1893
{
	int i;
...
void func_32() // Position - 0x1BC2
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_34(character) && !func_33(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != character && func_34(Global_113810.f_2366.f_539.f_4321))
...
BOOL func_34(eCharacter echParam0) // Position - 0x1CCD
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1CD9
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1D16
{
...
Hash func_37(eCharacter echParam0) // Position - 0x1D3B
{
	return Global_2058[echParam0 /*29*/];
}

BOOL func_38(int iParam0) // Position - 0x1D4A
{
	int num;
	int i;
...
int func_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x1E73
{
...
BOOL func_44() // Position - 0x2069
{
	return true;
}

BOOL func_45() // Position - 0x2072
{
	if (Global_32523)
	{
		func_20(4);
...
void func_50(Ped pedParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x20DF
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(pedParam0, sParam1, sParam2, func_51(iParam3), false);
	return;
}

char* func_51(int iParam0) // Position - 0x20F8
{
	char* str;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x23B1
{
	func_32();
...
BOOL func_64(char* sParam0) // Position - 0x256C
{
	var string2;
...
BOOL func_66(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x25E8
{
	Global_21846 = 0;
...
BOOL func_69(Player plParam0) // Position - 0x2950
{
	return func_70(plParam0, 20);
}

BOOL func_70(Player plParam0, int iParam1) // Position - 0x2960
{
	return IS_BIT_SET(Global_1895156[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x2978
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2B06
{
	if (func_33(14))
	{
...
BOOL func_81(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2CE3
{
	if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
	{
	...
	switch (iLocal_68)
	{
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(pedLocal_56))
			{
				if (!PED::IS_PED_INJURED(pedLocal_56))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(pedLocal_56, uLocal_110, Global_19, true, true, 0) && func_116(true, false, true))
					{
...
void func_84(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3101
{
	int outValue;
	Hash statHash;
...
void func_88(int iParam0) // Position - 0x3AAE
{
	BOOL flag;
	var txdName;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x3C26
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_92(int iParam0) // Position - 0x3D54
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x3EF4
{
	if (iParam1 == -1)
		iParam1 = func_9();
...
BOOL func_97(var uParam0, int iParam1) // Position - 0x407F
{
	int i;
	var unk;
...
void func_102(var uParam0, int iParam1) // Position - 0x4200
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_107(int iParam0) // Position - 0x4276
{
	switch (iParam0)
	{
		case 60:
...
void func_108(Hash hParam0, int iParam1) // Position - 0x42C6
{
	int outValue;
...
int func_111(eCharacter echParam0) // Position - 0x43BB
{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x43F0
{
...
BOOL func_116(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4651
{
...
Blip func_122(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4F83
{
	Blip blip;
...
var func_123(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4FAF
{
	if (bParam0)
		return uParam1;
...
Blip func_124(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x4FC6
{
	Blip blip;
...
Blip func_125(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5010
{
	Blip blip;
...
float func_134(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x5951
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

BOOL func_135(char* sParam0) // Position - 0x596B
{
	var string2;
...
int func_141(BOOL bParam0) // Position - 0x63ED
{
	if (func_144())
	{
		Global_113800 = true;
		...
		if (bParam0 && func_26(Global_113799))
...
BOOL func_144() // Position - 0x655D
{
	switch (func_145(&Global_32343, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x6719
{
	return func_148(iParam0, Global_43377);
}

BOOL func_148(int iParam0, int iParam1) // Position - 0x672A
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_149(int iParam0) // Position - 0x690B
{
	if (Global_43377 == 15)
		return false;
...
void func_151() // Position - 0x6969
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_61 - { 10f, 10f, 10f }, uLocal_61 + { 10f, 10f, 10f }, false, true, true, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_110 - { 3f, 2f, 2f }, uLocal_110 + { 3f, 2f, 2f }, false, true, true, true);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x6CC4
{
...
void func_154(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x7044
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, func_51(iParam2), 1);
	return;
}

BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x705B
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x70A9
{
...
BOOL func_160(Ped pedParam0) // Position - 0x7377
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_163(Ped pedParam0) // Position - 0x745C
{
...
BOOL func_184(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9446
{
	BOOL flag;
...
BOOL func_185(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x97E0
{
	if (bParam6)
...
BOOL func_186(eCharacter echParam0) // Position - 0x9827
{
	int num;
...
BOOL func_187(int iParam0) // Position - 0x9848
{
...
var func_198(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9C1A
{
	if (bParam0)
		return uParam1;
...
BOOL func_200(int iParam0, int iParam1) // Position - 0x9C3E
{
	int num;
	int num2;
...
BOOL func_208(int iParam0) // Position - 0x9F4B
{
	int num;
	int num2;
	int num3;
...
BOOL func_209(int iParam0, int iParam1) // Position - 0xA027
{
...
BOOL func_210(int iParam0) // Position - 0xA047
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_218() || Global_112857 || Global_32286 || func_217() || func_78(8, -1) || func_216() || func_215() || func_214() || func_213() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_218() || Global_32286 || func_217() || func_78(8, -1) || func_214() || func_216() || func_215() || func_213() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_218() || Global_112857 || Global_32286 || func_217() || func_78(8, -1) || func_216() || func_215() || func_213() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_218() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_78(8, -1) || func_213() || func_212() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_218() || Global_32286 || func_217() || func_78(8, -1) || func_215() || func_214() || func_213() || Global_113810.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_218() || func_215() || Global_112857 || Global_32286 || func_217() || Global_44569 || func_78(8, -1) || func_214() || func_212() || func_213() || Global_113810.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_211() // Position - 0xA764
{
	return Global_100872.f_1;
}

BOOL func_212() // Position - 0xA772
{
	if (Global_97735 != -1)
...
BOOL func_217() // Position - 0xA7FB
{
	return Global_1575063;
}

BOOL func_218() // Position - 0xA807
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_221(int iParam0, int iParam1, eCharacter echParam2) // Position - 0xA85D
{
	BOOL num;
	eCharacter character;
...
int func_222(eCharacter echParam0) // Position - 0xA941
{
...
BOOL func_223(int iParam0) // Position - 0xA965
{
	int num;
	BOOL flag;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xAA01
{
	int profileSetting;
...
BOOL func_226(int iParam0, int iParam1) // Position - 0xAAB9
{
	if (Global_113810.f_10197[iParam0 /*12*/].f_5 == 1)
	{
		iParam1 == 1;
...
void func_228(int iParam0) // Position - 0xAC49
{
	...
	if (func_180())
	{
		...
		func_231(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_230(Global_113799, true), 64);
